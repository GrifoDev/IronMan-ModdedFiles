...
.field private i:Landroid/support/v7/widget/ao;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput v3, p0, Landroid/support/v7/widget/ap$a;->g:I

    iput v4, p0, Landroid/support/v7/widget/ap$a;->h:I

    :goto_0
    return-void

    :cond_0
    iput v4, p0, Landroid/support/v7/widget/ap$a;->g:I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ap$a;->i:Landroid/support/v7/widget/ao;
    ...
    :goto_1
    iget-object v2, p0, Landroid/support/v7/widget/ap$a;->j:Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ap$a;->i:Landroid/support/v7/widget/ao;

    invoke-interface {v3, v0, v2}, Landroid/support/v7/widget/ao;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V

    :cond_0
    iput-object v1, p0, Landroid/support/v7/widget/ap$a;->j:Landroid/view/MenuItem;

    if-eqz v1, :cond_1

    iget-object v2, p0, Landroid/support/v7/widget/ap$a;->i:Landroid/support/v7/widget/ao;

    invoke-interface {v2, v0, v1}, Landroid/support/v7/widget/ao;->b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/ap$a;->g:I
    ...
    invoke-virtual {p0, v0, v2, v4, v5}, Landroid/support/v7/widget/ap$a;->performItemClick(Landroid/view/View;IJ)Z
    ...
    iget v0, p0, Landroid/support/v7/widget/ap$a;->h:I

    if-ne p1, v0, :cond_2

    const/4 v0, -0x1

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ap$a;->setSelection(I)V
...
.method public setHoverListener(Landroid/support/v7/widget/ao;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ap$a;->i:Landroid/support/v7/widget/ao;
