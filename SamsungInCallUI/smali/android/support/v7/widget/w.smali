...
# instance fields
.field private d:Landroid/support/v7/widget/k;
...
.field private j:Landroid/support/v7/widget/w$b;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v7/widget/w;->a:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/support/v7/widget/w;->b:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/w;->l:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/w;->d:Landroid/support/v7/widget/k;

    new-instance v0, Landroid/support/v7/widget/f;

    iget-object v2, p0, Landroid/support/v7/widget/w;->d:Landroid/support/v7/widget/k;

    invoke-direct {v0, p0, v2}, Landroid/support/v7/widget/f;-><init>(Landroid/view/View;Landroid/support/v7/widget/k;)V
    ...
    iput v5, p0, Landroid/support/v7/widget/w;->k:I
    ...
    :cond_6
    sget-boolean v0, Landroid/support/v7/widget/w;->a:Z
...
.method static synthetic a(Landroid/support/v7/widget/w;Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    .locals 1

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/w;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method private a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/w;->l:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/w;->l:Landroid/graphics/Rect;
...
.method static synthetic a(Landroid/support/v7/widget/w;)Landroid/support/v7/widget/w$b;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/w;->j:Landroid/support/v7/widget/w$b;
...
.method public getDropDownHorizontalOffset()I
    ...
    :cond_0
    sget-boolean v0, Landroid/support/v7/widget/w;->b:Z
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v7/widget/w;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/w;->j:Landroid/support/v7/widget/w$b;
...
.method public setDropDownWidth(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/w;->k:I
