...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;ZII)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/bc;->r:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/bc;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_3
    iget-object v2, p0, Landroid/support/v7/widget/bc;->g:Landroid/graphics/drawable/Drawable;

    if-nez v2, :cond_4

    iget-object v2, p0, Landroid/support/v7/widget/bc;->r:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bc;->p:Landroid/support/v7/widget/k;
    ...
    :cond_d
    invoke-direct {p0}, Landroid/support/v7/widget/bc;->r()I
...
.method private r()I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/bc;->r:Landroid/graphics/drawable/Drawable;
...
.method public a(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bc;->p:Landroid/support/v7/widget/k;
...
.method public a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/bc;->s()V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bc;->n:Landroid/support/v7/widget/ActionMenuPresenter;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bc;->n:Landroid/support/v7/widget/ActionMenuPresenter;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bc;->n:Landroid/support/v7/widget/ActionMenuPresenter;
