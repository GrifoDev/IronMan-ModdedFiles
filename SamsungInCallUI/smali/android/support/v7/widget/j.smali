...
# direct methods
.method constructor <init>(Landroid/widget/CompoundButton;Landroid/support/v7/widget/k;)V
    .locals 2
    ...
    iput-object v1, p0, Landroid/support/v7/widget/j;->c:Landroid/content/res/ColorStateList;

    iput-object v1, p0, Landroid/support/v7/widget/j;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/j;->b:Landroid/support/v7/widget/k;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/j;->c:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/j;->c:Landroid/content/res/ColorStateList;
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/j;->d:Landroid/graphics/PorterDuff$Mode;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/j;->b:Landroid/support/v7/widget/k;

    iget-object v4, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/CompoundButton;

    invoke-virtual {v4}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-virtual {v3, v4, v0}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/j;->d:Landroid/graphics/PorterDuff$Mode;
...
.method c()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/j;->g:Z
...
.method d()V
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/j;->f:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/j;->c:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/j;->d:Landroid/graphics/PorterDuff$Mode;
