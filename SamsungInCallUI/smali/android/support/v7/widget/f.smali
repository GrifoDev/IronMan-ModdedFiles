...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/f;->e:Landroid/support/v7/widget/az;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/f;->e:Landroid/support/v7/widget/az;
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/az;[I)V
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/az;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/az;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v1, v3, v4}, Landroid/support/v7/widget/bb;->g(II)I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/bb;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v2, v3}, Landroid/support/v7/widget/bb;->a(II)I
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/f;->c:Landroid/support/v7/widget/az;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->c:Landroid/support/v7/widget/az;
...
.method c()V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/az;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/az;[I)V

    goto :goto_0

    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/f;->c:Landroid/support/v7/widget/az;
