...
# direct methods
.method constructor <init>(Landroid/widget/SeekBar;Landroid/support/v7/widget/k;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/r;-><init>(Landroid/widget/ProgressBar;Landroid/support/v7/widget/k;)V

    iput-object v1, p0, Landroid/support/v7/widget/v;->d:Landroid/content/res/ColorStateList;

    iput-object v1, p0, Landroid/support/v7/widget/v;->e:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v0, p0, Landroid/support/v7/widget/v;->f:Z

    iput-boolean v0, p0, Landroid/support/v7/widget/v;->g:Z

    iput-object p1, p0, Landroid/support/v7/widget/v;->b:Landroid/widget/SeekBar;
...
.method private d()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/v;->c:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/v;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/v;->d:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/v;->e:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/v;->b:Landroid/widget/SeekBar;
...
.method a(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/v;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/v;->b:Landroid/widget/SeekBar;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/v;->b:Landroid/widget/SeekBar;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/v;->c:Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/v;->b:Landroid/widget/SeekBar;
    ...
    iput-boolean v3, p0, Landroid/support/v7/widget/v;->g:Z
