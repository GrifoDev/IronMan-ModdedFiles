...
# instance fields
.field private final mBackgroundTintHelper:Landroid/support/v7/widget/f;

.field private final mDrawableManager:Landroid/support/v7/widget/k;

.field private final mTextHelper:Landroid/support/v7/widget/x;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->mDrawableManager:Landroid/support/v7/widget/k;

    new-instance v0, Landroid/support/v7/widget/f;

    iget-object v1, p0, Landroid/support/v7/widget/g;->mDrawableManager:Landroid/support/v7/widget/k;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/f;-><init>(Landroid/view/View;Landroid/support/v7/widget/k;)V

    iput-object v0, p0, Landroid/support/v7/widget/g;->mBackgroundTintHelper:Landroid/support/v7/widget/f;

    iget-object v0, p0, Landroid/support/v7/widget/g;->mBackgroundTintHelper:Landroid/support/v7/widget/f;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->mTextHelper:Landroid/support/v7/widget/x;

    iget-object v0, p0, Landroid/support/v7/widget/g;->mTextHelper:Landroid/support/v7/widget/x;
