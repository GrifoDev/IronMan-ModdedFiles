...
.method public constructor <init>(Landroid/support/v7/app/p;Landroid/content/Context;Landroid/support/v7/view/b$a;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/p$a;->c:Landroid/support/v7/view/menu/h;
...
.method public a(I)V
    ...
    invoke-static {v0}, Landroid/support/v7/app/p;->i(Landroid/support/v7/app/p;)Landroid/content/Context;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/p$a;->b(Ljava/lang/CharSequence;)V
...
.method public a(Landroid/support/v7/view/menu/h;)V
    ...
    invoke-static {v0}, Landroid/support/v7/app/p;->g(Landroid/support/v7/app/p;)Landroid/support/v7/widget/ActionBarContextView;
...
.method public b(I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/p$a;->a(Ljava/lang/CharSequence;)V
...
.method public c()V
    ...
    iget-object v0, v0, Landroid/support/v7/app/p;->a:Landroid/support/v7/app/p$a;
    ...
    invoke-static {v0}, Landroid/support/v7/app/p;->e(Landroid/support/v7/app/p;)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v7/app/p$a;->a:Landroid/support/v7/app/p;

    invoke-static {v1}, Landroid/support/v7/app/p;->f(Landroid/support/v7/app/p;)Z
    ...
    iput-object p0, v0, Landroid/support/v7/app/p;->b:Landroid/support/v7/view/b;

    iget-object v0, p0, Landroid/support/v7/app/p$a;->a:Landroid/support/v7/app/p;

    iget-object v1, p0, Landroid/support/v7/app/p$a;->d:Landroid/support/v7/view/b$a;

    iput-object v1, v0, Landroid/support/v7/app/p;->c:Landroid/support/v7/view/b$a;

    :goto_1
    iput-object v3, p0, Landroid/support/v7/app/p$a;->d:Landroid/support/v7/view/b$a;

    iget-object v0, p0, Landroid/support/v7/app/p$a;->a:Landroid/support/v7/app/p;

    invoke-virtual {v0, v2}, Landroid/support/v7/app/p;->j(Z)V
    ...
    iget-boolean v1, v1, Landroid/support/v7/app/p;->d:Z

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ActionBarOverlayLayout;->setHideOnContentScrollEnabled(Z)V

    iget-object v0, p0, Landroid/support/v7/app/p$a;->a:Landroid/support/v7/app/p;

    iput-object v3, v0, Landroid/support/v7/app/p;->a:Landroid/support/v7/app/p$a;
