...
.method private setPrimaryCall(Lcom/android/incallui/Call;)V
    ...
    invoke-virtual {v0}, Lcom/android/incallui/service/vt/VideoCallManager$CallContext;->isUsingScreenTypeSensor()Z
...
# virtual methods
.method public canUseZoom()Z
    .locals 1

    iget-object v0, p0, Lcom/android/incallui/service/vt/VideoCallManager;->mVideoCallStatus:Lcom/android/incallui/service/vt/VideoCallManager$VideoCallStatus;

    iget-boolean v0, v0, Lcom/android/incallui/service/vt/VideoCallManager$VideoCallStatus;->canUseZoom:Z
...
.method public isZoomInVideo()Z
    ...
    iget-boolean v0, v0, Lcom/android/incallui/service/vt/VideoCallManager$VideoCallStatus;->isZoomInVideo:Z
...
.method public onVideoCallUiEvent(I)V
    ...
    iget-object v2, p0, Lcom/android/incallui/service/vt/VideoCallManager;->mPrimaryCallContext:Lcom/android/incallui/service/vt/VideoCallManager$CallContext;

    if-eqz v2, :cond_2

    iget-object v2, p0, Lcom/android/incallui/service/vt/VideoCallManager;->mPrimaryCallContext:Lcom/android/incallui/service/vt/VideoCallManager$CallContext;

    invoke-virtual {v2, v1}, Lcom/android/incallui/service/vt/VideoCallManager$CallContext;->saveScreenTypeSensorState(Z)V

    :cond_2
    invoke-virtual {p0}, Lcom/android/incallui/service/vt/VideoCallManager;->isPipRunning()Z

    move-result v2

    if-eqz v2, :cond_3

    const-string v0, "VideoCallManager - ACCELEROMETER_CHANGED : ignore, pip is running"
    ...
    invoke-virtual {v0}, Lcom/android/incallui/service/vt/InCallRotationEventListener;->setAutoRotationSystemProperty()V
    ...
    const-string v3, "VideoCallManager - ACCELEROMETER_CHANGED, canUseScreenTypeSensor="
    ...
    invoke-virtual {v0}, Lcom/android/incallui/service/vt/VideoCallEventHandler;->startSwitchCameraTimer()V
...
.method public onVideoSessionEvent(ILcom/android/incallui/Call;)V
    ...
    invoke-static {p1}, Lcom/android/incallui/service/vt/VideoCallConstants$SessionEvent;->isPreviewEvent(I)Z
    ...
    invoke-virtual {v0}, Lcom/android/incallui/service/vt/VideoCallEventHandler;->cancelSwitchCameraTimer()V
...
.method public sendEpdgRequest(Z)V
    ...
    const-string v0, "sendEpdgRequest failed. call is null"
    ...
    const-string v2, "sendEpdgRequest, isUiShowing="
    ...
    const-string v0, "sendEpdgRequest ignore. Tx is already pausd"
...
.method public setZoomAbility(Z)V
    .locals 2
    ...
    iput-boolean p1, v0, Lcom/android/incallui/service/vt/VideoCallManager$VideoCallStatus;->canUseZoom:Z
...
.method public setZoomInVideo(Z)V
    .locals 2
    ...
    iput-boolean p1, v0, Lcom/android/incallui/service/vt/VideoCallManager$VideoCallStatus;->isZoomInVideo:Z
