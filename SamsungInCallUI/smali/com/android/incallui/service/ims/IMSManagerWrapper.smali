...
.method public getRttMode()I
    ...
    invoke-virtual {v0}, Lcom/sec/ims/ImsManager;->getRttMode()I
...
.method public isRegisteredEpdg()Z
    .locals 7
    ...
    invoke-virtual {v2}, Lcom/sec/ims/ImsManager;->getRegistrationInfo()[Lcom/sec/ims/ImsRegistration;
    ...
    const-string v2, "isRegisteredEpdg(): EPDG not registered."
...
.method public isRttCall(I)Z
    ...
    const-string v2, " mImsManager.isRttCall(sessionId):"
    ...
    invoke-virtual {v2, p1}, Lcom/sec/ims/ImsManager;->isRttCall(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/sec/ims/ImsManager;->isRttCall(I)Z
...
.method public registerRttEventListener(Lcom/sec/ims/IRttEventListener;)V
    .locals 3

    const-string v0, "IMSManagerWrapper"

    const-string v1, "registerRttEventListener"
    ...
    invoke-virtual {v0, p1}, Lcom/sec/ims/ImsManager;->registerRttEventListener(Lcom/sec/ims/IRttEventListener;)V
...
.method public sendRttMessage(Ljava/lang/String;)V
    ...
    const-string v1, "sendRttMessage"
    ...
    invoke-virtual {v0, p1}, Lcom/sec/ims/ImsManager;->sendRttMessage(Ljava/lang/String;)V
...
.method public sendRttSessionModifyRequest(IZ)V
    ...
    const-string v1, "sendRttSessionModifyRequest"
    ...
    invoke-virtual {v0, p1, p2}, Lcom/sec/ims/ImsManager;->sendRttSessionModifyRequest(IZ)V
...
.method public sendRttSessionModifyResponse(IZ)V
    ...
    const-string v1, "sendRttSessionModifyResponse"
    ...
    invoke-virtual {v0, p1, p2}, Lcom/sec/ims/ImsManager;->sendRttSessionModifyResponse(IZ)V
...
.method public setRttMode(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/sec/ims/ImsManager;->setRttMode(I)V
...
.method public unregisterRttEventListener(Lcom/sec/ims/IRttEventListener;)V
    .locals 3

    const-string v0, "IMSManagerWrapper"

    const-string v1, "unregisterRttEventListener"
    ...
    invoke-virtual {v0, p1}, Lcom/sec/ims/ImsManager;->unregisterRttEventListener(Lcom/sec/ims/IRttEventListener;)V
