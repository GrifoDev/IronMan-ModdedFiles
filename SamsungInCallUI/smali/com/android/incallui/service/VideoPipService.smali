...
.field public mContactCacheEntry:Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;
...
.field public mMyProfilePhotoUri:Landroid/net/Uri;

.field protected mParent:Landroid/view/ViewGroup;

.field private mPipPhoto:Landroid/widget/ImageView;
...
.method private clearContactPhoto()V
    .locals 2

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/incallui/service/VideoPipService;->mContactCacheEntry:Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;

    iput-object v1, p0, Lcom/android/incallui/service/VideoPipService;->mMyProfilePhotoUri:Landroid/net/Uri;

    iget-boolean v0, p0, Lcom/android/incallui/service/VideoPipService;->mPreviewType:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/incallui/service/VideoPipService;->mPipPhoto:Landroid/widget/ImageView;
...
.method private onStateChange()V
    ...
    invoke-direct {p0, v0}, Lcom/android/incallui/service/VideoPipService;->updatePrimaryCall(Lcom/android/incallui/Call;)V
...
.method private setContactPhoto(Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;)V
    .locals 2

    const/4 v0, 0x0

    iget-object v1, p0, Lcom/android/incallui/service/VideoPipService;->mContactCacheEntry:Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;
    ...
    const-string v0, "setContactPhoto, set contact photo"

    invoke-static {v0}, Lcom/android/incallui/service/vt/VideoCallLog;->pip(Ljava/lang/String;)V

    iput-object p1, p0, Lcom/android/incallui/service/VideoPipService;->mContactCacheEntry:Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;

    iget-object v0, p1, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->photo:Landroid/graphics/drawable/Drawable;

    :goto_0
    iget-object v1, p0, Lcom/android/incallui/service/VideoPipService;->mPipPhoto:Landroid/widget/ImageView;
    ...
    :cond_1
    iput-object v0, p0, Lcom/android/incallui/service/VideoPipService;->mContactCacheEntry:Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;

    goto :goto_0
.end method

.method private setMyProfilePhoto(Landroid/net/Uri;)V
    .locals 2
    ...
    iget-object v1, p0, Lcom/android/incallui/service/VideoPipService;->mMyProfilePhotoUri:Landroid/net/Uri;
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/incallui/service/VideoPipService;->mMyProfilePhotoUri:Landroid/net/Uri;

    const-string v0, "setMyProfilePhoto, set my profile image"
    ...
    iput-object v0, p0, Lcom/android/incallui/service/VideoPipService;->mMyProfilePhotoUri:Landroid/net/Uri;
...
.method private updatePrimaryCall(Lcom/android/incallui/Call;)V
    .locals 1

    iput-object p1, p0, Lcom/android/incallui/service/VideoPipService;->mPrimary:Lcom/android/incallui/Call;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {p0}, Lcom/android/incallui/service/VideoPipService;->onStateChange()V
...
.method public onDestroy()V
    ...
    invoke-direct {p0}, Lcom/android/incallui/service/VideoPipService;->clearContactPhoto()V
...
.method protected onFinishInflate(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Lcom/android/incallui/service/VideoPipService;->mPipPhoto:Landroid/widget/ImageView;
...
.method protected updateContactPhoto()V
    .locals 2
    ...
    invoke-direct {p0, v0}, Lcom/android/incallui/service/VideoPipService;->setMyProfilePhoto(Landroid/net/Uri;)V
    ...
    :cond_2
    invoke-direct {p0, v0}, Lcom/android/incallui/service/VideoPipService;->setContactPhoto(Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;)V
...
.method protected updateVideoDetails()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/incallui/service/vt/VideoDetails;->copy(Lcom/android/incallui/service/vt/VideoDetails;)V
