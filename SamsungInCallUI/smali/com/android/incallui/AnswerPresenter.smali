...
.field private final RJIO_CONFERENCECALL_MAX_SIZE:I

.field private final TMO_VIDEOCONFERENCECALL_MAX_SIZE:I
...
.method public constructor <init>()V
    ...
    iput v2, p0, Lcom/android/incallui/AnswerPresenter;->RJIO_CONFERENCECALL_MAX_SIZE:I

    iput v2, p0, Lcom/android/incallui/AnswerPresenter;->TMO_VIDEOCONFERENCECALL_MAX_SIZE:I
...
.method private DisplayWaitingCallDialogWhenDoNotHaveHoldingCall(I)V
    ...
    invoke-static {v5}, Lcom/android/incallui/util/SecCallExtraUtils;->getIsVolteConference(Lcom/android/incallui/Call;)Z
    ...
    const-string v5, "not support merge option during participant"
    ...
    invoke-virtual {v8}, Lcom/android/incallui/InCallApp;->getIMSManagerWrapper()Lcom/android/incallui/service/ims/IMSManagerWrapper;

    move-result-object v8

    invoke-virtual {v4}, Lcom/android/incallui/CallList;->hasRttCall()Z
    ...
    invoke-virtual {v4}, Lcom/android/incallui/SecCall;->getSessionId()I

    move-result v4

    invoke-virtual {v8, v4}, Lcom/android/incallui/service/ims/IMSManagerWrapper;->isRttCall(I)Z
    ...
    invoke-static {v2, v4, v6}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v9, "count in video conference of TMO_VOLTE_UI is "
    ...
    const-string v9, "Video conference of TMO_VOLTE_UI is "
    ...
    invoke-interface {v0, v1, v3, v2, p1}, Lcom/android/incallui/AnswerUi;->showWaitingCallDialog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
...
.method public hangUpThenAnswer(II)V
    ...
    const-string v3, "hangUpThenAnswer : "
    ...
    iget v3, p0, Lcom/android/incallui/AnswerPresenter;->mAnswerVideoStateAfterThisDisconnect:I
