...
.field private static final LOG_TAG:Ljava/lang/String; = "Agifflow-CoreAppsUtils"
...
.method public static getEnhancedFeatures()Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures;
    ...
    :try_start_0
    sget-object v1, Lcom/android/incallui/coreapps/CoreAppsUtils;->mEnhancedFeatures:Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures;
    ...
    invoke-direct {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;-><init>(Landroid/content/Context;)V

    sget-object v2, Lcom/android/incallui/coreapps/CoreAppsUtils;->APP_ID:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->addAppId(Ljava/lang/String;)Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;

    move-result-object v1

    sget-object v2, Lcom/android/incallui/coreapps/CoreAppsUtils;->APP_SECRET:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->addAppSecret(Ljava/lang/String;)Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;

    move-result-object v1

    sget-object v2, Lcom/android/incallui/coreapps/CoreAppsUtils;->CID:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->addCid(Ljava/lang/String;)Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->addAnonymous(Z)Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;

    move-result-object v1

    sget-object v2, Lcom/android/incallui/coreapps/CoreAppsUtils;->SPP_ID:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->addSppId(Ljava/lang/String;)Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;

    move-result-object v1

    sget-object v2, Lcom/android/incallui/coreapps/CoreAppsUtils;->GCM_ID:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->addGcmId(Ljava/lang/String;)Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;

    move-result-object v1

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->addEnhancedProfile(I)Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;

    move-result-object v1

    invoke-virtual {v1}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->addEnhancedShare()Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;

    move-result-object v1

    sget-object v2, Lcom/android/incallui/coreapps/CoreAppsUtils;->SHOP_SERVICE_NAME:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->addEnhancedShop(Ljava/lang/String;)Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;

    move-result-object v1

    invoke-virtual {v1}, Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;->enableEnhancedModule()Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures$Builder;
    ...
    sput-object v1, Lcom/android/incallui/coreapps/CoreAppsUtils;->mEnhancedFeatures:Lcom/samsung/android/sdk/enhancedfeatures/EnhancedFeatures;
    ...
    const-string v1, "Agifflow-CoreAppsUtils"

    const-string v2, "need READ_PHONE_STATE permission."
    ...
    const-string v2, "No available space in disk"
...
.method public static getPhonenumberInfo(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber;
    .locals 8
    ...
    invoke-static {p0, v1}, Lcom/android/incallui/util/SystemServiceUtils;->getCountryIso(Landroid/content/Context;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {v4, v1, v7}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {v1}, Lcom/android/incallui/coreapps/CoreAppsUtils;->getNetworkCountryIso(I)Ljava/lang/String;

    move-result-object v0

    invoke-static {v1}, Lcom/android/incallui/coreapps/CoreAppsUtils;->getSimCountryIso(I)Ljava/lang/String;
    ...
    :cond_4
    :try_start_0
    invoke-static {p0}, Lcom/android/contacts/common/GeoUtil;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v5, "GeoUtil.getCurrentCountryIso : "
    ...
    const-string v5, "last country iso check, countryiso = "
    ...
    invoke-static {v1, v0, v7}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v5, "last country iso = "
    ...
    invoke-static {v1, v4, v7}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)V

    :try_start_2
    invoke-virtual {v3, p1, v0}, Lcom/google/i18n/phonenumbers/PhoneNumberUtil;->parse(Ljava/lang/String;Ljava/lang/String;)Lcom/google/i18n/phonenumbers/Phonenumber$PhoneNumber;
    :try_end_2
    .catch Lcom/google/i18n/phonenumbers/NumberParseException; {:try_start_2 .. :try_end_2} :catch_3
    ...
    const-string v2, "Agifflow-CoreAppsUtils"
    ...
    const-string v4, "getPhonenumberInfo - exception occured, GeoUtil.getCurrentCountryIso"

    invoke-static {v1, v4, v7}, Lcom/android/incallui/Log;->w(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v4, "getPhonenumberInfo - exception occured, toUpperCase"
...
.method public static getProfileAndCapabilityfromEFServer(Ljava/lang/String;Lcom/samsung/android/sdk/enhancedfeatures/contact/apis/listener/GetProfileAndCapabilityListener;)V
    ...
    const-string v1, "getProfileAndCapabilityfromEFServer exception occured"
