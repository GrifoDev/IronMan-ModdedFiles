...
# static fields
.field protected static final LOG_TAG:Ljava/lang/String; = "AgifImageAdapter"


# instance fields
.field protected final AGIF_CONTENT_COUNT:I

.field protected mAgifContentsInfo:Ljava/util/ArrayList;
...
.field protected mCallState:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/ArrayList;IZ)V
    ...
    iput v0, p0, Lcom/android/incallui/agif/AgifImageAdapter;->AGIF_CONTENT_COUNT:I

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mIsRejectPage:Z

    iput-object p1, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mContext:Landroid/content/Context;

    iput-boolean p4, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mIsRejectPage:Z

    iget-boolean v0, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mIsRejectPage:Z
    ...
    :goto_0
    iput-object v0, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mCallState:Ljava/lang/String;

    invoke-virtual {p0, p2, p3}, Lcom/android/incallui/agif/AgifImageAdapter;->init(Ljava/util/ArrayList;I)V
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-direct {v0, p0}, Lcom/android/incallui/agif/AgifImageAdapter$ViewHolder;-><init>(Lcom/android/incallui/agif/AgifImageAdapter;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/incallui/agif/AgifImageView;->setVisibility(I)V
...
.method public init(Ljava/util/ArrayList;I)V
    ...
    iput v1, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mSize:I
    ...
    :goto_0
    iget v1, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mSize:I
    ...
    iget v2, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mSize:I
    ...
    iput-object v0, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mPackageName:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/android/incallui/agif/AgifLoader;->getAgifPackageInfo(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mPackageName:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/android/incallui/agif/AgifLoader;->getAgifContentsInfoSize(Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v1}, Lcom/android/incallui/agif/AgifLoader;->getAgifContentsInfo(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-boolean v2, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mIsRejectPage:Z

    if-eqz v2, :cond_5

    if-eqz v0, :cond_4

    iget-boolean v2, v0, Lcom/android/incallui/agif/AgifLoader$AgifContentsInfo;->isRejectContents:Z

    if-eqz v2, :cond_4

    iget-object v2, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mAgifContentsInfo:Ljava/util/ArrayList;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-interface {v0}, Lcom/android/incallui/AgifPresenter$AgifUi;->isShowRecommendPage()Z
    ...
    invoke-static {v1}, Lcom/android/incallui/agif/AgifCallServiceUtils;->sendRejectWithAgifMessage(Landroid/net/Uri;)V

    iget-object v1, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v1, v0}, Lcom/android/incallui/agif/AgifLoader;->getAgifUniqueId(Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mContext:Landroid/content/Context;

    invoke-static {v1, v0}, Lcom/android/incallui/agif/AgifCallServiceUtils;->isAlreadyStickerRecent(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    iget-object v2, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mPackageName:Ljava/lang/String;

    iget-object v3, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mCallState:Ljava/lang/String;

    invoke-static {v1, v2, v0, v3}, Lcom/android/incallui/agif/AgifCallServiceUtils;->insertStickerRecent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/incallui/UiAdapter;->onSelectAgifContents(Landroid/net/Uri;)V
    ...
    iget-object v2, p0, Lcom/android/incallui/agif/AgifImageAdapter;->mCallState:Ljava/lang/String;

    invoke-static {v1, v0, v2}, Lcom/android/incallui/agif/AgifCallServiceUtils;->updateStickerRecent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
