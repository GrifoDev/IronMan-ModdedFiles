...
.method public static isPstnComponent(Landroid/telecom/Call;)Z
    .locals 1
    ...
    invoke-static {v0}, Lcom/android/incallui/util/InCallUtils;->isPstnComponentName(Landroid/content/ComponentName;)Z
...
.method public static isPstnComponentName(Landroid/content/ComponentName;)Z
    .locals 3

    const-string v0, "com.android.phone"

    const-string v0, "com.android.services.telephony.TelephonyConnectionService"
...
.method public static isShowCallDetailsHDIcon(Lcom/android/incallui/Call;)Z
    ...
    const-string v2, "display_cshd_icon"
    ...
    invoke-virtual {p0}, Lcom/android/incallui/Call;->getCallDetails()Lcom/android/incallui/CallDetails;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/incallui/CallDetails;->canShowHDIcon()Z
...
.method public static isShowHDVoiceIcon(Lcom/android/incallui/Call;)Z
    ...
    const-string v4, "isShowHDVoiceIcon false during disconnecting videocall"
...
.method public static isVoicemailCall(Lcom/android/incallui/Call;)Z
    .locals 4
    ...
    invoke-static {v0, v1}, Lcom/android/incallui/util/InCallUtilsWrapper;->isVoiceMailNumber(ILjava/lang/String;)Z
    ...
    const-string v3, " isVoicemailCall = "
    ...
    :cond_1
    invoke-static {v0, p0}, Lcom/android/incallui/CallerInfoUtils;->isVoiceMailNumber(Landroid/content/Context;Lcom/android/incallui/Call;)Z
...
.method public static startActivitySendToReminder(Landroid/content/Context;Ljava/lang/String;)V
    .locals 10
    ...
    const-string v5, "com.samsung.android.app.reminder.externalui.ShareViaActivityDummy"

    const-string v6, "com.samsung.android.app.reminder.action.REGISTER"
    ...
    iget-object v0, v7, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->namePrimary:Ljava/lang/String;

    :cond_0
    iget-object v3, v7, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->number:Ljava/lang/String;

    iget-object v2, v7, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->displayPhotoUri:Landroid/net/Uri;

    iget-boolean v8, v7, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->isVoiceMail:Z

    if-eqz v8, :cond_2

    iget-object v1, v7, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->originalNumber:Ljava/lang/String;
    ...
    const-string v4, "start activity send to reminder - extra [primary_text : "
