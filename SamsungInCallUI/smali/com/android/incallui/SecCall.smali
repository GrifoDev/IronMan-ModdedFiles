...
.field private mCanShowGrayImage:Z
...
.field private mRttChatMessages:Ljava/util/List;
...
.method public constructor <init>(Lcom/android/incallui/Call;)V
    ...
    iput-object v2, p0, Lcom/android/incallui/SecCall;->mSecCallExtra:Ljava/util/HashMap;

    sget v0, Lcom/android/incallui/SecCall$ModifyType;->NONE:I

    iput v0, p0, Lcom/android/incallui/SecCall;->mModifyType:I

    iput v3, p0, Lcom/android/incallui/SecCall;->mModifyRequestType:I

    iput v3, p0, Lcom/android/incallui/SecCall;->mModifyReceiveType:I

    iput v1, p0, Lcom/android/incallui/SecCall;->mHDIcon:I

    iput-object v2, p0, Lcom/android/incallui/SecCall;->mCdnipNumber:Ljava/lang/String;
    ...
    iput-boolean v1, p0, Lcom/android/incallui/SecCall;->mCanShowGrayImage:Z
    ...
    iput-object v2, p0, Lcom/android/incallui/SecCall;->mRttChatMessages:Ljava/util/List;
...
.method private checkForConferencedRx(Landroid/telecom/Call;)V
    ...
    iget-object v1, p0, Lcom/android/incallui/SecCall;->mCallId:Ljava/lang/String;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v1, " : CONFERENCED - child call"
    ...
    const-string v1, " : CONFERENCED - parent call"
    ...
    const-string v1, " : CONFERENCED - participant call"
    ...
    const-string v1, " : CONFERENCED - ims conference call"
...
.method private updateFromTelecommCall(Landroid/telecom/Call;)V
    ...
    invoke-static {v0}, Lcom/android/incallui/util/SecCallExtraParser;->getSecCallExtra(Lcom/android/incallui/Call;)Ljava/util/HashMap;
...
# virtual methods
.method public canShowGrayImage()Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/incallui/SecCall;->mCanShowGrayImage:Z
...
.method public getRttChatmessages()Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v1, "getRttChatmessages mRttChatMessages= "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v1, p0, Lcom/android/incallui/SecCall;->mRttChatMessages:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/incallui/SecCall;->mRttChatMessages:Ljava/util/List;
...
.method public isTheOtherPartyStateChanged(Z)Z
    .locals 3
...
.method public setRttChatmessages(Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v1, "setRttChatmessages chatmessages= "
    ...
    const-string v1, " mRttChatMessages= "
    ...
    iput-object v0, p0, Lcom/android/incallui/SecCall;->mRttChatMessages:Ljava/util/List;
...
.method public setSecVideoState()V
    ...
    invoke-virtual {p0}, Lcom/android/incallui/SecCall;->getVideoState()I
    ...
    :cond_2
    iput-boolean v3, p0, Lcom/android/incallui/SecCall;->mCanShowGrayImage:Z
    ...
    iput-boolean v2, p0, Lcom/android/incallui/SecCall;->mCanShowGrayImage:Z
...
.method public setType()V
    ...
    sget v0, Lcom/android/incallui/SecCall$ModifyType;->REQUEST:I
    ...
    sget v0, Lcom/android/incallui/SecCall$ModifyType;->RECEIVE:I
