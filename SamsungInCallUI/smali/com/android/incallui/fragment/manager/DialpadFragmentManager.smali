...
.method public constructor <init>(Lcom/android/incallui/InCallActivity;)V
    ...
    iput-boolean v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mIsHiden:Z

    iput-boolean v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mIsShowing:Z

    iput-boolean v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->needToShowMenu:Z

    iput-boolean v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mIsDeviceLandScape:Z

    iput-object v2, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mSavedDtmfText:Ljava/lang/String;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mPreviouslyProcessedTime:J

    const/16 v0, 0x64

    iput v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->EVENT_RESTORE_DTMF:I

    const/16 v0, 0x1f4

    iput v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->RESTORE_DTMF_DELAY:I

    const/16 v0, 0xc8

    iput v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->EVENT_DELETE_SENDDTMF_POP:I

    const/16 v0, 0x3e8

    iput v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->DELETE_SENDDTMF_POP_DELAY:I

    new-instance v0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager$1;

    invoke-direct {v0, p0}, Lcom/android/incallui/fragment/manager/DialpadFragmentManager$1;-><init>(Lcom/android/incallui/fragment/manager/DialpadFragmentManager;)V

    iput-object v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mHandler:Landroid/os/Handler;

    new-instance v0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager$2;

    invoke-direct {v0, p0}, Lcom/android/incallui/fragment/manager/DialpadFragmentManager$2;-><init>(Lcom/android/incallui/fragment/manager/DialpadFragmentManager;)V

    iput-object v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mReceiver:Landroid/content/BroadcastReceiver;

    iput-object v2, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mMenuObserver:Ljava/lang/Runnable;

    const/16 v0, 0x32

    iput v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->REFRESH_DIALPAD_MENU_DELAY:I
...
.method static synthetic access$100(Lcom/android/incallui/fragment/manager/DialpadFragmentManager;)J
    .locals 2

    iget-wide v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mPreviouslyProcessedTime:J

    return-wide v0
.end method

.method static synthetic access$200(Lcom/android/incallui/fragment/manager/DialpadFragmentManager;)Z
    .locals 1
...
.method static synthetic access$300(Lcom/android/incallui/fragment/manager/DialpadFragmentManager;)V
    .locals 0
...
.method private runRefreshDialpadMenu()V
    ...
    const-string v1, "DialpadFragmentManager - Menu is opened"
    ...
    const-string v1, "DialpadFragmentManager - Now Menu is closed"

    invoke-virtual {p0, v1}, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->log(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mMenuObserver:Ljava/lang/Runnable;

    if-nez v1, :cond_0

    new-instance v1, Lcom/android/incallui/fragment/manager/DialpadFragmentManager$3;

    invoke-direct {v1, p0, v0}, Lcom/android/incallui/fragment/manager/DialpadFragmentManager$3;-><init>(Lcom/android/incallui/fragment/manager/DialpadFragmentManager;Lcom/android/incallui/InCallMenu;)V

    iput-object v1, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mMenuObserver:Ljava/lang/Runnable;
...
.method public hideDialpad()V
    ...
    invoke-virtual {v0}, Lcom/android/incallui/fragment/DialpadFragment;->getPreviouslyProcessedTime()J
    ...
    invoke-static {v0, v2}, Lcom/android/incallui/util/InCallUtils;->sendBroadcastDiapadStateforUWA(Landroid/content/Context;Z)V
...
.method protected makeTestList()V
    ...
    iput-object v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mTestFragmentList:Ljava/util/List;
...
.method public onCoverStateChanged(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/incallui/fragment/DialpadFragment;->setVisible(Z)V

    iget-object v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mInCallActivity:Lcom/android/incallui/InCallActivity;

    invoke-virtual {v0, v2, v2}, Lcom/android/incallui/InCallActivity;->displayDialpad(ZZ)V

    iput-boolean v3, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mIsHiden:Z
    ...
    :cond_1
    iget-boolean v0, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mIsHiden:Z
    ...
    invoke-virtual {v0, v3, v2}, Lcom/android/incallui/InCallActivity;->displayDialpad(ZZ)V

    :cond_2
    iput-boolean v2, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mIsHiden:Z
...
.method protected setFragment(Ljava/lang/Enum;Z)V
    ...
    invoke-virtual {p0, v1, v0, p2}, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->setFragmentInternal(ILandroid/app/Fragment;Z)V

    :cond_0
    return-void

    :pswitch_0
    new-instance v0, Lcom/android/incallui/fragment/VideoCallDialpadVGAFragment;

    invoke-direct {v0}, Lcom/android/incallui/fragment/VideoCallDialpadVGAFragment;-><init>()V

    goto :goto_0

    :pswitch_1
    new-instance v0, Lcom/android/incallui/fragment/VideoCallDialpadQCIFFragment;

    invoke-direct {v0}, Lcom/android/incallui/fragment/VideoCallDialpadQCIFFragment;-><init>()V
...
.method public showDialpad()V
    ...
    iget-wide v2, p0, Lcom/android/incallui/fragment/manager/DialpadFragmentManager;->mPreviouslyProcessedTime:J
    ...
    invoke-static {v0, v4}, Lcom/android/incallui/util/InCallUtils;->sendBroadcastDiapadStateforUWA(Landroid/content/Context;Z)V
