...
.field protected mDisplayCaptureAnimatinoView:Landroid/view/View;

.field protected mDisplayContainer:Landroid/view/ViewGroup;
...
.field protected mPreviewCaptureAnimatinoView:Landroid/view/View;
...
.field protected mPreviewSwitchAnimationView:Landroid/view/View;
...
.field protected mVideoContainerLayout:Landroid/view/View;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mVideoViews:Landroid/view/View;

    iput-object v1, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mPreviewBorder:Landroid/view/View;

    iput-object v1, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mDisplayBorder:Landroid/view/View;

    iput-object v1, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mDisplayCaptureAnimatinoView:Landroid/view/View;

    iput-object v1, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mPreviewCaptureAnimatinoView:Landroid/view/View;

    iput-object v1, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mPreviewSwitchAnimationView:Landroid/view/View;

    iput-boolean v2, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mIsShowingPreviewAnimation:Z

    iput-boolean v2, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mIsLayoutComplete:Z
    ...
    iput-object v1, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mPrimaryCall:Lcom/android/incallui/Call;
    ...
    iput-boolean v2, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mFullScreenMode:Z

    iput-boolean v2, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mConference:Z
...
.method protected checkAndRefreshDisplaySurface()V
    ...
    invoke-static {v2}, Lcom/android/incallui/service/vt/VideoCallLog;->peer(Ljava/lang/String;)V
...
.method protected checkAndRefreshPreviewSurface()V
    ...
    invoke-static {v1}, Lcom/android/incallui/service/vt/VideoCallLog;->preview(Ljava/lang/String;)V
...
.method public getDisplayBitmap()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0}, Lcom/android/incallui/fragment/VideoCallFragment$VideoCallSurface;->getBitmap()Landroid/graphics/Bitmap;
...
.method public onCallObjectChanged(Lcom/android/incallui/Call;)V
    ...
    const-string v1, "VideoCallFragment - onCallObjectChanged, "
...
.method public refreshSurface(I)Z
    .locals 4
    ...
    invoke-static {v2}, Lcom/android/incallui/service/vt/VideoCallControl;->isAvailableVideoTx(Lcom/android/incallui/Call;)Z

    move-result v3

    iget-object v2, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mPreviewSurface:Lcom/android/incallui/fragment/VideoCallFragment$VideoCallSurface;

    if-eqz v2, :cond_1

    iget-object v2, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mPreviewSurface:Lcom/android/incallui/fragment/VideoCallFragment$VideoCallSurface;

    invoke-virtual {v2}, Lcom/android/incallui/fragment/VideoCallFragment$VideoCallSurface;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {v0}, Lcom/android/incallui/service/vt/VideoCallLog;->preview(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/incallui/VideoCallPresenter;->setPreviewSurface(Landroid/view/Surface;)V
    ...
    invoke-static {v2}, Lcom/android/incallui/service/vt/VideoCallControl;->isAvailableVideoRx(Lcom/android/incallui/Call;)Z

    move-result v3

    iget-object v2, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mDisplaySurface:Lcom/android/incallui/fragment/VideoCallFragment$VideoCallSurface;
    ...
    invoke-static {v0}, Lcom/android/incallui/service/vt/VideoCallLog;->peer(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/incallui/VideoCallPresenter;->setDisplaySurface(Landroid/view/Surface;)V
...
.method public setPrimaryCall(Lcom/android/incallui/Call;)V
    ...
    sget-boolean v2, Lcom/android/incallui/service/vt/VideoCallConfig;->MULTITASKING_PIP_ENABLED:Z
    ...
    invoke-virtual {v2}, Lcom/android/incallui/service/vt/VideoCallManager;->isUiShowing()Z
    ...
    invoke-virtual {v2}, Lcom/android/incallui/service/vt/VideoCallManager;->isPipRunning()Z
    ...
    const-string v3, "VideoCallFragment - setPrimaryCall : PIP is running - "
    ...
    invoke-static {v2}, Lcom/android/incallui/service/vt/VideoCallLog;->flow(Ljava/lang/String;)V

    sget v2, Lcom/android/incallui/service/vt/SecVideoState;->VIDEO_NONE:I

    invoke-virtual {p0, v2}, Lcom/android/incallui/fragment/VideoCallFragment;->setSecVideoState(I)V
...
.method public setSwitchCameraAnimationView(Z)V
    ...
    iget-object v0, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mPreviewSwitchAnimationView:Landroid/view/View;
...
.method public setTransform(IFII)V
    .locals 1
    ...
    invoke-virtual {v0, p2, p3, p4}, Lcom/android/incallui/fragment/VideoCallFragment$VideoCallSurface;->setTransform(FII)V
...
.method public showFarEndCaptureAnimation()V
    ...
    iget-object v0, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mDisplayCaptureAnimatinoView:Landroid/view/View;
...
.method public showNearEndCaptureAnimation()V
    ...
    iget-object v0, p0, Lcom/android/incallui/fragment/VideoCallFragment;->mPreviewCaptureAnimatinoView:Landroid/view/View;
