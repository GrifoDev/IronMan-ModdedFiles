...
.method private voiceCallClicked(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/incallui/fragment/EndCallButtonFragment;->setEnabled(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/incallui/agif/AgifManager;->redial()V
    ...
    invoke-static {v1, p2, v4}, Landroid/net/Uri;->fromParts(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method public onClick(Landroid/view/View;)V
    ...
    :sswitch_0
    invoke-static {v3}, Lcom/android/incallui/util/CommonAppLogging;->endCall_voiceCallButton(Lcom/android/incallui/Call;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/incallui/fragment/EndCallButtonFragment;->setMultiNumberCall(IZ)V
    ...
    :sswitch_1
    invoke-static {v3}, Lcom/android/incallui/util/CommonAppLogging;->endCall_voiceCallSim1Button(Lcom/android/incallui/Call;)V
    ...
    :sswitch_2
    invoke-static {v3}, Lcom/android/incallui/util/CommonAppLogging;->endCall_voiceCallSim2Button(Lcom/android/incallui/Call;)V
    ...
    iget v1, p0, Lcom/android/incallui/fragment/EndCallButtonFragment;->SIM_SLOT_2:I
    ...
    :sswitch_3
    invoke-static {v3}, Lcom/android/incallui/util/CommonAppLogging;->endCall_videoCallButton(Lcom/android/incallui/Call;)V
    ...
    invoke-virtual {p0, v1, v3}, Lcom/android/incallui/fragment/EndCallButtonFragment;->getPhoneNumber(Landroid/content/Context;Lcom/android/incallui/Call;)Ljava/lang/String;
    ...
    const-string v3, "com.samsung.crane.addreason.LAUNCH"
    ...
    :cond_5
    sget-object v1, Lcom/android/incallui/secrcs/RcsShareUI;->mCallPlusSubject:Ljava/lang/String;
    ...
    const-string v3, "mCallPlusSubject= "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-object v3, Lcom/android/incallui/secrcs/RcsShareUI;->mCallPlusSubject:Ljava/lang/String;
    ...
    const-string v0, "callcomposer_subject"
    ...
    :sswitch_5
    invoke-static {v3}, Lcom/android/incallui/util/CommonAppLogging;->endCall_messageButton(Lcom/android/incallui/Call;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/incallui/fragment/EndCallButtonFragment;->setMultiNumberCall(IZ)V
    ...
    invoke-static {v3, v0}, Lcom/android/incallui/util/CommonAppLogging;->endCall_blockNumber(Lcom/android/incallui/Call;Z)V

    invoke-virtual {p0}, Lcom/android/incallui/fragment/EndCallButtonFragment;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0, v3}, Lcom/android/incallui/util/PackageHelpers;->spamBlockClicked(Landroid/content/Context;Lcom/android/incallui/Call;)V
    ...
    invoke-static {v3}, Lcom/android/incallui/util/CommonAppLogging;->endCall_reportNumber(Lcom/android/incallui/Call;)V

    invoke-virtual {p0}, Lcom/android/incallui/fragment/EndCallButtonFragment;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0, v3}, Lcom/android/incallui/util/PackageHelpers;->spamReportClicked(Landroid/content/Context;Lcom/android/incallui/Call;)V
    ...
    :sswitch_9
    const-string v2, "onClick add reminder"

    invoke-static {p0, v2}, Lcom/android/incallui/Log;->d(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v3}, Lcom/android/incallui/util/CommonAppLogging;->endCall_addReminder(Lcom/android/incallui/Call;)V

    if-eqz v3, :cond_8

    invoke-virtual {v3}, Lcom/android/incallui/Call;->isIncomingDirection()Z
    ...
    :sswitch_data_0
    .sparse-switch
        0x7f10016e -> :sswitch_1
        0x7f10016f -> :sswitch_2
        0x7f100170 -> :sswitch_6
        0x7f100171 -> :sswitch_3
        0x7f10021b -> :sswitch_4
        0x7f100243 -> :sswitch_0
        0x7f100244 -> :sswitch_5
        0x7f100245 -> :sswitch_3
        0x7f10030a -> :sswitch_7
        0x7f10030b -> :sswitch_8
        0x7f10030c -> :sswitch_9
    .end sparse-switch
.end method
...
.method protected updateEndCallButtons()V
    ...
    const-string v12, "updateEndCallButtons emergencyMode: "
    ...
    invoke-static {v10, v11, v1}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)V
