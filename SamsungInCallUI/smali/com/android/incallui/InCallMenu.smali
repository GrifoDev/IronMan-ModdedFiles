...
.field private static final TTY_HCO:I = 0x1

.field private static final TTY_VCO:I = 0x2
...
.method private checkAddCallMenu()Z
    ...
    invoke-virtual {v0}, Lcom/android/incallui/secrcs/RcsShareUI;->isVSHButtonAvailable()Z
...
.method private checkAddVoiceUserMenu()Z
    ...
    invoke-virtual {v4}, Lcom/android/incallui/Call;->isIncomingDirection()Z
...
.method private checkSwitchToVoiceCallEnabled()Z
    .locals 5
    ...
    const-string v3, " checkSwitchToVoiceCallEnabled"
    ...
    const-string v4, " checkSwitchToVoiceCallEnabled switchToVoiceCallEnabled: "
...
.method private manageRttMenu(Landroid/view/MenuItem;)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/incallui/CallList;->isConferenceCall(Lcom/android/incallui/Call;)Z
...
.method private manageSwitchToVoiceCallMenu(Landroid/view/MenuItem;)V
    ...
    invoke-direct {p0}, Lcom/android/incallui/InCallMenu;->checkSwitchToVoiceCallMenu()Z

    move-result v0

    invoke-interface {p1, v0}, Landroid/view/MenuItem;->setVisible(Z)Landroid/view/MenuItem;

    invoke-direct {p0}, Lcom/android/incallui/InCallMenu;->checkSwitchToVoiceCallEnabled()Z
...
.method public holdClicked(Z)V
    ...
    invoke-interface {v1}, Lcom/android/incallui/RTTUi;->updateRTTMessage()V
...
.method public optionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v4}, Lcom/android/incallui/UiAdapter;->getRTTPresenter()Lcom/android/incallui/RTTPresenter;
    ...
    invoke-virtual {v0, v6}, Lcom/android/incallui/CallButtonPresenter;->isAudio(I)Z
    ...
    invoke-virtual {v4, v1}, Lcom/android/incallui/RTTPresenter;->hideSoftInput(Z)V
    ...
    invoke-virtual {v4, v2}, Lcom/android/incallui/RTTPresenter;->hideSoftInput(Z)V
...
.method public prepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/incallui/InCallMenu;->manageRttMenu(Landroid/view/MenuItem;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/incallui/InCallMenu;->manageSwitchToVoiceCallMenu(Landroid/view/MenuItem;)V
