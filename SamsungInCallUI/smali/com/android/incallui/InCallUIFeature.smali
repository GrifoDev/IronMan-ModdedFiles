...
.field private static mFeatureList:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/incallui/InCallUIFeature;->mFeatureList:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static isRCVOnlyCSVT()Z
    .locals 3
...
.method public static makeFeature(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    sget-object v2, Lcom/android/incallui/InCallUIFeature;->mFeatureList:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static makeFeatureForCanada()V
    ...
    sget-object v8, Lcom/android/incallui/InCallUIFeature;->mFeatureList:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static makeFeatureForChina()V
    ...
    sget-object v5, Lcom/android/incallui/InCallUIFeature;->mFeatureList:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string v5, "crbt_video_cmcc"

    invoke-static {}, Lcom/samsung/android/feature/SemCscFeature;->getInstance()Lcom/samsung/android/feature/SemCscFeature;

    move-result-object v6

    const-string v7, "CscFeature_VoiceCall_ConfigOpStyleForImsFunction"

    invoke-virtual {v6, v7}, Lcom/samsung/android/feature/SemCscFeature;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    const-string v7, "crbt_video_cmcc"
    ...
    sget-object v3, Lcom/android/incallui/InCallUIFeature;->mFeatureList:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static makeFeatureForCommon()V
    ...
    sget-object v4, Lcom/android/incallui/InCallUIFeature;->mFeatureList:Ljava/util/concurrent/ConcurrentHashMap;

    const-string v5, "feature_org"
    ...
    invoke-static {v5}, Lcom/android/incallui/InCallUIFeature;->hasSystemFeature(Ljava/lang/String;)Z
    ...
    sget v3, Lcom/android/incallui/wrapper/InternalRWrapper$bool;->config_showNavigationBar:I
    ...
    const-string v3, "support_sticker_center"
    ...
    const-string v3, "support_sticker_download"
    ...
    const-string v3, "support_touch_dead_zone"

    const-string v4, "SEC_FLOATING_FEATURE_FRAMEWORK_SUPPORT_TSP_STATE_MANAGER"

    invoke-static {v4}, Lcom/android/incallui/InCallUIFeature$Floating;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public static makeFeatureForIndia()V
    ...
    :cond_3
    sget-object v6, Lcom/android/incallui/InCallUIFeature;->mFeatureList:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static makeFeatureForKor()V
    ...
    const-string v10, "CscFeature_Setting_ConfigOperatorCallService"
    ...
    const-string v8, "com.skt.tgroupon"

    invoke-static {v8}, Lcom/android/incallui/InCallUIFeature;->hasPackage(Ljava/lang/String;)Z
    ...
    sget-object v8, Lcom/android/incallui/InCallUIFeature;->opStyleForVolte:Ljava/lang/String;

    const-string v9, "KOR_"
    ...
    const-string v9, "CscFeature_IMS_SupportVolteDuringRoaming"
    ...
    const-string v9, "CscFeature_VoiceCall_SupportImsPsBarring"
    ...
    const-string v8, "government_request_project"
    ...
    const-string v8, "display_uhd_voice_icon"
    ...
    const-string v9, "CscFeature_VoiceCall_ConfigCnap"

    invoke-virtual {v8, v9}, Lcom/samsung/android/feature/SemCscFeature;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    const-string v9, "_CNAP"
    ...
    const-string v8, "CscFeature_VoiceCall_DisableGeoDescription"
    ...
    const-string v8, "CscFeature_VoiceCall_DisableNotiBarExpandDuringOta"
    ...
    const-string v0, "government_request_project"
    ...
    const-string v3, "smart_folder_concept"
...
.method public static makeFeatureForMassProject()V
    ...
    const-string v1, "inflate_fragments_immediately"
...
.method public static makeFeatureForUsa()V
    ...
    :cond_12
    sget-object v7, Lcom/android/incallui/InCallUIFeature;->mFeatureList:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string v4, "CscFeature_VoiceCall_SupportRTT"
    ...
    const-string v2, "CscFeature_VoiceCall_ConfigOpStyleForMvno"
    ...
    const-string v4, "CscFeature_VoiceCall_SupportHoldUiForVolte"
    ...
    const-string v2, "ims_only_conf_initiator_can_merge"
    ...
    const-string v2, "support_spr_svd"

    invoke-static {}, Lcom/samsung/android/feature/SemCscFeature;->getInstance()Lcom/samsung/android/feature/SemCscFeature;

    move-result-object v3

    const-string v4, "CscFeature_Contact_ConfigImsOpStyle"
    ...
    const-string v3, "PARTIAL_BRANDED"
    ...
    const-string v3, "CscFeature_VoiceCall_SupportImsConfSplit"
...
.method public static makeFeatureForVT()V
    ...
    const-string v2, "csvt_rcv_only"

    invoke-static {}, Lcom/android/incallui/InCallUIFeature;->isRCVOnlyCSVT()Z
...
.method public static supportAgifCallEnhancedService(Ljava/lang/String;)Z
    ...
    const-string v3, "getSupportEnhancedService"
    ...
    const-string v1, "extra_support_enhanced_service"
...
.method public static supportAgifCallService()Z
    ...
    const-string v3, "getSupportService"
    ...
    const-string v1, "extra_support_service"
