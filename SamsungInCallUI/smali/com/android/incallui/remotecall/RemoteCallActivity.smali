...
.method private updateGradientBackground(Lcom/android/incallui/remotecall/remotecall/RemoteCall;)V
    ...
    const-string v1, "updateGradientBackground: view is null"
    ...
    const-string v1, "updateGradientBackground: call is null"
    ...
    invoke-virtual {v0}, Lcom/android/incallui/widget/GradientAnimationView;->endHideAnimationImmediately()V
...
.method protected onStart()V
    ...
    invoke-virtual {v1}, Lcom/sec/ims/DialogEvent;->getDialogList()Ljava/util/List;
    ...
    invoke-virtual {v0, v1}, Lcom/android/incallui/remotecall/remotecall/RemoteCallList;->receiveRemoteCallData(Ljava/util/ArrayList;)V
...
.method public updateUI(Lcom/android/incallui/remotecall/remotecall/RemoteCallList;)V
    ...
    invoke-virtual {p0}, Lcom/android/incallui/remotecall/RemoteCallActivity;->isDestroyed()Z

    move-result v0

    if-eqz v0, :cond_1

    const-string v0, "updateUI : Activity has been destroyed"
