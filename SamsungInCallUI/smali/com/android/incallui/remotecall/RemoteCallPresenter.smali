...
.method private clear()V
    ...
    invoke-virtual {p0}, Lcom/android/incallui/remotecall/RemoteCallPresenter;->forceCancelStatusBarRemoteCall()V
...
.method private startUI()V
    ...
    :goto_0
    new-instance v0, Lcom/android/incallui/remotecall/RemoteCallStatusBarNotifier;

    iget-object v1, p0, Lcom/android/incallui/remotecall/RemoteCallPresenter;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/android/incallui/remotecall/RemoteCallStatusBarNotifier;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/incallui/remotecall/RemoteCallPresenter;->mRemoteCallStatusBarNotifier:Lcom/android/incallui/remotecall/RemoteCallStatusBarNotifier;

    iget-object v0, p0, Lcom/android/incallui/remotecall/RemoteCallPresenter;->mRemoteCallStatusBarNotifier:Lcom/android/incallui/remotecall/RemoteCallStatusBarNotifier;

    invoke-virtual {p0, v0}, Lcom/android/incallui/remotecall/RemoteCallPresenter;->addListener(Lcom/android/incallui/remotecall/RemoteCallPresenter$RemoteCallListener;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/incallui/remotecall/RemoteCallPresenter;->onNotifyRemoteCallStateChanged(Ljava/util/ArrayList;)V
...
.method public forceCancelStatusBarRemoteCall()V
    .locals 3

    const-string v0, "RemoteCallPresenter"

    const-string v1, "forceCancelStatusBarRemoteCall()..."

    const/4 v2, 0x1

    invoke-static {v0, v1, v2}, Lcom/android/incallui/remotecall/utils/Log;->i(Ljava/lang/String;Ljava/lang/String;Z)V

    iget-object v0, p0, Lcom/android/incallui/remotecall/RemoteCallPresenter;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v0}, Lcom/android/incallui/remotecall/RemoteCallStatusBarNotifier;->forceCancelRemoteCall()V
...
.method public launchDialer()V
    ...
    invoke-static {p0, v1, v0}, Lcom/android/incallui/remotecall/utils/Log;->e(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public requestPulling()Z
    ...
    const-string v3, "requestPulling"

    invoke-static {v0, v3, v2}, Lcom/android/incallui/remotecall/utils/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v3, "requestPulling, RemoteCall is null"
    ...
    invoke-virtual {p0}, Lcom/android/incallui/remotecall/RemoteCallPresenter;->init()V
    ...
    const-string v3, "requestPulling, mRemoteCallManager is null"
    ...
    iget-object v3, p0, Lcom/android/incallui/remotecall/RemoteCallPresenter;->mRemoteCallManager:Lcom/android/incallui/remotecall/data/IRemoteCallManager;

    invoke-interface {v3}, Lcom/android/incallui/remotecall/data/IRemoteCallManager;->getRemoteCallAdapterList()Ljava/util/ArrayList;

    move-result-object v3

    invoke-interface {v0, v3}, Lcom/android/incallui/remotecall/data/IRemoteCallManager;->onNotifyRemoteCallStateChanged(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/incallui/remotecall/remotecall/RemoteCallList;->receiveRemoteCallData(Ljava/util/ArrayList;)V
    ...
    const-string v3, "requestPulling, call is null again"
    ...
    invoke-direct {v0, v2}, Lcom/android/incallui/remotecall/RemoteCallStatusBarNotifier;-><init>(Landroid/content/Context;)V
    ...
    const-string v3, "requestPulling, isPullAvailable() is false"
