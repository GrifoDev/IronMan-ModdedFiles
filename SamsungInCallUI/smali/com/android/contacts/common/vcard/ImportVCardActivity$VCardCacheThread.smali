...
.field private d:Lcom/android/b/k;
...
.method private a([BLandroid/net/Uri;Ljava/lang/String;)Lcom/android/contacts/common/vcard/ImportRequest;
    ...
    :goto_0
    new-instance v1, Lcom/android/b/o;

    invoke-direct {v1}, Lcom/android/b/o;-><init>()V

    iput-object v1, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;
    :try_end_0
    .catch Lcom/android/b/a/e; {:try_start_0 .. :try_end_0} :catch_7

    :try_start_1
    new-instance v3, Lcom/android/b/h;

    invoke-direct {v3}, Lcom/android/b/h;-><init>()V
    :try_end_1
    .catch Lcom/android/b/a/g; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    :try_start_2
    new-instance v1, Lcom/android/b/t;

    invoke-direct {v1}, Lcom/android/b/t;-><init>()V
    :try_end_2
    .catch Lcom/android/b/a/g; {:try_start_2 .. :try_end_2} :catch_c
    .catchall {:try_start_2 .. :try_end_2} :catchall_2

    :try_start_3
    iget-object v2, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;

    invoke-virtual {v2, v3}, Lcom/android/b/k;->a(Lcom/android/b/j;)V

    iget-object v2, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;

    invoke-virtual {v2, v1}, Lcom/android/b/k;->a(Lcom/android/b/j;)V

    iget-object v2, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;

    invoke-virtual {v2, v4}, Lcom/android/b/k;->a(Ljava/io/InputStream;)V
    :try_end_3
    .catch Lcom/android/b/a/g; {:try_start_3 .. :try_end_3} :catch_d
    ...
    .catch Lcom/android/b/a/e; {:try_start_4 .. :try_end_4} :catch_8
    ...
    invoke-virtual {v2}, Lcom/android/b/t;->c()I

    move-result v5

    invoke-virtual {v2}, Lcom/android/b/t;->f()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v3}, Lcom/android/b/h;->c()I
    ...
    :try_end_5
    .catch Lcom/android/b/a/e; {:try_start_5 .. :try_end_5} :catch_7
    ...
    :goto_5
    new-instance v3, Lcom/android/b/p;

    invoke-direct {v3}, Lcom/android/b/p;-><init>()V

    iput-object v3, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;
    :try_end_7
    ...
    invoke-direct {v3}, Lcom/android/b/h;-><init>()V
    :try_end_8
    .catch Lcom/android/b/a/g; {:try_start_8 .. :try_end_8} :catch_2
    .catchall {:try_start_8 .. :try_end_8} :catchall_4

    :try_start_9
    new-instance v2, Lcom/android/b/t;

    invoke-direct {v2}, Lcom/android/b/t;-><init>()V
    :try_end_9
    .catch Lcom/android/b/a/g; {:try_start_9 .. :try_end_9} :catch_a
    .catchall {:try_start_9 .. :try_end_9} :catchall_5

    :try_start_a
    iget-object v1, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;

    invoke-virtual {v1, v3}, Lcom/android/b/k;->a(Lcom/android/b/j;)V

    iget-object v1, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;

    invoke-virtual {v1, v2}, Lcom/android/b/k;->a(Lcom/android/b/j;)V

    iget-object v1, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;

    invoke-virtual {v1, v4}, Lcom/android/b/k;->a(Ljava/io/InputStream;)V
    :try_end_a
    .catch Lcom/android/b/a/g; {:try_start_a .. :try_end_a} :catch_b
    ...
    .catch Lcom/android/b/a/e; {:try_start_b .. :try_end_b} :catch_9
    ...
    :goto_6
    :try_start_d
    new-instance v3, Lcom/android/b/a/b;

    const-string v5, "vCard with unspported version."

    invoke-direct {v3, v5}, Lcom/android/b/a/b;-><init>(Ljava/lang/String;)V
    ...
    .catch Lcom/android/b/a/e; {:try_start_e .. :try_end_e} :catch_3
    ...
    throw v1
    :try_end_f
    .catch Lcom/android/b/a/e; {:try_start_f .. :try_end_f} :catch_3
...
.method public b()V
    ...
    iget-object v0, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/contacts/common/vcard/ImportVCardActivity$VCardCacheThread;->d:Lcom/android/b/k;

    invoke-virtual {v0}, Lcom/android/b/k;->a()V
...
.method public run()V
    ...
    :try_end_2
    .catch Lcom/android/b/a/b; {:try_start_2 .. :try_end_2} :catch_0
    ...
    :try_end_8
    .catch Lcom/android/b/a/b; {:try_start_8 .. :try_end_8} :catch_2
