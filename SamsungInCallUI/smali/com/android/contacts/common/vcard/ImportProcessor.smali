...
.field private g:Lcom/android/b/k;
...
.method private a(Ljava/io/InputStream;ILjava/lang/String;Lcom/android/b/j;[I)Z
    .locals 8
    ...
    :try_start_0
    instance-of v1, p4, Lcom/android/b/g;

    if-eqz v1, :cond_0

    move-object v0, p4

    check-cast v0, Lcom/android/b/g;

    move-object v1, v0

    invoke-virtual {v1}, Lcom/android/b/g;->c()V

    :cond_0
    monitor-enter p0
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Lcom/android/b/a/e; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lcom/android/b/a/f; {:try_start_0 .. :try_end_0} :catch_3
    .catch Lcom/android/b/a/g; {:try_start_0 .. :try_end_0} :catch_5
    .catch Lcom/android/b/a/b; {:try_start_0 .. :try_end_0} :catch_7
    ...
    :try_start_1
    new-instance v1, Lcom/android/b/p;

    invoke-direct {v1, p2}, Lcom/android/b/p;-><init>(I)V

    :goto_1
    iput-object v1, p0, Lcom/android/contacts/common/vcard/ImportProcessor;->g:Lcom/android/b/k;
    ...
    iget-object v1, p0, Lcom/android/contacts/common/vcard/ImportProcessor;->g:Lcom/android/b/k;

    invoke-virtual {v1}, Lcom/android/b/k;->a()V
    ...
    invoke-virtual {v1, p1, p4}, Lcom/android/b/k;->a(Ljava/io/InputStream;Lcom/android/b/j;)V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
    .catch Lcom/android/b/a/e; {:try_start_2 .. :try_end_2} :catch_1
    .catch Lcom/android/b/a/f; {:try_start_2 .. :try_end_2} :catch_3
    .catch Lcom/android/b/a/g; {:try_start_2 .. :try_end_2} :catch_5
    .catch Lcom/android/b/a/b; {:try_start_2 .. :try_end_2} :catch_7
    ...
    invoke-direct {v1, p2}, Lcom/android/b/o;-><init>(I)V
    ...
    .catch Lcom/android/b/a/e; {:try_start_5 .. :try_end_5} :catch_1
    .catch Lcom/android/b/a/f; {:try_start_5 .. :try_end_5} :catch_3
    .catch Lcom/android/b/a/g; {:try_start_5 .. :try_end_5} :catch_5
    .catch Lcom/android/b/a/b; {:try_start_5 .. :try_end_5} :catch_7
    ...
    invoke-virtual {v1}, Lcom/android/b/a/f;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/b/a/b;->toString()Ljava/lang/String;
...
.method private d()V
    ...
    new-instance v4, Lcom/android/b/g;

    invoke-direct {v4, v2, v1, v3}, Lcom/android/b/g;-><init>(ILandroid/accounts/Account;Ljava/lang/String;)V

    new-instance v9, Lcom/android/b/f;

    iget-object v1, p0, Lcom/android/contacts/common/vcard/ImportProcessor;->b:Landroid/content/ContentResolver;

    invoke-direct {v9, v1}, Lcom/android/b/f;-><init>(Landroid/content/ContentResolver;)V

    invoke-virtual {v4, v9}, Lcom/android/b/g;->a(Lcom/android/b/i;)V

    invoke-virtual {v4, p0}, Lcom/android/b/g;->a(Lcom/android/b/i;)V
    ...
    :try_start_1
    invoke-direct/range {v0 .. v5}, Lcom/android/contacts/common/vcard/ImportProcessor;->a(Ljava/io/InputStream;ILjava/lang/String;Lcom/android/b/j;[I)Z
    :try_end_1
    ...
    invoke-virtual {v9}, Lcom/android/b/f;->a()Ljava/util/ArrayList;
...
.method public a(Lcom/android/b/e;)V
    ...
    invoke-interface/range {v0 .. v5}, Lcom/android/contacts/common/vcard/VCardImportExportListener;->a(Lcom/android/contacts/common/vcard/ImportRequest;ILcom/android/b/e;II)V
