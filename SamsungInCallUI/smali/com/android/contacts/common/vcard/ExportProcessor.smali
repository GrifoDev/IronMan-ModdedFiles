...
.method private c()V
    ...
    invoke-virtual {v2}, Lcom/android/b/c;->b()V
    ...
    invoke-static {v0}, Lcom/android/b/d;->a(Ljava/lang/String;)I
    ...
    invoke-direct {v0, v4, v1, v5}, Lcom/android/b/c;-><init>(Landroid/content/Context;IZ)V
    :try_end_4
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/b/c;->a(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Z

    move-result v1

    if-nez v1, :cond_8

    invoke-virtual {v0}, Lcom/android/b/c;->e()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/b/c;->b()V
    ...
    :cond_8
    :try_start_b
    invoke-virtual {v0}, Lcom/android/b/c;->c()I
    ...
    :goto_6
    :try_start_d
    invoke-virtual {v0}, Lcom/android/b/c;->d()Z
    ...
    :cond_e
    :try_start_f
    invoke-virtual {v0}, Lcom/android/b/c;->a()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/android/b/c;->b()V
