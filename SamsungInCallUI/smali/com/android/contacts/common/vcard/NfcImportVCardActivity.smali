...
.method a()Lcom/android/contacts/common/vcard/ImportRequest;
    ...
    new-instance v4, Lcom/android/b/o;

    invoke-direct {v4}, Lcom/android/b/o;-><init>()V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_4
    .catch Lcom/android/b/a/e; {:try_start_0 .. :try_end_0} :catch_5
    .catch Lcom/android/b/a/b; {:try_start_0 .. :try_end_0} :catch_6

    :try_start_1
    new-instance v2, Lcom/android/b/h;

    invoke-direct {v2}, Lcom/android/b/h;-><init>()V
    :try_end_1
    .catch Lcom/android/b/a/g; {:try_start_1 .. :try_end_1} :catch_0
    ...
    :try_end_2
    .catch Lcom/android/b/a/g; {:try_start_2 .. :try_end_2} :catch_e
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-virtual {v4, v2}, Lcom/android/b/k;->a(Lcom/android/b/j;)V

    invoke-virtual {v4, v1}, Lcom/android/b/k;->a(Lcom/android/b/j;)V

    invoke-virtual {v4, v5}, Lcom/android/b/k;->a(Ljava/io/InputStream;)V
    :try_end_3
    .catch Lcom/android/b/a/g; {:try_start_3 .. :try_end_3} :catch_f
    ...
    .catch Lcom/android/b/a/e; {:try_start_4 .. :try_end_4} :catch_9
    .catch Lcom/android/b/a/b; {:try_start_4 .. :try_end_4} :catch_6
    ...
    invoke-virtual {v6}, Lcom/android/b/t;->c()I

    move-result v5

    invoke-virtual {v6}, Lcom/android/b/t;->f()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v8}, Lcom/android/b/h;->c()I
    ...
    new-instance v6, Lcom/android/b/p;

    invoke-direct {v6}, Lcom/android/b/p;-><init>()V
    :try_end_5
    ...
    invoke-direct {v2}, Lcom/android/b/h;-><init>()V
    :try_end_6
    .catch Lcom/android/b/a/g; {:try_start_6 .. :try_end_6} :catch_2
    ...
    invoke-direct {v1}, Lcom/android/b/t;-><init>()V
    :try_end_7
    .catch Lcom/android/b/a/g; {:try_start_7 .. :try_end_7} :catch_c
    .catchall {:try_start_7 .. :try_end_7} :catchall_4

    :try_start_8
    invoke-virtual {v6, v2}, Lcom/android/b/k;->a(Lcom/android/b/j;)V

    invoke-virtual {v6, v1}, Lcom/android/b/k;->a(Lcom/android/b/j;)V

    invoke-virtual {v6, v5}, Lcom/android/b/k;->a(Ljava/io/InputStream;)V
    :try_end_8
    .catch Lcom/android/b/a/g; {:try_start_8 .. :try_end_8} :catch_d
    ...
    .catch Lcom/android/b/a/e; {:try_start_9 .. :try_end_9} :catch_9
    .catch Lcom/android/b/a/b; {:try_start_9 .. :try_end_9} :catch_6
    ...
    .catch Lcom/android/b/a/e; {:try_start_a .. :try_end_a} :catch_a
    .catch Lcom/android/b/a/b; {:try_start_a .. :try_end_a} :catch_6
    ...
    .catch Lcom/android/b/a/e; {:try_start_b .. :try_end_b} :catch_b
    .catch Lcom/android/b/a/b; {:try_start_b .. :try_end_b} :catch_6
    ...
    .catch Lcom/android/b/a/e; {:try_start_c .. :try_end_c} :catch_b
    .catch Lcom/android/b/a/b; {:try_start_c .. :try_end_c} :catch_6
...
.method public a(Lcom/android/contacts/common/vcard/ImportRequest;ILcom/android/b/e;II)V
    .locals 0
