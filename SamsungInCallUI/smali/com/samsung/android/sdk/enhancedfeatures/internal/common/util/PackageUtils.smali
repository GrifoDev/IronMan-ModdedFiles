...
# static fields
.field private static final BOOT_RECEIVER:Ljava/lang/String; = "com.samsung.android.sdk.enhancedfeatures.easysignup.internal.receiver.BootReceiver"
...
.field public static final DCM_CONTACT_PACKAGE_NAME:Ljava/lang/String; = "com.samsung.contacts"

.field private static final NETWORK_STATE_LISTENER:Ljava/lang/String; = "com.samsung.android.sdk.enhancedfeatures.easysignup.internal.receiver.NetworkStateListener"

.field public static final SERVICE_ICON:Ljava/lang/String; = "coreapps_service_icon"

.field public static final SERVICE_NAME:Ljava/lang/String; = "coreapps_service_name"
...
.method public static disableBootReceiverComponent(Landroid/content/Context;)V
    ...
    :try_start_0
    const-string v0, "com.samsung.android.sdk.enhancedfeatures.easysignup.internal.receiver.BootReceiver"

    invoke-static {v0}, Ljava/lang/Class;->forName(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v0

    invoke-static {v0, p0}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/PackageUtils;->disableComponent(Ljava/lang/Class;Landroid/content/Context;)V
    :try_end_0
...
.method private static disableComponent(Ljava/lang/Class;Landroid/content/Context;)V
    ...
    const-string v1, "disable component "
    ...
    sget-object v1, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/PackageUtils;->TAG:Ljava/lang/String;
...
.method public static disableComponents(Landroid/content/Context;)V
    ...
    :try_start_0
    const-string v0, "com.samsung.android.sdk.enhancedfeatures.easysignup.internal.receiver.NetworkStateListener"
...
.method public static enableBootReceiverComponent(Landroid/content/Context;)V
    ...
    invoke-static {v0, p0}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/PackageUtils;->enableComponent(Ljava/lang/Class;Landroid/content/Context;)V
    :try_end_0
    .catch Ljava/lang/ClassNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static enableComponent(Ljava/lang/Class;Landroid/content/Context;)V
    ...
    const-string v1, "enable component "
...
.method public static getAppMajorMinorVersionName()Ljava/lang/String;
    .locals 5
    ...
    sget-object v2, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/PackageUtils;->mContext:Landroid/content/Context;

    if-nez v2, :cond_0

    const-string v1, "getAppVersion. Invalid Context."
    ...
    const-string v2, "getAppVersion. return "
...
.method public static getAppName()Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/PackageUtils;->TAG:Ljava/lang/String;

    const-string v1, "Failed to obtain app info!"
    ...
    const-string v3, "Excepiton occurs. "
    ...
    invoke-static {v1, v0}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SDKLog;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static getAppNameInEnglish()Ljava/lang/String;
    ...
    const-string v5, "Current language: "
    ...
    invoke-static {v3, v0}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SDKLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "English app label is "
    ...
    const-string v2, "Failed to obtain app info!"
    ...
    invoke-static {v2, v1}, Lcom/samsung/android/sdk/enhancedfeatures/internal/common/util/SDKLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "Excepiton occurs. "
...
.method public static getAppPackageName()Ljava/lang/String;
    ...
    const-string v1, "getAppPackageName. Invalid Context."
    ...
    const-string v2, "getAppPackageName. return "
...
.method public static getAppVersionCode(Landroid/content/Context;Ljava/lang/String;)I
    ...
    const-string v2, "getAppVersionCode. return "
...
.method public static getAppVersionName()Ljava/lang/String;
    ...
    const-string v1, "getAppVersionName. Invalid Context."
...
.method public static getSDKServiceAppInfo(I)Landroid/content/pm/ApplicationInfo;
    .locals 4
    ...
    const-string v3, "com.samsung.android.enhancedfeatures.sdk.service"
...
.method public static getSDKServiceList()Ljava/util/HashMap;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v5, "com.samsung.android.enhancedfeatures.sdk.service"
    ...
    const-string v3, "SDK service list : "
...
.method public static getServiceId(Landroid/content/Context;)I
    ...
    const-string v2, "com.samsung.android.enhancedfeatures.sdk.service"
...
.method public static getServiceList()Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v3, "com.samsung.android.coreapps.service"
    ...
    const-string v2, "enhancedfeatures service list : "
...
.method public static isAppEnabled(Ljava/lang/String;)Z
    .locals 4
    ...
    const-string v1, "isAppEnabled. Invalid Context."
    ...
    const-string v2, "isAppEnabled. return "
...
.method public static isGooglePlayServicesAvailable()Z
    ...
    const-string v1, "isGooglePlayServicesAvailable. Invalid Context."
    ...
    :cond_1
    invoke-static {v1}, Lcom/google/android/gms/common/c;->a(I)Z

    move-result v1

    if-eqz v1, :cond_2

    const-string v1, "isGooglePlayServicesAvailable. Please update Google Play Service manually!"
    ...
    :cond_2
    const-string v1, "isGooglePlayServicesAvailable. This device is not supported."
...
.method public static readDrawable(Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    .locals 4
    ...
    :try_start_0
    invoke-virtual {v1, p0}, Landroid/content/pm/PackageManager;->getResourcesForApplication(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/Resources;
...
.method public static readString(Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)Ljava/lang/String;
    .locals 4
