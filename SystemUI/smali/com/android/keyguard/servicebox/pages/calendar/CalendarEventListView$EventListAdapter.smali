...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v4, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarEventListView$EventListAdapter;->this$0:Lcom/android/keyguard/servicebox/pages/calendar/CalendarEventListView;

    invoke-static {v4}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarEventListView;->-get2(Lcom/android/keyguard/servicebox/pages/calendar/CalendarEventListView;)I
    ...
    invoke-static {v4}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarEventListView;->-get1(Lcom/android/keyguard/servicebox/pages/calendar/CalendarEventListView;)Landroid/view/LayoutInflater;

    move-result-object v4

    sget v5, Lcom/android/keyguard/R$layout;->servicebox_today_event_item_small:I
    ...
    sget v4, Lcom/android/keyguard/R$id;->servicebox_today_event_time:I
    ...
    sget v4, Lcom/android/keyguard/R$id;->servicebox_today_event_title:I
    ...
    sget v4, Lcom/android/keyguard/R$id;->servicebox_today_event_dot:I

    invoke-virtual {p2, v4}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v0

    iget-object v4, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarEventListView$EventListAdapter;->mEventList:Ljava/util/ArrayList;
    ...
    invoke-virtual {v4}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarEventListView;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-virtual {v1, v4}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;->getFormattedStartTime(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v4}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;->getFormattedTitle(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget v5, Lcom/android/keyguard/R$layout;->servicebox_today_event_item_big:I
    ...
    invoke-virtual {v1, v4}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;->getFormattedStartEndTime(Landroid/content/Context;)Ljava/lang/String;
