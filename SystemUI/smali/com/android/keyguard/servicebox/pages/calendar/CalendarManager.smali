...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager$7;,
        Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager$8;,
        Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager$9;,
...
.field protected mCalendarDataService:Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataServiceWrapper;
...
.method static synthetic -wrap0(Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;JJJ)Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;
    .locals 1

    invoke-direct/range {p0 .. p6}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->getEventsFromCalendar(JJJ)Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;
...
.method static synthetic -wrap1(Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;JJ)Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;
    .locals 1

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->getTasksFromCalendar(JJ)Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;
...
.method static synthetic -wrap6(Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;)V
    ...
    invoke-direct {p0}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->sendDataToExternal()V

    return-void
.end method

.method static synthetic -wrap7(Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;)V
    .locals 0
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput v3, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCurrentUserId:I
    ...
    iput-object v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCalendarDataConnection:Landroid/content/ServiceConnection;
    ...
    invoke-virtual {p0, v1}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->controlCalendarDataServiceConnection(I)V

    return-void
.end method

.method private getEventsFromCalendar(JJJ)Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;
    .locals 17
    ...
    sget-object v7, Lcom/android/keyguard/servicebox/pages/calendar/CalendarEvent;->TABLE_PROJECTION:[Ljava/lang/String;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->query(ILandroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->getHideContactsEvents()Z
    ...
    invoke-virtual {v15, v13}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;->addAll(Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;)V

    invoke-virtual {v15, v11}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;->addAll(Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;)V

    move-wide/from16 v0, p1

    move-wide/from16 v2, p3

    invoke-virtual {v15, v0, v1, v2, v3}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;->resetTimeForDay(JJ)V

    invoke-virtual {v15}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;->sort()V
...
.method private getNextEndEvent(Ljava/util/ArrayList;)Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;
    ...
    check-cast v2, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;

    invoke-direct {p0, v2}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->isValidEndTime(Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;)Z

    move-result v7

    if-eqz v7, :cond_2

    iget-wide v8, v2, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;->endTime:J
    ...
    iget-wide v4, v2, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;->endTime:J
    ...
    invoke-virtual {v6}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;->toString()Ljava/lang/String;
...
.method private getTasksFromCalendar(JJ)Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;
    .locals 7
    ...
    sget-object v3, Lcom/android/keyguard/servicebox/pages/calendar/CalendarTask;->TABLE_PROJECTION:[Ljava/lang/String;

    move-object v0, p0

    invoke-direct/range {v0 .. v6}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->query(ILandroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;
...
.method private isValidEndTime(Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;)Z
    .locals 5
    ...
    iget-wide v0, p1, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;->endTime:J
...
.method private query(ILandroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataContainer;
    .locals 11
...
.method private registerReceivers()V
    ...
    iget-object v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCalendarChangeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCalendarSettingChangeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mTimeTickReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mSettingsListener:Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;

    sget-object v2, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->SETTINGS_VALUE_LISTENER_LIST:[Landroid/net/Uri;
    ...
    iget-object v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mKeyguardUpdateCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;

    invoke-virtual {v0, v1}, Lcom/android/keyguard/KeyguardUpdateMonitor;->registerCallback(Lcom/android/keyguard/KeyguardUpdateMonitorCallback;)V

    iget-object v0, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mEventChangedListener:Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager$EventChangedListener;

    invoke-virtual {p0, v0}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->addEventChangedListener(Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager$EventChangedListener;)V
...
.method private removeEndedEvents(Ljava/util/ArrayList;)V
    ...
    check-cast v5, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;

    iget-wide v2, v5, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;->endTime:J
    ...
    iget-boolean v5, v5, Lcom/android/keyguard/servicebox/pages/calendar/CalendarData;->isAllDay:Z
...
.method public addEventChangedListener(Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager$EventChangedListener;)V
    ...
    iget-object v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mDataList:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mDataList:Ljava/util/ArrayList;
...
.method public bindCalendarDataService()V
    ...
    iget-boolean v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mIsCalendarDataServiceBound:Z
    ...
    iget-object v3, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCalendarDataConnection:Landroid/content/ServiceConnection;

    iget v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCurrentUserId:I
    ...
    iput-boolean v5, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mIsCalendarDataServiceBound:Z
    ...
    iget v4, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCurrentUserId:I
    ...
    :cond_1
    iput-boolean v6, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mIsCalendarDataServiceBound:Z
...
.method public controlCalendarDataServiceConnection(I)V
    ...
    iput p1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCurrentUserId:I

    if-nez p1, :cond_0

    invoke-virtual {p0}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->unbindCalendarDataService()V

    :goto_0
    return-void

    :cond_0
    invoke-virtual {p0}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->bindCalendarDataService()V
...
.method public loadTodayEvents(Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager$LoadEventListCompletedListener;)V
    ...
    invoke-direct {v0, v4, v5}, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->roundDownMillis(J)J
...
.method public notifyEventChanged()V
    ...
    iget-object v2, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mDataList:Ljava/util/ArrayList;
...
.method public declared-synchronized unbindCalendarDataService()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mIsCalendarDataServiceBound:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mContext:Landroid/content/Context;

    iget-object v1, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCalendarDataConnection:Landroid/content/ServiceConnection;

    invoke-virtual {v0, v1}, Landroid/content/Context;->unbindService(Landroid/content/ServiceConnection;)V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mIsCalendarDataServiceBound:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/keyguard/servicebox/pages/calendar/CalendarManager;->mCalendarDataService:Lcom/android/keyguard/servicebox/pages/calendar/CalendarDataServiceWrapper;
