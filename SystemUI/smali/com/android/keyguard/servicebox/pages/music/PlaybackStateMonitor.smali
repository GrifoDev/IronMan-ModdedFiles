...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$1;,
        Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$ObserveSessionCallback;,
...
# direct methods
.method static synthetic -get0(Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mIsStarted:Z
...
.method static synthetic -get1()Ljava/lang/Object;
    ...
    sget-object v0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mLock:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic -get2(Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;)Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$OnPlaybackStateChangedListener;
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;)V
    .locals 0
...
.method static synthetic -wrap1(Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mSessionCb:Landroid/media/session/MediaController$Callback;

    new-instance v0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$ObserveSessionCallback;

    invoke-direct {v0, p0, v1}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$ObserveSessionCallback;-><init>(Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$ObserveSessionCallback;)V

    iput-object v0, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mObserverCb:Landroid/media/session/MediaController$Callback;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mObserverControllerList:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mBlackListSet:Ljava/util/Set;

    iput-object v1, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mOnPlaybackStateChangedListener:Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$OnPlaybackStateChangedListener;

    iput-object v1, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mActiveSessionPkgName:Ljava/lang/String;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mIsStarted:Z

    new-instance v0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$1;

    invoke-direct {v0, p0}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$1;-><init>(Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;)V

    iput-object v0, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    iget-object v1, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
...
.method private observeNonMetadataSessions(Ljava/util/List;)V
    ...
    iget-object v3, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mObserverControllerList:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mObserverCb:Landroid/media/session/MediaController$Callback;
    ...
    iget-object v2, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mObserverControllerList:Ljava/util/ArrayList;
...
.method private sendCurrentState()V
    ...
    invoke-virtual {p0}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->getCurrentSessionPackageName()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$OnPlaybackStateChangedListener;->onSessionChanged(Ljava/lang/String;)V

    iget-object v2, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mOnPlaybackStateChangedListener:Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$OnPlaybackStateChangedListener;

    iget-object v3, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mMediaController:Landroid/media/session/MediaController;

    invoke-virtual {v3}, Landroid/media/session/MediaController;->getPlaybackState()Landroid/media/session/PlaybackState;

    move-result-object v3

    invoke-interface {v2, v3}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$OnPlaybackStateChangedListener;->onPlaybackStateChanged(Landroid/media/session/PlaybackState;)V
    ...
    invoke-interface {v2, v3}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$OnPlaybackStateChangedListener;->onMetadataChanged(Landroid/media/MediaMetadata;)V
    ...
    iget-object v3, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mActiveSessionPkgName:Ljava/lang/String;

    if-nez v3, :cond_3

    :cond_2
    :goto_0
    invoke-interface {v2, v1}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$OnPlaybackStateChangedListener;->onSessionEnabled(Z)V
    ...
    invoke-interface {v1, v4}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$OnPlaybackStateChangedListener;->onPendingIntentChanged(Landroid/app/PendingIntent;)V
...
.method private start()V
    ...
    iget-boolean v1, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mIsStarted:Z
    ...
    iput-boolean v1, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mIsStarted:Z
    ...
    invoke-virtual {p0}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->loadBlackList()V

    invoke-virtual {p0}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->updateSessions()V
...
.method private updateController(Landroid/media/session/MediaController;)V
    ...
    iget-object v0, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mActiveSessionPkgName:Ljava/lang/String;
    ...
    :goto_0
    invoke-interface {v2, v0}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor$OnPlaybackStateChangedListener;->onSessionEnabled(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v0, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mObserverControllerList:Ljava/util/ArrayList;
...
.method public isBlackList(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mBlackListSet:Ljava/util/Set;
...
.method public loadBlackList()V
    ...
    iget-object v4, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mBlackListSet:Ljava/util/Set;

    invoke-interface {v4}, Ljava/util/Set;->clear()V

    iget-object v4, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v4}, Lcom/android/keyguard/util/SettingsHelper;->getServiceBoxBlackList()Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mBlackListSet:Ljava/util/Set;
...
.method public onActiveSessionsChanged(Ljava/util/List;)V
    ...
    invoke-direct {v0, v2}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->getControllerInfo(Landroid/media/session/MediaController;)Ljava/lang/String;
    ...
    :cond_0
    invoke-direct/range {p0 .. p0}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->releaseAllObservers()V
    ...
    iput-object v14, v0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mActiveSessionPkgName:Ljava/lang/String;
    ...
    invoke-direct {v0, v14}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->updateController(Landroid/media/session/MediaController;)V
    ...
    iget-object v14, v0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mContext:Landroid/content/Context;

    invoke-static {v14}, Lcom/android/keyguard/servicebox/pages/music/MusicController;->getInstance(Landroid/content/Context;)Lcom/android/keyguard/servicebox/pages/music/MusicController;

    move-result-object v14

    invoke-virtual {v14}, Lcom/android/keyguard/servicebox/pages/music/MusicController;->getLastSavedSessionPackageName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v14}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->isBlackList(Ljava/lang/String;)Z
    ...
    iget-object v14, v0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mMediaController:Landroid/media/session/MediaController;
    ...
    iget-object v15, v0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mMediaController:Landroid/media/session/MediaController;
    ...
    invoke-direct {v0, v2}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->updateController(Landroid/media/session/MediaController;)V
    ...
    :cond_a
    invoke-direct/range {p0 .. p1}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->observeNonMetadataSessions(Ljava/util/List;)V
    ...
    iget-object v0, v0, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->mMediaController:Landroid/media/session/MediaController;
    ...
    invoke-direct {v0, v1}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->getControllerInfo(Landroid/media/session/MediaController;)Ljava/lang/String;
    ...
    invoke-direct {v0, v13}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->getControllerInfo(Landroid/media/session/MediaController;)Ljava/lang/String;
    ...
    invoke-direct {v0, v13}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->updateController(Landroid/media/session/MediaController;)V
    ...
    invoke-direct {v0, v8}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->getControllerInfo(Landroid/media/session/MediaController;)Ljava/lang/String;
    ...
    invoke-direct {v0, v8}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->updateController(Landroid/media/session/MediaController;)V
...
.method public updateSessions()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/keyguard/servicebox/pages/music/PlaybackStateMonitor;->onActiveSessionsChanged(Ljava/util/List;)V
