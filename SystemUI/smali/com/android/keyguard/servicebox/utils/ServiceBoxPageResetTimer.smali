...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v2, p0, Lcom/android/keyguard/servicebox/utils/ServiceBoxPageResetTimer;->mIsMusicActivated:Z
...
.method private cancelTimer()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/keyguard/servicebox/utils/ServiceBoxPageResetTimer;->hasMessages(I)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, v3}, Lcom/android/keyguard/servicebox/utils/ServiceBoxPageResetTimer;->removeMessages(I)V
...
.method private startTimer()V
    ...
    invoke-virtual {p0, v3, v0, v1}, Lcom/android/keyguard/servicebox/utils/ServiceBoxPageResetTimer;->sendEmptyMessageDelayed(IJ)Z
...
.method private updateTimer()V
    ...
    iget-boolean v0, p0, Lcom/android/keyguard/servicebox/utils/ServiceBoxPageResetTimer;->mIsMusicActivated:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v1, p0, Lcom/android/keyguard/servicebox/utils/ServiceBoxPageResetTimer;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/android/keyguard/util/SettingsHelper;->getInstance(Landroid/content/Context;)Lcom/android/keyguard/util/SettingsHelper;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/keyguard/util/SettingsHelper;->isEnabledServiceBoxMusicPage()Z
    ...
    invoke-static {v1}, Lcom/android/keyguard/servicebox/pages/music/MusicController;->getInstance(Landroid/content/Context;)Lcom/android/keyguard/servicebox/pages/music/MusicController;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/keyguard/servicebox/pages/music/MusicController;->isMusicPlaying()Z

    move-result v0

    :goto_0
    sget-object v1, Lcom/android/keyguard/servicebox/utils/ServiceBoxPageResetTimer;->TAG:Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {v2, v1}, Lcom/android/keyguard/util/SettingsHelper;->setServiceBoxSharePageName(Ljava/lang/String;)V
...
.method public setMusicActivated(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/keyguard/servicebox/utils/ServiceBoxPageResetTimer;->mIsMusicActivated:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lcom/android/keyguard/servicebox/utils/ServiceBoxPageResetTimer;->mIsMusicActivated:Z
