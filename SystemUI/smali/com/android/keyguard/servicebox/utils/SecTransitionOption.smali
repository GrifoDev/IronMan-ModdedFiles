...
.method public constructor <init>()V
    ...
    iput v1, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mDuration:I

    iput v1, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mStartDelay:I

    iput v0, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mClipFace:I
    ...
    iput-object v2, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mSourceViewCustomAnimator:Landroid/animation/Animator;

    iput-object v2, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTargetViewCustomAnimator:Landroid/animation/Animator;
...
.method public static final combineOptions(Lcom/android/keyguard/servicebox/utils/SecTransitionOption;Lcom/android/keyguard/servicebox/utils/SecTransitionOption;)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    ...
    :cond_1
    iget v1, v0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTransitionType:I

    iget v2, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTransitionType:I

    or-int/2addr v1, v2

    iput v1, v0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTransitionType:I

    iget v1, v0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mMovePivot:I

    iget v2, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mMovePivot:I
    ...
    iget v1, v0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mClipFace:I

    iget v2, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mClipFace:I

    or-int/2addr v1, v2

    iput v1, v0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mClipFace:I

    iget-object v1, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mSourceViewCustomAnimator:Landroid/animation/Animator;

    if-eqz v1, :cond_2

    iget-object v1, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mSourceViewCustomAnimator:Landroid/animation/Animator;

    iput-object v1, v0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mSourceViewCustomAnimator:Landroid/animation/Animator;

    :cond_2
    iget-object v1, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTargetViewCustomAnimator:Landroid/animation/Animator;

    if-eqz v1, :cond_3

    iget-object v1, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTargetViewCustomAnimator:Landroid/animation/Animator;

    iput-object v1, v0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTargetViewCustomAnimator:Landroid/animation/Animator;

    :cond_3
    return-object v0
.end method

.method public static final generateCompositeOption()Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    .locals 1

    const/16 v0, 0x24

    invoke-static {v0, v0}, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->generateCompositeOption(II)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
...
.method public static final generateCompositeOption(II)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    .locals 2
    ...
    invoke-virtual {v1, p0, p1}, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->setPivot(II)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;

    return-object v0
.end method

.method public static final generateDefaultOption()Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    .locals 1

    const/4 v0, 0x0

    invoke-static {v0}, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->generateDefaultOption(Z)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
...
.method public copyFrom(Lcom/android/keyguard/servicebox/utils/SecTransitionOption;)V
    ...
    iget v0, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mClipFace:I

    iput v0, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mClipFace:I

    iget-object v0, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mSourceViewCustomAnimator:Landroid/animation/Animator;

    iput-object v0, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mSourceViewCustomAnimator:Landroid/animation/Animator;

    iget-object v0, p1, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTargetViewCustomAnimator:Landroid/animation/Animator;

    iput-object v0, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTargetViewCustomAnimator:Landroid/animation/Animator;
...
.method public getClipFace()I
    ...
    iget v0, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mClipFace:I
...
.method public getSourceViewCustomAnimator()Landroid/animation/Animator;
    ...
    iget-object v0, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mSourceViewCustomAnimator:Landroid/animation/Animator;
...
.method public getTargetViewCustomAnimator()Landroid/animation/Animator;
    ...
    iget-object v0, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTargetViewCustomAnimator:Landroid/animation/Animator;
...
.method public setClipFace(I)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    .locals 0

    iput p1, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mClipFace:I

    return-object p0
.end method

.method public setCustomAnimators(Landroid/animation/Animator;Landroid/animation/Animator;)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    .locals 0

    iput-object p1, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mSourceViewCustomAnimator:Landroid/animation/Animator;

    iput-object p2, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mTargetViewCustomAnimator:Landroid/animation/Animator;

    return-object p0
.end method

.method public setDuration(I)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    .locals 0

    iput p1, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mDuration:I
...
.method public setPivot(II)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    .locals 0

    iput p1, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mMovePivot:I

    iput p2, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mScalePivot:I

    return-object p0
.end method

.method public setScalePivot(I)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    .locals 0

    iput p1, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mScalePivot:I

    return-object p0
.end method

.method public setStartDelay(I)Lcom/android/keyguard/servicebox/utils/SecTransitionOption;
    .locals 0

    iput p1, p0, Lcom/android/keyguard/servicebox/utils/SecTransitionOption;->mStartDelay:I
