...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;Lcom/android/keyguard/util/ShortcutManager$ShortcutCallback;)V
    ...
    new-array v2, v2, [Lcom/android/keyguard/util/ShortcutManager$ShortcutData;

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mShortcuts:[Lcom/android/keyguard/util/ShortcutManager$ShortcutData;

    new-instance v2, Lcom/android/keyguard/util/ShortcutManager$1;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/keyguard/util/ShortcutManager$1;-><init>(Lcom/android/keyguard/util/ShortcutManager;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mShortcutCallback:Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;

    new-instance v2, Lcom/android/keyguard/util/ShortcutManager$2;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/keyguard/util/ShortcutManager$2;-><init>(Lcom/android/keyguard/util/ShortcutManager;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mUpdateMonitorCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;

    new-instance v2, Lcom/android/keyguard/util/ShortcutManager$3;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/keyguard/util/ShortcutManager$3;-><init>(Lcom/android/keyguard/util/ShortcutManager;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mIntentReceiver:Landroid/content/BroadcastReceiver;

    new-instance v2, Lcom/android/keyguard/util/ShortcutManager$4;
    ...
    invoke-direct {v2, v0, v3}, Lcom/android/keyguard/util/ShortcutManager$4;-><init>(Lcom/android/keyguard/util/ShortcutManager;Landroid/os/Looper;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mHandler:Landroid/os/Handler;
    ...
    iput-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mSb:Ljava/lang/StringBuilder;

    move-object/from16 v0, p1

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/keyguard/util/ShortcutManager;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mContext:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    sget v3, Lcom/android/keyguard/R$dimen;->shortuct_icon_default_size:I
    ...
    iput v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mIconSize:I

    move-object/from16 v0, p2

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/keyguard/util/ShortcutManager;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    move-object/from16 v0, p3

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/keyguard/util/ShortcutManager;->mCallback:Lcom/android/keyguard/util/ShortcutManager$ShortcutCallback;
    ...
    iput-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mPM:Landroid/content/pm/PackageManager;
    ...
    iput-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mSettingsHelper:Lcom/android/keyguard/util/SettingsHelper;
    ...
    iput-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    sget v3, Lcom/android/keyguard/R$integer;->shortcut_icon_utilization_ratio:I
    ...
    iput v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mIconScaleRatio:F
    ...
    iget-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mShortcuts:[Lcom/android/keyguard/util/ShortcutManager$ShortcutData;

    new-instance v3, Lcom/android/keyguard/util/ShortcutManager$ShortcutData;

    const/4 v4, 0x0

    move-object/from16 v0, p0

    invoke-direct {v3, v0, v4}, Lcom/android/keyguard/util/ShortcutManager$ShortcutData;-><init>(Lcom/android/keyguard/util/ShortcutManager;Lcom/android/keyguard/util/ShortcutManager$ShortcutData;)V
    ...
    iget-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mSettingsHelper:Lcom/android/keyguard/util/SettingsHelper;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/keyguard/util/ShortcutManager;->mShortcutCallback:Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;

    const/4 v4, 0x1

    new-array v4, v4, [Landroid/net/Uri;

    const-string/jumbo v6, "lock_application_shortcut"
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/keyguard/util/SettingsHelper;->registerCallback(Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;[Landroid/net/Uri;)V

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/keyguard/util/ShortcutManager;->mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/keyguard/util/ShortcutManager;->mUpdateMonitorCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
    ...
    iget-object v3, v0, Lcom/android/keyguard/util/ShortcutManager;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v6, v0, Lcom/android/keyguard/util/ShortcutManager;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/keyguard/util/ShortcutManager;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    sget-boolean v2, Lcom/android/keyguard/KeyguardRune;->SUPPORT_APPLOCK:Z
    ...
    iget-object v10, v0, Lcom/android/keyguard/util/ShortcutManager;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v11, v0, Lcom/android/keyguard/util/ShortcutManager;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/keyguard/util/ShortcutManager;->updateShortcuts()V
