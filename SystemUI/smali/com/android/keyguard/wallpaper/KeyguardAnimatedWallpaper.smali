...
.method static synthetic -get1(Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;)I
    ...
    iget v0, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mLastMobileKeyboardCoverd:I
...
.method static synthetic -set0(Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;I)I
    ...
    iput p1, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mLastMobileKeyboardCoverd:I
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/keyguard/wallpaper/WallpaperViewController$UpdateBitmapCallback;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;-><init>(Landroid/content/Context;Ljava/lang/String;ZIILcom/android/keyguard/wallpaper/WallpaperViewController$UpdateBitmapCallback;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;ZIILcom/android/keyguard/wallpaper/WallpaperViewController$UpdateBitmapCallback;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mScreenOn:Z
...
.method private init(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v8}, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->getComplexAnimation(Landroid/content/Context;Landroid/content/Context;)Lcom/android/keyguard/wallpaper/theme/builder/ComplexAnimationBuilder;

    move-result-object v8

    iput-object v8, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mComplexAnimationBuilder:Lcom/android/keyguard/wallpaper/theme/builder/ComplexAnimationBuilder;
    :try_end_0
...
.method public getComplexAnimation(Landroid/content/Context;Landroid/content/Context;)Lcom/android/keyguard/wallpaper/theme/builder/ComplexAnimationBuilder;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    new-instance v0, Lcom/android/keyguard/wallpaper/theme/xmlparser/ParserData;

    iget-object v3, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mPackageName:Ljava/lang/String;

    iget v5, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mViewWidth:I

    iget v6, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mViewHeight:I

    iget-boolean v7, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mIsPreview:Z

    iget v8, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mLastMobileKeyboardCoverd:I

    iget-object v9, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mUpdateBitmapCallback:Lcom/android/keyguard/wallpaper/WallpaperViewController$UpdateBitmapCallback;
    ...
    invoke-direct/range {v0 .. v9}, Lcom/android/keyguard/wallpaper/theme/xmlparser/ParserData;-><init>(Landroid/content/Context;Landroid/content/Context;Ljava/lang/String;Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;IIZILcom/android/keyguard/wallpaper/WallpaperViewController$UpdateBitmapCallback;)V

    new-instance v10, Lcom/android/keyguard/wallpaper/theme/xmlparser/ThemeParser;

    invoke-direct {v10, v0}, Lcom/android/keyguard/wallpaper/theme/xmlparser/ThemeParser;-><init>(Lcom/android/keyguard/wallpaper/theme/xmlparser/ParserData;)V

    invoke-virtual {v10}, Lcom/android/keyguard/wallpaper/theme/xmlparser/ThemeParser;->generateAnimationFromXml()Lcom/android/keyguard/wallpaper/theme/builder/ComplexAnimationBuilder;
...
.method public playAnimation()V
    ...
    iget-object v0, p0, Lcom/android/keyguard/wallpaper/KeyguardAnimatedWallpaper;->mComplexAnimationBuilder:Lcom/android/keyguard/wallpaper/theme/builder/ComplexAnimationBuilder;
    ...
    invoke-virtual {v0}, Lcom/android/keyguard/wallpaper/theme/builder/ComplexAnimationBuilder;->playAnimation()V
...
.method public stopAnimation()V
    ...
    invoke-virtual {v0}, Lcom/android/keyguard/wallpaper/theme/builder/ComplexAnimationBuilder;->stopAnimation()V
