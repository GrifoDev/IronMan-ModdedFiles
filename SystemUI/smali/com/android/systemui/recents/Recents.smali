...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/systemui/recents/Recents$BixbyRecentsHandler;
    }
.end annotation
...
# instance fields
.field private mBixbyHandler:Lcom/android/systemui/recents/bixby/IBixbyRecentsHandler;
...
.method public dockTopTask(IILandroid/graphics/Rect;IZ)Z
    ...
    invoke-virtual {v13}, Lcom/android/systemui/recents/misc/SystemServicesProxy;->getVisibleRunningFullscreenTask()Landroid/app/ActivityManager$RunningTaskInfo;
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/recents/Recents;->toggleRecents(Landroid/view/Display;)V
    ...
    sget v4, Lcom/samsung/android/framework/res/R$string;->dream_cant_use_this_app_in_multi_window_view_tpop:I

    const/4 v5, 0x0

    invoke-direct {v3, v4, v5}, Lcom/android/systemui/recents/events/component/ShowUserToastEvent;-><init>(II)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2}, Lcom/android/systemui/recents/events/EventBus;->dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
...
.method public hideRecents(ZZ)V
    ...
    const-string/jumbo v5, "hideRecents fromAltTab="
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/component/ScreenPinningRequestEvent;)V
    ...
    const-string/jumbo v3, "ScreenPinningRequestEvent - "
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/component/SnapViewRequestEvent;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/systemui/recents/RecentsImpl;->onStartSnapView(Landroid/content/Context;)V
...
.method public requestBixbyRegist()V
    .locals 2
    ...
    new-instance v0, Lcom/android/systemui/recents/Recents$BixbyRecentsHandler;

    invoke-direct {v0, p0}, Lcom/android/systemui/recents/Recents$BixbyRecentsHandler;-><init>(Lcom/android/systemui/recents/Recents;)V

    iput-object v0, p0, Lcom/android/systemui/recents/Recents;->mBixbyHandler:Lcom/android/systemui/recents/bixby/IBixbyRecentsHandler;
    ...
    iget-object v1, p0, Lcom/android/systemui/recents/Recents;->mBixbyHandler:Lcom/android/systemui/recents/bixby/IBixbyRecentsHandler;

    invoke-virtual {v0, v1}, Lcom/android/systemui/recents/bixby/EmRecentsManager;->register(Lcom/android/systemui/recents/bixby/IBixbyRecentsHandler;)V
