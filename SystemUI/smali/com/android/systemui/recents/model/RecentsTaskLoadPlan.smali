...
.method public declared-synchronized preloadPlan(Lcom/android/systemui/recents/model/RecentsTaskLoader;IZ)V
    ...
    check-cast v45, Landroid/app/ActivityManager$RecentTaskInfo;
    ...
    invoke-virtual/range {v44 .. v44}, Lcom/android/systemui/recents/model/RecentsSettingHelper;->isPrivateModeEnabled()Z
    ...
    invoke-static {v4}, Lcom/android/systemui/recents/model/TaskLockPreference;->getInstance(Landroid/content/Context;)Lcom/android/systemui/recents/model/TaskLockPreference;

    move-result-object v5

    move-object/from16 v0, p0

    iget-object v9, v0, Lcom/android/systemui/recents/model/RecentsTaskLoadPlan;->mContext:Landroid/content/Context;
    ...
    :goto_7
    iget v0, v3, Lcom/android/systemui/recents/model/Task$TaskKey;->userId:I
    ...
    invoke-virtual {v5, v9, v0, v4, v1}, Lcom/android/systemui/recents/model/TaskLockPreference;->isLocked(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-direct/range {v2 .. v28}, Lcom/android/systemui/recents/model/Task;-><init>(Lcom/android/systemui/recents/model/Task$TaskKey;IILandroid/graphics/drawable/Drawable;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIZZZZLandroid/graphics/Rect;Landroid/app/ActivityManager$TaskDescription;ILandroid/content/ComponentName;ZZZZZ)V
    ...
    invoke-virtual {v0, v5, v9}, Landroid/util/SparseIntArray;->get(II)I
    ...
    invoke-virtual {v4, v5, v0, v9}, Lcom/android/systemui/recents/model/TaskStack;->setTasks(Landroid/content/Context;Ljava/util/List;Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
