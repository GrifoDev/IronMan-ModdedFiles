...
.method private addPackage(Ljava/lang/String;I)Z
    ...
    iget v9, v0, Landroid/content/pm/ActivityInfo;->resizeMode:I

    invoke-static {v9}, Landroid/content/pm/ActivityInfo;->isResizeableMode(I)Z

    move-result v9

    if-nez v9, :cond_3

    invoke-virtual {v7, v0}, Lcom/android/systemui/recents/misc/SystemServicesProxy;->isForceResizable(Landroid/content/pm/ActivityInfo;)Z
    ...
    invoke-virtual {v7, v0}, Lcom/android/systemui/recents/misc/SystemServicesProxy;->shouldLaunchAsMultiInstance(Landroid/content/pm/ActivityInfo;)Z
