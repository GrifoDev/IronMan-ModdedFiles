...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/systemui/recents/events/EventBus$-void_-com_android_systemui_recents_events_EventBus_lambda$1_com_android_systemui_recents_events_EventHandler_handler_com_android_systemui_recents_events_EventBus$Event_e_LambdaImpl0;,
        Lcom/android/systemui/recents/events/EventBus$-void_registerSubscriber_java_lang_Object_subscriber_int_priority_android_util_MutableBoolean_hasInterprocessEventsChangedOut_LambdaImpl0;,
...
.field private mStickyEventMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method private constructor <init>(Landroid/os/Looper;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/recents/events/EventBus;->mStickyEventMap:Ljava/util/HashMap;
...
.method private queueEvent(Lcom/android/systemui/recents/events/EventBus$Event;)V
    ...
    iget-boolean v6, p1, Lcom/android/systemui/recents/events/EventBus$Event;->isSticky:Z

    if-eqz v6, :cond_1

    iget-object v6, p0, Lcom/android/systemui/recents/events/EventBus;->mStickyEventMap:Ljava/util/HashMap;
    ...
    iget-object v6, v0, Lcom/android/systemui/recents/events/EventHandler;->subscriber:Lcom/android/systemui/recents/events/Subscriber;

    invoke-virtual {v6}, Lcom/android/systemui/recents/events/Subscriber;->getReference()Ljava/lang/Object;

    move-result-object v6

    if-eqz v6, :cond_3

    iget-boolean v6, p1, Lcom/android/systemui/recents/events/EventBus$Event;->requiresPost:Z

    if-eqz v6, :cond_4

    iget-object v6, p0, Lcom/android/systemui/recents/events/EventBus;->mHandler:Landroid/os/Handler;

    new-instance v7, Lcom/android/systemui/recents/events/EventBus$4;

    invoke-direct {v7, p0, v0, p1}, Lcom/android/systemui/recents/events/EventBus$4;-><init>(Lcom/android/systemui/recents/events/EventBus;Lcom/android/systemui/recents/events/EventHandler;Lcom/android/systemui/recents/events/EventBus$Event;)V
    ...
    new-instance v7, Lcom/android/systemui/recents/events/EventBus$5;

    invoke-direct {v7, p0, p1}, Lcom/android/systemui/recents/events/EventBus$5;-><init>(Lcom/android/systemui/recents/events/EventBus;Lcom/android/systemui/recents/events/EventBus$Event;)V
...
.method private registerSubscriber(Ljava/lang/Object;ILandroid/util/MutableBoolean;)V
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/os/Looper;->getThread()Ljava/lang/Thread;
    ...
    const-string/jumbo v23, "Can not register() a subscriber from a non-main thread."
    ...
    new-instance v17, Lcom/android/systemui/recents/events/Subscriber;
    ...
    check-cast v13, Lcom/android/systemui/recents/events/EventHandlerMethod;
    ...
    iget-object v0, v13, Lcom/android/systemui/recents/events/EventHandlerMethod;->eventType:Ljava/lang/Class;
    ...
    new-instance v22, Lcom/android/systemui/recents/events/EventHandler;
    ...
    invoke-direct {v0, v1, v13, v2}, Lcom/android/systemui/recents/events/EventHandler;-><init>(Lcom/android/systemui/recents/events/Subscriber;Lcom/android/systemui/recents/events/EventHandlerMethod;I)V
    ...
    invoke-direct {v11, v0}, Landroid/util/MutableBoolean;-><init>(Z)V
    ...
    invoke-direct {v0, v12, v1, v11}, Lcom/android/systemui/recents/events/EventBus;->isValidEventBusHandlerMethod(Ljava/lang/reflect/Method;[Ljava/lang/Class;Landroid/util/MutableBoolean;)Z
    ...
    const-class v25, Landroid/os/Bundle;
    ...
    :cond_5
    new-instance v13, Lcom/android/systemui/recents/events/EventHandlerMethod;

    invoke-direct {v13, v12, v7}, Lcom/android/systemui/recents/events/EventHandlerMethod;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;)V

    new-instance v10, Lcom/android/systemui/recents/events/EventHandler;

    move-object/from16 v0, v17

    move/from16 v1, p2

    invoke-direct {v10, v0, v13, v1}, Lcom/android/systemui/recents/events/EventHandler;-><init>(Lcom/android/systemui/recents/events/Subscriber;Lcom/android/systemui/recents/events/EventHandlerMethod;I)V
    ...
    iget-object v0, v0, Lcom/android/systemui/recents/events/EventBus;->mStickyEventMap:Ljava/util/HashMap;
    ...
    new-instance v25, Lcom/android/systemui/recents/events/EventBus$-void_registerSubscriber_java_lang_Object_subscriber_int_priority_android_util_MutableBoolean_hasInterprocessEventsChangedOut_LambdaImpl0;

    move-object/from16 v0, v25

    move-object/from16 v1, p0

    invoke-direct {v0, v1, v10}, Lcom/android/systemui/recents/events/EventBus$-void_registerSubscriber_java_lang_Object_subscriber_int_priority_android_util_MutableBoolean_hasInterprocessEventsChangedOut_LambdaImpl0;-><init>(Lcom/android/systemui/recents/events/EventBus;Lcom/android/systemui/recents/events/EventHandler;)V

    invoke-interface/range {v24 .. v25}, Ljava/util/stream/Stream;->forEach(Ljava/util/function/Consumer;)V
    ...
    const-string/jumbo v23, "Expected InterprocessEvent to have a Bundle constructor"
...
# virtual methods
.method synthetic -com_android_systemui_recents_events_EventBus_lambda$1(Lcom/android/systemui/recents/events/EventHandler;Lcom/android/systemui/recents/events/EventBus$Event;)V
    .locals 4

    iget-object v0, p0, Lcom/android/systemui/recents/events/EventBus;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/systemui/recents/events/EventBus$-void_-com_android_systemui_recents_events_EventBus_lambda$1_com_android_systemui_recents_events_EventHandler_handler_com_android_systemui_recents_events_EventBus$Event_e_LambdaImpl0;

    invoke-direct {v1, p0, p2, p1}, Lcom/android/systemui/recents/events/EventBus$-void_-com_android_systemui_recents_events_EventBus_lambda$1_com_android_systemui_recents_events_EventHandler_handler_com_android_systemui_recents_events_EventBus$Event_e_LambdaImpl0;-><init>(Lcom/android/systemui/recents/events/EventBus;Lcom/android/systemui/recents/events/EventBus$Event;Lcom/android/systemui/recents/events/EventHandler;)V
...
.method synthetic -com_android_systemui_recents_events_EventBus_lambda$2(Lcom/android/systemui/recents/events/EventBus$Event;Lcom/android/systemui/recents/events/EventHandler;)V
    .locals 0

    invoke-virtual {p1}, Lcom/android/systemui/recents/events/EventBus$Event;->onPreDispatch()V

    invoke-direct {p0, p2, p1}, Lcom/android/systemui/recents/events/EventBus;->processEvent(Lcom/android/systemui/recents/events/EventHandler;Lcom/android/systemui/recents/events/EventBus$Event;)V
...
.method public removeStickyEvent(Lcom/android/systemui/recents/events/EventBus$Event;)V
    .locals 2

    iget-boolean v0, p1, Lcom/android/systemui/recents/events/EventBus$Event;->isSticky:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/systemui/recents/events/EventBus;->mStickyEventMap:Ljava/util/HashMap;
