...
# direct methods
.method constructor <init>(Lcom/android/systemui/recents/views/RecentsTransitionHelper;ZLcom/android/systemui/recents/views/TaskView;Lcom/android/systemui/recents/model/Task;Lcom/android/systemui/recents/views/TaskStackView;ZZ)V
    .locals 0
    ...
    iput-boolean p2, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$isFreeformDragging:Z

    iput-object p3, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$taskView:Lcom/android/systemui/recents/views/TaskView;

    iput-object p4, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$task:Lcom/android/systemui/recents/model/Task;

    iput-object p5, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$stackView:Lcom/android/systemui/recents/views/TaskStackView;

    iput-boolean p6, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$screenPinningRequested:Z

    iput-boolean p7, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$snapViewRequested:Z
...
.method public onAnimationStarted()V
    ...
    iget-boolean v0, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$isFreeformDragging:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$taskView:Lcom/android/systemui/recents/views/TaskView;
    ...
    iget-boolean v0, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$screenPinningRequested:Z
    ...
    iget-object v1, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$task:Lcom/android/systemui/recents/model/Task;
    ...
    :cond_1
    iget-boolean v0, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$snapViewRequested:Z
    ...
    invoke-direct {v1, p0}, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3$1;-><init>(Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;)V

    invoke-virtual {v0, v1, v4, v5}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z

    :cond_2
    iget-object v0, p0, Lcom/android/systemui/recents/views/RecentsTransitionHelper$3;->val$task:Lcom/android/systemui/recents/model/Task;
