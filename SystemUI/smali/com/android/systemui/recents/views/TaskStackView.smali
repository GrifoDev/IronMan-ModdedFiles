...
.method public isTouchPointInView(FFLcom/android/systemui/recents/views/TaskView;)Z
    ...
    invoke-virtual {p3}, Lcom/android/systemui/recents/views/TaskView;->getScaleX()F
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/activity/ConfigurationChangedEvent;)V
    ...
    iget-boolean v0, p1, Lcom/android/systemui/recents/events/activity/ConfigurationChangedEvent;->fromScreenSizeChange:Z
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/activity/EnterRecentsWindowAnimationCompletedEvent;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/recents/events/EventBus;->removeStickyEvent(Lcom/android/systemui/recents/events/EventBus$Event;)V
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/activity/LaunchNextTaskRequestEvent;)V
    ...
    iput-boolean v11, p0, Lcom/android/systemui/recents/views/TaskStackView;->mLaunchNextAfterFirstMeasure:Z
    ...
    invoke-direct {v1, v5, v11}, Lcom/android/systemui/recents/events/activity/HideRecentsEvent;-><init>(ZZ)V
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/activity/PackagesChangedEvent;)V
    ...
    iput-boolean v8, v2, Lcom/android/systemui/recents/model/Task;->isTaskLocked:Z
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/activity/RecentsViewModeChangedEvent;)V
    ...
    invoke-virtual {v4}, Lcom/android/systemui/recents/views/TaskViewHeader;->hideSnapButton()V

    invoke-virtual {v3, v5, v6, v5, v7}, Lcom/android/systemui/recents/views/TaskView;->hideScreenRatioButton(ZIZLandroid/animation/Animator$AnimatorListener;)V

    iget-boolean v4, p0, Lcom/android/systemui/recents/views/TaskStackView;->mScreenPinningEnabled:Z

    if-eqz v4, :cond_2

    invoke-virtual {v3, v5, v6, v5, v7}, Lcom/android/systemui/recents/views/TaskView;->hideActionButton(ZIZLandroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {v4}, Lcom/android/systemui/recents/views/TaskViewHeader;->showSnapButton()V

    invoke-virtual {v3, v5, v6}, Lcom/android/systemui/recents/views/TaskView;->showScreenRatioButton(ZI)V

    iget-boolean v4, p0, Lcom/android/systemui/recents/views/TaskStackView;->mScreenPinningEnabled:Z

    if-eqz v4, :cond_2

    invoke-virtual {v3, v5, v6}, Lcom/android/systemui/recents/views/TaskView;->showActionButton(ZI)V
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/activity/UnlockTaskEvent;)V
    ...
    iget-boolean v2, v1, Lcom/android/systemui/recents/model/Task;->isTaskLocked:Z

    if-eqz v2, :cond_1

    const/4 v2, 0x0

    iput-boolean v2, v1, Lcom/android/systemui/recents/model/Task;->isTaskLocked:Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/systemui/recents/model/Task;->includeTaskLockPref(Landroid/content/Context;)Z
    ...
    invoke-static {v2}, Lcom/android/systemui/recents/model/TaskLockPreference;->getInstance(Landroid/content/Context;)Lcom/android/systemui/recents/model/TaskLockPreference;
    ...
    invoke-virtual {v2, v3, v0, v4}, Lcom/android/systemui/recents/model/TaskLockPreference;->removePreference(Landroid/content/Context;Ljava/lang/String;I)V

    invoke-direct {p0, v1}, Lcom/android/systemui/recents/views/TaskStackView;->syncTaskLockState(Lcom/android/systemui/recents/model/Task;)V
...
.method protected onMeasure(II)V
    ...
    iput-boolean v12, p0, Lcom/android/systemui/recents/views/TaskStackView;->mAwaitingInitializeAlgorithm:Z
...
.method public onPickUpViewFromPool(Lcom/android/systemui/recents/views/TaskView;Lcom/android/systemui/recents/model/Task;Z)V
    ...
    sget-boolean v9, Lcom/android/systemui/recents/RecentsDebugFlags$Static;->EnableDozeTrigger:Z
    ...
    invoke-virtual {v9}, Lcom/android/systemui/recents/misc/DozeTrigger;->isAsleep()Z
    ...
    sget-boolean v9, Lcom/android/systemui/recents/RecentsDebugFlags$Static;->EnableFreeformInTaskStack:Z
    ...
    invoke-virtual {v9}, Lcom/android/systemui/recents/views/TaskViewHeader;->hideSnapButton()V
    ...
    invoke-virtual {v9}, Lcom/android/systemui/recents/views/TaskViewHeader;->showSnapButton()V
    ...
    :cond_8
    sget-boolean v9, Lcom/android/systemui/recents/RecentsDebugFlags$Static;->EnableTaskLock:Z
    ...
    iget-boolean v3, v9, Lcom/android/systemui/recents/RecentsConfiguration;->isInLockTaskEditMode:Z
...
.method public onReturnViewToPool(Lcom/android/systemui/recents/views/TaskView;)V
    ...
    iput-boolean v2, p1, Lcom/android/systemui/recents/views/TaskView;->mFrontMostTaskView:Z
    ...
    invoke-virtual {v1}, Lcom/android/systemui/recents/views/TaskViewHeader;->hideSnapButton()V

    :cond_0
    invoke-virtual {p1, v2, v2, v2, v3}, Lcom/android/systemui/recents/views/TaskView;->hideScreenRatioButton(ZIZLandroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-virtual {p1, v2, v2, v2, v3}, Lcom/android/systemui/recents/views/TaskView;->hideActionButton(ZIZLandroid/animation/Animator$AnimatorListener;)V
...
.method public onStackTaskRemoved(Lcom/android/systemui/recents/model/TaskStack;Lcom/android/systemui/recents/model/Task;Lcom/android/systemui/recents/model/Task;Lcom/android/systemui/recents/views/AnimationProps;ZZ)V
    ...
    iput-boolean v3, v0, Lcom/android/systemui/recents/views/TaskView;->mFrontMostTaskView:Z
    ...
    invoke-virtual {v0, v3, v5}, Lcom/android/systemui/recents/views/TaskView;->showScreenRatioButton(ZI)V
    ...
    invoke-virtual {v0, v3, v5}, Lcom/android/systemui/recents/views/TaskView;->showActionButton(ZI)V
...
.method public onStackTasksUpdated(Lcom/android/systemui/recents/model/TaskStack;)V
    ...
    iget-boolean v4, v4, Lcom/android/systemui/recents/RecentsConfiguration;->isInMultiWindowMode:Z

    if-eqz v4, :cond_2

    const/4 v4, 0x0

    invoke-virtual {v3, v5, v5, v5, v4}, Lcom/android/systemui/recents/views/TaskView;->hideScreenRatioButton(ZIZLandroid/animation/Animator$AnimatorListener;)V
...
.method public setFocusedTask(IZ)Z
    .locals 2
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lcom/android/systemui/recents/views/TaskStackView;->setFocusedTask(IZZI)Z
...
.method public updateButtonsFocus(Z)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/recents/views/TaskView;->updateButtonsFocus(Z)V
...
.method public updateTaskLockState(Z)V
    ...
    iget-object v7, p0, Lcom/android/systemui/recents/views/TaskStackView;->mContext:Landroid/content/Context;

    invoke-static {v7}, Lcom/android/systemui/recents/model/TaskLockPreference;->getInstance(Landroid/content/Context;)Lcom/android/systemui/recents/model/TaskLockPreference;

    move-result-object v7

    iget-object v8, p0, Lcom/android/systemui/recents/views/TaskStackView;->mContext:Landroid/content/Context;

    invoke-virtual {v7, v8}, Lcom/android/systemui/recents/model/TaskLockPreference;->getCount(Landroid/content/Context;)I
    ...
    iget-object v5, p0, Lcom/android/systemui/recents/views/TaskStackView;->mContext:Landroid/content/Context;

    invoke-virtual {v2, v5}, Lcom/android/systemui/recents/model/Task;->includeTaskLockPref(Landroid/content/Context;)Z
    ...
    invoke-static {v5}, Lcom/android/systemui/recents/model/TaskLockPreference;->getInstance(Landroid/content/Context;)Lcom/android/systemui/recents/model/TaskLockPreference;

    move-result-object v5

    iget-object v6, p0, Lcom/android/systemui/recents/views/TaskStackView;->mContext:Landroid/content/Context;

    invoke-virtual {v5, v6, v2}, Lcom/android/systemui/recents/model/TaskLockPreference;->savePreference(Landroid/content/Context;Lcom/android/systemui/recents/model/Task;)V
    ...
    invoke-virtual {v5, v6, v1, v7}, Lcom/android/systemui/recents/model/TaskLockPreference;->removePreference(Landroid/content/Context;Ljava/lang/String;I)V
