...
.method protected onTargetSelected(Lcom/android/internal/app/ResolverActivity$TargetInfo;Z)Z
    ...
    iget-object v9, p0, Lcom/android/systemui/usb/UsbResolverActivity;->mDevice:Landroid/hardware/usb/UsbDevice;

    if-eqz v9, :cond_2

    iget-object v9, p0, Lcom/android/systemui/usb/UsbResolverActivity;->mDevice:Landroid/hardware/usb/UsbDevice;

    invoke-interface {v6, v9, v7}, Landroid/hardware/usb/IUsbManager;->grantDevicePermission(Landroid/hardware/usb/UsbDevice;I)V
    ...
    invoke-interface {v6, v9, v10, v8}, Landroid/hardware/usb/IUsbManager;->setDevicePackage(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;I)V
    ...
    iget-object v9, p0, Lcom/android/systemui/usb/UsbResolverActivity;->mSShareCommon:Lcom/samsung/android/share/SShareCommon;

    sget v10, Lcom/samsung/android/share/SShareConstants;->SUPPORT_RESOLVER_GUIDE:I

    invoke-virtual {v9, v10}, Lcom/samsung/android/share/SShareCommon;->isFeatureSupported(I)Z

    move-result v9

    if-eqz v9, :cond_4

    new-instance v3, Lcom/android/internal/app/ResolverGuideDialogFragment;
    ...
    invoke-direct {v3, p0, v9, p1}, Lcom/android/internal/app/ResolverGuideDialogFragment;-><init>(Landroid/app/Activity;Ljava/lang/String;Lcom/android/internal/app/ResolverActivity$TargetInfo;)V

    new-instance v9, Lcom/android/systemui/usb/UsbResolverActivity$1;

    invoke-direct {v9, p0, v3, v8}, Lcom/android/systemui/usb/UsbResolverActivity$1;-><init>(Lcom/android/systemui/usb/UsbResolverActivity;Lcom/android/internal/app/ResolverGuideDialogFragment;I)V

    invoke-virtual {v3, v9}, Lcom/android/internal/app/ResolverGuideDialogFragment;->setOnClickListener(Landroid/content/DialogInterface$OnClickListener;)V

    new-instance v9, Lcom/android/systemui/usb/UsbResolverActivity$2;

    invoke-direct {v9, p0}, Lcom/android/systemui/usb/UsbResolverActivity$2;-><init>(Lcom/android/systemui/usb/UsbResolverActivity;)V

    invoke-virtual {v3, v9}, Lcom/android/internal/app/ResolverGuideDialogFragment;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    invoke-virtual {p0}, Lcom/android/systemui/usb/UsbResolverActivity;->getFragmentManager()Landroid/app/FragmentManager;

    move-result-object v9

    const-string/jumbo v10, "ResolverGuideDialogFragment"

    invoke-virtual {v3, v9, v10}, Lcom/android/internal/app/ResolverGuideDialogFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
    ...
    const-string/jumbo v9, "UsbResolverActivity"

    const-string/jumbo v10, "onIntentSelected failed"
    ...
    :cond_2
    :try_start_1
    iget-object v9, p0, Lcom/android/systemui/usb/UsbResolverActivity;->mAccessory:Landroid/hardware/usb/UsbAccessory;

    if-eqz v9, :cond_0

    iget-object v9, p0, Lcom/android/systemui/usb/UsbResolverActivity;->mAccessory:Landroid/hardware/usb/UsbAccessory;

    invoke-interface {v6, v9, v7}, Landroid/hardware/usb/IUsbManager;->grantAccessoryPermission(Landroid/hardware/usb/UsbAccessory;I)V
    ...
    invoke-interface {v6, v9, v10, v8}, Landroid/hardware/usb/IUsbManager;->setAccessoryPackage(Landroid/hardware/usb/UsbAccessory;Ljava/lang/String;I)V
    ...
    invoke-interface {p1, p0, v10, v9}, Lcom/android/internal/app/ResolverActivity$TargetInfo;->startAsUser(Landroid/app/Activity;Landroid/os/Bundle;Landroid/os/UserHandle;)Z
    :try_end_2
