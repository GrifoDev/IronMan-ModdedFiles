...
.method static synthetic -get63()Ljava/lang/Object;
    .locals 1
...
.method static synthetic -get71()Landroid/content/res/Resources;
    .locals 1
...
.method static synthetic -get72()Landroid/view/View;
    .locals 1
...
.method static synthetic -get73()I
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/plugins/GlobalActions$GlobalActionsManager;)V
    ...
    iput-object v2, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mColorHSV:[F

    iput-object v6, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mCurrentBG:Landroid/graphics/Bitmap;
...
.method private initValueForShow()V
    ...
    sput-object v3, Lcom/android/systemui/globalactions/GlobalActionsDialog;->sResource:Landroid/content/res/Resources;

    sget-object v3, Lcom/android/systemui/globalactions/GlobalActionsDialog;->sResource:Landroid/content/res/Resources;
    ...
    sput v3, Lcom/android/systemui/globalactions/GlobalActionsDialog;->sCurrentDensity:I
    ...
    iget v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mDisplayWidth:I

    iget v4, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mDisplayHeight:I
    ...
    iget v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mDisplayHeight:I
    ...
    sput v3, Lcom/android/systemui/globalactions/GlobalActionsDialog;->sMessageViewColorWhite:I
    ...
    sput v3, Lcom/android/systemui/globalactions/GlobalActionsDialog;->sStatusViewColorWhite:I
    ...
    sput v3, Lcom/android/systemui/globalactions/GlobalActionsDialog;->sMessageViewTextSize:I
    ...
    sput v3, Lcom/android/systemui/globalactions/GlobalActionsDialog;->sStatusViewTextSize:I
    ...
    invoke-virtual {v3}, Lcom/android/systemui/globalactions/GlobalActionsDialog$ActionsDialog;->getWindow()Landroid/view/Window;
    ...
    iput v2, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mIsSelectedItemTagForSecure:I

    :cond_0
    iput v2, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mIsSelectedItemTagForBixby:I

    const/4 v3, -0x1

    iput v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mSelectedItemNumbyBixby:I

    iput-boolean v2, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mIsConfirmPowerOffOnClearCover:Z

    iput-boolean v2, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mIsConfirmRestartOnClearCover:Z

    iput-boolean v2, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mIsInitWidthHeight:Z

    iget-object v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mCoverManager:Lcom/samsung/android/sdk/cover/ScoverManager;

    invoke-virtual {v3}, Lcom/samsung/android/sdk/cover/ScoverManager;->getCoverState()Lcom/samsung/android/sdk/cover/ScoverState;

    move-result-object v3

    iput-object v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mCoverState:Lcom/samsung/android/sdk/cover/ScoverState;

    sget-boolean v3, Lcom/android/systemui/globalactions/GlobalActionsDialog;->sSupportBlackWhiteTheme:Z

    if-eqz v3, :cond_5

    iget-object v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mContext:Landroid/content/Context;

    invoke-direct {p0, v3}, Lcom/android/systemui/globalactions/GlobalActionsDialog;->captureScreen(Landroid/content/Context;)Landroid/graphics/Bitmap;

    move-result-object v3

    iput-object v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mCurrentBG:Landroid/graphics/Bitmap;

    iget-object v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mCurrentBG:Landroid/graphics/Bitmap;
    ...
    invoke-static {v3, v0}, Lcom/android/systemui/globalactions/GlobalActionsDialog$ExtractColor;->getColorHSV(Landroid/graphics/Bitmap;Landroid/graphics/Rect;)[F

    move-result-object v3

    iput-object v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mColorHSV:[F

    iget-object v3, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mColorHSV:[F
    ...
    iget-object v5, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mColorHSV:[F
    ...
    iput v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mPowerOffIconResId:I

    const v1, 0x1080a9e

    iput v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mConfirmPowerOffIconResId:I

    const v1, 0x1080aa3

    iput v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mRestartIconResId:I

    const v1, 0x7f080919

    iput v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mRecoveryIconResId:I

    const v1, 0x1080aa2

    iput v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mConfirmRestartIconResId:I

    const v1, 0x7f080919

    iput v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mConfirmRecoveryIconResId:I

    const v1, 0x1080a9a

    iput v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mEmergencyIconResId:I

    const v1, 0x1080aa5

    iput v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mSafeModeIconResId:I

    sget-object v1, Lcom/android/systemui/globalactions/GlobalActionsDialog;->PRODUCT_NAME:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mDesktopModeManager:Lcom/samsung/android/desktopmode/SemDesktopModeManager;

    new-instance v1, Lcom/android/systemui/globalactions/GlobalActionsDialog$14;

    invoke-direct {v1, p0}, Lcom/android/systemui/globalactions/GlobalActionsDialog$14;-><init>(Lcom/android/systemui/globalactions/GlobalActionsDialog;)V

    iput-object v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mDesktopModeEventListener:Lcom/samsung/android/desktopmode/SemDesktopModeManager$DesktopModeListener;

    iget-object v1, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mDesktopModeManager:Lcom/samsung/android/desktopmode/SemDesktopModeManager;

    iget-object v2, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mDesktopModeEventListener:Lcom/samsung/android/desktopmode/SemDesktopModeManager$DesktopModeListener;
    ...
    iget v4, p0, Lcom/android/systemui/globalactions/GlobalActionsDialog;->mDisplayWidth:I
