...
.method static synthetic -get1(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Z
    .locals 1
...
.method static synthetic -get10(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Landroid/os/UserManager;
    .locals 1
...
.method static synthetic -get11(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Ljava/util/ArrayList;
    .locals 1
...
.method static synthetic -get2(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Landroid/content/Context;
    .locals 1
...
.method static synthetic -get3(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Landroid/app/Dialog;
    .locals 1
...
.method static synthetic -get4(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic -get5(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Lcom/android/systemui/statusbar/policy/KeyguardMonitor;
    .locals 1
...
.method static synthetic -get6(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)I
    .locals 1
...
.method static synthetic -get7(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Landroid/content/Intent;
    .locals 1
...
.method static synthetic -get8(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Z
    .locals 1
...
.method static synthetic -get9(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic -set1(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Z)Z
    .locals 0
...
.method static synthetic -set2(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Landroid/app/Dialog;)Landroid/app/Dialog;
    .locals 0
...
.method static synthetic -set3(Lcom/android/systemui/statusbar/policy/UserSwitcherController;I)I
    .locals 0
...
.method static synthetic -set5(Lcom/android/systemui/statusbar/policy/UserSwitcherController;I)I
    .locals 0
...
.method static synthetic -set6(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Z)Z
    .locals 0
...
.method static synthetic -set7(Lcom/android/systemui/statusbar/policy/UserSwitcherController;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    .locals 0
...
.method private refreshUsers(I)V
    ...
    invoke-virtual {v6, p1, v9}, Landroid/util/SparseBooleanArray;->put(IZ)V
    ...
    new-array v7, v9, [Landroid/util/SparseArray;
...
.method private showGuestNotification(I)V
    ...
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mCalling:Z
...
.method public switchTo(Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;)V
    ...
    iget-boolean v7, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mCalling:Z

    if-eqz v7, :cond_0

    iget-boolean v7, p1, Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;->isAddUser:Z

    if-eqz v7, :cond_2

    :cond_0
    iget-boolean v7, p1, Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;->isGuest:Z

    if-eqz v7, :cond_5

    iget-object v7, p1, Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;->info:Landroid/content/pm/UserInfo;

    if-nez v7, :cond_5

    iget-object v7, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mUserManager:Landroid/os/UserManager;
    ...
    invoke-virtual {v7, v8, v9}, Landroid/os/UserManager;->createGuest(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/UserInfo;

    move-result-object v1

    sget-boolean v7, Lcom/android/systemui/SystemUIRune;->SUPPORT_SOFT_PHONE_DEVICE:Z

    if-eqz v7, :cond_3

    iget-object v7, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mUserManager:Landroid/os/UserManager;

    invoke-virtual {v7}, Landroid/os/UserManager;->getDefaultGuestRestrictions()Landroid/os/Bundle;
    ...
    invoke-virtual {v7, v0}, Landroid/os/UserManager;->setDefaultGuestRestrictions(Landroid/os/Bundle;)V

    iget-object v7, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mUserManager:Landroid/os/UserManager;

    invoke-virtual {v7, v12}, Landroid/os/UserManager;->getUsers(Z)Ljava/util/List;
    ...
    invoke-virtual {v7, v8, v11, v5}, Landroid/os/UserManager;->setUserRestriction(Ljava/lang/String;ZLandroid/os/UserHandle;)V

    iget-object v7, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mUserManager:Landroid/os/UserManager;

    const-string/jumbo v8, "no_sms"

    invoke-virtual {v7, v8, v12, v5}, Landroid/os/UserManager;->setUserRestriction(Ljava/lang/String;ZLandroid/os/UserHandle;)V

    goto :goto_0

    :cond_2
    iget-boolean v7, p1, Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;->isCurrent:Z

    if-nez v7, :cond_0

    iget-object v7, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mContext:Landroid/content/Context;
    ...
    invoke-static {v7, v8, v12}, Lcom/android/systemui/SysUIToast;->makeText(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;
    ...
    :cond_6
    iget-object v7, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBar;
    ...
    invoke-virtual {v7, v11, v11, v11, v8}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->animateCollapsePanels(IZZF)V
    ...
    :cond_9
    invoke-direct {p0, v4}, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->showExitGuestDialog(I)V
    ...
    :cond_c
    invoke-direct {p0, v4}, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->switchToUserId(I)V
