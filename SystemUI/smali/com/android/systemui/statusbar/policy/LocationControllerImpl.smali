...
.method static synthetic -get1(Lcom/android/systemui/statusbar/policy/LocationControllerImpl;)Landroid/content/Context;
    .locals 1
...
.method static synthetic -get2(Lcom/android/systemui/statusbar/policy/LocationControllerImpl;)Lcom/android/systemui/statusbar/policy/LocationControllerImpl$H;
    .locals 1
...
.method static synthetic -get3(Lcom/android/systemui/statusbar/policy/LocationControllerImpl;)Ljava/util/ArrayList;
    .locals 1
...
.method public addSettingsChangedCallback(Lcom/android/systemui/statusbar/policy/LocationController$LocationChangeCallback;)V
    .locals 2
...
.method public isLocationEnabled()Z
    ...
    sget-boolean v5, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_GPS_IN_LOCATION:Z
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {v2, v5}, Lcom/android/systemui/statusbar/policy/LocationControllerImpl$H;->sendEmptyMessage(I)Z

    goto :goto_0

    :cond_2
    const-string/jumbo v2, "com.samsung.intent.action.CHANGE_STATUSBAR_ICON"
    ...
    const-string/jumbo v2, "iconEnable"
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/policy/LocationControllerImpl;->mStatusBarManager:Landroid/app/StatusBarManager;

    iget-object v3, p0, Lcom/android/systemui/statusbar/policy/LocationControllerImpl;->mSlotLocation:Ljava/lang/String;
    ...
    const-string/jumbo v4, " isPaused : "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v4, p0, Lcom/android/systemui/statusbar/policy/LocationControllerImpl;->isPaused:Z
    ...
    :cond_4
    iput-boolean v6, p0, Lcom/android/systemui/statusbar/policy/LocationControllerImpl;->isPaused:Z
...
.method public removeSettingsChangedCallback(Lcom/android/systemui/statusbar/policy/LocationController$LocationChangeCallback;)V
    .locals 2
...
.method public setLocationEnabled(ZZ)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/policy/LocationControllerImpl;->isUserLocationRestricted(I)Z
    ...
    :goto_1
    sget-boolean v6, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_QS_LOCATION_ENABLE_POPUP:Z

    if-eqz v6, :cond_1

    sget-boolean v6, Lcom/android/systemui/Rune;->QPANEL_IS_DCM_POPUP:Z
    ...
    sget-boolean v6, Lcom/android/systemui/Rune;->QPANEL_IS_VZW_POPUP:Z

    if-nez v6, :cond_2

    sget-boolean v6, Lcom/android/systemui/Rune;->QPANEL_IS_USC_POPUP:Z
    ...
    :cond_b
    sget-boolean v6, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_GPS_IN_LOCATION:Z
    ...
    const-string/jumbo v6, "android.settings.GPS_CHANGED"
