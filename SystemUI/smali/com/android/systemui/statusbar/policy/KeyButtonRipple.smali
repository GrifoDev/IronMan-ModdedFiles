...
.field private final mDarkRippleColor:I
...
.field private mHoverClicked:Z

.field private mHovered:Z

.field private final mInterpolator:Landroid/view/animation/Interpolator;

.field private mIsMouseHovered:Z
...
.method static synthetic -get0(Lcom/android/systemui/statusbar/policy/KeyButtonRipple;)Z
    ...
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mHovered:Z

    return v0
.end method

.method static synthetic -get1(Lcom/android/systemui/statusbar/policy/KeyButtonRipple;)Z
    .locals 1
...
.method static synthetic -get2(Lcom/android/systemui/statusbar/policy/KeyButtonRipple;)Ljava/util/HashSet;
    .locals 1
...
.method static synthetic -set1(Lcom/android/systemui/statusbar/policy/KeyButtonRipple;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mHoverClicked:Z
...
.method private enterHardware()V
    ...
    invoke-direct {v1, v2, v5}, Landroid/view/RenderNodeAnimator;-><init>(Landroid/graphics/CanvasProperty;F)V
    ...
    invoke-direct {v0, v2, v5}, Landroid/view/RenderNodeAnimator;-><init>(Landroid/graphics/CanvasProperty;F)V
    ...
    :goto_2
    iput v8, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mGlowScale:F

    iget v2, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mRippleColor:I

    iget v3, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mDarkRippleColor:I
...
.method private setHovered(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->setHoveredHardware(Z)V

    :cond_0
    return-void
.end method

.method private setHoveredHardware(Z)V
    .locals 1

    if-eqz p1, :cond_1

    iget-boolean v0, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mHoverClicked:Z
    ...
    iput-boolean v0, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mHoverClicked:Z
...
.method protected onStateChange([I)Z
    ...
    :cond_0
    :goto_1
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mPressed:Z

    if-eq v2, v3, :cond_3

    iput-boolean v2, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mPressed:Z

    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->setPressed(Z)V

    return v5

    :cond_1
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mIsMouseHovered:Z
    ...
    :cond_3
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mHovered:Z

    if-eq v0, v3, :cond_4

    iput-boolean v0, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mHovered:Z

    invoke-direct {p0, v0}, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->setHovered(Z)V
...
.method public setMouseHoverState(Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mIsMouseHovered:Z
...
.method public setRippleColor(I)V
    ...
    iput p1, p0, Lcom/android/systemui/statusbar/policy/KeyButtonRipple;->mRippleColor:I
