...
.field private mInstantCollapseQs:Z
...
.method private onQsExpansionStarted(I)V
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->updateNewCustomTileList()V
...
.method private onQsTouch(Landroid/view/MotionEvent;)V
    ...
    iput v9, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mInitialTouchY:F

    iput v8, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mInitialTouchX:F

    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->onQsExpansionStarted()V

    iget v10, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mQsExpansionHeight:F

    iput v10, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mInitialHeightOnTouch:F
    ...
    :pswitch_3
    iget-boolean v11, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mInstantCollapseQs:Z
    ...
    invoke-virtual {v11}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->isCoveredState()Z
    ...
    iget v12, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mTouchSlop:I
    ...
    iget v12, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mInitialTouchX:F
    ...
    invoke-virtual {v11, v13}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->goToLockedShade(Landroid/view/View;)V
    ...
    invoke-direct {p0, v11}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->setQsExpansion(F)V
    ...
    iput-boolean v3, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mInstantCollapseQs:Z

    :cond_7
    :goto_3
    iget-object v10, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    :goto_4
    invoke-direct {p0, v9, v10}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->flingQsWithCurrentVelocity(FZ)V
...
.method private setQsExpansion(F)V
    ...
    const-string/jumbo v3, "Quick panel"

    invoke-static {v0, v2, v3}, Lcom/android/systemui/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public computeMaxKeyguardNotifications(I)I
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->isCoveredState()Z
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/systemui/cover/SViewCoverLauncher;->getSViewCoverHeight(Landroid/content/Context;)F
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->getKeyguardBottomStackSize()F
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->getHeight()I
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/systemui/cover/SViewCoverLauncher;->getSViewCoverShortcutContainerHeight(Landroid/content/Context;)F
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/keyguard/KeyguardRune;->isDcmLauncher(Landroid/content/Context;)Z
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaView;->getBottomAreaMaxHeight()I
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->getStatusBarNotification()Landroid/service/notification/StatusBarNotification;

    move-result-object v22

    invoke-virtual/range {v21 .. v22}, Lcom/android/systemui/statusbar/phone/NotificationGroupManager;->isSummaryOfSuppressedGroup(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-virtual/range {v21 .. v22}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->shouldShowOnKeyguard(Landroid/service/notification/StatusBarNotification;)Z
...
.method protected isBottomBarVisible()Z
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mNotificationStackScroller:Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->isBottomBarVisible()Z
...
.method public moveFocus(Landroid/view/View;I)V
    ...
    :sswitch_data_0
    .sparse-switch
        0x7f13016f -> :sswitch_0
        0x7f1304dd -> :sswitch_1
    .end sparse-switch
.end method
...
.method protected onExpandingFinished()V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/QuickStatusBarHeader;->isHeaderButtonClickable()Z
    ...
    invoke-virtual {v0, v4}, Lcom/android/systemui/statusbar/phone/QuickStatusBarHeader;->setHeaderButtonClickable(Z)V
...
.method protected onExpandingStarted()V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->updateNewCustomTileList()V
...
.method protected onFinishInflate()V
    ...
    new-instance v7, Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;

    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->getContext()Landroid/content/Context;

    move-result-object v8

    invoke-direct {v7, p0, v8}, Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;-><init>(Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper$Callback;Landroid/content/Context;)V

    iput-object v7, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mAfforanceHelper:Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;

    iget-object v7, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mKeyguardBottomArea:Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaView;

    iget-object v8, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mAfforanceHelper:Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;

    invoke-virtual {v7, v8}, Lcom/android/systemui/statusbar/phone/KeyguardBottomAreaView;->setAffordanceHelper(Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v4, v8}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->onActivationReset(Lcom/android/systemui/statusbar/ActivatableNotificationView;)V
    ...
    invoke-virtual {v4}, Lcom/android/systemui/swipe/SwipeAnimator;->isViRunning()Z
...
.method public setBarState(IZZ)V
    ...
    iput-boolean v4, p0, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->mInstantCollapseQs:Z
