...
.method constructor <init>(Lcom/android/systemui/statusbar/phone/PhoneStatusBar;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpNewlyVisibleNotifications:Landroid/util/ArraySet;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpCurrentlyVisibleNotifications:Landroid/util/ArraySet;

    new-instance v0, Landroid/util/ArraySet;

    invoke-direct {v0}, Landroid/util/ArraySet;-><init>()V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpNoLongerVisibleNotifications:Landroid/util/ArraySet;
...
.method public run()V
    ...
    iget-object v10, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->this$0:Lcom/android/systemui/statusbar/phone/PhoneStatusBar;
    ...
    invoke-static {v10}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->-get46(Lcom/android/systemui/statusbar/phone/PhoneStatusBar;)Lcom/android/systemui/statusbar/NotificationData;
    ...
    invoke-static {v10}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->-get56(Lcom/android/systemui/statusbar/phone/PhoneStatusBar;)Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;
    ...
    iget-object v10, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpCurrentlyVisibleNotifications:Landroid/util/ArraySet;

    invoke-virtual {v10, v8}, Landroid/util/ArraySet;->add(Ljava/lang/Object;)Z

    if-nez v7, :cond_0

    iget-object v10, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpNewlyVisibleNotifications:Landroid/util/ArraySet;
    ...
    :cond_3
    iget-object v9, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpNoLongerVisibleNotifications:Landroid/util/ArraySet;
    ...
    iget-object v9, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->this$0:Lcom/android/systemui/statusbar/phone/PhoneStatusBar;

    iget-object v10, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpNewlyVisibleNotifications:Landroid/util/ArraySet;

    iget-object v11, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpNoLongerVisibleNotifications:Landroid/util/ArraySet;
    ...
    invoke-static {v9, v10}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->-wrap32(Lcom/android/systemui/statusbar/phone/PhoneStatusBar;Landroid/util/ArraySet;)V
    ...
    iget-object v10, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpNoLongerVisibleNotifications:Landroid/util/ArraySet;

    invoke-static {v9, v10}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->-wrap32(Lcom/android/systemui/statusbar/phone/PhoneStatusBar;Landroid/util/ArraySet;)V

    iget-object v9, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpCurrentlyVisibleNotifications:Landroid/util/ArraySet;

    invoke-virtual {v9}, Landroid/util/ArraySet;->clear()V

    iget-object v9, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBar$11;->mTmpNewlyVisibleNotifications:Landroid/util/ArraySet;
