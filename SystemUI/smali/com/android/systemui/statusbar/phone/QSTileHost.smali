...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/systemui/statusbar/phone/QSTileHost$-java_util_List_loadTileSpecsFromCscFeature_java_lang_String_tileList_boolean_isFotaUpdate_LambdaImpl0;,
        Lcom/android/systemui/statusbar/phone/QSTileHost$-void_onTileStateChanged_java_lang_String_tileSpec_int_value_LambdaImpl0;,
        Lcom/android/systemui/statusbar/phone/QSTileHost$-void_onTuningChanged_java_lang_String_key_java_lang_String_newValue_LambdaImpl0;,
        Lcom/android/systemui/statusbar/phone/QSTileHost$-void_sendSATileList_java_util_LinkedHashMap_map_LambdaImpl0;,
        Lcom/android/systemui/statusbar/phone/QSTileHost$1;,
        Lcom/android/systemui/statusbar/phone/QSTileHost$2;,
        Lcom/android/systemui/statusbar/phone/QSTileHost$CustomTileListCallback;
    }
.end annotation
...
.field private mPrefLooper:Landroid/os/Looper;
...
.method static synthetic -get3(Lcom/android/systemui/statusbar/phone/QSTileHost;)Ljava/util/LinkedHashMap;
    .locals 1
...
.method static synthetic -get4(Lcom/android/systemui/statusbar/phone/QSTileHost;)Landroid/content/SharedPreferences$Editor;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->tileEditor:Landroid/content/SharedPreferences$Editor;
...
.method static synthetic -set1(Lcom/android/systemui/statusbar/phone/QSTileHost;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefInitialized:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/PhoneStatusBar;Lcom/android/systemui/statusbar/policy/BluetoothController;Lcom/android/systemui/statusbar/policy/LocationController;Lcom/android/systemui/statusbar/policy/RotationLockController;Lcom/android/systemui/statusbar/policy/NetworkController;Lcom/android/systemui/statusbar/policy/ZenModeController;Lcom/android/systemui/statusbar/policy/HotspotController;Lcom/android/systemui/statusbar/policy/CastController;Lcom/android/systemui/statusbar/policy/FlashlightController;Lcom/android/systemui/statusbar/policy/UserSwitcherController;Lcom/android/systemui/statusbar/policy/UserInfoController;Lcom/android/systemui/statusbar/policy/KeyguardMonitor;Lcom/android/systemui/statusbar/policy/SecurityController;Lcom/android/systemui/statusbar/policy/BatteryController;Lcom/android/systemui/statusbar/phone/StatusBarIconController;Lcom/android/systemui/statusbar/policy/NextAlarmController;)V
    ...
    iput-boolean v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mReloadTiles:Z
    ...
    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mTileSpecs:Ljava/util/ArrayList;

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mCallbacks:Ljava/util/List;

    const/4 v4, 0x0

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefHandler:Landroid/os/Handler;

    new-instance v4, Landroid/os/Handler;

    invoke-direct {v4}, Landroid/os/Handler;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mHandler:Landroid/os/Handler;

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mCustomTileListCallbacks:Ljava/util/List;

    new-instance v4, Lcom/android/systemui/statusbar/phone/QSTileHost$1;

    invoke-direct {v4, p0}, Lcom/android/systemui/statusbar/phone/QSTileHost$1;-><init>(Lcom/android/systemui/statusbar/phone/QSTileHost;)V

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mKnoxStateCallback:Lcom/android/keyguard/KnoxStateMonitorCallback;
    ...
    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mInitTilePrefRunnable:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mHotspot:Lcom/android/systemui/statusbar/policy/HotspotController;
    ...
    new-instance v4, Lcom/android/systemui/statusbar/phone/ManagedProfileController;

    invoke-direct {v4, p0}, Lcom/android/systemui/statusbar/phone/ManagedProfileController;-><init>(Lcom/android/systemui/statusbar/phone/QSTileHost;)V

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mProfileController:Lcom/android/systemui/statusbar/phone/ManagedProfileController;
    ...
    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mUserManager:Landroid/os/UserManager;
    ...
    const-string/jumbo v4, "prefThread"
    ...
    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefLooper:Landroid/os/Looper;

    new-instance v4, Landroid/os/Handler;

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefLooper:Landroid/os/Looper;

    invoke-direct {v4, v5}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefHandler:Landroid/os/Handler;

    new-instance v4, Lcom/android/systemui/qs/external/TileServices;

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mLooper:Landroid/os/Looper;

    invoke-direct {v4, p0, v5}, Lcom/android/systemui/qs/external/TileServices;-><init>(Lcom/android/systemui/statusbar/phone/QSTileHost;Landroid/os/Looper;)V

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mServices:Lcom/android/systemui/qs/external/TileServices;
    ...
    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->tilePref:Landroid/content/SharedPreferences;

    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->tilePref:Landroid/content/SharedPreferences;
    ...
    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->tileEditor:Landroid/content/SharedPreferences$Editor;
    ...
    iput-boolean v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefInitialized:Z
    ...
    const-string/jumbo v6, "sysui_qs_emergency_tiles"
    ...
    :goto_0
    new-instance v4, Lcom/android/systemui/statusbar/phone/AutoTileManager;

    invoke-direct {v4, p1, p0}, Lcom/android/systemui/statusbar/phone/AutoTileManager;-><init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/QSTileHost;)V

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mAutoTiles:Lcom/android/systemui/statusbar/phone/AutoTileManager;

    new-instance v3, Lcom/android/systemui/qs/SVoiceCommandReceiver;

    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4, p0}, Lcom/android/systemui/qs/SVoiceCommandReceiver;-><init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/QSTileHost;)V
    ...
    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mKnoxStateMonitor:Lcom/android/keyguard/KnoxStateMonitor;

    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mKnoxStateMonitor:Lcom/android/keyguard/KnoxStateMonitor;

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mKnoxStateCallback:Lcom/android/keyguard/KnoxStateMonitorCallback;

    invoke-virtual {v4, v5}, Lcom/android/keyguard/KnoxStateMonitor;->registerCallback(Lcom/android/keyguard/KnoxStateMonitorCallback;)V

    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mKnoxStateMonitor:Lcom/android/keyguard/KnoxStateMonitor;

    invoke-virtual {v4}, Lcom/android/keyguard/KnoxStateMonitor;->getQuickPanelItems()Ljava/util/List;

    move-result-object v4

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mKnoxBlockedQsTileList:Ljava/util/List;
    ...
    const-string/jumbo v6, "QSTileHost : mKnoxBlockedQsTileList"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mKnoxBlockedQsTileList:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mKnoxBlockedQsTileList:Ljava/util/List;

    if-eqz v4, :cond_2

    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mComponentNameTable:Ljava/util/Map;
    ...
    :cond_2
    new-instance v4, Lcom/android/systemui/qs/QSScreenGridDialog;

    invoke-direct {v4, p1}, Lcom/android/systemui/qs/QSScreenGridDialog;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mScreenGridDialog:Lcom/android/systemui/qs/QSScreenGridDialog;

    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mScreenGridDialog:Lcom/android/systemui/qs/QSScreenGridDialog;

    invoke-virtual {v4, p0}, Lcom/android/systemui/qs/QSScreenGridDialog;->setHost(Lcom/android/systemui/statusbar/phone/QSTileHost;)V
...
.method private getCustomTileList()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/QSTileHost;->isDefaultCustomTile(Landroid/content/ComponentName;)Z
...
.method private getRecalculatedTileListForFota(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_9
    const-string/jumbo v6, "VoiceWakeup"
...
.method private isAvailableCustomTile(Ljava/lang/String;)Z
    ...
    sget-boolean v7, Lcom/android/systemui/SystemUIRune;->SUPPORT_QS_ALWAYS_ON_DISPLAY:Z
    ...
    iget-object v7, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mUserManager:Landroid/os/UserManager;
    ...
    :cond_12
    const-string/jumbo v7, "com.android.settings/com.samsung.android.settings.qstile.BluelightFilterTiles"
    ...
    const-string/jumbo v7, "isAvailableCustomTile : BluelightFilterTiles is removed"
    ...
    :cond_13
    const-string/jumbo v7, "com.samsung.android.sm/.ui.booster.PerformanceTile"
    ...
    const-string/jumbo v7, "isAvailableCustomTile : old PerformanceTile is removed"
    ...
    :cond_14
    const-string/jumbo v7, "com.android.settings/.accounts.SecAccountTiles"
    ...
    const-string/jumbo v7, "isAvailableCustomTile : old SyncTile is removed"
    ...
    :cond_15
    const-string/jumbo v7, "com.android.settings/com.samsung.android.settings.powersaving.PowerSavingTile"
    ...
    const-string/jumbo v7, "isAvailableCustomTile : old PowerSavingTile is removed"
    ...
    :cond_16
    sget-boolean v7, Lcom/android/systemui/SystemUIRune;->SUPPORT_SINGLE_SMART_VIEW_APK:Z
    ...
    :cond_17
    const-string/jumbo v7, "com.samsung.android.lool/com.samsung.android.sm.ui.uds.UDSTile"
    ...
    const-string/jumbo v7, "isAvailableCustomTile : old UDSTile is removed"
...
.method private sendGsimTileList(Ljava/util/LinkedHashMap;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v3}, Lcom/android/systemui/statusbar/phone/QSTileHost;->getCustomTileNameFromSpec(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v6, v7, v8, v9}, Lcom/android/keyguard/util/GsimLogManager;->sendStatusLog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;)V

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mContext:Landroid/content/Context;

    const-string/jumbo v6, "com.android.systemui.statusbar.policy.quicksetting"

    const-string/jumbo v7, "QS15"
...
.method private sendSATileList(Ljava/util/LinkedHashMap;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/phone/QSTileHost;->getCustomTileNameFromSpec(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefHandler:Landroid/os/Handler;

    new-instance v5, Lcom/android/systemui/statusbar/phone/QSTileHost$-void_sendSATileList_java_util_LinkedHashMap_map_LambdaImpl0;

    invoke-direct {v5, p0, v3}, Lcom/android/systemui/statusbar/phone/QSTileHost$-void_sendSATileList_java_util_LinkedHashMap_map_LambdaImpl0;-><init>(Lcom/android/systemui/statusbar/phone/QSTileHost;Ljava/lang/StringBuilder;)V
...
# virtual methods
.method synthetic -com_android_systemui_statusbar_phone_QSTileHost_lambda$1(Ljava/util/Map$Entry;)V
    .locals 8
    ...
    invoke-virtual {p0, v3}, Lcom/android/systemui/statusbar/phone/QSTileHost;->changeOldOSTileNameToNewName(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/QSTileHost;->getCustomTileNameFromSpec(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    :goto_0
    sget-object v4, Lcom/android/systemui/SystemUIAnalytics;->mTileSAIdMap:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->tileEditor:Landroid/content/SharedPreferences$Editor;
    ...
    sget v5, Lcom/android/systemui/SystemUIAnalytics;->QUICKTILE_MAP_TOGGLE_EID:I
    ...
    const-string/jumbo v4, "SystemUIAnalytics"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "SAPreference : "
...
.method synthetic -com_android_systemui_statusbar_phone_QSTileHost_lambda$2(Ljava/lang/String;I)V
    .locals 7
    ...
    invoke-interface {v4, v2, p2}, Landroid/content/SharedPreferences$Editor;->putInt(Ljava/lang/String;I)Landroid/content/SharedPreferences$Editor;
    ...
    const-string/jumbo v6, "SAPreference error : "
...
.method synthetic -com_android_systemui_statusbar_phone_QSTileHost_lambda$3(Ljava/lang/StringBuilder;)V
    .locals 3
...
.method synthetic -com_android_systemui_statusbar_phone_QSTileHost_lambda$4()V
    .locals 6
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->tileEditor:Landroid/content/SharedPreferences$Editor;
...
.method public addCustomTileListCallback(Lcom/android/systemui/statusbar/phone/QSTileHost$CustomTileListCallback;)V
    .locals 9

    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mCustomTileListCallbacks:Ljava/util/List;
    ...
    :cond_1
    invoke-interface {p1, v1, v2}, Lcom/android/systemui/statusbar/phone/QSTileHost$CustomTileListCallback;->onCustomTileListChanged(Ljava/lang/String;I)V
...
.method public createTile(Ljava/lang/String;)Lcom/android/systemui/qs/QSTile;
    ...
    sget-boolean v2, Lcom/android/systemui/statusbar/phone/QSTileHost;->DEBUG:Z
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/qs/external/TileServices;->dump(Ljava/io/PrintWriter;)V
...
.method protected loadTileSpecsDex(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-virtual {p0, v7}, Lcom/android/systemui/statusbar/phone/QSTileHost;->changeOldOSTileNameToNewName(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v7}, Lcom/android/systemui/statusbar/phone/QSTileHost;->getCustomTileSpecFromTileName(Ljava/lang/String;)Ljava/lang/String;
...
.method protected loadTileSpecsFromCscFeature(Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-boolean v10, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefInitialized:Z
    ...
    :cond_b
    iget-object v10, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->tileEditor:Landroid/content/SharedPreferences$Editor;

    if-eqz v10, :cond_a

    iget-object v10, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefHandler:Landroid/os/Handler;

    new-instance v11, Lcom/android/systemui/statusbar/phone/QSTileHost$-java_util_List_loadTileSpecsFromCscFeature_java_lang_String_tileList_boolean_isFotaUpdate_LambdaImpl0;

    invoke-direct {v11, p0}, Lcom/android/systemui/statusbar/phone/QSTileHost$-java_util_List_loadTileSpecsFromCscFeature_java_lang_String_tileList_boolean_isFotaUpdate_LambdaImpl0;-><init>(Lcom/android/systemui/statusbar/phone/QSTileHost;)V
...
.method public onEmergencyModeChanged()V
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/systemui/statusbar/phone/QSTileHost$3;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/phone/QSTileHost$3;-><init>(Lcom/android/systemui/statusbar/phone/QSTileHost;)V
...
.method public onTileStateChanged(Ljava/lang/String;I)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/systemui/statusbar/phone/QSTileHost$-void_onTileStateChanged_java_lang_String_tileSpec_int_value_LambdaImpl0;

    invoke-direct {v1, p0, p1, p2}, Lcom/android/systemui/statusbar/phone/QSTileHost$-void_onTileStateChanged_java_lang_String_tileSpec_int_value_LambdaImpl0;-><init>(Lcom/android/systemui/statusbar/phone/QSTileHost;Ljava/lang/String;I)V
...
.method public onTuningChanged(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v12, "sysui_qs_emergency_tiles"
    ...
    :cond_0
    sget-boolean v12, Lcom/android/systemui/statusbar/phone/QSTileHost;->DEBUG:Z

    if-eqz v12, :cond_1

    const-string/jumbo v12, "QSTileHost"

    const-string/jumbo v13, "Recreating tiles"

    invoke-static {v12, v13}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_1
    const-string/jumbo v12, "sysui_qs_dex_tiles"
    ...
    iget-object v12, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    invoke-virtual {v0, v12}, Lcom/android/systemui/statusbar/phone/QSTileHost;->loadTileSpecsDex(Landroid/content/Context;)Ljava/util/List;
    ...
    iget-object v12, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mTileSpecs:Ljava/util/ArrayList;
    ...
    iget-boolean v1, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mReloadTiles:Z
    ...
    iget v12, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mCurrentUser:I
    ...
    invoke-virtual {v0, v12}, Lcom/android/systemui/statusbar/phone/QSTileHost;->loadTileSpecsUPSM(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-virtual {v0, v12, v1}, Lcom/android/systemui/statusbar/phone/QSTileHost;->loadTileSpecs(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v12, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mTiles:Ljava/util/LinkedHashMap;
    ...
    iget-object v12, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mPrefHandler:Landroid/os/Handler;

    new-instance v13, Lcom/android/systemui/statusbar/phone/QSTileHost$-void_onTuningChanged_java_lang_String_key_java_lang_String_newValue_LambdaImpl0;

    move-object/from16 v0, p0

    invoke-direct {v13, v0, v7}, Lcom/android/systemui/statusbar/phone/QSTileHost$-void_onTuningChanged_java_lang_String_key_java_lang_String_newValue_LambdaImpl0;-><init>(Lcom/android/systemui/statusbar/phone/QSTileHost;Ljava/util/Map$Entry;)V
    ...
    check-cast v12, Lcom/android/systemui/qs/QSTile;

    invoke-virtual {v12}, Lcom/android/systemui/qs/QSTile;->destroy()V
    ...
    instance-of v12, v6, Lcom/android/systemui/qs/external/CustomTile;
    ...
    :cond_b
    invoke-virtual {v6}, Lcom/android/systemui/qs/QSTile;->removeCallbacks()V
    ...
    invoke-virtual {v6, v2}, Lcom/android/systemui/qs/QSTile;->userSwitch(I)V
    ...
    invoke-virtual {v0, v9}, Lcom/android/systemui/statusbar/phone/QSTileHost;->createTile(Ljava/lang/String;)Lcom/android/systemui/qs/QSTile;

    move-result-object v6

    if-eqz v6, :cond_9

    invoke-virtual {v6, v9}, Lcom/android/systemui/qs/QSTile;->setTileSpec(Ljava/lang/String;)V
    ...
    const-string/jumbo v14, "Error creating tile for spec: "
    ...
    :cond_f
    sget-boolean v12, Lcom/android/systemui/SystemUIRune;->SUPPORT_GSIM_LOG:Z

    if-eqz v12, :cond_10

    move-object/from16 v0, p0

    invoke-direct {v0, v4}, Lcom/android/systemui/statusbar/phone/QSTileHost;->sendGsimTileList(Ljava/util/LinkedHashMap;)V

    :cond_10
    move-object/from16 v0, p0

    iput v2, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mCurrentUser:I
    ...
    iget-object v12, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mCallbacks:Ljava/util/List;
    ...
    check-cast v12, Lcom/android/systemui/qs/QSTile$Host$Callback;

    invoke-interface {v12}, Lcom/android/systemui/qs/QSTile$Host$Callback;->onTilesChanged()V
    ...
    invoke-direct {v0, v4}, Lcom/android/systemui/statusbar/phone/QSTileHost;->sendSATileList(Ljava/util/LinkedHashMap;)V
    ...
    iget-object v13, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mInitTilePrefRunnable:Ljava/lang/Runnable;
...
.method public refreshTileList()V
    ...
    invoke-static {v11}, Lcom/android/systemui/statusbar/DeviceState;->isDesktopMode(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v11}, Lcom/android/systemui/statusbar/phone/QSTileHost;->loadTileSpecsDex(Landroid/content/Context;)Ljava/util/List;
    ...
    :cond_b
    sget-boolean v11, Lcom/android/systemui/SystemUIRune;->SUPPORT_GSIM_LOG:Z

    if-eqz v11, :cond_c

    invoke-direct {p0, v2}, Lcom/android/systemui/statusbar/phone/QSTileHost;->sendGsimTileList(Ljava/util/LinkedHashMap;)V
...
.method public removeCustomTileListCallback(Lcom/android/systemui/statusbar/phone/QSTileHost$CustomTileListCallback;)V
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mCustomTileListCallbacks:Ljava/util/List;
...
.method public resetNewCustomTileList()V
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mCustomTileListCallbacks:Ljava/util/List;
    ...
    check-cast v1, Lcom/android/systemui/statusbar/phone/QSTileHost$CustomTileListCallback;

    const-string/jumbo v2, ""

    const/4 v3, 0x0

    invoke-interface {v1, v2, v3}, Lcom/android/systemui/statusbar/phone/QSTileHost$CustomTileListCallback;->onCustomTileListChanged(Ljava/lang/String;I)V
...
.method public setQSPanelGrid(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/qs/QSScreenGridDialog;->setQSPanelGrid(I)Z
...
.method public shouldBeHiddenByKnox(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/QSTileHost;->getCustomTileSpecFromTileName(Ljava/lang/String;)Ljava/lang/String;
...
.method public updateNewCustomTileList()V
    ...
    :cond_1
    invoke-direct/range {p0 .. p0}, Lcom/android/systemui/statusbar/phone/QSTileHost;->getCustomTileList()Ljava/lang/String;
    ...
    sget-boolean v15, Lcom/android/systemui/statusbar/phone/QSTileHost;->DEBUG:Z
    ...
    iget-object v12, v0, Lcom/android/systemui/statusbar/phone/QSTileHost;->mCustomTileListCallbacks:Ljava/util/List;
    ...
    check-cast v12, Lcom/android/systemui/statusbar/phone/QSTileHost$CustomTileListCallback;

    invoke-interface {v12, v7, v8}, Lcom/android/systemui/statusbar/phone/QSTileHost$CustomTileListCallback;->onCustomTileListChanged(Ljava/lang/String;I)V
