...
# instance fields
.field private batteryDarkModeAlpha:F

.field private batteryLightModeAlpha:F
...
.field protected mBatteryText:Landroid/widget/TextView;
...
.field private mKeyguardBatteryRoot:Landroid/widget/FrameLayout;

.field private mKeyguardBatteryText:Landroid/widget/TextView;

.field private mKeyguardCarrierText:Landroid/widget/TextView;

.field private mKeyguardClock:Lcom/android/systemui/statusbar/policy/Clock;

.field protected mKeyguardNetspeedView:Lcom/android/systemui/statusbar/policy/NetspeedView;
...
.field private mStatusBarBatteryRoot:Landroid/widget/FrameLayout;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;Landroid/view/View;Lcom/android/systemui/statusbar/phone/PhoneStatusBar;)V
    ...
    iput-object v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mKeyguardBatteryRoot:Landroid/widget/FrameLayout;

    sget-boolean v2, Lcom/android/systemui/SystemUIRune;->SUPPORT_SEC_BATTERY_GUI:Z
    ...
    iput v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->batteryLightModeAlpha:F
    ...
    iput v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->batteryDarkModeAlpha:F

    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mStatusBarBatteryRoot:Landroid/widget/FrameLayout;

    iget v3, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->batteryLightModeAlpha:F

    invoke-virtual {v2, v3}, Landroid/widget/FrameLayout;->setAlpha(F)V

    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mKeyguardBatteryRoot:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {v2, v5}, Lcom/android/systemui/BatteryMeterView;->setDesktopMode(Z)V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->getClockTweak()Z
    ...
    iput-object v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mCenterClock:Lcom/android/systemui/statusbar/policy/Clock;
    ...
    iput-object v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mLeftClock:Lcom/android/systemui/statusbar/policy/Clock;
    ...
    iput-object v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mKeyguardClock:Lcom/android/systemui/statusbar/policy/Clock;
...
.method private clearLaunchableIcons(Landroid/view/ViewGroup;)V
    .locals 4
    ...
    instance-of v3, v1, Lcom/android/systemui/statusbar/phone/taskbar/desk/LaunchableIconView;
...
.method private deferIconTintChange(ZF)V
    .locals 1
    ...
    iput p2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mPendingDarkIntensity:F
...
.method private setBatteryViewAlpha(F)V
    .locals 4

    iget v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->batteryLightModeAlpha:F

    iget v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->batteryDarkModeAlpha:F
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mStatusBarBatteryRoot:Landroid/widget/FrameLayout;

    invoke-virtual {v1, v0}, Landroid/widget/FrameLayout;->setAlpha(F)V

    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mKeyguardBatteryRoot:Landroid/widget/FrameLayout;
...
.method private updateClock()V
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mClock:Lcom/android/systemui/statusbar/policy/Clock;
    ...
    invoke-virtual {v0, v1, v3, v2, v3}, Lcom/android/systemui/statusbar/policy/Clock;->setPaddingRelative(IIII)V

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mKeyguardClock:Lcom/android/systemui/statusbar/policy/Clock;
...
.method protected applyIconTint()V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->updateClockPosition()V
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mCenterClock:Lcom/android/systemui/statusbar/policy/Clock;

    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mTintArea:Landroid/graphics/Rect;

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mCenterClock:Lcom/android/systemui/statusbar/policy/Clock;
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mLeftClock:Lcom/android/systemui/statusbar/policy/Clock;

    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mTintArea:Landroid/graphics/Rect;

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mLeftClock:Lcom/android/systemui/statusbar/policy/Clock;
    ...
    :cond_2
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mKeyguardClock:Lcom/android/systemui/statusbar/policy/Clock;
    ...
    invoke-direct {p0, v2}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setBatteryViewAlpha(F)V
...
.method public clear()V
    ...
    invoke-direct {p0, v0}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->clearLaunchableIcons(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/NotificationIconAreaController;->clear()V
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    :cond_2
    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mClock:Lcom/android/systemui/statusbar/policy/Clock;

    invoke-virtual {v4, p1}, Lcom/android/systemui/statusbar/policy/Clock;->dumpClock(Ljava/io/PrintWriter;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->startClockActivity()V
...
.method protected scaleBatteryMeterViews(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v3}, Lcom/android/systemui/BatteryMeterView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public setClockVisibility(Z)V
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mClock:Lcom/android/systemui/statusbar/policy/Clock;
...
.method public setIconsDark(ZZ)V
    ...
    :goto_2
    invoke-direct {p0, p1, v0}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->deferIconTintChange(ZF)V
...
.method updateClockPosition()V
    ...
    const-string/jumbo v1, "clock_position"
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mCenterClock:Lcom/android/systemui/statusbar/policy/Clock;
    ...
    :cond_2
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mLeftClock:Lcom/android/systemui/statusbar/policy/Clock;
...
.method public updateNetspeedViewVisibility(Z)V
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->mNetspeedView:Lcom/android/systemui/statusbar/policy/NetspeedView;

    invoke-virtual {v0, p1}, Lcom/android/systemui/statusbar/policy/NetspeedView;->setNetspeedViewVisibility(Z)V
