...
.field private mCoverStateCovered:Z
...
.field private mLastCoverStateCovered:Z
...
.method static synthetic -get1(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic -get6(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)Lcom/android/keyguard/wallpaper/KeyguardWallpaperController;
    .locals 1
...
.method static synthetic -set1(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mDeferScrimFadeOut:Z

    return p1
.end method

.method static synthetic -set2(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;Landroid/view/ViewTreeObserver$OnPreDrawListener;)Landroid/view/ViewTreeObserver$OnPreDrawListener;
    .locals 0
...
.method private animateScrimControllerKeyguardFadingOut(JJLjava/lang/Runnable;Z)V
    ...
    new-instance v6, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$10;

    invoke-direct {v6, p0, p5}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$10;-><init>(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;Ljava/lang/Runnable;)V
...
.method public dismissWithAction(Lcom/android/keyguard/KeyguardHostView$OnDismissAction;Ljava/lang/Runnable;ZZ)V
    ...
    :cond_3
    iput-boolean v2, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mIsNotiClickedOnShadeLocked:Z

    :cond_4
    :goto_1
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mPhoneStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBar;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->getDeskPanel()Lcom/android/systemui/statusbar/phone/taskbar/desk/DeskPanel;
    ...
    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/phone/taskbar/desk/DeskPanel;->collapseAll(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/systemui/statusbar/phone/KeyguardBouncer;->show(Z)V
...
.method protected getLastNavBarVisible()Z
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mLastCoverStateCovered:Z
...
.method public hide(JJ)V
    ...
    iget-object v5, v0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mPhoneStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBar;

    invoke-virtual {v5}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->isInLaunchTransition()Z

    move-result v5

    if-nez v5, :cond_3

    sget-boolean v5, Lcom/android/keyguard/KeyguardRune;->SUPPORT_UNLOCK_VI:Z
    ...
    invoke-static {v5}, Lcom/android/keyguard/KeyguardRune;->isDcmLauncher(Landroid/content/Context;)Z
    ...
    new-instance v12, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$6;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$6;-><init>(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)V

    invoke-virtual {v5, v6, v12}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->fadeKeyguardAfterLaunchTransition(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    ...
    invoke-virtual/range {v5 .. v11}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->setKeyguardFadingAway(JJJ)V
    ...
    iget-object v5, v0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mWallpaperController:Lcom/android/keyguard/wallpaper/KeyguardWallpaperController;

    const/4 v6, 0x1

    invoke-virtual {v5, v6}, Lcom/android/keyguard/wallpaper/KeyguardWallpaperController;->setKeyguardFadingAway(Z)V

    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mPhoneStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBar;

    invoke-virtual {v5}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->fadeKeyguardWhilePulsing()V

    const-wide/16 v6, 0x0

    const-wide/16 v8, 0xf0

    new-instance v10, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$8;

    move-object/from16 v0, p0

    invoke-direct {v10, v0}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$8;-><init>(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)V
    ...
    invoke-virtual {v5, v6}, Lcom/android/keyguard/wallpaper/KeyguardWallpaperController;->setKeyguardShowing(Z)V
    ...
    invoke-virtual {v5}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->hideKeyguard()Z
    ...
    sget-boolean v5, Lcom/android/keyguard/KeyguardRune;->SUPPORT_SEC_WAKE_ON_FINGERPRINT:Z
    ...
    iget-boolean v5, v0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mScreenTurnedOn:Z
    ...
    iput-boolean v5, v0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mDeferScrimFadeOut:Z
    ...
    invoke-virtual {v5}, Lcom/android/keyguard/wallpaper/KeyguardWallpaperController;->getWallpaperRootView()Landroid/view/View;
    ...
    new-instance v5, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$9;

    move-object/from16 v6, p0

    invoke-direct/range {v5 .. v11}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$9;-><init>(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;Landroid/view/View;JJ)V

    move-object/from16 v0, p0

    iput-object v5, v0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mWallpaperDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    invoke-direct/range {v13 .. v18}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->animateScrimControllerKeyguardFadingOut(JJZ)V
    ...
    invoke-virtual {v5, v14, v15, v0, v1}, Lcom/android/systemui/statusbar/phone/ScrimController;->animateGoingToFullShade(JJ)V

    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mPhoneStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBar;

    invoke-virtual {v5}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->finishKeyguardFadingAway()V
...
.method protected isNavBarVisible()Z
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mCoverStateCovered:Z
...
.method public onActivityDrawn()V
    ...
    new-instance v1, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$11;

    invoke-direct {v1, p0}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager$11;-><init>(Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;)V
...
.method public onDensityOrFontScaleChanged()V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->isMirrorLinkEnabled()Z
    ...
    const-string/jumbo v1, "onDensityOrFontScaleChanged( need to re-create the bouncer view )"
...
.method public onStartedWakingUpWithReason(I)V
    ...
    const-string/jumbo v0, "StatusBarKeyguardViewManager#onStartedWakingUpWithReason"
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->onStartedWakingUpwithReason(I)V
...
.method public startDCMPreHideAnimation(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->fadeKeyguardOnlyForDCM(Ljava/lang/Runnable;)V
...
.method protected updateStates()V
    ...
    invoke-virtual {v11}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->isCoverViewShowing()Z

    move-result v11

    iput-boolean v11, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mCoverStateCovered:Z
    ...
    sget-boolean v11, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->SAFE_DEBUG:Z
    ...
    const-string/jumbo v13, "updateStates() navBarVisible="
    ...
    const-string/jumbo v13, ", lastNavBarVisible="
    ...
    invoke-virtual {v11}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->getVisibility()I
    ...
    iget-object v12, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mPhoneStatusBar:Lcom/android/systemui/statusbar/phone/PhoneStatusBar;
    ...
    :goto_7
    invoke-virtual {v12, v11}, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;->setBouncerShowing(Z)V
    ...
    iget-boolean v11, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mCoverStateCovered:Z

    iput-boolean v11, p0, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->mLastCoverStateCovered:Z
