...
.method static synthetic -get3(Lcom/android/systemui/ExpandHelper;)Z
    .locals 1
...
.method static synthetic -get4(Lcom/android/systemui/ExpandHelper;)Lcom/android/systemui/statusbar/ExpandableView;
    .locals 1
...
.method static synthetic -get5(Lcom/android/systemui/ExpandHelper;)Landroid/animation/ObjectAnimator;
    .locals 1
...
.method private finishExpanding(ZF)V
    ...
    :cond_0
    iget-object v10, p0, Lcom/android/systemui/ExpandHelper;->mScaler:Lcom/android/systemui/ExpandHelper$ViewScaler;

    invoke-virtual {v10}, Lcom/android/systemui/ExpandHelper$ViewScaler;->getHeight()F
    ...
    iget v10, p0, Lcom/android/systemui/ExpandHelper;->mOldHeight:F
    ...
    invoke-virtual {v10}, Lcom/android/systemui/ExpandHelper$ViewScaler;->getNaturalHeight()I
    ...
    :goto_1
    iget v10, p0, Lcom/android/systemui/ExpandHelper;->mNaturalHeight:F
    ...
    :cond_2
    iget-object v10, p0, Lcom/android/systemui/ExpandHelper;->mCallback:Lcom/android/systemui/ExpandHelper$Callback;

    const/4 v11, 0x0

    invoke-interface {v10, v11}, Lcom/android/systemui/ExpandHelper$Callback;->expansionStateChanged(Z)V
    ...
    invoke-virtual {v10}, Landroid/animation/ObjectAnimator;->setupStartValues()V
    ...
    invoke-direct {v11, p0, v7, v5}, Lcom/android/systemui/ExpandHelper$2;-><init>(Lcom/android/systemui/ExpandHelper;Landroid/view/View;Z)V
    ...
    :goto_5
    iget-object v10, p0, Lcom/android/systemui/ExpandHelper;->mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;

    iget-object v11, p0, Lcom/android/systemui/ExpandHelper;->mScaleAnimation:Landroid/animation/ObjectAnimator;

    invoke-virtual {v10, v11, v0, v8, p2}, Lcom/android/systemui/statusbar/FlingAnimationUtils;->apply(Landroid/animation/Animator;FFF)V
    ...
    :cond_e
    sget-object v12, Lcom/android/systemui/SystemUIAnalytics;->mCurrentScreenID:Ljava/lang/String;

    if-eqz v5, :cond_10

    if-eqz v3, :cond_f

    const-string/jumbo v10, "1123"

    :goto_7
    iget-boolean v11, p0, Lcom/android/systemui/ExpandHelper;->mIsMultiTouch:Z

    if-eqz v11, :cond_12

    const-string/jumbo v11, "Two finger swipe"

    :goto_8
    invoke-static {v12, v10, v11}, Lcom/android/systemui/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v10, p0, Lcom/android/systemui/ExpandHelper;->mCallback:Lcom/android/systemui/ExpandHelper$Callback;

    iget-object v11, p0, Lcom/android/systemui/ExpandHelper;->mResizedView:Lcom/android/systemui/statusbar/ExpandableView;

    invoke-interface {v10, v11, v5}, Lcom/android/systemui/ExpandHelper$Callback;->setUserExpandedChild(Landroid/view/View;Z)V
    ...
    invoke-interface {v10, v11, v12}, Lcom/android/systemui/ExpandHelper$Callback;->setUserLockedChild(Landroid/view/View;Z)V

    goto :goto_6

    :cond_f
    const-string/jumbo v10, "1121"
    ...
    const-string/jumbo v10, "1124"

    goto :goto_7

    :cond_11
    const-string/jumbo v10, "1122"

    goto :goto_7

    :cond_12
    const-string/jumbo v11, "One finger swipe"
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v7, p0, Lcom/android/systemui/ExpandHelper;->mIsMultiTouch:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v10, p0, Lcom/android/systemui/ExpandHelper;->mIsMultiTouch:Z
    ...
    iput-boolean v11, p0, Lcom/android/systemui/ExpandHelper;->mIsMultiTouch:Z
