...
.method static synthetic -get6(Lcom/android/systemui/ExpandHelper;)Lcom/android/systemui/ExpandHelper$ViewScaler;
    .locals 1
...
.method finishExpanding(ZF)V
    ...
    invoke-virtual {v9}, Lcom/android/systemui/ExpandHelper$ViewScaler;->getHeight()F

    move-result v0

    iget v9, p0, Lcom/android/systemui/ExpandHelper;->mOldHeight:F
    ...
    invoke-virtual {v9}, Lcom/android/systemui/ExpandHelper$ViewScaler;->getNaturalHeight()I
    ...
    iget-boolean v9, p0, Lcom/android/systemui/ExpandHelper;->mEnabled:Z
    ...
    invoke-virtual {v9, v10}, Landroid/animation/ObjectAnimator;->setFloatValues([F)V
    ...
    invoke-direct {v10, p0, v6, v1}, Lcom/android/systemui/ExpandHelper$2;-><init>(Lcom/android/systemui/ExpandHelper;Landroid/view/View;Z)V
    ...
    :goto_6
    iget-object v9, p0, Lcom/android/systemui/ExpandHelper;->mFlingAnimationUtils:Lcom/android/systemui/statusbar/FlingAnimationUtils;

    iget-object v10, p0, Lcom/android/systemui/ExpandHelper;->mScaleAnimation:Landroid/animation/ObjectAnimator;

    invoke-virtual {v9, v10, v0, v7, p2}, Lcom/android/systemui/statusbar/FlingAnimationUtils;->apply(Landroid/animation/Animator;FFF)V
    ...
    instance-of v9, v9, Lcom/android/systemui/statusbar/ExpandableNotificationRow;
    ...
    :cond_e
    sget-object v11, Lcom/android/systemui/SystemUIAnalytics;->mCurrentScreenID:Ljava/lang/String;

    if-eqz v4, :cond_11

    if-eqz v2, :cond_10

    const-string/jumbo v9, "1123"

    :goto_8
    iget-boolean v10, p0, Lcom/android/systemui/ExpandHelper;->mIsMultiTouch:Z

    if-eqz v10, :cond_13

    const-string/jumbo v10, "Two finger swipe"

    :goto_9
    invoke-static {v11, v9, v10}, Lcom/android/systemui/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v7}, Lcom/android/systemui/ExpandHelper$ViewScaler;->setHeight(F)V
    ...
    invoke-interface {v9, v10, v4}, Lcom/android/systemui/ExpandHelper$Callback;->setUserExpandedChild(Landroid/view/View;Z)V
    ...
    invoke-interface {v9, v10, v11}, Lcom/android/systemui/ExpandHelper$Callback;->setUserLockedChild(Landroid/view/View;Z)V

    iget-object v9, p0, Lcom/android/systemui/ExpandHelper;->mScaler:Lcom/android/systemui/ExpandHelper$ViewScaler;

    const/4 v10, 0x0

    invoke-virtual {v9, v10}, Lcom/android/systemui/ExpandHelper$ViewScaler;->setView(Lcom/android/systemui/statusbar/ExpandableView;)V

    goto :goto_7

    :cond_10
    const-string/jumbo v9, "1121"
    ...
    const-string/jumbo v9, "1124"

    goto :goto_8

    :cond_12
    const-string/jumbo v9, "1122"

    goto :goto_8

    :cond_13
    const-string/jumbo v10, "One finger swipe"
