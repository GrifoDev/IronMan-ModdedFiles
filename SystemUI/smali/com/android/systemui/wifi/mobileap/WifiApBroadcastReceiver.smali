...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string/jumbo v25, "SystemUI_WifiApBroadcastReceiver"

    new-instance v26, Ljava/lang/StringBuilder;

    invoke-direct/range {v26 .. v26}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v27, "onReceive: action "
    ...
    const-string/jumbo v26, "action is null"
    ...
    :cond_0
    const-string/jumbo v25, "android.intent.action.BOOT_COMPLETED"
    ...
    sput-boolean v25, Lcom/android/systemui/wifi/mobileap/WifiApBroadcastReceiver;->mIsBootComplete:Z

    :cond_1
    const-string/jumbo v25, "com.samsung.android.net.wifi.WIFI_AP_STA_ASSOCIATED_ACTION"
    ...
    const-string/jumbo v25, "extra"

    const-string/jumbo v26, "Hotspot_conn"
    ...
    const-string/jumbo v26, "onReceive: WIFI_AP_STA_ASSOCIATED_ACTION"
    ...
    const-string/jumbo v27, "onReceive END: action "
    ...
    :cond_3
    const-string/jumbo v25, "com.samsung.settings.WIFI_AP_SEC_SETTINGS"
    ...
    :cond_4
    const-string/jumbo v25, "com.samsung.intent.action.MIP_ERROR"
    ...
    const-string/jumbo v25, "com.samsung.android.intent.action.TETHERING_DENIED"
    ...
    const-string/jumbo v25, "com.samsung.android.intent.action.TETHERING_FAILED"
    ...
    const-string/jumbo v25, "SPRINT"

    sget-object v26, Lcom/android/systemui/wifi/mobileap/WifiApBroadcastReceiver;->CONFIGOPBRANDINGFORMOBILEAP:Ljava/lang/String;
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/net/wifi/WifiManager;->getWifiApState()I
    ...
    const-string/jumbo v27, "Mobile AP is disabled by [USA OPEN (SPR)] don\'t : "
    ...
    invoke-virtual/range {v24 .. v26}, Landroid/net/wifi/WifiManager;->setWifiApEnabled(Landroid/net/wifi/WifiConfiguration;Z)Z
    ...
    const-string/jumbo v26, "wifi_saved_state"

    invoke-static/range {v25 .. v26}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I
    :try_end_1
    ...
    const-string/jumbo v26, "Need to enabled Wifi since provision dialog got dismissed in onPause"
    ...
    const-string/jumbo v26, "SettingNotFoundException"
    ...
    const-string/jumbo v27, "mipErrorCode : "
    ...
    const-string/jumbo v26, "do NOT turn off MHS when DIALOG_HOTSPOT_NO_DATA , spr new requirement!!!!"
    ...
    :cond_b
    const-string/jumbo v25, "com.samsung.android.intent.action.WIFI_ENABLE_WARNING"
    ...
    :cond_c
    const-string/jumbo v25, "com.samsung.android.intent.action.WIFI_P2P_ENABLE_WARNING"
    ...
    :cond_d
    const-string/jumbo v25, "req_type"
    ...
    const-string/jumbo v25, "extra_type"
    ...
    :cond_e
    const-string/jumbo v25, "com.samsung.android.intent.action.WIFI_AP_ENABLE_WARNING"
    ...
    const-string/jumbo v26, "onReceive: WIFIAP_ENABLE_WARNING"
    ...
    const-string/jumbo v25, "android.intent.action.RADIO_TECHNOLOGY"
    ...
    :cond_10
    const-string/jumbo v25, "phoneName"
    ...
    const-string/jumbo v27, "Receive android.intent.action.RADIO_TECHNOLOGY, phoneType = "
    ...
    :try_start_2
    const-string/jumbo v25, "chameleon_gsmmaxuser"
    ...
    :cond_11
    :goto_3
    invoke-virtual/range {v24 .. v24}, Landroid/net/wifi/WifiManager;->getWifiApConfiguration()Landroid/net/wifi/WifiConfiguration;
    ...
    const-string/jumbo v27, "maxClientNum = "
    ...
    const-string/jumbo v25, "maxClient"
    ...
    :try_start_3
    const-string/jumbo v25, "chameleon_maxuser"
    ...
    :cond_14
    sget-boolean v25, Lcom/android/systemui/wifi/mobileap/WifiApBroadcastReceiver;->SUPPORTMOBILEAPWPSPBC:Z

    if-eqz v25, :cond_15

    const-string/jumbo v25, "com.nttdocomo.intent.action.SHOW_WPSDIALOG"
    ...
    :cond_15
    sget-object v25, Lcom/android/systemui/wifi/mobileap/WifiApBroadcastReceiver;->mHotspotActionForSimStatus:Ljava/lang/String;

    if-eqz v25, :cond_17

    sget-object v25, Lcom/android/systemui/wifi/mobileap/WifiApBroadcastReceiver;->mHotspotActionForSimStatus:Ljava/lang/String;

    const-string/jumbo v26, "turn off"
    ...
    const-string/jumbo v25, "android.intent.action.SIM_STATE_CHANGED"
    ...
    sget-boolean v25, Lcom/android/systemui/wifi/mobileap/WifiApBroadcastReceiver;->mIsBootComplete:Z
    ...
    const-string/jumbo v27, "Recieve Sim State Changed : "
    ...
    const-string/jumbo v27, "INTENT_VALUE_ICC_IMSI changed mccmnc old = "

    invoke-virtual/range {v26 .. v27}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v26

    sget-object v27, Lcom/android/systemui/wifi/mobileap/WifiApBroadcastReceiver;->currentMccMnc:Ljava/lang/String;
    ...
    sput-object v25, Lcom/android/systemui/wifi/mobileap/WifiApBroadcastReceiver;->currentMccMnc:Ljava/lang/String;
    ...
    :cond_17
    const-string/jumbo v25, "com.samsung.intent.action.PROVISION_DIALOG_DISMISSED"
    ...
    :cond_18
    const-string/jumbo v25, "com.samsung.android.net.wifi.WIFI_AP_STA_STATUS_CHANGED"
    ...
    sget-boolean v25, Lcom/android/systemui/wifi/mobileap/WifiApBroadcastReceiver;->DBG:Z

    if-eqz v25, :cond_2

    const-string/jumbo v25, "NUM"
    ...
    const-string/jumbo v27, "MHSPing WIFI_AP_STA_STATUS_CHANGED_ACTION ClientNum "
    ...
    const-string/jumbo v17, "/sdcard/mhspingstop"
    ...
    const-string/jumbo v27, "MHSPing "
    ...
    const-string/jumbo v27, " is exist!!! pingClear"
    ...
    const-string/jumbo v27, " is NOT exist"
    ...
    :cond_1b
    const-string/jumbo v25, "android.net.wifi.WIFI_AP_STATE_CHANGED"
