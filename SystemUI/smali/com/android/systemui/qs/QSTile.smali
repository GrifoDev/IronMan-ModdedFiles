...
.field public static final MAX_FORCE_REFRESH_COUNT:I = 0x3
...
.method static synthetic -wrap5(Lcom/android/systemui/qs/QSTile;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/systemui/qs/QSTile;->handleScrollToDetail(II)V
...
.method static synthetic -wrap7(Lcom/android/systemui/qs/QSTile;Z)V
    .locals 0
...
.method static synthetic -wrap8(Lcom/android/systemui/qs/QSTile;)V
    .locals 0
...
.method private handleScrollToDetail(II)V
    ...
    invoke-interface {v1, p1, p2}, Lcom/android/systemui/qs/QSTile$Callback;->onScrollToDetail(II)V
...
.method public click()V
    ...
    iget-boolean v2, v2, Lcom/android/systemui/qs/QSTile$State;->isCustomTile:Z
    ...
    const-string/jumbo v4, "QP06"

    iget-object v5, p0, Lcom/android/systemui/qs/QSTile;->mState:Lcom/android/systemui/qs/QSTile$State;

    iget-object v5, v5, Lcom/android/systemui/qs/QSTile$State;->tileClassName:Ljava/lang/String;
    ...
    iget-object v1, v2, Lcom/android/systemui/qs/QSTile$State;->tileClassName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lcom/android/systemui/qs/QSTile;->getLoggingValue(Z)I
    ...
    invoke-virtual {v2, v3}, Lcom/android/systemui/qs/QSTile$H;->sendEmptyMessage(I)Z
...
.method public fireScrollToDetail(II)V
    ...
    invoke-virtual {v0, v1, p1, p2}, Lcom/android/systemui/qs/QSTile$H;->obtainMessage(III)Landroid/os/Message;
...
.method public getLoggingValue(Z)I
    ...
    :cond_1
    iget-object v0, p0, Lcom/android/systemui/qs/QSTile;->mTmpState:Lcom/android/systemui/qs/QSTile$State;
...
.method protected handleRefreshState(Ljava/lang/Object;)V
    ...
    iget-boolean v1, v3, Lcom/android/systemui/qs/QSTile$BooleanState;->value:Z

    iget-object v3, p0, Lcom/android/systemui/qs/QSTile;->mState:Lcom/android/systemui/qs/QSTile$State;

    check-cast v3, Lcom/android/systemui/qs/QSTile$BooleanState;

    iget-boolean v2, v3, Lcom/android/systemui/qs/QSTile$BooleanState;->value:Z

    if-eq v1, v2, :cond_0

    iget-object v3, p0, Lcom/android/systemui/qs/QSTile;->mTileSpec:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/systemui/qs/QSTile;->mTileSpec:Ljava/lang/String;

    const/4 v5, 0x0

    invoke-virtual {p0, v5}, Lcom/android/systemui/qs/QSTile;->getLoggingValue(Z)I

    move-result v5

    invoke-interface {v3, v4, v5}, Lcom/android/systemui/qs/QSTile$Host;->onTileStateChanged(Ljava/lang/String;I)V
...
.method public setListening(Ljava/lang/Object;Z)V
    ...
    invoke-interface {v0}, Lcom/android/systemui/qs/QSTile$Host;->isDeskMode()Z
    ...
    invoke-virtual {v0, v3, v2, v1}, Lcom/android/systemui/qs/QSTile$H;->obtainMessage(III)Landroid/os/Message;
    ...
    invoke-virtual {v0, v3, v1, v1}, Lcom/android/systemui/qs/QSTile$H;->obtainMessage(III)Landroid/os/Message;
