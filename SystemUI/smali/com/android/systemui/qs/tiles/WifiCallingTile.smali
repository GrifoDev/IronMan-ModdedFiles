...
# instance fields
.field private final ENTITLEMENT_CANNOT_BE_ACTIVATED:I

.field private final ENTITLEMENT_CAN_BE_ACTIVATED:I

.field private final ENTITLEMENT_IN_PROGRESS:I

.field private final ENTITLEMENT_WEB_VIEW:I
...
.method public constructor <init>(Lcom/android/systemui/qs/QSHost;)V
    ...
    iput v4, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->ENTITLEMENT_CANNOT_BE_ACTIVATED:I

    iput v3, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->ENTITLEMENT_IN_PROGRESS:I

    const/4 v5, 0x2

    iput v5, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->ENTITLEMENT_WEB_VIEW:I

    const/4 v5, 0x3

    iput v5, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->ENTITLEMENT_CAN_BE_ACTIVATED:I
...
.method private changeState(Z)Z
    ...
    :cond_5
    sget-boolean v0, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_ENTITLEMENT_FOR_ORANGE_OPERATOR:Z
    ...
    invoke-static {v0, v10}, Lcom/android/systemui/statusbar/DeviceState;->getImsManager(Landroid/content/Context;I)Lcom/sec/ims/ImsManager;

    move-result-object v8

    if-eqz v8, :cond_6

    invoke-virtual {v8, v10}, Lcom/sec/ims/ImsManager;->getVoWiFiActivationMode(I)I
    ...
    const-string/jumbo v2, "getVoWiFiActivationMode : "
    ...
    const-string/jumbo v1, "entitlement can not be activated "
    ...
    const-string/jumbo v1, "entitlement show web view "

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {v8, v10}, Lcom/sec/ims/ImsManager;->openVoWiFiWebSheet(I)V
    ...
    const-string/jumbo v1, "entitlement in progress"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {v8, v10}, Lcom/sec/ims/ImsManager;->getVoWiFiPopupMessage(I)Ljava/lang/String;
    ...
    new-instance v1, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$3;

    invoke-direct {v1, p0}, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$3;-><init>(Ljava/lang/Object;)V
    ...
    new-instance v4, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$4;

    invoke-direct {v4, p0}, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$4;-><init>(Ljava/lang/Object;)V

    new-instance v6, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$5;

    invoke-direct {v6, p0}, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$5;-><init>(Ljava/lang/Object;)V
...
.method private isWfcEnabled()Z
    ...
    sget-boolean v7, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_TMOWFC:Z

    if-eqz v7, :cond_1

    iget-object v7, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->mContext:Landroid/content/Context;

    invoke-static {v7}, Lcom/android/systemui/Rune;->isTmoWfcServiceEnabled(Landroid/content/Context;)Z
    ...
    invoke-static {v7}, Lcom/samsung/tmowfc/wfcutils/WfcDbHelper;->getRegister(Landroid/content/ContentResolver;)Lcom/samsung/tmowfc/wfcutils/WfcDbHelper$RegisterContract$State;

    move-result-object v2

    sget-object v7, Lcom/samsung/tmowfc/wfcutils/WfcDbHelper$RegisterContract$State;->REGISTER:Lcom/samsung/tmowfc/wfcutils/WfcDbHelper$RegisterContract$State;
    ...
    const-string/jumbo v8, "wifi_call_enable"

    invoke-static {v7, v8, v6}, Lcom/android/systemui/statusbar/policy/WifiCallingDBController;->getInt(Landroid/content/Context;Ljava/lang/String;I)I

    move-result v4

    sget-boolean v7, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_ROGERSWFC:Z

    if-eqz v7, :cond_3

    iget-boolean v7, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->mSimProvisioned:Z
    ...
    :cond_3
    sget-boolean v7, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_UNIFIEDWFC:Z
    ...
    const-string/jumbo v8, "vowifi_menu_enable"
    ...
    :goto_1
    iput-boolean v7, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->mIsWifiCallingMenuEnabled:Z
    ...
    iget-boolean v7, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->mIsWifiCallingMenuEnabled:Z
    ...
    :cond_6
    sget-boolean v7, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_ENTITLEMENT_FOR_ORANGE_OPERATOR:Z
    ...
    invoke-static {v7, v1}, Lcom/android/systemui/statusbar/DeviceState;->getImsManager(Landroid/content/Context;I)Lcom/sec/ims/ImsManager;

    move-result-object v0

    if-eqz v0, :cond_7

    invoke-virtual {v0, v1}, Lcom/sec/ims/ImsManager;->getVoWiFiActivationMode(I)I

    move-result v3

    iget-object v7, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->TAG:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "getVoWiFiActivationMode : "
...
.method private setMode(Z)V
    ...
    sget-boolean v2, Lcom/android/systemui/Rune;->QPANEL_SUPPORT_TMOWFC:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Lcom/android/systemui/qs/tiles/WifiCallingTile;->mContext:Landroid/content/Context;

    invoke-static {v2}, Lcom/android/systemui/Rune;->isTmoWfcServiceEnabled(Landroid/content/Context;)Z
    ...
    const-string/jumbo v6, "set mode TMO "
    ...
    :goto_0
    invoke-static {v5, v2}, Lcom/samsung/tmowfc/wfcutils/WfcDbHelper;->setRegister(Landroid/content/ContentResolver;Lcom/samsung/tmowfc/wfcutils/WfcDbHelper$RegisterContract$State;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/systemui/qs/tiles/WifiCallingTile;->getATTVoWifiIntent(I)Landroid/content/Intent;
    ...
    const-string/jumbo v4, "startActivityDismissingKeyguard() failed: "
    ...
    :goto_2
    invoke-static {v5, v6, v2}, Lcom/android/systemui/statusbar/policy/WifiCallingDBController;->setInt(Landroid/content/Context;Ljava/lang/String;I)V
...
.method private showLocationInfoDialog(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/content/DialogInterface$OnClickListener;ILandroid/content/DialogInterface$OnClickListener;)V
    ...
    new-instance v3, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$11;

    invoke-direct {v3, p0, v1}, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$11;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    new-instance v4, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$7;

    invoke-direct {v4, p0}, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$7;-><init>(Ljava/lang/Object;)V
...
.method private showWfcOPVDialog()V
    ...
    new-instance v2, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$6;

    invoke-direct {v2, p0}, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$6;-><init>(Ljava/lang/Object;)V
    ...
    new-instance v2, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$9;

    invoke-direct {v2, p0}, Lcom/android/systemui/qs/tiles/-$Lambda$M2clPisUsRjPaF2mY9ybml71wMk$9;-><init>(Ljava/lang/Object;)V
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_16987(Landroid/content/DialogInterface;I)V
    .locals 0
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_17557(Landroid/content/DialogInterface;I)V
    .locals 5
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_19026(Landroid/content/DialogInterface;I)V
    .locals 0
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_20822(Landroid/content/DialogInterface;I)V
    .locals 1
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_21627(Landroid/content/DialogInterface;I)V
    .locals 1
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_21734(Landroid/content/DialogInterface;I)V
    .locals 3
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_29759(Landroid/content/DialogInterface;I)V
    .locals 3
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_30040(Landroid/content/DialogInterface;)V
    .locals 0
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_30832(Landroid/widget/CheckBox;Landroid/widget/CompoundButton;Z)V
    .locals 3
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_31691(Landroid/content/DialogInterface;)V
    .locals 0
...
.method synthetic lambda$-com_android_systemui_qs_tiles_WifiCallingTile_32683(Landroid/content/DialogInterface;)V
    .locals 0
