...
.method private setFilterParams(Landroid/view/SurfaceHolder;I)V
    ...
    invoke-static {v5}, Lcom/android/systemui/ImageWallpaper;->-get5(Lcom/android/systemui/ImageWallpaper;)Z
...
.method drawFrame(Z)V
    ...
    const-string/jumbo v30, "drawFrame="
    ...
    const-string/jumbo v30, " rotation="
    ...
    const-string/jumbo v30, " mLastRotation="
    ...
    const-string/jumbo v30, " deviceWidth="
    ...
    const-string/jumbo v30, " deviceHeight="
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/android/systemui/ImageWallpaper;->getResources()Landroid/content/res/Resources;
    ...
    iget v4, v0, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mLastSurfaceRotation:I
    ...
    invoke-static/range {v29 .. v29}, Lcom/android/systemui/ImageWallpaper;->-get2(Lcom/android/systemui/ImageWallpaper;)I
    ...
    const-string/jumbo v29, "SurfaceSize updated"
    ...
    const-string/jumbo v30, "drawFrame:[frame.width()]"
    ...
    const-string/jumbo v30, "[frame.height()]"
    ...
    const-string/jumbo v30, "surfaceDimensionsChanged="
    ...
    const-string/jumbo v30, " mLastSurfaceRotation="
    ...
    const-string/jumbo v30, " mDisplayWidth="
    ...
    const-string/jumbo v30, " mDisplayHeight="
    ...
    const-string/jumbo v30, "mNewKeyboard : "
    ...
    invoke-static/range {v30 .. v30}, Lcom/android/systemui/ImageWallpaper;->-get3(Lcom/android/systemui/ImageWallpaper;)I
    ...
    const-string/jumbo v30, " mLastKeyboard : "
    ...
    invoke-static/range {v30 .. v30}, Lcom/android/systemui/ImageWallpaper;->-get2(Lcom/android/systemui/ImageWallpaper;)I
    ...
    const-string/jumbo v30, " mForceDraw = "
    ...
    invoke-static/range {v29 .. v29}, Lcom/android/systemui/ImageWallpaper;->-get3(Lcom/android/systemui/ImageWallpaper;)I
    ...
    const-string/jumbo v30, "redrawNeeded = "
    ...
    const-string/jumbo v30, ", mOffsetsChanged = "
    ...
    const-string/jumbo v30, "Surface != bitmap dimensions: surface w/h, bitmap w/h: "
    ...
    const-string/jumbo v29, "ImageWallpaper"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v30, "Reloading bitmap: mBackground, bgw, bgh, dw, dh = "
    ...
    invoke-direct {v0, v4}, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->loadWallpaper(Z)V

    const-string/jumbo v4, "ImageWallpaper"

    const-string/jumbo v29, "Reloading, resuming draw later"
    ...
    const-string/jumbo v29, "Suppressed drawFrame since redraw is not needed and offsets have not changed."
    ...
    const-string/jumbo v30, "drawFrame() wallpaperRegion = "
    ...
    const-string/jumbo v30, "drawFrame() statusBarRegion = "
    ...
    :goto_b
    sget-boolean v4, Lcom/android/systemui/SystemUIRune;->SUPPORT_NAVIGATIONBAR:Z
    ...
    const-string/jumbo v30, "drawFrame() navigationBarRegion = "
    ...
    const-string/jumbo v30, "mNeedBlackText = "
    ...
    const-string/jumbo v30, " mNeedBlackStatusBar = "
    ...
    const-string/jumbo v30, " mNeedBlackNavigationBar = "
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/android/systemui/ImageWallpaper;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v29

    const-string/jumbo v30, "need_dark_font"
    ...
    const-string/jumbo v30, "need_dark_statusbar"
    ...
    const-string/jumbo v29, "need_dark_font"
    ...
    const-string/jumbo v29, "need_dark_statusbar"
    ...
    const-string/jumbo v29, "need_dark_navigationbar"
    ...
    const-string/jumbo v30, "mMobileKeyboardHeight:"
    ...
    invoke-virtual {v4}, Lcom/android/systemui/ImageWallpaper;->getBaseContext()Landroid/content/Context;
    ...
    const-string/jumbo v4, "com.samsung.feature.device_category_tablet"
    ...
    const-string/jumbo v30, " xPixels= "
    ...
    const-string/jumbo v30, " yPixels= "
    ...
    const-string/jumbo v30, "availwUnscaled="
    ...
    const-string/jumbo v30, "  availhUnscaled="
    ...
    const-string/jumbo v30, "mLastSurfaceWidth:"
    ...
    const-string/jumbo v30, " mLastSurfaceHeight:"
    ...
    const-string/jumbo v29, "Suppressed drawFrame since the image has not actually moved an integral number of pixels."
    ...
    const-string/jumbo v30, "Whole Area Hue="
    ...
    const-string/jumbo v30, ", Saturation="
    ...
    const-string/jumbo v30, ", Brightness="
    ...
    const-string/jumbo v30, "StatusBar Area Hue="
    ...
    const-string/jumbo v30, "NavigationBar Area Hue="
    ...
    const-string/jumbo v30, "need_dark_navigationbar"
    ...
    const-string/jumbo v29, "Redrawing wallpaper"
    ...
    const-string/jumbo v29, "initialize mForceDraw = false"
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/app/WallpaperManager;->forgetLoadedWallpaper()V
...
.method updateSurfaceSize(Landroid/view/SurfaceHolder;Landroid/view/DisplayInfo;ZZ)Z
    ...
    const-string/jumbo v5, "Reloading, redoing updateSurfaceSize later."
    ...
    const-string/jumbo v6, "deviceWidth="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, p2, Landroid/view/DisplayInfo;->logicalWidth:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string/jumbo v6, " deviceHeight="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, p2, Landroid/view/DisplayInfo;->logicalHeight:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string/jumbo v6, " backgroundWidth="
    ...
    const-string/jumbo v6, " backgroundHeight="
    ...
    const-string/jumbo v6, " surfaceWidth="
    ...
    const-string/jumbo v6, " surfaceHeight="
    ...
    const-string/jumbo v6, " tiltEnabled="
    ...
    const-string/jumbo v6, " lastRequestedWidth="
    ...
    const-string/jumbo v6, " lastRequestedHeight="
    ...
    iget v4, p0, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mLastRequestedWidth:I

    if-ne v4, v3, :cond_4

    iget v4, p0, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mLastRequestedHeight:I
    ...
    iget-boolean v4, p0, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mNeedsDrawAfterLoadingWallpaper:Z
    ...
    :cond_5
    :goto_0
    invoke-interface {p1, v3, v2}, Landroid/view/SurfaceHolder;->setFixedSize(II)V
    ...
    iget v4, p2, Landroid/view/DisplayInfo;->rotation:I

    iput v4, p0, Lcom/android/systemui/ImageWallpaper$DrawableEngine;->mLastSurfaceRotation:I
    ...
    const-string/jumbo v6, "SurfaceSize width : "
