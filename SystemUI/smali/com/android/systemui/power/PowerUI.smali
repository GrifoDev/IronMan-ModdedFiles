...
.method static synthetic -get10(Lcom/android/systemui/power/PowerUI;)I
    .locals 1
...
.method static synthetic -get18(Lcom/android/systemui/power/PowerUI;)Landroid/os/PowerManager;
    .locals 1
...
.method static synthetic -get19(Lcom/android/systemui/power/PowerUI;)Landroid/hardware/scontext/SContextListener;
    .locals 1
...
.method static synthetic -get20(Lcom/android/systemui/power/PowerUI;)Landroid/hardware/scontext/SContextManager;
    .locals 1
...
.method static synthetic -get21(Lcom/android/systemui/power/PowerUI;)I
    .locals 1
...
.method static synthetic -get22(Lcom/android/systemui/power/PowerUI;)J
    .locals 2
...
.method static synthetic -get23(Lcom/android/systemui/power/PowerUI;)Lcom/android/systemui/power/PowerUI$WarningsUI;
    .locals 1
...
.method static synthetic -get7(Lcom/android/systemui/power/PowerUI;)Z
    ...
    iget-boolean v0, p0, Lcom/android/systemui/power/PowerUI;->mFlashOverHeated:Z

    return v0
.end method

.method static synthetic -get8(Lcom/android/systemui/power/PowerUI;)Z
    .locals 1
...
.method static synthetic -get9(Lcom/android/systemui/power/PowerUI;)Landroid/os/Handler;
    .locals 1
...
.method private checkBatteryHealthInterruptionStatus(II)V
    ...
    sget-boolean v5, Lcom/android/systemui/SystemUIRune;->SUPPORT_FLASH_OVER_HEAT_NOTICE:Z

    if-eqz v5, :cond_8

    iget-boolean v1, p0, Lcom/android/systemui/power/PowerUI;->mFlashOverHeated:Z

    const-string/jumbo v5, "1"

    const-string/jumbo v6, "/sys/class/power_supply/battery/camera_limit"

    invoke-virtual {p0, v6}, Lcom/android/systemui/power/PowerUI;->readFromFile(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget v5, p0, Lcom/android/systemui/power/PowerUI;->mBatteryStatus:I
    ...
    iget-boolean v5, p0, Lcom/android/systemui/power/PowerUI;->mFlashOverHeated:Z
    ...
    iget-boolean v6, p0, Lcom/android/systemui/power/PowerUI;->mFlashOverHeated:Z

    const/4 v7, 0x0

    invoke-interface {v5, v7, v6}, Lcom/android/systemui/power/PowerUI$WarningsUI;->showFlashHighTemperatureWarning(ZZ)V

    :cond_1
    iget-object v5, p0, Lcom/android/systemui/power/PowerUI;->mBatteryHealthInterruptionScreenDimWakeLock:Landroid/os/PowerManager$WakeLock;

    if-eqz v5, :cond_3

    iget-object v5, p0, Lcom/android/systemui/power/PowerUI;->mWarnings:Lcom/android/systemui/power/PowerUI$WarningsUI;

    invoke-interface {v5}, Lcom/android/systemui/power/PowerUI$WarningsUI;->dismissBatteryHealthInterruptionWarning()V

    const/4 v5, 0x0

    iput-boolean v5, p0, Lcom/android/systemui/power/PowerUI;->mDismissBatteryHealthInterruptionWarning:Z

    sget-boolean v5, Lcom/android/systemui/SystemUIRune;->SUPPORT_KEEP_DIMMING_AT_BATTERY_HEALTH_INTERRUPTION:Z
    ...
    :cond_3
    :goto_1
    iget-boolean v5, p0, Lcom/android/systemui/power/PowerUI;->mDismissBatteryHealthInterruptionWarning:Z
    ...
    iget-object v5, p0, Lcom/android/systemui/power/PowerUI;->mBatteryHealthInterruptionPartialWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual {v4}, Landroid/app/enterprise/knoxcustom/SettingsManager;->getScreenWakeupOnPowerState()Z
    ...
    const-string/jumbo v6, "Overvoltage/Undervoltage status is changed so turn on the screen."
    ...
    const-string/jumbo v6, "turnOnScreen : fail to get PowerManager reference"
    ...
    const-string/jumbo v6, "onReceive : fail to get PowerManager reference"
    ...
    invoke-interface {v5}, Lcom/android/systemui/power/PowerUI$WarningsUI;->showBatteryHealthInterruptionWarning()V
    ...
    invoke-interface {v5}, Lcom/android/systemui/power/PowerUI$WarningsUI;->dismissFlashHighTemperatureWarning()V
    ...
    const-string/jumbo v6, "Knox Customization: shouldWakeUp: not waking when battery health is changed"
    ...
    const-string/jumbo v5, "BatteryStateChanged"
    ...
    invoke-interface {v2, v6, v7, v5, v8}, Landroid/os/IPowerManager;->wakeUp(JLjava/lang/String;Ljava/lang/String;)V
    :try_end_0
    ...
    const-string/jumbo v7, "turnOnScreen : Exception = "
...
.method private checkConnectedChargerStatus(ZI)V
    ...
    :cond_b
    :goto_4
    sget-boolean v0, Lcom/android/systemui/SystemUIRune;->SUPPORT_WIRELESS_CHARGER_INFO_POPUP:Z
...
.method private sendLowBatteryDumpIfNeeded(III)V
    ...
    const-string/jumbo v1, "LOW_BATTERY_DUMP"
    ...
    const-string/jumbo v1, "Low battery dump"
    ...
    const-string/jumbo v2, "com.samsung.systemui.power.action.LOW_BATTERY_DUMP"
...
.method private updateBatteryNotificationLanguage()V
    ...
    :cond_0
    sget-boolean v0, Lcom/android/systemui/SystemUIRune;->SUPPORT_FULL_BATTERY_CHECK:Z
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    :cond_1
    sget-boolean v3, Lcom/android/systemui/SystemUIRune;->SUPPORT_BATTERY_CHARGER_CONNECTION_VI:Z
...
.method public start()V
    ...
    new-instance v5, Lcom/android/systemui/power/PowerNotificationWarnings;
    ...
    invoke-virtual {p0, v4}, Lcom/android/systemui/power/PowerUI;->getComponent(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/android/systemui/statusbar/phone/PhoneStatusBar;

    invoke-direct {v5, v6, v4}, Lcom/android/systemui/power/PowerNotificationWarnings;-><init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/PhoneStatusBar;)V

    iput-object v5, p0, Lcom/android/systemui/power/PowerUI;->mWarnings:Lcom/android/systemui/power/PowerUI$WarningsUI;

    new-instance v1, Lcom/android/systemui/power/PowerUI$7;

    iget-object v4, p0, Lcom/android/systemui/power/PowerUI;->mHandler:Landroid/os/Handler;

    invoke-direct {v1, p0, v4}, Lcom/android/systemui/power/PowerUI$7;-><init>(Lcom/android/systemui/power/PowerUI;Landroid/os/Handler;)V
    ...
    invoke-virtual {v3, v4, v7, v1, v5}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
