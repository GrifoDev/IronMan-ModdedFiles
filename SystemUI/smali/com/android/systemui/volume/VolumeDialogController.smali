...
# static fields
.field public static final STREAMS:[I

.field public static final STREAMTITLES:[I
...
.method static synthetic -get0()Z
    ...
    sget-boolean v0, Lcom/android/systemui/volume/VolumeDialogController;->SUPPORT_DEFAULTSTREAM_NOTIFICATION:Z
...
.method static synthetic -get10(Lcom/android/systemui/volume/VolumeDialogController;)Landroid/app/NotificationManager;
    .locals 1
...
.method static synthetic -get11(Lcom/android/systemui/volume/VolumeDialogController;)I
    .locals 1
...
.method static synthetic -get12(Lcom/android/systemui/volume/VolumeDialogController;)Lcom/android/systemui/volume/VolumeDialogController$State;
    .locals 1
...
.method static synthetic -get13(Lcom/android/systemui/volume/VolumeDialogController;)Lcom/android/systemui/volume/VolumeDialogController$W;
    .locals 1
...
.method static synthetic -get2(Lcom/android/systemui/volume/VolumeDialogController;)Landroid/media/AudioManager;
    .locals 1
...
.method static synthetic -get3(Lcom/android/systemui/volume/VolumeDialogController;)Lcom/android/systemui/volume/VolumeDialogController$C;
    .locals 1
...
.method static synthetic -get4(Lcom/android/systemui/volume/VolumeDialogController;)Landroid/content/ComponentName;
    .locals 1
...
.method static synthetic -get5(Lcom/android/systemui/volume/VolumeDialogController;)Landroid/content/Context;
    .locals 1
...
.method static synthetic -get7(Lcom/android/systemui/volume/VolumeDialogController;)Z
    .locals 1
...
.method static synthetic -get9(Lcom/android/systemui/volume/VolumeDialogController;)Lcom/android/systemui/volume/MediaSessions;
    .locals 1
...
.method static synthetic -wrap19(Lcom/android/systemui/volume/VolumeDialogController;)V
    ...
    invoke-direct {p0}, Lcom/android/systemui/volume/VolumeDialogController;->onShowSmartViewMuteToast()V
...
.method static synthetic -wrap21(Lcom/android/systemui/volume/VolumeDialogController;)V
    .locals 0
...
.method static constructor <clinit>()V
    ...
    sput-boolean v3, Lcom/android/systemui/volume/VolumeDialogController;->SUPPORT_DEFAULTSTREAM_NOTIFICATION:Z
...
.method private onGetStateW()V
    ...
    iget-object v8, p0, Lcom/android/systemui/volume/VolumeDialogController;->mContext:Landroid/content/Context;

    invoke-virtual {v8}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v5

    sget-object v9, Lcom/android/systemui/volume/VolumeDialogController;->STREAMS:[I
    ...
    invoke-virtual {v11, v7}, Landroid/media/AudioManager;->isStreamMute(I)Z
    ...
    sget-object v11, Lcom/android/systemui/volume/VolumeDialogController;->TAG:Ljava/lang/String;

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v13, "onGetStateW : "
    ...
    const-string/jumbo v13, " is mute"
    ...
    invoke-virtual {v11, v12}, Landroid/media/AudioManager;->semGetFineVolume(I)I
    ...
    :cond_2
    :goto_2
    invoke-direct {p0, v7, v1}, Lcom/android/systemui/volume/VolumeDialogController;->updateStreamLevelW(II)Z

    const/16 v11, 0xa

    if-ne v7, v11, :cond_b

    iget-object v11, p0, Lcom/android/systemui/volume/VolumeDialogController;->mDisplayManager:Landroid/hardware/display/DisplayManager;

    if-eqz v11, :cond_a

    sget-boolean v11, Lcom/android/systemui/volume/VolumeDialogController;->mIsDLNAStatus:Z

    if-nez v11, :cond_3

    sget-boolean v11, Lcom/android/systemui/volume/VolumeDialogController;->mIsSupportTvVolumeControl:Z

    if-eqz v11, :cond_4

    :cond_3
    invoke-direct {p0, v7}, Lcom/android/systemui/volume/VolumeDialogController;->streamStateW(I)Lcom/android/systemui/volume/VolumeDialogController$StreamState;

    move-result-object v11

    iget v12, p0, Lcom/android/systemui/volume/VolumeDialogController;->mMinSmartViewVol:I

    iput v12, v11, Lcom/android/systemui/volume/VolumeDialogController$StreamState;->levelMin:I

    invoke-direct {p0, v7}, Lcom/android/systemui/volume/VolumeDialogController;->streamStateW(I)Lcom/android/systemui/volume/VolumeDialogController$StreamState;

    move-result-object v11

    iget v12, p0, Lcom/android/systemui/volume/VolumeDialogController;->mMaxSmartViewVol:I

    iput v12, v11, Lcom/android/systemui/volume/VolumeDialogController$StreamState;->levelMax:I

    :cond_4
    :goto_3
    invoke-direct {p0, v7, v4}, Lcom/android/systemui/volume/VolumeDialogController;->updateStreamMuteW(IZ)Z
    ...
    invoke-virtual {v11, v7}, Landroid/media/AudioManager;->isStreamAffectedByMute(I)Z

    move-result v11

    iput-boolean v11, v6, Lcom/android/systemui/volume/VolumeDialogController$StreamState;->muteSupported:Z

    :goto_4
    sget-object v11, Lcom/android/systemui/volume/VolumeDialogController;->STREAMTITLES:[I
    ...
    iput-object v11, v6, Lcom/android/systemui/volume/VolumeDialogController$StreamState;->name:Ljava/lang/String;

    invoke-direct {p0, v7}, Lcom/android/systemui/volume/VolumeDialogController;->checkRoutedToBluetoothW(I)Z
    ...
    invoke-virtual {v11, v12}, Landroid/media/AudioManager;->isStreamMute(I)Z
    ...
    invoke-virtual {v11}, Landroid/media/AudioManager;->semGetPinDevice()I
    ...
    invoke-virtual {v11, v12, v0}, Landroid/media/AudioManager;->getFineVolume(II)I
    ...
    invoke-virtual {v11, v7}, Landroid/media/AudioManager;->getLastAudibleStreamVolume(I)I
    ...
    iget-object v12, p0, Lcom/android/systemui/volume/VolumeDialogController;->mAudio:Landroid/media/AudioManager;

    const/4 v13, 0x3

    invoke-virtual {v12, v13}, Landroid/media/AudioManager;->getStreamMinVolume(I)I
    ...
    invoke-virtual {v12, v7}, Landroid/media/AudioManager;->getStreamMinVolume(I)I
    ...
    invoke-virtual {v11, v12}, Landroid/media/AudioManager;->isStreamAffectedByMute(I)Z
    ...
    :cond_e
    iget-object v8, p0, Lcom/android/systemui/volume/VolumeDialogController;->mAudio:Landroid/media/AudioManager;

    invoke-virtual {v8}, Landroid/media/AudioManager;->getRingerMode()I

    move-result v8

    invoke-direct {p0, v8}, Lcom/android/systemui/volume/VolumeDialogController;->updateRingerModeExternalW(I)Z

    invoke-direct {p0}, Lcom/android/systemui/volume/VolumeDialogController;->updateZenModeW()Z

    iget-object v8, p0, Lcom/android/systemui/volume/VolumeDialogController;->mNoMan:Landroid/app/NotificationManager;

    invoke-virtual {v8}, Landroid/app/NotificationManager;->getEffectsSuppressor()Landroid/content/ComponentName;

    move-result-object v8

    invoke-direct {p0, v8}, Lcom/android/systemui/volume/VolumeDialogController;->updateEffectsSuppressorW(Landroid/content/ComponentName;)Z

    iget-object v8, p0, Lcom/android/systemui/volume/VolumeDialogController;->mCallbacks:Lcom/android/systemui/volume/VolumeDialogController$C;

    iget-object v9, p0, Lcom/android/systemui/volume/VolumeDialogController;->mState:Lcom/android/systemui/volume/VolumeDialogController$State;

    invoke-virtual {v8, v9}, Lcom/android/systemui/volume/VolumeDialogController$C;->onStateChanged(Lcom/android/systemui/volume/VolumeDialogController$State;)V
...
.method private onSetStreamVolumeW(II)V
    ...
    invoke-virtual {v3, p1, p2}, Lcom/android/systemui/volume/VolumeDialogController$MediaSessionsCallbacks;->setStreamVolume(II)V
...
.method private onShowSmartViewMuteToast()V
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/volume/VolumeDialogController;->mCallbacks:Lcom/android/systemui/volume/VolumeDialogController$C;

    invoke-virtual {v0}, Lcom/android/systemui/volume/VolumeDialogController$C;->onShowSmartViewMuteToast()V
...
.method private onVolumeChangedW(II)Z
    ...
    iput v15, v0, Lcom/android/systemui/volume/VolumeDialogController;->mSmartViewFlag:I
    ...
    iget-object v15, v0, Lcom/android/systemui/volume/VolumeDialogController;->mAudio:Landroid/media/AudioManager;
    ...
    sget-object v15, Lcom/android/systemui/volume/VolumeDialogController;->TAG:Ljava/lang/String;
    ...
    iget-object v15, v0, Lcom/android/systemui/volume/VolumeDialogController;->mCallbacks:Lcom/android/systemui/volume/VolumeDialogController$C;

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/systemui/volume/VolumeDialogController;->mState:Lcom/android/systemui/volume/VolumeDialogController$State;

    move-object/from16 v16, v0

    invoke-virtual/range {v15 .. v16}, Lcom/android/systemui/volume/VolumeDialogController$C;->onStateChanged(Lcom/android/systemui/volume/VolumeDialogController$State;)V

    if-eqz v4, :cond_15

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/systemui/volume/VolumeDialogController;->mContext:Landroid/content/Context;
    ...
    iput-boolean v15, v0, Lcom/android/systemui/volume/VolumeDialogController;->mFromKey:Z
    ...
    iget-object v15, v0, Lcom/android/systemui/volume/VolumeDialogController;->mKnoxStateMonitor:Lcom/android/keyguard/KnoxStateMonitor;

    invoke-virtual {v15}, Lcom/android/keyguard/KnoxStateMonitor;->isVolumeDialogEnabled()Z
    ...
    invoke-virtual/range {v15 .. v16}, Lcom/android/systemui/volume/VolumeDialogController$C;->onShowRequested(I)V
    ...
    invoke-virtual {v15}, Lcom/android/systemui/volume/VolumeDialogController$C;->onPlaySound()V
    ...
    invoke-virtual {v15}, Lcom/android/systemui/volume/VolumeDialogController$C;->onStopSound()V
    ...
    invoke-virtual {v15}, Lcom/android/systemui/volume/VolumeDialogController$C;->onShowVibrateHint()V
    ...
    invoke-virtual {v15}, Lcom/android/systemui/volume/VolumeDialogController$C;->onShowSilentHint()V
...
.method public notifyVisible(Z)V
    ...
    :cond_0
    sput-boolean p1, Lcom/android/systemui/volume/VolumeDialogController;->mIsVolumeDialogShowing:Z
