...
.method synthetic lambda$-com_android_systemui_wallpaper_KeyguardVideoWallpaperPreviewActivity_11519(Landroid/content/DialogInterface;I)V
    .locals 0
...
.method synthetic lambda$-com_android_systemui_wallpaper_KeyguardVideoWallpaperPreviewActivity_11623(Landroid/content/DialogInterface;I)V
    .locals 1
...
.method synthetic lambda$-com_android_systemui_wallpaper_KeyguardVideoWallpaperPreviewActivity_5573(FFFFII)V
    .locals 5
...
.method synthetic lambda$-com_android_systemui_wallpaper_KeyguardVideoWallpaperPreviewActivity_8501(Landroid/view/View;)V
    .locals 1
...
.method synthetic lambda$-com_android_systemui_wallpaper_KeyguardVideoWallpaperPreviewActivity_8761(Landroid/view/View;)V
    .locals 0
...
.method synthetic lambda$-com_android_systemui_wallpaper_KeyguardVideoWallpaperPreviewActivity_9305(Landroid/content/DialogInterface;)V
    .locals 2
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mVideoFileDescriptor:Landroid/content/res/AssetFileDescriptor;
    ...
    const-string/jumbo v3, "File path or descriptor is invalid"
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->setContentView(I)V

    const v2, 0x7f0a03e1

    invoke-virtual {p0, v2}, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->findViewById(I)Landroid/view/View;

    move-result-object v2

    check-cast v2, Landroid/widget/ImageView;

    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mBgBlendingImageView:Landroid/widget/ImageView;
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mOverlayImageView:Landroid/widget/ImageView;
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mFakeImageView:Landroid/widget/ImageView;
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mVideoSurfaceView:Landroid/view/TextureView;
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mInfoTextView:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mEditButton:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mSetAsWallpaperButton:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mSetBtnContainer:Landroid/view/View;
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mEditBtnContainer:Landroid/view/View;

    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mVideoSurfaceView:Landroid/view/TextureView;

    iget-object v3, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mSurfaceTextureListener:Landroid/view/TextureView$SurfaceTextureListener;

    invoke-virtual {v2, v3}, Landroid/view/TextureView;->setSurfaceTextureListener(Landroid/view/TextureView$SurfaceTextureListener;)V

    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mSetAsWallpaperButton:Landroid/widget/TextView;

    new-instance v3, Lcom/android/systemui/wallpaper/-$Lambda$zISa71F4vgnBMtfo7SaHtWhoHZ8$3;

    invoke-direct {v3, p0}, Lcom/android/systemui/wallpaper/-$Lambda$zISa71F4vgnBMtfo7SaHtWhoHZ8$3;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v2, v3}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mEditButton:Landroid/widget/TextView;

    new-instance v3, Lcom/android/systemui/wallpaper/-$Lambda$zISa71F4vgnBMtfo7SaHtWhoHZ8$4;

    invoke-direct {v3, p0}, Lcom/android/systemui/wallpaper/-$Lambda$zISa71F4vgnBMtfo7SaHtWhoHZ8$4;-><init>(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v3}, Lcom/android/systemui/wallpaper/WallpaperUtils;->getFileExt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mFileExt:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mSurfaceController:Lcom/android/systemui/wallpaper/video/SurfaceController;

    invoke-direct {v2, v3, v4, v5}, Lcom/android/systemui/wallpaper/video/VideoPlayer;-><init>(Landroid/content/Context;Lcom/android/systemui/wallpaper/video/SurfaceController;Z)V

    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mVideoPlayer:Lcom/android/systemui/wallpaper/video/VideoPlayer;

    new-instance v2, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity$VideoFileCopyTask;

    invoke-direct {v2, p0, v6}, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity$VideoFileCopyTask;-><init>(Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity$VideoFileCopyTask;)V

    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mVideoCopyTask:Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity$VideoFileCopyTask;
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mProgressDialog:Landroid/app/ProgressDialog;

    iget-object v2, p0, Lcom/android/systemui/wallpaper/KeyguardVideoWallpaperPreviewActivity;->mProgressDialog:Landroid/app/ProgressDialog;
    ...
    new-instance v3, Lcom/android/systemui/wallpaper/-$Lambda$zISa71F4vgnBMtfo7SaHtWhoHZ8;

    invoke-direct {v3, p0}, Lcom/android/systemui/wallpaper/-$Lambda$zISa71F4vgnBMtfo7SaHtWhoHZ8;-><init>(Ljava/lang/Object;)V
...
.method public showVideoTrimmerActivity()V
    ...
    invoke-static {v4}, Lcom/android/systemui/wallpaper/WallpaperUtils;->getOuputVideoResolution(Ljava/lang/String;)Landroid/graphics/Point;
