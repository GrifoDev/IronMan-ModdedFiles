...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/theme/view/RainView;->list:Ljava/util/Vector;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/systemui/wallpaper/theme/view/RainView;->refresh:Z

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2}, Landroid/graphics/Paint;-><init>()V

    iput-object v2, p0, Lcom/android/systemui/wallpaper/theme/view/RainView;->mPaint:Landroid/graphics/Paint;

    iput-object p1, p0, Lcom/android/systemui/wallpaper/theme/view/RainView;->mContext:Landroid/content/Context;

    sget v2, Lcom/android/systemui/wallpaper/theme/view/RainView;->MAX_POOL_SIZE:I

    new-array v2, v2, [Lcom/android/systemui/wallpaper/theme/particle/Rain;

    iput-object v2, p0, Lcom/android/systemui/wallpaper/theme/view/RainView;->mRainPool:[Lcom/android/systemui/wallpaper/theme/particle/Rain;

    const/4 v0, 0x0

    :goto_0
    iget-object v2, p0, Lcom/android/systemui/wallpaper/theme/view/RainView;->mRainPool:[Lcom/android/systemui/wallpaper/theme/particle/Rain;
    ...
    new-instance v3, Lcom/android/systemui/wallpaper/theme/particle/Rain;

    invoke-direct {v3, p1}, Lcom/android/systemui/wallpaper/theme/particle/Rain;-><init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/systemui/wallpaper/theme/view/RainView;->rainline:Landroid/graphics/Bitmap;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v1, p0, Lcom/android/systemui/wallpaper/theme/view/RainView;->refresh:Z
    ...
    iget v6, v0, Lcom/android/systemui/wallpaper/theme/particle/Rain;->x:F
    ...
    iget v7, v0, Lcom/android/systemui/wallpaper/theme/particle/Rain;->y:F
    ...
    invoke-virtual {v0}, Lcom/android/systemui/wallpaper/theme/particle/Rain;->next()V
