...
.method private calculateLocalPaths()V
    ...
    invoke-virtual {p0}, Lcom/android/settingslib/graph/UsageGraph;->isRTL()Z

    move-result v9

    if-eqz v9, :cond_1

    iget v9, p0, Lcom/android/settingslib/graph/UsageGraph;->mMaxX:F
...
.method private drawFilledPathInRTL(Landroid/graphics/Canvas;)V
    .locals 8
    ...
    iget-object v7, p0, Lcom/android/settingslib/graph/UsageGraph;->mLocalPaths:Landroid/util/SparseIntArray;
...
.method private drawLinePathinRTL(Landroid/graphics/Canvas;)V
    .locals 7
...
.method public isRTL()Z
    ...
    invoke-virtual {p0}, Lcom/android/settingslib/graph/UsageGraph;->getContext()Landroid/content/Context;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/settingslib/graph/UsageGraph;->drawProjectionInRTL(Landroid/graphics/Canvas;)V

    :cond_2
    invoke-direct {p0, p1}, Lcom/android/settingslib/graph/UsageGraph;->drawFilledPathInRTL(Landroid/graphics/Canvas;)V

    invoke-direct {p0, p1}, Lcom/android/settingslib/graph/UsageGraph;->drawLinePathinRTL(Landroid/graphics/Canvas;)V
