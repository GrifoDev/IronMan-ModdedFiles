...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/sec/android/cover/neoncover/NeonCoverController$3;,
...
.method static synthetic -get5(Lcom/sec/android/cover/neoncover/NeonCoverController;)J
    .locals 2

    iget-wide v0, p0, Lcom/sec/android/cover/neoncover/NeonCoverController;->mLastNeonWakeupTime:J
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Lcom/sec/android/cover/neoncover/NeonCoverController;->mKeyguardCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;

    new-instance v0, Lcom/sec/android/cover/neoncover/NeonCoverController$3;

    invoke-direct {v0, p0}, Lcom/sec/android/cover/neoncover/NeonCoverController$3;-><init>(Lcom/sec/android/cover/neoncover/NeonCoverController;)V
...
.method private cancelAnimationsForType(Lcom/sec/android/cover/neoncover/animation/NeonAnimation$AnimationType;)V
    ...
    const-string/jumbo v4, "cancelAnimationsForType() type="
    ...
    invoke-virtual {v2}, Lcom/sec/android/cover/neoncover/animation/NeonAnimation;->stopAnimation()V
    :try_end_0
...
.method private playAnimation(Lcom/sec/android/cover/neoncover/NeonFSM$NeonState;)V
    ...
    const-string/jumbo v3, "playAnimation() neonState="
    ...
    const-string/jumbo v2, "playAnimation(): cover is open"
    ...
    const-string/jumbo v2, "playAnimation(): mView is null, cover is not attached!"
    ...
    const-string/jumbo v2, "playAnimation(): there is animation to play"
    ...
    sget-object v2, Lcom/sec/android/cover/neoncover/NeonBrightnessController$BrightnessSate;->BRIGHT:Lcom/sec/android/cover/neoncover/NeonBrightnessController$BrightnessSate;
    ...
    :pswitch_1
    :try_start_3
    iget-object v1, p0, Lcom/sec/android/cover/neoncover/NeonCoverController;->mAnimations:Ljava/util/Map;
    ...
    invoke-direct {v0, v1, p0}, Lcom/sec/android/cover/neoncover/animation/NeonAnimationOngoing;-><init>(Landroid/content/Context;Lcom/sec/android/cover/neoncover/NeonControllerCallback;)V
    ...
    invoke-direct {v0, v1, p0}, Lcom/sec/android/cover/neoncover/animation/NeonAnimationCoverClose;-><init>(Landroid/content/Context;Lcom/sec/android/cover/neoncover/NeonControllerCallback;)V
    ...
    invoke-direct {v0, v1, p0}, Lcom/sec/android/cover/neoncover/animation/NeonAnimationNewMessage;-><init>(Landroid/content/Context;Lcom/sec/android/cover/neoncover/NeonControllerCallback;)V
    ...
    invoke-direct {v0, v1, p0}, Lcom/sec/android/cover/neoncover/animation/NeonAnimationTest;-><init>(Landroid/content/Context;Lcom/sec/android/cover/neoncover/NeonControllerCallback;)V
    ...
    const-string/jumbo v2, "playAnimation(): nothing to play"
...
.method private stopAllAnimations()V
    ...
    const-string/jumbo v1, "stopAllAnimations()"
    ...
    const-string/jumbo v1, "stopAllAnimations() cover is open"
    ...
    const-string/jumbo v1, "topAllAnimations() mView is null, cover is not attached!"
    ...
    :try_start_2
    invoke-direct {p0, v0}, Lcom/sec/android/cover/neoncover/NeonCoverController;->cancelAnimationsForType(Lcom/sec/android/cover/neoncover/animation/NeonAnimation$AnimationType;)V
...
.method public onCoverAttached(Lcom/samsung/android/cover/CoverState;)V
    ...
    iget-object v1, p0, Lcom/sec/android/cover/neoncover/NeonCoverController;->mKeyguardCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
...
.method public onCoverDetatched(Lcom/samsung/android/cover/CoverState;)V
    ...
    iget-object v2, p0, Lcom/sec/android/cover/neoncover/NeonCoverController;->mKeyguardCallback:Lcom/android/keyguard/KeyguardUpdateMonitorCallback;
