...
.method private extract(Ljava/lang/annotation/Annotation;)[Ljava/lang/annotation/Annotation;
    ...
    const-string/jumbo v1, "Annotation \'%s\' is not a valid union for %s"
...
.method private union(Ljava/lang/annotation/Annotation;I)Ljava/util/List;
    ...
    const-string/jumbo v2, "Annotation name \'%s\' used more than once in %s for %s"
...
.method private validate(Lorg/simpleframework/xml/core/Parameter;Ljava/lang/Object;)V
    ...
    const-string/jumbo v1, "Parameter types do not match for \'%s\' in %s"
    ...
    const-string/jumbo v1, "Annotations do not match for \'%s\' in %s"
