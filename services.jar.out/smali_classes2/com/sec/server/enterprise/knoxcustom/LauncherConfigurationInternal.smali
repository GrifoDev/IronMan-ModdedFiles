.class Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->CONTENT_URI:Landroid/net/Uri;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->mContext:Landroid/content/Context;
...
.method public addShortcut(ILandroid/graphics/Point;Landroid/content/ComponentName;)I
    ...
    iget-object v3, p0, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->mContext:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v3

    sget-object v4, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->CONTENT_URI:Landroid/net/Uri;
...
.method public getAppsButtonVisibility()Z
    ...
    iget-object v1, p0, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->mContext:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    sget-object v2, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->CONTENT_URI:Landroid/net/Uri;

    const-string/jumbo v3, "get_apps_button_state"
...
.method public getHomeMode()I
    ...
    iget-object v2, p0, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->mContext:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v2

    sget-object v3, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->CONTENT_URI:Landroid/net/Uri;
...
.method public getHotseatItem(I)Landroid/content/ComponentName;
    ...
    iget-object v4, p0, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->mContext:Landroid/content/Context;

    invoke-virtual {v4}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v4

    sget-object v5, Lcom/sec/server/enterprise/knoxcustom/LauncherConfigurationInternal;->CONTENT_URI:Landroid/net/Uri;
