...
.field public static final SERVICE_VERSION:Ljava/lang/String; = "v3.8.1"
...
.method private checkDevicePolicy()I
    ...
    iget-object v10, p0, Lcom/samsung/android/security/mdf/MdfService/MdfPolicy;->mLPU:Lcom/android/internal/widget/LockPatternUtils;
    ...
    const-string/jumbo v10, "Direction lock : Direction lock should not be set."

    const/4 v11, 0x1

    const/4 v12, 0x6

    invoke-direct {p0, v11, v12, v10}, Lcom/samsung/android/security/mdf/MdfService/MdfPolicy;->logForAuditAndLogcat(IILjava/lang/String;)V
    ...
    const-string/jumbo v11, "Password attempts : setMaximumFailedPasswordsForWipe() should be set between 1 and 50. Current value = "
    ...
    const-string/jumbo v10, "Screen lock : setPasswordQuality() should be set to alphanumeric."
    ...
    const-string/jumbo v10, "Recovery password : semSetPasswordRecoverable() should be set to false."
    ...
    const-string/jumbo v10, "Password history length : setPasswordHistoryLength() should be set to 0."
    ...
    const-string/jumbo v10, "Certificate revocation : enableRevocationCheck() should be set on all packages."
    ...
    iget-object v10, p0, Lcom/samsung/android/security/mdf/MdfService/MdfPolicy;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    const-string/jumbo v10, "Device encryption : OK"
    ...
    const-string/jumbo v10, "MdfService"

    const-string/jumbo v11, "Face lock : check error. mLPU is null"
    ...
    :cond_3
    const-string/jumbo v10, "Direction lock : OK"
    ...
    :cond_4
    const-string/jumbo v10, "Password attempts : OK"
    ...
    :cond_5
    const-string/jumbo v10, "Screen lock : OK"
    ...
    :cond_6
    const-string/jumbo v10, "Recovery password : OK"
    ...
    :cond_7
    const-string/jumbo v10, "Password history length : OK"
    ...
    :cond_8
    const-string/jumbo v10, "Certificate revocation : OK"
    ...
    :cond_9
    const-string/jumbo v10, "Device encryption : setRequireStorageCardEncryption() should be set to true."
    ...
    const-string/jumbo v10, "Device encryption : Secure Startup should be set."
    ...
    const-string/jumbo v11, "Device encryption : unexpected status. Status value = "
    ...
    :pswitch_3
    const-string/jumbo v10, "Device encryption : fast encryption should not be set."
    ...
    :pswitch_4
    const-string/jumbo v10, "Device encryption : encryption status is FULLY_ENCRYPTED_ERROR."
    ...
    :cond_d
    iget-object v10, p0, Lcom/samsung/android/security/mdf/MdfService/MdfPolicy;->mPP:Lcom/samsung/android/knox/devicesecurity/PasswordPolicy;
    ...
    const-string/jumbo v10, "Face lock : BIOMETRIC_AUTHENTICATION_FACE should be set to false in the setBiometricAuthenticationEnabled()."
    ...
    :cond_e
    const-string/jumbo v10, "Face lock : OK"
