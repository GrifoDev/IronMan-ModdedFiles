...
.method computeFocusedWindow()Lcom/android/server/wm/WindowState;
    ...
    invoke-interface {v3}, Lcom/android/server/wm/IWindowManagerServiceBridge;->getVSFocusedWindow()Lcom/android/server/wm/WindowState;
...
.method handleNotObscuredLocked(Lcom/android/server/wm/WindowState;ZZ)Z
    ...
    invoke-interface {v8}, Lcom/android/server/wm/IWindowManagerServiceBridge;->isDesktopModeLoadingScreenShowing()Z
...
.method performSurfacePlacement(Z)V
    ...
    invoke-interface/range {v25 .. v25}, Lcom/android/server/wm/IWindowManagerServiceBridge;->notifyOrientationChangeComplete()V
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/server/wm/WindowManagerService;->getSecondaryDisplayId()I
...
.method setDisplayOverrideConfigurationIfNeeded(Landroid/content/res/Configuration;I)[I
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/WindowManagerService;->getSecondaryDisplayId()I

    move-result v3

    if-ne p2, v3, :cond_4

    invoke-virtual {p0, p2}, Lcom/android/server/wm/RootWindowContainer;->onNonDefaultDisplayConfigurationChanged(I)V
