...
.method public getLaunchBoundsForMetaKeyEvent(Landroid/view/WindowManagerPolicy$WindowState;I)Landroid/graphics/Rect;
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/Task;->isAttachedToDisplay()Z
    ...
    :cond_0
    sget-object v4, Lcom/samsung/android/multiwindow/MultiWindowManager$MetaKeyBoundsChecker;->sInvalidBounds:Landroid/graphics/Rect;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_1
    :try_start_1
    iget-object v4, p0, Lcom/android/server/wm/MultiWindowManagerInternal;->mFreeformController:Lcom/android/server/wm/FreeformStackWindowController;

    invoke-virtual {v4, v2, p2}, Lcom/android/server/wm/FreeformStackWindowController;->getLaunchBoundsForMetaKeyEventLocked(Lcom/android/server/wm/Task;I)Landroid/graphics/Rect;
    :try_end_1
...
.method public resizeTaskWithRelaunchAnim(Lcom/android/server/wm/AppWindowToken;Landroid/graphics/Rect;)V
    ...
    const-string/jumbo v6, "resize_task"

    const/4 v7, 0x0

    const/4 v8, 0x2

    invoke-virtual {v5, v7, v8, v6}, Lcom/android/server/wm/ScreenFreezeAnimationController;->setFreeformRelaunchAnimState(Ljava/util/ArrayList;ILjava/lang/String;)V
