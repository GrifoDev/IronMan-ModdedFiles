...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/wm/Session$1;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/android/server/wm/Session;)Lcom/android/server/wm/AlertWindowNotification;
    .locals 1
...
.method static synthetic -get1(Lcom/android/server/wm/Session;)Z
    .locals 1
...
.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;Landroid/view/IWindowSessionCallback;Lcom/android/internal/view/IInputMethodClient;Lcom/android/internal/view/IInputContext;)V
    ...
    iput v9, p0, Lcom/android/server/wm/Session;->mNumWindow:I

    new-instance v7, Ljava/util/HashSet;

    invoke-direct {v7}, Ljava/util/HashSet;-><init>()V

    iput-object v7, p0, Lcom/android/server/wm/Session;->mAppOverlaySurfaces:Ljava/util/Set;

    new-instance v7, Ljava/util/HashSet;

    invoke-direct {v7}, Ljava/util/HashSet;-><init>()V

    iput-object v7, p0, Lcom/android/server/wm/Session;->mAlertWindowSurfaces:Ljava/util/Set;

    iput-boolean v9, p0, Lcom/android/server/wm/Session;->mClientDead:Z

    new-instance v7, Lcom/android/server/wm/Session$1;

    invoke-direct {v7, p0}, Lcom/android/server/wm/Session$1;-><init>(Lcom/android/server/wm/Session;)V

    iput-object v7, p0, Lcom/android/server/wm/Session;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput v7, p0, Lcom/android/server/wm/Session;->mUid:I

    invoke-static {}, Landroid/os/Binder;->getCallingPid()I

    move-result v7

    iput v7, p0, Lcom/android/server/wm/Session;->mPid:I

    invoke-virtual {p1}, Lcom/android/server/wm/WindowManagerService;->getCurrentAnimatorScale()F

    move-result v7

    iput v7, p0, Lcom/android/server/wm/Session;->mLastReportedAnimatorScale:F

    iget-object v7, p1, Lcom/android/server/wm/WindowManagerService;->mContext:Landroid/content/Context;

    const-string/jumbo v10, "android.permission.INTERNAL_SYSTEM_WINDOW"

    invoke-virtual {v7, v10}, Landroid/content/Context;->checkCallingOrSelfPermission(Ljava/lang/String;)I
    ...
    :goto_0
    iput-boolean v7, p0, Lcom/android/server/wm/Session;->mCanAddInternalSystemWindow:Z

    iget-object v7, p1, Lcom/android/server/wm/WindowManagerService;->mContext:Landroid/content/Context;

    const-string/jumbo v10, "android.permission.HIDE_NON_SYSTEM_OVERLAY_WINDOWS"
    ...
    :goto_1
    iput-boolean v8, p0, Lcom/android/server/wm/Session;->mCanHideNonSystemOverlayWindows:Z

    iget-object v7, p0, Lcom/android/server/wm/Session;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-boolean v7, v7, Lcom/android/server/wm/WindowManagerService;->mShowAlertWindowNotifications:Z

    iput-boolean v7, p0, Lcom/android/server/wm/Session;->mShowingAlertWindowNotificationAllowed:Z
    ...
    iput-object v7, p0, Lcom/android/server/wm/Session;->mStringName:Ljava/lang/String;
    ...
    iget-object v7, v7, Lcom/android/server/wm/WindowManagerService;->mInputMethodManager:Lcom/android/internal/view/IInputMethodManager;

    if-nez v7, :cond_0

    iget-object v7, p0, Lcom/android/server/wm/Session;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-boolean v7, v7, Lcom/android/server/wm/WindowManagerService;->mHaveInputMethods:Z
    ...
    iput-object v9, v7, Lcom/android/server/wm/WindowManagerService;->mInputMethodManager:Lcom/android/internal/view/IInputMethodManager;
    :try_end_0
    ...
    iget v8, p0, Lcom/android/server/wm/Session;->mUid:I

    iget v9, p0, Lcom/android/server/wm/Session;->mPid:I

    invoke-interface {v7, p3, p4, v8, v9}, Lcom/android/internal/view/IInputMethodManager;->addClient(Lcom/android/internal/view/IInputMethodClient;Lcom/android/internal/view/IInputContext;II)V
    ...
    invoke-interface {v7, p0, v8}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_1
    ...
    iget-object v8, p0, Lcom/android/server/wm/Session;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    :try_start_2
    invoke-interface {p3, v7}, Lcom/android/internal/view/IInputMethodClient;->setUsingInputMethod(Z)V
    :try_end_2
    ...
    invoke-interface {v7, p3}, Lcom/android/internal/view/IInputMethodManager;->removeClient(Lcom/android/internal/view/IInputMethodClient;)V
    :try_end_3
