...
.method public setDexCompatMode(ZI)V
    ...
    iput-boolean p1, v0, Lcom/android/server/wm/Task;->mIsDexCompatEnabled:Z

    iget-object v0, p0, Lcom/android/server/wm/TaskWindowContainerController;->mContainer:Lcom/android/server/wm/WindowContainer;

    check-cast v0, Lcom/android/server/wm/Task;

    iput p2, v0, Lcom/android/server/wm/Task;->mDexCompatUiMode:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public setLastBoundsForMetaKeyInteractionLocked(Landroid/graphics/Rect;)V
    ...
    iput-object v2, v0, Lcom/android/server/wm/Task;->mLastBoundsForMetaKeyEvent:Landroid/graphics/Rect;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public setProcessKillAfterRemovingTask(Z)V
    ...
    iget-object v3, p0, Lcom/android/server/wm/TaskWindowContainerController;->mWindowMap:Lcom/android/server/wm/WindowHashMap;
    ...
    const-string/jumbo v5, "setProcessKillAfterRemovingTask: mContainer is null, taskId="
    ...
    iget-object v2, v2, Lcom/android/server/wm/Task;->mChildren:Lcom/android/server/wm/WindowList;
    ...
    iput-boolean p1, v0, Lcom/android/server/wm/AppWindowToken;->mProcessKillAfterRemovingTask:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
