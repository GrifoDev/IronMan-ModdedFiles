...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "mIsDexCompatEnabled="
    ...
    const-string/jumbo v0, "mTransientBarShowingDelay="
...
.method findDexCompatBaseWindowLocked()Lcom/android/server/wm/WindowState;
    ...
    iget-boolean v4, v3, Lcom/android/server/wm/WindowState;->mReplacingRemoveRequested:Z

    if-nez v4, :cond_0

    iget-boolean v4, v3, Lcom/android/server/wm/WindowState;->mIsDecorCaptionWin:Z

    if-nez v4, :cond_0

    invoke-virtual {v3}, Lcom/android/server/wm/WindowState;->isFullscreen()Z
...
.method hasDecorCaptionWin()Z
    ...
    iget-boolean v1, v1, Lcom/android/server/wm/WindowState;->mIsDecorCaptionWin:Z
...
.method onAppTransitionDone()V
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/AppWindowToken;->sendingToBottom:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/AppWindowToken;->sendingToBottom:Z
...
.method transferStartingWindow(Landroid/os/IBinder;)Z
    ...
    invoke-virtual {v7, p1}, Lcom/android/server/wm/DisplayContent;->getAppWindowToken(Landroid/os/IBinder;)Lcom/android/server/wm/AppWindowToken;
    ...
    instance-of v7, v7, Lcom/android/server/wm/SnapshotStartingData;

    if-eqz v7, :cond_2

    iget-boolean v7, v1, Lcom/android/server/wm/AppWindowToken;->startingDisplayed:Z
    ...
    const-string/jumbo v8, "stop transfering starting window and remove previous one."
    ...
    invoke-virtual {v7}, Lcom/android/server/wm/AppWindowContainerController;->removeStartingWindow()V
    ...
    iget-object v8, v1, Lcom/android/server/wm/AppWindowToken;->mAppAnimator:Lcom/android/server/wm/AppWindowAnimator;
    ...
    iget-object v7, v7, Lcom/android/server/wm/AppWindowAnimator;->transformation:Landroid/view/animation/Transformation;

    const/4 v8, 0x0

    invoke-virtual {v7, v8}, Landroid/view/animation/Transformation;->setAlpha(F)V

    :cond_1
    return v12

    :cond_2
    iget-object v5, v1, Lcom/android/server/wm/AppWindowToken;->startingWindow:Lcom/android/server/wm/WindowState;

    if-eqz v5, :cond_a

    iget-object v7, v1, Lcom/android/server/wm/AppWindowToken;->startingSurface:Landroid/view/WindowManagerPolicy$StartingSurface;

    if-eqz v7, :cond_a

    iget-object v7, p0, Lcom/android/server/wm/AppWindowToken;->mService:Lcom/android/server/wm/WindowManagerService;

    iput-boolean v11, v7, Lcom/android/server/wm/WindowManagerService;->mSkipAppTransitionAnimation:Z
    ...
    iput-object v7, p0, Lcom/android/server/wm/AppWindowToken;->startingSurface:Landroid/view/WindowManagerPolicy$StartingSurface;

    iget-boolean v7, v1, Lcom/android/server/wm/AppWindowToken;->startingDisplayed:Z

    iput-boolean v7, p0, Lcom/android/server/wm/AppWindowToken;->startingDisplayed:Z

    iput-boolean v12, v1, Lcom/android/server/wm/AppWindowToken;->startingDisplayed:Z

    iput-object v5, p0, Lcom/android/server/wm/AppWindowToken;->startingWindow:Lcom/android/server/wm/WindowState;

    iget-boolean v7, v1, Lcom/android/server/wm/AppWindowToken;->reportedVisible:Z

    iput-boolean v7, p0, Lcom/android/server/wm/AppWindowToken;->reportedVisible:Z

    iput-object v10, v1, Lcom/android/server/wm/AppWindowToken;->startingData:Lcom/android/server/wm/StartingData;

    iput-object v10, v1, Lcom/android/server/wm/AppWindowToken;->startingSurface:Landroid/view/WindowManagerPolicy$StartingSurface;

    iput-object v10, v1, Lcom/android/server/wm/AppWindowToken;->startingWindow:Lcom/android/server/wm/WindowState;

    iput-boolean v11, v1, Lcom/android/server/wm/AppWindowToken;->startingMoved:Z

    iput-object p0, v5, Lcom/android/server/wm/WindowState;->mToken:Lcom/android/server/wm/WindowToken;

    iput-object p0, v5, Lcom/android/server/wm/WindowState;->mAppToken:Lcom/android/server/wm/AppWindowToken;
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/WindowState;->getBridge()Lcom/samsung/android/view/IWindowStateBridge;

    move-result-object v7

    invoke-interface {v7, v0}, Lcom/samsung/android/view/IWindowStateBridge;->getCustomAspectRatioFrame(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v7}, Lcom/android/server/policy/PhoneWindowManager;->getSamsungPolicy()Lcom/android/server/policy/IPhoneWindowManagerBridge;
    ...
    invoke-interface {v7, v5, v0, v8}, Lcom/android/server/policy/IPhoneWindowManagerBridge;->adjustAspectRatioFrame(Landroid/view/WindowManagerPolicy$WindowState;Landroid/graphics/Rect;Landroid/view/DisplayInfo;)V

    iget-object v7, v5, Lcom/android/server/wm/WindowState;->mAppToken:Lcom/android/server/wm/AppWindowToken;

    invoke-virtual {v7, v0}, Lcom/android/server/wm/AppWindowToken;->setBounds(Landroid/graphics/Rect;)V
    ...
    :cond_6
    invoke-virtual {v1, v5}, Lcom/android/server/wm/AppWindowToken;->removeChild(Lcom/android/server/wm/WindowState;)V

    invoke-virtual {v1, v5}, Lcom/android/server/wm/AppWindowToken;->postWindowRemoveStartingWindowCleanup(Lcom/android/server/wm/WindowState;)V

    iput-boolean v12, v1, Lcom/android/server/wm/AppWindowToken;->mHiddenSetFromTransferredStartingWindow:Z

    invoke-virtual {p0, v5}, Lcom/android/server/wm/AppWindowToken;->addWindow(Lcom/android/server/wm/WindowState;)V

    iget-boolean v7, v1, Lcom/android/server/wm/AppWindowToken;->allDrawn:Z

    if-eqz v7, :cond_7

    iput-boolean v11, p0, Lcom/android/server/wm/AppWindowToken;->allDrawn:Z

    iget-boolean v7, v1, Lcom/android/server/wm/AppWindowToken;->deferClearAllDrawn:Z

    iput-boolean v7, p0, Lcom/android/server/wm/AppWindowToken;->deferClearAllDrawn:Z

    :cond_7
    iget-boolean v7, v1, Lcom/android/server/wm/AppWindowToken;->firstWindowDrawn:Z

    if-eqz v7, :cond_8

    iput-boolean v11, p0, Lcom/android/server/wm/AppWindowToken;->firstWindowDrawn:Z

    :cond_8
    iget-boolean v7, v1, Lcom/android/server/wm/AppWindowToken;->hidden:Z

    if-nez v7, :cond_9

    iput-boolean v12, p0, Lcom/android/server/wm/AppWindowToken;->hidden:Z

    iput-boolean v12, p0, Lcom/android/server/wm/AppWindowToken;->hiddenRequested:Z

    iput-boolean v11, p0, Lcom/android/server/wm/AppWindowToken;->mHiddenSetFromTransferredStartingWindow:Z

    :cond_9
    iget-boolean v7, v1, Lcom/android/server/wm/AppWindowToken;->mClientHidden:Z

    invoke-virtual {p0, v7}, Lcom/android/server/wm/AppWindowToken;->setClientHidden(Z)V

    iget-object v7, v1, Lcom/android/server/wm/AppWindowToken;->mAppAnimator:Lcom/android/server/wm/AppWindowAnimator;

    iget-object v8, p0, Lcom/android/server/wm/AppWindowToken;->mAppAnimator:Lcom/android/server/wm/AppWindowAnimator;
    ...
    invoke-virtual {v7, v8, v11}, Lcom/android/server/wm/WindowManagerService;->updateFocusedWindowLocked(IZ)Z
    ...
    invoke-virtual {v7}, Lcom/android/server/wm/AppWindowContainerController;->scheduleAddStartingWindow()V
    ...
    iget-object v6, p0, Lcom/android/server/wm/AppWindowToken;->mAppAnimator:Lcom/android/server/wm/AppWindowAnimator;
