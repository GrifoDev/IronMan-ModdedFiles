...
.method constructor <init>(Lcom/android/server/policy/PhoneWindowManager;IIILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/WindowManagerPolicy$WindowState;Z)V
    ...
    iput-object p7, p0, Lcom/android/server/policy/PhoneWindowManager$23;->val$win:Landroid/view/WindowManagerPolicy$WindowState;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/android/server/policy/PhoneWindowManager$23;->this$0:Lcom/android/server/policy/PhoneWindowManager;
    ...
    const-string/jumbo v3, "set systemUiVisibility of statusbar : systemUiFlags= 0x"
    ...
    iget v3, v3, Lcom/android/server/policy/PhoneWindowManager;->mLastSystemUiFlags:I
    ...
    const-string/jumbo v3, " fullscreenStackSysUiFlag= 0x"
    ...
    iget v3, v3, Lcom/android/server/policy/PhoneWindowManager;->mLastFullscreenStackSysUiFlags:I
    ...
    iget v1, p0, Lcom/android/server/policy/PhoneWindowManager$23;->val$visibility:I

    iget v2, p0, Lcom/android/server/policy/PhoneWindowManager$23;->val$fullscreenVisibility:I

    iget v3, p0, Lcom/android/server/policy/PhoneWindowManager$23;->val$dockedVisibility:I

    iget-object v5, p0, Lcom/android/server/policy/PhoneWindowManager$23;->val$fullscreenStackBounds:Landroid/graphics/Rect;

    iget-object v6, p0, Lcom/android/server/policy/PhoneWindowManager$23;->val$dockedStackBounds:Landroid/graphics/Rect;

    iget-object v4, p0, Lcom/android/server/policy/PhoneWindowManager$23;->val$win:Landroid/view/WindowManagerPolicy$WindowState;
