...
.field private static msfforSemContextRotation:Lcom/samsung/android/smartface/SmartFaceManager;
...
.method static synthetic -get5()Lcom/samsung/android/smartface/SmartFaceManager;
    ...
    sget-object v0, Lcom/android/server/policy/WindowOrientationListener;->msfforSemContextRotation:Lcom/samsung/android/smartface/SmartFaceManager;
...
.method static synthetic -set0(Lcom/samsung/android/smartface/SmartFaceManager;)Lcom/samsung/android/smartface/SmartFaceManager;
    ...
    sput-object p0, Lcom/android/server/policy/WindowOrientationListener;->msfforSemContextRotation:Lcom/samsung/android/smartface/SmartFaceManager;
...
.method private constructor <init>(Landroid/content/Context;Landroid/os/Handler;I)V
    ...
    iput-boolean v5, p0, Lcom/android/server/policy/WindowOrientationListener;->mbSemContext:Z
    ...
    iput-object v2, p0, Lcom/android/server/policy/WindowOrientationListener;->mSemContextManager:Lcom/samsung/android/hardware/context/SemContextManager;
    ...
    iput-boolean v6, p0, Lcom/android/server/policy/WindowOrientationListener;->mbSemContext:Z
    ...
    const-string/jumbo v4, "mbSemContext : "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-boolean v4, p0, Lcom/android/server/policy/WindowOrientationListener;->mbSemContext:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/policy/WindowOrientationListener;->mbSemContext:Z

    if-eqz v2, :cond_3

    const-string/jumbo v2, "WindowOrientationListener"

    const-string/jumbo v3, "++SemContextListenerImpl"
...
.method public canDetectOrientation()Z
    ...
    :try_start_0
    iget-boolean v3, p0, Lcom/android/server/policy/WindowOrientationListener;->mbSemContext:Z
...
.method public disable()V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/WindowOrientationListener;->mbSemContext:Z
...
.method public enable()V
    ...
    :try_start_0
    iput-boolean v1, p0, Lcom/android/server/policy/WindowOrientationListener;->mbResultFaceDectection:Z

    iget-boolean v1, p0, Lcom/android/server/policy/WindowOrientationListener;->mbSemContext:Z
    ...
    const-string/jumbo v3, "WindowOrientationListener enabled"
    ...
    invoke-virtual {v1}, Lcom/android/server/policy/WindowOrientationListener$OrientationJudge;->resetLocked()V
    ...
    invoke-virtual {v1, v3, v4, v0}, Lcom/samsung/android/hardware/context/SemContextManager;->registerListener(Lcom/samsung/android/hardware/context/SemContextListener;ILcom/samsung/android/hardware/context/SemContextAttribute;)Z
