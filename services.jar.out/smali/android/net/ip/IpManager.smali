...
.field private mIsWifiSMStarted:Z
...
.method static synthetic -get12(Landroid/net/ip/IpManager;)Lcom/android/internal/util/WakeupMessage;
    .locals 1
...
.method static synthetic -get13(Landroid/net/ip/IpManager;)Lcom/android/internal/util/State;
    .locals 1
...
.method static synthetic -get6(Landroid/net/ip/IpManager;)Z
    .locals 1

    iget-boolean v0, p0, Landroid/net/ip/IpManager;->mIsStartCalled:Z

    return v0
.end method

.method static synthetic -get7(Landroid/net/ip/IpManager;)Landroid/net/LinkProperties;
    .locals 1
...
.method static synthetic -get8(Landroid/net/ip/IpManager;)Landroid/util/LocalLog;
    .locals 1
...
.method static synthetic -get9(Landroid/net/ip/IpManager;)Landroid/net/ip/IpManager$MessageHandlingLogger;
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/net/ip/IpManager$Callback;Landroid/os/INetworkManagementService;)V
    ...
    iput-boolean v3, p0, Landroid/net/ip/IpManager;->mIsWifiSMStarted:Z

    iput-boolean v3, p0, Landroid/net/ip/IpManager;->mIsStartCalled:Z
    ...
    iput-boolean v1, p0, Landroid/net/ip/IpManager;->mIsStartCalled:Z
