...
.method installNewProgramLocked()V
    ...
    check-cast v11, Landroid/net/apf/ApfFilter$Ra;

    invoke-virtual {v11, v9}, Landroid/net/apf/ApfFilter$Ra;->generateFilterLocked(Landroid/net/apf/ApfGenerator;)J

    invoke-virtual {v9}, Landroid/net/apf/ApfGenerator;->programLengthOverEstimate()I
    ...
    :cond_2
    :try_start_1
    invoke-virtual {v9}, Landroid/net/apf/ApfGenerator;->generate()[B
    :try_end_1
    ...
    iput-object v10, p0, Landroid/net/apf/ApfFilter;->mLastInstalledProgram:[B
    ...
    invoke-virtual {v1, v10}, Landroid/net/ip/IpManager$Callback;->installPacketFilter([B)V
    ...
    iget-object v14, p0, Landroid/net/apf/ApfFilter;->mMetricsLog:Landroid/net/metrics/IpConnectivityLog;
    ...
    invoke-virtual {v14, v1}, Landroid/net/metrics/IpConnectivityLog;->log(Landroid/os/Parcelable;)V
