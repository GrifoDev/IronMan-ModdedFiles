...
.method protected receivePacket(Landroid/net/dhcp/DhcpPacket;)V
    ...
    iget-object v1, v0, Landroid/net/DhcpResults;->dnsServers:Ljava/util/ArrayList;
    ...
    invoke-static {v1}, Landroid/net/dhcp/DhcpClient;->-get17(Landroid/net/dhcp/DhcpClient;)Landroid/net/DhcpResults;
    ...
    const-string/jumbo v2, "Using Offer\'s dnsServers instead of Ack\'s because there is no Ack\'s dnsServer"
    ...
    invoke-static {v1, v2}, Landroid/net/dhcp/DhcpClient;->-wrap16(Landroid/net/dhcp/DhcpClient;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v1, v3}, Landroid/net/dhcp/DhcpClient;->-set3(Landroid/net/dhcp/DhcpClient;Landroid/net/DhcpResults;)Landroid/net/DhcpResults;
...
.method protected sendPacket()Z
    ...
    invoke-static {v3}, Landroid/net/dhcp/DhcpClient;->-get17(Landroid/net/dhcp/DhcpClient;)Landroid/net/DhcpResults;
