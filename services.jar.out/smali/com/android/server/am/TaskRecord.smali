...
.field final mMaxDimensions:Landroid/graphics/Point;

.field mMaxHeight:I

.field mMaxWidth:I

.field final mMinDimensions:Landroid/graphics/Point;
...
.method private constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/Intent;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Landroid/content/ComponentName;Landroid/content/ComponentName;ZZZIIILjava/lang/String;Ljava/util/ArrayList;JJJZLandroid/app/ActivityManager$TaskDescription;Landroid/app/ActivityManager$TaskThumbnailInfo;IIIIILjava/lang/String;IZZZII)V
    ...
    iput-object v2, p0, Lcom/android/server/am/TaskRecord;->mTmpRect3:Landroid/graphics/Rect;
    ...
    iput-boolean v2, p0, Lcom/android/server/am/TaskRecord;->mDexCompatModeUpdated:Z
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/app/ActivityManager$TaskDescription;Landroid/app/ActivityManager$TaskThumbnailInfo;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/TaskRecord;->mTmpRect3:Landroid/graphics/Rect;
    ...
    iput-boolean v3, p0, Lcom/android/server/am/TaskRecord;->mDexCompatModeUpdated:Z
    ...
    iput-boolean v4, p0, Lcom/android/server/am/TaskRecord;->mIsDexModeTask:Z
...
.method private calculateOverrideConfig(Landroid/graphics/Rect;Landroid/graphics/Rect;ZZZ)Landroid/content/res/Configuration;
    ...
    sget-object v23, Landroid/content/res/Configuration;->EMPTY:Landroid/content/res/Configuration;
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/server/am/ActivityStack;->getDisplayId()I
    ...
    invoke-interface {v0, v10, v1}, Lcom/android/server/wm/IWindowManagerServiceBridge;->computeScreenConfiguration(Landroid/content/res/Configuration;I)V

    :goto_2
    sget-boolean v23, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SAMSUNG_MULTIWINDOW_DYNAMIC_ENABLED:Z
    ...
    sget-boolean v23, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_DENSITY_CHANGE:Z
    ...
    invoke-static/range {v23 .. v24}, Lcom/samsung/android/bridge/multiwindow/MultiWindowManagerBridge$Utils;->getFreeformDensity(II)I
    ...
    iput v15, v10, Landroid/content/res/Configuration;->densityDpi:I

    int-to-float v0, v15

    move/from16 v23, v0

    const v24, 0x3bcccccd    # 0.00625f
    ...
    invoke-static/range {v23 .. v23}, Landroid/content/res/Configuration;->resetScreenLayout(I)I
    ...
    iget-boolean v0, v0, Lcom/android/server/am/TaskRecord;->mIsDexCompatEnabled:Z
    ...
    invoke-interface/range {v23 .. v23}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->getDecorCaptionWindowHeight()I
    ...
    invoke-virtual {v0, v1, v5, v2, v3}, Landroid/graphics/Rect;->inset(IIII)V
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/am/ActivityStack;->getDisplaySize(Landroid/graphics/Point;)V
    ...
    iput v0, v10, Landroid/content/res/Configuration;->fontScale:F
    ...
    sget-boolean v23, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SNAP_WINDOW_SUPPORT:Z
...
.method static restoreFromXml(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/am/ActivityStackSupervisor;)Lcom/android/server/am/TaskRecord;
    ...
    sget-boolean v6, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->MULTIWINDOW_ENSURE_DIMENSIONS_BASED_ON_TOP:Z
    ...
    const-string/jumbo v64, "TaskRecord: Unknown attribute="
    ...
    const-string/jumbo v64, "restoreTask: Unexpected name="
    ...
    const-string/jumbo v64, "Updating task #"
    ...
    const-string/jumbo v64, ": effectiveUid="
...
.method private setIntent(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)V
    ...
    iget-object v8, p0, Lcom/android/server/am/TaskRecord;->intent:Landroid/content/Intent;

    if-nez v8, :cond_7

    iget v8, p2, Landroid/content/pm/ActivityInfo;->flags:I
    ...
    :goto_0
    iput-boolean v8, p0, Lcom/android/server/am/TaskRecord;->mNeverRelinquishIdentity:Z

    :cond_0
    iget-object v8, p2, Landroid/content/pm/ActivityInfo;->taskAffinity:Ljava/lang/String;

    iput-object v8, p0, Lcom/android/server/am/TaskRecord;->affinity:Ljava/lang/String;

    iget-object v8, p0, Lcom/android/server/am/TaskRecord;->intent:Landroid/content/Intent;

    if-nez v8, :cond_1

    iget-object v8, p0, Lcom/android/server/am/TaskRecord;->affinity:Ljava/lang/String;

    iput-object v8, p0, Lcom/android/server/am/TaskRecord;->rootAffinity:Ljava/lang/String;
    ...
    iput v8, p0, Lcom/android/server/am/TaskRecord;->effectiveUid:I

    const/4 v8, 0x0

    iput-object v8, p0, Lcom/android/server/am/TaskRecord;->stringName:Ljava/lang/String;
    ...
    invoke-virtual {v0, v8}, Landroid/content/Intent;->setSourceBounds(Landroid/graphics/Rect;)V
    ...
    :goto_1
    iput-object v8, p0, Lcom/android/server/am/TaskRecord;->realActivity:Landroid/content/ComponentName;

    const/4 v8, 0x0

    iput-object v8, p0, Lcom/android/server/am/TaskRecord;->origActivity:Landroid/content/ComponentName;
    ...
    iput-boolean v8, p0, Lcom/android/server/am/TaskRecord;->rootWasReset:Z
    ...
    iput v8, p0, Lcom/android/server/am/TaskRecord;->userId:I
    ...
    iget v10, p0, Lcom/android/server/am/TaskRecord;->userId:I
    ...
    :goto_4
    iput-boolean v8, p0, Lcom/android/server/am/TaskRecord;->mUserSetupComplete:Z
    ...
    iput-boolean v8, p0, Lcom/android/server/am/TaskRecord;->autoRemoveRecents:Z

    :goto_5
    iget v8, p2, Landroid/content/pm/ActivityInfo;->resizeMode:I

    iput v8, p0, Lcom/android/server/am/TaskRecord;->mResizeMode:I

    iget v8, p2, Landroid/content/pm/ActivityInfo;->lockTaskLaunchMode:I

    iput v8, p0, Lcom/android/server/am/TaskRecord;->mLockTaskMode:I
    ...
    :goto_6
    iput-boolean v8, p0, Lcom/android/server/am/TaskRecord;->mPrivileged:Z
    ...
    sget-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->MULTIWINDOW_ENSURE_DIMENSIONS_BASED_ON_TOP:Z
    ...
    :cond_7
    iget-boolean v8, p0, Lcom/android/server/am/TaskRecord;->mNeverRelinquishIdentity:Z
    ...
    invoke-virtual {v7, v8}, Landroid/content/Intent;->setSelector(Landroid/content/Intent;)V

    const/4 v8, 0x0

    invoke-virtual {v7, v8}, Landroid/content/Intent;->setSourceBounds(Landroid/graphics/Rect;)V

    iput-object v7, p0, Lcom/android/server/am/TaskRecord;->intent:Landroid/content/Intent;

    iput-object v6, p0, Lcom/android/server/am/TaskRecord;->realActivity:Landroid/content/ComponentName;
    ...
    iput-object v8, p0, Lcom/android/server/am/TaskRecord;->intent:Landroid/content/Intent;
    ...
    iget v8, p2, Landroid/content/pm/ActivityInfo;->documentLaunchMode:I
    ...
    :cond_11
    iget-object v8, p2, Landroid/content/pm/ActivityInfo;->windowLayout:Landroid/content/pm/ActivityInfo$WindowLayout;

    if-eqz v8, :cond_12

    iget-object v8, p0, Lcom/android/server/am/TaskRecord;->mMinDimensions:Landroid/graphics/Point;

    iget-object v9, p2, Landroid/content/pm/ActivityInfo;->windowLayout:Landroid/content/pm/ActivityInfo$WindowLayout;

    iget v9, v9, Landroid/content/pm/ActivityInfo$WindowLayout;->minWidth:I
    ...
    iget v9, v9, Landroid/content/pm/ActivityInfo$WindowLayout;->minHeight:I

    iput v9, v8, Landroid/graphics/Point;->y:I

    :cond_12
    iget-object v8, p2, Landroid/content/pm/ActivityInfo;->metaData:Landroid/os/Bundle;
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/wm/WindowManagerService;->getInitialDisplayDensity(I)I
    ...
    const-string/jumbo v9, "com.samsung.android.sdk.multiwindow.maxWidth"
    ...
    const-string/jumbo v9, "com.samsung.android.sdk.multiwindow.maxHeight"
    ...
    iget-object v8, p0, Lcom/android/server/am/TaskRecord;->mMaxDimensions:Landroid/graphics/Point;
...
.method private setMaxDimensions(Landroid/content/pm/ActivityInfo;)V
    ...
    invoke-interface {v1, v0, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->getTaskMaxDimensions(Landroid/graphics/Point;Landroid/content/pm/ActivityInfo;)V
...
.method private setMinDimensions(Landroid/content/pm/ActivityInfo;)V
    ...
    invoke-interface {v1, v0, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->getTaskMinDimensions(Landroid/graphics/Point;Landroid/content/pm/ActivityInfo;)V
...
.method addActivityAtIndex(ILcom/android/server/am/ActivityRecord;)V
    ...
    invoke-interface {v2, p2}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setTaskDimensions(Lcom/android/server/am/ActivityRecord;)V
...
.method getDexDefaultHeight()I
    ...
    iget-object v1, p0, Lcom/android/server/am/TaskRecord;->mDexLaunchDimensions:Landroid/graphics/Point;
...
.method getLaunchBounds()Landroid/graphics/Rect;
    ...
    invoke-interface {v1, p0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->getSupportScreenBounds(Lcom/android/server/am/TaskRecord;)Landroid/graphics/Rect;
...
.method setDexDefaultDimensions(Landroid/content/pm/ActivityInfo;)V
    ...
    const-string/jumbo v3, "com.samsung.android.sdk.multiwindow.dex.launchwidth"
    ...
    const-string/jumbo v3, "com.samsung.android.sdk.multiwindow.dex.launchheight"
    ...
    iput-object v2, p0, Lcom/android/server/am/TaskRecord;->mDexLaunchDimensions:Landroid/graphics/Point;
...
.method updateOverrideConfiguration(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/content/res/Configuration;
    ...
    invoke-interface {v0, p0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->updateDexCompatModeLocked(Lcom/android/server/am/TaskRecord;)V
    ...
    :goto_2
    iput v0, v2, Landroid/content/res/Configuration;->dexCompatEnabled:I
...
.method updateOverrideConfigurationFromLaunchBounds()Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lcom/android/server/am/TaskRecord;->mTmpRect3:Landroid/graphics/Rect;
