...
.method public sendControlInfo(ILjava/lang/String;)Z
    ...
    iget-object v9, p0, Lcom/android/server/am/BartenderActivityManager;->mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-boolean v8, v1, Lcom/android/server/am/ProcessRecord;->freezed:Z
    ...
    iget-object v11, p0, Lcom/android/server/am/BartenderActivityManager;->mContext:Landroid/content/Context;

    invoke-virtual {v11}, Landroid/content/Context;->getUserId()I

    move-result v11

    const-string/jumbo v12, "Bartender-kill"

    invoke-virtual {v8, v10, v11, v12}, Lcom/android/server/am/MARsPolicyManager;->unFreezePackage(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v8, v10}, Lcom/android/server/am/ProcessRecord;->kill(Ljava/lang/String;Z)V
    :try_end_1
    ...
    iput-boolean v8, v1, Lcom/android/server/am/ProcessRecord;->slowCachedStay:Z

    const/4 v8, 0x0

    iput-boolean v8, v1, Lcom/android/server/am/ProcessRecord;->slowCached:Z
    ...
    iput-boolean v8, v1, Lcom/android/server/am/ProcessRecord;->slowAbnormalStay:Z

    const/4 v8, 0x0

    iput-boolean v8, v1, Lcom/android/server/am/ProcessRecord;->slowAbnormal:Z
