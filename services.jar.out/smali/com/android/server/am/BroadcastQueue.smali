...
.method final processNextBroadcast(Z)V
    ...
    check-cast v59, Lcom/android/server/am/BroadcastRecord;
    ...
    check-cast v68, Lcom/android/server/am/BroadcastFilter;
    ...
    check-cast v40, Lcom/android/server/am/BroadcastQueue$BroadcastSpamCheckEntry;

    if-nez v40, :cond_17

    new-instance v40, Lcom/android/server/am/BroadcastQueue$BroadcastSpamCheckEntry;
    ...
    :cond_1e
    invoke-static/range {v63 .. v63}, Ljava/util/Collections;->sort(Ljava/util/List;)V
    ...
    iget-wide v10, v0, Lcom/android/server/am/BroadcastQueue;->mBroadcastSpamCheckTimeLast:J
    ...
    invoke-virtual/range {v34 .. v34}, Landroid/content/ComponentName;->flattenToShortString()Ljava/lang/String;
    ...
    invoke-virtual/range {v4 .. v11}, Lcom/android/server/am/MARsPolicyManager;->isRestrictedFreezedPackage(Landroid/content/ComponentName;Landroid/app/IApplicationThread;IILjava/lang/String;Landroid/content/Intent;I)Z
    :try_end_d
    ...
    :cond_39
    invoke-static/range {v65 .. v65}, Landroid/app/AppOpsManager;->permissionToOpCode(Ljava/lang/String;)I
    ...
    invoke-static/range {v65 .. v65}, Landroid/app/AppOpsManager;->permissionToOp(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v39 .. v39}, Ljava/lang/SecurityException;->getMessage()Ljava/lang/String;
