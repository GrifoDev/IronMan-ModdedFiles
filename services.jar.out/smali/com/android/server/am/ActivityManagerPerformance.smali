...
.method private setBoosterHome(ZZLcom/android/server/am/ActivityRecord;)V
    ...
    const-string/jumbo v10, "setBoosterHome() fastBoost: "
    ...
    const-string/jumbo v10, ", startAct: "
    ...
    const-string/jumbo v10, ", curTopState: "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    sget v10, Lcom/android/server/am/ActivityManagerPerformance;->curTopState:I

    invoke-static {v10}, Lcom/android/server/am/ActivityManagerPerformance;->topStateToString(I)Ljava/lang/String;
    ...
    const-string/jumbo v10, "setBoosterHome() Trace\n"
    ...
    const-string/jumbo v9, "setBoosterHome() skipped. Method is called by non-system_server"
    ...
    :cond_3
    iget-boolean v8, p0, Lcom/android/server/am/ActivityManagerPerformance;->mIsScreenOn:Z
    ...
    const-string/jumbo v9, "setBoosterHome() skipped. mIsScreenOn: false"
    ...
    const-string/jumbo v10, "setBoosterHome() skipped. Home key was pressed, but curTopState is already "
    ...
    :cond_9
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerPerformance;->rLastActHome:Lcom/android/server/am/ActivityRecord;
    ...
    const-string/jumbo v9, "setBoosterHome() skipped. uninterrupted boosting"
    ...
    const-string/jumbo v10, "setBoosterHome() skipped. already boosted "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v10, p3, Lcom/android/server/am/ActivityRecord;->processName:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityManagerPerformance;->rCurBoostAppSwitch:Lcom/android/server/am/ActivityRecord;
    ...
    const-string/jumbo v9, "setBoosterHome() call setBoosterActStart()"
    ...
    invoke-direct {p0, v8, p3}, Lcom/android/server/am/ActivityManagerPerformance;->setBoosterActStart(ZLcom/android/server/am/ActivityRecord;)V
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityManagerPerformance;->rCurBoostActResume:Lcom/android/server/am/ActivityRecord;
    ...
    const-string/jumbo v9, "setBoosterHome() call setBoosterActResume()"
    ...
    invoke-direct {p0, v8, p3}, Lcom/android/server/am/ActivityManagerPerformance;->setBoosterActResume(ZLcom/android/server/am/ActivityRecord;)V

    goto :goto_2

    :cond_1c
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerPerformance;->mBoosterHome:Lcom/samsung/android/os/SemDvfsManager;

    if-nez v8, :cond_1d

    iget-object v8, p0, Lcom/android/server/am/ActivityManagerPerformance;->mContext:Landroid/content/Context;

    const-string/jumbo v9, "AMS_APP_HOME"
    ...
    iput-object v8, p0, Lcom/android/server/am/ActivityManagerPerformance;->mBoosterHome:Lcom/samsung/android/os/SemDvfsManager;
    ...
    const-string/jumbo v9, "setBoosterHome() skipped. SemDvfsManager.createInstance() failed"
    ...
    :try_start_0
    iget-object v9, p0, Lcom/android/server/am/ActivityManagerPerformance;->mLockHome:Ljava/lang/Object;
    ...
    const-string/jumbo v9, "AMP_acquire() HOME failed"
    ...
    const-string/jumbo v10, "AMP_acquire() HOME failed. e: "
