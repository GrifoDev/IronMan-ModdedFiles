...
.field private static final DEFAULT_COMPONENT_NAME:Ljava/lang/String; = "SluggishInfo_AAAA"
...
.method static constructor <clinit>()V
    ...
    sput-boolean v2, Lcom/android/server/am/SluggishInfo;->DEBUG:Z

    sput-boolean v2, Lcom/android/server/am/SluggishInfo;->ALWAYS:Z

    sput-object v7, Lcom/android/server/am/SluggishInfo;->CurrentLocale:Ljava/util/Locale;

    sput-object v7, Lcom/android/server/am/SluggishInfo;->DateFormat:Ljava/text/SimpleDateFormat;

    const/16 v1, 0x3e8

    sput v1, Lcom/android/server/am/SluggishInfo;->MAXIMUM_LOG_COUNT:I

    sput-object v7, Lcom/android/server/am/SluggishInfo;->LogList:Ljava/util/LinkedList;

    sput-boolean v3, Lcom/android/server/am/SluggishInfo;->FLAG_MEMINFO:Z

    sput-boolean v3, Lcom/android/server/am/SluggishInfo;->FLAG_DHA:Z

    sput-boolean v3, Lcom/android/server/am/SluggishInfo;->FLAG_VMSTAT:Z

    const-string/jumbo v1, "SluggishInfo_AAAA"
    ...
    const-string/jumbo v4, "SluggishInfo static initialize"
    ...
    :goto_0
    sput-boolean v1, Lcom/android/server/am/SluggishInfo;->ENABLE:Z
    ...
    sput-object v7, Lcom/android/server/am/SluggishInfo;->instance:Lcom/android/server/am/SluggishInfo;
    ...
    const-string/jumbo v4, "SwapFree"

    aput-object v4, v1, v8

    sput-object v1, Lcom/android/server/am/SluggishInfo;->TypeMeminfo:[Ljava/lang/String;

    sput v6, Lcom/android/server/am/SluggishInfo;->numCached:I

    sput v6, Lcom/android/server/am/SluggishInfo;->numEmpty:I

    sput v6, Lcom/android/server/am/SluggishInfo;->numCachedHiddenProcs:I

    sput v6, Lcom/android/server/am/SluggishInfo;->numNonCachedProcs:I

    const/4 v1, 0x4

    new-array v1, v1, [Ljava/lang/String;

    const-string/jumbo v4, "numCached"

    aput-object v4, v1, v2

    const-string/jumbo v4, "numEmpty"

    aput-object v4, v1, v3

    const-string/jumbo v4, "numCachedHiddenProcs"

    aput-object v4, v1, v8

    const-string/jumbo v4, "numNonCachedProcs"

    const/4 v5, 0x3

    aput-object v4, v1, v5

    sput-object v1, Lcom/android/server/am/SluggishInfo;->TypeDHA:[Ljava/lang/String;
    ...
    const-string/jumbo v2, "pgsteal_kswapd_dma"

    aput-object v2, v1, v8

    const-string/jumbo v2, "pgsteal_kswapd_normal"

    const/4 v3, 0x3

    aput-object v2, v1, v3

    const-string/jumbo v2, "pgsteal_kswapd_movable"

    const/4 v3, 0x4

    aput-object v2, v1, v3

    const-string/jumbo v2, "pgsteal_direct_dma"

    const/4 v3, 0x5

    aput-object v2, v1, v3

    const-string/jumbo v2, "pgsteal_direct_normal"

    const/4 v3, 0x6

    aput-object v2, v1, v3

    const-string/jumbo v2, "pgsteal_direct_movable"

    const/4 v3, 0x7

    aput-object v2, v1, v3

    const-string/jumbo v2, "allocstall"

    const/16 v3, 0x8

    aput-object v2, v1, v3

    const-string/jumbo v2, "compact_stall"

    const/16 v3, 0x9

    aput-object v2, v1, v3

    sput-object v1, Lcom/android/server/am/SluggishInfo;->TypeVmstat:[Ljava/lang/String;
...
.method static addChangeActivityLog(Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "SluggishInfo_addChangeActivityLog()"
...
.method private static declared-synchronized addInnerChangeActivityLog(Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "SluggishInfo_addInnerChangeActivityLog()"
...
.method private static declared-synchronized addInnerEndLaunchingLog(Ljava/lang/String;)V
    ...
    :cond_1
    :try_start_1
    const-string/jumbo v0, "SluggishInfo_AAAA"
    ...
    const-string/jumbo v0, "SluggishInfo_addInnerEndLaunchingLog()"
...
.method private static declared-synchronized addInnerStartLaunchingLog(Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "SluggishInfo_addInnerStartLaunchingLog()"
...
.method private static declared-synchronized addLog(Ljava/lang/String;)V
    ...
    const-class v4, Lcom/android/server/am/SluggishInfo;
    ...
    const-string/jumbo v5, "com.sec.android.app.tinym"
    ...
    const-string/jumbo v3, "SluggishInfo"

    const-string/jumbo v5, "addLog() - current log is tinym, return"
    ...
    const-string/jumbo v6, "addLog() - log : "
    ...
    const-string/jumbo v3, "SluggishInfo_addLog()"
    ...
    sget-object v3, Lcom/android/server/am/SluggishInfo;->DateFormat:Ljava/text/SimpleDateFormat;
    ...
    :cond_9
    :try_start_5
    invoke-static {v2}, Lcom/android/server/am/SluggishInfo;->initDateFormat(Ljava/util/Locale;)V
    :try_end_5
    ...
    const-string/jumbo v5, "addLog() - ERROR"
    ...
    const-string/jumbo v5, "00-00 00:00:00.000 "
...
.method static executeCommand(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    sput-boolean v5, Lcom/android/server/am/SluggishInfo;->ALWAYS:Z

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "change ALWAYS:"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget-boolean v6, Lcom/android/server/am/SluggishInfo;->ALWAYS:Z
...
.method private static getCurrentMeminfo()[J
    ...
    const-string/jumbo v5, "SluggishInfo_getCurrentMeminfo()"
...
.method private static getCurrentVmstat()[J
    ...
    const-string/jumbo v5, "SluggishInfo_getCurrentVmstat()"
...
.method private static sendLogToHandler(ILjava/lang/String;)V
    ...
    const-string/jumbo v4, "sendLogToHandler() - log : "
    ...
    invoke-virtual {v2, p0, p1}, Lcom/android/server/am/SluggishInfo$SluggishInfoHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
