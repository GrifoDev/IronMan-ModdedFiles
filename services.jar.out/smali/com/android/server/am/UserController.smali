...
.field private final mUserStateListenerRoll:Lcom/android/server/am/UserStateListenerRoll;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    new-instance v1, Lcom/android/server/am/UserStateListenerRoll;

    invoke-direct {v1}, Lcom/android/server/am/UserStateListenerRoll;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/UserController;->mUserStateListenerRoll:Lcom/android/server/am/UserStateListenerRoll;
...
.method private finishUserBoot(Lcom/android/server/am/UserState;Landroid/content/IIntentReceiver;)V
    ...
    iget-object v2, v0, Lcom/android/server/am/UserController;->mUserStateListenerRoll:Lcom/android/server/am/UserStateListenerRoll;

    const/4 v3, 0x4

    move/from16 v0, v18

    invoke-virtual {v2, v0, v3}, Lcom/android/server/am/UserStateListenerRoll;->update(II)V
...
.method private finishUserUnlocking(Lcom/android/server/am/UserState;)V
    ...
    iget-object v2, p0, Lcom/android/server/am/UserController;->mUserStateListenerRoll:Lcom/android/server/am/UserStateListenerRoll;

    const/4 v3, 0x3

    invoke-virtual {v2, v1, v3}, Lcom/android/server/am/UserStateListenerRoll;->update(II)V
...
.method finishUserStopped(Lcom/android/server/am/UserState;)V
    ...
    :cond_2
    iget-object v6, p0, Lcom/android/server/am/UserController;->mUserStateListenerRoll:Lcom/android/server/am/UserStateListenerRoll;

    const/4 v8, 0x5

    invoke-virtual {v6, v4, v8}, Lcom/android/server/am/UserStateListenerRoll;->update(II)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public registerUserStateListener(Landroid/os/IUserStateListener;)V
    .locals 2
    ...
    const-string/jumbo v1, "Register uss listener..."

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/am/UserController;->mUserStateListenerRoll:Lcom/android/server/am/UserStateListenerRoll;

    invoke-virtual {v0, p1}, Lcom/android/server/am/UserStateListenerRoll;->enroll(Landroid/os/IUserStateListener;)Z
...
.method public unregisterUserStateListener(Landroid/os/IUserStateListener;)V
    .locals 2
    ...
    const-string/jumbo v1, "Unregister uss listener..."

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/am/UserController;->mUserStateListenerRoll:Lcom/android/server/am/UserStateListenerRoll;

    invoke-virtual {v0, p1}, Lcom/android/server/am/UserStateListenerRoll;->disenroll(Landroid/os/IUserStateListener;)Z
