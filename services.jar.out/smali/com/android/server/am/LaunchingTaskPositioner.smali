...
.method private position(Lcom/android/server/am/TaskRecord;Ljava/util/ArrayList;Landroid/graphics/Rect;ZIZ)V
    ...
    iget-object v9, v6, Lcom/android/server/am/TaskRecord;->mBounds:Landroid/graphics/Rect;

    iget v9, v9, Landroid/graphics/Rect;->left:I

    iget-object v10, v6, Lcom/android/server/am/TaskRecord;->mBounds:Landroid/graphics/Rect;

    iget v10, v10, Landroid/graphics/Rect;->top:I

    move-object/from16 v0, p3

    invoke-virtual {v0, v9, v10}, Landroid/graphics/Rect;->offsetTo(II)V

    iget-object v9, p0, Lcom/android/server/am/LaunchingTaskPositioner;->mTmpOriginal:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/am/LaunchingTaskPositioner;->shiftStartingPoint(Landroid/graphics/Rect;I)V

    move-object/from16 v0, p3

    invoke-direct {p0, v0}, Lcom/android/server/am/LaunchingTaskPositioner;->shiftedToRightFar(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v10, v9}, Landroid/graphics/Rect;->offsetTo(II)V

    :cond_1
    move-object/from16 v0, p3

    invoke-direct {p0, v0}, Lcom/android/server/am/LaunchingTaskPositioner;->shiftedToBottomFar(Landroid/graphics/Rect;)Z
    ...
    invoke-static {v0, v2, v4}, Lcom/android/server/am/LaunchingTaskPositioner;->findBoundsConflictTasks(Landroid/graphics/Rect;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, v0, v8}, Lcom/android/server/am/LaunchingTaskPositioner;->isUsedPosition(Landroid/graphics/Rect;Ljava/util/ArrayList;)Z
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/am/LaunchingTaskPositioner;->shiftedToFar(Landroid/graphics/Rect;I)Z
    ...
    :cond_d
    iget-object v9, p0, Lcom/android/server/am/LaunchingTaskPositioner;->mAvailableRect:Landroid/graphics/Rect;

    iget v9, v9, Landroid/graphics/Rect;->left:I

    iget-object v10, p0, Lcom/android/server/am/LaunchingTaskPositioner;->mAvailableRect:Landroid/graphics/Rect;

    iget v10, v10, Landroid/graphics/Rect;->top:I

    iget-object v11, p0, Lcom/android/server/am/LaunchingTaskPositioner;->mAvailableRect:Landroid/graphics/Rect;
    ...
    iget-object v12, p0, Lcom/android/server/am/LaunchingTaskPositioner;->mAvailableRect:Landroid/graphics/Rect;
    ...
    iget v10, p0, Lcom/android/server/am/LaunchingTaskPositioner;->mDefaultFreeformStartX:I
    ...
    iget v10, p0, Lcom/android/server/am/LaunchingTaskPositioner;->mDefaultFreeformStartY:I
