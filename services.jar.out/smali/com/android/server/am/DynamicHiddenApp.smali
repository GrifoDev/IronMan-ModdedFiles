...
.field static DYNAMIC_SPC_ENABLE:Z = false
...
.field mMaxDHACached:I

.field mMaxDHAEmpty:I
...
.field mNumSPCCached:I

.field mNumSPCEmpty:I

.field private final mOomAdj:[I

.field mPrevSPCCached:I

.field mPrevSPCEmpty:I
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v0, "ro.config.dynamic_spc_enable"
    ...
    sput-boolean v0, Lcom/android/server/am/DynamicHiddenApp;->DYNAMIC_SPC_ENABLE:Z
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessList;Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHACached:I

    sget v0, Lcom/android/server/am/DynamicHiddenApp;->INIT_EMPTY_APPS:I

    iput v0, p0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHAEmpty:I
    ...
    iput v2, p0, Lcom/android/server/am/DynamicHiddenApp;->mNumSPCCached:I

    iput v2, p0, Lcom/android/server/am/DynamicHiddenApp;->mNumSPCEmpty:I

    iput v2, p0, Lcom/android/server/am/DynamicHiddenApp;->mPrevSPCCached:I

    iput v2, p0, Lcom/android/server/am/DynamicHiddenApp;->mPrevSPCEmpty:I

    iput-boolean v2, p0, Lcom/android/server/am/DynamicHiddenApp;->isSPCKill:Z
...
.method decrementEmptyAppCount(II)I
    ...
    iget v1, p0, Lcom/android/server/am/DynamicHiddenApp;->mNumSPCCached:I
    ...
    iput v1, p0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHACached:I

    iget v0, p0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHAEmpty:I

    :cond_0
    :goto_0
    iget v1, p0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHACached:I
    ...
    sget v1, Lcom/android/server/am/DynamicHiddenApp;->TOTAL_MEMORY:I
    ...
    iput v7, p0, Lcom/android/server/am/DynamicHiddenApp;->mMaxCached:I
    ...
    :cond_3
    iget v1, p0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHAEmpty:I

    if-le v1, v0, :cond_5

    iget v1, p0, Lcom/android/server/am/DynamicHiddenApp;->mNumSPCEmpty:I

    sub-int v1, v0, v1

    sget v2, Lcom/android/server/am/DynamicHiddenApp;->MIN_EMPTY_APPS:I

    if-ge v1, v2, :cond_4

    sget v1, Lcom/android/server/am/DynamicHiddenApp;->MIN_EMPTY_APPS:I

    iget v2, p0, Lcom/android/server/am/DynamicHiddenApp;->mNumSPCEmpty:I
    ...
    iput v6, p0, Lcom/android/server/am/DynamicHiddenApp;->mMaxCached:I
...
.method public dhaProcessesLocked(Ljava/util/ArrayList;Lcom/android/server/am/ProcessRecord;)V
    ...
    iput v0, v1, Lcom/android/server/am/DynamicHiddenApp;->mNumSPCCached:I
    ...
    iput v0, v1, Lcom/android/server/am/DynamicHiddenApp;->mNumSPCEmpty:I
    ...
    iget v0, v0, Lcom/android/server/am/DynamicHiddenApp;->mNumSPCCached:I
    ...
    iget v0, v0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHACached:I
    ...
    const-string/jumbo v27, "com.android.vending"
    ...
    const-string/jumbo v27, "GATE"

    const-string/jumbo v32, "<GATE-M> MARKET_LAUNCHED_FAIL </GATE-M>"
    ...
    sget v32, Lcom/android/server/am/ProcessList;->TRIM_EMPTY_APPS:I
    ...
    const-string/jumbo v27, "AL_Kill : over 1 sec"
    ...
    iget v0, v0, Lcom/android/server/am/DynamicHiddenApp;->mNumSPCEmpty:I
    ...
    iget v0, v0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHAEmpty:I
    ...
    sget-boolean v27, Lcom/android/server/am/DynamicHiddenApp;->DYNAMIC_SPC_ENABLE:Z
    ...
    iget v0, v0, Lcom/android/server/am/DynamicHiddenApp;->mPrevSPCCached:I
    ...
    iput v0, v1, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHACached:I
    ...
    iget-boolean v0, v0, Lcom/android/server/am/DynamicHiddenApp;->isSPCKill:Z
    ...
    iget v0, v0, Lcom/android/server/am/DynamicHiddenApp;->mPrevSPCEmpty:I
    ...
    iput v0, v1, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHAEmpty:I
    ...
    iput v0, v1, Lcom/android/server/am/DynamicHiddenApp;->mPrevSPCCached:I
    ...
    iput v0, v1, Lcom/android/server/am/DynamicHiddenApp;->mPrevSPCEmpty:I
...
.method public initProperty()V
    ...
    const-string/jumbo v0, "ro.cfg.dynamic_spc_enable"

    const-string/jumbo v1, "ro.config.dynamic_spc_enable"
...
.method public updateDHAParameter()V
    ...
    :cond_1c
    const-string/jumbo v11, "ro.config.dynamic_spc_enable"
    ...
    sput-boolean v11, Lcom/android/server/am/DynamicHiddenApp;->DYNAMIC_SPC_ENABLE:Z
...
.method public updateHiddenAppNum(II)I
    ...
    iget v11, v0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHAEmpty:I
    ...
    iget v11, v0, Lcom/android/server/am/DynamicHiddenApp;->mMax_ES_Total:I
    ...
    sget v22, Lcom/android/server/am/DynamicHiddenApp;->TOTAL_MEMORY:I
    ...
    sget-boolean v20, Lcom/android/server/am/DynamicHiddenApp;->INFINITE_CACHED_ENABLE:Z
    ...
    iget v10, v0, Lcom/android/server/am/DynamicHiddenApp;->mMax_ES_Total:I

    :goto_2
    sget-object v21, Lcom/android/server/am/DynamicHiddenApp;->TAG:Ljava/lang/String;

    new-instance v20, Ljava/lang/StringBuilder;

    invoke-direct/range {v20 .. v20}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v22, "AvailableMem = "
    ...
    const-string/jumbo v22, "Threshold = "
    ...
    const-string/jumbo v22, ", Current Hidden"
    ...
    const-string/jumbo v22, ", Current Empty"
    ...
    const-string/jumbo v22, "],[SPC Hidden:"
    ...
    const-string/jumbo v22, ", SPC Empty:"
    ...
    const-string/jumbo v22, ", Frag.Mem = 0KB"
    ...
    const-string/jumbo v22, ", KPU Total = "
    ...
    const-string/jumbo v22, ", ILS Flag: "
    ...
    sget v21, Lcom/android/server/am/DynamicHiddenApp;->MAX_EMPTY_APPS:I
    ...
    iget v9, v0, Lcom/android/server/am/DynamicHiddenApp;->mSzDHAThresholdRate:F
    ...
    iput-boolean v0, v1, Lcom/android/server/am/DynamicHiddenApp;->isSPCKill:Z
    ...
    iget v5, v0, Lcom/android/server/am/DynamicHiddenApp;->mMax_ES_Total:I
    ...
    sget-boolean v20, Lcom/android/server/am/MARsPolicyManager;->MARs_ENABLE:Z
    ...
    invoke-virtual/range {v20 .. v21}, Lcom/android/server/am/MARsPolicyManager;->isPolicyEnabled(I)Z
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/am/MARsPolicyManager;->getEmergencyKillEnabled()Z
    ...
    iget-boolean v0, v0, Lcom/android/server/am/DynamicHiddenApp;->mDidStepUp:Z
    ...
    sget v21, Lcom/android/server/am/DynamicHiddenApp;->MIN_EMPTY_APPS:I
    ...
    iput-boolean v0, v1, Lcom/android/server/am/DynamicHiddenApp;->mDidStepUp:Z

    move-object/from16 v0, p0

    iput-wide v12, v0, Lcom/android/server/am/DynamicHiddenApp;->mLastTimeTriggerAREs:J
    ...
    const-string/jumbo v20, "com.android.server.am.ACTION_MEMORY_NOT_ENOUGH_ARES"
    ...
    const-string/jumbo v22, "Decrease BG Slot Number ( H:"
    ...
    iget v5, v0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHAEmpty:I

    move-object/from16 v0, p0

    iget v4, v0, Lcom/android/server/am/DynamicHiddenApp;->mMaxDHACached:I
    ...
    const-string/jumbo v22, "Increase BG Slot Number ( H:"
