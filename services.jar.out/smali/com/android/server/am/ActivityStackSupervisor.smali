...
.field mHandleNonResizeableTask:Z
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-boolean v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mSnapWindowRunning:Z

    iput-boolean v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mHandleNonResizeableTask:Z
...
.method private isSecureFodlerImmeditateLockExceptionalCase(ILcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/ActivityStackSupervisor;->isKnoxOnAppPair(I)Z
...
.method final activityIdleInternalLocked(Landroid/os/IBinder;ZLandroid/content/res/Configuration;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-interface {v3, v4, v5}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isDexCompatConfigurationTargetLocked(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/ActivityRecord;)Z
...
.method findTaskLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-interface {v8, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isPairActivity(Lcom/android/server/am/ActivityRecord;)Z
    ...
    :cond_0
    iget-object v8, p0, Lcom/android/server/am/ActivityStackSupervisor;->mTmpFindTaskResult:Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;

    iput-object v10, v8, Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;->r:Lcom/android/server/am/ActivityRecord;

    iget-object v8, p0, Lcom/android/server/am/ActivityStackSupervisor;->mTmpFindTaskResult:Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;

    iput-boolean v11, v8, Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;->matchedByRootAffinity:Z
    ...
    invoke-virtual {v5, p1, v8}, Lcom/android/server/am/ActivityStack;->findTaskLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;)V

    sget-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->MULTIINSTANCE_SUPPORT:Z

    if-eqz v8, :cond_5

    iget-object v8, p0, Lcom/android/server/am/ActivityStackSupervisor;->mTmpFindTaskResult:Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;

    iget-object v8, v8, Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;->r:Lcom/android/server/am/ActivityRecord;

    if-eqz v8, :cond_5

    iget-object v8, p0, Lcom/android/server/am/ActivityStackSupervisor;->mTmpFindTaskResult:Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;

    iget-boolean v8, v8, Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;->matchedByRootAffinity:Z
    ...
    iget-object v1, v8, Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;->r:Lcom/android/server/am/ActivityRecord;
    ...
    iget-object v8, v8, Lcom/android/server/am/ActivityRecord;->state:Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    invoke-virtual {p0, v8}, Lcom/android/server/am/ActivityStackSupervisor;->acquireAppLaunchPerfLock(Ljava/lang/String;)V
    ...
    :cond_7
    iget-boolean v8, p0, Lcom/android/server/am/ActivityStackSupervisor;->mIsDockMinimized:Z
    ...
    iget-boolean v8, v8, Lcom/android/server/am/ActivityRecord;->visible:Z
    ...
    :cond_c
    iget-object v8, p0, Lcom/android/server/am/ActivityStackSupervisor;->mRecentTasks:Lcom/android/server/am/RecentTasks;

    iget-object v10, v1, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;

    invoke-virtual {v8, v10}, Lcom/android/server/am/RecentTasks;->indexOf(Ljava/lang/Object;)I
    ...
    invoke-virtual {v8}, Lcom/android/server/am/ActivityStack;->isDockedStack()Z
...
.method handleNonResizableTaskIfNeeded(Lcom/android/server/am/TaskRecord;IIZ)V
    ...
    invoke-interface {v2, v5}, Lcom/android/server/am/IMultiScreenManagerServiceBridge;->isVirtualScreen(I)Z
    ...
    invoke-virtual {v2, v5}, Lcom/android/server/am/ActivityManagerService$MainHandler;->sendEmptyMessage(I)Z

    iput-boolean v3, p0, Lcom/android/server/am/ActivityStackSupervisor;->mHandleNonResizeableTask:Z
    ...
    :goto_0
    invoke-virtual {p0, v6, v2, v3}, Lcom/android/server/am/ActivityStackSupervisor;->moveTasksToFullscreenStackLocked(IZZ)V

    iput-boolean v4, p0, Lcom/android/server/am/ActivityStackSupervisor;->mHandleNonResizeableTask:Z
    ...
    invoke-virtual {v2, v5, v3, v4, v0}, Lcom/android/server/am/ActivityManagerService$MainHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public hideKnoxMultiwindowsLocked(I)V
    ...
    check-cast v33, Lcom/android/server/am/ActivityStack;

    if-eqz v33, :cond_f

    invoke-virtual/range {v33 .. v33}, Lcom/android/server/am/ActivityStack;->getAllTasks()Ljava/util/ArrayList;
    ...
    invoke-virtual/range {v33 .. v33}, Lcom/android/server/am/ActivityStack;->getStackId()I
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/ActivityStackSupervisor;->getPersonaManagerLocked()Lcom/android/server/pm/PersonaManagerService;
    ...
    invoke-virtual {v2, v3, v5}, Lcom/android/server/pm/PersonaManagerService;->isAttribute(Landroid/content/pm/PersonaAttribute;I)Z
    ...
    const-string/jumbo v3, "com.android.settings/com.samsung.android.settings.KnoxChooseLockTwoFactor"
    ...
    const-string/jumbo v3, "com.android.settings/.password.SetNewPasswordActivity"
...
.method public hideKnoxMultiwindowsLockedAsTask(Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-virtual {v1, v2, v4}, Lcom/android/server/pm/PersonaManagerService;->isAttribute(Landroid/content/pm/PersonaAttribute;I)Z
    ...
    const-string/jumbo v2, "com.android.settings/.ChooseLockGeneric"
    ...
    const-string/jumbo v2, "com.android.settings/com.samsung.android.settings.KnoxChooseLockTwoFactor"
    ...
    const-string/jumbo v2, "com.android.settings/.password.SetNewPasswordActivity"
...
.method isFocusedStack(Lcom/android/server/am/ActivityStack;)Z
    ...
    invoke-interface {v3, p1}, Lcom/android/server/am/IActivityManagerServiceBridge;->isVSManagedStack(Lcom/android/server/am/ActivityStack;)Z
...
.method isFrontStack(Lcom/android/server/am/ActivityStack;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mBridge:Lcom/android/server/am/IActivityManagerServiceBridge;

    invoke-interface {v0, p1}, Lcom/android/server/am/IActivityManagerServiceBridge;->isVSManagedStack(Lcom/android/server/am/ActivityStack;)Z
...
.method isUserLockedProfile(I)Z
    ...
    invoke-virtual {p0, v6, p1}, Lcom/android/server/am/ActivityStackSupervisor;->taskContainsActivityFromUser(Lcom/android/server/am/TaskRecord;I)Z
    ...
    invoke-virtual {p0, v5, p1}, Lcom/android/server/am/ActivityStackSupervisor;->taskContainsActivityFromUser(Lcom/android/server/am/TaskRecord;I)Z
...
.method public minimizeKnoxTasks(I)V
    .locals 10
    ...
    const-string/jumbo v9, "minimize knox tasks for "
    ...
    invoke-virtual {v7, v8, v9}, Lcom/android/server/am/ActivityStack;->moveTaskToBackLocked(IZ)Z
    ...
    const-string/jumbo v9, "failed to minimize knox tasks for "
...
.method moveActivityStackToFront(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)Z
    ...
    iget-object v2, v2, Lcom/android/server/am/ActivityStack;->mActivityContainer:Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;

    invoke-virtual {v2}, Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;->getDisplayId()I

    move-result v2

    invoke-interface {v1, v2, v4}, Lcom/android/server/wm/IWindowManagerServiceBridge;->setFocusedDisplay(IZ)Z
...
.method moveProfileTasksFromFreeformToFullscreenStackLocked(I)V
    ...
    invoke-virtual {p0, v4, p1}, Lcom/android/server/am/ActivityStackSupervisor;->taskContainsActivityFromUser(Lcom/android/server/am/TaskRecord;I)Z
...
.method moveTaskToStackLocked(IIZZLjava/lang/String;ZZ)Z
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/am/ActivityStack;->getDisplayId()I
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStackSupervisor;->mBridge:Lcom/android/server/am/IActivityManagerServiceBridge;

    invoke-interface {v3}, Lcom/android/server/am/IActivityManagerServiceBridge;->isMovingAllTasksToFreeformLocked()Z
    ...
    iput-object v3, v4, Lcom/android/server/am/TaskRecord;->mOverrideConfig:Landroid/content/res/Configuration;
    ...
    invoke-interface {v3, v4}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->updateDexCompatModeLocked(Lcom/android/server/am/TaskRecord;)V

    iget-boolean v3, v4, Lcom/android/server/am/TaskRecord;->mFullscreen:Z
    ...
    iget-object v5, v4, Lcom/android/server/am/TaskRecord;->mLastNonFullscreenBounds:Landroid/graphics/Rect;
    ...
    iget-object v7, v0, Lcom/android/server/am/ActivityStackSupervisor;->mWindowManager:Lcom/android/server/wm/WindowManagerService;
    ...
    :goto_d
    invoke-virtual {v7, v8, v6}, Lcom/android/server/wm/WindowManagerService;->scheduleClearReplacingWindowIfNeeded(Landroid/os/IBinder;Z)V
    ...
    iget-boolean v8, v0, Lcom/android/server/am/ActivityRecord;->isRelaunching:Z
    ...
    :try_start_2
    iget-object v3, v4, Lcom/android/server/am/TaskRecord;->mLastDeXBounds:Landroid/graphics/Rect;
...
.method moveTaskToStackUncheckedLocked(Lcom/android/server/am/TaskRecord;IZZLjava/lang/String;)Lcom/android/server/am/ActivityStack;
    ...
    invoke-static/range {p2 .. p2}, Landroid/app/ActivityManager$StackId;->isMultiWindowStack(I)Z
    ...
    iget-boolean v13, v13, Lcom/android/server/am/ActivityManagerService;->mSupportsMultiWindow:Z
    ...
    :goto_0
    iget-object v13, v3, Lcom/android/server/am/ActivityStack;->mResumedActivity:Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v13, v14}, Lcom/android/server/am/UserController;->shouldConfirmCredentials(I)Z
    ...
    :goto_4
    sget-object v13, Lcom/android/server/am/ActivityStackSupervisor;->TAG:Ljava/lang/String;

    new-instance v14, Ljava/lang/StringBuilder;

    invoke-direct {v14}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v15, "Can not move locked profile task="
    ...
    const-string/jumbo v15, " to freeform stack. Moving to stackId="
    ...
    const-string/jumbo v15, " instead."
    ...
    invoke-virtual {v13}, Lcom/android/server/am/ActivityManagerService;->isDesktopModeLocked()Z
    ...
    :goto_5
    iget v13, v3, Lcom/android/server/am/ActivityStack;->mStackId:I

    move/from16 v0, p2

    invoke-static {v13, v0}, Lcom/samsung/android/bridge/multiwindow/MultiWindowManagerBridge$Utils;->isMovingToFreeform(II)Z
    ...
    iget-boolean v13, v0, Lcom/android/server/am/ActivityStackSupervisor;->mIsDockMinimized:Z

    if-eqz v13, :cond_16

    :cond_7
    const-string/jumbo v13, "moveToFreeform moveHomeStackToFront"

    const/4 v14, 0x1

    move-object/from16 v0, p0

    invoke-virtual {v0, v14, v13}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStackTaskToTop(ILjava/lang/String;)Z
    ...
    invoke-virtual {v7}, Lcom/android/server/am/ActivityStack;->getDisplayId()I
    ...
    const-string/jumbo v13, "moveTaskToStack"
    ...
    iput-boolean v13, v0, Lcom/android/server/am/TaskRecord;->mTemporarilyUnresizable:Z
    ...
    invoke-virtual {v0, v1, v13, v2}, Lcom/android/server/am/ActivityStackSupervisor;->getStack(IZZ)Lcom/android/server/am/ActivityStack;
    ...
    iget v15, v6, Lcom/android/server/am/ActivityStack;->mStackId:I

    move/from16 v0, p3

    invoke-virtual {v13, v14, v15, v0}, Lcom/android/server/wm/WindowManagerService;->moveTaskToStack(IIZ)V
    ...
    invoke-virtual {v6, v0, v1, v2}, Lcom/android/server/am/ActivityStack;->addTask(Lcom/android/server/am/TaskRecord;ZLjava/lang/String;)V
    ...
    invoke-virtual {v0, v13}, Lcom/android/server/am/TaskRecord;->setTaskToReturnTo(I)V
    ...
    invoke-interface {v13, v0, v14}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setHiddenTaskLocked(Lcom/android/server/am/TaskRecord;I)V
    ...
    invoke-interface {v13, v3, v6, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->postMoveTaskToStackLocked(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityStack;Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-virtual {v6, v4, v11, v12, v0}, Lcom/android/server/am/ActivityStack;->moveToFrontAndResumeStateIfNeeded(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)V
    ...
    invoke-interface {v13, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->checkRunningFreeformWithLoggingLocked(Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-interface {v13}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isMovingMultiWindowTasksToFullScreenLocked()Z

    move-result v13

    if-nez v13, :cond_0

    const-string/jumbo v13, "change-display moveTaskToStack"
    ...
    const-string/jumbo v15, "moveTaskToStackUncheckedLocked: Device doesn\'t support multi-window task="
    ...
    const-string/jumbo v15, " to stackId="
    ...
    iget-boolean v13, v0, Lcom/android/server/am/TaskRecord;->mSnapWindowTarget:Z
    ...
    const-string/jumbo v15, "Can not move unresizeable task="
    ...
    const-string/jumbo v15, " to docked stack. Moving to stackId="
    ...
    invoke-virtual {v0, v13, v1}, Lcom/android/server/am/ActivityStackSupervisor;->shouldSetTaskReturnToHome(II)Z
...
.method moveTasksToFullscreenStackLocked(IZZ)V
    ...
    invoke-interface {v1, v3, v4}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->startSplitResizeAnimIfNeededLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method positionTaskInStackLocked(III)V
    ...
    invoke-virtual {p0, p2, v0, v9}, Lcom/android/server/am/ActivityStackSupervisor;->getStack(IZZ)Lcom/android/server/am/ActivityStack;

    move-result-object v7

    invoke-virtual {v8, v7}, Lcom/android/server/am/TaskRecord;->updateOverrideConfigurationForStack(Lcom/android/server/am/ActivityStack;)V

    iget-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mWindowManager:Lcom/android/server/wm/WindowManagerService;

    iget-object v4, v8, Lcom/android/server/am/TaskRecord;->mBounds:Landroid/graphics/Rect;

    iget-object v5, v8, Lcom/android/server/am/TaskRecord;->mOverrideConfig:Landroid/content/res/Configuration;
    ...
    invoke-virtual {v7, v8, p3}, Lcom/android/server/am/ActivityStack;->positionTask(Lcom/android/server/am/TaskRecord;I)V
    ...
    invoke-interface {v0, v6, v7, v8}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->postMoveTaskToStackLocked(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityStack;Lcom/android/server/am/TaskRecord;)V

    :cond_1
    invoke-virtual {v7, v10, v9, v9}, Lcom/android/server/am/ActivityStack;->ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;IZ)V
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    iput-object v4, v0, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iget-object v5, v0, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;

    move-object/from16 v0, p1

    invoke-interface {v4, v5, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isDexCompatConfigurationTargetLocked(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string/jumbo v7, "realStartActivity["
    ...
    invoke-interface {v4, v0, v1, v5, v6}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->applyDexCompatConfigurationLocked(Lcom/android/server/am/ActivityRecord;Landroid/content/res/Configuration;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)V
    ...
    invoke-interface {v4, v5, v0}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->setDexCompatEnabled(Landroid/os/IBinder;Z)V
    ...
    iput-object v4, v0, Lcom/android/server/am/ProcessRecord;->waitingKillByClosingFreeform:Ljava/lang/String;
    ...
    invoke-interface {v4, v0, v9, v5, v6}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->applyDexCompatConfigurationLocked(Lcom/android/server/am/ActivityRecord;Landroid/content/res/Configuration;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)V

    :cond_10
    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/am/ActivityStackSupervisor;->mBridge:Lcom/android/server/am/IActivityManagerServiceBridge;

    move-object/from16 v0, p1

    invoke-interface {v4, v0}, Lcom/android/server/am/IActivityManagerServiceBridge;->applyConventionalMode(Lcom/android/server/am/ActivityRecord;)Z
...
.method reportActivityVisibleLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/pm/PersonaManagerService;->notifyFocusChanged(I)V
    ...
    iget-boolean v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mIsDockMinimized:Z
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/pm/PersonaManagerService;->inState(Lcom/samsung/android/knox/SemPersonaState;I)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/am/ActivityStackSupervisor;->hideKnoxMultiwindowsLockedAsTask(Lcom/android/server/am/TaskRecord;)V
...
.method reportResumedActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    iget-object v0, v0, Lcom/android/server/am/ActivityManagerService;->mMultiScreenManager:Lcom/android/server/am/IMultiScreenManagerServiceBridge;
    ...
    const-string/jumbo v2, "reportResumedActivityLocked: skip to ensure activities visible for virtual screen activity r="
...
.method resizeDockedStackLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Z)V
    ...
    invoke-virtual/range {v0 .. v8}, Lcom/android/server/am/ActivityStackSupervisor;->resizeDockedStackLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZZ)V

    return-void
.end method

.method resizeDockedStackLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZZ)V
    .locals 13
    ...
    iget-boolean v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mSnapWindowRunning:Z
    ...
    invoke-interface {v2, v6, v7, v4, v5}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setSnapWindowLocked(ZLandroid/graphics/Rect;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v12, p1, p2, v0}, Lcom/android/server/am/ActivityStackSupervisor;->resizeStackUncheckedLocked(Lcom/android/server/am/ActivityStack;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    iget-boolean v2, v12, Lcom/android/server/am/ActivityStack;->mFullscreen:Z

    if-nez v2, :cond_c

    if-nez p1, :cond_8

    invoke-virtual {v12}, Lcom/android/server/am/ActivityStack;->isAttached()Z
    ...
    invoke-virtual {v12, v11, v0}, Lcom/android/server/am/ActivityStack;->ensureVisibleActivitiesConfigurationLocked(Lcom/android/server/am/ActivityRecord;Z)V
    ...
    invoke-interface {v2, v10, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->startSplitResizeAnimIfNeededLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method resizeStackLocked(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZZ)V
    ...
    :try_start_0
    invoke-virtual {p0, v9, p2, p3, p4}, Lcom/android/server/am/ActivityStackSupervisor;->resizeStackUncheckedLocked(Lcom/android/server/am/ActivityStack;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v9, v0, p5}, Lcom/android/server/am/ActivityStack;->ensureVisibleActivitiesConfigurationLocked(Lcom/android/server/am/ActivityRecord;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method resizeStackUncheckedLocked(Lcom/android/server/am/ActivityStack;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    :cond_7
    invoke-virtual {v8, p2, p2}, Lcom/android/server/am/TaskRecord;->updateOverrideConfiguration(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/content/res/Configuration;
    ...
    :cond_9
    iget-boolean v0, v8, Lcom/android/server/am/TaskRecord;->mFullscreen:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mAllowDockedStackResize:Z
    ...
    iget-object v1, p0, Lcom/android/server/am/ActivityStackSupervisor;->tempRect2:Landroid/graphics/Rect;

    iget-object v2, v8, Lcom/android/server/am/TaskRecord;->mBounds:Landroid/graphics/Rect;

    invoke-interface {v0, v8, v1, v2}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->addTaskBoundsUnchangedDuringResizeIfNeededLocked(Lcom/android/server/am/TaskRecord;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method resizeTaskLocked(Lcom/android/server/am/TaskRecord;Landroid/graphics/Rect;IZZ)Z
    ...
    iget-boolean v0, p1, Lcom/android/server/am/TaskRecord;->mIsDexCompatEnabled:Z
    ...
    iget-boolean v5, p1, Lcom/android/server/am/TaskRecord;->mMovingTaskWithReplacing:Z
    ...
    invoke-interface {v0}, Lcom/android/server/am/IActivityManagerServiceBridge;->isMovingAllTasksToFreeformLocked()Z
...
.method resumedAppLocked()Lcom/android/server/am/ActivityRecord;
    ...
    invoke-interface {v2}, Lcom/android/server/am/IActivityManagerServiceBridge;->getResumedActivityVS()Lcom/android/server/am/ActivityRecord;
...
.method setDockedStackMinimized(Z)V
    ...
    iget v3, v2, Lcom/android/server/am/ActivityRecord;->userId:I
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/server/pm/PersonaManagerService;->inState(Lcom/samsung/android/knox/SemPersonaState;I)Z
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/am/ActivityManagerService;->activityResumed(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/am/ActivityStarter;->showConfirmDeviceCredential(I)V
...
.method final startActivityFromRecentsInner(ILandroid/os/Bundle;)I
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/am/ActivityStarter;->sendPowerHintForLaunchStartIfNeeded(Z)V
...
.method switchUserLocked(ILcom/android/server/am/UserState;)Z
    ...
    invoke-interface {v8}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->minimizeAllTasksInFreeformLocked()Z
...
.method taskContainsActivityFromUser(Lcom/android/server/am/TaskRecord;I)Z
    .locals 4
