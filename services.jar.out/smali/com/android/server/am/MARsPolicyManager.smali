...
.field private static final RESTRICTION_TYPES_BIGDATA_FLAG_APPLOCKER:I = 0x14140000

.field private static final RESTRICTION_TYPES_BIGDATA_FLAG_ARES:I = 0x101c0880

.field private static final RESTRICTION_TYPES_BIGDATA_FLAG_AUTORUN:I = 0x101c0880
...
.field private mFreezedPackages:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mIsFreecessEnabled:Z
...
.field private mUnusedForceKillTime:J
...
.method static synthetic -get10(Lcom/android/server/am/MARsPolicyManager;)Landroid/util/ArrayMap;
    .locals 1
...
.method static synthetic -get9(Lcom/android/server/am/MARsPolicyManager;)I
    .locals 1
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/am/MARsPolicyManager;->mScreenOn:Z

    iput-boolean v2, p0, Lcom/android/server/am/MARsPolicyManager;->mCarModeOn:Z
    ...
    iput v1, p0, Lcom/android/server/am/MARsPolicyManager;->mAllPoliciesOn:I

    iput-boolean v2, p0, Lcom/android/server/am/MARsPolicyManager;->mIsManualMode:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/am/MARsPolicyManager;->mAppUsedRecently:Z

    iput-boolean v2, p0, Lcom/android/server/am/MARsPolicyManager;->mFirstTimeExcutingPolicy:Z
    ...
    const-string/jumbo v0, "sys.config.mars_freecess"
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/server/am/MARsPolicyManager;->mIsFreecessEnabled:Z

    iput-boolean v2, p0, Lcom/android/server/am/MARsPolicyManager;->mIsFreecessSkipTimeEnabled:Z

    const-wide/32 v4, 0x1b7740

    iput-wide v4, p0, Lcom/android/server/am/MARsPolicyManager;->mUnusedForceKillTime:J
    ...
    iput-object v0, p0, Lcom/android/server/am/MARsPolicyManager;->mFreezedPackages:Ljava/util/ArrayList;
    ...
    iput-object v8, p0, Lcom/android/server/am/MARsPolicyManager;->mSemHqmManager:Landroid/os/SemHqmManager;

    iput v9, p0, Lcom/android/server/am/MARsPolicyManager;->RESTRICTION_THRESHOLD:I

    iput v9, p0, Lcom/android/server/am/MARsPolicyManager;->KILL_THRESHOLD:I

    const/16 v0, 0x5a

    iput v0, p0, Lcom/android/server/am/MARsPolicyManager;->SKIP_RATIO:I

    iput v2, p0, Lcom/android/server/am/MARsPolicyManager;->mRestrictionCnt:I

    iput v2, p0, Lcom/android/server/am/MARsPolicyManager;->RESTRICTION_TYPES_BIGDATA_FLAG_FILTER:I
    ...
    iput-boolean v2, p0, Lcom/android/server/am/MARsPolicyManager;->mActiveAdminsUpdated:Z
...
.method private freezePackage(Lcom/android/server/am/MARsPackageStatus;Ljava/lang/String;)V
    .locals 5
    ...
    iget v2, p1, Lcom/android/server/am/MARsPackageStatus;->uid:I

    invoke-direct {p0, v1, v2, v4}, Lcom/android/server/am/MARsPolicyManager;->sendFreecessSingal(Ljava/lang/String;II)Z
    ...
    invoke-direct {p0, v1, v2, v4}, Lcom/android/server/am/MARsPolicyManager;->setProcessFreezedFlag(Ljava/lang/String;IZ)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v2

    iput-wide v2, p1, Lcom/android/server/am/MARsPackageStatus;->freezedTime:J

    iput-object p2, p1, Lcom/android/server/am/MARsPackageStatus;->freezedReason:Ljava/lang/String;

    iput-boolean v4, p1, Lcom/android/server/am/MARsPackageStatus;->isFreezed:Z

    iget-object v1, p0, Lcom/android/server/am/MARsPolicyManager;->mFreezedPackages:Ljava/util/ArrayList;
    ...
    const-string/jumbo v3, "freezePackage: "
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/am/MARsDBManager;->callCancelJobSchedulerPackage(Ljava/lang/String;I)V
    ...
    const-string/jumbo v3, "freezePackage error : pkgName = "
...
.method private isAutoRunBlockedPackage(Lcom/android/server/am/ProcessRecord;Landroid/content/ComponentName;Ljava/lang/String;Landroid/content/Intent;I)I
    .locals 6
...
.method private isFreezedPackage(Lcom/android/server/am/MARsPackageStatus;)Z
    ...
    iget-object v2, p0, Lcom/android/server/am/MARsPolicyManager;->mFreezedPackages:Ljava/util/ArrayList;
    ...
    iget v2, v0, Lcom/android/server/am/MARsPackageStatus;->userId:I
...
.method private setProcessFreezedFlag(Ljava/lang/String;IZ)V
    .locals 9
...
.method private unFreezePackage(Lcom/android/server/am/MARsPackageStatus;Ljava/lang/String;)V
    .locals 5
    ...
    iput-wide v2, p1, Lcom/android/server/am/MARsPackageStatus;->unfreezedTime:J

    iput-object p2, p1, Lcom/android/server/am/MARsPackageStatus;->unfreezedReason:Ljava/lang/String;
    ...
    const-string/jumbo v3, "unFreezePackage: "
    ...
    const-string/jumbo v3, "unFreezePackage error : pkgName = "
...
.method private writeDevFile(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    const-string/jumbo v10, "unfreezed pid: "
    ...
    const-string/jumbo v10, "freezed pid: "
...
.method public dumpMARs(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;)V
    ...
    :cond_6
    iget-boolean v11, v7, Lcom/android/server/am/MARsPackageStatus;->isFreezed:Z

    if-eqz v11, :cond_8

    const-string/jumbo v11, "--Freezing"
    ...
    iget-boolean v11, v0, Lcom/android/server/am/MARsPolicyManager;->mIsFreecessEnabled:Z

    if-eqz v11, :cond_a

    const-string/jumbo v11, "--freezedTime "

    move-object/from16 v0, p2

    invoke-virtual {v0, v11}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-wide v14, v7, Lcom/android/server/am/MARsPackageStatus;->freezedTime:J
    ...
    const-string/jumbo v11, "--freezedReason "

    move-object/from16 v0, p2

    invoke-virtual {v0, v11}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-object v11, v7, Lcom/android/server/am/MARsPackageStatus;->freezedReason:Ljava/lang/String;
    ...
    const-string/jumbo v11, "mFreezedPackages --- size "
    ...
    iget-object v11, v0, Lcom/android/server/am/MARsPolicyManager;->mFreezedPackages:Ljava/util/ArrayList;
    ...
    iget-object v11, v0, Lcom/android/server/am/MARsPolicyManager;->mFreezeTargetPackages:Landroid/util/ArrayMap;

    if-eqz v11, :cond_15

    const-string/jumbo v11, "mFreezeTargetPackages "
    ...
    iget v11, v0, Lcom/android/server/am/MARsPolicyManager;->mSecureFolderUserId:I
...
.method executePolicy(Lcom/android/server/am/MARsPolicyManager$Policy;Ljava/lang/String;)V
    ...
    iget-boolean v3, p0, Lcom/android/server/am/MARsPolicyManager;->mIsFreecessEnabled:Z
    ...
    :cond_a
    iget-boolean v3, v2, Lcom/android/server/am/MARsPackageStatus;->isFreezed:Z
    ...
    iget-wide v8, p0, Lcom/android/server/am/MARsPolicyManager;->mUnusedForceKillTime:J

    sub-long/2addr v6, v8

    iget-wide v8, v2, Lcom/android/server/am/MARsPackageStatus;->freezedTime:J

    cmp-long v3, v6, v8

    if-lez v3, :cond_1

    const-string/jumbo v3, "MARsKill"

    invoke-direct {p0, v2, v3}, Lcom/android/server/am/MARsPolicyManager;->unFreezePackage(Lcom/android/server/am/MARsPackageStatus;Ljava/lang/String;)V

    goto :goto_2

    :cond_b
    invoke-direct {p0, v2}, Lcom/android/server/am/MARsPolicyManager;->isFreezeTargetPackage(Lcom/android/server/am/MARsPackageStatus;)Z

    move-result v3

    if-eqz v3, :cond_5

    iget-object v3, p1, Lcom/android/server/am/MARsPolicyManager$Policy;->name:Ljava/lang/String;

    invoke-direct {p0, v2, v3}, Lcom/android/server/am/MARsPolicyManager;->freezePackage(Lcom/android/server/am/MARsPackageStatus;Ljava/lang/String;)V
...
.method public forceRunPolicy(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;ILjava/lang/String;I)V
    ...
    iget-boolean v7, v4, Lcom/android/server/am/MARsPolicyManager$Policy;->enabled:Z
    ...
    iput-wide v8, p0, Lcom/android/server/am/MARsPolicyManager;->lastTriggerTime:J

    iget-object v8, p0, Lcom/android/server/am/MARsPolicyManager;->mAm:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-direct {p0, v4}, Lcom/android/server/am/MARsPolicyManager;->generateTargetList(Lcom/android/server/am/MARsPolicyManager$Policy;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v7, v0, v1}, Lcom/android/server/am/MARsPolicyManager;->getMARsPackageStatus(Ljava/util/ArrayList;Ljava/lang/String;I)Lcom/android/server/am/MARsPackageStatus;
    ...
    iput v0, v6, Lcom/android/server/am/MARsPackageStatus;->forceStopReason:I

    iget v7, v4, Lcom/android/server/am/MARsPolicyManager$Policy;->num:I

    const/4 v9, 0x0

    const/4 v10, 0x0

    invoke-virtual {p0, v6, v7, v9, v10}, Lcom/android/server/am/MARsPolicyManager;->isCurrentImportantPackage(Lcom/android/server/am/MARsPackageStatus;IZZ)Z
    ...
    iget-object v9, v6, Lcom/android/server/am/MARsPackageStatus;->name:Ljava/lang/String;

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    const-string/jumbo v9, " is CurrentImportantPackage !!!"
    ...
    :cond_4
    iget-object v7, v6, Lcom/android/server/am/MARsPackageStatus;->name:Ljava/lang/String;

    iget v9, v6, Lcom/android/server/am/MARsPackageStatus;->uid:I

    invoke-direct {p0, v7, v9}, Lcom/android/server/am/MARsPolicyManager;->isRunningPackage(Ljava/lang/String;I)Z

    move-result v7

    if-eqz v7, :cond_6

    iget-boolean v7, p0, Lcom/android/server/am/MARsPolicyManager;->mIsFreecessEnabled:Z

    if-eqz v7, :cond_5

    iget-boolean v7, p0, Lcom/android/server/am/MARsPolicyManager;->mFirstTimeExcutingPolicy:Z
    ...
    iput v7, v6, Lcom/android/server/am/MARsPackageStatus;->forceStopReason:I

    iget-object v7, v6, Lcom/android/server/am/MARsPackageStatus;->name:Ljava/lang/String;

    iget v9, v6, Lcom/android/server/am/MARsPackageStatus;->userId:I

    invoke-direct {p0, v7, v4, v9}, Lcom/android/server/am/MARsPolicyManager;->forceKillPackage(Ljava/lang/String;Lcom/android/server/am/MARsPolicyManager$Policy;I)Z
    ...
    iput-wide v10, v6, Lcom/android/server/am/MARsPackageStatus;->forceStopTime:J
    ...
    iget v7, v6, Lcom/android/server/am/MARsPackageStatus;->isSendPackageRestart:I
    ...
    iput v7, v6, Lcom/android/server/am/MARsPackageStatus;->isSendPackageRestart:I

    iget-object v7, v6, Lcom/android/server/am/MARsPackageStatus;->name:Ljava/lang/String;

    iget v9, v6, Lcom/android/server/am/MARsPackageStatus;->uid:I

    invoke-direct {p0, v7, v9}, Lcom/android/server/am/MARsPolicyManager;->sendPackageRestartedIntent(Ljava/lang/String;I)V
    ...
    iput v7, v6, Lcom/android/server/am/MARsPackageStatus;->restrictedFlag:I

    iget-object v7, v6, Lcom/android/server/am/MARsPackageStatus;->appliedPolicies:Ljava/util/ArrayList;
    ...
    iput-object v7, v6, Lcom/android/server/am/MARsPackageStatus;->appliedPolicies:Ljava/util/ArrayList;
    ...
    :cond_8
    :goto_4
    iget-object v7, p0, Lcom/android/server/am/MARsPolicyManager;->mRestrictedPackages:Ljava/util/ArrayList;
    ...
    :cond_a
    iget-boolean v7, v6, Lcom/android/server/am/MARsPackageStatus;->isFreezed:Z
    ...
    iget-wide v12, p0, Lcom/android/server/am/MARsPolicyManager;->mUnusedForceKillTime:J

    sub-long/2addr v10, v12

    iget-wide v12, v6, Lcom/android/server/am/MARsPackageStatus;->freezedTime:J

    cmp-long v7, v10, v12

    if-lez v7, :cond_3

    const-string/jumbo v7, "MARsKill"

    invoke-direct {p0, v6, v7}, Lcom/android/server/am/MARsPolicyManager;->unFreezePackage(Lcom/android/server/am/MARsPackageStatus;Ljava/lang/String;)V

    goto/16 :goto_3

    :cond_b
    invoke-direct {p0, v6}, Lcom/android/server/am/MARsPolicyManager;->isFreezeTargetPackage(Lcom/android/server/am/MARsPackageStatus;)Z

    move-result v7

    if-eqz v7, :cond_5

    iget-object v7, v4, Lcom/android/server/am/MARsPolicyManager$Policy;->name:Ljava/lang/String;

    invoke-direct {p0, v6, v7}, Lcom/android/server/am/MARsPolicyManager;->freezePackage(Lcom/android/server/am/MARsPackageStatus;Ljava/lang/String;)V
...
.method public forceRunPolicyForSpecificPackage(ILjava/util/ArrayList;)V
    ...
    iget-boolean v12, v0, Lcom/android/server/am/MARsPolicyManager;->mIsFreecessEnabled:Z

    if-eqz v12, :cond_a

    iget-boolean v12, v10, Lcom/android/server/am/MARsPackageStatus;->isFreezed:Z

    if-eqz v12, :cond_a

    const-string/jumbo v12, "MARsKill"

    move-object/from16 v0, p0

    invoke-direct {v0, v10, v12}, Lcom/android/server/am/MARsPolicyManager;->unFreezePackage(Lcom/android/server/am/MARsPackageStatus;Ljava/lang/String;)V
...
.method public getDatabaseVersion(I)I
    .locals 6
    ...
    invoke-virtual {v1, v2, v3, p1}, Landroid/content/pm/PackageManager;->getPackageInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
...
.method public getFreecessEnabled()Z
    ...
    iget-boolean v0, p0, Lcom/android/server/am/MARsPolicyManager;->mIsFreecessEnabled:Z
...
.method public getIsDataCleared(Ljava/lang/String;I)Z
    .locals 4
...
.method getPkgInfoFromSMToMARs(Ljava/util/ArrayList;)V
    ...
    const-string/jumbo v24, "getPkgInfoFromSMToMARs size = "
    ...
    check-cast v22, Lcom/android/server/am/MARsDBManager$SMDBValue;
    ...
    invoke-direct/range {v4 .. v12}, Lcom/android/server/am/MARsPackageStatus;-><init>(Landroid/content/Context;Ljava/lang/String;IJIILjava/lang/String;)V
    ...
    const-string/jumbo v24, "NameNotFoundException occurred for package :"
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/content/Context;->getUserId()I
...
.method public handlePackageResumedFG(Ljava/lang/String;Ljava/lang/String;ZLandroid/content/Intent;I)V
    ...
    const-string/jumbo v6, "handlePackageResumedFG pkgName = "
    ...
    invoke-direct {p0, v4, p1, p5}, Lcom/android/server/am/MARsPolicyManager;->getMARsPackageStatus(Ljava/util/ArrayList;Ljava/lang/String;I)Lcom/android/server/am/MARsPackageStatus;
    ...
    const-string/jumbo v6, "Current Home Package "
    ...
    :cond_1
    iget-boolean v4, p0, Lcom/android/server/am/MARsPolicyManager;->mScreenOn:Z
    ...
    iget-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->aresPolicy:Lcom/android/server/am/MARsPolicyManager$Policy;
    ...
    :try_start_0
    iget-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->mLatestProtectedPackages:Landroid/util/ArrayMap;
    ...
    iget-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->mLaunchedAppBeforeInit:Ljava/util/ArrayList;
    ...
    iget-boolean v4, p0, Lcom/android/server/am/MARsPolicyManager;->mIsFreecessEnabled:Z
    ...
    :try_start_1
    iget-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->mFreezeTargetPackages:Landroid/util/ArrayMap;
    ...
    sget v6, Lcom/android/server/am/MARsPolicyManager;->FREEZED_PACKAGES_LIMIT:I
...
.method public handlePackageStatusChange(Ljava/lang/String;Ljava/lang/String;ZI)V
    ...
    const-string/jumbo v4, "handlePackageStatusChange packageName = "
    ...
    invoke-direct {p0, v2, p1, p4}, Lcom/android/server/am/MARsPolicyManager;->getMARsPackageStatus(Ljava/util/ArrayList;Ljava/lang/String;I)Lcom/android/server/am/MARsPackageStatus;

    move-result-object v1

    if-eqz v1, :cond_2

    invoke-virtual {p0, v1}, Lcom/android/server/am/MARsPolicyManager;->initBigdataPackage(Lcom/android/server/am/MARsPackageStatus;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v2, p1, p4}, Lcom/android/server/am/MARsDBManager;->insertPackageToDB(Ljava/lang/String;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string/jumbo v4, "handlePackageStatusChange isReInstall don\'t care!"
    ...
    invoke-virtual {v2, p1, p4}, Lcom/android/server/am/MARsDBManager;->deletePackageInDB(Ljava/lang/String;I)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    invoke-virtual {v2, p1, p4, v4}, Lcom/android/server/am/MARsDBManager;->updateDataClearedPackage(Ljava/lang/String;IZ)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
...
.method public init(Z)V
    ...
    iget-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->mTrigger:Lcom/android/server/am/MARsTrigger;

    invoke-virtual {v4}, Lcom/android/server/am/MARsTrigger;->registerEmStateReceiver()V
    ...
    :cond_0
    sput-boolean v7, Lcom/android/server/am/MARsPolicyManager;->MARs_ENABLE:Z
    ...
    const-string/jumbo v5, "AppSleepUI is available"

    invoke-static {v4, v5}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    sput-boolean v7, Lcom/android/server/am/MARsPolicyManager;->AppSleep_Enable:Z

    :cond_1
    :try_start_0
    const-string/jumbo v4, "sys.config.mars_version"

    const-string/jumbo v5, "2.10"
    ...
    iput-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->MARS_VERSION:Ljava/lang/String;
    :try_end_1
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/am/MARsPolicyManager;->getDatabaseVersion(I)I
    ...
    iput-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->MARSDB_VERSION:Ljava/lang/String;
    :try_end_2
    ...
    invoke-virtual {v4, p1}, Lcom/android/server/am/MARsDBManager;->getMARsPolicyCondition(Z)V

    iget-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->mTrigger:Lcom/android/server/am/MARsTrigger;

    invoke-virtual {v4, v7}, Lcom/android/server/am/MARsTrigger;->registerReceiver(Z)V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/am/MARsPolicyManager;->getActiveAdminsPackages(I)V

    iget-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->mDBManager:Lcom/android/server/am/MARsDBManager;

    invoke-virtual {v4}, Lcom/android/server/am/MARsDBManager;->initSettingFromUI()V

    iget-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->mDBManager:Lcom/android/server/am/MARsDBManager;

    invoke-virtual {v4}, Lcom/android/server/am/MARsDBManager;->initManagedPackages()V

    iget-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->mDBManager:Lcom/android/server/am/MARsDBManager;

    invoke-virtual {v4}, Lcom/android/server/am/MARsDBManager;->initSKTPackagesWhiteList()V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/am/MARsPolicyManager;->getDefaultIMEPackage(I)V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/am/MARsPolicyManager;->getDefaultDialerPackage(I)V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/am/MARsPolicyManager;->getDefaultSmsPackage(I)V
    ...
    invoke-virtual {v3, v4, v7}, Lcom/samsung/android/knox/SemPersonaManager;->getKnoxId(IZ)I

    move-result v4

    iput v4, p0, Lcom/android/server/am/MARsPolicyManager;->mSecureFolderUserId:I
    ...
    iget v5, p0, Lcom/android/server/am/MARsPolicyManager;->mSecureFolderUserId:I

    invoke-virtual {v4, v5}, Lcom/android/server/am/MARsTrigger;->registerSecureFolderReceiver(I)V
    ...
    iput v4, p0, Lcom/android/server/am/MARsPolicyManager;->mDualAppUserId:I
    ...
    iget v5, p0, Lcom/android/server/am/MARsPolicyManager;->mDualAppUserId:I

    invoke-virtual {v4, v5}, Lcom/android/server/am/MARsTrigger;->registerDualAppReceiver(I)V
    :try_end_3
    ...
    iput-object v4, p0, Lcom/android/server/am/MARsPolicyManager;->mWindowManager:Lcom/android/server/wm/WindowManagerService;
    ...
    const-string/jumbo v5, "init(), we cannot set system property"
    ...
    const-string/jumbo v5, "init(), we cannot get MARsVersion"
    ...
    const-string/jumbo v5, "init(), IndexOutOfBoundsException"
    ...
    const-string/jumbo v5, "init() get DualAppUserId failed!"
...
.method public initBigdataPackage(Lcom/android/server/am/MARsPackageStatus;)V
    .locals 7
...
.method public isCurrentImportantPackage(Lcom/android/server/am/MARsPackageStatus;IZZ)Z
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/am/MARsPolicyManager;->isSCPMManagedPackage(IILjava/lang/String;Ljava/lang/String;Landroid/content/Intent;)Z
    ...
    const-string/jumbo v6, " -is blacklist package!"
    ...
    iget-object v4, v0, Lcom/android/server/am/MARsPolicyManager;->mCoreManager:Lcom/android/server/am/MARsCoreManager;
    ...
    invoke-virtual/range {v4 .. v12}, Lcom/android/server/am/MARsDBManager;->sendBigDataInfoFromMARs(ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2, v4}, Lcom/android/server/am/MARsPolicyManager;->isOngoingNotificationPackage(Lcom/android/server/am/MARsPackageStatus;IZ)Z
...
.method public isRestrictedFreezedPackage(Landroid/content/ComponentName;Landroid/app/IApplicationThread;IILjava/lang/String;Landroid/content/Intent;I)Z
    .locals 13
    ...
    const-string/jumbo v10, "we will return, because userid is not same"
    ...
    :goto_0
    iget-object v9, p0, Lcom/android/server/am/MARsPolicyManager;->mFreezedPackages:Ljava/util/ArrayList;
    ...
    const-string/jumbo v11, "Abnomal case in mFreezedPackages, package name is null"
    ...
    invoke-virtual {v9, p2}, Lcom/android/server/am/ActivityManagerService;->getRecordForAppLocked(Landroid/app/IApplicationThread;)Lcom/android/server/am/ProcessRecord;
    ...
    :goto_1
    iget-boolean v9, p0, Lcom/android/server/am/MARsPolicyManager;->mScreenOn:Z
    ...
    const-string/jumbo v12, " hostingType: "
    ...
    const-string/jumbo v12, " is Restricted by freecess action: caller is: "
    ...
    const-string/jumbo v7, "Screen On"

    :goto_2
    invoke-direct {p0, v8, v7}, Lcom/android/server/am/MARsPolicyManager;->unFreezePackage(Lcom/android/server/am/MARsPackageStatus;Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public isRestrictedPackage(Landroid/content/ComponentName;Landroid/app/IApplicationThread;IILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;I)Z
    ...
    check-cast v28, Lcom/android/server/am/MARsPolicyManager$Policy;
    ...
    invoke-virtual {v0, v14, v4, v1}, Lcom/android/server/am/MARsPolicyManager;->cancelPolicy(Ljava/lang/String;II)V
    ...
    iget-object v4, v0, Lcom/android/server/am/MARsPackageStatus;->skipRestrictionReason:Ljava/lang/String;
    ...
    iget-object v6, v0, Lcom/android/server/am/MARsPolicyManager;->mDBManager:Lcom/android/server/am/MARsDBManager;
    ...
    iget-object v11, v0, Lcom/android/server/am/MARsPackageStatus;->skipRestrictionReason:Ljava/lang/String;

    move-object/from16 v13, p5

    invoke-virtual/range {v6 .. v14}, Lcom/android/server/am/MARsDBManager;->sendBigDataInfoFromMARs(ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v15 .. v21}, Lcom/android/server/am/MARsPolicyManager;->markAppStartUpResult(ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/am/MARsPolicyManager;->isAutoRunBlockedPackage(Lcom/android/server/am/ProcessRecord;Landroid/content/ComponentName;Ljava/lang/String;Landroid/content/Intent;I)I
...
.method public sendBigDataInfoFromMARstoHQM(ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 13
    ...
    iget-object v2, p0, Lcom/android/server/am/MARsPolicyManager;->MARS_VERSION:Ljava/lang/String;

    iget-object v3, p0, Lcom/android/server/am/MARsPolicyManager;->MARSDB_VERSION:Ljava/lang/String;

    iget-object v1, p0, Lcom/android/server/am/MARsPolicyManager;->mCoreManager:Lcom/android/server/am/MARsCoreManager;

    invoke-virtual {v1, p1}, Lcom/android/server/am/MARsCoreManager;->convertPolicyNumToName(I)Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/server/am/MARsPolicyManager;->mSemHqmManager:Landroid/os/SemHqmManager;
    ...
    :goto_0
    iget-object v1, p0, Lcom/android/server/am/MARsPolicyManager;->mSemHqmManager:Landroid/os/SemHqmManager;
    ...
    const-string/jumbo v2, "Failed to send sluggish info to HQM"
...
.method public setFreecessEnabled(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/am/MARsPolicyManager;->mIsFreecessEnabled:Z
...
.method public setIsDataCleared(Ljava/lang/String;IZ)Z
    .locals 4
...
.method public unFreezePackage(Ljava/lang/String;)V
    ...
    :goto_0
    iget-object v3, p0, Lcom/android/server/am/MARsPolicyManager;->mFreezedPackages:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3, v4, v5}, Lcom/android/server/am/MARsPolicyManager;->sendFreecessSingal(Ljava/lang/String;II)Z
    ...
    invoke-direct {p0, v3, v4, v6}, Lcom/android/server/am/MARsPolicyManager;->setProcessFreezedFlag(Ljava/lang/String;IZ)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v4

    iput-wide v4, v0, Lcom/android/server/am/MARsPackageStatus;->unfreezedTime:J
    ...
    const-string/jumbo v5, "unFreezePackage: "
    ...
    const-string/jumbo v5, "unFreezePackage error : pkgName = "
...
.method public unFreezePackage(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {p0, v3, v4, v6}, Lcom/android/server/am/MARsPolicyManager;->sendFreecessSingal(Ljava/lang/String;II)Z
    ...
    invoke-direct {p0, v3, v4, v5}, Lcom/android/server/am/MARsPolicyManager;->setProcessFreezedFlag(Ljava/lang/String;IZ)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v6

    iput-wide v6, v0, Lcom/android/server/am/MARsPackageStatus;->unfreezedTime:J
