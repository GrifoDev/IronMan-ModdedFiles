...
.method private unFreezePackage(Lcom/android/server/am/MARsPolicyManager$PkgStatusInfo;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v2, v5}, Lcom/android/server/am/MARsPolicyManager;->sendFreecessSingal(Ljava/lang/String;II)Z
    ...
    invoke-virtual {v1, v2, v3, v5, v4}, Lcom/android/server/am/MARsHandler;->sendSetWakeLockMsgToMainHandler(Ljava/lang/String;IIZ)V
...
.method setWakeLockEnableDisable(Ljava/lang/String;IIZ)V
    ...
    const-string/jumbo v3, " frozen app wakelock."
    ...
    const-string/jumbo v2, "frozen app wakelock held by system."
