...
.field private static final ANIMATION_TRIGGER_LAUNCHER_SCREEN_APPS:I = 0x14

.field private static final ANIMATION_TRIGGER_LAUNCHER_SCREEN_HOME:I = 0xa
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZZLcom/android/server/am/ActivityStackSupervisor;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Landroid/app/ActivityOptions;Lcom/android/server/am/ActivityRecord;)V
    ...
    iput v13, v0, Lcom/android/server/am/ActivityRecord;->mRotationAnimationHint:I
    ...
    iput v13, v0, Lcom/android/server/am/ActivityRecord;->processAppLaunchPolicy:I

    const/4 v13, 0x0

    move-object/from16 v0, p0

    iput-boolean v13, v0, Lcom/android/server/am/ActivityRecord;->isConventionalMode:Z
    ...
    invoke-virtual {v13}, Landroid/app/ActivityOptions;->getRotationAnimationHint()I
    ...
    invoke-interface {v13, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isPairActivity(Lcom/android/server/am/ActivityRecord;)Z
    ...
    :cond_1b
    invoke-virtual/range {p17 .. p17}, Lcom/android/server/am/ActivityRecord;->isFreeform()Z
    ...
    invoke-virtual {v13, v14}, Landroid/content/Intent;->setPairActivity(I)V
...
.method private reportLaunchTimeLocked(J)V
    ...
    iput-object v1, v11, Lcom/android/server/am/ActivityStack;->mLastSetDisplayTimeActivity:Lcom/android/server/am/ActivityRecord;
...
.method applyOptionsLocked()V
    ...
    invoke-interface {v1, v2}, Lcom/android/server/wm/IWindowManagerServiceBridge;->setAnimationTriggerLauncherScreen(I)V
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    iget-boolean v11, v11, Lcom/android/server/am/TaskRecord;->mIsDexModeTask:Z
    ...
    const-string/jumbo v11, "conventional_mode="
    ...
    iget-boolean v11, v0, Lcom/android/server/am/ActivityRecord;->isConventionalMode:Z
    ...
    const-string/jumbo v11, "max_aspect="
    ...
    const-string/jumbo v12, "android.max_aspect"

    const/4 v13, 0x0

    invoke-virtual {v11, v12, v13}, Landroid/os/Bundle;->getFloat(Ljava/lang/String;F)F

    move-result v11

    move-object/from16 v0, p1

    invoke-virtual {v0, v11}, Ljava/io/PrintWriter;->print(F)V

    invoke-virtual/range {p1 .. p2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    const-string/jumbo v11, "resizable_app="
...
.method windowsVisibleLocked()V
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/server/am/MARsPolicyManager;->getIsDataCleared(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v3, v4, v5, v6}, Lcom/android/server/am/MARsPolicyManager;->setIsDataCleared(Ljava/lang/String;IZ)Z
