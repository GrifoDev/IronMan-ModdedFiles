...
.method private computeBounds(Landroid/graphics/Rect;)V
    ...
    iget v9, p0, Lcom/android/server/am/ActivityRecord;->vrActivityType:I
    ...
    iget-object v10, p0, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;

    invoke-interface {v9, v10}, Lcom/android/server/wm/IWindowManagerServiceBridge;->isMaxAspectComponent(Landroid/content/pm/ActivityInfo;)Z
    ...
    invoke-interface {v9, v10, v6}, Lcom/android/server/wm/IWindowManagerServiceBridge;->getCustomMaxAspectRatio(Ljava/lang/String;F)F
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/WindowManagerService;->getDefaultDisplayRotation()I
    ...
    invoke-direct {p0, v3}, Lcom/android/server/am/ActivityRecord;->getDisplayRealSize(Landroid/graphics/Point;)V
    ...
    invoke-virtual {p1, v9, v11}, Landroid/graphics/Rect;->offset(II)V
...
.method private reportLaunchTimeLocked(J)V
    ...
    iget-wide v2, v10, Lcom/android/server/am/ActivityStack;->mLaunchStartTime:J
    ...
    invoke-static {v2, v3, v1, v11}, Landroid/os/Trace;->asyncTraceEnd(JLjava/lang/String;I)V
    ...
    invoke-static {p0, v4, v5}, Lcom/android/server/am/SluggishDetector;->reportLaunch(Lcom/android/server/am/ActivityRecord;J)V
    ...
    iget-object v9, v1, Lcom/android/server/am/ActivityManagerService;->mStringBuilder:Ljava/lang/StringBuilder;
    ...
    invoke-static {v6, v7, v9}, Landroid/util/TimeUtils;->formatDuration(JLjava/lang/StringBuilder;)V
    ...
    invoke-virtual {v1, v11, v12, v2, v3}, Landroid/util/BoostFramework;->perfUXEngine_events(IILjava/lang/String;I)I
    ...
    invoke-virtual {v1, v2, v3, v8}, Landroid/util/BoostFramework;->perfIOPrefetchStart(ILjava/lang/String;Ljava/lang/String;)I
    ...
    iput-object v1, v10, Lcom/android/server/am/ActivityStack;->mLastSetDisplayTimeActivity:Lcom/android/server/am/ActivityRecord;

    const-wide/16 v2, 0x0

    iput-wide v2, v10, Lcom/android/server/am/ActivityStack;->mLaunchStartTime:J
...
.method completeResumeLocked()V
    ...
    iput-boolean v8, v4, Lcom/android/server/am/ActivityStackSupervisor;->mAppVisibilitiesChangedSinceLastPause:Z
    ...
    const-string/jumbo v6, "completeResume"

    invoke-interface {v4, v5, v8, v6}, Lcom/android/server/am/IActivityManagerServiceBridge;->notifyTaskToFrontLocked(Lcom/android/server/am/TaskRecord;ZLjava/lang/String;)V
...
.method createWindowContainer()V
    ...
    :cond_5
    sget-boolean v2, Lcom/android/server/am/ActivityRecord;->SAFE_DEBUG:Z
    ...
    const-string/jumbo v5, "setTransientBarShowingDelay: delayMillis="
    ...
    iget v5, v5, Landroid/content/pm/ActivityInfo;->requestTransientBarDelay:I
    ...
    iget v4, v4, Landroid/content/pm/ActivityInfo;->requestTransientBarDelay:I

    invoke-virtual {v2, v4}, Lcom/android/server/wm/AppWindowContainerController;->setTransientBarShowingDelay(I)V
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string/jumbo v12, "requestTransientBarDelay="
    ...
    iget v12, v12, Landroid/content/pm/ActivityInfo;->requestTransientBarDelay:I
    ...
    iget-boolean v11, v11, Lcom/android/server/am/TaskRecord;->mRunningInDex:Z
    ...
    const-string/jumbo v12, "AppLaunchPolicy=0x"
    ...
    iget v12, v0, Lcom/android/server/am/ActivityRecord;->processAppLaunchPolicy:I
    ...
    const-string/jumbo v12, " ProcessAppInfo="
    ...
    iget-object v12, v0, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;
...
.method ensureActivityConfigurationLocked(IZZ)Z
    ...
    iget-boolean v8, v7, Lcom/android/server/am/ActivityStack;->mConfigWillChange:Z
    ...
    invoke-virtual {v7, v8}, Lcom/android/server/am/ActivityStack;->shouldBeVisible(Lcom/android/server/am/ActivityRecord;)I
    ...
    iget v8, v8, Lcom/android/server/am/TaskRecord;->mHiddenState:I
    ...
    iget v8, p0, Lcom/android/server/am/ActivityRecord;->mLastReportedDisplayId:I
    ...
    iput v4, p0, Lcom/android/server/am/ActivityRecord;->mLastReportedDisplayId:I
    ...
    iget-object v1, v8, Lcom/android/server/am/ActivityManagerService;->mFreeformController:Lcom/android/server/am/FreeformStackController;

    iget-object v8, p0, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;

    invoke-virtual {v1, v8, p0}, Lcom/android/server/am/FreeformStackController;->isDexCompatConfigurationTargetLocked(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string/jumbo v10, "ensureActivityConfig["
    ...
    invoke-virtual {v1, p0, v3, v8, v9}, Lcom/android/server/am/FreeformStackController;->applyDexCompatConfigurationLocked(Lcom/android/server/am/ActivityRecord;Landroid/content/res/Configuration;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)V

    iget-object v8, p0, Lcom/android/server/am/ActivityRecord;->mLastReportedConfiguration:Landroid/util/MergedConfiguration;

    invoke-virtual {v8, v3}, Landroid/util/MergedConfiguration;->setGlobalConfiguration(Landroid/content/res/Configuration;)V

    iget-object v8, p0, Lcom/android/server/am/ActivityRecord;->appToken:Landroid/view/IApplicationToken$Stub;

    const/4 v9, 0x1

    invoke-virtual {v1, v8, v9}, Lcom/android/server/am/FreeformStackController;->applyDexCompatToAppWindow(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual {v9}, Landroid/util/MergedConfiguration;->getMergedConfiguration()Landroid/content/res/Configuration;
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityRecord;->mTmpConfig:Landroid/content/res/Configuration;
    ...
    invoke-direct {p0, v8}, Lcom/android/server/am/ActivityRecord;->getConfigurationChanges(Landroid/content/res/Configuration;)I
    ...
    invoke-virtual {v8, v3, v5}, Landroid/util/MergedConfiguration;->setConfiguration(Landroid/content/res/Configuration;Landroid/content/res/Configuration;)V
    ...
    invoke-interface {v8, v5, v9}, Lcom/android/server/DssController;->scaleExistingConfiguration(Landroid/content/res/Configuration;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/server/am/ActivityRecord;->scheduleActivityMovedToDisplay(ILandroid/content/res/Configuration;)V
    ...
    invoke-direct {p0, v0, v8}, Lcom/android/server/am/ActivityRecord;->shouldRelaunchLocked(ILandroid/content/res/Configuration;)Z
    ...
    invoke-virtual {v7, p0, v9, v8}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZLjava/lang/String;)Z
...
.method public onWindowsVisible()V
    ...
    iget-object v6, p0, Lcom/android/server/am/ActivityRecord;->mStackSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    invoke-virtual {v6, p0}, Lcom/android/server/am/ActivityStackSupervisor;->reportActivityVisibleLocked(Lcom/android/server/am/ActivityRecord;)V

    iget-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->nowVisible:Z
    ...
    iput-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->launching:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/am/ActivityRecord;->idle:Z

    if-nez v6, :cond_0

    iget-object v6, p0, Lcom/android/server/am/ActivityRecord;->mStackSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    invoke-virtual {v6}, Lcom/android/server/am/ActivityStackSupervisor;->isStoppingNoHistoryActivity()Z
    ...
    invoke-virtual {v6}, Lcom/android/server/am/ActivityManagerService;->scheduleAppGcsLocked()V

    :cond_a
    iget-object v6, p0, Lcom/android/server/am/ActivityRecord;->service:Lcom/android/server/am/ActivityManagerService;

    iget-object v6, v6, Lcom/android/server/am/ActivityManagerService;->mAMBooster:Lcom/android/server/am/ActivityManagerPerformance;
    ...
    invoke-virtual {v6, p0}, Lcom/android/server/am/ActivityManagerPerformance;->onActivityVisibleLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    sget-object v6, Lcom/android/server/am/ActivityRecord;->TAG:Ljava/lang/String;

    const-string/jumbo v8, "onActivityVisibleLocked Done"
    ...
    invoke-virtual {v6, v8, v9}, Lcom/android/server/am/MARsPolicyManager;->getIsDataCleared(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v6, v8, v9, v10}, Lcom/android/server/am/MARsPolicyManager;->setIsDataCleared(Ljava/lang/String;IZ)Z
    ...
    const-string/jumbo v8, "SetDataCleared Done"
    ...
    invoke-virtual {v6, v8, v9, v10}, Lcom/android/server/am/ActivityStackSupervisor;->processStoppingActivitiesLocked(Lcom/android/server/am/ActivityRecord;ZZ)Ljava/util/ArrayList;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method relaunchActivityLocked(ZZ)V
    ...
    iget-object v0, p0, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;

    invoke-virtual {v9, v0, p0}, Lcom/android/server/am/FreeformStackController;->isDexCompatConfigurationTargetLocked(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string/jumbo v4, "relaunchActivity["
    ...
    invoke-virtual {v9, p0, v6, v0, v1}, Lcom/android/server/am/FreeformStackController;->applyDexCompatConfigurationLocked(Lcom/android/server/am/ActivityRecord;Landroid/content/res/Configuration;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v0}, Lcom/android/server/am/FreeformStackController;->removeToggleFreeformList(Lcom/android/server/am/TaskRecord;)V
...
.method setRequestedOrientation(I)V
    ...
    invoke-virtual {v3, p0}, Lcom/android/server/am/TaskRecord;->isTaskOrientationChangedLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v3, p0}, Lcom/android/server/am/FreeformStackController;->rotateFreeformTaskLocked(Lcom/android/server/am/ActivityRecord;)V
