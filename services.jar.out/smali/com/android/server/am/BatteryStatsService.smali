...
.method private extractDelta(Landroid/net/wifi/WifiActivityEnergyInfo;)Landroid/net/wifi/WifiActivityEnergyInfo;
    ...
    const-string/jumbo v28, "!@ mLastInfo "
    ...
    const-string/jumbo v28, "!@ delta timePeriodMs : "
    ...
    const-string/jumbo v28, " txTimeMs : "
    ...
    const-string/jumbo v28, " rxTimeMs :"
    ...
    const-string/jumbo v28, " idleTimeMs : "
...
.method public noteAodService(Z)V
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/os/BatteryStatsImpl;->noteAodServiceLocked(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setBatteryState(IIIIIIIIII)V
    .locals 13

    invoke-virtual {p0}, Lcom/android/server/am/BatteryStatsService;->enforceCallingPermission()V

    iget-object v12, p0, Lcom/android/server/am/BatteryStatsService;->mHandler:Lcom/android/server/am/BatteryStatsService$BatteryStatsHandler;
    ...
    invoke-direct/range {v0 .. v11}, Lcom/android/server/am/BatteryStatsService$1;-><init>(Lcom/android/server/am/BatteryStatsService;IIIIIIIIII)V

    invoke-virtual {v12, v0}, Lcom/android/server/am/BatteryStatsService$BatteryStatsHandler;->post(Ljava/lang/Runnable;)Z
