...
.field static ENABLE_ACTIVE_LAUNCH:Z = false
...
.field private final mPkgActiveLaunch:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "sys.config.active_launch_on"
    ...
    sput-boolean v0, Lcom/android/server/am/SchedPolicyManager;->ENABLE_ACTIVE_LAUNCH:Z
...
.method private constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/SchedPolicyManager;->mPkgActiveLaunch:Ljava/util/Map;
...
.method private parseListToActiveLaunch(Ljava/lang/String;Z)V
    .locals 6
    ...
    :cond_0
    sput-boolean p2, Lcom/android/server/am/SchedPolicyManager;->ENABLE_ACTIVE_LAUNCH:Z
    ...
    iget-object v4, p0, Lcom/android/server/am/SchedPolicyManager;->mPkgActiveLaunch:Ljava/util/Map;
...
.method private updateScpm()V
    ...
    const-string/jumbo v0, "ActiveLaunch-"
    ...
    invoke-direct {p0, v13}, Lcom/android/server/am/SchedPolicyManager;->isInvokedModel(Ljava/lang/String;)Z
    ...
    const-string/jumbo v0, "enable_on"
    ...
    :cond_3
    const-string/jumbo v0, "enable_off"
    ...
    invoke-direct {p0, v9, v0}, Lcom/android/server/am/SchedPolicyManager;->parseListToActiveLaunch(Ljava/lang/String;Z)V
    ...
    :cond_8
    invoke-direct {p0, v9, v14}, Lcom/android/server/am/SchedPolicyManager;->parseListToAddPolicy(Ljava/lang/String;Lcom/android/server/am/SchedPolicyManager$GroupPolicy;)V
...
.method isPossibleToActiveLaunch(Ljava/lang/String;)Z
    .locals 3

    sget-boolean v1, Lcom/android/server/am/SchedPolicyManager;->ENABLE_ACTIVE_LAUNCH:Z

    iget-object v2, p0, Lcom/android/server/am/SchedPolicyManager;->mPkgActiveLaunch:Ljava/util/Map;
