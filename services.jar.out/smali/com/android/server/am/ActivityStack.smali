...
.field protected static final ANIMATION_TRIGGER_ACTIVITY_HOME_SCREEN:I = 0x1
...
.method private adjustFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)V
    ...
    iget-object v1, v0, Lcom/android/server/am/ActivityStack;->mStackSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    move-object/from16 v0, p0

    invoke-virtual {v1, v0}, Lcom/android/server/am/ActivityStackSupervisor;->isFocusedStack(Lcom/android/server/am/ActivityStack;)Z
    ...
    invoke-virtual {v1, v14, v2}, Lcom/android/server/am/ActivityManagerService;->setFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)Z
    ...
    const-string/jumbo v2, "adjustFocusedActivity"

    const/4 v3, 0x1

    const/4 v4, 0x0

    invoke-virtual {v1, v3, v4, v2}, Lcom/android/server/am/ActivityStackSupervisor;->resumeHomeStackTask(ILcom/android/server/am/ActivityRecord;Ljava/lang/String;)Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->isFocusable()Z
    ...
    invoke-virtual {v1, v11, v10}, Lcom/android/server/am/ActivityManagerService;->setFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v12}, Lcom/android/server/am/ActivityStack;->isAllActivitiesFinishingLocked(Lcom/android/server/am/TaskRecord;)Z
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/am/ActivityStack;->checkBelowTasksToGoHomeStackLocked(Lcom/android/server/am/TaskRecord;)Z
    ...
    iget-object v1, v12, Lcom/android/server/am/TaskRecord;->stack:Lcom/android/server/am/ActivityStack;
    ...
    invoke-direct {v0, v13, v10}, Lcom/android/server/am/ActivityStack;->adjustFocusToNextFocusableStackLocked(ILjava/lang/String;)Z
    ...
    iget-boolean v1, v0, Lcom/android/server/am/ActivityStack;->mFullscreen:Z
    ...
    invoke-virtual {v1, v13, v10}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStackTaskToTop(ILjava/lang/String;)Z
    ...
    invoke-direct {v0, v1, v10}, Lcom/android/server/am/ActivityStack;->adjustFocusToNextFocusableStackLocked(ILjava/lang/String;)Z
    ...
    invoke-virtual {v1, v2, v10}, Lcom/android/server/am/ActivityManagerService;->setFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)Z
...
.method private completePauseLocked(ZLcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/ActivityRecord;->isHomeActivity()Z
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/am/TaskRecord;->isCustomScaleDownAnimationAllowed()Z
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/am/TaskRecord;->getStartX()I

    move-result v3

    invoke-virtual/range {v18 .. v18}, Lcom/android/server/am/TaskRecord;->getStartY()I

    move-result v4

    invoke-virtual/range {v18 .. v18}, Lcom/android/server/am/TaskRecord;->getAppIconWidth()I

    move-result v5

    invoke-virtual/range {v18 .. v18}, Lcom/android/server/am/TaskRecord;->getAppIconHeight()I

    move-result v6

    invoke-virtual/range {v18 .. v18}, Lcom/android/server/am/TaskRecord;->isHomeItem()Z
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/am/ActivityRecord;->isRecentsActivity()Z
    ...
    invoke-interface {v2, v3}, Lcom/android/server/wm/IWindowManagerServiceBridge;->setAnimationTriggerActivity(I)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/server/am/ActivityStack;->finishCurrentActivityLocked(Lcom/android/server/am/ActivityRecord;IZ)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v2, v0, v1, v3}, Lcom/android/server/am/ActivityStackSupervisor;->resumeFocusedStackTopActivityLocked(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;)Z

    :cond_c
    :goto_5
    if-eqz v17, :cond_f

    invoke-virtual/range {v17 .. v17}, Lcom/android/server/am/ActivityRecord;->resumeKeyDispatchingLocked()V
    ...
    iget-wide v2, v0, Lcom/android/server/am/ActivityRecord;->cpuTimeAtResume:J
    ...
    iget-wide v4, v0, Lcom/android/server/am/ActivityRecord;->cpuTimeAtResume:J
    ...
    invoke-virtual {v10, v2, v3}, Lcom/android/internal/os/BatteryStatsImpl;->getProcessStatsLocked(ILjava/lang/String;)Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;
    ...
    invoke-virtual {v0, v12, v13}, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;->addForegroundTimeLocked(J)V
    :try_end_0
    ...
    iput-wide v2, v0, Lcom/android/server/am/ActivityRecord;->cpuTimeAtResume:J
    ...
    iget-object v3, v2, Lcom/android/server/am/ActivityManagerService;->mMultiScreenManager:Lcom/android/server/am/IMultiScreenManagerServiceBridge;
    ...
    invoke-interface {v3, v2}, Lcom/android/server/am/IMultiScreenManagerServiceBridge;->isVirtualScreen(I)Z
    ...
    invoke-virtual {v2, v0, v3, v4}, Lcom/android/server/am/ActivityStackSupervisor;->ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;IZ)V
    ...
    iget-boolean v2, v0, Lcom/android/server/am/ActivityRecord;->deferRelaunchUntilPaused:Z
    ...
    invoke-direct {v0, v1, v2, v4, v3}, Lcom/android/server/am/ActivityStack;->relaunchActivityLocked(Lcom/android/server/am/ActivityRecord;IZZ)V
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/ActivityStack;->addToStopping(Lcom/android/server/am/ActivityRecord;Z)V
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/am/ActivityStack;->topRunningActivityLocked()Lcom/android/server/am/ActivityRecord;
...
.method private completeResumeLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-interface {v1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->notifyCompleteResumeLocked()V
...
.method private insertTaskAtTop(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/am/ActivityStack;->insertTaskAtTop(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStack;)V

    return-void
.end method

.method private insertTaskAtTop(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStack;)V
    .locals 14
    ...
    iget-boolean v9, v9, Lcom/android/server/am/ActivityStackSupervisor;->mSnapWindowRunning:Z
    ...
    iget-boolean v9, p1, Lcom/android/server/am/TaskRecord;->mSnapWindowTarget:Z
    ...
    iget-object v9, v9, Lcom/android/server/am/ActivityManagerService;->mSamsungWindowManager:Lcom/android/server/wm/IWindowManagerServiceBridge;

    invoke-interface {v9}, Lcom/android/server/wm/IWindowManagerServiceBridge;->inVSMode()Z
    ...
    invoke-virtual {v9, v10}, Lcom/android/server/am/ActivityStackSupervisor;->isCurrentProfileLocked(I)Z
    ...
    iget v10, v8, Lcom/android/server/am/TaskRecord;->userId:I
    ...
    const-string/jumbo v10, "snap task to back"
    ...
    invoke-interface {v9, v12, v13, v10, v11}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setSnapWindowLocked(ZLandroid/graphics/Rect;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v9}, Landroid/app/ActivityManager$StackId;->allowTopTaskToReturnHome(I)Z
    ...
    iget v6, v9, Lcom/android/server/am/TaskRecord;->taskType:I
...
.method private isAllActivitiesFinishingLocked(Lcom/android/server/am/TaskRecord;)Z
    .locals 4
    ...
    const-string/jumbo v3, "All activities are finishing of the task"
...
.method private postAddTask(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityStack;)V
    ...
    invoke-interface {v1, p1, v2}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->initializePairActivityModeLocked(Lcom/android/server/am/TaskRecord;Z)V
...
.method private relaunchActivityLocked(Lcom/android/server/am/ActivityRecord;IZZ)V
    ...
    iget-object v1, p1, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;

    invoke-interface {v0, v1, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isDexCompatConfigurationTargetLocked(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string/jumbo v5, "relaunchActivity["
    ...
    invoke-interface {v0, p1, v6, v1, v4}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->applyDexCompatConfigurationLocked(Lcom/android/server/am/ActivityRecord;Landroid/content/res/Configuration;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/am/ActivityStack;->addToStopping(Lcom/android/server/am/ActivityRecord;Z)V
...
.method private resumeTopActivityInnerLocked(Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;)Z
    ...
    sget-boolean v4, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->MULTIWINDOW_ENSURE_DIMENSIONS_BASED_ON_TOP:Z
    ...
    invoke-static {v4}, Landroid/app/ActivityManager$StackId;->isMultiWindowStack(I)Z
    ...
    invoke-interface {v4, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setTaskDimensions(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-interface {v4, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isTaskOrientationChangedLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStack;->equals(Ljava/lang/Object;)Z
    ...
    invoke-interface {v4, v5}, Lcom/android/server/am/IActivityManagerServiceBridge;->applyConventionalMode(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-interface {v4}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isSnapWindowResizing()Z
...
.method private setAppTask(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/TaskRecord;)V
    ...
    sget-boolean v0, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->MULTIWINDOW_ENSURE_DIMENSIONS_BASED_ON_TOP:Z
    ...
    invoke-interface {v0, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setTaskDimensions(Lcom/android/server/am/ActivityRecord;)V
...
.method addConfigOverride(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/TaskRecord;)V
    ...
    iget v2, v0, Lcom/android/server/am/TaskRecord;->mMaxWidth:I
    ...
    iget v2, v0, Lcom/android/server/am/TaskRecord;->mMaxHeight:I
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/am/ActivityStack;->layoutTaskInStack(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;)Z
    ...
    iget-object v4, v0, Lcom/android/server/am/TaskRecord;->mBounds:Landroid/graphics/Rect;

    move-object/from16 v0, p2

    iget-object v5, v0, Lcom/android/server/am/TaskRecord;->mOverrideConfig:Landroid/content/res/Configuration;

    const/4 v6, 0x0

    const/4 v7, 0x0

    invoke-virtual/range {v2 .. v7}, Lcom/android/server/wm/WindowManagerService;->resizeTask(ILandroid/graphics/Rect;Landroid/content/res/Configuration;ZZ)V
    ...
    invoke-virtual/range {v2 .. v20}, Lcom/android/server/wm/WindowManagerService;->addAppToken(ILandroid/view/IApplicationToken;IIIZZIIZZLandroid/graphics/Rect;Landroid/content/res/Configuration;IZZII)V
    ...
    sget-boolean v2, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->MULTIWINDOW_ENSURE_DIMENSIONS_BASED_ON_TOP:Z
    ...
    invoke-interface {v2, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setTaskDimensions(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-interface {v2, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->updateDexCompatModeLocked(Lcom/android/server/am/TaskRecord;)V
    ...
    const-string/jumbo v3, "com.samsung.android.sdk.multiwindow.freeform.border"
    ...
    invoke-interface {v2, v3, v0}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->setUseFreeformBorder(Landroid/os/IBinder;Z)V
    ...
    const-string/jumbo v3, "com.samsung.android.sdk.multiwindow.force_hide_floating_multiwindow"
    ...
    invoke-interface {v2, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isAppToBlockFloatingMultiWindows(Ljava/lang/String;)Z
    ...
    invoke-interface {v2, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->addGrantPermissionComponent(Ljava/lang/String;)V
    ...
    iput-object v2, v0, Lcom/android/server/am/ActivityRecord;->taskConfigOverride:Landroid/content/res/Configuration;
    ...
    invoke-interface {v2, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setTaskDimensions(Lcom/android/server/am/TaskRecord;)V
...
.method addTask(Lcom/android/server/am/TaskRecord;ZLjava/lang/String;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Lcom/android/server/am/ActivityStack;->insertTaskAtTop(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStack;)V
...
.method checkBelowTasksToGoHomeStackLocked(Lcom/android/server/am/TaskRecord;)Z
    .locals 7
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/server/am/UserController;->isSameProfileGroup(II)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/ActivityStack;->isAllActivitiesFinishingLocked(Lcom/android/server/am/TaskRecord;)Z
...
.method createTaskRecord(ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;ZLandroid/app/ActivityOptions;)Lcom/android/server/am/TaskRecord;
    .locals 11
    ...
    invoke-interface {v2, v1, p2, v0}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->updateDexCompatModeLocked(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo;Landroid/app/ActivityOptions;)V
    ...
    invoke-static {v2}, Lcom/samsung/android/bridge/multiwindow/MultiWindowManagerBridge$Utils;->isDexFullscreenLaunchBounds(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/am/TaskRecord;->updateOverrideConfiguration(Landroid/graphics/Rect;)Landroid/content/res/Configuration;
...
.method dumpActivitiesLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;ZZLjava/lang/String;ZLjava/lang/String;)Z
    ...
    const-string/jumbo v5, "    mLastDeXBounds="

    invoke-virtual {v1, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v5, v13, Lcom/android/server/am/TaskRecord;->mLastDeXBounds:Landroid/graphics/Rect;
...
.method final ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;IZ)V
    ...
    invoke-virtual {v3, v0, v9, v10}, Lcom/android/server/am/ActivityStackSupervisor;->pauseBackStacks(ZLcom/android/server/am/ActivityRecord;Z)Z
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->hasVisibleFullscreenActivityLocked()Z
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->isHomeTask()Z
    ...
    :cond_18
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->isRecentsTask()Z

    move-result v3

    if-eqz v3, :cond_15

    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->getTaskToReturnTo()I
...
.method ensureActivityConfigurationLocked(Lcom/android/server/am/ActivityRecord;IZ)Z
    ...
    invoke-interface {v0, v12, v1}, Lcom/android/server/DssController;->createScaledConfiguration(Landroid/content/res/Configuration;Ljava/lang/String;)Landroid/content/res/Configuration;
    ...
    iget-object v0, v0, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;
    ...
    invoke-interface {v0, v1, v2}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isDexCompatConfigurationTargetLocked(Landroid/content/pm/ApplicationInfo;Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string/jumbo v21, "ensureActivityConfig["
    ...
    invoke-interface {v0, v1, v12, v2, v3}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->applyDexCompatConfigurationLocked(Lcom/android/server/am/ActivityRecord;Landroid/content/res/Configuration;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v12}, Lcom/android/server/am/TaskRecord;->sanitizeOverrideConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, v12}, Landroid/content/res/Configuration;->equals(Landroid/content/res/Configuration;)Z
    ...
    iget-object v13, v0, Lcom/android/server/am/ActivityRecord;->configuration:Landroid/content/res/Configuration;

    move-object/from16 v0, p1

    iget-object v14, v0, Lcom/android/server/am/ActivityRecord;->taskConfigOverride:Landroid/content/res/Configuration;

    move-object/from16 v0, p1

    iput-object v12, v0, Lcom/android/server/am/ActivityRecord;->configuration:Landroid/content/res/Configuration;
    ...
    invoke-interface {v0, v1, v9}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->setDexCompatEnabled(Landroid/os/IBinder;Z)V
    ...
    invoke-direct {v0, v1, v2, v14}, Lcom/android/server/am/ActivityStack;->getTaskConfigurationChanges(Lcom/android/server/am/ActivityRecord;Landroid/content/res/Configuration;Landroid/content/res/Configuration;)I

    move-result v16

    invoke-virtual {v13, v12}, Landroid/content/res/Configuration;->diff(Landroid/content/res/Configuration;)I
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/content/pm/ActivityInfo;->getRealConfigChanged()I
    ...
    invoke-interface/range {v18 .. v18}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->okToDisplay()Z
    ...
    invoke-static/range {v18 .. v18}, Lcom/samsung/android/bridge/multiwindow/MultiWindowManagerBridge$Utils;->isForcePreserveWindowConfigChange(I)Z
    ...
    :goto_4
    sget-boolean v18, Lcom/android/server/am/ActivityManagerDebugConfig;->SAFE_DEBUG:Z

    if-eqz v18, :cond_c

    sget-object v18, Lcom/android/server/am/ActivityStack;->TAG_CONFIGURATION:Ljava/lang/String;

    new-instance v19, Ljava/lang/StringBuilder;

    invoke-direct/range {v19 .. v19}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v20, "preserveWindow="
    ...
    const-string/jumbo v20, " forcePreserveWindow="
    ...
    const-string/jumbo v20, " changes=0x"
    ...
    const-string/jumbo v20, " globalChanges=0x"
    ...
    const-string/jumbo v20, " configChangeFlags="
    ...
    const-string/jumbo v20, " orientationChanging="
    ...
    const-string/jumbo v20, " displayFrozen="
    ...
    const-string/jumbo v20, " forcePreserveWindowConfigs="
    ...
    const-string/jumbo v20, " isDockedStackEnabled="
    ...
    const-string/jumbo v20, " mightReplaceWindow="
    ...
    sget-object v19, Lcom/android/server/am/ActivityStack$ActivityState;->PAUSING:Lcom/android/server/am/ActivityStack$ActivityState;
...
.method findTaskLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStackSupervisor$FindTaskResult;)V
    ...
    invoke-interface {v0, v1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isPairActivity(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-interface {v0, v11}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isFullScreenPairActivity(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-interface {v0, v1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isDockedPairActivity(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-interface/range {v19 .. v20}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isLaunchableForMultiInstance(Landroid/content/pm/ActivityInfo;)Z
...
.method final finishActivityLocked(Lcom/android/server/am/ActivityRecord;ILandroid/content/Intent;Ljava/lang/String;Z)Z
    ...
    iget-object v7, v12, Lcom/android/server/am/TaskRecord;->mActivities:Ljava/util/ArrayList;
    ...
    invoke-virtual {v12}, Lcom/android/server/am/TaskRecord;->setFrontOfTask()V
    ...
    iget-object v1, v11, Lcom/android/server/am/ActivityRecord;->intent:Landroid/content/Intent;
    ...
    invoke-virtual {v1, v13, v2}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
    ...
    invoke-virtual {p0, v1, v2, v3, v5}, Lcom/android/server/am/ActivityStack;->startPausingLocked(ZZLcom/android/server/am/ActivityRecord;Z)Z
    ...
    invoke-virtual {v1, v12}, Lcom/android/server/am/ActivityStackSupervisor;->removeLockedTaskLocked(Lcom/android/server/am/TaskRecord;)V
    ...
    const-string/jumbo v1, "user-terminated"
    ...
    :cond_8
    iget-boolean v1, v12, Lcom/android/server/am/TaskRecord;->isLaunchedPairApp:Z
    ...
    invoke-interface {v1, v2, v3, v5}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->moveTasksToFullscreenStackExceptTopTaskLocked(IZZ)V
    ...
    invoke-interface {v1, v2, v3}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->startSplitResizeAnimIfNeededLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-boolean v1, v12, Lcom/android/server/am/TaskRecord;->mFullscreen:Z
...
.method finishAllActivitiesLocked(Z)V
    ...
    iget-object v5, v5, Lcom/android/server/am/ActivityStackSupervisor;->mBridge:Lcom/android/server/am/IActivityManagerServiceBridge;

    invoke-interface {v5, p0}, Lcom/android/server/am/IActivityManagerServiceBridge;->isVSStack(Lcom/android/server/am/ActivityStack;)Z
...
.method getStackVisibilityLocked(Lcom/android/server/am/ActivityRecord;)I
    ...
    iget-object v14, v0, Lcom/android/server/am/ActivityStack;->mBridge:Lcom/android/server/am/IActivityManagerServiceBridge;

    move-object/from16 v0, p0

    invoke-interface {v14, v0}, Lcom/android/server/am/IActivityManagerServiceBridge;->hideNonVSStack(Lcom/android/server/am/ActivityStack;)Z
    ...
    iget-object v14, v14, Lcom/android/server/am/ActivityManagerService;->mMultiWindowManager:Lcom/android/server/am/IMultiWindowManagerServiceBridge;

    const/4 v15, 0x0

    move-object/from16 v0, p0

    invoke-interface {v14, v0, v15}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isAllTaskHiddenLocked(Lcom/android/server/am/ActivityStack;Z)Z
    ...
    invoke-interface {v14, v0, v1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isVisibleStackBehindFreeformLocked(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityRecord;)Z
    ...
    iget-boolean v14, v14, Lcom/android/server/am/ActivityStackSupervisor;->mIsDockMinimized:Z
    ...
    invoke-interface {v14, v15}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isAnimatingForMinimizedDockedStack(I)Z
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/am/ActivityStackSupervisor;->isFocusedStack(Lcom/android/server/am/ActivityStack;)Z
    ...
    iget-object v4, v5, Lcom/android/server/am/ActivityStack;->mResumedActivity:Lcom/android/server/am/ActivityRecord;
    ...
    iget-object v14, v0, Lcom/android/server/am/ActivityStack;->mStacks:Ljava/util/ArrayList;
    ...
    const-string/jumbo v16, " isn\'t front stack but is at the top of the stack list"
    ...
    iget-boolean v14, v14, Lcom/android/server/am/ActivityRecord;->fullscreen:Z
    ...
    iget v11, v14, Lcom/android/server/am/ActivityStack;->mStackId:I
    ...
    invoke-direct {v2, v0, v11}, Lcom/android/server/am/ActivityStack;->isStackTranslucent(Lcom/android/server/am/ActivityRecord;I)Z
    ...
    iget-boolean v14, v10, Lcom/android/server/am/ActivityStack;->mFullscreen:Z

    if-nez v14, :cond_1a

    invoke-direct {v10}, Lcom/android/server/am/ActivityStack;->hasFullscreenTask()Z
    ...
    invoke-static {v14}, Landroid/app/ActivityManager$StackId;->isDynamicStacksVisibleBehindAllowed(I)Z
    ...
    invoke-direct {v10, v0, v14}, Lcom/android/server/am/ActivityStack;->isStackTranslucent(Lcom/android/server/am/ActivityRecord;I)Z
...
.method getTasksLocked(Ljava/util/List;IZI)V
    ...
    iget-boolean v14, v12, Lcom/android/server/am/ActivityRecord;->isConventionalMode:Z

    iput-boolean v14, v4, Landroid/app/ActivityManager$RunningTaskInfo;->isConventionalMode:Z
...
.method layoutTaskInStack(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;)Z
    ...
    invoke-interface {v0, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->updateDexCompatModeLocked(Lcom/android/server/am/TaskRecord;)V
    ...
    :goto_1
    invoke-virtual {p1, v0}, Lcom/android/server/am/TaskRecord;->updateOverrideConfiguration(Landroid/graphics/Rect;)Landroid/content/res/Configuration;
    ...
    invoke-interface {v0, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->getSupportScreenBounds(Lcom/android/server/am/TaskRecord;)Landroid/graphics/Rect;

    move-result-object v6

    if-nez v6, :cond_4

    invoke-virtual {p1, v1}, Lcom/android/server/am/TaskRecord;->updateOverrideConfiguration(Landroid/graphics/Rect;)Landroid/content/res/Configuration;
...
.method final moveTaskToBackLocked(IZLandroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStack;->checkBelowTasksToGoHomeStackLocked(Lcom/android/server/am/TaskRecord;)Z
    ...
    iget-boolean v2, v0, Lcom/android/server/am/TaskRecord;->isLaunchedPairApp:Z
    ...
    const-string/jumbo v2, "moveDockedTasksToFullScreen"
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/am/ActivityStack;->screenshotActivitiesLocked(Lcom/android/server/am/ActivityRecord;)Landroid/graphics/Bitmap;

    move-result-object v3

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4}, Lcom/android/server/am/ActivityRecord;->updateThumbnailLocked(Landroid/graphics/Bitmap;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v13}, Lcom/android/server/am/ActivityStack;->isHomeStack()Z
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mStacks:Ljava/util/ArrayList;
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;ZLandroid/app/ActivityOptions;Lcom/android/server/am/AppTimeTracker;Ljava/lang/String;)V
    ...
    invoke-interface {v6, p1}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->checkRunningFreeformWithLoggingLocked(Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-virtual {v6, p1}, Lcom/android/server/am/ActivityStackSupervisor;->isLockedTask(Lcom/android/server/am/TaskRecord;)Z
...
.method removeTask(Lcom/android/server/am/TaskRecord;Ljava/lang/String;I)V
    ...
    iget-boolean v7, p1, Lcom/android/server/am/TaskRecord;->mSnapWindowTarget:Z
    ...
    invoke-interface {v7, v10, v11, v8, v9}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->setSnapWindowLocked(ZLandroid/graphics/Rect;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v7, p0}, Lcom/android/server/am/IActivityManagerServiceBridge;->isVSStack(Lcom/android/server/am/ActivityStack;)Z
    ...
    invoke-interface {v7, p1, v8}, Lcom/android/server/am/IActivityManagerServiceBridge;->notifyTaskRemovedLocked(Lcom/android/server/am/TaskRecord;Ljava/lang/String;)V
    ...
    invoke-interface {v7}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->isLaunchingPairActivitiesLocked()Z
    ...
    invoke-interface {v7}, Lcom/android/server/am/IMultiWindowManagerServiceBridge;->deferDetachDockStackLocked()V
...
.method resumeTopActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;)Z
    ...
    invoke-interface {v1, p0}, Lcom/android/server/am/IActivityManagerServiceBridge;->resumeVSStackIfNeeded(Lcom/android/server/am/ActivityStack;)V
...
.method setLaunchTime(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/ActivityStack;->clearLaunchTime(Lcom/android/server/am/ActivityRecord;)V
...
.method final startPausingLocked(ZZLcom/android/server/am/ActivityRecord;Z)Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/am/ActivityStack;->screenshotActivitiesLocked(Lcom/android/server/am/ActivityRecord;)Landroid/graphics/Bitmap;
...
.method updateTaskMovement(Lcom/android/server/am/TaskRecord;Z)V
    ...
    invoke-interface {v0, p0, v1}, Lcom/android/server/am/IActivityManagerServiceBridge;->updatedTopTask(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/TaskRecord;)V
