...
.method private adjustFocusedActivityStackLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "adjustFocusedActivity"

    invoke-virtual {v6, v7}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStackToFront(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/am/ActivityStackSupervisor;->moveRecentsStackToFront(Ljava/lang/String;)V
    ...
    invoke-static {v6}, Landroid/app/ActivityManager$StackId;->keepFocusInStackIfPossible(I)Z
    ...
    invoke-virtual {v5}, Lcom/android/server/am/TaskRecord;->isFreeform()Z

    move-result v6

    if-eqz v6, :cond_7

    invoke-virtual {p0, v5}, Lcom/android/server/am/ActivityStack;->isATopFinishingTask(Lcom/android/server/am/TaskRecord;)Z
    ...
    invoke-virtual {v5, v8}, Lcom/android/server/am/TaskRecord;->setTaskToReturnTo(I)V
    ...
    const-string/jumbo v8, "activity no longer associated with task:"
    ...
    invoke-direct {p0, v3}, Lcom/android/server/am/ActivityStack;->adjustFocusToNextFocusableStackLocked(Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, v3}, Lcom/android/server/am/ActivityStackSupervisor;->moveHomeStackTaskToTop(Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, v3, v0}, Lcom/android/server/am/ActivityStackSupervisor;->setFocusStackUnchecked(Ljava/lang/String;Lcom/android/server/am/ActivityStack;)V
    ...
    invoke-virtual {v6, v7, v3}, Lcom/android/server/am/ActivityStackSupervisor;->moveFocusableActivityStackToFrontLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;)Z
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;ZLandroid/app/ActivityOptions;Lcom/android/server/am/AppTimeTracker;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/am/FreeformStackController;->removeToggleFreeformList(Lcom/android/server/am/TaskRecord;)V
...
.method removeTask(Lcom/android/server/am/TaskRecord;Ljava/lang/String;I)V
    ...
    invoke-virtual {v10, v0, v11}, Lcom/android/server/am/PairedRecentTasksController;->removePairedTask(Lcom/android/server/am/TaskRecord;Z)V
