...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    invoke-virtual/range {v18 .. v19}, Landroid/net/NetworkCapabilities;->hasCapability(I)Z
    ...
    const-string/jumbo v18, "roaming status changed, notifying NetworkStatsService"
    ...
    :cond_1
    const-string/jumbo v18, "ignoring duplicate network state non-change"
    ...
    const-string/jumbo v19, " EVENT_NETWORK_INFO_CHANGED, going from "
    ...
    const-string/jumbo v19, "Update the connection status of VPN -> "
    ...
    const-string/jumbo v19, "2Gvoice suspended networkinfo : "
    ...
    sget-object v18, Landroid/net/NetworkInfo$State;->CONNECTING:Landroid/net/NetworkInfo$State;
    ...
    invoke-virtual/range {v18 .. v19}, Landroid/net/NetworkCapabilities;->addCapability(I)Landroid/net/NetworkCapabilities;
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/net/LinkProperties;->getDnsServers()Ljava/util/List;
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/net/NetworkCapabilities;->getNetworkSpecifier()Landroid/net/NetworkSpecifier;
    ...
    const-string/jumbo v18, "ril.ims_netid"
    ...
    const-string/jumbo v19, "ril.ims_netid was set to "
    ...
    const-string/jumbo v18, "ril.epdn_netid"
    ...
    const-string/jumbo v18, "ril.eims_netid"
    ...
    const-string/jumbo v19, "ril.epdn_netid was set to "
    ...
    const-string/jumbo v18, "ro.radio.noril"
    ...
    :cond_10
    const-string/jumbo v18, "CONNECT"
    ...
    invoke-virtual/range {v18 .. v20}, Lcom/android/server/connectivity/NetworkMonitor;->sendMessage(II)V
    ...
    sget-object v18, Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;->REAP:Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;
    ...
    const-string/jumbo v19, "2Gvoice connected networkinfo : "
    ...
    const-string/jumbo v19, "isSuspendedToConnected : "
    ...
    invoke-interface/range {v18 .. v20}, Landroid/os/INetworkManagementService;->createPhysicalNetwork(ILjava/lang/String;)V
    :try_end_4
    ...
    const-string/jumbo v19, "Error creating network "
    ...
    const-string/jumbo v19, "NumberFormatException on "
    ...
    :cond_18
    const-string/jumbo v18, "ril.ims_netid2"
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/util/AsyncChannel;->disconnect()V
...
.method synthetic lambda$-com_android_server_ConnectivityService_142334(Landroid/net/Network;)V
    .locals 3
...
.method synthetic lambda$-com_android_server_ConnectivityService_44203()V
    .locals 0
