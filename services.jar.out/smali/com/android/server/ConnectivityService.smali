...
.method static synthetic -get10(Lcom/android/server/ConnectivityService;)Landroid/os/INetworkManagementService;
    .locals 1
...
.method static synthetic -get11(Lcom/android/server/ConnectivityService;)Ljava/util/HashMap;
    .locals 1
...
.method static synthetic -get12(Lcom/android/server/ConnectivityService;)Landroid/util/SparseArray;
    .locals 1
...
.method static synthetic -get13(Lcom/android/server/ConnectivityService;)Lcom/android/server/connectivity/NetworkNotificationManager;
    .locals 1
...
.method static synthetic -get14(Lcom/android/server/ConnectivityService;)Ljava/lang/Object;
    .locals 1
...
.method static synthetic -get15(Lcom/android/server/ConnectivityService;)Landroid/telephony/SignalStrength;
    .locals 1
...
.method static synthetic -get16(Lcom/android/server/ConnectivityService;)Lcom/android/server/connectivity/Tethering;
    .locals 1
...
.method static synthetic -get17(Lcom/android/server/ConnectivityService;)Landroid/util/SparseIntArray;
    .locals 1
...
.method static synthetic -get18(Lcom/android/server/ConnectivityService;)Landroid/util/SparseIntArray;
    .locals 1
...
.method static synthetic -get19()Landroid/util/SparseArray;
    .locals 1
...
.method static synthetic -get6(Lcom/android/server/ConnectivityService;)Landroid/util/ArraySet;
    .locals 1
...
.method static synthetic -get7(Lcom/android/server/ConnectivityService;)Landroid/os/PowerManager$WakeLock;
    .locals 1
...
.method static synthetic -get8(Lcom/android/server/ConnectivityService;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -get9(Lcom/android/server/ConnectivityService;)I
    .locals 1
...
.method static synthetic -set4(Lcom/android/server/ConnectivityService;Landroid/telephony/SignalStrength;)Landroid/telephony/SignalStrength;
    .locals 0
...
.method static synthetic -wrap22(Lcom/android/server/ConnectivityService;IZ)V
    .locals 0
...
.method static synthetic -wrap34(Lcom/android/server/ConnectivityService;Landroid/net/ProxyInfo;)V
    .locals 0
...
.method private filterNetworkStateForUid(Landroid/net/NetworkState;IZ)V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/ConnectivityService;->hasImsCap(Landroid/net/Network;)Z

    move-result v5

    if-eqz v5, :cond_5

    const-string/jumbo v5, "filterNetworkStateForUid() Do not augmentNetworkInfo in case of IMS"
    ...
    const-string/jumbo v8, "filterNetworkStateForUid() uid: "
...
.method private handleReleaseNetworkRequest(Landroid/net/NetworkRequest;I)V
    ...
    const-string/jumbo v22, "release NetworkRequest"
    ...
    const-string/jumbo v23, "releasing "
    ...
    invoke-virtual {v13}, Lcom/android/server/ConnectivityService$NetworkRequestInfo;->unlinkDeathRecipient()V
    ...
    iget v0, v13, Lcom/android/server/ConnectivityService$NetworkRequestInfo;->mUid:I
    ...
    sget-object v22, Lcom/android/server/ConnectivityService;->TAG:Ljava/lang/String;

    new-instance v24, Ljava/lang/StringBuilder;

    invoke-direct/range {v24 .. v24}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v25, "BUG: too small request count "
    ...
    const-string/jumbo v25, " for UID "
    ...
    invoke-virtual/range {v22 .. v23}, Landroid/util/LocalLog;->log(Ljava/lang/String;)V
    ...
    iget-object v0, v13, Lcom/android/server/ConnectivityService$NetworkRequestInfo;->request:Landroid/net/NetworkRequest;
    ...
    check-cast v22, Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    invoke-virtual {v7}, Lcom/android/server/connectivity/NetworkAgentInfo;->isBackgroundNetwork()Z
    ...
    invoke-virtual {v7, v0}, Lcom/android/server/connectivity/NetworkAgentInfo;->removeRequest(I)V

    new-instance v22, Ljava/lang/StringBuilder;

    invoke-direct/range {v22 .. v22}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v23, " Removing from current network "
    ...
    const-string/jumbo v23, ", leaving "

    invoke-virtual/range {v22 .. v23}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v22

    invoke-virtual {v7}, Lcom/android/server/connectivity/NetworkAgentInfo;->numNetworkRequests()I
    ...
    iget v9, v0, Landroid/net/Network;->netId:I
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/samsung/android/emergencymode/SemEmergencyManager;->isEmergencyMode()Z
    ...
    invoke-virtual {v0, v1, v7, v2}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->remove(ILcom/android/server/connectivity/NetworkAgentInfo;Z)V
    ...
    invoke-direct {v0, v7, v1, v2}, Lcom/android/server/ConnectivityService;->updateLingerState(Lcom/android/server/connectivity/NetworkAgentInfo;J)V

    sget-object v22, Lcom/android/server/ConnectivityService$UnneededFor;->TEARDOWN:Lcom/android/server/ConnectivityService$UnneededFor;

    move-object/from16 v0, p0

    move-object/from16 v1, v22

    invoke-direct {v0, v7, v1}, Lcom/android/server/ConnectivityService;->unneeded(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$UnneededFor;)Z
    ...
    const-string/jumbo v23, "no live requests for "
    ...
    const-string/jumbo v23, "; disconnecting"
    ...
    invoke-direct {v0, v7}, Lcom/android/server/ConnectivityService;->teardownUnneededNetwork(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    invoke-direct {v0, v1, v7, v2}, Lcom/android/server/ConnectivityService;->updateCapabilities(ILcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/connectivity/NetworkAgentInfo;->isSatisfyingRequest(I)Z
    ...
    sget-object v23, Lcom/android/server/ConnectivityService;->TAG:Ljava/lang/String;
    ...
    const-string/jumbo v24, " satisfied by "
    ...
    const-string/jumbo v24, ", but mNetworkAgentInfos says "
    ...
    invoke-virtual/range {v24 .. v25}, Landroid/util/SparseIntArray;->indexOfKey(I)I
    ...
    const-string/jumbo v23, "MultiNetwork Request(TransportType - Wi-Fi request) release ("
    ...
    const-string/jumbo v22, "requestID"
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/android/server/connectivity/NetworkMonitor;->sendMessage(IIILjava/lang/Object;)V
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/net/NetworkRequest;->isListen()Z
    ...
    const-string/jumbo v23, "Release; mRefCount = "
    ...
    invoke-direct {v0, v1, v2, v9}, Lcom/android/server/ConnectivityService;->updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;I)Z
    ...
    invoke-direct {v0, v1, v2, v9}, Lcom/android/server/ConnectivityService;->updateDnses(Landroid/net/LinkProperties;Landroid/net/LinkProperties;I)V
    ...
    invoke-virtual {v7, v6}, Lcom/android/server/connectivity/NetworkAgentInfo;->requestAt(I)Landroid/net/NetworkRequest;
    ...
    invoke-virtual/range {v16 .. v16}, Landroid/net/NetworkRequest;->isRequest()Z

    move-result v22

    if-eqz v22, :cond_11

    const-string/jumbo v22, " still have other legacy request - leaving"
    ...
    iget-object v0, v10, Lcom/android/server/ConnectivityService$NetworkFactoryInfo;->asyncChannel:Lcom/android/internal/util/AsyncChannel;
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/net/NetworkCapabilities;->hasSignalStrength()Z
    ...
    invoke-virtual {v7, v0}, Lcom/android/server/connectivity/NetworkAgentInfo;->satisfiesImmutableCapabilitiesOf(Landroid/net/NetworkRequest;)Z

    move-result v22

    if-eqz v22, :cond_15

    const-string/jumbo v22, "RELEASE"
    ...
    invoke-direct {v0, v7, v1, v2}, Lcom/android/server/ConnectivityService;->updateSignalStrengthThresholds(Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;Landroid/net/NetworkRequest;)V
    ...
    invoke-direct {v0, v13, v1, v2, v3}, Lcom/android/server/ConnectivityService;->callCallbackForRequest(Lcom/android/server/ConnectivityService$NetworkRequestInfo;Lcom/android/server/connectivity/NetworkAgentInfo;II)V
...
.method private makeDefault(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    const-string/jumbo v4, "mMobileConnected(hipri) : "
...
.method private updateCapabilities(ILcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkCapabilities;)V
    ...
    const-string/jumbo v10, "updateCapabilities: oldCap = "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v10, p2, Lcom/android/server/connectivity/NetworkAgentInfo;->networkCapabilities:Landroid/net/NetworkCapabilities;

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v9

    const-string/jumbo v10, ", newCap = "
    ...
    iget-boolean v9, p2, Lcom/android/server/connectivity/NetworkAgentInfo;->everConnected:Z

    if-eqz v9, :cond_0

    iget-object v9, p2, Lcom/android/server/connectivity/NetworkAgentInfo;->networkCapabilities:Landroid/net/NetworkCapabilities;

    invoke-virtual {v9, p3}, Landroid/net/NetworkCapabilities;->equalImmutableCapabilities(Landroid/net/NetworkCapabilities;)Z
    ...
    iget-boolean v9, p2, Lcom/android/server/connectivity/NetworkAgentInfo;->lastValidated:Z
    ...
    :goto_1
    iget-boolean v9, p2, Lcom/android/server/connectivity/NetworkAgentInfo;->lastCaptivePortalDetected:Z
    ...
    const-string/jumbo v11, " changed immutable capabilities: "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, p2, Lcom/android/server/connectivity/NetworkAgentInfo;->networkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    iget-boolean v9, p2, Lcom/android/server/connectivity/NetworkAgentInfo;->created:Z
    ...
    invoke-virtual {v2, v6}, Landroid/net/NetworkCapabilities;->equalRequestableCapabilities(Landroid/net/NetworkCapabilities;)Z
    ...
    invoke-direct {p0, p2, v9}, Lcom/android/server/ConnectivityService;->processListenRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Z)V
    ...
    iget-object v10, p2, Lcom/android/server/connectivity/NetworkAgentInfo;->network:Landroid/net/Network;

    iget v10, v10, Landroid/net/Network;->netId:I

    invoke-interface {v9, v10, v3}, Landroid/os/INetworkManagementService;->setNetworkPermission(ILjava/lang/String;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-virtual {v4, v2}, Landroid/net/NetworkCapabilities;->satisfiedByNetworkCapabilities(Landroid/net/NetworkCapabilities;)Z

    move-result v9

    if-eqz v9, :cond_9

    invoke-virtual {v4, v2}, Landroid/net/NetworkCapabilities;->getDiffCapabilities(Landroid/net/NetworkCapabilities;)[I
    ...
    invoke-direct {p0, v9}, Lcom/android/server/ConnectivityService;->getFixedApnTypeFromNetCap(I)Ljava/lang/String;

    move-result-object v9

    invoke-direct {p0, v9}, Lcom/android/server/ConnectivityService;->IncludeFixedApn(Ljava/lang/String;)Z
    ...
    iget-object v9, p0, Lcom/android/server/ConnectivityService;->mTempNri:Lcom/android/server/ConnectivityService$NetworkRequestInfo;

    if-eqz v9, :cond_6

    iget-object v9, p0, Lcom/android/server/ConnectivityService;->mTempNri:Lcom/android/server/ConnectivityService$NetworkRequestInfo;

    iget-object v9, v9, Lcom/android/server/ConnectivityService$NetworkRequestInfo;->request:Landroid/net/NetworkRequest;

    invoke-virtual {p2, v9}, Lcom/android/server/connectivity/NetworkAgentInfo;->addRequest(Landroid/net/NetworkRequest;)Z

    const/4 v9, 0x0

    iput-object v9, p0, Lcom/android/server/ConnectivityService;->mTempNri:Lcom/android/server/ConnectivityService$NetworkRequestInfo;
    ...
    const-string/jumbo v10, "Exception in setNetworkPermission: "
    ...
    invoke-virtual {v2, v4}, Landroid/net/NetworkCapabilities;->getDiffCapabilities(Landroid/net/NetworkCapabilities;)[I
    ...
    invoke-virtual {p0, p2, v9}, Lcom/android/server/ConnectivityService;->notifyNetworkCallbacks(Lcom/android/server/connectivity/NetworkAgentInfo;I)V
    ...
    invoke-virtual {v9, v10, p2}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->add(ILcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    iput-object v12, v0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
    ...
    const-string/jumbo v12, "roaming status changed, notifying NetworkStatsService"
    ...
    :cond_1
    const-string/jumbo v12, "ignoring duplicate network state non-change"
    ...
    const-string/jumbo v13, " EVENT_NETWORK_INFO_CHANGED, going from "
    ...
    iput-object v10, v0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v13, "Update the connection status of VPN -> "
    ...
    iget-object v13, v0, Lcom/android/server/ConnectivityService;->mVpnState:Landroid/net/NetworkInfo$State;
    ...
    iput-boolean v12, v0, Lcom/android/server/ConnectivityService;->mSendIntentForSUSPENDED:Z

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v13, "2Gvoice suspended networkinfo : "
    ...
    iget-boolean v12, v0, Lcom/android/server/connectivity/NetworkAgentInfo;->created:Z
    ...
    invoke-virtual {v12, v13}, Landroid/net/NetworkCapabilities;->addCapability(I)Landroid/net/NetworkCapabilities;
    ...
    iget v15, v12, Landroid/net/Network;->netId:I
    ...
    iget-object v12, v0, Lcom/android/server/connectivity/NetworkAgentInfo;->networkMisc:Landroid/net/NetworkMisc;
    ...
    iget-boolean v12, v12, Landroid/net/NetworkMisc;->allowBypass:Z
    ...
    :goto_4
    invoke-interface {v14, v15, v13, v12}, Landroid/os/INetworkManagementService;->createVirtualNetwork(IZZ)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    iput-boolean v12, v0, Lcom/android/server/connectivity/NetworkAgentInfo;->created:Z

    :cond_7
    move-object/from16 v0, p1

    iget-boolean v12, v0, Lcom/android/server/connectivity/NetworkAgentInfo;->everConnected:Z
    ...
    iput-boolean v12, v0, Lcom/android/server/connectivity/NetworkAgentInfo;->everConnected:Z
    ...
    const-string/jumbo v12, "ril.ims_netid"
    ...
    const-string/jumbo v13, "ril.ims_netid was set to "
    ...
    const-string/jumbo v12, "ril.epdn_netid"
    ...
    const-string/jumbo v12, "ril.eims_netid"
    ...
    const-string/jumbo v13, "ril.epdn_netid was set to "
    ...
    invoke-direct {v0, v1, v12}, Lcom/android/server/ConnectivityService;->updateLinkProperties(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/LinkProperties;)V

    invoke-direct/range {p0 .. p0}, Lcom/android/server/ConnectivityService;->notifyIfacesChangedForNetworkStats()V

    const-string/jumbo v12, "CMC"

    const-string/jumbo v13, "CMC"
    ...
    invoke-direct {v0, v12, v13}, Lcom/android/server/ConnectivityService;->updateBidirectionalTcp(Landroid/net/LinkProperties;Z)V

    :cond_a
    move-object/from16 v0, p1

    iget-object v12, v0, Lcom/android/server/connectivity/NetworkAgentInfo;->networkMonitor:Lcom/android/server/connectivity/NetworkMonitor;
    ...
    iget-object v13, v0, Lcom/android/server/ConnectivityService;->mProxyLock:Ljava/lang/Object;
    ...
    iget-boolean v12, v0, Lcom/android/server/ConnectivityService;->mDefaultProxyDisabled:Z
    ...
    iput-boolean v12, v0, Lcom/android/server/ConnectivityService;->mDefaultProxyDisabled:Z

    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/server/ConnectivityService;->mGlobalProxy:Landroid/net/ProxyInfo;

    if-nez v12, :cond_d

    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/server/ConnectivityService;->mDefaultProxy:Landroid/net/ProxyInfo;
    ...
    invoke-direct {v0, v12}, Lcom/android/server/ConnectivityService;->sendProxyBroadcast(Landroid/net/ProxyInfo;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    invoke-direct {v0, v1, v12, v13}, Lcom/android/server/ConnectivityService;->updateSignalStrengthThresholds(Lcom/android/server/connectivity/NetworkAgentInfo;Ljava/lang/String;Landroid/net/NetworkRequest;)V
    ...
    invoke-virtual {v12, v13, v14}, Lcom/android/server/connectivity/NetworkMonitor;->sendMessage(II)V
    ...
    sget-object v12, Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;->REAP:Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v0, v1, v12, v4, v5}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;J)V
    ...
    invoke-virtual {v0, v1, v12}, Lcom/android/server/ConnectivityService;->notifyNetworkCallbacks(Lcom/android/server/connectivity/NetworkAgentInfo;I)V
    ...
    iput-boolean v12, v0, Lcom/android/server/ConnectivityService;->mSendIntentForCONNECTED:Z

    const/4 v12, 0x1

    move-object/from16 v0, p0

    iput-boolean v12, v0, Lcom/android/server/ConnectivityService;->mSuspendCallBack:Z
    ...
    const-string/jumbo v13, "2Gvoice connected networkinfo : "
    ...
    const-string/jumbo v13, "isSuspendedToConnected : "
    ...
    iget-object v14, v0, Lcom/android/server/connectivity/NetworkAgentInfo;->networkCapabilities:Landroid/net/NetworkCapabilities;

    move-object/from16 v0, p0

    invoke-direct {v0, v14}, Lcom/android/server/ConnectivityService;->getNetworkPermission(Landroid/net/NetworkCapabilities;)Ljava/lang/String;

    move-result-object v14

    invoke-interface {v12, v13, v14}, Landroid/os/INetworkManagementService;->createPhysicalNetwork(ILjava/lang/String;)V
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_0
    ...
    const-string/jumbo v13, "Error creating network "
    ...
    iget-object v12, v0, Lcom/android/server/connectivity/NetworkAgentInfo;->asyncChannel:Lcom/android/internal/util/AsyncChannel;

    invoke-virtual {v12}, Lcom/android/internal/util/AsyncChannel;->disconnect()V
    ...
    invoke-direct {v0, v1, v7}, Lcom/android/server/ConnectivityService;->rematchAllNetworksAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;I)V
    ...
    invoke-virtual {v12, v0}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->update(Lcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-direct {v14, v0, v1}, Lcom/android/internal/util/IndentingPrintWriter;-><init>(Ljava/io/Writer;Ljava/lang/String;)V
    ...
    const-string/jumbo v21, "Permission Denial: can\'t dump ConnectivityService from from pid="
    ...
    :cond_1
    const-string/jumbo v20, "NetworkFactories for:"

    move-object/from16 v0, v20

    invoke-virtual {v14, v0}, Lcom/android/internal/util/IndentingPrintWriter;->print(Ljava/lang/String;)V
    ...
    const-string/jumbo v20, "Active default network: "
    ...
    const-string/jumbo v20, "Current Networks:"
    ...
    const-string/jumbo v20, "Requests: REQUEST:%d LISTEN:%d BACKGROUND_REQUEST:%d total:%d"
    ...
    invoke-virtual {v14, v0}, Lcom/android/internal/util/IndentingPrintWriter;->println(I)V
    ...
    const-string/jumbo v20, "Lingered:"
    ...
    const-string/jumbo v20, "Metered Interfaces:"
    ...
    const-string/jumbo v20, "Restrict background: "
    ...
    invoke-virtual {v14, v0}, Lcom/android/internal/util/IndentingPrintWriter;->println(Z)V

    invoke-virtual {v14}, Lcom/android/internal/util/IndentingPrintWriter;->println()V

    const-string/jumbo v20, "Status for known UIDs:"
    ...
    invoke-virtual {v14, v0}, Lcom/android/internal/util/IndentingPrintWriter;->print(I)V
    ...
    const-string/jumbo v20, " rules="

    move-object/from16 v0, v20

    invoke-virtual {v14, v0}, Lcom/android/internal/util/IndentingPrintWriter;->print(Ljava/lang/String;)V

    invoke-static/range {v17 .. v17}, Landroid/net/NetworkPolicyManager;->uidRulesToString(I)Ljava/lang/String;
    ...
    const-string/jumbo v20, "Network Requests:"
    ...
    const-string/jumbo v20, "tcp window buffer size for:"
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string/jumbo v21, "mNetTransitionWakeLock: currently "
    ...
    const-string/jumbo v21, ", last requested for "
    ...
    invoke-virtual {v0, v1, v14, v2}, Lcom/android/server/connectivity/Tethering;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/connectivity/KeepaliveTracker;->dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    const-string/jumbo v20, "Inet condition reports:"
    ...
    invoke-virtual {v14, v0}, Lcom/android/internal/util/IndentingPrintWriter;->println(Ljava/lang/Object;)V
    ...
    :cond_b
    const-string/jumbo v20, ", last requested never"
    ...
    :try_start_2
    const-string/jumbo v20, "mValidationLogs (most recent first):"
    ...
    iget-object v0, v12, Lcom/android/server/ConnectivityService$ValidationLog;->mLog:Landroid/util/LocalLog$ReadOnlyLocalLog;
    ...
    invoke-virtual {v0, v1, v14, v2}, Landroid/util/LocalLog$ReadOnlyLocalLog;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v20, "mNetworkRequestInfoLogs (most recent first):"
    ...
    invoke-virtual {v0, v1, v14, v2}, Landroid/util/LocalLog;->reverseDump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V

    invoke-virtual {v14}, Lcom/android/internal/util/IndentingPrintWriter;->decreaseIndent()V

    invoke-virtual {v14}, Lcom/android/internal/util/IndentingPrintWriter;->println()V

    const-string/jumbo v20, "mNetworkInfoBlockingLogs (most recent first):"
...
.method public isTetheringSupported()Z
    ...
    const-string/jumbo v5, "CscFeature_Common_UseChameleon"
...
.method public requestNetwork(Landroid/net/NetworkCapabilities;Landroid/os/Messenger;ILandroid/os/IBinder;I)Landroid/net/NetworkRequest;
    ...
    const-string/jumbo v3, "Invalid network specifier - must not be \'*\'"
...
.method public updateLockdownVpn()Z
    ...
    const-string/jumbo v3, "KeyStore locked; unable to create LockdownTracker"
