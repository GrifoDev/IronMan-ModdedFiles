...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v4, v0}, Lcom/android/server/SdpManagerService$SdpEngineDatabase;->-wrap1(Lcom/android/server/SdpManagerService$SdpEngineDatabase;I)Lcom/samsung/android/knox/sdp/core/SdpEngineInfo;
    ...
    iget-object v7, v0, Lcom/android/server/SdpManagerService$SdpHandler;->this$0:Lcom/android/server/SdpManagerService;
    ...
    invoke-static {v5}, Lcom/android/server/SdpManagerService;->-get1(Lcom/android/server/SdpManagerService;)Lcom/sec/knox/container/util/EnterprisePartitionManager;

    move-result-object v5

    const/4 v6, 0x0

    invoke-direct/range {v1 .. v6}, Lcom/android/server/SdpManagerService$SecureFileSystemManager;-><init>(Landroid/content/Context;Lcom/android/server/pm/TimaHelper;Lcom/sec/knox/container/util/KeyManagementUtil;Lcom/sec/knox/container/util/EnterprisePartitionManager;Lcom/android/server/SdpManagerService$SecureFileSystemManager;)V

    invoke-static {v7, v1}, Lcom/android/server/SdpManagerService;->-set3(Lcom/android/server/SdpManagerService;Lcom/android/server/SdpManagerService$SecureFileSystemManager;)Lcom/android/server/SdpManagerService$SecureFileSystemManager;
    ...
    invoke-static {v4, v12}, Lcom/android/server/SdpManagerService;->-wrap2(Lcom/android/server/SdpManagerService;I)Z
    ...
    invoke-static {v4, v12}, Lcom/android/server/SdpManagerService;->-wrap6(Lcom/android/server/SdpManagerService;I)I
    ...
    invoke-virtual {v4, v12, v5}, Lcom/sec/knox/container/util/KeyManagementUtil;->getECMKLength(II)I

    move-result v11

    add-int/lit8 v22, v11, -0x59

    if-lez v22, :cond_8

    sget v4, Lcom/sec/knox/container/security/Header;->LENGTH:I
    ...
    const-string/jumbo v6, "Detected ECMK length : "
    ...
    invoke-static {v4, v5}, Lcom/sec/sdp/internal/SDPLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v12}, Lcom/sec/knox/container/util/KeyManagementUtil;->recoverEcmkHeader(I)V
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/content/pm/UserInfo;->isManagedProfile()Z

    move-result v4

    if-nez v4, :cond_a

    invoke-virtual/range {v23 .. v23}, Landroid/content/pm/UserInfo;->isKnoxWorkspace()Z
