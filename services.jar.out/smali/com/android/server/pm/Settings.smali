...
.method private readDisabledSysPackageLPw(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-direct {v6, v15}, Lorg/xmlpull/v1/XmlPullParserException;-><init>(Ljava/lang/String;)V
...
.method private readPackageLPw(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    :try_end_18
    .catch Ljava/lang/NumberFormatException; {:try_start_18 .. :try_end_18} :catch_b
...
.method createNewUserLI(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Installer;I)V
    ...
    const-string/jumbo v5, "isDualAppId : true"
...
.method dumpPackageLPr(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Landroid/util/ArraySet;Lcom/android/server/pm/PackageSetting;Ljava/text/SimpleDateFormat;Ljava/util/Date;Ljava/util/List;Z)V
    ...
    :pswitch_0
    const-string/jumbo v18, "failed to dexopt"
    ...
    :pswitch_2
    const-string/jumbo v18, "small art"

    goto/16 :goto_b

    :pswitch_3
    const-string/jumbo v18, "full art"

    goto/16 :goto_b

    :pswitch_4
    const-string/jumbo v18, "Not running dexopt due to low memory"
    ...
    iget-object v5, v15, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;
    ...
    iget-object v5, v15, Landroid/content/pm/PackageParser$Package;->codePath:Ljava/lang/String;
    ...
    check-cast v23, Landroid/content/pm/PackageParser$Permission;
    ...
    iget-object v13, v4, Landroid/content/pm/PackageParser$Package;->mAppMetaData:Landroid/os/Bundle;

    if-eqz v13, :cond_3b

    const-string/jumbo v4, "resizeableSetExplicitly"
    ...
    const-string/jumbo v4, "    resizeableSetExplicitly Application: true"
    ...
    iget-object v4, v10, Landroid/content/pm/PackageParser$Activity;->info:Landroid/content/pm/ActivityInfo;

    if-eqz v4, :cond_3c

    iget-object v4, v10, Landroid/content/pm/PackageParser$Activity;->metaData:Landroid/os/Bundle;

    if-eqz v4, :cond_3c

    iget-object v13, v10, Landroid/content/pm/PackageParser$Activity;->metaData:Landroid/os/Bundle;
    ...
    const-string/jumbo v4, "    resizeableSetExplicitly Activities:"
...
.method readInstallPermissionsLPr(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/pm/PermissionsState;)V
    ...
    iget-object v10, p0, Lcom/android/server/pm/Settings;->mPermissions:Landroid/util/ArrayMap;
    ...
    const-string/jumbo v12, "Permission already added: "
    ...
    :try_start_1
    invoke-virtual {p2, v0, v10, v11, v2}, Lcom/android/server/pm/PermissionsState;->updatePermissionFlags(Lcom/android/server/pm/BasePermission;III)Z
    ...
    const-string/jumbo v12, "Unknown element under <permissions>: "
...
.method readLPw(Ljava/util/List;)Z
    ...
    const-string/jumbo v4, "No start tag found in packages file"
