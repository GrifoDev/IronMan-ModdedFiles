...
.method static synthetic -wrap10(Lcom/android/server/pm/PersonaManagerService;Lcom/samsung/android/knox/SemPersonaInfo;Ljava/util/List;)V
    .locals 0
...
.method static synthetic -wrap11(Lcom/android/server/pm/PersonaManagerService;ZIII)V
    .locals 0
...
.method static synthetic -wrap12(Lcom/android/server/pm/PersonaManagerService;IZ)V
    .locals 0
...
.method static synthetic -wrap16(Lcom/android/server/pm/PersonaManagerService;Ljava/util/List;)V
    .locals 0
...
.method static synthetic -wrap7(Lcom/android/server/pm/PersonaManagerService;ILandroid/content/ComponentName;Z)V
    .locals 0
...
.method private cleanSettingsProvider(I)V
    ...
    const-string/jumbo v13, "cleanSettingsProvider is called for personaId "
    ...
    const-string/jumbo v11, "databases"
    ...
    const-string/jumbo v12, "/settings_system.xml"
    ...
    const-string/jumbo v12, "/settings_secure.xml"
    ...
    const-string/jumbo v12, "/settings_global.xml"
    ...
    const-string/jumbo v12, "/appwidgets.xml"
...
.method private getKnoxPhoneOrMessageIcon(Ljava/lang/String;)[B
    ...
    :try_start_0
    const-string/jumbo v14, "com.samsung.android.knox.containeragent.switcher.PhoneIcon"
    ...
    const-string/jumbo v9, "com.samsung.android.contacts"
    ...
    const-string/jumbo v16, "Phone Package Name = "
    ...
    invoke-virtual {v14, v9, v15, v0}, Landroid/content/pm/PackageManager;->getPackageInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    ...
    const-string/jumbo v14, "android.intent.action.DIAL"
    ...
    invoke-virtual {v14, v8, v15, v0}, Landroid/content/pm/PackageManager;->queryIntentActivitiesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    const-string/jumbo v16, "Phone PackageName List = "
    ...
    invoke-virtual {v10, v3, v5}, Landroid/content/res/Resources;->getDrawableForDensity(II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2, v14, v15, v13}, Landroid/graphics/Bitmap;->compress(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    ...
    :cond_4
    const-string/jumbo v14, "com.samsung.android.knox.containeragent.switcher.SMSIcon"
    ...
    const-string/jumbo v9, "com.samsung.android.messaging"
    ...
    const-string/jumbo v16, "SMS Package Name = "
    ...
    const-string/jumbo v14, "android.intent.category.INFO"
    ...
    invoke-virtual {v14, v12, v15, v0}, Landroid/content/pm/PackageManager;->queryIntentActivitiesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    invoke-virtual {v12, v14}, Landroid/content/Intent;->removeCategory(Ljava/lang/String;)V
    ...
    const-string/jumbo v16, "Failed to load icon from default resource: "
...
.method private handleFOTAProfileOwnerPrime()V
    ...
    const-string/jumbo v22, "PersonaManagerService:FOTA"

    const-string/jumbo v23, "handleFOTAProfileOwnerPrime() update UserInfo.attribute for PO -> PO\' FOTA case from 2.9 -> 3.0"
    ...
    invoke-virtual/range {v22 .. v23}, Landroid/os/UserManager;->getProfiles(I)Ljava/util/List;
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/content/pm/UserInfo;->isFirstContainer()Z
    ...
    :cond_1
    invoke-virtual/range {v19 .. v19}, Landroid/content/pm/UserInfo;->isSecondContainer()Z
    ...
    const-string/jumbo v22, "com.sec.android.app.samsungapps"

    const-string/jumbo v23, "com.sec.android.app.samsungapps.SamsungAppsMainActivity"
    ...
    const-string/jumbo v24, "handleFOTAProfileOwnerPrime() get user: "
    ...
    new-instance v23, Lcom/samsung/android/knox/ContextInfo;
    ...
    invoke-direct {v0, v15, v1}, Lcom/samsung/android/knox/ContextInfo;-><init>(II)V
    ...
    const-string/jumbo v23, "com.knox.vpn.proxyhandler"

    invoke-virtual/range {v22 .. v23}, Lcom/samsung/android/knox/application/ApplicationPolicy;->addAppPackageNameToWhiteList(Ljava/lang/String;)Z
    ...
    const-string/jumbo v23, "com.android.server.telecom"
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/content/pm/UserInfo;->isKnoxWorkspace()Z
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/content/pm/UserInfo;->isDualAppProfile()Z
    ...
    const-string/jumbo v24, "handleFOTAProfileOwnerPrime() PO\' is always the third container migrated "
    ...
    const-string/jumbo v22, "attributes"
    ...
    const-string/jumbo v24, "handleFOTAProfileOwnerPrime() update attribute for AFW ManagedProfile: "
    ...
    const-string/jumbo v23, "handleFOTAProfileOwnerPrime() migrating Settings.System.KNOX_SETTINGS_KNOX_STYLE as FOLDER"
    ...
    const-string/jumbo v23, "KNOX_SETTINGS_KNOX_STYLE"

    const-string/jumbo v24, "FOLDER"
    ...
    invoke-static/range {v22 .. v25}, Landroid/provider/Settings$System;->putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z

    const-string/jumbo v22, "PersonaManagerService:FOTA"

    const-string/jumbo v23, "handleFOTAProfileOwnerPrime() migrating  Settings.System.IS_SHOWN_FOLDER_HELP "
    ...
    const-string/jumbo v23, "IS_SHOWN_FOLDER_HELP"
    ...
    const-string/jumbo v23, "handleFOTAProfileOwnerPrime() migrating Settings.System.IS_SHOWN_LAUNCHER_HELP "
    ...
    const-string/jumbo v23, "IS_SHOWN_LAUNCHER_HELP"
    ...
    const-string/jumbo v23, "handleFOTAProfileOwnerPrime() set default Settings.System.KNOX_SCREEN_OFF_TIMEOUT "
    ...
    const-string/jumbo v23, "knox_screen_off_timeout"
    ...
    const-string/jumbo v24, "handleFOTAProfileOwnerPrime() set default caller_id_to_show_ "
    ...
    const-string/jumbo v24, "caller_id_to_show_"
    ...
    const-string/jumbo v23, "handleFOTAProfileOwnerPrime() Adding Google PO owner uid in enterprise DB"
    ...
    const-string/jumbo v24, "handleFOTAProfileOwnerPrime() ownerPackage: "
    ...
    const-string/jumbo v24, "handleFOTAProfileOwnerPrime() addMUMContainer result: "
    ...
    const-string/jumbo v24, "handleFOTAProfileOwnerPrime() agentInstallStatus : "
    ...
    const-string/jumbo v24, "handleFOTAProfileOwnerPrime() exception : "
...
.method private handleFOTAUpgradeToO(Lcom/samsung/android/knox/SemPersonaInfo;)V
    ...
    const-string/jumbo v17, "PersonaManagerService:FOTA"

    new-instance v18, Ljava/lang/StringBuilder;

    invoke-direct/range {v18 .. v18}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v19, "handleFOTAUpgradeToO is called for id "
    ...
    iget v8, v0, Lcom/samsung/android/knox/SemPersonaInfo;->flags:I
    ...
    invoke-direct {v0, v10, v1}, Lcom/samsung/android/knox/ContextInfo;-><init>(II)V
    ...
    invoke-virtual {v9}, Lcom/samsung/android/knox/container/KnoxContainerManager;->getApplicationPolicy()Lcom/samsung/android/knox/application/ApplicationPolicy;

    move-result-object v17

    const-string/jumbo v18, "com.samsung.android.knox.containeragent"

    invoke-virtual/range {v17 .. v18}, Lcom/samsung/android/knox/application/ApplicationPolicy;->addAppPackageNameToWhiteList(Ljava/lang/String;)Z

    invoke-virtual {v9}, Lcom/samsung/android/knox/container/KnoxContainerManager;->getApplicationPolicy()Lcom/samsung/android/knox/application/ApplicationPolicy;

    move-result-object v17

    const-string/jumbo v18, "com.samsung.android.knox.containercore"
    ...
    or-int/lit8 v16, v17, 0x10

    const-string/jumbo v17, "PersonaManagerService:FOTA"

    const-string/jumbo v18, "handleFOTAUpgradeToO migrating secure folder flag"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating user owned flag"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating light weight flag"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating kiosk mode flag"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating bbc container flag"
    ...
    const-string/jumbo v18, "samsungaccount"
    ...
    invoke-static/range {v17 .. v20}, Landroid/provider/Settings$System;->putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating CL Container flag"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating first container flags"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating eCryptfs flag"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO adding flags in bundle"
    ...
    const-string/jumbo v17, "knoxid.reset_on_reboot"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating reset on reboot attribute"
    ...
    iget-object v12, v0, Lcom/samsung/android/knox/SemPersonaInfo;->currentState:Ljava/lang/String;
    ...
    :goto_2
    invoke-static/range {v17 .. v17}, Lcom/samsung/android/knox/SemPersonaState;->valueOf(Ljava/lang/String;)Lcom/samsung/android/knox/SemPersonaState;
    ...
    const-string/jumbo v19, "handleFOTAUpgradeToO persona state - "
    ...
    sget-object v17, Lcom/samsung/android/knox/SemPersonaState;->ADMIN_LOCKED:Lcom/samsung/android/knox/SemPersonaState;
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating admin lock attribute"
    ...
    const-string/jumbo v18, "PASSWORD_CHANGE_REQUEST"
    ...
    :cond_c
    sget-object v17, Lcom/samsung/android/knox/SemPersonaState;->LICENSE_LOCKED:Lcom/samsung/android/knox/SemPersonaState;
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating premium container attribute"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating trust agent UI enabled attribute"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating external sdcard attribute"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO adding attributes in bundle"

    invoke-static/range {v17 .. v18}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v17, "attributes"
    ...
    const-string/jumbo v19, "handleFOTAUpgradeToO ecName - "
    ...
    :cond_12
    const-string/jumbo v17, "fotaUpgradeVersion"
    ...
    const-string/jumbo v19, "handleFOTAUpgradeToO fotaUpgradeVersion : "
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO calling usermanager to migrate persona information "
    ...
    invoke-virtual {v0, v1, v5}, Landroid/os/UserManager;->updateUserInfo(ILandroid/os/Bundle;)Z
    ...
    const-string/jumbo v19, "handleFOTAUpgradeToO updateUserInfo status - "
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating  Settings.System.IS_SHOWN_FOLDER_HELP "
    ...
    const-string/jumbo v19, "IS_SHOWN_FOLDER_HELP"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating Settings.System.IS_SHOWN_LAUNCHER_HELP "
    ...
    const-string/jumbo v19, "IS_SHOWN_LAUNCHER_HELP"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating Settings.System.KNOX_SETTINGS_KNOX_STYLE as FOLDER"
    ...
    const-string/jumbo v18, "KNOX_SETTINGS_KNOX_STYLE"

    const-string/jumbo v19, "FOLDER"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating Settings.System.KNOX_SCREEN_OFF_TIMEOUT for Securefolder user using immediately timeout"
    ...
    const-string/jumbo v18, "knox_screen_off_timeout"
    ...
    invoke-static {v0, v1, v14, v2}, Landroid/provider/Settings$System;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    const-string/jumbo v18, "ExternalStorage"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating external sdcard usage"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating bluetooth usage"
    ...
    const-string/jumbo v19, "handleFOTAUpgradeToO migratePersonaPoliciesToMdmDb status - "
    ...
    const-string/jumbo v19, "handleFOTAUpgradeToO enableOwnerLaunchersForCOM status - "
    ...
    const-string/jumbo v19, "handleFOTAUpgradeToO migrateKnoxAppsData status - "
    ...
    const-string/jumbo v17, "KNOX II"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating second container flags"
    ...
    const-string/jumbo v19, "handleFOTAUpgradeToO neither first nor second container for user: "
    ...
    :cond_1b
    sget-object v17, Lcom/samsung/android/knox/SemPersonaState;->DELETING:Lcom/samsung/android/knox/SemPersonaState;
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating license lock attribute"
    ...
    :cond_1e
    sget-object v17, Lcom/samsung/android/knox/SemPersonaState;->TIMA_COMPROMISED:Lcom/samsung/android/knox/SemPersonaState;
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating device compromised attribute"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO migrating Settings.System.KNOX_SETTINGS_KNOX_STYLE as LAUNCHER"
    ...
    const-string/jumbo v19, "LAUNCHER"
    ...
    const-string/jumbo v18, "handleFOTAUpgradeToO pInfo is null"
