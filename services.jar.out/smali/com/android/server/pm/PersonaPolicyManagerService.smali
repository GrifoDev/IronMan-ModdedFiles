...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/pm/PersonaPolicyManagerService$PersonaHandler;,
...
.field private static final MSG_ADD_PACKAGES_TO_BLACK_LIST:I = 0x1
...
.field private mPersonaHandler:Lcom/android/server/pm/PersonaPolicyManagerService$PersonaHandler;
...
.method static synthetic -wrap2(Lcom/android/server/pm/PersonaPolicyManagerService;Ljava/util/List;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/pm/PersonaPolicyManagerService;->setApplicationBlackList(Ljava/util/List;I)V
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/pm/PersonaPolicyManagerService;->handlerThread:Landroid/os/HandlerThread;

    iput-object v1, p0, Lcom/android/server/pm/PersonaPolicyManagerService;->mPersonaHandler:Lcom/android/server/pm/PersonaPolicyManagerService$PersonaHandler;
    ...
    iput-object v0, p0, Lcom/android/server/pm/PersonaPolicyManagerService;->handlerThread:Landroid/os/HandlerThread;

    iget-object v0, p0, Lcom/android/server/pm/PersonaPolicyManagerService;->handlerThread:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaHandler;

    iget-object v1, p0, Lcom/android/server/pm/PersonaPolicyManagerService;->handlerThread:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaHandler;-><init>(Lcom/android/server/pm/PersonaPolicyManagerService;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/pm/PersonaPolicyManagerService;->mPersonaHandler:Lcom/android/server/pm/PersonaPolicyManagerService$PersonaHandler;
...
.method public setSecureFolderPolicy(Ljava/lang/String;Ljava/util/List;I)Z
    ...
    iget-object v2, v1, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaPolicyData;->mSecureFolderPolicies:Ljava/util/HashMap;
    ...
    const-string/jumbo v2, "DisallowPackage"
    ...
    iget-object v2, p0, Lcom/android/server/pm/PersonaPolicyManagerService;->mPersonaHandler:Lcom/android/server/pm/PersonaPolicyManagerService$PersonaHandler;

    invoke-virtual {v2, v3}, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/pm/PersonaPolicyManagerService$PersonaHandler;->sendMessage(Landroid/os/Message;)Z
