...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageParser$Package;IIILjava/lang/String;Landroid/content/pm/IPackageDataObserver;)V
    ...
    iput-object p2, p0, Lcom/android/server/pm/PackageManagerService$18;->val$pkg:Landroid/content/pm/PackageParser$Package;

    iput p3, p0, Lcom/android/server/pm/PackageManagerService$18;->val$callingUid:I

    iput p4, p0, Lcom/android/server/pm/PackageManagerService$18;->val$hasAccessInstantApps:I

    iput p5, p0, Lcom/android/server/pm/PackageManagerService$18;->val$userId:I

    iput-object p6, p0, Lcom/android/server/pm/PackageManagerService$18;->val$packageName:Ljava/lang/String;

    iput-object p7, p0, Lcom/android/server/pm/PackageManagerService$18;->val$observer:Landroid/content/pm/IPackageDataObserver;
...
.method public run()V
    ...
    iget-object v5, p0, Lcom/android/server/pm/PackageManagerService$18;->val$pkg:Landroid/content/pm/PackageParser$Package;
    ...
    iget v5, p0, Lcom/android/server/pm/PackageManagerService$18;->val$callingUid:I
    ...
    iget v5, p0, Lcom/android/server/pm/PackageManagerService$18;->val$hasAccessInstantApps:I
    ...
    iget-object v5, p0, Lcom/android/server/pm/PackageManagerService$18;->this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    iget-object v7, p0, Lcom/android/server/pm/PackageManagerService$18;->val$pkg:Landroid/content/pm/PackageParser$Package;
    ...
    :cond_1
    iget-object v5, p0, Lcom/android/server/pm/PackageManagerService$18;->val$observer:Landroid/content/pm/IPackageDataObserver;
