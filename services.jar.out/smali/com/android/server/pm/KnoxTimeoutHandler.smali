...
.method static synthetic -wrap5(Lcom/android/server/pm/KnoxTimeoutHandler;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/pm/KnoxTimeoutHandler;->hideKeyguardIfNeeded(Z)V
...
.method private declared-synchronized activityDrawn(Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;)V
    ...
    const-string/jumbo v6, "activityDrawn for COM container "
    ...
    iget-boolean v4, p1, Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;->skipShowKeyguard:Z
    ...
    const-string/jumbo v6, " mCurrent is KNOX user"
...
.method private declared-synchronized handleActiveUserChange(Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;)V
    ...
    :try_start_0
    iget v7, p1, Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;->userId:I

    iget-object v8, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mService:Lcom/android/server/pm/PersonaManagerService;

    invoke-virtual {v8, v7}, Lcom/android/server/pm/PersonaManagerService;->exists(I)Z
    ...
    const-string/jumbo v10, "handleActiveUserChange "
    ...
    iget-boolean v8, p1, Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;->isMutiwindowRecord:Z

    if-nez v8, :cond_0

    iput v7, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mCurrentId:I

    :cond_0
    const/4 v8, 0x1

    iput-boolean v8, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->isKnox:Z

    iget-object v8, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mService:Lcom/android/server/pm/PersonaManagerService;

    sget-object v9, Lcom/samsung/android/knox/SemPersonaState;->ACTIVE:Lcom/samsung/android/knox/SemPersonaState;

    invoke-virtual {v8, v9, v7}, Lcom/android/server/pm/PersonaManagerService;->inState(Lcom/samsung/android/knox/SemPersonaState;I)Z
    ...
    iget-wide v10, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mLatestTouchedTime:J
    ...
    const-string/jumbo v10, " reset timeout from active user change. The time difference is "
    ...
    invoke-direct {p0, v7}, Lcom/android/server/pm/KnoxTimeoutHandler;->resetLockTimer(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v8, v7}, Lcom/android/server/pm/PersonaManagerService;->getPersonaInfo(I)Lcom/samsung/android/knox/SemPersonaInfo;

    move-result-object v5

    if-eqz v5, :cond_3

    iget-boolean v8, v5, Lcom/samsung/android/knox/SemPersonaInfo;->removePersona:Z
    ...
    const-string/jumbo v10, " is removed, no locking needed"
    ...
    invoke-virtual {v8, v7}, Lcom/android/server/pm/PersonaManagerService;->isUserHasTrust(I)Z
    ...
    sget-object v9, Lcom/samsung/android/knox/SemPersonaState;->LOCKED:Lcom/samsung/android/knox/SemPersonaState;
    ...
    const-string/jumbo v10, " isUserHasTrust "
    ...
    invoke-virtual {v8, v7}, Lcom/android/server/pm/PersonaManagerService;->dismissPersonaKeyGuard(I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    :cond_4
    :try_start_3
    iget-boolean v8, p1, Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;->showWhenLocked:Z
    ...
    invoke-virtual {v8}, Lcom/android/server/wm/WindowManagerService;->stopFreezingScreen()V

    invoke-static {v2, v3}, Landroid/os/Binder;->restoreCallingIdentity(J)V

    const-string/jumbo v8, "KnoxTimeoutHandler"

    const-string/jumbo v9, "Do not show knox security screen cause it has FLAG_SHOW_WHEN_LOCKED but hide if needed"

    invoke-static {v8, v9}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v8, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mHandler:Landroid/os/Handler;

    iget-object v9, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v8, v7, v9}, Lcom/android/server/pm/PersonaManagerService;->showKeyguard(II)V

    goto/16 :goto_0

    :cond_6
    iget-boolean v8, p1, Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;->skipShowKeyguard:Z

    if-nez v8, :cond_1

    iget-object v8, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mService:Lcom/android/server/pm/PersonaManagerService;

    invoke-virtual {v8, v7}, Lcom/android/server/pm/PersonaManagerService;->showKeyguard(I)V
    ...
    invoke-virtual {v8}, Lcom/samsung/android/knox/shareddevice/EnterpriseSharedDevicePolicy;->isSharedDeviceEnabled()Z
    ...
    const-string/jumbo v10, "Shared devices show user state"
    ...
    const-string/jumbo v9, "isEmergencyCall"
    ...
    const-string/jumbo v10, "Shared devices flag "
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/pm/PersonaManagerService;->showKeyguard(I)V
    :try_end_4
    ...
    const-string/jumbo v10, "handleActiveUserChange for COM container "
    ...
    iget-object v10, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mService:Lcom/android/server/pm/PersonaManagerService;

    iget v10, v10, Lcom/android/server/pm/PersonaManagerService;->enabledKioskContainerId:I

    invoke-virtual {v8, v9, v10}, Lcom/android/server/pm/PersonaManagerService;->inState(Lcom/samsung/android/knox/SemPersonaState;I)Z
    ...
    const-string/jumbo v10, " reset timeout from active Kiosk user. The time difference is "
    ...
    invoke-direct {p0, v8}, Lcom/android/server/pm/KnoxTimeoutHandler;->resetLockTimer(I)V
    ...
    iget-object v9, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mService:Lcom/android/server/pm/PersonaManagerService;

    iget v9, v9, Lcom/android/server/pm/PersonaManagerService;->enabledKioskContainerId:I
    ...
    :cond_d
    iget-boolean v8, p1, Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;->fullscreen:Z
...
.method private handleHomeShow(I)V
    ...
    const-string/jumbo v5, "handleHomeShow for "
    ...
    const-string/jumbo v5, " and current "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mCurrentPersonaId:I
    ...
    const-string/jumbo v5, " launch home intent for calibration because home is shown for "
    ...
    const-string/jumbo v3, "DesktopModeService"
...
.method private hideKeyguardIfNeeded(Z)V
    .locals 1

    iget-object v0, p0, Lcom/android/server/pm/KnoxTimeoutHandler;->mService:Lcom/android/server/pm/PersonaManagerService;

    invoke-virtual {v0, p1}, Lcom/android/server/pm/PersonaManagerService;->hideKeyguardIfNeeded(Z)V
...
.method notifyActivityDrawn(IZZIZ)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;-><init>(Lcom/android/server/pm/KnoxTimeoutHandler;IZZIZ)V
...
.method postActiveUserChange(IZZZZ)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/pm/KnoxTimeoutHandler$MsgParam;-><init>(Lcom/android/server/pm/KnoxTimeoutHandler;IZZZZ)V
