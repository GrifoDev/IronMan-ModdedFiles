...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->mActivityManagerInternal:Landroid/app/ActivityManagerInternal;
...
.method private ensureInUserProfiles(ILjava/lang/String;)V
    ...
    :try_start_0
    iget-object v8, p0, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->mUm:Landroid/os/UserManager;
    ...
    :cond_1
    :try_start_1
    iget-object v8, p0, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->mPm:Landroid/content/pm/PackageManager;

    const-string/jumbo v9, "android.uid.systemui"

    invoke-virtual {v8, v9}, Landroid/content/pm/PackageManager;->getUidForSharedUser(Ljava/lang/String;)I
    ...
    invoke-virtual {v8, v9, v0}, Landroid/content/pm/PackageManager;->checkSignatures(II)I
    :try_end_1
    ...
    invoke-virtual {p0, v4, v5}, Lcom/android/server/pm/LauncherAppsService$LauncherAppsImpl;->injectRestoreCallingIdentity(J)V
    ...
    iget v9, v2, Landroid/content/pm/UserInfo;->profileGroupId:I
    :try_end_2
