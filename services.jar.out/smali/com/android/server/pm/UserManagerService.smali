...
.method private createUserInternalUnchecked(Ljava/lang/String;II)Landroid/content/pm/UserInfo;
    ...
    const-string/jumbo v27, "Cannot add more managed profiles for user "
    ...
    const-string/jumbo v26, "Cannot add restricted profile - parent user must be specified"
    ...
    const-string/jumbo v26, "Cannot add restricted profile - parent user must be owner"
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/content/pm/UserInfo;->canHaveProfile()Z
    ...
    const-string/jumbo v27, "Cannot add restricted profile - profiles cannot be created for the specified parent user id "
    ...
    const-string/jumbo v26, "Ephemeral users are supported on split-system-user systems only."
    ...
    invoke-direct {v0, v1, v2, v3, v12}, Lcom/android/server/pm/UserManagerService;->getNextAvailableId(ZZZZ)I

    move-result v22

    invoke-static/range {v22 .. v22}, Landroid/os/Environment;->getUserSystemDirectory(I)Ljava/io/File;
    ...
    new-instance v21, Lcom/android/server/pm/UserManagerService$UserData;
    ...
    const-class v25, Landroid/os/storage/StorageManager;

    invoke-virtual/range {v24 .. v25}, Landroid/content/Context;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    const-string/jumbo v24, "users_guest_created"
    ...
    const-string/jumbo v27, "Cannot add more dual app for user "
    ...
    :cond_22
    const-string/jumbo v24, "users_user_created"
    :try_end_26
...
.method private fallbackToSingleUserLP()V
    ...
    invoke-direct {v14, v0}, Lcom/android/server/pm/UserManagerService$UserData;-><init>(Lcom/android/server/pm/UserManagerService$UserData;)V
...
.method private getNextAvailableId(ZZZZ)I
    .locals 5
...
.method public canAddMoreManagedProfiles(IZ)Z
    ...
    const-string/jumbo v8, "check if more managed profiles can be added."
    ...
    const-string/jumbo v11, "android.software.managed_users"
    ...
    :cond_1
    invoke-virtual {p0, p1, v9}, Lcom/android/server/pm/UserManagerService;->getProfiles(IZ)Ljava/util/List;
...
.method public createKnoxContainer(Ljava/lang/String;IZZZZLjava/lang/String;Lcom/sec/knox/container/util/KnoxFileHandler;)Landroid/content/pm/UserInfo;
    .locals 28

    const-string/jumbo v4, "Only the system can create users"
    ...
    const-string/jumbo v6, "Only user owner can have profiles"
    ...
    const-string/jumbo v6, "Cannot add user. DISALLOW_ADD_USER is enabled."
    ...
    new-instance v23, Lcom/android/server/pm/UserManagerService$UserData;

    const/4 v4, 0x0

    move-object/from16 v0, v23

    invoke-direct {v0, v4}, Lcom/android/server/pm/UserManagerService$UserData;-><init>(Lcom/android/server/pm/UserManagerService$UserData;)V
    ...
    const-string/jumbo v8, "UserInfo for parent is null, hence exiting container creation!"
    ...
    invoke-direct {v0, v4, v1, v2, v8}, Lcom/android/server/pm/UserManagerService;->getNextAvailableId(ZZZZ)I

    move-result v5

    new-instance v25, Landroid/content/pm/UserInfo;
    ...
    invoke-direct {v0, v5, v1, v4, v14}, Landroid/content/pm/UserInfo;-><init>(ILjava/lang/String;Ljava/lang/String;I)V
    :try_end_5
    ...
    iget-object v4, v0, Lcom/android/server/pm/UserManagerService$UserData;->info:Landroid/content/pm/UserInfo;
    ...
    iget-object v8, v0, Lcom/android/server/pm/UserManagerService$UserData;->info:Landroid/content/pm/UserInfo;
    ...
    invoke-virtual {v4, v5, v13}, Landroid/util/SparseArray;->append(ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v5}, Lcom/android/server/pm/UserManagerService;->setKnoxRestrictions(Landroid/os/Bundle;I)V
    :try_end_6
    ...
    invoke-virtual {v0, v5, v1, v2, v4}, Lcom/sec/knox/container/util/KnoxFileHandler;->createPartition(ILjava/lang/String;ZI)Z
    ...
    const-string/jumbo v6, "Knox Partition created. Starting mount.."
    ...
    invoke-virtual/range {v4 .. v10}, Lcom/sec/knox/container/util/KnoxFileHandler;->mountFS(ILjava/lang/String;ZIZI)Z
    ...
    const-string/jumbo v7, "CreateKnoxContainer: mountStatus "
    ...
    invoke-virtual {v0, v5}, Lcom/sec/knox/container/util/KnoxFileHandler;->unmount(I)Z
    ...
    invoke-virtual {v0, v5, v1, v4}, Lcom/sec/knox/container/util/KnoxFileHandler;->removePartition(IZI)Z
    :try_end_9
    ...
    const-string/jumbo v6, "Knox Partition mount complete successfully"
    ...
    invoke-virtual {v4, v5, v6, v7}, Lcom/android/server/pm/PackageManagerService;->prepareUserData(III)V

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/pm/UserManagerService;->mPm:Lcom/android/server/pm/PackageManagerService;

    invoke-virtual {v4, v5}, Lcom/android/server/pm/PackageManagerService;->onNewUserCreated(I)V
    :try_end_d
    ...
    const-string/jumbo v6, "Creation failed due to createPartition error response"
    ...
    const-string/jumbo v7, "CreateKnoxContainer: Failed to mount file system. "
    ...
    const-string/jumbo v7, "CreateKnoxContainer: Failed to unmount file system. "
