...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Landroid/content/Context;Z)V
    ...
    invoke-static {v0, v15, v1}, Lcom/android/server/notification/NotificationRecord;->idDebugString(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget v15, v11, Landroid/app/Notification;->priority:I
    ...
    iget-boolean v15, v0, Lcom/android/server/notification/NotificationRecord;->mIsSeen:Z
    ...
    const-string/jumbo v15, "  groupKey="
    ...
    const-string/jumbo v15, "  contentIntent="

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget-object v15, v11, Landroid/app/Notification;->contentIntent:Landroid/app/PendingIntent;
    ...
    const-string/jumbo v15, "  deleteIntent="
    ...
    iget-object v15, v11, Landroid/app/Notification;->tickerText:Ljava/lang/CharSequence;
    ...
    const-string/jumbo v15, "  contentView="

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget-object v15, v11, Landroid/app/Notification;->contentView:Landroid/widget/RemoteViews;
    ...
    const-string/jumbo v15, "  defaults=0x%08x flags=0x%08x"
    ...
    const-string/jumbo v15, "  sound="

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget-object v15, v11, Landroid/app/Notification;->sound:Landroid/net/Uri;
    ...
    const-string/jumbo v15, "  audioStreamType="

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget v15, v11, Landroid/app/Notification;->audioStreamType:I
    ...
    const-string/jumbo v15, "  audioAttributes="

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget-object v15, v11, Landroid/app/Notification;->audioAttributes:Landroid/media/AudioAttributes;
    ...
    const-string/jumbo v15, "  color=0x%08x"
    ...
    iget-object v15, v11, Landroid/app/Notification;->vibrate:[J
    ...
    const-string/jumbo v15, "  led=0x%08x onMs=%d offMs=%d"
    ...
    invoke-virtual {v11, v12, v14}, Landroid/app/Notification;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    const-string/jumbo v15, "  parcelDataSize="

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget v15, v11, Landroid/app/Notification;->parcelDataSize:I
    ...
    iget-object v14, v11, Landroid/app/Notification;->actions:[Landroid/app/Notification$Action;
    ...
    const-string/jumbo v15, "%s    [%d] \"%s\" -> %s"
    ...
    :cond_4
    iget-object v14, v11, Landroid/app/Notification;->extras:Landroid/os/Bundle;
    ...
    iget-object v15, v0, Lcom/android/server/notification/NotificationRecord;->stats:Lcom/android/server/notification/NotificationUsageStats$SingleNotificationStats;

    invoke-virtual {v15}, Lcom/android/server/notification/NotificationUsageStats$SingleNotificationStats;->toString()Ljava/lang/String;
    ...
    const-string/jumbo v15, "  mContactAffinity="
    ...
    iget v15, v0, Lcom/android/server/notification/NotificationRecord;->mContactAffinity:F
    ...
    const-string/jumbo v15, "  mRecentlyIntrusive="
    ...
    iget-boolean v15, v0, Lcom/android/server/notification/NotificationRecord;->mRecentlyIntrusive:Z
    ...
    const-string/jumbo v15, "  mPackagePriority="
    ...
    iget v15, v0, Lcom/android/server/notification/NotificationRecord;->mPackagePriority:I
    ...
    const-string/jumbo v15, "  mPackageVisibility="
    ...
    iget v15, v0, Lcom/android/server/notification/NotificationRecord;->mPackageVisibility:I
    ...
    const-string/jumbo v15, "  mUserImportance="
    ...
    iget v15, v0, Lcom/android/server/notification/NotificationRecord;->mUserImportance:I

    invoke-static {v15}, Landroid/service/notification/NotificationListenerService$Ranking;->importanceToString(I)Ljava/lang/String;
    ...
    const-string/jumbo v15, "  mImportance="
    ...
    iget v15, v0, Lcom/android/server/notification/NotificationRecord;->mImportance:I
    ...
    const-string/jumbo v15, "  mImportanceExplanation="
    ...
    iget-object v15, v0, Lcom/android/server/notification/NotificationRecord;->mImportanceExplanation:Ljava/lang/CharSequence;
    ...
    const-string/jumbo v15, "  mIntercept="
    ...
    iget-boolean v15, v0, Lcom/android/server/notification/NotificationRecord;->mIntercept:Z
    ...
    const-string/jumbo v15, "  mGlobalSortKey="
    ...
    iget-object v15, v0, Lcom/android/server/notification/NotificationRecord;->mGlobalSortKey:Ljava/lang/String;
    ...
    const-string/jumbo v14, "yyyy-MM-dd\' \'HH:mm:ss.SSSZ"
    ...
    const-string/jumbo v15, "  mRankingTimeMs="
    ...
    const-string/jumbo v15, "  mCreationTimeMs="
    ...
    const-string/jumbo v15, "  mVisibleSinceMs="
    ...
    const-string/jumbo v15, "  mUpdateTimeMs="
    ...
    const-string/jumbo v15, "  mSuppressedVisualEffects= "
    ...
    iget v15, v0, Lcom/android/server/notification/NotificationRecord;->mSuppressedVisualEffects:I
