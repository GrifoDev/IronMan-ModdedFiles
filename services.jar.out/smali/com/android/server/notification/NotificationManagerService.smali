...
# instance fields
.field private final SUPPORT_SMART_GLOW:Z
...
.field private mSmartGlowObserver:Lcom/android/server/notification/NotificationManagerService$SmartGlowObserver;
...
.method static synthetic -get19(Lcom/android/server/notification/NotificationManagerService;)Landroid/util/AtomicFile;
    .locals 1
...
.method static synthetic -get20(Lcom/android/server/notification/NotificationManagerService;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -get21(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/NotificationManagerService$NotificationRankers;
    .locals 1
...
.method static synthetic -get22(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/RankingHandler;
    .locals 1
...
.method static synthetic -get24(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/NotificationManagerService$SettingsObserver;
    .locals 1
...
.method static synthetic -get25(Lcom/android/server/notification/NotificationManagerService;)Lcom/android/server/notification/SmartAlertController;
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v3, p0, Lcom/android/server/notification/NotificationManagerService;->SUPPORT_SMART_GLOW:Z
...
.method private clearSmartGlowLocked()V
    .locals 3
    ...
    iget-boolean v0, p0, Lcom/android/server/notification/NotificationManagerService;->mSmartGlowTurnedON:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->mSmartGlow:Lcom/android/server/lights/Light;

    const/4 v1, -0x1

    const/4 v2, 0x3

    invoke-virtual {v0, v1, v2}, Lcom/android/server/lights/Light;->setSmartGlowOff(II)V

    iget-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->mSmartLight:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, Lcom/android/server/notification/NotificationManagerService;->mSmartLightPackage:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/notification/NotificationManagerService;->mSmartGlowTurnedON:Z
...
.method private maybeClearAutobundleSummaryLocked(Landroid/service/notification/Adjustment;)V
    ...
    const-string/jumbo v1, "autogroup_needed"
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/notification/NotificationManagerService$9;-><init>(Lcom/android/server/notification/NotificationManagerService;Landroid/service/notification/Adjustment;)V
...
.method buzzBeepBlinkLocked(Lcom/android/server/notification/NotificationRecord;)V
    ...
    :goto_c
    invoke-static/range {v29 .. v29}, Lcom/android/server/notification/NotificationManagerService;->audioAttributesForNotification(Landroid/app/Notification;)Landroid/media/AudioAttributes;
    ...
    sget-object v10, Landroid/os/Vibrator$SemMagnitudeTypes;->TYPE_NOTIFICATION:Landroid/os/Vibrator$SemMagnitudeTypes;

    invoke-virtual/range {v4 .. v10}, Landroid/os/Vibrator;->semVibrate(ILjava/lang/String;[JILandroid/media/AudioAttributes;Landroid/os/Vibrator$SemMagnitudeTypes;)V
    :try_end_1
    ...
    invoke-virtual {v12, v4}, Landroid/view/accessibility/AccessibilityManager;->semOnLightNotification(Ljava/lang/String;)Z
...
.method cancelNotification(IILjava/lang/String;Ljava/lang/String;IIIZIILcom/android/server/notification/ManagedServices$ManagedServiceInfo;)V
    ...
    invoke-direct/range {v0 .. v12}, Lcom/android/server/notification/NotificationManagerService$12;-><init>(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;IILjava/lang/String;ILjava/lang/String;IIIIZ)V
...
.method removeEdgeNotificationInternal(IILjava/lang/String;ILandroid/os/Bundle;I)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/notification/NotificationManagerService$11;-><init>(Lcom/android/server/notification/NotificationManagerService;Ljava/lang/String;ILandroid/os/Bundle;I)V
