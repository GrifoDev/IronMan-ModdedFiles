...
.method private enforcePwdChangeIfNeededOnStart(I)V
    ...
    invoke-virtual {p0, v6, v1, p1}, Lcom/android/server/enterprise/security/PasswordPolicy;->setPwdChangeRequestedForUser(III)Z
    ...
    invoke-direct {p0, p1, v3, v4}, Lcom/android/server/enterprise/security/PasswordPolicy;->setPersonaAttribute(ILandroid/content/pm/PersonaAttribute;Z)Z
    ...
    const-string/jumbo v5, "Exception during enforcePwdChangeIfNeededOnStart on setPersonaAttribute: "
...
.method private unlockSdp(I)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/enterprise/security/PasswordPolicy$4;-><init>(Lcom/android/server/enterprise/security/PasswordPolicy;I)V
...
.method public isBiometricAuthenticationEnabledAsUser(II)Z
    ...
    const-string/jumbo v6, "isBiometricAuthenticationEnabled(IRIS): return true "
    ...
    const-string/jumbo v6, "isBiometricAuthenticationEnabled(FACE): return true "
