...
.method private _enableKioskMode(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;)V
    ...
    const-string/jumbo v15, "KioskModeService"

    const-string/jumbo v17, " _enableKioskMode"
    ...
    const-string/jumbo v17, "SEC_FLOATING_FEATURE_COMMON_SUPPORT_NFC_HW_KEYBOARD"

    move-object/from16 v0, v17

    invoke-virtual {v15, v0}, Lcom/samsung/android/feature/SemFloatingFeature;->getBoolean(Ljava/lang/String;)Z
    ...
    const-string/jumbo v17, " support HW keyboard "
    ...
    iget v15, v3, Landroid/content/res/Configuration;->semMobileKeyboardCovered:I
    ...
    const-string/jumbo v17, "Kiosk Mode - mobile keypad enabled::: return false"
    ...
    const-string/jumbo v17, "_enableKioskMode :: NoSuchFieldException"
    ...
    const-string/jumbo v17, "Kiosk Mode already enabled"
    ...
    invoke-direct {v0, v14, v15}, Lcom/android/server/enterprise/kioskmode/KioskModeService;->setKioskModeEnabledSystemUI(IZ)V
    ...
    const-string/jumbo v18, "Kiosk  result   "
    ...
    const-string/jumbo v17, "Kiosk Mode App not validated"
    ...
    invoke-direct {v0, v14, v4, v1}, Lcom/android/server/enterprise/kioskmode/KioskModeService;->setDefaultHomeScreen(ILjava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v17, "Cannot find HOME activity"
    ...
    invoke-direct {v0, v2, v15, v1, v4}, Lcom/android/server/enterprise/kioskmode/KioskModeService;->updateDB(IZLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v15, v0, v1, v14}, Landroid/app/IActivityManager;->getRecentTasks(III)Landroid/content/pm/ParceledListSlice;
    :try_end_5
