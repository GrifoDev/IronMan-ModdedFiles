...
.field private static final NPA_VERSION_STRING:Ljava/lang/String; = "1.1.65535"
...
.method static synthetic -get2(Lcom/android/server/enterprise/nap/NetworkAnalyticsService;)Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;
    .locals 1
...
.method static synthetic -wrap10(Lcom/android/server/enterprise/nap/NetworkAnalyticsService;Landroid/os/Bundle;)V
    .locals 0
...
.method static synthetic -wrap11(Lcom/android/server/enterprise/nap/NetworkAnalyticsService;IIILjava/lang/Object;)V
    .locals 0
...
.method static synthetic -wrap8(Lcom/android/server/enterprise/nap/NetworkAnalyticsService;Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->_unbindClient(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;)V

    return-void
.end method

.method static synthetic -wrap9(Lcom/android/server/enterprise/nap/NetworkAnalyticsService;I)V
    .locals 0
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mContext:Landroid/content/Context;

    iput-object v2, p0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;

    iput-object v2, p0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mHandlerThread:Landroid/os/HandlerThread;

    iput-object v2, p0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mHandler:Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NapHandler;
    ...
    invoke-direct {p0, v0, v3, v3, v2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->sendMessageToHandler(IIILjava/lang/Object;)V
...
.method private _bindAndActivate(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;II)V
    ...
    const-string/jumbo v14, "_bindAndActivate:PROFILE_ACTIVATED: Doing bind and activate."

    invoke-static {v13, v14}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_0
    new-instance v12, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v12, v0, v1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;-><init>(Lcom/android/server/enterprise/nap/NetworkAnalyticsService;Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;)V
    ...
    iput-object v13, v12, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;->countDownLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-direct {v0, v12}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->_bindToClient(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;)I
    ...
    const-string/jumbo v14, "_bindAndActivate:PROFILE_ACTIVATED: _bindToClient did not succeed"
    ...
    invoke-interface {v6, v13}, Lcom/samsung/android/knox/net/nap/IStatusCallback;->onCallComplete(I)V
    ...
    iget-object v13, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mConnectionManager:Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;

    move-object/from16 v0, p1

    iget-object v14, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->packageName:Ljava/lang/String;

    move-object/from16 v0, p1

    iget v15, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->userId:I
    ...
    iget-object v15, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->profileName:Ljava/lang/String;

    move/from16 v0, p2

    invoke-static {v15, v0}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->getTransformedVendorName(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v15

    invoke-virtual {v13, v14, v15}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->isProfilePresentForPackage(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v14, "_bindAndActivate:PROFILE_ACTIVATED: Honoring previous bind."
    ...
    invoke-virtual {v13, v14}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->getServiceConnectionForPackage(Ljava/lang/String;)Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;
    ...
    const-string/jumbo v15, "_bindAndActivate:PROFILE_ACTIVATED: _bindToClient & countdown: "
    ...
    invoke-virtual {v13, v14, v15}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->addProfileForPackage(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v13, v2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->_activateNAPClient(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;II)Z
    ...
    const-string/jumbo v14, "_bindAndActivate:PROFILE_ACTIVATED: Adding to data delivery"
    ...
    iget-object v13, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->profileName:Ljava/lang/String;

    move-object/from16 v0, p0

    move/from16 v1, p2

    invoke-direct {v0, v13, v12, v1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->_getDataDeliveryHelper(Ljava/lang/String;Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;I)Lcom/android/server/enterprise/nap/DataDeliveryHelper;

    move-result-object v9

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mDataDelivery:Lcom/android/server/enterprise/nap/NetworkAnalyticsDataDelivery;

    invoke-virtual {v13, v9}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDataDelivery;->addNAPDataRecipient(Lcom/android/server/enterprise/nap/DataDeliveryHelper;)V

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mDriver:Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;

    invoke-virtual {v13}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;->openCharDevice()I

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mDriver:Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;

    invoke-virtual {v13}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;->beginDataRecording()V
    ...
    const-string/jumbo v14, "NetworkAnalytics:Service"

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v15, "_bindAndActivate: callback return = "
    ...
    const-string/jumbo v14, "_bindAndActivate:PROFILE_ACTIVATED: bind and activate complete."
    ...
    :cond_e
    iget-object v13, v12, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$NetworkAnalyticsServiceConnection;->countDownLatch:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-virtual {v13, v0, v1, v14}, Ljava/util/concurrent/CountDownLatch;->await(JLjava/util/concurrent/TimeUnit;)Z
    ...
    const-string/jumbo v14, "_bindAndActivate:PROFILE_NOT_ACTIVATED: Doing deactivate and unbind."
    ...
    const-string/jumbo v14, "_bindAndActivate:PROFILE_NOT_ACTIVATED: deactivate did not succeed"
    ...
    invoke-virtual {v13, v14, v15}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->removeProfileForPackage(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v14, v0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->profileName:Ljava/lang/String;

    move/from16 v0, p2

    invoke-virtual {v13, v14, v0}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDataDelivery;->removeNAPDataRecipient(Ljava/lang/String;I)V
    ...
    invoke-virtual {v13, v14}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->isProfilePresentForPackage(Ljava/lang/String;)Z
    ...
    const-string/jumbo v14, "_bindAndActivate:PROFILE_NOT_ACTIVATED: Wont unbind."
    ...
    invoke-virtual {v13}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConnectionManager;->getActiveProfilesNumber()I
    ...
    const-string/jumbo v14, "_bindAndActivate:PROFILE_NOT_ACTIVATED: Will stop data recording."
    ...
    invoke-virtual {v13}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDriver;->endDataRecording()V
    ...
    const-string/jumbo v15, "_bindAndActivate:PROFILE_NOT_ACTIVATED: deactivate complete: "
    ...
    const-string/jumbo v14, "_bindAndActivate RemoteException"
    ...
    const-string/jumbo v14, "_bindAndActivate Exception"
...
.method private _cleanUpConnectionDetails(Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDataDelivery;->removeDataRecipientsForPackage(Ljava/lang/String;)V
...
.method private _packageAddedAction(Ljava/lang/String;)V
    ...
    const-string/jumbo v8, "_packageRemovedAction: ACTIVATING FOR PACKAGE ADDED."
...
.method private _packageRemovedAction(Ljava/lang/String;)V
    ...
    :cond_3
    :try_start_1
    invoke-static {p1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsDataDelivery;->updatePackageRemoved(Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
...
.method private _validateNAPClient(Ljava/lang/String;I)I
    .locals 5
...
.method private enforceNetworkAnalyticsPermission(Lcom/samsung/android/knox/ContextInfo;)Lcom/samsung/android/knox/ContextInfo;
    ...
    invoke-direct {p0}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->getEDM()Landroid/app/enterprise/EnterpriseDeviceManager;
    ...
    const-string/jumbo v3, "com.sec.enterprise.knox.KNOX_GENERIC_VPN"
...
.method private getEDM()Landroid/app/enterprise/EnterpriseDeviceManager;
    ...
    iget-object v0, p0, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;
...
.method private unregisterNetworkMonitorProfile(ILjava/lang/String;)I
    ...
    :cond_0
    :try_start_0
    const-string/jumbo v8, "NetworkAnalytics:Service"

    const-string/jumbo v9, "unregisterNetworkMonitorProfile: Invalid parameters"
    ...
    invoke-virtual {v8, p1, p2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->doesAdminOwnProfile(ILjava/lang/String;)I
    ...
    const-string/jumbo v10, "unregisterNetworkMonitorProfile: Profile "
    ...
    const-string/jumbo v10, "is absent or does not belong to adminUid "
    ...
    invoke-virtual {v8, p2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->getAllActiveKeysForProfile(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->getProfileforName(Ljava/lang/String;)Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;
    ...
    const-string/jumbo v10, "unregisterNetworkMonitorProfile config profile obj is null for profile: "
    ...
    invoke-direct {p0, v1, v8}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->activateProfile(Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;I)I
    ...
    const-string/jumbo v10, "unregisterNetworkMonitorProfile: deactivation failed for profile:"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    invoke-virtual {v1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->toString()Ljava/lang/String;
    ...
    iput-object v8, v3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->profileName:Ljava/lang/String;

    invoke-virtual {v1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->getPackageName()Ljava/lang/String;

    move-result-object v8

    iput-object v8, v3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->packageName:Ljava/lang/String;

    invoke-virtual {v1}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore$NAPConfigProfile;->getUserId()I

    move-result v8

    iput v8, v3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->userId:I

    const/4 v8, 0x0

    iput-object v8, v3, Lcom/android/server/enterprise/nap/NetworkAnalyticsService$AsyncHandlerObject;->callback:Lcom/samsung/android/knox/net/nap/IStatusCallback;
    ...
    invoke-direct {p0, v9, v10, v8, v3}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->sendMessageToHandler(IIILjava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v9, "unregisterNetworkMonitorProfile. Exception"
    ...
    const-string/jumbo v9, "Remove profile from database falied."
    ...
    const-string/jumbo v9, "The Knox NAP feature has been disabled"
    ...
    invoke-direct {p0, v8}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->setFeatureProperty(Z)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
...
.method private validateNAPClient(IIZ)I
    .locals 3
    ...
    :cond_0
    invoke-direct {p0, v0, p2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->_validateNAPClient(Ljava/lang/String;I)I
...
.method public getNPAVersion()Ljava/lang/String;
    ...
    const-string/jumbo v0, "1.1.65535"
...
.method public getProfiles(Lcom/samsung/android/knox/ContextInfo;)Ljava/util/List;
    ...
    const-string/jumbo v7, "getProfiles: NAP client caller cannot be validated. PackageName null"
    ...
    :cond_0
    invoke-direct {p0, v1, v0}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->_validateNAPClient(Ljava/lang/String;I)I
    ...
    const-string/jumbo v7, "getProfiles: Invalid app calling getProfiles."
    ...
    invoke-virtual {v6, v1, v0}, Lcom/android/server/enterprise/nap/NetworkAnalyticsConfigStore;->getClientProfiles(Ljava/lang/String;I)Ljava/util/List;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v7, "Get NVM client profiles. Exception"
...
.method public declared-synchronized handleNAPClientCall(Ljava/lang/String;Z)I
    ...
    :try_start_1
    invoke-direct {p0, v1, v0, p2}, Lcom/android/server/enterprise/nap/NetworkAnalyticsService;->validateNAPClient(IIZ)I
