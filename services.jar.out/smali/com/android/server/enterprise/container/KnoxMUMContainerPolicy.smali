...
.method private showSecureFolder(I)V
    ...
    const-string/jumbo v30, "device lock failed. trustmanager may be null."
...
.method public createContainer(Lcom/samsung/android/knox/ContextInfo;Lcom/samsung/android/knox/container/CreationParams;I)I
    ...
    check-cast v31, Lcom/samsung/android/knox/container/KnoxConfigurationType;
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/am/ActivityManagerService;->getPackageFromAppProcesses(I)Ljava/lang/String;
    ...
    :goto_2
    const v25, 0x10000060

    if-eqz v22, :cond_c

    const v25, 0x10400060
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/enterprise/container/KnoxMUMContainerPolicy$ProvisioningState;->start(Landroid/os/Bundle;)Z
    ...
    iget v5, v15, Landroid/content/pm/ApplicationInfo;->icon:I
...
.method public createContainerInternal(Lcom/samsung/android/knox/container/ContainerCreationParams;)I
    ...
    const-string/jumbo v10, "createContainerInternal"

    invoke-static {v10}, Lcom/android/server/enterprise/container/KnoxMUMContainerPolicy;->checkCallerPermissionFor(Ljava/lang/String;)I
    ...
    const-string/jumbo v11, "Enabling proxy admins."
    ...
    const-string/jumbo v12, " is not an active admin"
    ...
    const-string/jumbo v12, "Unable to find ResolveInfo for "
    ...
    invoke-direct {v4, v10}, Landroid/app/enterprise/EnterpriseDeviceManager;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v11, v10, v12}, Landroid/app/admin/ProxyDeviceAdminInfo;-><init>(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)V

    invoke-static {v2, v9}, Landroid/os/UserHandle;->getUid(II)I

    move-result v10

    invoke-virtual {v4, v11, v10, v0, v9}, Landroid/app/enterprise/EnterpriseDeviceManager;->addProxyAdmin(Landroid/app/admin/ProxyDeviceAdminInfo;ILandroid/content/ComponentName;I)V

    const/4 v10, 0x0

    invoke-virtual {v4, v0, v10, v2}, Landroid/app/enterprise/EnterpriseDeviceManager;->activateAdminForUser(Landroid/content/ComponentName;ZI)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    sget-object v10, Lcom/android/server/enterprise/container/KnoxMUMContainerPolicy;->TAG:Ljava/lang/String;

    const-string/jumbo v11, "Activating proxy admins done."
    ...
    const-string/jumbo v12, "createContainerInternal ::  uid : "
    ...
    invoke-direct {p0, v2, v9}, Lcom/android/server/enterprise/container/KnoxMUMContainerPolicy;->addContainerOwnerRelationship(II)Z
    ...
    const-string/jumbo v12, "createContainerInternal: failed to addContainerOwnerRelationship(uid: "
    ...
    const-string/jumbo v12, "Exception caught when adding proxy admin and activate admin for user: "
...
.method public getConfigurationTypeByName(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/am/ActivityManagerService;->getPackageFromAppProcesses(I)Ljava/lang/String;
...
.method public setSettingsOptionEnabled(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v9, "setSettingsOptionEnabled()"
    ...
    const-string/jumbo v9, "Error from setSettingsOptionEnabled(): option is null or empty"
    ...
    :try_start_0
    const-string/jumbo v8, "option_callerinfo"
    ...
    const-string/jumbo v10, "setSettingsOptionEnabled(): already row present ? "
    ...
    invoke-virtual {v8, v9, v1, v6}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->putValues(Ljava/lang/String;Landroid/content/ContentValues;Landroid/content/ContentValues;)Z
    ...
    const-string/jumbo v10, "setSettingsOptionEnabled failed : result = "
    ...
    const-string/jumbo v10, "setSettingsOptionEnabled() : enable = "
    ...
    invoke-virtual {v8, v9, v6}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->putValuesNoUpdate(Ljava/lang/String;Landroid/content/ContentValues;)Z
    ...
    invoke-virtual {v8, v7, v9}, Landroid/app/admin/DevicePolicyManager;->setCrossProfileCallerIdDisabled(Landroid/content/ComponentName;Z)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
