...
.field private mService:Lcom/android/server/pm/PersonaManagerService;
...
.method private getPersonaService()Lcom/android/server/pm/PersonaManagerService;
    ...
    iget-object v0, p0, Lcom/android/server/enterprise/adapterlayer/PersonaManagerAdapter;->mService:Lcom/android/server/pm/PersonaManagerService;
    ...
    iput-object v0, p0, Lcom/android/server/enterprise/adapterlayer/PersonaManagerAdapter;->mService:Lcom/android/server/pm/PersonaManagerService;
...
.method public getPersonaService(Z)Lcom/android/server/pm/PersonaManagerService;
    .locals 1
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/server/enterprise/adapterlayer/PersonaManagerAdapter;->getPersonaService()Lcom/android/server/pm/PersonaManagerService;
...
.method public isMyKnoxUser(I)Z
    ...
    sget-object v3, Landroid/content/pm/PersonaAttribute;->MY_KNOX:Landroid/content/pm/PersonaAttribute;

    invoke-virtual {v2, v3, p1}, Lcom/android/server/pm/PersonaManagerService;->isAttribute(Landroid/content/pm/PersonaAttribute;I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public registerKnoxModeChangeObserver(Landroid/content/pm/IKnoxModeChangeObserver;)Z
    ...
    invoke-virtual {v2, p1}, Lcom/samsung/android/knox/SemPersonaManager;->registerKnoxModeChangeObserver(Landroid/content/pm/IKnoxModeChangeObserver;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, "registerKnoxModeChangeObserver() failed"
...
.method public setIsFingerAsSupplement(IZ)Z
    ...
    invoke-virtual {v2, p1, p2}, Lcom/samsung/android/knox/SemPersonaManager;->setIsFingerAsSupplement(IZ)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v4, "setIsFingerAsSupplement() failed, personaId = "
