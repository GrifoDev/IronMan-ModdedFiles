...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/policy/LegacyGlobalActions$20$1;
    }
.end annotation
...
.method constructor <init>(Lcom/android/server/policy/LegacyGlobalActions;Lcom/android/server/policy/LegacyGlobalActions$Action;Landroid/view/View;Z)V
    ...
    iput-object v0, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->longPressHandler:Landroid/os/Handler;

    new-instance v0, Lcom/android/server/policy/LegacyGlobalActions$20$1;

    iget-object v1, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->val$action:Lcom/android/server/policy/LegacyGlobalActions$Action;

    iget-object v2, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->val$newItemView:Landroid/view/View;

    iget-boolean v3, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->val$isPort:Z

    invoke-direct {v0, p0, v1, v2, v3}, Lcom/android/server/policy/LegacyGlobalActions$20$1;-><init>(Lcom/android/server/policy/LegacyGlobalActions$20;Lcom/android/server/policy/LegacyGlobalActions$Action;Landroid/view/View;Z)V

    iput-object v0, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->mLongPressed:Ljava/lang/Runnable;
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->longPressHandler:Landroid/os/Handler;

    iget-object v3, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->mLongPressed:Ljava/lang/Runnable;
    ...
    iget-object v3, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->val$action:Lcom/android/server/policy/LegacyGlobalActions$Action;

    iget-object v4, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->val$newItemView:Landroid/view/View;

    iget-boolean v5, p0, Lcom/android/server/policy/LegacyGlobalActions$20;->val$isPort:Z
