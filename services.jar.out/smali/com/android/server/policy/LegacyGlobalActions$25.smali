...
.method constructor <init>(Lcom/android/server/policy/LegacyGlobalActions;IIIII)V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mIsFirstEmergency:Z

    iput-boolean v6, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mShowConditionalEmergency:Z

    iput-boolean v6, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mIsVT:Z

    iput-boolean v6, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mIsVoLTE:Z
...
.method public isEnabled()Z
    ...
    iget-object v0, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->this$0:Lcom/android/server/policy/LegacyGlobalActions;
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mIsVT:Z
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mIsVoLTE:Z

    iget-boolean v0, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mIsVT:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mIsVoLTE:Z
...
.method public onPress()V
    ...
    iget-object v1, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->this$0:Lcom/android/server/policy/LegacyGlobalActions;

    const-string/jumbo v2, "0002"

    const-string/jumbo v3, "EmergencyMode"

    invoke-static {v1, v2, v3}, Lcom/android/server/policy/LegacyGlobalActions;->-wrap32(Lcom/android/server/policy/LegacyGlobalActions;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->this$0:Lcom/android/server/policy/LegacyGlobalActions;

    invoke-static {v1}, Lcom/android/server/policy/LegacyGlobalActions;->-wrap5(Lcom/android/server/policy/LegacyGlobalActions;)Z
    ...
    invoke-static {v1, v2, v4}, Lcom/android/server/policy/LegacyGlobalActions;->-wrap39(Lcom/android/server/policy/LegacyGlobalActions;II)V
    ...
    iget-object v2, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->this$0:Lcom/android/server/policy/LegacyGlobalActions;
...
.method public showConditional()Z
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mIsFirstEmergency:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lcom/android/server/policy/LegacyGlobalActions$25;->showConditionalInternal()Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mShowConditionalEmergency:Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->mShowConditionalEmergency:Z
...
.method public showConditionalInternal()Z
    ...
    iget-object v6, p0, Lcom/android/server/policy/LegacyGlobalActions$25;->this$0:Lcom/android/server/policy/LegacyGlobalActions;
