...
.method public constructor <init>(Landroid/content/Context;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;Ljava/lang/Runnable;)V
    ...
    iput-object v2, p0, Lcom/android/server/policy/LegacyGlobalActions;->mColorHSV:[F

    iput-object v6, p0, Lcom/android/server/policy/LegacyGlobalActions;->mCurrentBG:Landroid/graphics/Bitmap;
...
.method private addCustomDialogItems(Landroid/graphics/drawable/BitmapDrawable;Ljava/lang/String;Landroid/content/Intent;I)Z
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/policy/LegacyGlobalActions$33;-><init>(Lcom/android/server/policy/LegacyGlobalActions;Landroid/graphics/drawable/Drawable;Ljava/lang/String;ILandroid/content/Intent;)V
...
.method private addUsersToMenu(Ljava/util/ArrayList;)V
    ...
    :goto_3
    new-instance v0, Lcom/android/server/policy/LegacyGlobalActions$38;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/policy/LegacyGlobalActions$38;-><init>(Lcom/android/server/policy/LegacyGlobalActions;ILandroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Landroid/content/pm/UserInfo;)V
...
.method private adjustBottomView()V
    ...
    new-instance v7, Lcom/android/server/policy/LegacyGlobalActions$43;

    invoke-direct {v7, p0}, Lcom/android/server/policy/LegacyGlobalActions$43;-><init>(Lcom/android/server/policy/LegacyGlobalActions;)V
...
.method private changeAirplaneModeSystemSetting(Z)V
    ...
    new-instance v2, Lcom/android/server/policy/LegacyGlobalActions$39;

    invoke-direct {v2, p0}, Lcom/android/server/policy/LegacyGlobalActions$39;-><init>(Lcom/android/server/policy/LegacyGlobalActions;)V
...
.method private confirmAction(Landroid/view/View;Lcom/android/server/policy/LegacyGlobalActions$Action;Z)V
    ...
    new-instance v5, Lcom/android/server/policy/LegacyGlobalActions$31;

    invoke-direct {v5, p0, p2}, Lcom/android/server/policy/LegacyGlobalActions$31;-><init>(Lcom/android/server/policy/LegacyGlobalActions;Lcom/android/server/policy/LegacyGlobalActions$Action;)V
...
.method private createDialog()Lcom/android/server/policy/LegacyGlobalActions$GlobalActionsDialog;
    ...
    new-instance v19, Lcom/android/server/policy/LegacyGlobalActions$15;
    ...
    new-instance v26, Lcom/android/server/policy/LegacyGlobalActions$17;
    ...
    new-instance v25, Lcom/android/server/policy/LegacyGlobalActions$18;

    move-object/from16 v0, v25

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/server/policy/LegacyGlobalActions$18;-><init>(Lcom/android/server/policy/LegacyGlobalActions;)V
...
.method private doAnimation(Landroid/view/View;FFFIZ)V
    ...
    sget-boolean v31, Lcom/android/server/policy/LegacyGlobalActions;->sIsNeedWhiteTheme:Z

    if-eqz v31, :cond_1

    if-eqz v9, :cond_1

    sget v31, Lcom/android/server/policy/LegacyGlobalActions;->sStatusViewColorWhite:I
    ...
    invoke-virtual/range {v31 .. v32}, Lcom/android/server/policy/globalactions/GlobalActionsFrameLayout;->findViewById(I)Landroid/view/View;
    ...
    sget-boolean v31, Lcom/android/server/policy/LegacyGlobalActions;->sSupportBlackWhiteTheme:Z
    ...
    new-instance v31, Lcom/android/server/policy/LegacyGlobalActions$32;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/policy/LegacyGlobalActions$32;-><init>(Lcom/android/server/policy/LegacyGlobalActions;Landroid/widget/FrameLayout;)V
...
.method private getLockdownAction()Lcom/android/server/policy/LegacyGlobalActions$Action;
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/android/server/policy/LegacyGlobalActions$37;-><init>(Lcom/android/server/policy/LegacyGlobalActions;II)V
...
.method private getPhoneStateListener(I)Landroid/telephony/PhoneStateListener;
    ...
    new-instance v0, Lcom/android/server/policy/LegacyGlobalActions$41;

    invoke-static {p1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/policy/LegacyGlobalActions$41;-><init>(Lcom/android/server/policy/LegacyGlobalActions;Ljava/lang/Integer;)V
...
.method private hideDecorView()V
    ...
    new-instance v3, Lcom/android/server/policy/LegacyGlobalActions$42;

    invoke-direct {v3, p0, v0}, Lcom/android/server/policy/LegacyGlobalActions$42;-><init>(Lcom/android/server/policy/LegacyGlobalActions;Landroid/view/View;)V
...
.method private initValueForShow()V
    ...
    sput-object v3, Lcom/android/server/policy/LegacyGlobalActions;->sResource:Landroid/content/res/Resources;

    sget-object v3, Lcom/android/server/policy/LegacyGlobalActions;->sResource:Landroid/content/res/Resources;
    ...
    sput v3, Lcom/android/server/policy/LegacyGlobalActions;->sCurrentDensity:I
    ...
    iget v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mDisplayWidth:I

    iget v4, p0, Lcom/android/server/policy/LegacyGlobalActions;->mDisplayHeight:I
    ...
    iget v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mDisplayHeight:I
    ...
    sput v3, Lcom/android/server/policy/LegacyGlobalActions;->sMessageViewColorWhite:I
    ...
    sput v3, Lcom/android/server/policy/LegacyGlobalActions;->sStatusViewColorWhite:I
    ...
    sput v3, Lcom/android/server/policy/LegacyGlobalActions;->sMessageViewTextSize:I
    ...
    sput v3, Lcom/android/server/policy/LegacyGlobalActions;->sStatusViewTextSize:I
    ...
    iput v2, p0, Lcom/android/server/policy/LegacyGlobalActions;->mIsSelectedItemTagForSecure:I

    :cond_0
    iput v2, p0, Lcom/android/server/policy/LegacyGlobalActions;->mIsSelectedItemTagForBixby:I

    const/4 v3, -0x1

    iput v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mSelectedItemNumbyBixby:I

    iput-boolean v2, p0, Lcom/android/server/policy/LegacyGlobalActions;->mIsConfirmPowerOffOnClearCover:Z

    iput-boolean v2, p0, Lcom/android/server/policy/LegacyGlobalActions;->mIsConfirmRestartOnClearCover:Z

    iput-boolean v2, p0, Lcom/android/server/policy/LegacyGlobalActions;->mIsInitWidthHeight:Z

    iget-object v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mCoverManager:Lcom/samsung/android/cover/CoverManager;

    invoke-virtual {v3}, Lcom/samsung/android/cover/CoverManager;->getCoverState()Lcom/samsung/android/cover/CoverState;

    move-result-object v3

    iput-object v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mCoverState:Lcom/samsung/android/cover/CoverState;

    sget-boolean v3, Lcom/android/server/policy/LegacyGlobalActions;->sSupportBlackWhiteTheme:Z

    if-eqz v3, :cond_5

    iget-object v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mContext:Landroid/content/Context;

    invoke-direct {p0, v3}, Lcom/android/server/policy/LegacyGlobalActions;->captureScreen(Landroid/content/Context;)Landroid/graphics/Bitmap;

    move-result-object v3

    iput-object v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mCurrentBG:Landroid/graphics/Bitmap;

    iget-object v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mCurrentBG:Landroid/graphics/Bitmap;
    ...
    invoke-static {v3, v0}, Lcom/android/server/policy/LegacyGlobalActions$ExtractColor;->getColorHSV(Landroid/graphics/Bitmap;Landroid/graphics/Rect;)[F

    move-result-object v3

    iput-object v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mColorHSV:[F

    iget-object v3, p0, Lcom/android/server/policy/LegacyGlobalActions;->mColorHSV:[F
    ...
    const-string/jumbo v5, "Whole Area Hue="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, p0, Lcom/android/server/policy/LegacyGlobalActions;->mColorHSV:[F
    ...
    :goto_2
    sput-boolean v1, Lcom/android/server/policy/LegacyGlobalActions;->sIsNeedWhiteTheme:Z

    :cond_1
    const v1, 0x1080a9f

    iput v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mPowerOffIconResId:I

    const v1, 0x1080a9e

    iput v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mConfirmPowerOffIconResId:I

    const v1, 0x1080aa3

    iput v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mRestartIconResId:I

    const v1, 0x1080aa2

    iput v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mConfirmRestartIconResId:I

    const v1, 0x1080a9a

    iput v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mEmergencyIconResId:I

    const v1, 0x1080aa5

    iput v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mSafeModeIconResId:I

    sget-object v1, Lcom/android/server/policy/LegacyGlobalActions;->PRODUCT_NAME:Ljava/lang/String;
    ...
    sput-boolean v1, Lcom/android/server/policy/LegacyGlobalActions;->sIsGraceR:Z
    ...
    iput-object v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mDesktopModeManager:Lcom/samsung/android/desktopmode/SemDesktopModeManager;

    new-instance v1, Lcom/android/server/policy/LegacyGlobalActions$14;

    invoke-direct {v1, p0}, Lcom/android/server/policy/LegacyGlobalActions$14;-><init>(Lcom/android/server/policy/LegacyGlobalActions;)V

    iput-object v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mDesktopModeEventListener:Lcom/samsung/android/desktopmode/SemDesktopModeManager$DesktopModeListener;

    iget-object v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mDesktopModeManager:Lcom/samsung/android/desktopmode/SemDesktopModeManager;

    iget-object v2, p0, Lcom/android/server/policy/LegacyGlobalActions;->mDesktopModeEventListener:Lcom/samsung/android/desktopmode/SemDesktopModeManager$DesktopModeListener;
    ...
    iget v4, p0, Lcom/android/server/policy/LegacyGlobalActions;->mDisplayWidth:I
...
.method private isSimReady()Z
    ...
    new-instance v5, Lcom/android/server/policy/LegacyGlobalActions$40;

    invoke-direct {v5, p0}, Lcom/android/server/policy/LegacyGlobalActions$40;-><init>(Lcom/android/server/policy/LegacyGlobalActions;)V
...
.method private makeActionsItemView(Lcom/android/server/policy/LegacyGlobalActions$Action;IZ)Landroid/view/View;
    ...
    new-instance v14, Lcom/android/server/policy/LegacyGlobalActions$21;
    ...
    invoke-direct {v14, v0, v1, v12, v2}, Lcom/android/server/policy/LegacyGlobalActions$21;-><init>(Lcom/android/server/policy/LegacyGlobalActions;Lcom/android/server/policy/LegacyGlobalActions$Action;Landroid/view/View;Z)V
...
.method private makeActionsItems()V
    ...
    new-instance v0, Lcom/android/server/policy/LegacyGlobalActions$25;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/policy/LegacyGlobalActions$25;-><init>(Lcom/android/server/policy/LegacyGlobalActions;IIIII)V
    ...
    new-instance v1, Lcom/android/server/policy/LegacyGlobalActions$27;

    invoke-direct {v1, p0}, Lcom/android/server/policy/LegacyGlobalActions$27;-><init>(Lcom/android/server/policy/LegacyGlobalActions;)V
    ...
    new-instance v0, Lcom/android/server/policy/LegacyGlobalActions$28;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/android/server/policy/LegacyGlobalActions$28;-><init>(Lcom/android/server/policy/LegacyGlobalActions;IIIIILandroid/app/AlertDialog;)V
    ...
    new-instance v1, Lcom/android/server/policy/LegacyGlobalActions$29;
    ...
    invoke-direct {v1, p0, v0, v2}, Lcom/android/server/policy/LegacyGlobalActions$29;-><init>(Lcom/android/server/policy/LegacyGlobalActions;II)V
    ...
    new-instance v0, Lcom/android/server/policy/LegacyGlobalActions$30;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/policy/LegacyGlobalActions$30;-><init>(Lcom/android/server/policy/LegacyGlobalActions;IIIII)V
