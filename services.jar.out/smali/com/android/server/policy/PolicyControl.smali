...
.field private static sConventionalRatioWinVisible:Z
...
.field private static sMobileKeyboardEnabled:Z
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/policy/PolicyControl;->mDisableImmersiveConfirmationPackages:[Ljava/lang/String;
...
.method public static disableImmersiveConfirmation(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, p0}, Lcom/android/server/policy/PolicyControl$Filter;->matches(Ljava/lang/String;)Z
    ...
    :cond_2
    sget-object v3, Lcom/android/server/policy/PolicyControl;->mDisableImmersiveConfirmationPackages:[Ljava/lang/String;
...
.method private static dump(Ljava/lang/String;Lcom/android/server/policy/PolicyControl$Filter;Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    const-string/jumbo v0, "sForceImmersiveMode="
    ...
    const-string/jumbo v0, "sInputMethodVisible="
    ...
    const-string/jumbo v0, "sMobileKeyboardEnabled="

    invoke-virtual {p3, v0}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    sget-boolean v0, Lcom/android/server/policy/PolicyControl;->sMobileKeyboardEnabled:Z
    ...
    const-string/jumbo v0, "sDesktopTaskBarEnabled="
...
.method public static getSystemUiVisibility(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;)I
    ...
    :cond_1
    sget-boolean v1, Lcom/android/server/policy/PolicyControl;->sForceFullScreen:Z
    ...
    invoke-static {p0}, Lcom/android/server/policy/PolicyControl;->needForceImmersiveMode(Landroid/view/WindowManagerPolicy$WindowState;)Z
...
.method public static isForceFullScreen()Z
    .locals 1

    sget-boolean v0, Lcom/android/server/policy/PolicyControl;->sForceFullScreen:Z
...
.method public static needForceImmersiveMode(Landroid/view/WindowManagerPolicy$WindowState;)Z
    .locals 2
    ...
    invoke-interface {v0}, Lcom/samsung/android/view/IWindowStateBridge;->needForceImmersiveMode()Z
...
.method public static setConventionalRatioWinVisible(Z)V
    .locals 0

    sput-boolean p0, Lcom/android/server/policy/PolicyControl;->sConventionalRatioWinVisible:Z
...
.method public static setMobileKeyboardState(Z)V
    .locals 0

    sput-boolean p0, Lcom/android/server/policy/PolicyControl;->sMobileKeyboardEnabled:Z
