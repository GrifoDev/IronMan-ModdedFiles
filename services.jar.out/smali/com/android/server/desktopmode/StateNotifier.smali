...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/android/server/desktopmode/StateNotifier;
...
.method notifyDesktopDockConnectionChanged(Z)V
    ...
    :try_start_1
    iget-object v4, v2, Lcom/android/server/desktopmode/StateNotifier$EventListenerInfo;->listener:Lcom/samsung/android/desktopmode/IDesktopModeCallback;

    invoke-interface {v4, p1}, Lcom/samsung/android/desktopmode/IDesktopModeCallback;->onDesktopDockConnectionChanged(Z)V
    :try_end_1
...
.method notifyDesktopModeChanged(Z)V
    ...
    invoke-interface {v4, p1}, Lcom/samsung/android/desktopmode/IDesktopModeCallback;->onDesktopModeChanged(Z)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
...
.method registerEventListener(Lcom/samsung/android/desktopmode/IDesktopModeCallback;Ljava/lang/String;)Z
    .locals 10
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/desktopmode/StateNotifier$EventListenerInfo;-><init>(Lcom/android/server/desktopmode/StateNotifier;Lcom/samsung/android/desktopmode/IDesktopModeCallback;Ljava/lang/String;II)V
...
.method unregisterEventListener(Lcom/samsung/android/desktopmode/IDesktopModeCallback;)Z
    .locals 5
    ...
    iget-object v1, v0, Lcom/android/server/desktopmode/StateNotifier$EventListenerInfo;->listener:Lcom/samsung/android/desktopmode/IDesktopModeCallback;

    invoke-interface {v1}, Lcom/samsung/android/desktopmode/IDesktopModeCallback;->asBinder()Landroid/os/IBinder;
