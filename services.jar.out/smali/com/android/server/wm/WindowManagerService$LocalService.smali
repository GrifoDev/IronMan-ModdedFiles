...
.method public waitForAllWindowsDrawn(Ljava/lang/Runnable;J)V
    ...
    invoke-interface {v11}, Lcom/android/server/policy/EdgeWindowPolicy;->isCocktailRotationAnimationNeeded()Z
    ...
    const-string/jumbo v13, "Wait for cocktail windows drawn"
    ...
    invoke-interface {v11}, Lcom/samsung/android/view/IWindowStateBridge;->getCoverMode()I
    ...
    invoke-interface {v11}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->getCoverStateSwitch()Z
    ...
    const-string/jumbo v14, "Wait to relayouting from CoverUI : win="
    ...
    const-string/jumbo v14, "waitForAllWindowsDrawn: win="
    ...
    invoke-virtual {v11, v13, v0, v1}, Lcom/android/server/wm/WindowManagerService$H;->sendEmptyMessageDelayed(IJ)Z
