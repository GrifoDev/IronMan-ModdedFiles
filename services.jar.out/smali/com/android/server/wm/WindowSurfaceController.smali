...
.method public constructor <init>(Landroid/view/SurfaceSession;Ljava/lang/String;IIIILcom/android/server/wm/WindowStateAnimator;)V
    ...
    iget-object v1, v10, Lcom/android/server/wm/AppWindowToken;->mTask:Lcom/android/server/wm/Task;
    ...
    iget-boolean v1, v1, Lcom/android/server/wm/Task;->mIsDexCompatEnabled:Z
    ...
    iget-object v8, v10, Lcom/android/server/wm/AppWindowToken;->mTask:Lcom/android/server/wm/Task;
    ...
    const-string/jumbo v3, "dexcompat background"
    ...
    iput-object v10, v1, Lcom/android/server/wm/Task;->mBackgroundToken:Lcom/android/server/wm/AppWindowToken;
    ...
    invoke-virtual {v1, v11}, Lcom/android/server/wm/DisplayContent;->getLogicalDisplayRect(Landroid/graphics/Rect;)V
    ...
    const-string/jumbo v3, "aspectRatio background"
    ...
    invoke-virtual {v1, v11}, Landroid/view/SurfaceControl;->setWindowCrop(Landroid/graphics/Rect;)V
...
.method private showSurface()Z
    ...
    :try_start_0
    iput-boolean v3, p0, Lcom/android/server/wm/WindowSurfaceController;->mSurfaceShown:Z
    ...
    iget-object v2, v3, Lcom/android/server/wm/WindowStateAnimator;->mWin:Lcom/android/server/wm/WindowState;
    ...
    iget-object v3, v1, Lcom/android/server/wm/Task;->mBackgroundControl:Landroid/view/SurfaceControl;
    ...
    const-string/jumbo v5, "WindowSurfaceController show mBackgroundControl taskId="
    ...
    const-string/jumbo v5, "Failure showing surface "
    ...
    invoke-virtual {v3, v4, v6}, Lcom/android/server/wm/WindowStateAnimator;->reclaimSomeSurfaceMemory(Ljava/lang/String;Z)V
...
.method shouldSaveSurface()Z
    ...
    instance-of v1, v1, Lcom/android/server/wm/WindowSurfaceController$SurfaceControlWithBackground;

    if-eqz v1, :cond_0

    iget-object v0, p0, Lcom/android/server/wm/WindowSurfaceController;->mSurfaceControl:Landroid/view/SurfaceControl;

    check-cast v0, Lcom/android/server/wm/WindowSurfaceController$SurfaceControlWithBackground;

    invoke-virtual {v0}, Lcom/android/server/wm/WindowSurfaceController$SurfaceControlWithBackground;->isOpaque()Z
