...
.method private stopDimmingIfNeeded(Lcom/android/server/wm/DimLayer$DimLayerUser;)V
    ...
    iget-object v3, p0, Lcom/android/server/wm/DimLayerController;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget-object v4, p0, Lcom/android/server/wm/DimLayerController;->mTmpBounds:Landroid/graphics/Rect;

    invoke-interface {v2, v3, v4}, Lcom/android/server/wm/IWindowManagerServiceBridge;->updateDimBounds(Lcom/android/server/wm/DisplayContent;Landroid/graphics/Rect;)Z
...
# virtual methods
.method adjustExitingDimLayer(Lcom/android/server/wm/DimLayer$DimLayerUser;Lcom/android/server/wm/WindowStateAnimator;)V
    .locals 4
    ...
    const-string/jumbo v3, "adjustExitingDimLayer trying to set exiting dim layer for: "
    ...
    const-string/jumbo v3, ", but no dim layer user found."
    ...
    const-string/jumbo v3, ", but dim layer user is invalid."
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/android/server/wm/DimLayerController;->isDimming()Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/wm/DimLayer;->getLayer(Z)I
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/wm/DimLayer;->setLayer(IZ)V
...
.method startDimmingIfNeeded(Lcom/android/server/wm/DimLayer$DimLayerUser;Lcom/android/server/wm/WindowStateAnimator;Z)V
    ...
    iput-boolean p3, v1, Lcom/android/server/wm/DimLayerController$DimLayerState;->dimAbove:Z
    ...
    const-string/jumbo v4, "startDimmingIfNeeded, dimLayerUser="
    ...
    const-string/jumbo v4, " newWinAnimator="
    ...
    const-string/jumbo v4, " state.animator="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, v1, Lcom/android/server/wm/DimLayerController$DimLayerState;->animator:Lcom/android/server/wm/WindowStateAnimator;
    ...
    iget-object v2, v1, Lcom/android/server/wm/DimLayerController$DimLayerState;->animator:Lcom/android/server/wm/WindowStateAnimator;
    ...
    :cond_1
    iput-object p2, v1, Lcom/android/server/wm/DimLayerController$DimLayerState;->animator:Lcom/android/server/wm/WindowStateAnimator;
    ...
    iget-object v2, p2, Lcom/android/server/wm/WindowStateAnimator;->mWin:Lcom/android/server/wm/WindowState;
    ...
    :goto_1
    iget-object v3, v1, Lcom/android/server/wm/DimLayerController$DimLayerState;->dimLayer:Lcom/android/server/wm/DimLayer;
...
.method updateDimLayer(Lcom/android/server/wm/DimLayer$DimLayerUser;)V
    ...
    invoke-interface {v4, v5, v6}, Lcom/android/server/wm/IWindowManagerServiceBridge;->updateDimBounds(Lcom/android/server/wm/DisplayContent;Landroid/graphics/Rect;)Z
