...
.field private mIsEnsured:Z

.field mLastAnimationBackgroundTarget:Ljava/lang/String;

.field private mMinimizeAmount:F

.field private mOrigDockStackBounds:Landroid/graphics/Rect;
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;I)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/TaskStack;->mOrigDockStackBounds:Landroid/graphics/Rect;

    iput-boolean v1, p0, Lcom/android/server/wm/TaskStack;->mIsEnsured:Z

    iput v1, p0, Lcom/android/server/wm/TaskStack;->mEnsureDockStackBottom:I

    iput v2, p0, Lcom/android/server/wm/TaskStack;->mPrevInputTargetStackId:I
...
.method private adjustForIME(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-interface/range {v26 .. v26}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->hasIMEHeightChanged()Z
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/wm/DockedStackDividerController;->getContentWidth()I
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/wm/DockedStackDividerController;->getContentWidthInactive()I
    ...
    invoke-interface/range {v26 .. v27}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getTopVisibleWindowLocked(I)Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/android/server/wm/DockedStackDividerController;->getMinimalSizeResizableTask(I)I
    ...
    invoke-interface/range {v26 .. v26}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isAutoResizeAnimating()Z
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/wm/WindowManagerService;->getImeFocusStackLocked()Lcom/android/server/wm/TaskStack;
    ...
    sget-boolean v26, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->ENSURE_DOCKED_VIEW_SUPPORT:Z
    ...
    iget-object v0, v0, Lcom/android/server/wm/TaskStack;->mOrigDockStackBounds:Landroid/graphics/Rect;
    ...
    iput v3, v0, Lcom/android/server/wm/TaskStack;->mEnsureDockStackBottom:I
...
.method private alignTasksToAdjustedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-boolean v11, v0, Lcom/android/server/wm/TaskStack;->mFullscreen:Z
    ...
    :cond_0
    sget-boolean v11, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->ENSURE_DOCKED_VIEW_SUPPORT:Z

    if-eqz v11, :cond_1

    move-object/from16 v0, p0

    iget-object v11, v0, Lcom/android/server/wm/TaskStack;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-boolean v11, v11, Lcom/android/server/wm/WindowManagerService;->mSnapWindowRunning:Z
    ...
    iget-object v11, v0, Lcom/android/server/wm/TaskStack;->mTasks:Ljava/util/ArrayList;
    ...
    invoke-virtual {v8, v11}, Lcom/android/server/wm/Task;->getBounds(Landroid/graphics/Rect;)V

    sget-boolean v11, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SNAP_WINDOW_SUPPORT:Z

    if-eqz v11, :cond_d

    invoke-virtual {v8}, Lcom/android/server/wm/Task;->isSnapWindowTarget()Z
    ...
    invoke-virtual {v11}, Lcom/android/server/wm/DockedStackDividerController;->isAdjustedForIme()Z

    move-result v5

    move-object/from16 v0, p0

    iget-boolean v11, v0, Lcom/android/server/wm/TaskStack;->mIsEnsured:Z

    if-eqz v11, :cond_7

    move-object/from16 v0, p0

    iget-boolean v11, v0, Lcom/android/server/wm/TaskStack;->mAdjustedForIme:Z

    if-nez v11, :cond_7

    move-object/from16 v0, p0

    iget v11, v0, Lcom/android/server/wm/TaskStack;->mAdjustImeAmount:F
    ...
    iget-object v12, v0, Lcom/android/server/wm/TaskStack;->mOrigDockStackBounds:Landroid/graphics/Rect;

    invoke-interface {v11, v12}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->requestAutoResizingIfNeededLocked(Landroid/graphics/Rect;)Z
    ...
    invoke-interface {v11, v12, v13}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->ensureDockedResize(Landroid/graphics/Rect;Z)V
    ...
    iput v11, v0, Lcom/android/server/wm/TaskStack;->mPrevInputTargetStackId:I

    const/4 v11, 0x0

    move-object/from16 v0, p0

    iput-boolean v11, v0, Lcom/android/server/wm/TaskStack;->mIsEnsured:Z
    ...
    iget-object v11, v0, Lcom/android/server/wm/TaskStack;->mOrigDockStackBounds:Landroid/graphics/Rect;
    ...
    iget-object v11, v11, Lcom/android/server/wm/WindowManagerService;->mInputMethodTarget:Lcom/android/server/wm/WindowState;
    ...
    iget-object v12, v0, Lcom/android/server/wm/TaskStack;->mBounds:Landroid/graphics/Rect;

    invoke-virtual {v11, v12}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    move-object/from16 v0, p0

    iput v3, v0, Lcom/android/server/wm/TaskStack;->mPrevInputTargetStackId:I
    ...
    iget-object v13, v0, Lcom/android/server/wm/TaskStack;->mBounds:Landroid/graphics/Rect;
    ...
    iget v0, v0, Lcom/android/server/wm/TaskStack;->mEnsureDockStackBottom:I
    ...
    iget v11, v0, Lcom/android/server/wm/TaskStack;->mPrevInputTargetStackId:I
    ...
    invoke-virtual {v8, v11, v12, v13}, Lcom/android/server/wm/Task;->resizeLocked(Landroid/graphics/Rect;Landroid/content/res/Configuration;Z)Z

    move-object/from16 v0, p0

    iget-object v11, v0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    invoke-virtual {v8, v11}, Lcom/android/server/wm/Task;->scrollLocked(Landroid/graphics/Rect;)Z
    ...
    iget-object v11, v0, Lcom/android/server/wm/TaskStack;->mFinalAdjustedImeBounds:Landroid/graphics/Rect;

    iget v11, v11, Landroid/graphics/Rect;->bottom:I

    move-object/from16 v0, p0

    iget v12, v0, Lcom/android/server/wm/TaskStack;->mStackBottomBeforeAdjustment:I
    ...
    invoke-virtual {v8, v6, v0, v11}, Lcom/android/server/wm/Task;->alignToAdjustedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;Z)V
    ...
    invoke-virtual {v8, v0, v1, v2}, Lcom/android/server/wm/Task;->alignToAdjustedBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;Z)V
...
.method private setBounds(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v6, v9}, Lcom/android/server/wm/DisplayContent;->getLogicalDisplayRect(Landroid/graphics/Rect;)V
    ...
    iget v3, v6, Landroid/view/DisplayInfo;->rotation:I
    ...
    :goto_0
    iput-boolean v6, p0, Lcom/android/server/wm/TaskStack;->mFullscreen:Z
    ...
    invoke-virtual {v6}, Lcom/android/server/wm/DockedStackDividerController;->isResizing()Z
    ...
    iget-object v6, v6, Lcom/android/server/wm/DisplayContent;->mDimLayerController:Lcom/android/server/wm/DimLayerController;

    invoke-virtual {v6, p0}, Lcom/android/server/wm/DimLayerController;->updateDimLayer(Lcom/android/server/wm/DimLayer$DimLayerUser;)V

    :cond_4
    iget-object v6, p0, Lcom/android/server/wm/TaskStack;->mAnimationBackgroundSurface:Lcom/android/server/wm/DimLayer;

    invoke-virtual {v6, p1}, Lcom/android/server/wm/DimLayer;->setBounds(Landroid/graphics/Rect;)V
    ...
    iput v4, p0, Lcom/android/server/wm/TaskStack;->mScreenHeight:I

    iput v5, p0, Lcom/android/server/wm/TaskStack;->mScreenWidth:I

    iget-object v6, p0, Lcom/android/server/wm/TaskStack;->mStackColorLayer:Lcom/android/server/wm/IMultiWindowStackColorLayer;

    if-eqz v6, :cond_6

    iget-object v6, p0, Lcom/android/server/wm/TaskStack;->mStackColorLayer:Lcom/android/server/wm/IMultiWindowStackColorLayer;

    invoke-interface {v6}, Lcom/android/server/wm/IMultiWindowStackColorLayer;->getBounds()Landroid/graphics/Rect;
    ...
    iget-object v6, p0, Lcom/android/server/wm/TaskStack;->mAdjustedBounds:Landroid/graphics/Rect;
    ...
    invoke-interface {v6, p1}, Lcom/android/server/wm/IMultiWindowStackColorLayer;->setBounds(Landroid/graphics/Rect;)V
    ...
    iget-object v8, p0, Lcom/android/server/wm/TaskStack;->mAdjustedBounds:Landroid/graphics/Rect;

    invoke-interface {v6, v8}, Lcom/android/server/wm/IMultiWindowStackColorLayer;->setSurfacePosition(Landroid/graphics/Rect;)V
...
.method private updateBoundsAfterConfigChange()Z
    ...
    iget v0, v0, Lcom/android/server/wm/TaskStack;->mRotation:I
    ...
    iget v0, v0, Lcom/android/server/wm/TaskStack;->mDensity:I
    ...
    invoke-interface/range {v17 .. v17}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isOrientationChanging()Z
    ...
    iget v0, v0, Lcom/android/server/wm/TaskStack;->mScreenHeight:I
    ...
    iget v0, v0, Lcom/android/server/wm/TaskStack;->mScreenWidth:I
    ...
    iget-boolean v0, v0, Lcom/android/server/wm/TaskStack;->mFullscreen:Z
    ...
    iget v11, v0, Lcom/android/server/wm/TaskStack;->mRotation:I
    ...
    iput v0, v1, Lcom/android/server/wm/TaskStack;->mPrevInputTargetStackId:I
    ...
    iput-boolean v0, v1, Lcom/android/server/wm/TaskStack;->mIsEnsured:Z
    ...
    iget-boolean v0, v0, Lcom/android/server/wm/TaskStack;->mAdjBoundsForSnapWindow:Z
    ...
    invoke-interface/range {v17 .. v18}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getMiddleTargetDockedBounds(Landroid/graphics/Rect;)V
    ...
    iget-object v0, v0, Lcom/android/server/wm/TaskStack;->mBoundsAfterRotation:Landroid/graphics/Rect;
    ...
    iput v5, v0, Lcom/android/server/wm/TaskStack;->mDensity:I
    ...
    iput-boolean v0, v1, Lcom/android/server/wm/TaskStack;->mAdjBoundsForSnapWindow:Z
    ...
    invoke-virtual {v0, v1, v7, v2}, Lcom/android/server/wm/DisplayContent;->rotateBounds(IILandroid/graphics/Rect;)V
    ...
    invoke-interface {v0, v11, v1, v7, v2}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->adjustBoundsForNaviBarForConfigChange(ILandroid/graphics/Rect;ILandroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/wm/WindowManagerService;->setDockedStackCreateStateLocked(ILandroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/server/wm/DisplayContent;->getDockedDividerController()Lcom/android/server/wm/DockedStackDividerController;

    move-result-object v17

    move-object/from16 v0, v17

    invoke-virtual {v0, v6}, Lcom/android/server/wm/DockedStackDividerController;->notifyDockSideChanged(I)V
    ...
    const-string/jumbo v19, "Display size can not be 0 ! Caller = "
    ...
    iget v15, v0, Lcom/android/server/wm/TaskStack;->mScreenWidth:I
    ...
    iput v0, v1, Lcom/android/server/wm/TaskStack;->mScreenWidth:I

    move-object/from16 v0, p0

    iput v15, v0, Lcom/android/server/wm/TaskStack;->mScreenHeight:I
    ...
    invoke-static {v10, v0, v1}, Lcom/android/server/wm/TaskStack;->getDockSideUnchecked(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I
    ...
    invoke-interface {v0, v1, v6, v12}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->adjustDockedStackBoundAfterDisplaySizeChange(Landroid/graphics/Rect;IF)V
...
.method attachDisplayContent(Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-static {v9, v0}, Lcom/samsung/android/bridge/multiscreen/MultiScreenManagerBridge;->getStackIdAdjustedToDisplayId(II)I
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    :cond_4
    iget-object v3, p0, Lcom/android/server/wm/TaskStack;->mLastAnimationBackgroundTarget:Ljava/lang/String;
    ...
    const-string/jumbo v4, "mLastAnimationBackgroundTarget="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/server/wm/TaskStack;->mLastAnimationBackgroundTarget:Ljava/lang/String;
...
.method isVisibleLocked(Z)Z
    ...
    iput-boolean v10, p0, Lcom/android/server/wm/TaskStack;->mHideColorLayerByKeyguard:Z
    ...
    invoke-interface {v5, v6, v8, v9}, Lcom/android/server/wm/IMultiWindowStackColorLayer;->show(FJ)V
...
.method resetAdjustedForIme(Z)V
    ...
    invoke-interface {v0, v3}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->setEnsureDockedResizing(Z)V
...
.method setAdjustedForIme(Lcom/android/server/wm/WindowState;Z)V
    ...
    invoke-interface {v2, v3}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->setEnsureDockedResizing(Z)V
...
.method setAnimationBackground(Lcom/android/server/wm/WindowStateAnimator;I)V
    ...
    iput-object v1, p0, Lcom/android/server/wm/TaskStack;->mLastAnimationBackgroundTarget:Ljava/lang/String;
...
.method setBounds(Landroid/graphics/Rect;Landroid/util/SparseArray;Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    invoke-interface {v4}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isAutoResizeAnimating()Z
...
.method updateAdjustedBounds(Z)V
    ...
    invoke-virtual {v4, v7, v5, v6}, Lcom/android/server/wm/WindowManagerService;->setResizeDimLayer(ZIF)V
    ...
    invoke-virtual {v4, v8, v5, v1}, Lcom/android/server/wm/WindowManagerService;->setResizeDimLayer(ZIF)V
