...
.field private static final FULLSCREEN_APP_IS_NOT_RESIZABLE:I = 0x15
...
.field private mIsResizableFullScreenApp:Z
...
.method static synthetic -get10(Lcom/android/server/wm/TaskPositioner;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/wm/TaskPositioner;->mIsResizableFullScreenApp:Z
...
.method static synthetic -get14(Lcom/android/server/wm/TaskPositioner;)I
    .locals 1
...
.method static synthetic -get15(Lcom/android/server/wm/TaskPositioner;)Z
    .locals 1
...
.method static synthetic -get16(Lcom/android/server/wm/TaskPositioner;)Z
    .locals 1
...
.method static synthetic -get18(Lcom/android/server/wm/TaskPositioner;)Lcom/android/server/wm/WindowManagerService;
    .locals 1
...
.method static synthetic -get19(Lcom/android/server/wm/TaskPositioner;)F
    .locals 1
...
.method static synthetic -get20(Lcom/android/server/wm/TaskPositioner;)F
    .locals 1
...
.method static synthetic -get21(Lcom/android/server/wm/TaskPositioner;)Lcom/android/server/wm/Task;
    .locals 1
...
.method static synthetic -get23(Lcom/android/server/wm/TaskPositioner;)Landroid/view/VelocityTracker;
    .locals 1
...
.method static synthetic -get24(Lcom/android/server/wm/TaskPositioner;)Landroid/graphics/Rect;
    .locals 1
...
.method static synthetic -get25(Lcom/android/server/wm/TaskPositioner;)Landroid/graphics/Rect;
    .locals 1
...
.method static synthetic -get4(Lcom/android/server/wm/TaskPositioner;)Landroid/graphics/Rect;
    .locals 1
...
.method static synthetic -set5(Lcom/android/server/wm/TaskPositioner;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/wm/TaskPositioner;->mIsResizableFullScreenApp:Z
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/TaskPositioner;->mIsResizableFullScreenApp:Z
...
.method private getDimSide(II)I
    ...
    invoke-interface {v2, v3, v4, v5, v1}, Landroid/view/WindowManagerPolicy;->getNonDecorInsetsLw(IIILandroid/graphics/Rect;)V
    ...
    iget v2, p0, Lcom/android/server/wm/TaskPositioner;->mSideMargin:I
...
.method private notifyMoveLocked(FF)Z
    ...
    const-string/jumbo v12, "notifyMoveLocked: {"
    ...
    iget v10, p0, Lcom/android/server/wm/TaskPositioner;->mStartDragX:F
    ...
    iget v10, p0, Lcom/android/server/wm/TaskPositioner;->mStartDragY:F
    ...
    iget-boolean v10, p0, Lcom/android/server/wm/TaskPositioner;->mFreeformResizing:Z
    ...
    invoke-interface {v10, v1}, Landroid/view/WindowManagerPolicy;->getContentRectLw(Landroid/graphics/Rect;)V

    iget v10, v1, Landroid/graphics/Rect;->bottom:I

    iget v11, p0, Lcom/android/server/wm/TaskPositioner;->mFreeformResizeBottomMargin:I
    ...
    invoke-virtual {v10, v5, v9, v8, v0}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual {v10, v11, v12}, Lcom/android/server/wm/Task;->setDragResizing(ZI)V
    ...
    iget-object v10, v10, Lcom/android/server/wm/Task;->mStack:Lcom/android/server/wm/TaskStack;

    iget-object v11, p0, Lcom/android/server/wm/TaskPositioner;->mTmpRect:Landroid/graphics/Rect;

    invoke-virtual {v10, v11}, Lcom/android/server/wm/TaskStack;->getDimBounds(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v10, v6, v7}, Landroid/graphics/Rect;->contains(II)Z
    ...
    invoke-static {p2, v10}, Ljava/lang/Math;->max(FF)F
    ...
    :cond_b
    invoke-direct {p0, v6, v7}, Lcom/android/server/wm/TaskPositioner;->updateWindowDragBounds(II)V

    sget-boolean v10, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SAMSUNG_MULTIWINDOW_DYNAMIC_ENABLED:Z

    if-eqz v10, :cond_e

    invoke-direct {p0, v6, v7}, Lcom/android/server/wm/TaskPositioner;->updateDimLayerVisibility(II)V
    ...
    iget v12, p0, Lcom/android/server/wm/TaskPositioner;->mMinVisibleHeight:I
    ...
    :cond_e
    invoke-direct {p0, v6}, Lcom/android/server/wm/TaskPositioner;->updateDimLayerVisibility(I)V
...
.method private showDimLayer()V
    ...
    invoke-interface {v6, v11}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getTopVisibleTaskLocked(I)Lcom/android/server/wm/Task;
...
.method register(Landroid/view/Display;)V
    ...
    sget v4, Lcom/samsung/android/framework/res/R$dimen;->multiwindow_divider_guideview_height:I

    invoke-virtual {v3, v4}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    iput v3, p0, Lcom/android/server/wm/TaskPositioner;->mDividerHeight:I
...
.method startDragLocked(Lcom/android/server/wm/WindowState;ZFF)V
    ...
    sget v11, Lcom/samsung/android/framework/res/R$dimen;->multiwindow_freeform_resizing_bottom_margin:I

    invoke-virtual {v10, v11}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v10

    iput v10, p0, Lcom/android/server/wm/TaskPositioner;->mFreeformResizeBottomMargin:I
