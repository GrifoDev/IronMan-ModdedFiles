...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/TaskStack;Landroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    iput-object p2, p0, Lcom/android/server/wm/WindowManagerService$11;->val$stack:Lcom/android/server/wm/TaskStack;

    iput-object p3, p0, Lcom/android/server/wm/WindowManagerService$11;->val$originalBounds:Landroid/graphics/Rect;

    iput-object p4, p0, Lcom/android/server/wm/WindowManagerService$11;->val$bounds:Landroid/graphics/Rect;

    iput p5, p0, Lcom/android/server/wm/WindowManagerService$11;->val$animationDuration:I
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/android/server/wm/WindowManagerService$11;->val$stack:Lcom/android/server/wm/TaskStack;

    iget-object v2, p0, Lcom/android/server/wm/WindowManagerService$11;->val$originalBounds:Landroid/graphics/Rect;

    iget-object v3, p0, Lcom/android/server/wm/WindowManagerService$11;->val$bounds:Landroid/graphics/Rect;

    iget v4, p0, Lcom/android/server/wm/WindowManagerService$11;->val$animationDuration:I
