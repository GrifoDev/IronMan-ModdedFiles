...
.field private mPendingImeAdjustAnimation:Z
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;)V
    ...
    iput-boolean v2, p0, Lcom/android/server/wm/DockedStackDividerController;->mPendingImeAdjustAnimation:Z
...
.method private animateForIme(J)Z
    ...
    iput-boolean v9, p0, Lcom/android/server/wm/DockedStackDividerController;->mAnimationStartDelayed:Z
...
.method private checkMinimizeChanged(Z)V
    ...
    invoke-interface {v10}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isFreeformDockingLeftOrBottom()Z
    ...
    iget-boolean v10, v10, Lcom/android/server/wm/WindowManagerService;->mIgnoreMinimizeDocked:Z
...
.method private clearImeAdjustAnimation()Z
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/TaskStack;->endImeAdjustAnimation()V
...
.method private setMinimizedDockedStack(ZZ)V
    ...
    iget-boolean v10, p0, Lcom/android/server/wm/DockedStackDividerController;->mMinimizedDock:Z
    ...
    invoke-virtual {v11, v6}, Lcom/android/server/wm/WindowList;->get(I)Ljava/lang/Object;
    ...
    iget-object v0, v9, Lcom/android/server/wm/Task;->mStack:Lcom/android/server/wm/TaskStack;
    ...
    iget v0, v9, Lcom/android/server/wm/Task;->mTaskId:I

    iput v0, p0, Lcom/android/server/wm/DockedStackDividerController;->mTopDockedTaskId:I

    iget-object v0, p0, Lcom/android/server/wm/DockedStackDividerController;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v1, v12, Lcom/android/server/wm/WindowState;->mAppToken:Lcom/android/server/wm/AppWindowToken;
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/wm/DockedStackDividerController;->startAdjustAnimation(FF)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/DockedStackDividerController;->setMinimizedDockedStack(Z)Z
    ...
    const-string/jumbo v2, "setMinimizedDockedStack: IME adjust changed due to minimizing, minimizedDock="
    ...
    const-string/jumbo v2, " minimizedChange="
...
.method private setMinimizedDockedStack(Z)Z
    ...
    :cond_0
    iput-boolean v6, p0, Lcom/android/server/wm/DockedStackDividerController;->mAnimatingForMinimizedDockedStack:Z
...
.method synthetic -com_android_server_wm_DockedStackDividerController_lambda$1(ZZ)V
    ...
    const-string/jumbo v3, "Skip notifyAdjustedForImeChanged"
...
.method dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    const-string/jumbo v1, "  mForceHide="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v1, p0, Lcom/android/server/wm/DockedStackDividerController;->mForceHide:Z
...
.method navigationBarWindowAdded()V
    .locals 0
...
.method notifyDockedStackExistsChanged(Z)V
    ...
    invoke-direct {p0, v7}, Lcom/android/server/wm/DockedStackDividerController;->setMinimizedDockedStack(Z)Z
...
.method setAdjustedForIme(ZZZLcom/android/server/wm/WindowState;IZ)V
    ...
    iget v1, p0, Lcom/android/server/wm/DockedStackDividerController;->mImeHeight:I
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/DockedStackDividerController;->mPendingImeAdjustAnimation:Z
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/DockedStackDividerController;->mPendingImeAdjustAnimation:Z
    ...
    :cond_3
    iget-boolean v1, p0, Lcom/android/server/wm/DockedStackDividerController;->mPendingImeAdjustAnimation:Z
...
.method setResizeDimLayer(ZIF)V
    ...
    iget-boolean v4, v4, Lcom/android/server/wm/WindowManagerService;->mSnapWindowRunning:Z
