...
.field mDockedActivityTransitionTarget:Z

.field mDockedTaskTargetFromRecents:Z

.field mIsAnimatingInTask:Z
...
.method public constructor <init>(Lcom/android/server/wm/AppWindowToken;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/AppWindowAnimator;->clipConventionalFrame:Z

    iput-boolean v1, p0, Lcom/android/server/wm/AppWindowAnimator;->mDockedActivityTransitionTarget:Z

    iput-boolean v1, p0, Lcom/android/server/wm/AppWindowAnimator;->mDockedTaskTargetFromRecents:Z

    iput-boolean v1, p0, Lcom/android/server/wm/AppWindowAnimator;->mIsAnimatingInTask:Z
...
.method public setAnimation(Landroid/view/animation/Animation;IIZI)V
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/Task;->isHomeTask()Z
    ...
    iget-boolean v3, v3, Lcom/android/server/wm/WindowManagerService;->mCoverDockedDivider:Z
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/Task;->inDockedWorkspace()Z

    move-result v3

    if-eqz v3, :cond_3

    iput-boolean v4, p0, Lcom/android/server/wm/AppWindowAnimator;->mDockedTaskTargetFromRecents:Z

    iget-object v3, p0, Lcom/android/server/wm/AppWindowAnimator;->mService:Lcom/android/server/wm/WindowManagerService;

    iput-boolean v4, v3, Lcom/android/server/wm/WindowManagerService;->mCoverDockedDivider:Z
    ...
    invoke-direct {p0, v3}, Lcom/android/server/wm/AppWindowAnimator;->updateAnimationDuration(Landroid/view/animation/Animation;)V
...
.method setNullAnimation()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/AppWindowAnimator;->mDimAnimation:Landroid/view/animation/Animation;

    iget-boolean v0, p0, Lcom/android/server/wm/AppWindowAnimator;->mDockedTaskTargetFromRecents:Z
    ...
    iput-boolean v1, v0, Lcom/android/server/wm/WindowManagerService;->mCoverDockedDivider:Z
...
.method stepAnimationLocked(JI)Z
    ...
    const-string/jumbo v7, "Starting animation in "
    ...
    invoke-virtual {v5, v6, v7}, Landroid/view/animation/Animation;->setStartTime(J)V
    ...
    const-string/jumbo v6, "AppWindowToken"

    const/16 v7, 0x8

    invoke-virtual {v5, p0, v7, v6, p3}, Lcom/android/server/wm/WindowAnimator;->setAppLayoutChanges(Lcom/android/server/wm/AppWindowAnimator;ILjava/lang/String;I)V
    ...
    invoke-virtual {v5, v9}, Lcom/android/server/wm/WindowManagerService;->moveInputMethodWindowsIfNeededLocked(Z)Z
    ...
    const-string/jumbo v7, "Animation done in "
    ...
    const-string/jumbo v7, ": reportedVisible="
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/wm/AppTransition;->notifyAppTransitionFinishedLocked(Landroid/os/IBinder;)V
    ...
    iget-boolean v5, v5, Lcom/android/server/wm/AppWindowToken;->mProcessKillAfterRemovingTask:Z

    if-eqz v5, :cond_d

    iget-object v5, p0, Lcom/android/server/wm/AppWindowAnimator;->mAppToken:Lcom/android/server/wm/AppWindowToken;

    iput-boolean v8, v5, Lcom/android/server/wm/AppWindowToken;->mProcessKillAfterRemovingTask:Z
    ...
    invoke-interface {v5, v6}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->notifyProcessKillByClosingFreeform(I)V
    ...
    invoke-interface {v5}, Lcom/android/server/am/IMultiScreenManagerServiceBridge;->clearTransition()V

    iget-object v5, p0, Lcom/android/server/wm/AppWindowAnimator;->mService:Lcom/android/server/wm/WindowManagerService;

    iput-boolean v8, v5, Lcom/android/server/wm/WindowManagerService;->mAnimateWallpaperWithTarget:Z

    iput-boolean v8, p0, Lcom/android/server/wm/AppWindowAnimator;->mIsAnimatingInTask:Z
...
.method updateLayers()V
    ...
    iget-object v6, v6, Lcom/android/server/wm/WindowManagerService;->mChangeRatioWindow:Lcom/android/server/wm/WindowState;
    ...
    iget-object v6, v6, Lcom/android/server/wm/WindowState;->mTargetAppToken:Lcom/android/server/wm/AppWindowToken;
    ...
    iget-object v7, v7, Lcom/android/server/wm/WindowManagerService;->mChangeRatioWindow:Lcom/android/server/wm/WindowState;

    iget v7, v7, Lcom/android/server/wm/WindowState;->mLayer:I

    add-int/2addr v7, v0

    iput v7, v6, Lcom/android/server/wm/WindowStateAnimator;->mAnimLayer:I
