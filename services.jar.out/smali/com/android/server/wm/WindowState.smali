...
.field static final NO_CHANGE_WHEN_DIVIDER_DIED:Z = true
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;ILcom/android/server/wm/DisplayContent;)V
    ...
    new-instance v22, Lcom/android/server/wm/WindowList;

    invoke-direct/range {v22 .. v22}, Lcom/android/server/wm/WindowList;-><init>()V
    ...
    invoke-direct/range {v22 .. v22}, Landroid/content/res/Configuration;-><init>()V
    ...
    iput-boolean v0, v1, Lcom/android/server/wm/WindowState;->mFrameSizeChanged:Z
    ...
    iput v0, v1, Lcom/android/server/wm/WindowState;->mLastVisibleLayoutRotation:I
    ...
    iput-object v0, v1, Lcom/android/server/wm/WindowState;->mTmpPointerRect:Landroid/graphics/Rect;
    ...
    iput-boolean v0, v1, Lcom/android/server/wm/WindowState;->mSeamlesslyRotated:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/wm/WindowState;->mForceResizeSurface:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/wm/WindowState;->mReadyToBeReused:Z
    ...
    new-instance v22, Lcom/android/server/wm/WindowState$1;
    ...
    sget-object v22, Lcom/android/server/wm/WindowState;->TAG:Ljava/lang/String;
    ...
    invoke-interface/range {v22 .. v23}, Landroid/view/WindowManagerPolicy;->windowTypeToLayerLw(I)I
    ...
    invoke-interface/range {v22 .. v23}, Landroid/view/WindowManagerPolicy;->subWindowTypeToLayerLw(I)I
    ...
    sget-boolean v22, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_ADD_REMOVE:Z
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/wm/Task;->inFreeformWorkspace()Z
    ...
    :cond_1c
    new-instance v22, Lcom/android/server/wm/WindowStateAnimator;
    ...
    new-instance v23, Lcom/android/server/input/InputWindowHandle;
    ...
    iget-object v0, v13, Lcom/android/server/wm/AppWindowToken;->allAppWindows:Lcom/android/server/wm/WindowList;
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/server/wm/Session;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/wm/Task;->isFullscreen()Z
    ...
    :cond_1f
    sget-object v22, Lcom/android/server/SamsungCoreServices$ServiceTag;->TAG_SAMSUNG_WINDOW_STATE:Lcom/android/server/SamsungCoreServices$ServiceTag;

    const/16 v23, 0x0

    invoke-static/range {v22 .. v23}, Lcom/android/server/SamsungCoreServices;->createService(Lcom/android/server/SamsungCoreServices$ServiceTag;Z)Ljava/lang/Object;

    move-result-object v22

    check-cast v22, Lcom/samsung/android/view/IWindowStateBridge;
    ...
    invoke-interface/range {v22 .. v22}, Lcom/samsung/android/view/IWindowStateBridge;->initPackageConfigurations()V
...
.method private shouldSaveSurface()Z
    ...
    invoke-virtual {v3}, Lcom/android/server/wm/WindowSurfaceController;->shouldSaveSurface()Z
...
.method applyDimLayerIfNeeded()V
    ...
    invoke-virtual {v7, v8, v9}, Lcom/android/server/wm/DimLayerController;->adjustExitingDimLayer(Lcom/android/server/wm/DimLayer$DimLayerUser;Lcom/android/server/wm/WindowStateAnimator;)V
...
.method applyGravityAndUpdateFrame(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/wm/Task;->getDisplayContent()Lcom/android/server/wm/DisplayContent;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/wm/Task;->inDockedWorkspace()Z

    move-result v1

    if-nez v1, :cond_6

    invoke-virtual/range {v16 .. v16}, Lcom/android/server/wm/Task;->isResizeableByDockedStack()Z
    ...
    invoke-virtual/range {v16 .. v17}, Lcom/android/server/wm/Task;->getDimBounds(Landroid/graphics/Rect;)V
    ...
    iget-boolean v1, v1, Lcom/android/server/wm/WindowManagerService;->mIsLayoutSizeAtLeastLarge:Z
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/Task;->getDisplayContent()Lcom/android/server/wm/DisplayContent;
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/Task;->isFloating()Z
    ...
    :goto_2
    sget-boolean v53, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SNAP_WINDOW_SUPPORT:Z
    ...
    invoke-interface/range {v53 .. v53}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->getStatusBarHeight()I
    ...
    invoke-interface/range {v53 .. v53}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->getNavigationBarHeight()I
    ...
    invoke-virtual/range {v53 .. v53}, Landroid/graphics/Rect;->setEmpty()V
    ...
    sget-boolean v53, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SAMSUNG_MULTIWINDOW_DYNAMIC_ENABLED:Z

    if-eqz v53, :cond_5

    sget-boolean v53, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_SLIDE_MODE:Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/wm/WindowState;->getSystemUiVisibility()I
    ...
    invoke-interface/range {v53 .. v53}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getDecorCaptionWindowHeight()I
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/Task;->isFullscreenDexCompatMode()Z
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/Task;->isResizeableByDockedStack()Z
    ...
    invoke-virtual/range {v53 .. v54}, Landroid/graphics/Rect;->contains(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual/range {v53 .. v53}, Lcom/android/server/wm/WindowStateAnimator;->getShown()Z
    ...
    invoke-virtual/range {v53 .. v57}, Landroid/graphics/Rect;->set(IIII)V
    ...
    invoke-virtual/range {v53 .. v53}, Lcom/android/server/wm/DisplayContent;->getDockedDividerController()Lcom/android/server/wm/DockedStackDividerController;
    ...
    invoke-virtual/range {v53 .. v54}, Lcom/android/server/wm/DockedStackDividerController;->positionDockedStackedDivider(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v53 .. v54}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v53 .. v54}, Landroid/graphics/Rect;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static/range {v57 .. v58}, Ljava/lang/Math;->max(II)I
    ...
    invoke-virtual/range {v53 .. v55}, Landroid/graphics/Rect;->offset(II)V
    ...
    invoke-virtual/range {v53 .. v54}, Landroid/graphics/Rect;->scale(F)V
    ...
    invoke-static/range {v53 .. v54}, Lcom/android/server/DssController$Tools;->applyScaleToCompatFrame(Landroid/graphics/Rect;F)V
    ...
    invoke-interface/range {v53 .. v53}, Lcom/samsung/android/view/IWindowStateBridge;->configureReducedScreenSpec()V
    ...
    iget v0, v14, Landroid/view/DisplayInfo;->logicalWidth:I

    move/from16 v54, v0

    iget v0, v14, Landroid/view/DisplayInfo;->logicalHeight:I
    ...
    :cond_19
    sget-boolean v53, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_LAYOUT:Z

    if-nez v53, :cond_1a

    sget-boolean v53, Lcom/android/server/wm/WindowManagerService;->localLOGV:Z

    if-eqz v53, :cond_1b

    :cond_1a
    sget-object v53, Lcom/android/server/wm/WindowState;->TAG:Ljava/lang/String;

    new-instance v54, Ljava/lang/StringBuilder;

    invoke-direct/range {v54 .. v54}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v55, "Resolving (mRequestedWidth="
    ...
    const-string/jumbo v55, ", mRequestedheight="
    ...
    const-string/jumbo v55, ") to"

    invoke-virtual/range {v54 .. v55}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v54

    const-string/jumbo v55, " (pw="
    ...
    invoke-virtual/range {v55 .. v55}, Landroid/graphics/Rect;->toShortString()Ljava/lang/String;
    ...
    invoke-static/range {v53 .. v54}, Landroid/util/Slog;->v(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v1, v11, v2, v3}, Landroid/graphics/Rect;->inset(IIII)V
    ...
    invoke-virtual/range {v53 .. v53}, Ljava/util/ArrayDeque;->isEmpty()Z
    ...
    invoke-interface/range {v53 .. v53}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getCurrentInputMethodClient()Lcom/android/server/wm/WindowState;
    ...
    invoke-interface/range {v53 .. v54}, Landroid/view/WindowManagerPolicy;->getContentRectLw(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v53 .. v53}, Lcom/android/server/wm/AppWindowToken;->findMainWindow()Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v53 .. v53}, Lcom/android/server/wm/DockedStackDividerController;->isResizing()Z
    ...
    invoke-virtual/range {v54 .. v54}, Lcom/android/server/wm/DisplayContent;->getDisplayInfo()Landroid/view/DisplayInfo;
    ...
    invoke-virtual/range {v55 .. v55}, Lcom/android/server/wm/DisplayContent;->getDisplayInfo()Landroid/view/DisplayInfo;
    ...
    invoke-virtual/range {v53 .. v53}, Ljava/util/ArrayDeque;->peek()Ljava/lang/Object;
    ...
    invoke-virtual/range {v53 .. v53}, Lcom/android/server/wm/WindowState;->getTask()Lcom/android/server/wm/Task;
    ...
    check-cast v49, Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v49 .. v49}, Lcom/android/server/wm/WindowState;->isDisplayedLw()Z
    ...
    invoke-virtual/range {v47 .. v47}, Lcom/android/server/wm/Task;->inDockedWorkspace()Z
    ...
    invoke-virtual/range {v54 .. v54}, Landroid/graphics/Rect;->height()I
    ...
    invoke-virtual/range {v53 .. v53}, Lcom/android/server/wm/DisplayContent;->getDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    invoke-static {v0, v15}, Lcom/android/server/wm/WindowManagerService;->dipToPixel(ILandroid/util/DisplayMetrics;)I
    ...
    invoke-virtual {v0, v1, v10, v2, v3}, Landroid/graphics/Rect;->inset(IIII)V
    ...
    invoke-virtual/range {v53 .. v54}, Lcom/android/server/wm/DockedStackDividerController;->positionDividerPanel(Landroid/graphics/Rect;)V
    ...
    invoke-static/range {v55 .. v56}, Ljava/lang/Math;->min(II)I
    ...
    invoke-virtual/range {v53 .. v54}, Lcom/android/server/wm/DisplayContent;->getLogicalDisplayRect(Landroid/graphics/Rect;)V
...
.method destroyOrSaveSurface()V
    ...
    iput-boolean v7, p0, Lcom/android/server/wm/WindowState;->mSurfaceSaved:Z

    iget-boolean v7, p0, Lcom/android/server/wm/WindowState;->mSurfaceSaved:Z
    ...
    :cond_0
    sget-object v7, Lcom/android/server/wm/WindowState;->TAG:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "Saving surface: "
    ...
    :cond_1
    iget-object v7, p0, Lcom/android/server/wm/WindowState;->mSession:Lcom/android/server/wm/Session;

    iget-object v8, p0, Lcom/android/server/wm/WindowState;->mClient:Landroid/view/IWindow;

    sget-object v9, Lcom/android/server/wm/WindowState;->sEmptyRegion:Landroid/graphics/Region;

    invoke-virtual {v7, v8, v9}, Lcom/android/server/wm/Session;->setTransparentRegion(Landroid/view/IWindow;Landroid/graphics/Region;)V

    iget-object v7, p0, Lcom/android/server/wm/WindowState;->mWinAnimator:Lcom/android/server/wm/WindowStateAnimator;

    const-string/jumbo v8, "saved surface"
    ...
    invoke-virtual {p0, v10}, Lcom/android/server/wm/WindowState;->setHasSurface(Z)V
    ...
    invoke-virtual {v7}, Lcom/android/server/wm/WindowSurfaceController;->disconnectInTransaction()V

    :cond_2
    iput-boolean v10, p0, Lcom/android/server/wm/WindowState;->mAnimatingWithSavedSurface:Z
    ...
    iget-object v7, v0, Lcom/android/server/wm/Task;->mBackgroundControl:Landroid/view/SurfaceControl;
    ...
    iget-object v7, v6, Lcom/android/server/wm/AppWindowToken;->allAppWindows:Lcom/android/server/wm/WindowList;
    ...
    invoke-virtual {v4}, Lcom/android/server/wm/WindowState;->isInMultiWindowMode()Z
    ...
    invoke-virtual {v7}, Lcom/android/server/wm/WindowStateAnimator;->destroySurfaceLocked()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/Task;->clearBackgroundSurfaceAnimation()V

    iget-object v7, v0, Lcom/android/server/wm/Task;->mBackgroundControl:Landroid/view/SurfaceControl;

    invoke-virtual {v7}, Landroid/view/SurfaceControl;->hide()V
    ...
    const-string/jumbo v9, "WindowState : hide mBackgroundControl taskId="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, v0, Lcom/android/server/wm/Task;->mTaskId:I
...
.method getTouchableRegion(Landroid/graphics/Region;ILandroid/graphics/Region;)I
    ...
    iget-object v10, p0, Lcom/android/server/wm/WindowState;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    invoke-interface {v3, v9}, Lcom/android/server/wm/DimLayer$DimLayerUser;->getDimBounds(Landroid/graphics/Rect;)V
    ...
    :cond_1
    :goto_2
    iget-object v9, p0, Lcom/android/server/wm/WindowState;->mTmpPointerRect:Landroid/graphics/Rect;
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/DisplayContent;->getDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    invoke-static {v9, v4}, Lcom/android/server/wm/WindowManagerService;->dipToPixel(ILandroid/util/DisplayMetrics;)I
    ...
    invoke-interface {v9, p0}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->isFreeformAlphaModeLocked(Lcom/android/server/wm/WindowState;)Z
    ...
    iget-object v11, v11, Lcom/android/server/wm/AppWindowToken;->mTask:Lcom/android/server/wm/Task;

    iget v11, v11, Lcom/android/server/wm/Task;->mCurrentCaptionHieght:I
    ...
    iget-object v9, v9, Lcom/android/server/wm/AppWindowToken;->mTask:Lcom/android/server/wm/Task;

    iget-boolean v9, v9, Lcom/android/server/wm/Task;->mIsDexCompatEnabled:Z
    ...
    invoke-virtual {p1, v9}, Landroid/graphics/Region;->set(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {p3, v9}, Landroid/graphics/Region;->set(Landroid/graphics/Rect;)Z

    if-nez v6, :cond_6

    invoke-virtual {p0, p3}, Lcom/android/server/wm/WindowState;->cropRegionToStackBoundsIfNeeded(Landroid/graphics/Region;)V
    ...
    invoke-interface {v11}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->getDecorCaptionWindowHeight()I
    ...
    invoke-virtual {p0, v9}, Lcom/android/server/wm/WindowState;->getVisibleBounds(Landroid/graphics/Rect;)V
    ...
    iget-object v10, p0, Lcom/android/server/wm/WindowState;->mContainingFrame:Landroid/graphics/Rect;
    ...
    invoke-interface {v9, p1}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->exludedRegionFromFreefomTasksLocked(Landroid/graphics/Region;)V
    :try_end_0
...
.method isBackgroundTargetWindowLocked()Z
    .locals 10
    ...
    iget-object v6, v4, Lcom/android/server/wm/AppWindowToken;->allAppWindows:Lcom/android/server/wm/WindowList;
    ...
    iget-object v6, v2, Lcom/android/server/wm/WindowState;->mCompatFrame:Landroid/graphics/Rect;
...
.method maybeRemoveReplacedWindow()Z
    .locals 11
    ...
    iget-boolean v7, v4, Lcom/android/server/wm/WindowState;->mWillReplaceWindow:Z

    if-eqz v7, :cond_5

    iget-object v7, v4, Lcom/android/server/wm/WindowState;->mReplacingWindow:Lcom/android/server/wm/WindowState;
    ...
    invoke-direct {p0, v4}, Lcom/android/server/wm/WindowState;->setReplacingWindowForChild(Lcom/android/server/wm/WindowState;)V
    ...
    const-string/jumbo v9, "Removing replaced window: "
    ...
    invoke-virtual {v4}, Lcom/android/server/wm/WindowState;->transferDimToReplacement()V

    :cond_3
    iput-boolean v6, v4, Lcom/android/server/wm/WindowState;->mWillReplaceWindow:Z

    iget-boolean v0, v4, Lcom/android/server/wm/WindowState;->mAnimateReplacingWindow:Z

    iput-boolean v6, v4, Lcom/android/server/wm/WindowState;->mAnimateReplacingWindow:Z

    iput-boolean v6, v4, Lcom/android/server/wm/WindowState;->mReplacingRemoveRequested:Z

    iput-object v10, v4, Lcom/android/server/wm/WindowState;->mReplacingWindow:Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {v7, v4, v8, v6}, Lcom/android/server/wm/WindowManagerService;->removeWindowInnerLocked(Lcom/android/server/wm/WindowState;ZZ)V
    ...
    const-string/jumbo v8, "maybeRemoveReplacedWindow: setting mFocusMayChange true"
    ...
    iput-boolean v8, v7, Lcom/android/server/wm/WindowManagerService;->mFocusMayChange:Z
...
.method removeLocked()V
    ...
    invoke-interface {v1, p0}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->appWindowDrawnLocked(Lcom/android/server/wm/WindowState;)V

    return-void

    :cond_2
    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mDexCompatBaseWindow:Lcom/android/server/wm/WindowState;

    if-eqz v1, :cond_3

    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mDexCompatBaseWindow:Lcom/android/server/wm/WindowState;

    iput-object v2, v1, Lcom/android/server/wm/WindowState;->mDecorCaptionWindow:Lcom/android/server/wm/WindowState;

    goto :goto_0

    :cond_3
    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mDecorCaptionWindow:Lcom/android/server/wm/WindowState;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mDecorCaptionWindow:Lcom/android/server/wm/WindowState;

    iput-object v2, v1, Lcom/android/server/wm/WindowState;->mDexCompatBaseWindow:Lcom/android/server/wm/WindowState;
...
.method public reportFocusChangedSerialized(ZZ)V
    ...
    iget-object v4, p0, Lcom/android/server/wm/WindowState;->mDecorCaptionWindow:Lcom/android/server/wm/WindowState;
...
.method translateToWindowX(F)F
    ...
    invoke-interface {v2}, Lcom/samsung/android/view/IWindowStateBridge;->getReducedScreenScaleSpecLocked()Landroid/view/MagnificationSpec;
...
.method public whichCustomStartingAnimationLw()I
    .locals 5
