...
.method createAspectScaledThumbnailEnterExitAnimationLocked(IIIILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZIZILandroid/graphics/Rect;)Landroid/view/animation/Animation;
    ...
    sub-float v25, v27, v38

    sub-float v26, v28, v39
...
.method loadAnimation(Landroid/view/WindowManager$LayoutParams;IZIILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZIZILandroid/graphics/Rect;Lcom/android/server/wm/AppWindowToken;)Landroid/view/animation/Animation;
    ...
    check-cast v32, Lcom/android/server/wm/Task;
    ...
    iget v7, v0, Lcom/android/server/wm/Task;->mFreeformTransit:I
    ...
    iget-object v15, v7, Lcom/android/server/wm/WindowManagerService;->mMultiWindowManagerInternal:Lcom/android/server/wm/IMultiWindowManagerInternalBridge;

    move-object/from16 v0, v32

    iget v0, v0, Lcom/android/server/wm/Task;->mFreeformTransit:I
    ...
    invoke-interface/range {v15 .. v22}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->loadMultiWindowTransitionLocked(IILandroid/graphics/Rect;Landroid/graphics/Rect;ZZLandroid/view/animation/Animation;)Landroid/view/animation/Animation;
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/server/wm/Task;->isFullscreen()Z
    ...
    invoke-interface {v7, v0, v1, v2}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->shouldKeepVisibleAnimation(Lcom/android/server/wm/AppWindowToken;ZZ)Z
    ...
    invoke-interface {v7}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->createKeepVisibleAnimation()Landroid/view/animation/Animation;
    ...
    invoke-interface {v7, v0}, Lcom/android/server/am/IMultiScreenManagerServiceBridge;->createVirtualScreenAnimation(Z)Landroid/view/animation/Animation;
    ...
    const-string/jumbo v25, "ANIM_THUMBNAIL_SCALE_UP"
    ...
    :cond_21
    const-string/jumbo v25, "ANIM_THUMBNAIL_SCALE_DOWN"
    ...
    const-string/jumbo v25, "ANIM_THUMBNAIL_ASPECT_SCALE_UP"
    ...
    :cond_25
    const-string/jumbo v25, "ANIM_THUMBNAIL_ASPECT_SCALE_DOWN"
    ...
    invoke-interface/range {v7 .. v14}, Lcom/android/server/wm/IWindowManagerServiceBridge;->createSamsungCustomAnimationLocked(Landroid/graphics/Rect;IIZLandroid/graphics/Rect;Landroid/graphics/Rect;Z)Landroid/view/animation/Animation;
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/server/wm/Task;->isResizeableByDockedStack()Z
    ...
    invoke-interface/range {v7 .. v14}, Lcom/android/server/wm/IMultiWindowManagerInternalBridge;->loadMultiWindowTransitionLocked(IILandroid/graphics/Rect;Landroid/graphics/Rect;ZZLandroid/view/animation/Animation;)Landroid/view/animation/Animation;
    ...
    invoke-virtual {v7}, Lcom/android/server/wm/Task;->inFreeformWorkspace()Z
...
.method shouldApplyAspectFrameClip()Z
    .locals 4
