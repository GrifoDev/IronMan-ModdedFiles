...
.field private static final CALENDAR_URI:Landroid/net/Uri;
...
.field private mLastSyncedCalendarColor:J
...
.method static synthetic -get4(Lcom/android/server/bridge/operations/DbObserver;)J
    .locals 2

    iget-wide v0, p0, Lcom/android/server/bridge/operations/DbObserver;->mLastSyncedCalendarColor:J
...
.method static synthetic -set2(Lcom/android/server/bridge/operations/DbObserver;J)J
    .locals 1

    iput-wide p1, p0, Lcom/android/server/bridge/operations/DbObserver;->mLastSyncedCalendarColor:J
...
.method static synthetic -set5(Lcom/android/server/bridge/operations/DbObserver;I)I
    .locals 0
...
.method static synthetic -wrap6(Lcom/android/server/bridge/operations/DbObserver;)J
    .locals 2

    invoke-direct {p0}, Lcom/android/server/bridge/operations/DbObserver;->getCalendarColor()J
...
.method static synthetic -wrap7(Lcom/android/server/bridge/operations/DbObserver;)V
    .locals 0
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/bridge/operations/DbObserver;->CALENDAR_URI:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-wide v4, p0, Lcom/android/server/bridge/operations/DbObserver;->mLastSyncedCalendarColor:J
...
.method private getCalendarColor()J
    .locals 11
    ...
    const-string/jumbo v3, "account_type = ?  AND account_name = ? AND deleted = ?"
    ...
    const-string/jumbo v0, "My calendar"
    ...
    const-string/jumbo v0, "calendar_color"
    ...
    sget-object v1, Lcom/android/server/bridge/operations/DbObserver;->CALENDAR_URI:Landroid/net/Uri;
...
.method private registerCalendarObserver()V
    ...
    iput-wide v0, p0, Lcom/android/server/bridge/operations/DbObserver;->mLastSyncedCalendarColor:J
    ...
    const-string/jumbo v2, "registerCalendarObserver, Calendar_last_synced_timeStamp : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-wide v2, p0, Lcom/android/server/bridge/operations/DbObserver;->mCalendar_last_synced_timeStamp:J

    invoke-virtual {v1, v2, v3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " , No_of_events_last_synced : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/server/bridge/operations/DbObserver;->mNo_of_events_last_synced:I

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " , No_of_tasks_last_synced : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/server/bridge/operations/DbObserver;->mNo_of_tasks_last_synced:I

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, " ,mLastSyncedCalendarColor : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-wide v2, p0, Lcom/android/server/bridge/operations/DbObserver;->mLastSyncedCalendarColor:J
...
.method private registerContactObserver()V
    ...
    const-string/jumbo v2, " , No_of_contact_last_synced : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/server/bridge/operations/DbObserver;->mNo_of_contact_last_synced:I
