...
.method private changeExtSdPath(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/server/bridge/BridgeProxy;->-get1(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
...
.method private copyListToFile(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-static/range {v16 .. v16}, Lcom/android/server/bridge/BridgeProxy;->-get1(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
...
.method private isContainerStateIsValid(I)Z
    ...
    invoke-static {v1}, Lcom/android/server/bridge/BridgeProxy;->-get1(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
...
.method public cancelCopyChunks(J)V
    ...
    invoke-static {v0}, Lcom/android/server/bridge/BridgeProxy;->-get1(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
...
.method public copyFiles(ILjava/util/List;ILjava/util/List;Lcom/samsung/android/knox/SemIRCPCallback;)J
    ...
    invoke-static {v4}, Lcom/android/server/bridge/BridgeProxy;->-get1(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
...
.method isMoveFilesAllowed(II)Z
    ...
    invoke-static {v9}, Lcom/android/server/bridge/BridgeProxy;->-get1(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
...
.method public moveFile(ILjava/lang/String;ILjava/lang/String;)I
    ...
    invoke-virtual {v1, p3}, Lcom/samsung/android/knox/SemPersonaManager;->getPersonaInfo(I)Lcom/samsung/android/knox/SemPersonaInfo;
    ...
    invoke-virtual {v2, p3, v3}, Lcom/samsung/android/knox/SemPersonaManager;->getContainerName(ILandroid/content/Context;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/android/server/bridge/BridgeProxy;->-set2(Lcom/android/server/bridge/BridgeProxy;Ljava/lang/String;)Ljava/lang/String;
...
.method public moveFiles(ILjava/util/List;ILjava/util/List;Lcom/samsung/android/knox/SemIRCPCallback;)J
    ...
    invoke-static {v5}, Lcom/android/server/bridge/BridgeProxy;->-get1(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/server/bridge/BridgeProxy;->-get13(Lcom/android/server/bridge/BridgeProxy;)Lcom/samsung/android/knox/SemPersonaManager;

    move-result-object v5

    invoke-virtual {v5, p3}, Lcom/samsung/android/knox/SemPersonaManager;->getPersonaInfo(I)Lcom/samsung/android/knox/SemPersonaInfo;
    ...
    invoke-static {v7}, Lcom/android/server/bridge/BridgeProxy;->-get5(Lcom/android/server/bridge/BridgeProxy;)Landroid/content/Context;

    move-result-object v7

    invoke-virtual {v6, p3, v7}, Lcom/samsung/android/knox/SemPersonaManager;->getContainerName(ILandroid/content/Context;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v5, v6}, Lcom/android/server/bridge/BridgeProxy;->-set2(Lcom/android/server/bridge/BridgeProxy;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/server/bridge/BridgeProxy;->-get2(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
...
.method public moveFilesForApp(ILjava/util/List;Ljava/util/List;)J
    ...
    invoke-static/range {v26 .. v26}, Lcom/android/server/bridge/BridgeProxy;->-get1(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
...
.method public moveFilesForAppEx(ILjava/util/List;Ljava/util/List;I)J
    ...
    invoke-static/range {v31 .. v31}, Lcom/android/server/bridge/BridgeProxy;->-get1(Lcom/android/server/bridge/BridgeProxy;)Ljava/lang/String;
