...
.method public constructor <init>(Landroid/content/Context;JLandroid/os/IBinder;Landroid/hardware/fingerprint/IFingerprintServiceReceiver;IIZLjava/lang/String;Landroid/os/Bundle;)V
    ...
    iput-object v1, p0, Lcom/android/server/fingerprint/ClientMonitor;->mOwnerOfFpms:Ljava/lang/String;
    ...
    const-string/jumbo v3, "ClientMonitor: packageName = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/fingerprint/ClientMonitor;->mOwnerOfFpms:Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/fingerprint/FingerprintService;->isKeyguard(Ljava/lang/String;)Z

    move-result v1

    if-eqz v1, :cond_3

    iput-boolean v4, p0, Lcom/android/server/fingerprint/ClientMonitor;->mIsKeyguard:Z

    iget v1, p0, Lcom/android/server/fingerprint/ClientMonitor;->mPrivilegedAttr:I
    ...
    iput-boolean v4, p0, Lcom/android/server/fingerprint/ClientMonitor;->mIsFromPassCompat:Z
    ...
    const-string/jumbo v3, "ClientMonitor: Owner = "
    ...
    iget v3, p0, Lcom/android/server/fingerprint/ClientMonitor;->mTargetUserId:I
    ...
    iget v3, p0, Lcom/android/server/fingerprint/ClientMonitor;->mGroupId:I
    ...
    const-string/jumbo v3, "ClientMonitor: privilegedAttr = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/fingerprint/ClientMonitor;->mPrivilegedAttr:I
    ...
    iput-boolean v4, p0, Lcom/android/server/fingerprint/ClientMonitor;->mIsFromFPMS:Z
...
.method public onAcquired(I)Z
    ...
    iget-boolean v6, p0, Lcom/android/server/fingerprint/ClientMonitor;->mIsFromPassCompat:Z
...
.method public setNavigationBar(Z)V
    ...
    const-string/jumbo v1, "android.intent.action.CHANGE_FINGERPRINT_NAVIGATION_BAR"
    ...
    :cond_1
    const-string/jumbo v1, "android.intent.action.CHANGE_FINGERPRINT_NAVIGATION_BAR_DONE"
