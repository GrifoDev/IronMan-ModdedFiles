...
.field private static final LISTENER_BLACKLIST_CHANGED:I = 0xd
...
.field private mFusedProviderEnable:Z
...
.field private mGpsProviderEnable:Z
...
.field private final mListenerBlacklist:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet",
            "<",
...
.field private mNetworkProviderEnable:Z
...
.method static synthetic -get3(Lcom/android/server/LocationManagerService;)Ljava/util/HashSet;
    .locals 1

    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mListenerBlacklist:Ljava/util/HashSet;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v3, p0, Lcom/android/server/LocationManagerService;->mGpsProviderEnable:Z

    iput-boolean v3, p0, Lcom/android/server/LocationManagerService;->mNetworkProviderEnable:Z

    iput-boolean v3, p0, Lcom/android/server/LocationManagerService;->mFusedProviderEnable:Z

    iput-boolean v2, p0, Lcom/android/server/LocationManagerService;->mBound:Z

    iput v2, p0, Lcom/android/server/LocationManagerService;->mNsFlpFeatureLevel:I
    ...
    iput-object v1, p0, Lcom/android/server/LocationManagerService;->mListenerBlacklist:Ljava/util/HashSet;
...
.method private applyRequirementsLocked(Ljava/lang/String;)V
    ...
    iget v9, p0, Lcom/android/server/LocationManagerService;->mNsFlpFeatureLevel:I
    ...
    iget-boolean v9, p0, Lcom/android/server/LocationManagerService;->mGpsProviderEnable:Z
    ...
    iget-boolean v9, p0, Lcom/android/server/LocationManagerService;->mNetworkProviderEnable:Z
    ...
    iget-boolean v9, p0, Lcom/android/server/LocationManagerService;->mFusedProviderEnable:Z
...
.method private loadProvidersLocked_nlpHub()V
    ...
    const-string/jumbo v4, "CscFeature_GPS_SupportTencentNLP"
...
.method private removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    const-string/jumbo v5, ", receiver.mPid = "
    ...
    iget v5, v0, Lcom/android/server/LocationManagerService$Receiver;->mPid:I

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string/jumbo v5, ", receiver.mUid = "
    ...
    iget v5, v0, Lcom/android/server/LocationManagerService$Receiver;->mUid:I
    ...
    iget v11, v0, Lcom/android/server/LocationManagerService$Receiver;->mPid:I

    move-object/from16 v0, p1

    iget v12, v0, Lcom/android/server/LocationManagerService$Receiver;->mUid:I
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v25, "Permission Denial: can\'t dump LocationManagerService from from pid="
    ...
    :try_start_0
    const-string/jumbo v24, "Current Location Manager state:"
    ...
    const-string/jumbo v24, "  Location Listeners:"
    ...
    :cond_1
    :try_start_1
    const-string/jumbo v24, "  Active Records by Provider:"
    ...
    :cond_3
    const-string/jumbo v24, "  Historical Records by Provider:"
    ...
    check-cast v23, Lcom/android/server/location/LocationRequestStatistics$PackageStatistics;
    ...
    :cond_4
    const-string/jumbo v24, "  Last Known Locations:"
    ...
    :cond_5
    const-string/jumbo v24, "  Last Known Locations Coarse Intervals:"
    ...
    :cond_6
    const-string/jumbo v24, "  Location Request List:"
    ...
    const-string/jumbo v26, "  Current Fused Location Requests["
    ...
    const-string/jumbo v26, "  Current Gps Location Requests["
    ...
    const-string/jumbo v26, "  Current Network Location Requests["
    ...
    :cond_9
    const-string/jumbo v24, "  Location Provider Binding History:"
    ...
    const-string/jumbo v24, "  Enabled Providers:"
    ...
    const-string/jumbo v24, "  Disabled Providers:"
    ...
    const-string/jumbo v24, "  Mock Providers:"
    ...
    check-cast v24, Lcom/android/server/location/MockProvider;
    ...
    const-string/jumbo v26, " Internal State"
    ...
    instance-of v0, v15, Lcom/android/server/location/LocationProviderProxy;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/location/LocationProviderProxy;->getConnectedPackageName()Ljava/lang/String;
    ...
    invoke-interface {v15, v0, v1, v2}, Lcom/android/server/location/LocationProviderInterface;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public isProviderRunning(Ljava/lang/String;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/LocationManagerService;->mGpsProviderEnable:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/LocationManagerService;->mNetworkProviderEnable:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/LocationManagerService;->mFusedProviderEnable:Z
...
.method public pauseProvider(Ljava/lang/String;)V
    ...
    iput-boolean v6, p0, Lcom/android/server/LocationManagerService;->mGpsProviderEnable:Z
    ...
    iput-boolean v6, p0, Lcom/android/server/LocationManagerService;->mNetworkProviderEnable:Z
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    iput-boolean v6, p0, Lcom/android/server/LocationManagerService;->mFusedProviderEnable:Z
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/LocationManagerService;->mListenerBlacklist:Ljava/util/HashSet;
    ...
    const-string/jumbo v7, "listener size is over threshold, so return : "
...
.method public setDataFromNSFLP(ILandroid/os/Bundle;)V
    ...
    const-string/jumbo v3, "setDataFromNSFLP, type = "
    ...
    invoke-direct {p0, v1, p2}, Lcom/android/server/LocationManagerService;->addToLocationList(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    const-string/jumbo v3, "size of mLocBlacklist = "
    ...
    const-string/jumbo v3, "size of mLocWhitelist = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/LocationManagerService;->mLocWhitelist:Ljava/util/HashMap;
    ...
    const-string/jumbo v2, "setData for ListenerBlacklist"

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v1, "listenerblacklist"

    invoke-virtual {p2, v1}, Landroid/os/Bundle;->getStringArrayList(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v0

    iget-object v1, p0, Lcom/android/server/LocationManagerService;->mListenerBlacklist:Ljava/util/HashSet;
    ...
    const-string/jumbo v3, "size of mListenerBlacklist = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/LocationManagerService;->mListenerBlacklist:Ljava/util/HashSet;
...
.method public systemRunning()V
    ...
    iget v5, p0, Lcom/android/server/LocationManagerService;->mNsFlpFeatureLevel:I
