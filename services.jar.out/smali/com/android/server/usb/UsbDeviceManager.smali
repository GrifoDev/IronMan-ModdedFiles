...
.method static synthetic -get12(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/utils/sysfwutil/DexObserver;
    .locals 1
...
.method static synthetic -get13(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/usb/UsbAlsaManager;Lcom/android/server/utils/sysfwutil/DexObserver;)V
    .locals 7
    ...
    const-string/jumbo v5, "Support dual_role"
    ...
    iput-object p3, p0, Lcom/android/server/usb/UsbDeviceManager;->mDexObserver:Lcom/android/server/utils/sysfwutil/DexObserver;
    ...
    const-string/jumbo v5, "Don\'t support dual_role"
...
.method private isUsbWet()Z
    ...
    const-string/jumbo v5, "USB_WATER_PATH is not exist!"
    ...
    const-string/jumbo v5, "isUsbWet : read \'"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string/jumbo v5, "/sys/class/sec/ccic/water"
    ...
    const-string/jumbo v5, "Error reading at isUsbWet()"
...
.method private showWaterUsbNoti(Z)V
    ...
    iget-object v7, p0, Lcom/android/server/usb/UsbDeviceManager;->KERNEL_LOG_PREFIX:Ljava/lang/String;
    ...
    invoke-static {v5, v6}, Lcom/android/server/utils/sysfwutil/Slog;->v(Ljava/lang/String;Ljava/lang/String;)I
...
.method private updateTimeStamp(Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "failed to write to "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string/jumbo v7, "/data/log/wet_detect.log"
...
.method public bootCompleted()V
    ...
    invoke-static {v0, v3}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->-wrap7(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;Z)V
    ...
    const-string/jumbo v2, "This usb is wet in booting time."
