...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    const-string/jumbo v3, "com.samsung.server.BatteryService.action.SEC_BATTERY_WATER_IN_CONNECTOR"
...
.method private handleSecBatteryEvent(Landroid/content/Intent;)V
    ...
    invoke-static {v3}, Lcom/android/server/usb/UsbDeviceManager;->-get13(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDeviceManager$UsbHandler;

    move-result-object v3

    const/16 v4, 0xc

    invoke-virtual {v3, v4, v7}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->sendMessage(IZ)V

    iput-boolean v7, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mTAPowerConnected:Z
    ...
    invoke-virtual {v3, v8, v7}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->sendMessage(IZ)V
    ...
    invoke-virtual {v3, v8, v6}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->sendMessage(IZ)V
...
.method private updateUsbNotification(Z)V
    ...
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager;->-get12(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/utils/sysfwutil/DexObserver;
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->-get14(Lcom/android/server/usb/UsbDeviceManager;)Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->-get0(Lcom/android/server/usb/UsbDeviceManager;)Ljava/lang/String;
    ...
    invoke-static {v7, v8}, Landroid/hardware/usb/UsbManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->-get6(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    const-string/jumbo v9, "MSG_UPDATE_STATE : salesCode is null"
    ...
    invoke-direct {p0, v13, v9}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->setEnabledFunctions(Ljava/lang/String;Z)V
    ...
    const-string/jumbo v9, "MSG_UPDATE_STATE : mDualRoleState is not none."
    ...
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->-get19(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    :cond_f
    invoke-direct {p0, v3, v9}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->setEnabledFunctions(Ljava/lang/String;Z)V
    ...
    const-string/jumbo v9, "handleMessage -> MSG_SET_USB_DATA_UNLOCKED"
    ...
    const-string/jumbo v9, "handleMessage -> MSG_SYSTEM_READY"
    ...
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->-wrap1(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    invoke-virtual {v7, v9}, Lcom/android/server/usb/UsbSettingsManager;->accessoryAttached(Landroid/hardware/usb/UsbAccessory;)V

    :cond_10
    iget-object v7, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->this$0:Lcom/android/server/usb/UsbDeviceManager;

    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->-get11(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
    ...
    invoke-static {v9}, Lcom/android/server/usb/UsbDeviceManager;->-get3(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->-get13(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
    ...
    invoke-static {v10}, Lcom/android/server/usb/UsbDeviceManager;->-get6(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    const-string/jumbo v9, "MSG_POWER_STATE : SETUP WIZARD SCREEN. So skip about showing USB BLOCK Popup"
    ...
    const-string/jumbo v10, "USB Blocked by UPSM while Device is not in CHARGING MODE. And Not on SetupWizard. Show TOAST"
    ...
    const-string/jumbo v9, "MSG_POWER_STATE : BLOCK by UPSM -> DISCONNECTED"
    ...
    const-string/jumbo v9, "USB Blocked by SIM while Device is not in CHARGING MODE. Show Dialog"
    ...
    const-string/jumbo v9, "MSG_POWER_STATE : BLOCK by SIM -> DISCONNECTED"
    ...
    const-string/jumbo v10, "USB Blocked by BOTH while Device is not in CHARGING MODE. And Not on SetupWizard. Show Dialog and TOAST"
    ...
    const-string/jumbo v9, "MSG_POWER_STATE : BLOCK by BOTH -> DISCONNECTED"
    ...
    invoke-static {v11}, Lcom/android/server/usb/UsbDeviceManager;->-get14(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    invoke-static {v8}, Lcom/android/server/usb/UsbDeviceManager;->-get10(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Context;
    ...
    const-string/jumbo v11, "Emergency Mode Toast"
    ...
    const-string/jumbo v9, "Don\'t show Toast"
    ...
    const-string/jumbo v10, "MSG_TA_POWER_STATE : DEVICE is CHARGING via TA"
    ...
    const-string/jumbo v9, "MSG_TA_POWER_STATE : SETUP WIZARD SCREEN. So skip about showing USB BLOCK Popup"
...
.method public updateHostState(Landroid/hardware/usb/UsbPort;Landroid/hardware/usb/UsbPortStatus;)V
    ...
    const-string/jumbo v8, "updateHostState()  hostConnected : "
    ...
    const-string/jumbo v8, ", isPowerSource : "
    ...
    const-string/jumbo v8, ", mDualRoleState : "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v8, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mDualRoleState:I
    ...
    invoke-static {v4, v7}, Lcom/android/server/utils/sysfwutil/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v8, "updateHostState "
    ...
    invoke-static {v4, v7}, Lcom/android/server/utils/sysfwutil/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
