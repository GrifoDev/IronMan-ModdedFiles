...
.method private handleNotifyAppWidgetViewDataChanged(Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;Lcom/android/internal/appwidget/IAppWidgetHost;IIJ)V
    ...
    invoke-direct {v4, v0}, Lcom/android/server/appwidget/AppWidgetServiceImpl$3;-><init>(Lcom/android/server/appwidget/AppWidgetServiceImpl;)V
...
.method private handleNotifyUpdateAppWidget(Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;Lcom/android/internal/appwidget/IAppWidgetHost;ILandroid/widget/RemoteViews;J)V
    ...
    :cond_19
    const-string/jumbo v25, "AppWidgetServiceImpl"

    new-instance v23, Ljava/lang/StringBuilder;

    invoke-direct/range {v23 .. v23}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v26, "RemoteException, failed to remove widget because : (fds == null) = "
...
.method private onKNOXStarted(I)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v5}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->ensureGroupStateLoadedLocked(IZ)V
    :try_end_0
    ...
    invoke-virtual {v5, p1}, Lcom/android/server/appwidget/AppWidgetServiceImpl$SecurityPolicy;->getGroupParent(I)I

    move-result v5

    invoke-virtual {p0, v5}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->reloadWidgetsMaskedStateForGroup(I)V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->sendEnableIntentLocked(Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;)V

    iget-object v5, v4, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->widgets:Ljava/util/ArrayList;

    invoke-static {v5}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->getWidgetIds(Ljava/util/ArrayList;)[I

    move-result-object v1

    const/4 v5, 0x0

    invoke-direct {p0, v4, v1, v5}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->sendUpdateIntentLocked(Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;[IZ)V

    invoke-direct {p0, v4, v1}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->registerForBroadcastsLocked(Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;[I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public getAllProvidersForProfile(IIZ)Ljava/util/List;
    ...
    :cond_4
    sget-boolean v7, Lcom/android/server/appwidget/AppWidgetServiceImpl;->sSProtectPolicy:Z

    if-eqz v7, :cond_5

    invoke-virtual {v3, v2, v5}, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->semIsHidden(Landroid/content/pm/PackageManager;I)Z
...
.method public getInstalledProvidersForProfile(II)Landroid/content/pm/ParceledListSlice;
    ...
    iget v8, v1, Landroid/appwidget/AppWidgetProviderInfo;->widgetCategory:I
