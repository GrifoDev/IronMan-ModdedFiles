...
.field private mUsbStorageBooster:Lcom/samsung/android/os/SemDvfsManager;
...
.method static synthetic -get12(Lcom/android/server/MountService;)Lcom/samsung/android/os/SemDvfsManager;
    .locals 1

    iget-object v0, p0, Lcom/android/server/MountService;->mUsbStorageBooster:Lcom/samsung/android/os/SemDvfsManager;

    return-object v0
.end method

.method static synthetic -get13(Lcom/android/server/MountService;)Landroid/util/ArrayMap;
    .locals 1
...
.method static synthetic -get4(Lcom/android/server/MountService;)I
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v6, p0, Lcom/android/server/MountService;->mUsbStorageBooster:Lcom/samsung/android/os/SemDvfsManager;
    ...
    const-string/jumbo v1, "com.android.server"
    ...
    iput-object v0, p0, Lcom/android/server/MountService;->mUsbStorageBooster:Lcom/samsung/android/os/SemDvfsManager;
...
.method private checkLogEnableAtKernel()V
    ...
    const-string/jumbo v4, "/data/local/tmp/voldlog"
    ...
    const-string/jumbo v5, "!@checkLogEnableAtKernel !!"
    ...
    invoke-static {v1}, Landroid/os/storage/Log;->setKernelLogPrefix(Ljava/lang/String;)V

    invoke-static {v1}, Lcom/android/server/utils/sysfwutil/Slog;->setKernelLogPrefix(Ljava/lang/String;)V

    :try_start_0
    iget-object v4, p0, Lcom/android/server/MountService;->mConnector:Lcom/android/server/NativeDaemonConnector;

    const-string/jumbo v5, "enableKernelLog"

    const/4 v6, 0x1

    new-array v6, v6, [Ljava/lang/Object;

    const-string/jumbo v7, "logCmd"
    ...
    const-string/jumbo v5, "!@ File is not created"
...
.method private copyLocaleFromMountService()V
    ...
    invoke-static {v4, v5, v1}, Lcom/android/server/utils/sysfwutil/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method private handleDaemonConnected()V
    ...
    invoke-direct {p0}, Lcom/android/server/MountService;->checkLogEnableAtKernel()V
...
.method private hasDeviceRestriction(Ljava/lang/String;Z)Z
    ...
    invoke-direct {p0, p1, v3, v4, v5}, Lcom/android/server/MountService;->hasSecRestriction(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v3, v4, v8}, Lcom/android/server/MountService;->hasSecRestriction(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    iget-boolean v3, p0, Lcom/android/server/MountService;->preSDPolicy:Z
    ...
    iput-boolean v6, p0, Lcom/android/server/MountService;->preSDPolicy:Z
...
.method private isMountDisallowed(Landroid/os/storage/VolumeInfo;)Z
    ...
    const-string/jumbo v13, "isMountDisallowed : "
    ...
    const-string/jumbo v11, "trigger_restart_framework"
    ...
    const-string/jumbo v13, "!!!Skip!!! mount request : encrypt_state="
    ...
    const-string/jumbo v13, ", decrypt_state="
    ...
    const-string/jumbo v13, "to protect sdcardfs"
    ...
    const-string/jumbo v12, "Encryption type is FBE"
    ...
    iget-object v11, p1, Landroid/os/storage/VolumeInfo;->disk:Landroid/os/storage/DiskInfo;
    ...
    invoke-virtual {v8}, Landroid/app/enterprise/RestrictionPolicy;->isSdCardEnabled()Z
    ...
    invoke-virtual {v8, v11}, Landroid/app/enterprise/RestrictionPolicy;->isUsbHostStorageAllowed(Z)Z
    ...
    const-string/jumbo v11, "sdcard_storage"

    const/4 v12, 0x0

    invoke-direct {p0, v11, v12}, Lcom/android/server/MountService;->hasDeviceRestriction(Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v12, "Policy has restriction \'sdcard\'; cannot mount volume."

    invoke-static {v11, v12}, Lcom/android/server/utils/sysfwutil/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v12, "SDcard is restricted in MDM"

    invoke-static {v11, v12}, Lcom/android/server/utils/sysfwutil/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v9, Landroid/content/Intent;

    const-string/jumbo v11, "com.samsung.intent.action.SDCARD_ITPOLICY_TOAST_EVENT"
    ...
    const-string/jumbo v12, "USB MEMORY is restricted in MDM"
    ...
    const-string/jumbo v11, "usbhost_storage"
    ...
    const-string/jumbo v12, "Policy has restriction \'usbhost_storage\'; cannot mount volume."
    ...
    :cond_b
    const-string/jumbo v11, "storage_itpolicy_ui"
    ...
    const-string/jumbo v12, "Policy has restriction \'storage_itpolicy_ui\'; cannot mount volume."
    ...
    iget v11, p1, Landroid/os/storage/VolumeInfo;->type:I
    ...
    :cond_e
    const-string/jumbo v11, "no_physical_media"
...
.method public getVolumeList(ILjava/lang/String;I)[Landroid/os/storage/StorageVolume;
    ...
    invoke-static {v4, v5}, Landroid/os/storage/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
...
.method public mount(Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/MountService;->mUsbStorageBooster:Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-virtual {v6, v7}, Lcom/samsung/android/os/SemDvfsManager;->acquire(I)V
...
.method public unlockUserKey(II[B[B)V
    ...
    const-string/jumbo v3, "Unlock User Key for Knox : "
    ...
    invoke-static {v1, v2}, Landroid/os/storage/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
