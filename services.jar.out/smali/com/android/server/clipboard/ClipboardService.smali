...
.method public setPrimaryClip(Landroid/content/ClipData;Ljava/lang/String;)V
    ...
    iput-object v0, v6, Lcom/android/server/clipboard/ClipboardService$PerUserClipboard;->primaryClipForKNOX:Landroid/content/ClipData;

    iget-object v0, v6, Lcom/android/server/clipboard/ClipboardService$PerUserClipboard;->primaryClipByUid:Ljava/util/Map;
    ...
    const-string/jumbo v19, "No items"
    ...
    check-cast v15, Landroid/content/ClipData;
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    invoke-static/range {v18 .. v18}, Lcom/samsung/android/knox/SemPersonaManager;->isBBCContainer(I)Z
    ...
    invoke-virtual {v12, v0}, Lcom/samsung/android/knox/SemPersonaManager;->exists(I)Z
    ...
    const-string/jumbo v18, "persona_policy"

    move-object/from16 v0, v18

    invoke-virtual {v12, v0}, Lcom/samsung/android/knox/SemPersonaManager;->getPersonaService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Landroid/os/PersonaPolicyManager;

    if-eqz v13, :cond_6

    move/from16 v0, v17

    invoke-virtual {v13, v0}, Landroid/os/PersonaPolicyManager;->isShareClipboardDataToOwnerAllowed(I)Z
    ...
    invoke-direct {v0, v9}, Lcom/android/server/clipboard/ClipboardService;->getClipboard(I)Lcom/android/server/clipboard/ClipboardService$PerUserClipboard;
    ...
    const-string/jumbo v19, "no_cross_profile_copy_paste"
    ...
    :try_start_7
    const-string/jumbo v18, "ClipboardService"

    new-instance v19, Ljava/lang/StringBuilder;

    invoke-direct/range {v19 .. v19}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v20, "Remote Exception calling UserManager: "
    ...
    invoke-direct {v5, v0}, Landroid/content/ClipData;-><init>(Landroid/content/ClipData;)V
    :try_end_7
    ...
    invoke-direct/range {v18 .. v19}, Landroid/content/ClipData$Item;-><init>(Landroid/content/ClipData$Item;)V

    move-object/from16 v0, v18

    invoke-virtual {v5, v8, v0}, Landroid/content/ClipData;->setItemAt(ILandroid/content/ClipData$Item;)V
    :try_end_8
