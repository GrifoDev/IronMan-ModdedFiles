...
.method private checkInitialUid()V
    ...
    invoke-static {v11, v12}, Lcom/android/server/connectivity/NetworkMonitor;->-set16(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
    ...
    invoke-static {v12, v13}, Lcom/android/server/connectivity/NetworkMonitor;->-set7(Lcom/android/server/connectivity/NetworkMonitor;I)I

    move-result v12

    invoke-static {v11, v12}, Lcom/android/server/connectivity/NetworkMonitor;->-set9(Lcom/android/server/connectivity/NetworkMonitor;I)I
    ...
    invoke-static {v12}, Lcom/android/server/connectivity/NetworkMonitor;->-get11(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    invoke-static {v11, v12, v13}, Lcom/android/server/connectivity/NetworkMonitor;->-set6(Lcom/android/server/connectivity/NetworkMonitor;J)J
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/NetworkMonitor;->-get11(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/NetworkMonitor;->-get21(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/NetworkMonitor;->-get19(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v11}, Lcom/android/server/connectivity/NetworkMonitor;->-get11(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    invoke-static {v11}, Lcom/android/server/connectivity/NetworkMonitor;->-get21(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v11, v12}, Lcom/android/server/connectivity/NetworkMonitor;->-set10(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
...
.method public enter()V
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/NetworkMonitor;->-get24(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/NetworkMonitor;->-get39(Lcom/android/server/connectivity/NetworkMonitor;)Landroid/net/wifi/WifiManager;
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/NetworkMonitor;->-get38(Lcom/android/server/connectivity/NetworkMonitor;)Lcom/android/internal/util/State;

    move-result-object v9

    invoke-static {v8, v9}, Lcom/android/server/connectivity/NetworkMonitor;->-wrap9(Lcom/android/server/connectivity/NetworkMonitor;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v10}, Lcom/android/server/connectivity/NetworkMonitor;->-get29(Lcom/android/server/connectivity/NetworkMonitor;)I

    move-result v10

    invoke-virtual {v9, v13, v14, v10, v11}, Lcom/android/server/connectivity/NetworkMonitor;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/NetworkMonitor;->-get14(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/NetworkMonitor;->-get35(Lcom/android/server/connectivity/NetworkMonitor;)Landroid/telephony/TelephonyManager;
    ...
    invoke-static {v8, v7}, Lcom/android/server/connectivity/NetworkMonitor;->-set13(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/NetworkMonitor;->-get30(Lcom/android/server/connectivity/NetworkMonitor;)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    invoke-static {v10, v7, v5, v7}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v10

    const v11, 0x8200a

    invoke-virtual {v8, v11, v14, v9, v10}, Lcom/android/server/connectivity/NetworkMonitor;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    iget-object v8, v8, Lcom/android/server/connectivity/NetworkMonitor;->mWatchdogChannel:Lcom/android/internal/util/AsyncChannel;

    const-string/jumbo v9, "CWeb"

    invoke-virtual {v8, v12, v7, v7, v9}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
    ...
    invoke-static {v7, v14}, Lcom/android/server/connectivity/NetworkMonitor;->-set2(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/NetworkMonitor;->-get31(Lcom/android/server/connectivity/NetworkMonitor;)Lcom/android/server/connectivity/NetworkMonitor$NetworkMonitorPhoneStateListner;
    ...
    new-instance v9, Lcom/android/server/connectivity/NetworkMonitor$NetworkMonitorPhoneStateListner;

    iget-object v10, p0, Lcom/android/server/connectivity/NetworkMonitor$CaptivePortalState;->this$0:Lcom/android/server/connectivity/NetworkMonitor;

    invoke-direct {v9, v10}, Lcom/android/server/connectivity/NetworkMonitor$NetworkMonitorPhoneStateListner;-><init>(Lcom/android/server/connectivity/NetworkMonitor;)V

    invoke-static {v8, v9}, Lcom/android/server/connectivity/NetworkMonitor;->-set21(Lcom/android/server/connectivity/NetworkMonitor;Lcom/android/server/connectivity/NetworkMonitor$NetworkMonitorPhoneStateListner;)Lcom/android/server/connectivity/NetworkMonitor$NetworkMonitorPhoneStateListner;
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/NetworkMonitor;->-get31(Lcom/android/server/connectivity/NetworkMonitor;)Lcom/android/server/connectivity/NetworkMonitor$NetworkMonitorPhoneStateListner;
    ...
    invoke-virtual {v8, v12, v14, v7, v9}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V
    ...
    invoke-static {v7, v8}, Lcom/android/server/connectivity/NetworkMonitor;->-wrap4(Lcom/android/server/connectivity/NetworkMonitor;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9}, Lcom/android/server/connectivity/NetworkMonitor;->-wrap5(Lcom/android/server/connectivity/NetworkMonitor;I)V
    ...
    invoke-static {v8, v9}, Lcom/android/server/connectivity/NetworkMonitor;->-set19(Lcom/android/server/connectivity/NetworkMonitor;Lcom/android/server/connectivity/NetworkMonitor$CustomIntentReceiver;)Lcom/android/server/connectivity/NetworkMonitor$CustomIntentReceiver;
    ...
    invoke-static {v10}, Lcom/android/server/connectivity/NetworkMonitor;->-get27(Lcom/android/server/connectivity/NetworkMonitor;)Lcom/android/server/connectivity/NetworkMonitor$CustomIntentReceiver;
    ...
    invoke-virtual {v8, v9, v7, v10, v11}, Lcom/android/server/connectivity/NetworkMonitor;->sendMessageDelayed(IIJ)V
...
.method public exit()V
    ...
    invoke-static {v1, v2}, Lcom/android/server/connectivity/NetworkMonitor;->-wrap7(Lcom/android/server/connectivity/NetworkMonitor;I)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/NetworkMonitor;->-get24(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/NetworkMonitor;->-get21(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    const-string/jumbo v7, "Captive portal login activity already created once."
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/NetworkMonitor;->-get33(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    const-string/jumbo v7, "Captive portal - Smart detection is not available for now."
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/NetworkMonitor;->-get11(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    const-string/jumbo v8, ", mCurrentTxByteUid:"
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/NetworkMonitor;->-get10(Lcom/android/server/connectivity/NetworkMonitor;)J
    ...
    const-string/jumbo v8, ", mCaptivePortalTxCheckSec:"
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/NetworkMonitor;->-get5(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    invoke-static {v6}, Lcom/android/server/connectivity/NetworkMonitor;->-get5(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    invoke-static {v6, v7}, Lcom/android/server/connectivity/NetworkMonitor;->-set3(Lcom/android/server/connectivity/NetworkMonitor;I)I

    iget-object v6, p0, Lcom/android/server/connectivity/NetworkMonitor$CaptivePortalState;->this$0:Lcom/android/server/connectivity/NetworkMonitor;

    invoke-static {v6}, Lcom/android/server/connectivity/NetworkMonitor;->-get10(Lcom/android/server/connectivity/NetworkMonitor;)J
    ...
    const-string/jumbo v7, "TxBytes increased: start Activity"

    invoke-virtual {v6, v7}, Lcom/android/server/connectivity/NetworkMonitor;->log(Ljava/lang/String;)V

    iget-object v6, p0, Lcom/android/server/connectivity/NetworkMonitor$CaptivePortalState;->this$0:Lcom/android/server/connectivity/NetworkMonitor;

    invoke-static {v6}, Lcom/android/server/connectivity/NetworkMonitor;->-get18(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v7}, Lcom/android/server/connectivity/NetworkMonitor;->-get17(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    invoke-static {v6, v7}, Lcom/android/server/connectivity/NetworkMonitor;->-set10(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
    ...
    invoke-virtual {v6, v8, v9, v7, v10}, Lcom/android/server/connectivity/NetworkMonitor;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v6, v9, v10, v7, v8}, Lcom/android/server/connectivity/NetworkMonitor;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-static {v6, v7}, Lcom/android/server/connectivity/NetworkMonitor;->-set11(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
    ...
    const-string/jumbo v7, "Launch captive portal login activity immediately - Smart detection"
    ...
    invoke-static {v6, v7, v8}, Lcom/android/server/connectivity/NetworkMonitor;->-wrap8(Lcom/android/server/connectivity/NetworkMonitor;ZZ)V
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/NetworkMonitor;->-get34(Lcom/android/server/connectivity/NetworkMonitor;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v8, v9, v10, v7}, Lcom/android/internal/util/AsyncChannel;->sendMessage(IIILjava/lang/Object;)V

    iget-object v6, p0, Lcom/android/server/connectivity/NetworkMonitor$CaptivePortalState;->this$0:Lcom/android/server/connectivity/NetworkMonitor;

    iget-object v6, v6, Lcom/android/server/connectivity/NetworkMonitor;->mWatchdogChannel:Lcom/android/internal/util/AsyncChannel;

    const-string/jumbo v7, "CWeb"
    ...
    const-string/jumbo v7, "Stop checking captive portal Tx by Timer"
    ...
    invoke-static {v6, v7}, Lcom/android/server/connectivity/NetworkMonitor;->-wrap7(Lcom/android/server/connectivity/NetworkMonitor;I)V
    ...
    const-string/jumbo v7, "Restart checkInitialUid"
    ...
    const-string/jumbo v7, "Restart CaptivePortalLoginActivity"
    ...
    const-string/jumbo v7, "Update notification"
