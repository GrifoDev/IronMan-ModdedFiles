...
.method public enter()V
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering;->-get28(Lcom/android/server/connectivity/Tethering;)Lcom/android/server/connectivity/Tethering$UpstreamNetworkMonitor;
...
.method public exit()V
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering;->-get28(Lcom/android/server/connectivity/Tethering;)Lcom/android/server/connectivity/Tethering$UpstreamNetworkMonitor;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v10, p0, v11}, Lcom/android/server/connectivity/Tethering;->-wrap11(Lcom/android/server/connectivity/Tethering;Lcom/android/internal/util/State;I)V
    ...
    const-string/jumbo v12, "TetherModeAliveState.processMessage what="
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->-get5(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Ljava/util/ArrayList;
    ...
    invoke-static {v8}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->-get1(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/server/connectivity/tethering/IPv6TetheringCoordinator;

    move-result-object v8

    invoke-virtual {v8, v7}, Lcom/android/server/connectivity/tethering/IPv6TetheringCoordinator;->addActiveDownstream(Lcom/android/server/connectivity/tethering/TetherInterfaceStateMachine;)V
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/Tethering;->-get8(Lcom/android/server/connectivity/Tethering;)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v1, v8, v9}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v8, "actualIface"

    iget-object v9, p0, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherModeAliveState;->this$1:Lcom/android/server/connectivity/Tethering$TetherMasterSM;

    invoke-static {v9}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->-get0(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Ljava/lang/String;
    ...
    invoke-virtual {v7, v8, v1}, Lcom/android/server/connectivity/tethering/TetherInterfaceStateMachine;->sendMessage(ILjava/lang/Object;)V
    ...
    const-string/jumbo v12, "Tether Mode unrequested by "
    ...
    invoke-static {v10}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->-get5(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Ljava/util/ArrayList;
    ...
    const-string/jumbo v12, "TetherModeAlive removing notifyee "
    ...
    invoke-virtual {v8, v7}, Lcom/android/server/connectivity/tethering/IPv6TetheringCoordinator;->removeActiveDownstream(Lcom/android/server/connectivity/tethering/TetherInterfaceStateMachine;)V
    ...
    const-string/jumbo v12, "TetherModeAlive still has "
    ...
    invoke-static {v12}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->-get5(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Ljava/util/ArrayList;
    ...
    const-string/jumbo v12, " live requests:"
    ...
    const-string/jumbo v10, "TetherModeAliveState UNREQUESTED has unknown who: "
    ...
    const-string/jumbo v11, "CMD_UPSTREAM_CHANGED event received"
    ...
    invoke-static {v9}, Lcom/android/server/connectivity/Tethering;->-get28(Lcom/android/server/connectivity/Tethering;)Lcom/android/server/connectivity/Tethering$UpstreamNetworkMonitor;
    ...
    invoke-virtual {v9, v10, v11}, Lcom/android/server/connectivity/Tethering$UpstreamNetworkMonitor;->processCallback(ILjava/lang/Object;)Landroid/net/NetworkState;
    ...
    invoke-virtual {v9, v2}, Lcom/android/server/connectivity/Tethering;->pertainsToCurrentUpstream(Landroid/net/NetworkState;)Z
    ...
    :pswitch_7
    invoke-virtual {p0, v2}, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherModeAliveState;->handleNewUpstreamNetworkState(Landroid/net/NetworkState;)V
    ...
    :pswitch_8
    iget-object v8, v2, Landroid/net/NetworkState;->network:Landroid/net/Network;

    iget-object v9, v2, Landroid/net/NetworkState;->linkProperties:Landroid/net/LinkProperties;
    ...
    :pswitch_9
    invoke-virtual {p0, v13}, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherModeAliveState;->handleNewUpstreamNetworkState(Landroid/net/NetworkState;)V
    ...
    iput v8, v9, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->mRetryCount:I
