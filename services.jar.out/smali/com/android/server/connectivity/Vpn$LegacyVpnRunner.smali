...
.method private checkpoint(Z)V
    ...
    invoke-static {v2, v3, v4}, Lcom/android/server/connectivity/Vpn;->-wrap8(Lcom/android/server/connectivity/Vpn;Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;)V
...
.method private execute(Z)V
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Vpn;->-get23(Lcom/android/server/connectivity/Vpn;)Z
    ...
    const-string/jumbo v4, "add vpn rules"
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Vpn;->-get21(Lcom/android/server/connectivity/Vpn;)Lcom/android/server/connectivity/VpnRules;

    move-result-object v2

    invoke-virtual {v2}, Lcom/android/server/connectivity/VpnRules;->createVpnPostroutingChain()V
    ...
    invoke-virtual {v2}, Lcom/android/server/connectivity/VpnRules;->addTcpmssClampRule()V
    :try_end_12
    ...
    invoke-static {v3}, Lcom/android/server/connectivity/Vpn;->-wrap5(Lcom/android/server/connectivity/Vpn;)V
...
.method private monitorDaemons()V
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/Vpn;->-get7(Lcom/android/server/connectivity/Vpn;)Z
    ...
    iget-object v3, p0, Lcom/android/server/connectivity/Vpn$LegacyVpnRunner;->mServerIP:Ljava/lang/String;

    invoke-static {v1, v3, v6}, Lcom/android/server/connectivity/Vpn;->-wrap3(Lcom/android/server/connectivity/Vpn;Ljava/lang/String;Z)V

    :cond_2
    const-string/jumbo v1, "LegacyVpnRunner"

    const-string/jumbo v3, "delete vpn rules"

    invoke-static {v1, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v1, p0, Lcom/android/server/connectivity/Vpn$LegacyVpnRunner;->this$0:Lcom/android/server/connectivity/Vpn;

    invoke-static {v1}, Lcom/android/server/connectivity/Vpn;->-get21(Lcom/android/server/connectivity/Vpn;)Lcom/android/server/connectivity/VpnRules;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/server/connectivity/VpnRules;->deleteVpnPostroutingChain()V

    invoke-direct {p0}, Lcom/android/server/connectivity/Vpn$LegacyVpnRunner;->stopLegacyDaemons()V

    iget-object v1, p0, Lcom/android/server/connectivity/Vpn$LegacyVpnRunner;->this$0:Lcom/android/server/connectivity/Vpn;

    invoke-static {v1}, Lcom/android/server/connectivity/Vpn;->-wrap5(Lcom/android/server/connectivity/Vpn;)V
