...
.method public enter()V
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/NetworkMonitor;->-get16(Lcom/android/server/connectivity/NetworkMonitor;)Landroid/net/util/Stopwatch;
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/NetworkMonitor;->-get36(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    invoke-static {v1, v5}, Lcom/android/server/connectivity/NetworkMonitor;->-set25(Lcom/android/server/connectivity/NetworkMonitor;I)I
    ...
    invoke-static {v1}, Lcom/android/server/connectivity/NetworkMonitor;->-get9(Lcom/android/server/connectivity/NetworkMonitor;)Ljava/lang/String;
    ...
    invoke-static {v1, v2}, Lcom/android/server/connectivity/NetworkMonitor;->-set5(Lcom/android/server/connectivity/NetworkMonitor;Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    ...
    invoke-static {v1, v2}, Lcom/android/server/connectivity/NetworkMonitor;->-set17(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/NetworkMonitor;->-get32(Lcom/android/server/connectivity/NetworkMonitor;)I

    move-result v3

    add-int/lit8 v3, v3, 0x1

    invoke-static {v2, v3}, Lcom/android/server/connectivity/NetworkMonitor;->-set22(Lcom/android/server/connectivity/NetworkMonitor;I)I

    move-result v2

    const v3, 0x82006

    invoke-virtual {v1, v3, v2, v4}, Lcom/android/server/connectivity/NetworkMonitor;->sendMessage(III)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/NetworkMonitor;->-get32(Lcom/android/server/connectivity/NetworkMonitor;)I
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/NetworkMonitor;->-get37(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/NetworkMonitor;->-get12(Lcom/android/server/connectivity/NetworkMonitor;)Landroid/net/NetworkRequest;
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/NetworkMonitor;->-get30(Lcom/android/server/connectivity/NetworkMonitor;)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    invoke-static {v2, v4}, Lcom/android/server/connectivity/NetworkMonitor;->-wrap10(Lcom/android/server/connectivity/NetworkMonitor;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/NetworkMonitor;->-get38(Lcom/android/server/connectivity/NetworkMonitor;)Lcom/android/internal/util/State;

    move-result-object v4

    invoke-static {v2, v4}, Lcom/android/server/connectivity/NetworkMonitor;->-wrap9(Lcom/android/server/connectivity/NetworkMonitor;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/NetworkMonitor;->-get30(Lcom/android/server/connectivity/NetworkMonitor;)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/NetworkMonitor;->-get24(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/NetworkMonitor;->-get39(Lcom/android/server/connectivity/NetworkMonitor;)Landroid/net/wifi/WifiManager;
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/NetworkMonitor;->-get28(Lcom/android/server/connectivity/NetworkMonitor;)Z
    ...
    invoke-static {v2, v4}, Lcom/android/server/connectivity/NetworkMonitor;->-set20(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
    ...
    invoke-static {v5}, Lcom/android/server/connectivity/NetworkMonitor;->-get29(Lcom/android/server/connectivity/NetworkMonitor;)I

    move-result v5

    move-object/from16 v0, v18

    iget-object v7, v0, Lcom/android/server/connectivity/NetworkMonitor$CaptivePortalProbeResult;->redirectUrl:Ljava/lang/String;
    ...
    invoke-static {v2, v0}, Lcom/android/server/connectivity/NetworkMonitor;->-set18(Lcom/android/server/connectivity/NetworkMonitor;Lcom/android/server/connectivity/NetworkMonitor$CaptivePortalProbeResult;)Lcom/android/server/connectivity/NetworkMonitor$CaptivePortalProbeResult;
    ...
    invoke-static {v4, v5}, Lcom/android/server/connectivity/NetworkMonitor;->-set22(Lcom/android/server/connectivity/NetworkMonitor;I)I
    ...
    invoke-static {v2, v4}, Lcom/android/server/connectivity/NetworkMonitor;->-wrap3(Lcom/android/server/connectivity/NetworkMonitor;I)V
    ...
    invoke-static {v2, v4}, Lcom/android/server/connectivity/NetworkMonitor;->-set15(Lcom/android/server/connectivity/NetworkMonitor;Z)Z
