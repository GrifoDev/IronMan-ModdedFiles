...
.method private doVerifyBackupPassword(Ljava/lang/String;ZJILcom/android/internal/widget/ICheckCredentialProgressCallback;)Lcom/android/internal/widget/VerifyCredentialResponse;
    .locals 13
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    new-instance v10, Lcom/android/server/LockSettingsService$11;

    invoke-direct {v10, p0}, Lcom/android/server/LockSettingsService$11;-><init>(Lcom/android/server/LockSettingsService;)V
...
.method private doVerifyPassword(Ljava/lang/String;Lcom/android/server/LockSettingsStorage$CredentialHash;ZJILcom/android/internal/widget/ICheckCredentialProgressCallback;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    const-string/jumbo v4, "Password can\'t be null or empty"
...
.method private doVerifyRecoveryPassword(Ljava/lang/String;ZJILcom/android/internal/widget/ICheckCredentialProgressCallback;)Lcom/android/internal/widget/VerifyCredentialResponse;
    .locals 13
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/LockSettingsStorage;->readRecoveryPasswordHash(I)Lcom/android/server/LockSettingsStorage$CredentialHash;

    move-result-object v5

    new-instance v10, Lcom/android/server/LockSettingsService$10;

    invoke-direct {v10, p0}, Lcom/android/server/LockSettingsService$10;-><init>(Lcom/android/server/LockSettingsService;)V
...
.method private migrateOldData()V
    ...
    :cond_11
    const-string/jumbo v33, "migrated_fingerprint_to_biometric"
    ...
    const-string/jumbo v33, "lockscreen.enabled_fingerprint"
    ...
    const-string/jumbo v34, "Migrated fingerprint to biometric"

    invoke-static/range {v33 .. v34}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    :cond_14
    const-string/jumbo v33, "migrated_clear_locktype_if_not_saved_password"
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/widget/LockPatternUtils;->isLockDirectionEnabled(I)Z
    ...
    const-string/jumbo v34, "migrated : if no password saved, clear locktype ."
...
.method private setLockPasswordInternal(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1, p3, v0}, Lcom/android/server/LockSettingsService;->enrollKnoxCredential(Ljava/lang/String;II)V
    ...
    invoke-direct {p0, v0, p3}, Lcom/android/server/LockSettingsService;->setKeystorePassword(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v0, p3}, Lcom/android/server/LockSettingsService;->notifyActivePasswordMetricsAvailable(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v11, v0}, Lcom/android/server/LockSettingsStorage$CredentialHash;-><init>([BI)V
    ...
    invoke-virtual {v0, p3, v1}, Lcom/android/server/LockSettingsService$SdpHandler;->removeKeyPair(II)V
...
.method private unlockUser(I[B[B)V
    ...
    const-string/jumbo v8, "unlockUser begin"
    ...
    const-string/jumbo v8, "unlockUser end"
...
.method private verifyKnoxCredential(Ljava/lang/String;ILcom/android/server/LockSettingsService$IKeystoreUtil;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    const-string/jumbo v6, "Verification - Start!"
    ...
    const-string/jumbo v6, "Verification - Unacceptable credential..."
    ...
    invoke-virtual {v6, p2}, Lcom/android/server/pm/PersonaManagerService;->mountCeStorage(I)V
    ...
    invoke-direct {p0, p2, v7}, Lcom/android/server/LockSettingsService;->getVerificationType(II)I

    move-result v7

    invoke-direct {v0, p2, v6, v7, p1}, Lcom/android/server/LockSettingsService$CredentialInfo;-><init>(IIILjava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/LockSettingsService$RecoveryCredentialResponse;->getResponseCode()I
    ...
    :pswitch_0
    const-string/jumbo v6, "Verification - Failed to recovery..."
    ...
    :pswitch_1
    iget-boolean v6, v0, Lcom/android/server/LockSettingsService$CredentialInfo;->isSdpEnabled:Z

    if-eqz v6, :cond_5

    iget-object v6, v0, Lcom/android/server/LockSettingsService$CredentialInfo;->credential:Ljava/lang/String;

    iget v7, v0, Lcom/android/server/LockSettingsService$CredentialInfo;->userId:I

    invoke-direct {p0, v6, v7}, Lcom/android/server/LockSettingsService;->getEncodedCredential(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/server/LockSettingsService;->mKeystoreUtil:Lcom/android/server/LockSettingsService$KeystoreUtil;

    iget v7, v0, Lcom/android/server/LockSettingsService$CredentialInfo;->userId:I

    invoke-static {v6, v1, v7}, Lcom/android/server/LockSettingsService$KeystoreUtil;->-wrap0(Lcom/android/server/LockSettingsService$KeystoreUtil;Ljava/lang/String;I)Z

    goto :goto_0

    :cond_5
    iget v6, v0, Lcom/android/server/LockSettingsService$CredentialInfo;->verifType:I
    ...
    iget v8, v0, Lcom/android/server/LockSettingsService$CredentialInfo;->lockType:I

    invoke-direct {p0, v6, v7, v8}, Lcom/android/server/LockSettingsService;->compareHash(Ljava/lang/String;II)Z
    ...
    iget-object v7, v0, Lcom/android/server/LockSettingsService$CredentialInfo;->credential:Ljava/lang/String;

    iget v8, v0, Lcom/android/server/LockSettingsService$CredentialInfo;->userId:I

    invoke-static {v6, v7, v8}, Lcom/android/server/LockSettingsService$KeystoreUtil;->-wrap0(Lcom/android/server/LockSettingsService$KeystoreUtil;Ljava/lang/String;I)Z

    goto/16 :goto_0

    :cond_6
    const-string/jumbo v6, "Verification - Unexpected condition..."
    ...
    const-string/jumbo v6, "Verification - Verification and Recovery completed!"
...
.method public checkBackupPassword(Ljava/lang/String;I)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/server/LockSettingsService;->doVerifyBackupPassword(Ljava/lang/String;ZJILcom/android/internal/widget/ICheckCredentialProgressCallback;)Lcom/android/internal/widget/VerifyCredentialResponse;
...
.method public checkPassword(Ljava/lang/String;ILcom/android/internal/widget/ICheckCredentialProgressCallback;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    invoke-direct {v8, v9}, Lcom/samsung/android/security/SemSdCardEncryption;-><init>(Landroid/content/Context;)V

    invoke-virtual {v8, p1}, Lcom/samsung/android/security/SemSdCardEncryption;->setPassword(Ljava/lang/String;)I
...
.method public checkPattern(Ljava/lang/String;ILcom/android/internal/widget/ICheckCredentialProgressCallback;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    invoke-direct {v8, v1}, Lcom/samsung/android/security/SemSdCardEncryption;-><init>(Landroid/content/Context;)V
...
.method public resetKeyStore(I)V
    ...
    invoke-direct {v0, v7}, Lcom/android/server/LockSettingsService;->isUserRemoveCertificatesAllowed(I)Z
    ...
    const-string/jumbo v15, "Clear not allowed for userId "
    ...
    const-string/jumbo v15, " (isUserRemoveCertificatesAllowedAsUser == false)"
...
.method public setStrongAuthFor24Hours(I)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/LockSettingsStrongAuth;->setStrongAuthFor24Hours(I)V
...
.method public verifyPattern(Ljava/lang/String;JI)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    const-string/jumbo v2, "verifyPattern "
