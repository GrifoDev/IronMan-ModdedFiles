...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/SdpManagerService$SdpUssListener;,
...
.field private static final MSG_USER_STARTED:I = 0x5
...
.field private final mSdpUssListener:Lcom/android/server/SdpManagerService$SdpUssListener;
...
.method static synthetic -wrap13(Lcom/android/server/SdpManagerService;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/SdpManagerService;->handleUserStarted(I)V
...
.method static synthetic -wrap14(Lcom/android/server/SdpManagerService;I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/SdpManagerService;->onUserStarted(I)V

    return-void
.end method

.method static synthetic -wrap15(Lcom/android/server/SdpManagerService;Ljava/lang/String;Ljava/lang/Exception;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic -wrap16(Lcom/android/server/SdpManagerService;[B)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/SdpManagerService;->mStateMap:Ljava/util/HashMap;

    iput-boolean v3, p0, Lcom/android/server/SdpManagerService;->mWaitForPassword:Z
    ...
    iput-object v2, p0, Lcom/android/server/SdpManagerService;->mSdpEngineDb:Lcom/android/server/SdpManagerService$SdpEngineDatabase;

    iput-boolean v3, p0, Lcom/android/server/SdpManagerService;->bootComplete:Z

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/SdpManagerService;->mEnginState:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/SdpManagerService;->mCMKMap:Ljava/util/Map;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/SdpManagerService;->mResetPwdKeyMap:Ljava/util/Map;

    iput-object v2, p0, Lcom/android/server/SdpManagerService;->mTimaHelper:Lcom/android/server/pm/TimaHelper;

    iput-object v2, p0, Lcom/android/server/SdpManagerService;->mKeyManagementUtil:Lcom/sec/knox/container/util/KeyManagementUtil;

    iput-object v2, p0, Lcom/android/server/SdpManagerService;->mEPM:Lcom/sec/knox/container/util/EnterprisePartitionManager;

    iput-object v2, p0, Lcom/android/server/SdpManagerService;->mUM:Landroid/os/UserManager;

    iput-object v2, p0, Lcom/android/server/SdpManagerService;->mEngineMonitor:Lcom/android/server/SdpManagerService$EngineMonitor;

    iput-object v2, p0, Lcom/android/server/SdpManagerService;->mSdpHandler:Lcom/android/server/SdpManagerService$SdpHandler;

    iput-object v2, p0, Lcom/android/server/SdpManagerService;->handlerThread:Landroid/os/HandlerThread;

    iput-boolean v3, p0, Lcom/android/server/SdpManagerService;->mIsReady:Z
    ...
    new-instance v1, Lcom/android/server/SdpManagerService$SdpUssListener;

    invoke-direct {v1, p0, p0}, Lcom/android/server/SdpManagerService$SdpUssListener;-><init>(Lcom/android/server/SdpManagerService;Lcom/android/server/SdpManagerService;)V

    iput-object v1, p0, Lcom/android/server/SdpManagerService;->mSdpUssListener:Lcom/android/server/SdpManagerService$SdpUssListener;
    ...
    iget-object v1, p0, Lcom/android/server/SdpManagerService;->mSdpUssListener:Lcom/android/server/SdpManagerService$SdpUssListener;

    invoke-virtual {v0, v1}, Landroid/app/ActivityManagerInternal;->registerUserStateListener(Landroid/os/IUserStateListener;)V
    ...
    const-string/jumbo v2, "Failed to register uss listener due to ami connection failed..."
...
.method private handleUserStarted(I)V
    ...
    const-string/jumbo v5, "handleUserStarted :: User "
    ...
    const-string/jumbo v5, "handleUserStarted :: Managed profile started... "
    ...
    invoke-direct {p0, v3}, Lcom/android/server/SdpManagerService;->getEngineInfoLocked(I)Lcom/samsung/android/knox/sdp/core/SdpEngineInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0, p1, v3, v4}, Lcom/android/server/SdpManagerService;->sendBroadcastForStateChange(III)V
...
.method private onUserStarted(I)V
    ...
    const-string/jumbo v3, "On User Started : "
    ...
    invoke-virtual {v1, v2, p1, v3}, Lcom/android/server/SdpManagerService$SdpHandler;->obtainMessage(III)Landroid/os/Message;
    ...
    const-string/jumbo v2, "On User Started - Handler is not prepared yet... skipped"
...
.method public onPackageRemoved(ILjava/lang/String;)V
    ...
    const-string/jumbo v3, "SdpHandler is not ready..."
...
.method public systemReady()V
    ...
    invoke-virtual {v1, v4}, Lcom/android/server/SdpManagerService$SdpHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    iput-boolean v4, p0, Lcom/android/server/SdpManagerService;->mIsHandlerReady:Z
