...
.field private mExtenderNotificationBuilder:Landroid/app/Notification$Builder;
...
.method static synthetic -get6(Lcom/android/server/NetworkManagementService;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/NetworkManagementService;->mMHSAllowAll:Z

    return v0
.end method

.method static synthetic -get7(Lcom/android/server/NetworkManagementService;)Ljava/util/Hashtable;
    .locals 1

    iget-object v0, p0, Lcom/android/server/NetworkManagementService;->mMHSClients:Ljava/util/Hashtable;
...
.method static synthetic -wrap0(Lcom/android/server/NetworkManagementService;Ljava/lang/String;)Z
    .locals 1

    invoke-direct {p0, p1}, Lcom/android/server/NetworkManagementService;->isAllowedList(Ljava/lang/String;)Z
...
.method static synthetic -wrap1(Lcom/android/server/NetworkManagementService;)Z
    .locals 1
...
.method static synthetic -wrap16(Lcom/android/server/NetworkManagementService;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/NetworkManagementService;->sendMHSBigdata(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic -wrap2(Lcom/android/server/NetworkManagementService;)I
    .locals 1
...
.method static synthetic -wrap3(Lcom/android/server/NetworkManagementService;)V
    .locals 0
...
.method static synthetic -wrap7(Lcom/android/server/NetworkManagementService;IIJIZ)V
    .locals 1
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mMHSClients:Ljava/util/Hashtable;

    iput-boolean v1, p0, Lcom/android/server/NetworkManagementService;->mMHSAllowAll:Z

    iput v1, p0, Lcom/android/server/NetworkManagementService;->mLastNotificationId:I

    const-string/jumbo v0, "/data/misc/wifi_hostapd/hostapd.accept"

    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->HOSTAPD_ACCEPT:Ljava/lang/String;
...
.method private static getExtenderSecurityType(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    .locals 2
    ...
    const-string/jumbo v1, "open from default"
    ...
    :pswitch_1
    invoke-static {p0}, Lcom/android/server/NetworkManagementService;->getPairwiseCiphers(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/android/server/NetworkManagementService;->getGroupCiphers(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    ...
    const-string/jumbo v0, "wpa-psk-tkip_wpa2-psk-tkip"
    ...
    const-string/jumbo v0, "wpa-psk-ccmp_wpa2-psk-tkip"

    return-object v0

    :cond_1
    const-string/jumbo v1, "tkip ccmp"
    ...
    const-string/jumbo v0, "wpa-psk-tkip-ccmp_wpa2-psk-tkip"
    ...
    const-string/jumbo v0, "wpa-psk-tkip_wpa2-psk-ccmp"
    ...
    const-string/jumbo v0, "wpa-psk-tkip_wpa2-psk-tkip-ccmp"

    return-object v0

    :cond_4
    const-string/jumbo v0, "wpa-psk-tkip"
    ...
    const-string/jumbo v0, "wpa-psk-ccmp_wpa2-psk-ccmp"
    ...
    const-string/jumbo v0, "wpa-psk-ccmp_wpa2-psk-tkip-ccmp"

    return-object v0

    :cond_7
    const-string/jumbo v0, "wpa-psk-ccmp"
    ...
    const-string/jumbo v0, "wpa-psk-tkip-ccmp_wpa2-psk-ccmp"
    ...
    const-string/jumbo v0, "wpa-psk-tkip-ccmp_wpa2-psk-tkip-ccmp"

    return-object v0

    :cond_a
    const-string/jumbo v0, "wpa-psk-tkip-ccmp"
    ...
    const-string/jumbo v0, "wpa2-psk-tkip"
    ...
    const-string/jumbo v0, "wpa2-psk-ccmp"
    ...
    const-string/jumbo v0, "wpa2-psk-tkip-ccmp"
...
.method private static getGroupCiphers(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    .locals 3
    ...
    const-string/jumbo v0, "tkip ccmp"
    ...
    const-string/jumbo v1, "return blank"
...
.method private static getPairwiseCiphers(Landroid/net/wifi/WifiConfiguration;)Ljava/lang/String;
    .locals 3
...
.method public getStationInfo(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "sta_info"
...
.method public setTCRule(ZLjava/lang/String;I)V
    ...
    const-string/jumbo v4, "setTCRule - interface name is not starts with wlan"
...
.method public showExtenderNotification(Z)V
    .locals 14
    ...
    const-string/jumbo v5, "notifyExtenderMode..."
    ...
    iget-object v0, p0, Lcom/android/server/NetworkManagementService;->mExtenderNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mExtenderNotificationBuilder:Landroid/app/Notification$Builder;
    ...
    iget v0, p0, Lcom/android/server/NetworkManagementService;->mLastNotificationId:I

    iget-object v1, p0, Lcom/android/server/NetworkManagementService;->mExtenderNotificationBuilder:Landroid/app/Notification$Builder;
...
.method public startAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    iget-object v2, v0, Lcom/android/server/NetworkManagementService;->mMHSClients:Ljava/util/Hashtable;
    ...
    iget-object v5, v0, Lcom/android/server/NetworkManagementService;->mMHSClients:Ljava/util/Hashtable;
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/net/wifi/WifiManager;->semSupportWifiAp5G()Z

    move-result v2

    if-nez v2, :cond_8

    invoke-virtual/range {v26 .. v26}, Landroid/net/wifi/WifiManager;->semSupportWifiAp5GBasedOnCountry()Z
    ...
    const-string/jumbo v2, "mhs.channel"

    invoke-static {v2}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v21

    const-string/jumbo v2, "mhs.maxclient"
    ...
    const-string/jumbo v5, "SamsungAP..."
    ...
    iget-boolean v5, v0, Landroid/net/wifi/WifiConfiguration;->isSamsungAp:Z
    ...
    const-string/jumbo v20, "12343df"
    ...
    iput-boolean v2, v0, Lcom/android/server/NetworkManagementService;->mMHSAllowAll:Z
