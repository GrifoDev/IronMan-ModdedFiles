...
.method public run()V
    ...
    const-string/jumbo v56, "/data/anr/traces.txt"
    ...
    invoke-virtual/range {v51 .. v51}, Ljava/io/File;->createNewFile()Z
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/android/server/Watchdog$HandlerChecker;->scheduleCheckLocked()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string/jumbo v57, "Failed to create /data/anr/traces.txt"

    invoke-static/range {v56 .. v57}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v58, "!@Sync "

    invoke-virtual/range {v57 .. v58}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v57

    sget v58, Lcom/android/server/Watchdog;->WSyncCount:I

    add-int/lit8 v59, v58, 0x1

    sput v59, Lcom/android/server/Watchdog;->WSyncCount:I
    ...
    invoke-direct/range {v59 .. v61}, Ljava/util/Date;-><init>(J)V

    invoke-virtual/range {v58 .. v59}, Ljava/text/SimpleDateFormat;->format(Ljava/util/Date;)Ljava/lang/String;
    ...
    const-string/jumbo v57, "/proc/self/fd"

    invoke-direct/range {v56 .. v57}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    invoke-virtual/range {v56 .. v56}, Ljava/io/File;->listFiles()[Ljava/io/File;
    ...
    const-string/jumbo v56, "===== fd_list: "
    ...
    new-instance v58, Ljava/util/Date;
    ...
    invoke-virtual/range {v57 .. v58}, Ljava/text/SimpleDateFormat;->format(Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-static/range {v58 .. v58}, Landroid/system/Os;->readlink(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v59, " -> readlink error"
    ...
    new-instance v56, Ljava/io/FileReader;

    const-string/jumbo v57, "/proc/self/maps"

    invoke-direct/range {v56 .. v57}, Ljava/io/FileReader;-><init>(Ljava/lang/String;)V
    ...
    const-string/jumbo v56, "/data/log/fd_list.txt"
    ...
    :try_start_a
    new-instance v36, Ljava/util/zip/GZIPOutputStream;
    ...
    const-string/jumbo v57, "UTF-8"

    invoke-virtual/range {v56 .. v57}, Ljava/lang/String;->getBytes(Ljava/lang/String;)[B
    ...
    invoke-virtual/range {v36 .. v36}, Ljava/util/zip/GZIPOutputStream;->close()V
    ...
    const-string/jumbo v57, "FD_LIST_INFO **********\n"
    ...
    new-instance v56, Ljava/io/FileWriter;
    ...
    const-string/jumbo v57, "!@ The number of fd in system_server is over (RLIMIT-100), so we make fd_list file for debugging."
    ...
    const-string/jumbo v57, "chown system:log /data/log/fd_list.txt"

    invoke-virtual/range {v56 .. v57}, Ljava/lang/Runtime;->exec(Ljava/lang/String;)Ljava/lang/Process;

    invoke-static {}, Ljava/lang/Runtime;->getRuntime()Ljava/lang/Runtime;

    move-result-object v56

    const-string/jumbo v57, "chmod 640 /data/log/fd_list.txt"
    ...
    sub-long v56, v56, v48

    const-wide/16 v58, 0x7530

    sub-long v52, v58, v56
    ...
    const-string/jumbo v57, "Failed to write system_server MAPS info"
    ...
    const-string/jumbo v57, "Failed to write contens in fd_list.txt"
    ...
    const-string/jumbo v58, "chown system:log /data/log/fd_list.txt"

    invoke-virtual/range {v57 .. v58}, Ljava/lang/Runtime;->exec(Ljava/lang/String;)Ljava/lang/Process;

    invoke-static {}, Ljava/lang/Runtime;->getRuntime()Ljava/lang/Runtime;

    move-result-object v57

    const-string/jumbo v58, "chmod 640 /data/log/fd_list.txt"
    ...
    const-string/jumbo v57, "!@ The number of fd in system_server is over (RLIMIT-100), so we ran dumpstate for debugging."

    invoke-static/range {v56 .. v57}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v56, "bugreportsem"
    ...
    sget-object v56, Lcom/android/server/Watchdog;->NATIVE_STACKS_OF_INTEREST:[Ljava/lang/String;
    ...
    const-string/jumbo v57, "!@*** WAITED_HALF"
    ...
    :goto_12
    sget-object v57, Lcom/android/server/Watchdog;->NATIVE_STACKS_OF_INTEREST:[Ljava/lang/String;
    ...
    const-wide/16 v56, 0x7d0

    invoke-static/range {v56 .. v57}, Landroid/os/SystemClock;->sleep(J)V
    ...
    const-string/jumbo v56, "PF"

    const-string/jumbo v57, "WD"

    invoke-static/range {v56 .. v57}, Landroid/os/Debug;->dumpResetReason(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v22, Lcom/android/server/Watchdog$1;

    const-string/jumbo v56, "watchdogWriteToDropbox"
    ...
    :goto_13
    const-string/jumbo v56, "persist.sys.crashOnWatchdog"

    const/16 v57, 0x0

    invoke-static/range {v56 .. v57}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v57, "Triggering SysRq for system_server watchdog"
    ...
    const-wide/16 v56, 0xbb8

    invoke-static/range {v56 .. v57}, Landroid/os/SystemClock;->sleep(J)V

    :try_start_1b
    new-instance v50, Ljava/io/FileWriter;

    const-string/jumbo v56, "/proc/sysrq-trigger"
    ...
    invoke-virtual/range {v50 .. v50}, Ljava/io/FileWriter;->close()V
    :try_end_1b
    ...
    const-string/jumbo v57, "Reporting stuck state to activity controller"

    invoke-static/range {v56 .. v57}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    :try_start_1d
    const-string/jumbo v56, "Service dumps disabled due to hung system process."

    invoke-static/range {v56 .. v56}, Landroid/os/Binder;->setDumpDisabled(Ljava/lang/String;)V
    ...
    const-string/jumbo v57, "Activity controller requested to coninue to wait"
    ...
    const-string/jumbo v57, "Failed to write \'c\' to /proc/sysrq-trigger"
    ...
    const-string/jumbo v57, "Debugger connected: Watchdog is *not* killing the system process"
    ...
    const-string/jumbo v57, "Debugger was connected: Watchdog is *not* killing the system process"
    ...
    const-string/jumbo v57, "Restart not allowed: Watchdog is *not* killing the system process"
    ...
    const-string/jumbo v58, "!@*** WATCHDOG KILLING SYSTEM PROCESS: "
    ...
    const-string/jumbo v56, "\"CAUSE\":\"!@*** WATCHDOG KILLING SYSTEM PROCESS: "
    ...
    add-int/lit8 v44, v56, 0x0

    const-string/jumbo v56, "\"STACK\":\""
    ...
    const-string/jumbo v57, "Watchdog"
    ...
    check-cast v56, Lcom/android/server/Watchdog$HandlerChecker;

    invoke-virtual/range {v56 .. v56}, Lcom/android/server/Watchdog$HandlerChecker;->getName()Ljava/lang/String;
    ...
    const-string/jumbo v58, " stack trace:"
    ...
    const-string/jumbo v57, " stack trace:"
    ...
    invoke-virtual/range {v56 .. v56}, Lcom/android/server/Watchdog$HandlerChecker;->getThread()Ljava/lang/Thread;

    move-result-object v56

    invoke-virtual/range {v56 .. v56}, Ljava/lang/Thread;->getStackTrace()[Ljava/lang/StackTraceElement;
    ...
    invoke-virtual/range {v27 .. v27}, Ljava/lang/StackTraceElement;->toString()Ljava/lang/String;
    ...
    const-string/jumbo v58, "ActivityConroller is set by "
    ...
    const-string/jumbo v57, "*** GOODBYE!"
    ...
    :try_start_1e
    new-instance v34, Ljava/io/FileWriter;

    const-string/jumbo v56, "/data/log/pf_reset_reason.txt"
    ...
    :try_start_20
    invoke-virtual/range {v34 .. v34}, Ljava/io/FileWriter;->close()V
    :try_end_20
    ...
    :cond_20
    :goto_19
    const-string/jumbo v56, "bugreportswd"
    ...
    const-string/jumbo v56, "sys.sf.restart"
    ...
    const-string/jumbo v58, "Failed to close /data/log/pf_reset_reason.txt"
    ...
    const-string/jumbo v58, "Failed to write to /data/log/pf_reset_reason.txt"
    ...
    const-string/jumbo v59, "Failed to close /data/log/pf_reset_reason.txt"
    ...
    invoke-static/range {v57 .. v58}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I
