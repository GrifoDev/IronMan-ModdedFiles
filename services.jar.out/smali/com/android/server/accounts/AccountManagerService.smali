...
.method static synthetic -wrap17(Lcom/android/server/accounts/AccountManagerService;Landroid/content/Intent;)V
    .locals 0
...
.method static synthetic -wrap19(Lcom/android/server/accounts/AccountManagerService;Lcom/android/server/accounts/AccountManagerService$UserAccounts;Landroid/accounts/Account;Ljava/lang/String;[BLjava/lang/String;Ljava/lang/String;J)V
    .locals 1
...
.method static synthetic -wrap20(Lcom/android/server/accounts/AccountManagerService;Landroid/accounts/IAccountManagerResponse;ILjava/lang/String;)V
    .locals 0
...
.method static synthetic -wrap21(Lcom/android/server/accounts/AccountManagerService;Landroid/accounts/IAccountManagerResponse;Landroid/os/Bundle;)V
    .locals 0
...
.method private isRemovePersonaForUser(Landroid/content/pm/UserInfo;)Ljava/lang/Boolean;
    ...
    const-string/jumbo v3, "isRemovePersonaForUser return true. mPersona == null user.id : "
    ...
    const-string/jumbo v3, "isRemovePersonaForUser return true. mPersona.getPersonaInfo(user.id) == null user.id : "
    ...
    const-string/jumbo v3, "isRemovePersonaForUser return : "
    ...
    invoke-virtual {v0, v3}, Lcom/samsung/android/knox/SemPersonaManager;->getPersonaInfo(I)Lcom/samsung/android/knox/SemPersonaInfo;

    move-result-object v3

    iget-boolean v3, v3, Lcom/samsung/android/knox/SemPersonaInfo;->removePersona:Z
    ...
    iget-boolean v1, v1, Lcom/samsung/android/knox/SemPersonaInfo;->removePersona:Z
...
.method private removeAccountInternal(Lcom/android/server/accounts/AccountManagerService$UserAccounts;Landroid/accounts/Account;I)Z
    ...
    iget-object v11, v0, Lcom/android/server/accounts/AccountManagerService$UserAccounts;->cacheLock:Ljava/lang/Object;
...
.method private validateAccountsInternal(Lcom/android/server/accounts/AccountManagerService$UserAccounts;Z)V
    ...
    invoke-virtual/range {v33 .. v33}, Landroid/content/pm/UserInfo;->isKnoxWorkspace()Z
    ...
    invoke-direct {v0, v1}, Lcom/android/server/accounts/AccountManagerService;->isRemovePersonaForUser(Landroid/content/pm/UserInfo;)Ljava/lang/Boolean;
    ...
    const-string/jumbo v5, " isRemovePersona true"
...
.method public removeAccountAsUser(Landroid/accounts/IAccountManagerResponse;Landroid/accounts/Account;ZI)V
    ...
    check-cast v18, Lcom/samsung/android/knox/EnterpriseDeviceManager;

    if-eqz v18, :cond_5

    invoke-virtual/range {v18 .. v18}, Lcom/samsung/android/knox/EnterpriseDeviceManager;->getDeviceAccountPolicy()Lcom/samsung/android/knox/accounts/DeviceAccountPolicy;
    ...
    invoke-virtual {v4, v6, v7, v12, v0}, Lcom/samsung/android/knox/accounts/DeviceAccountPolicy;->isAccountRemovalAllowedAsUser(Ljava/lang/String;Ljava/lang/String;ZI)Z
    ...
    const-string/jumbo v6, "Security policy blocks this account removal"
