...
.method static synthetic -wrap10(Lcom/android/server/display/DisplayManagerService;Landroid/os/Bundle;I)V
    .locals 0
...
.method static synthetic -wrap11(Lcom/android/server/display/DisplayManagerService;)V
    .locals 0
...
.method static synthetic -wrap12(Lcom/android/server/display/DisplayManagerService;Ljava/io/PrintWriter;)V
    .locals 0
...
.method static synthetic -wrap13(Lcom/android/server/display/DisplayManagerService;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic -wrap21(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/IDisplayManagerCallback;I)V
    .locals 0
...
.method static synthetic -wrap22(Lcom/android/server/display/DisplayManagerService;)V
    .locals 0
...
.method static synthetic -wrap23(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
    .locals 0
...
.method static synthetic -wrap24(Lcom/android/server/display/DisplayManagerService;Landroid/os/IBinder;)V
    .locals 0
...
.method static synthetic -wrap25(Lcom/android/server/display/DisplayManagerService;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic -wrap27(Lcom/android/server/display/DisplayManagerService;II)V
    .locals 0
...
.method static synthetic -wrap28(Lcom/android/server/display/DisplayManagerService;Landroid/os/IBinder;III)V
    .locals 0
...
.method static synthetic -wrap29(Lcom/android/server/display/DisplayManagerService;)V
    .locals 0
...
.method static synthetic -wrap30(Lcom/android/server/display/DisplayManagerService;Z)V
    .locals 0
...
.method static synthetic -wrap32(Lcom/android/server/display/DisplayManagerService;ILandroid/view/DisplayInfo;)V
    .locals 0
...
.method static synthetic -wrap33(Lcom/android/server/display/DisplayManagerService;III)V
    .locals 0
...
.method static synthetic -wrap34(Lcom/android/server/display/DisplayManagerService;IZFIZ)V
    .locals 0
...
.method static synthetic -wrap35(Lcom/android/server/display/DisplayManagerService;III)V
    .locals 0
...
.method static synthetic -wrap36(Lcom/android/server/display/DisplayManagerService;Landroid/os/IBinder;I)V
    .locals 0
...
.method static synthetic -wrap37(Lcom/android/server/display/DisplayManagerService;Landroid/os/IBinder;Landroid/view/Surface;)V
    .locals 0
...
.method static synthetic -wrap39(Lcom/android/server/display/DisplayManagerService;I)V
    .locals 0
...
.method static synthetic -wrap40(Lcom/android/server/display/DisplayManagerService;II)V
    .locals 0
...
.method static synthetic -wrap41(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
    .locals 0
...
.method static synthetic -wrap5(Lcom/android/server/display/DisplayManagerService;I)I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/display/DisplayManagerService;->getDisplayGravityInternal(I)I
...
.method static synthetic -wrap7(Lcom/android/server/display/DisplayManagerService;Landroid/os/Bundle;I)V
    .locals 0
...
.method static synthetic -wrap8(Lcom/android/server/display/DisplayManagerService;II)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p0, v5}, Lcom/android/server/display/DisplayManagerService$DisplayAdapterListener;-><init>(Lcom/android/server/display/DisplayManagerService;Lcom/android/server/display/DisplayManagerService$DisplayAdapterListener;)V
    ...
    iput-object v1, p0, Lcom/android/server/display/DisplayManagerService;->mPackageConfController:Lcom/android/server/PackageConfigurationController;
...
.method private configureDisplayInTransactionLocked(Lcom/android/server/display/DisplayDevice;)V
    ...
    :cond_3
    invoke-virtual {v0}, Lcom/android/server/display/LogicalDisplay;->isSwapped()Z
    ...
    :cond_6
    iget-object v3, p0, Lcom/android/server/display/DisplayManagerService;->mPointerViewport:Landroid/hardware/display/DisplayViewport;
...
.method private getDisplayGravityInternal(I)I
    .locals 1
...
.method private getDisplayInfoInternal(III)Landroid/view/DisplayInfo;
    ...
    iget-object v9, p0, Lcom/android/server/display/DisplayManagerService;->mPackageConfController:Lcom/android/server/PackageConfigurationController;

    if-eqz v9, :cond_1

    new-instance v3, Landroid/view/DisplayInfo;

    invoke-direct {v3, v4}, Landroid/view/DisplayInfo;-><init>(Landroid/view/DisplayInfo;)V

    invoke-virtual {v3, v4}, Landroid/view/DisplayInfo;->copyFrom(Landroid/view/DisplayInfo;)V

    iget-object v9, p0, Lcom/android/server/display/DisplayManagerService;->mPackageConfController:Lcom/android/server/PackageConfigurationController;

    invoke-interface {v9, p3}, Lcom/android/server/PackageConfigurationController;->isNaviBarNoneImmersivePackage(I)Z
    ...
    iget v7, p0, Lcom/android/server/display/DisplayManagerService;->mNaviBarHeight:I

    :cond_0
    sub-int v7, v9, v7

    iput v7, v3, Landroid/view/DisplayInfo;->appHeight:I
    ...
    invoke-interface {v7, p3}, Lcom/android/server/DssController;->isScaledApp(I)Z
    ...
    invoke-interface {v5, p3}, Lcom/android/server/DssController;->getScalingFactor(I)F
    ...
    iput v7, v3, Landroid/view/DisplayInfo;->logicalDensityDpi:I

    iget v7, v3, Landroid/view/DisplayInfo;->physicalXDpi:F
    ...
    iput v7, v3, Landroid/view/DisplayInfo;->physicalXDpi:F

    iget v7, v3, Landroid/view/DisplayInfo;->physicalYDpi:F
    ...
    iput v7, v3, Landroid/view/DisplayInfo;->physicalYDpi:F
    ...
    iput v7, v3, Landroid/view/DisplayInfo;->logicalHeight:I
    ...
    iget v7, v3, Landroid/view/DisplayInfo;->appHeight:I
    ...
    iput v7, v3, Landroid/view/DisplayInfo;->appWidth:I

    move-object v4, v3

    :cond_2
    iget-object v7, p0, Lcom/android/server/display/DisplayManagerService;->mPackageConfController:Lcom/android/server/PackageConfigurationController;

    if-eqz v7, :cond_3

    iget-object v7, p0, Lcom/android/server/display/DisplayManagerService;->mPackageConfController:Lcom/android/server/PackageConfigurationController;

    invoke-interface {v7, p3}, Lcom/android/server/PackageConfigurationController;->getAspectRatio(I)F
    ...
    iget v7, p0, Lcom/android/server/display/DisplayManagerService;->mNaviBarWidth:I
...
.method private getNavigationBarInfo()V
    .locals 2
    ...
    iput v0, p0, Lcom/android/server/display/DisplayManagerService;->mNaviBarHeight:I
    ...
    iput v0, p0, Lcom/android/server/display/DisplayManagerService;->mNaviBarWidth:I
...
.method private handleDisplayDeviceRemovedLocked(Lcom/android/server/display/DisplayDevice;)V
    ...
    const-string/jumbo v9, "Virtual device connected to logical display 0 being removed"

    invoke-static {v8, v9}, Lcom/android/server/power/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0, v12}, Lcom/android/server/display/DisplayManagerService;->overrideMainDisplay(Landroid/os/IBinder;)V

    invoke-static {v11}, Landroid/view/SurfaceControl;->getBuiltInDisplay(I)Landroid/os/IBinder;
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/display/LogicalDisplay;->setPrimaryDisplayDeviceLocked(Lcom/android/server/display/DisplayDevice;)V
    ...
    const-string/jumbo v9, "Didn\'t unroute display device 0"
    ...
    const-string/jumbo v10, "Attempted to remove non-existent display device: "
    ...
    const-string/jumbo v10, "chipname info: "
    ...
    const-string/jumbo v8, ".*smdk4x12.*"
    ...
    iget v8, v8, Lcom/android/server/display/DisplayDeviceInfo;->type:I
    ...
    const-string/jumbo v9, "remove saved sidesync information"
    ...
    iput-object v12, p0, Lcom/android/server/display/DisplayManagerService;->wifiDevice:Lcom/android/server/display/DisplayDevice;
    ...
    const-string/jumbo v10, "Display device removed: "
    ...
    iput-object v7, p1, Lcom/android/server/display/DisplayDevice;->mDebugLastLoggedDeviceInfo:Lcom/android/server/display/DisplayDeviceInfo;
...
.method private requestDisplayStateInternal(III)V
    ...
    invoke-direct {p0, v1, p2, p3, v5}, Lcom/android/server/display/DisplayManagerService;->updateDisplayStateLocked(Lcom/android/server/display/DisplayDevice;III)Ljava/lang/Runnable;
...
.method private setDisplayGravityInternal(IIZ)V
    .locals 0
...
.method private setDisplayInfoOverrideFromWindowManagerInternal(ILandroid/view/DisplayInfo;)V
    ...
    invoke-direct {p0}, Lcom/android/server/display/DisplayManagerService;->getNavigationBarInfo()V
...
.method private updateDisplayStateLocked(Lcom/android/server/display/DisplayDevice;III)Ljava/lang/Runnable;
    .locals 2
