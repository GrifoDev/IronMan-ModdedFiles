...
.field private mIsRtspTimeOutCase:Z
...
.method static synthetic -get12(Lcom/android/server/display/IpRemoteDisplayController;)Lcom/android/server/display/WFDUibcManager;
    .locals 1

    iget-object v0, p0, Lcom/android/server/display/IpRemoteDisplayController;->mWfdUibcManager:Lcom/android/server/display/WFDUibcManager;
...
.method static synthetic -get5(Lcom/android/server/display/IpRemoteDisplayController;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic -get6(Lcom/android/server/display/IpRemoteDisplayController;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/display/IpRemoteDisplayController;->mIsRtspTimeOutCase:Z
...
.method static synthetic -set3(Lcom/android/server/display/IpRemoteDisplayController;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/display/IpRemoteDisplayController;->mIsRtspTimeOutCase:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/display/IpRemoteDisplayController$Listener;)V
    ...
    iput-boolean v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mPrevNativeDisposeCompleted:Z

    const/4 v2, -0x1

    iput v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mConnectState:I

    new-instance v2, Lcom/android/server/display/IpRemoteDisplayController$1;

    invoke-direct {v2, p0}, Lcom/android/server/display/IpRemoteDisplayController$1;-><init>(Lcom/android/server/display/IpRemoteDisplayController;)V

    iput-object v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mRtspTimeout:Ljava/lang/Runnable;
    ...
    new-instance v2, Lcom/android/server/display/WFDUibcManager;

    iget-object v3, p0, Lcom/android/server/display/IpRemoteDisplayController;->mContext:Landroid/content/Context;

    invoke-direct {v2, v3}, Lcom/android/server/display/WFDUibcManager;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mWfdUibcManager:Lcom/android/server/display/WFDUibcManager;
    ...
    new-instance v0, Lcom/android/server/display/IpRemoteDisplayController$2;

    iget-object v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mHandler:Landroid/os/Handler;

    invoke-direct {v0, p0, v2, v1}, Lcom/android/server/display/IpRemoteDisplayController$2;-><init>(Lcom/android/server/display/IpRemoteDisplayController;Landroid/os/Handler;Landroid/content/ContentResolver;)V
    ...
    iput-boolean v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mSupportsProtectedBuffers:Z
...
.method private advertiseDisplay(Landroid/hardware/display/WifiDisplay;Landroid/view/Surface;IIII)V
    ...
    invoke-direct/range {v2 .. v14}, Lcom/android/server/display/IpRemoteDisplayController$10;-><init>(Lcom/android/server/display/IpRemoteDisplayController;Landroid/view/Surface;Landroid/view/Surface;Landroid/hardware/display/WifiDisplay;Landroid/hardware/display/WifiDisplay;IIIIZII)V
...
.method private broadcastWfdState(I)V
    ...
    iget-boolean v3, p0, Lcom/android/server/display/IpRemoteDisplayController;->mDisconnectByUser:Z

    if-eqz v3, :cond_0

    const-string/jumbo v3, "IpRemoteDisplayController"

    const-string/jumbo v4, "by_user : true"
...
.method private declared-synchronized disconnect()V
    ...
    invoke-virtual {v0}, Lcom/android/server/display/WFDUibcManager;->stop()Z

    iget-object v0, p0, Lcom/android/server/display/IpRemoteDisplayController;->mWfdUibcManager:Lcom/android/server/display/WFDUibcManager;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lcom/android/server/display/WFDUibcManager;->setCoupleShotMode(Z)V
...
.method private enableWifiDisplay(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string/jumbo v4, "enableWifiDisplay mRemoteDisplay already existed."
    ...
    iput v0, p0, Lcom/android/server/display/IpRemoteDisplayController;->mConnectState:I

    iget v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mConnectState:I
    ...
    invoke-direct {p0, v2, v4}, Lcom/android/server/display/IpRemoteDisplayController;->sendEventToSemDeviceStatusListener(II)V

    iget-object v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mConnectedDevice:Landroid/net/wifi/p2p/WifiP2pDevice;

    if-eqz v2, :cond_3

    iget-object v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mConnectedDevice:Landroid/net/wifi/p2p/WifiP2pDevice;

    invoke-direct {p0, v2}, Lcom/android/server/display/IpRemoteDisplayController;->createWifiDisplay(Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/hardware/display/WifiDisplay;

    move-result-object v3

    iget v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mConnectState:I

    invoke-direct {p0, v2}, Lcom/android/server/display/IpRemoteDisplayController;->isApMirroring(I)Z
    ...
    invoke-virtual {v3, v2}, Landroid/hardware/display/WifiDisplay;->setDeviceInfo(I)V

    iget-object v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mConnectedDeviceUri:Ljava/lang/String;

    invoke-virtual {v3, v2}, Landroid/hardware/display/WifiDisplay;->setUri(Ljava/lang/String;)V

    :cond_2
    iget v8, p0, Lcom/android/server/display/IpRemoteDisplayController;->mConnectState:I
    ...
    invoke-direct/range {v2 .. v8}, Lcom/android/server/display/IpRemoteDisplayController;->advertiseDisplay(Landroid/hardware/display/WifiDisplay;Landroid/view/Surface;IIII)V

    :cond_3
    iget-object v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mContext:Landroid/content/Context;

    new-instance v4, Lcom/android/server/display/IpRemoteDisplayController$7;

    invoke-direct {v4, p0}, Lcom/android/server/display/IpRemoteDisplayController$7;-><init>(Lcom/android/server/display/IpRemoteDisplayController;)V
    ...
    iget-object v2, p0, Lcom/android/server/display/IpRemoteDisplayController;->mWfdUibcManager:Lcom/android/server/display/WFDUibcManager;
    ...
    const-string/jumbo v5, "requestEnable processing init option :"
    ...
    invoke-direct {p0, v9, v2}, Lcom/android/server/display/IpRemoteDisplayController;->requestDataSetting(Lorg/json/JSONObject;I)V
    ...
    const-string/jumbo v5, "mRemoteDIsplayInterface = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, p0, Lcom/android/server/display/IpRemoteDisplayController;->mRemoteDisplayInterface:Ljava/lang/String;
    ...
    const-string/jumbo v5, "initParam = "
    ...
    const-string/jumbo v5, ", RTSP_TIMEOUT_SECONDS:"
    ...
    new-instance v4, Lcom/android/server/display/IpRemoteDisplayController$8;

    invoke-direct {v4, p0}, Lcom/android/server/display/IpRemoteDisplayController$8;-><init>(Lcom/android/server/display/IpRemoteDisplayController;)V

    iget-object v5, p0, Lcom/android/server/display/IpRemoteDisplayController;->mHandler:Landroid/os/Handler;

    iget-object v6, p0, Lcom/android/server/display/IpRemoteDisplayController;->mContext:Landroid/content/Context;
    ...
    invoke-static {v2, v4, v5, v6, v0}, Landroid/media/RemoteDisplay;->listen(Ljava/lang/String;Landroid/media/RemoteDisplay$Listener;Landroid/os/Handler;Ljava/lang/String;Ljava/lang/String;)Landroid/media/RemoteDisplay;
    ...
    iget-object v4, p0, Lcom/android/server/display/IpRemoteDisplayController;->mRtspTimeout:Ljava/lang/Runnable;
...
.method private sendEventToSemDeviceStatusListener(II)V
    ...
    invoke-direct {v1, p0, p2, p1}, Lcom/android/server/display/IpRemoteDisplayController$11;-><init>(Lcom/android/server/display/IpRemoteDisplayController;II)V
...
.method private sendEventToSemDisplayVolumeKeyListener(Landroid/os/Bundle;I)V
    ...
    invoke-direct {v1, p0, p2, p1}, Lcom/android/server/display/IpRemoteDisplayController$13;-><init>(Lcom/android/server/display/IpRemoteDisplayController;ILandroid/os/Bundle;)V
...
.method private sendEventToSemDisplayVolumeListener(Landroid/os/Bundle;I)V
    ...
    invoke-direct {v1, p0, p2, p1}, Lcom/android/server/display/IpRemoteDisplayController$12;-><init>(Lcom/android/server/display/IpRemoteDisplayController;ILandroid/os/Bundle;)V
...
.method public setHdmiConnectionState(Z)V
    ...
    const-string/jumbo v1, "HDMI Connected! we disconnect WFD!"

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    const v0, 0x22074

    invoke-direct {p0, v0}, Lcom/android/server/display/IpRemoteDisplayController;->requestPopup(I)V
