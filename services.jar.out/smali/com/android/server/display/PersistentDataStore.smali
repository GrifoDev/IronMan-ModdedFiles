...
.field private mRememberScreenRatioValue:Z
...
.method private loadFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    const-string/jumbo v2, "remembered-screen-ratio"
    ...
    const-string/jumbo v2, "loadFromXml call loadRememberedScreenRatioValueFromXml"

    invoke-static {v1, v2}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0, p1}, Lcom/android/server/display/PersistentDataStore;->loadRememberedScreenRatioValueFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
...
.method private loadRememberedScreenRatioValueFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    const-string/jumbo v3, "loadRememberedScreenRatioValueFromXml deviceName:"
    ...
    iput-boolean v1, p0, Lcom/android/server/display/PersistentDataStore;->mRememberScreenRatioValue:Z
...
.method private saveToXml(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-object v6, p0, Lcom/android/server/display/PersistentDataStore;->mRememberedDlnaDevice:Landroid/hardware/display/SemDlnaDevice;

    if-eqz v6, :cond_4

    const-string/jumbo v6, "remembered-dlna-device"

    invoke-interface {p1, v9, v6}, Lorg/xmlpull/v1/XmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    const-string/jumbo v6, "deviceName"

    iget-object v7, p0, Lcom/android/server/display/PersistentDataStore;->mRememberedDlnaDevice:Landroid/hardware/display/SemDlnaDevice;

    invoke-virtual {v7}, Landroid/hardware/display/SemDlnaDevice;->getDeviceName()Ljava/lang/String;

    move-result-object v7

    invoke-interface {p1, v9, v6, v7}, Lorg/xmlpull/v1/XmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    const-string/jumbo v6, "p2pmac"

    iget-object v7, p0, Lcom/android/server/display/PersistentDataStore;->mRememberedDlnaDevice:Landroid/hardware/display/SemDlnaDevice;

    invoke-virtual {v7}, Landroid/hardware/display/SemDlnaDevice;->getP2pMacAddress()Ljava/lang/String;

    move-result-object v7

    invoke-interface {p1, v9, v6, v7}, Lorg/xmlpull/v1/XmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    const-string/jumbo v6, "macfromarp"

    iget-object v7, p0, Lcom/android/server/display/PersistentDataStore;->mRememberedDlnaDevice:Landroid/hardware/display/SemDlnaDevice;

    invoke-virtual {v7}, Landroid/hardware/display/SemDlnaDevice;->getMacAddressFromArp()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Landroid/hardware/display/SemDlnaDevice;->getNetType()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Landroid/hardware/display/SemDlnaDevice;->getUid()Ljava/lang/String;

    move-result-object v7

    invoke-interface {p1, v9, v6, v7}, Lorg/xmlpull/v1/XmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    const-string/jumbo v6, "dlnatype"

    iget-object v7, p0, Lcom/android/server/display/PersistentDataStore;->mRememberedDlnaDevice:Landroid/hardware/display/SemDlnaDevice;

    invoke-virtual {v7}, Landroid/hardware/display/SemDlnaDevice;->getDlnaType()I
    ...
    invoke-virtual {v6}, Landroid/hardware/display/SemDlnaDevice;->getUri()Ljava/lang/String;
    ...
    invoke-virtual {v7}, Landroid/hardware/display/SemDlnaDevice;->getUri()Ljava/lang/String;
    ...
    const-string/jumbo v6, "DisplayManager"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "saveToXml deviceName:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/server/display/PersistentDataStore;->mRememberedDlnaDevice:Landroid/hardware/display/SemDlnaDevice;

    invoke-virtual {v8}, Landroid/hardware/display/SemDlnaDevice;->getDeviceName()Ljava/lang/String;
    ...
    const-string/jumbo v8, ", p2pMacAddress:"
    ...
    invoke-virtual {v8}, Landroid/hardware/display/SemDlnaDevice;->getP2pMacAddress()Ljava/lang/String;
    ...
    const-string/jumbo v8, ", macAddressFromARP:"
    ...
    invoke-virtual {v8}, Landroid/hardware/display/SemDlnaDevice;->getMacAddressFromArp()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Landroid/hardware/display/SemDlnaDevice;->getNetType()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Landroid/hardware/display/SemDlnaDevice;->getUid()Ljava/lang/String;
    ...
    const-string/jumbo v8, ", dlnatype:"
    ...
    invoke-virtual {v8}, Landroid/hardware/display/SemDlnaDevice;->getDlnaType()I
    ...
    invoke-virtual {v8}, Landroid/hardware/display/SemDlnaDevice;->getUri()Ljava/lang/String;
    ...
    :cond_4
    iget-object v6, p0, Lcom/android/server/display/PersistentDataStore;->mRememberedGCastDevice:Ljava/lang/String;

    if-eqz v6, :cond_5

    const-string/jumbo v6, "remembered-gcast-device"

    invoke-interface {p1, v9, v6}, Lorg/xmlpull/v1/XmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    const-string/jumbo v6, "deviceName"

    iget-object v7, p0, Lcom/android/server/display/PersistentDataStore;->mRememberedGCastDevice:Ljava/lang/String;
    ...
    const-string/jumbo v8, "saveToXml remembered GCastDevice deviceName:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/server/display/PersistentDataStore;->mRememberedGCastDevice:Ljava/lang/String;
    ...
    :cond_5
    const-string/jumbo v6, "remembered-screen-ratio"

    invoke-interface {p1, v9, v6}, Lorg/xmlpull/v1/XmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    const-string/jumbo v6, "screenRatioValue"

    iget-boolean v7, p0, Lcom/android/server/display/PersistentDataStore;->mRememberScreenRatioValue:Z
    ...
    const-string/jumbo v8, "saveToXml remembered screen ratio value:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-boolean v8, p0, Lcom/android/server/display/PersistentDataStore;->mRememberScreenRatioValue:Z
...
.method public getRememberedScreenRatioValue()Z
    .locals 1

    invoke-virtual {p0}, Lcom/android/server/display/PersistentDataStore;->loadIfNeeded()V

    iget-boolean v0, p0, Lcom/android/server/display/PersistentDataStore;->mRememberScreenRatioValue:Z
...
.method public rememberScreenRatioValue(Z)Z
    .locals 3
    ...
    const-string/jumbo v2, "rememberScreenRatioValue = "
    ...
    const-string/jumbo v2, "mRememberScreenRatioValue already "
    ...
    :cond_0
    iput-boolean p1, p0, Lcom/android/server/display/PersistentDataStore;->mRememberScreenRatioValue:Z
