...
.method static synthetic -wrap21(Lcom/android/server/display/WifiDisplayController;II)V
    .locals 0
...
.method static synthetic -wrap22(Lcom/android/server/display/WifiDisplayController;I)V
    .locals 0
...
.method static synthetic -wrap23(Lcom/android/server/display/WifiDisplayController;Landroid/hardware/display/WifiDisplay;)V
    .locals 0
...
.method static synthetic -wrap24(Lcom/android/server/display/WifiDisplayController;I)V
    .locals 0
...
.method private createConnectConfig(Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/net/wifi/p2p/WifiP2pConfig;
    ...
    const-string/jumbo v6, "set groupOwnerIntent : "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, v1, Landroid/net/wifi/p2p/WifiP2pConfig;->groupOwnerIntent:I
    ...
    const-string/jumbo v6, "iconIdx :"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, p1, Landroid/net/wifi/p2p/WifiP2pDevice;->iconIdx:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string/jumbo v6, " kddi : "
    ...
    const-string/jumbo v5, "set PERSISTENT_NET_ID"

    invoke-static {v4, v5}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    const/4 v4, -0x2

    iput v4, v1, Landroid/net/wifi/p2p/WifiP2pConfig;->netId:I
    ...
    const-string/jumbo v6, "createConnectConfig() :: name = "
    ...
    invoke-virtual {v4}, Landroid/hardware/display/SemDeviceInfo;->isPinRequest()Z
    ...
    :cond_3
    iput v6, v1, Landroid/net/wifi/p2p/WifiP2pConfig;->groupOwnerIntent:I
...
.method private sendDeviceVolumeChangedEvent(ILandroid/os/Bundle;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/display/WifiDisplayController$31;-><init>(Lcom/android/server/display/WifiDisplayController;ILandroid/os/Bundle;)V
...
.method private sendRemoteDisplayStateChangeEvent(II)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/display/WifiDisplayController$30;-><init>(Lcom/android/server/display/WifiDisplayController;II)V
...
.method public enableCPUBoosting(Z)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/display/WifiDisplayController$32;-><init>(Lcom/android/server/display/WifiDisplayController;Z)V
