...
.method private onLoadSoundEffects()Z
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get74(Lcom/android/server/audio/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get82(Lcom/android/server/audio/AudioService;)Z
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get76(Lcom/android/server/audio/AudioService;)Landroid/media/SoundPool;
    :try_end_1
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-wrap33(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v10, v12}, Lcom/android/server/audio/AudioService;->-set41(Lcom/android/server/audio/AudioService;Landroid/media/SoundPool;)Landroid/media/SoundPool;

    iget-object v10, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    const/4 v12, 0x0

    invoke-static {v10, v12}, Lcom/android/server/audio/AudioService;->-set42(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioService$SoundPoolCallback;)Lcom/android/server/audio/AudioService$SoundPoolCallback;
    ...
    invoke-static {v10, v12}, Lcom/android/server/audio/AudioService;->-set43(Lcom/android/server/audio/AudioService;Lcom/android/server/audio/AudioService$SoundPoolListenerThread;)Lcom/android/server/audio/AudioService$SoundPoolListenerThread;

    iget-object v10, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get78(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$SoundPoolListenerThread;
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get77(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$SoundPoolCallback;
    :try_end_2
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get79(Lcom/android/server/audio/AudioService;)Landroid/os/Looper;
    ...
    invoke-static {v10, v12}, Lcom/android/server/audio/AudioService;->-set44(Lcom/android/server/audio/AudioService;Landroid/os/Looper;)Landroid/os/Looper;
    ...
    :cond_5
    :try_start_6
    invoke-static {}, Lcom/android/server/audio/AudioService;->-get5()Ljava/util/List;
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get6(Lcom/android/server/audio/AudioService;)[[I
    ...
    invoke-static {v10}, Lcom/android/server/audio/AudioService;->-get4(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
    ...
    invoke-static {v12}, Lcom/android/server/audio/AudioService;->-get4(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
    ...
    invoke-static {v13}, Lcom/android/server/audio/AudioService;->-get6(Lcom/android/server/audio/AudioService;)[[I
    ...
    invoke-static {v12}, Lcom/android/server/audio/AudioService;->-get6(Lcom/android/server/audio/AudioService;)[[I
...
.method private onPlaySoundEffect(II)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get74(Lcom/android/server/audio/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get76(Lcom/android/server/audio/AudioService;)Landroid/media/SoundPool;
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get6(Lcom/android/server/audio/AudioService;)[[I
    ...
    invoke-static {v1}, Lcom/android/server/audio/AudioService;->-get6(Lcom/android/server/audio/AudioService;)[[I
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get48(Lcom/android/server/audio/AudioService;)Z
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get4(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/audio/AudioService;->-get4(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/android/server/audio/AudioService;->-get6(Lcom/android/server/audio/AudioService;)[[I
...
.method private onUnloadSoundEffects()V
    ...
    invoke-static {v3}, Lcom/android/server/audio/AudioService;->-get74(Lcom/android/server/audio/AudioService;)Ljava/lang/Object;
    ...
    invoke-static {v3}, Lcom/android/server/audio/AudioService;->-get76(Lcom/android/server/audio/AudioService;)Landroid/media/SoundPool;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v5}, Lcom/android/server/audio/AudioService;->-get6(Lcom/android/server/audio/AudioService;)[[I
    ...
    invoke-static {v3, v5}, Lcom/android/server/audio/AudioService;->-set41(Lcom/android/server/audio/AudioService;Landroid/media/SoundPool;)Landroid/media/SoundPool;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method private persistRingerMode(I)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get86(Lcom/android/server/audio/AudioService;)Z
...
.method private persistVolume(Lcom/android/server/audio/AudioService$VolumeStreamState;I)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get81(Lcom/android/server/audio/AudioService;)[I
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get18(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$AudioHandler;
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/server/audio/AudioService;->-wrap59(Landroid/os/Handler;IIIILjava/lang/Object;I)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get12(Lcom/android/server/audio/AudioService;)Landroid/bluetooth/BluetoothA2dp;
    ...
    invoke-static {v1}, Lcom/android/server/audio/AudioService;->-get11(Lcom/android/server/audio/AudioService;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/android/server/audio/AudioService$AudioHandler;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get10(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get22(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
...
.method private setAllVolumes(Lcom/android/server/audio/AudioService$VolumeStreamState;)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get81(Lcom/android/server/audio/AudioService;)[I
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get80(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
...
.method private setDeviceVolume(Lcom/android/server/audio/AudioService$VolumeStreamState;I)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get80(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get40(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$FineVolumeState;
    ...
    invoke-static {v1}, Lcom/android/server/audio/AudioService;->-get40(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$FineVolumeState;
...
.method private setForceUse(II)V
    ...
    invoke-static {v0}, Lcom/android/server/audio/AudioService;->-get30(Lcom/android/server/audio/AudioService;)Landroid/util/ArrayMap;
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/audio/AudioService;->-wrap64(Lcom/android/server/audio/AudioService;II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    check-cast v25, Lcom/android/server/audio/AudioService$LoadSoundEffectReply;
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/server/audio/AudioService$LoadSoundEffectReply;->notify()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get30(Lcom/android/server/audio/AudioService;)Landroid/util/ArrayMap;
    ...
    invoke-static {v4, v2}, Lcom/android/server/audio/AudioService;->-wrap34(Lcom/android/server/audio/AudioService;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-static {}, Lcom/android/server/audio/AudioService;->-get8()Z
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get18(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$AudioHandler;
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get82(Lcom/android/server/audio/AudioService;)Z
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get17(Lcom/android/server/audio/AudioService;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/server/audio/AudioService;->-wrap45(Lcom/android/server/audio/AudioService;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v2, v4}, Lcom/android/server/audio/AudioService;->-wrap44(Lcom/android/server/audio/AudioService;Landroid/bluetooth/BluetoothDevice;I)V
    ...
    invoke-static {v2, v4, v5}, Lcom/android/server/audio/AudioService;->-set27(Lcom/android/server/audio/AudioService;J)J
    ...
    invoke-static {v3, v2, v4}, Lcom/android/server/audio/AudioService;->-wrap43(Lcom/android/server/audio/AudioService;Landroid/bluetooth/BluetoothDevice;I)V
    ...
    check-cast v23, Landroid/media/IAudioRoutesObserver;
    ...
    invoke-static {v2, v3}, Lcom/android/server/audio/AudioService;->-wrap35(Lcom/android/server/audio/AudioService;I)V
    ...
    invoke-static {v3, v2}, Lcom/android/server/audio/AudioService;->-wrap37(Lcom/android/server/audio/AudioService;Ljava/lang/String;)V
    ...
    invoke-static {v4, v3, v2}, Lcom/android/server/audio/AudioService;->-wrap39(Lcom/android/server/audio/AudioService;ZLjava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get44(Lcom/android/server/audio/AudioService;)Lcom/samsung/android/game/IGameManagerService;
    ...
    invoke-static {v2, v3}, Lcom/android/server/audio/AudioService;->-set17(Lcom/android/server/audio/AudioService;Lcom/samsung/android/game/IGameManagerService;)Lcom/samsung/android/game/IGameManagerService;
    :try_end_4
    ...
    invoke-static {v2, v3, v4}, Lcom/android/server/audio/AudioService;->-wrap46(Lcom/android/server/audio/AudioService;II)V
    ...
    invoke-static {v3, v2, v4}, Lcom/android/server/audio/AudioService;->-wrap40(Lcom/android/server/audio/AudioService;Ljava/lang/String;I)V
    ...
    invoke-static {v2, v3}, Lcom/android/server/audio/AudioService;->-set14(Lcom/android/server/audio/AudioService;Z)Z
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-wrap79(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v2, v3}, Lcom/android/server/audio/AudioService;->-set23(Lcom/android/server/audio/AudioService;Z)Z
    ...
    invoke-static {v2, v3}, Lcom/android/server/audio/AudioService;->-set26(Lcom/android/server/audio/AudioService;Z)Z
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get15(Lcom/android/server/audio/AudioService;)I
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get63(Lcom/android/server/audio/AudioService;)I
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get90(Lcom/android/server/audio/AudioService;)Lcom/samsung/android/os/SemDvfsManager;
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get27(Lcom/android/server/audio/AudioService;)I
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-wrap20(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get75(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/AudioService$SoundKitchen;
    ...
    invoke-static {v2, v10}, Lcom/android/server/audio/AudioService;->-wrap57(Lcom/android/server/audio/AudioService;Landroid/content/Intent;)V
    ...
    invoke-interface {v0, v3, v2}, Landroid/media/session/ISessionManager;->updateMultiSoundInfo(IZ)V
    :try_end_6
    ...
    const-string/jumbo v3, "Error in updateMultiSoundInfo."
    ...
    invoke-static {v2, v0}, Lcom/android/server/audio/AudioService;->-wrap56(Lcom/android/server/audio/AudioService;I)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->-get52(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/MediaFocusControl;
    ...
    invoke-static {v2, v11}, Lcom/android/server/audio/AudioService;->-wrap57(Lcom/android/server/audio/AudioService;Landroid/content/Intent;)V
    ...
    invoke-interface {v0, v2, v3}, Landroid/media/session/ISessionManager;->updateMultiSoundInfo(IZ)V
    :try_end_9
    ...
    invoke-static {v2, v3}, Lcom/android/server/audio/AudioService;->-set32(Lcom/android/server/audio/AudioService;I)I
    ...
    invoke-static {v4}, Lcom/android/server/audio/AudioService;->-get80(Lcom/android/server/audio/AudioService;)[Lcom/android/server/audio/AudioService$VolumeStreamState;
    ...
    invoke-static {v2, v6, v3, v4, v5}, Lcom/android/server/audio/AudioService;->-wrap61(Lcom/android/server/audio/AudioService;IIII)V
