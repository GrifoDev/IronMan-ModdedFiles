...
.method private resetByEnableDisable()V
    ...
    invoke-static {v6}, Lcom/android/server/audio/AudioService;->-get62(Lcom/android/server/audio/AudioService;)Landroid/app/IProcessObserver;
    ...
    invoke-static {v5}, Lcom/android/server/audio/AudioService;->-get52(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/MediaFocusControl;
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    invoke-static {v6, v7}, Lcom/android/server/audio/AudioService;->-wrap17(Lcom/android/server/audio/AudioService;I)[Ljava/lang/String;
...
.method public getAppDevice(I)I
    ...
    invoke-static {v5}, Lcom/android/server/audio/AudioService;->-get30(Lcom/android/server/audio/AudioService;)Landroid/util/ArrayMap;
...
.method public getPinAppInfo(I)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/server/audio/AudioService;->-get60(Lcom/android/server/audio/AudioService;)Landroid/content/pm/PackageManager;

    move-result-object v5

    iget-object v6, p0, Lcom/android/server/audio/AudioService$SoundKitchen;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {v6}, Lcom/android/server/audio/AudioService;->-get60(Lcom/android/server/audio/AudioService;)Landroid/content/pm/PackageManager;

    move-result-object v6

    iget-object v7, p0, Lcom/android/server/audio/AudioService$SoundKitchen;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {v7, v4}, Lcom/android/server/audio/AudioService;->-wrap17(Lcom/android/server/audio/AudioService;I)[Ljava/lang/String;
...
.method public getPinPackageName(I)[Ljava/lang/String;
    ...
    invoke-static {v5, v6}, Lcom/android/server/audio/AudioService;->-wrap17(Lcom/android/server/audio/AudioService;I)[Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public resetByAudioServerDied()V
    ...
    const-string/jumbo v5, "resetByAudioServerDied"
    ...
    invoke-virtual {v2, v5}, Lcom/android/server/audio/AudioService$SoundKitchen$SoundKitchenItem;->getAppDevice(Z)I

    move-result v5

    invoke-direct {p0, v4, v5}, Lcom/android/server/audio/AudioService$SoundKitchen;->setDeviceToNative(II)V
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/server/audio/AudioService$SoundKitchen;->setVolumeToNative(II)V
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/server/audio/AudioService$SoundKitchen;->setMaxLimitedSpkVolumeToNative(IZ)V
...
.method public setAppDevice(II)V
    ...
    :goto_0
    invoke-virtual {v0, v5}, Lcom/android/server/audio/AudioService$SoundKitchen$SoundKitchenItem;->setAppDevice(I)V

    invoke-virtual {v0}, Lcom/android/server/audio/AudioService$SoundKitchen$SoundKitchenItem;->getUid()I

    move-result v1

    invoke-direct {p0, v1, v5}, Lcom/android/server/audio/AudioService$SoundKitchen;->setDeviceToNative(II)V

    iget-object v1, p0, Lcom/android/server/audio/AudioService$SoundKitchen;->this$0:Lcom/android/server/audio/AudioService;

    invoke-static {v1}, Lcom/android/server/audio/AudioService;->-get52(Lcom/android/server/audio/AudioService;)Lcom/android/server/audio/MediaFocusControl;
