...
.method static synthetic -get11(Lcom/android/server/VibratorService;)I
    .locals 1
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mTmpWorkSource:Landroid/os/WorkSource;

    new-instance v9, Landroid/os/Handler;

    invoke-direct {v9}, Landroid/os/Handler;-><init>()V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mH:Landroid/os/Handler;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mInputDeviceVibrators:Ljava/util/ArrayList;
    ...
    const-string/jumbo v10, "MM-dd HH:mm:ss.SSS"

    invoke-direct {v9, v10}, Ljava/text/SimpleDateFormat;-><init>(Ljava/lang/String;)V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mTimeFormat:Ljava/text/SimpleDateFormat;

    const/4 v9, 0x0

    iput-boolean v9, p0, Lcom/android/server/VibratorService;->mIsEnableIntensity:Z

    const/4 v9, 0x0

    iput-boolean v9, p0, Lcom/android/server/VibratorService;->mIsHapticSupported:Z
    ...
    iput-boolean v9, p0, Lcom/android/server/VibratorService;->mIsHapticEngineSupported:Z

    const/4 v9, 0x0

    iput-boolean v9, p0, Lcom/android/server/VibratorService;->mIsForceTouchIntensitySupported:Z
    ...
    const-string/jumbo v11, "CscFeature_Framework_ConfigVibService"
    ...
    iput-boolean v9, p0, Lcom/android/server/VibratorService;->mUseMax:Z

    new-instance v9, Ljava/util/HashSet;

    invoke-direct {v9}, Ljava/util/HashSet;-><init>()V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mActAlwaysPkgs:Ljava/util/HashSet;

    const/16 v9, 0x270f

    iput v9, p0, Lcom/android/server/VibratorService;->mTouchMagnitude:I

    const/16 v9, 0x270f

    iput v9, p0, Lcom/android/server/VibratorService;->mCallMagnitude:I

    const/16 v9, 0x270f

    iput v9, p0, Lcom/android/server/VibratorService;->mNotiMagnitude:I

    const/16 v9, 0x270f

    iput v9, p0, Lcom/android/server/VibratorService;->mMaxMagnitude:I

    const/16 v9, 0x270f

    iput v9, p0, Lcom/android/server/VibratorService;->mMinMagnitude:I

    const/16 v9, 0x270f

    iput v9, p0, Lcom/android/server/VibratorService;->mForceMagnitude:I

    const/4 v9, -0x1

    iput v9, p0, Lcom/android/server/VibratorService;->mMotorType:I

    new-instance v9, Ljava/util/HashMap;

    invoke-direct {v9}, Ljava/util/HashMap;-><init>()V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mVibePatternHash:Ljava/util/HashMap;

    const/4 v9, 0x0

    iput v9, p0, Lcom/android/server/VibratorService;->mCheckExecutable:I

    const-string/jumbo v9, ""

    iput-object v9, p0, Lcom/android/server/VibratorService;->mCheckExecutablePkg:Ljava/lang/String;

    const/4 v9, 0x0

    iput-boolean v9, p0, Lcom/android/server/VibratorService;->mCameraOn:Z
    ...
    iput v9, p0, Lcom/android/server/VibratorService;->mHMTMountCount:I

    new-instance v9, Lcom/android/server/VibratorService$1;

    invoke-direct {v9, p0}, Lcom/android/server/VibratorService$1;-><init>(Lcom/android/server/VibratorService;)V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mVibrationRunnable:Ljava/lang/Runnable;

    new-instance v9, Lcom/android/server/VibratorService$2;

    invoke-direct {v9, p0}, Lcom/android/server/VibratorService$2;-><init>(Lcom/android/server/VibratorService;)V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string/jumbo v9, "VibratorService"

    const/4 v10, 0x1

    invoke-virtual {v5, v10, v9}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v9

    iput-object v9, p0, Lcom/android/server/VibratorService;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    iget-object v9, p0, Lcom/android/server/VibratorService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mAppOpsService:Lcom/android/internal/app/IAppOpsService;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mBatteryStatsService:Lcom/android/internal/app/IBatteryStats;
    ...
    iput v9, p0, Lcom/android/server/VibratorService;->mPreviousVibrationsLimit:I

    new-instance v9, Ljava/util/LinkedList;

    invoke-direct {v9}, Ljava/util/LinkedList;-><init>()V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mVibrations:Ljava/util/LinkedList;

    new-instance v9, Ljava/util/LinkedList;

    invoke-direct {v9}, Ljava/util/LinkedList;-><init>()V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mPreviousVibrations:Ljava/util/LinkedList;

    new-instance v9, Ljava/util/LinkedList;

    invoke-direct {v9}, Ljava/util/LinkedList;-><init>()V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mPreviousNoTouchVibrations:Ljava/util/LinkedList;
    ...
    const-string/jumbo v9, "com.sec.android.app.camera.ACTION_CAMERA_START"

    invoke-virtual {v1, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string/jumbo v9, "com.sec.android.app.camera.ACTION_CAMERA_STOP"

    invoke-virtual {v1, v9}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    iget-object v9, p0, Lcom/android/server/VibratorService;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-boolean v9, p0, Lcom/android/server/VibratorService;->mUseMax:Z

    if-eqz v9, :cond_0

    sget-object v9, Lcom/android/server/VibratorService;->PKG_ACT_ALWAYS:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/server/VibratorService;->mActAlwaysPkgs:Ljava/util/HashSet;
    ...
    invoke-virtual {p0, v6, v9, v10}, Lcom/android/server/VibratorService;->createPatternInfo(Landroid/content/res/Resources;II)Lcom/android/server/VibratorService$PatternInfo;

    move-result-object v9

    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_A:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_B:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_C:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_D:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_E:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_F:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_G:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_H:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_I:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_J:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_K:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_L:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_M:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_N:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_O:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_P:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_Q:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_R:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_S:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_T:Lcom/android/server/VibratorService$PatternInfo;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mPatternInfo_U:Lcom/android/server/VibratorService$PatternInfo;
    ...
    sget-boolean v9, Lcom/android/server/VibratorService;->SAFE_DEBUG:Z
    ...
    const-string/jumbo v11, "mMType : "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget v11, p0, Lcom/android/server/VibratorService;->mMotorType:I
    ...
    iget-boolean v11, p0, Lcom/android/server/VibratorService;->mIsHapticEngineSupported:Z
    ...
    iget-boolean v11, p0, Lcom/android/server/VibratorService;->mIsForceTouchIntensitySupported:Z
    ...
    :goto_1
    iget-boolean v9, p0, Lcom/android/server/VibratorService;->mIsEnableIntensity:Z

    if-eqz v9, :cond_d

    iget-object v9, p0, Lcom/android/server/VibratorService;->LEVEL_TO_MAGNITUDE:[I

    array-length v9, v9

    add-int/lit8 v4, v9, -0x1

    iget-object v9, p0, Lcom/android/server/VibratorService;->LEVEL_TO_TOUCH_MAGNITUDE:[I
    ...
    const-string/jumbo v11, "magnitudeMaxLevel : "
    ...
    const-string/jumbo v11, ", touchMagnitudeMaxLevel : "
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->LEVEL_TO_MAGNITUDE:[I
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->LEVEL_TO_TOUCH_MAGNITUDE:[I
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mContentResolver:Landroid/content/ContentResolver;

    new-instance v9, Lcom/android/server/VibratorService$SecSettingsObserver;

    const/4 v10, 0x0

    invoke-direct {v9, p0, v10}, Lcom/android/server/VibratorService$SecSettingsObserver;-><init>(Lcom/android/server/VibratorService;I)V

    iput-object v9, p0, Lcom/android/server/VibratorService;->mTouchMagnitudeObserver:Lcom/android/server/VibratorService$SecSettingsObserver;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mCallMagnitudeObserver:Lcom/android/server/VibratorService$SecSettingsObserver;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mNotiMagnitudeObserver:Lcom/android/server/VibratorService$SecSettingsObserver;

    iget-object v9, p0, Lcom/android/server/VibratorService;->mContentResolver:Landroid/content/ContentResolver;

    sget-object v10, Lcom/android/server/VibratorService;->TYPE_URI:[Ljava/lang/String;
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->LEVEL_TO_FORCE_MAGNITUDE:[I
    ...
    iput-object v9, p0, Lcom/android/server/VibratorService;->mForceMagnitudeObserver:Lcom/android/server/VibratorService$SecSettingsObserver;

    iget-object v9, p0, Lcom/android/server/VibratorService;->LEVEL_TO_FORCE_MAGNITUDE:[I
    ...
    const-string/jumbo v11, "touchForceMagnitudeMaxLevel : "
    ...
    iget-boolean v9, p0, Lcom/android/server/VibratorService;->mIsForceTouchIntensitySupported:Z

    if-eqz v9, :cond_c

    iget v9, p0, Lcom/android/server/VibratorService;->mForceMagnitude:I

    int-to-long v10, v9

    invoke-static {v10, v11}, Lcom/android/server/VibratorService;->vibratorForceTouchIntensity(J)V

    :cond_c
    iget v9, p0, Lcom/android/server/VibratorService;->mNotiMagnitude:I

    invoke-direct {p0, v9}, Lcom/android/server/VibratorService;->setIntensity(I)V
...
.method private addToPreviousVibrationsLocked(Lcom/android/server/VibratorService$Vibration;)V
    ...
    iget v0, v0, Lcom/android/server/VibratorService;->mNotiMagnitude:I
...
.method private doVibratorOn(JII[IIII)V
    ...
    const-string/jumbo v8, " is not working because HMTMount is TRUE."
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "  mMinM = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/VibratorService;->mMinMagnitude:I
    ...
    iget-boolean v3, p0, Lcom/android/server/VibratorService;->mIsEnableIntensity:Z
    ...
    iget-boolean v3, p0, Lcom/android/server/VibratorService;->mIsHapticSupported:Z
    ...
    const-string/jumbo v3, "  mIsSupportedFTI = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/VibratorService;->mIsForceTouchIntensitySupported:Z
    ...
    const-string/jumbo v3, "  USE_SET_MAX_M = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lcom/android/server/VibratorService;->mUseMax:Z
...
.method public semColorfulVibrate(ILjava/lang/String;[IILandroid/os/IBinder;IIILjava/lang/String;)V
    ...
    iget-boolean v6, v0, Lcom/android/server/VibratorService;->mIsEnableIntensity:Z
    ...
    iget v6, v0, Lcom/android/server/VibratorService;->mNotiMagnitude:I
    ...
    const-string/jumbo v10, " is not supported.(color)"
...
.method public vibrateMagnitude(ILjava/lang/String;JILandroid/os/IBinder;ILjava/lang/String;)V
    ...
    invoke-direct {p0, p8, p2}, Lcom/android/server/VibratorService;->getMagnitude(Ljava/lang/String;Ljava/lang/String;)I
...
.method public vibratePatternMagnitude(ILjava/lang/String;[JIILandroid/os/IBinder;IILjava/lang/String;)V
    ...
    iget v7, v0, Lcom/android/server/VibratorService;->mNotiMagnitude:I
    ...
    iget v5, v0, Lcom/android/server/VibratorService;->mNotiMagnitude:I
