...
.method static synthetic -wrap10(Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;ZLcom/samsung/accessory/manager/authentication/cover/CoverInfo;Lcom/samsung/accessory/manager/authentication/AuthenticationResult;)V
    .locals 0
...
.method static synthetic -wrap11(Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;ZJ)V
    .locals 0
...
.method static synthetic -wrap12(Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;)V
    .locals 0
...
.method static synthetic -wrap13(Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;J)V
    .locals 1
...
.method private checkCurrentHall()V
    ...
    invoke-virtual {v0, v3, v2, v1}, Lcom/android/server/input/InputManagerService;->getSwitchState(III)I
...
.method private getCoverSwitchState()I
    ...
    iget v1, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->currentHall:I
    ...
    invoke-virtual {v0, v4, v3, v1}, Lcom/android/server/input/InputManagerService;->getSwitchState(III)I
    ...
    :cond_0
    iget-object v1, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mInputManager:Lcom/android/server/input/InputManagerService;
...
.method private handleAuthResponse(Landroid/os/Message;)V
    ...
    iget-object v4, v0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mCurrentSession:Lcom/samsung/accessory/manager/authentication/AuthenticationSession;
    ...
    const-string/jumbo v5, "handleAuthResponse, mCurrentSession is null"
    ...
    invoke-virtual {v4, v5}, Lcom/samsung/accessory/manager/authentication/AuthenticationSession;->setCurrentHall(I)V
    ...
    check-cast v21, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;->getResultBundle()Landroid/os/Bundle;
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;->getApiState()I
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;->getExtraId()[B
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;->getPublicKey()Ljava/lang/String;
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;->getStringManagerURI()Ljava/lang/String;
    ...
    invoke-virtual {v12}, Lcom/samsung/accessory/manager/authentication/cover/CoverInfo;->getReserved()B
    ...
    iput v4, v0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->currentHall:I
    ...
    invoke-virtual {v4, v5, v6, v7}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthHandler;->sendEmptyMessageDelayed(IJ)Z
    ...
    const-string/jumbo v5, "Authentication is success, but Accessory is detached."
    ...
    invoke-direct {v0, v1, v12, v2}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->setFriendsVerified(ZLcom/samsung/accessory/manager/authentication/cover/CoverInfo;Lcom/samsung/accessory/manager/authentication/AuthenticationResult;)V
...
.method private notifyMateStateChanged(Z[B[B)Z
    ...
    const-class v1, Lcom/android/server/mate/MateServiceLocal;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/mate/MateServiceLocal;->accessoryStateChanged(Z[B[B)V
...
.method private sendFactoryResult()V
    ...
    const-string/jumbo v4, "factory intent is null"
    ...
    :cond_0
    iget-object v3, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mResult:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v3, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mUriData:[B
    ...
    invoke-virtual {p0, v3}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->byteArrayToString([B)Ljava/lang/String;
    ...
    const-string/jumbo v5, "Service ID = "
    ...
    invoke-direct {p0, v3, v4, v5, v2}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->setCoverResultForIntent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mFactoryIntent:Landroid/content/Intent;
...
.method private sendToIssManager()V
    ...
    const-string/jumbo v1, "com.samsung.android.isag.issmanager"

    invoke-direct {p0, v1}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->isPackageExist(Ljava/lang/String;)Z
    ...
    const-string/jumbo v1, "com.samsung.android.isag.issmanager.ACTION_COVER_AUTH"
    ...
    const-string/jumbo v2, "com.samsung.android.isag.issmanager.permission.COVER_AUTH"
...
.method private setCoverResultForIntent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "serviceid_factory"
...
.method private setCoverVerified(ZZLcom/samsung/accessory/manager/authentication/cover/CoverInfo;Lcom/samsung/accessory/manager/authentication/AuthenticationResult;)V
    ...
    invoke-virtual {v1, p2}, Lcom/samsung/android/cover/CoverState;->setFakeCover(Z)V

    if-eqz p1, :cond_b

    invoke-virtual {v1, v6}, Lcom/samsung/android/cover/CoverState;->setAttachState(Z)V

    invoke-virtual {p3}, Lcom/samsung/accessory/manager/authentication/cover/CoverInfo;->getColor()I

    move-result v3

    invoke-virtual {v1, v3}, Lcom/samsung/android/cover/CoverState;->setColor(I)V

    invoke-virtual {p3}, Lcom/samsung/accessory/manager/authentication/cover/CoverInfo;->getModel()I

    move-result v3

    invoke-virtual {v1, v3}, Lcom/samsung/android/cover/CoverState;->setModel(I)V
    ...
    invoke-virtual {v1, v3}, Lcom/samsung/android/cover/CoverState;->setSmartCoverAppUri(Ljava/lang/String;)V

    invoke-virtual {p4}, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;->getByteArrayExtraData()[B

    move-result-object v3

    invoke-virtual {v1, v3}, Lcom/samsung/android/cover/CoverState;->setSmartCoverCookie([B)V
    ...
    invoke-virtual {v1, v3}, Lcom/samsung/android/cover/CoverState;->setType(I)V

    invoke-virtual {p3}, Lcom/samsung/accessory/manager/authentication/cover/CoverInfo;->getSn()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, v3}, Lcom/samsung/android/cover/CoverState;->setSerialNumber(Ljava/lang/String;)V

    :goto_0
    iput-object v1, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mLastCoverState:Lcom/samsung/android/cover/CoverState;
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/input/InputManagerService;->setCoverVerify(I)V

    iget-object v3, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mPowerManager:Landroid/os/PowerManager;

    invoke-virtual {v1}, Lcom/samsung/android/cover/CoverState;->getType()I

    move-result v4

    invoke-virtual {v3, v4}, Landroid/os/PowerManager;->setCoverType(I)V

    invoke-virtual {p0, p1, v1}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->applyCoverVerifiedState(ZLcom/samsung/android/cover/CoverState;)Z
    ...
    invoke-direct {p0}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->sendToIssManager()V
    ...
    iput-object v3, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mUriData:[B
    ...
    const-string/jumbo v5, "coverInfo.getUrl: "
    ...
    const-string/jumbo v3, "com.sec.android.app.applinker.REQUEST_LINK"

    invoke-direct {v2, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    new-instance v0, Landroid/content/Intent;

    const-string/jumbo v3, "com.samsung.android.intent.action.ACCESSORY_AUTEHNTICATION_COMPLETE"
    ...
    invoke-direct {p0, v6, v3, v4}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->notifyMateStateChanged(Z[B[B)Z
    ...
    :cond_3
    iget-object v3, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mCoverAuthStateFile:Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthStateFile;
    ...
    invoke-static {v3, v4, v5, v6}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthStateFile;->-wrap0(Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthStateFile;[B[B[B)V
    ...
    :cond_6
    invoke-virtual {v1, v8}, Lcom/samsung/android/cover/CoverState;->setType(I)V
    ...
    const-string/jumbo v4, "uri data is null"
    ...
    iget-object v3, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mLastCoverState:Lcom/samsung/android/cover/CoverState;

    if-eqz v3, :cond_c

    iget-object v3, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mLastCoverState:Lcom/samsung/android/cover/CoverState;

    invoke-virtual {v3, v7}, Lcom/samsung/android/cover/CoverState;->setAttachState(Z)V

    :cond_c
    iget-object v3, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mLastCoverState:Lcom/samsung/android/cover/CoverState;

    invoke-virtual {p0, p1, v3}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->applyCoverVerifiedState(ZLcom/samsung/android/cover/CoverState;)Z

    iput-object v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mLastCoverState:Lcom/samsung/android/cover/CoverState;

    iget-object v3, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mCoverAuthStateFile:Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthStateFile;

    iget-object v3, v3, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthStateFile;->mId:[B
    ...
    iget-object v3, v3, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthStateFile;->mUri:[B
    ...
    invoke-direct {p0, v7, v3, v5}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->notifyMateStateChanged(Z[B[B)Z

    iput-object v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mUriData:[B
...
.method private setCoverVerifiedAlt()V
    ...
    invoke-direct {p0, v5, v4, v0, v1}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->setCoverVerified(ZZLcom/samsung/accessory/manager/authentication/cover/CoverInfo;Lcom/samsung/accessory/manager/authentication/AuthenticationResult;)V
    ...
    :cond_3
    invoke-direct {p0, v5, v0, v1}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->setFriendsVerified(ZLcom/samsung/accessory/manager/authentication/cover/CoverInfo;Lcom/samsung/accessory/manager/authentication/AuthenticationResult;)V
...
.method private setFriendsVerified(ZLcom/samsung/accessory/manager/authentication/cover/CoverInfo;Lcom/samsung/accessory/manager/authentication/AuthenticationResult;)V
    ...
    invoke-direct {p0, v2, v0, v1}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->notifyMateStateChanged(Z[B[B)Z
    ...
    invoke-direct {p0, v4, v0, v3}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->notifyMateStateChanged(Z[B[B)Z
