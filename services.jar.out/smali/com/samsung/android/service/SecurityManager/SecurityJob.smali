...
.field public static final SEC_MANAGER_OK:I = 0x0

.field private static final SERVICE_VERSION:Ljava/lang/String; = "v2.8.8"
...
.method private checkDevicePolicy()I
    ...
    invoke-virtual {v10, v14}, Landroid/app/admin/DevicePolicyManager;->semGetRequireStorageCardEncryption(Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v10, "Face Lock check FAILED"
    ...
    invoke-virtual {v10, v13, v11}, Lcom/android/internal/widget/LockPatternUtils;->getBiometricLockscreen(II)I

    move-result v10

    if-ne v10, v12, :cond_f

    const-string/jumbo v10, "Face Lock ON"
    ...
    :cond_f
    const-string/jumbo v10, "Face Lock check SUCCESS"
...
.method private performCCModePreProcess()I
    ...
    :cond_0
    const-string/jumbo v1, "Integrity verification succeeded"
...
.method private setNotification(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "SecurityManager : Notice for applying security policy"

    invoke-static {v6}, Lcom/samsung/android/service/SecurityManager/Log;->d(Ljava/lang/String;)I

    new-instance v1, Landroid/app/Notification$Builder;

    iget-object v6, p0, Lcom/samsung/android/service/SecurityManager/SecurityJob;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v1, v6, v7}, Landroid/app/Notification$Builder;->setFlag(IZ)Landroid/app/Notification$Builder;
    ...
    const-string/jumbo v8, "com.samsung.android.service.SecurityManager.UPDATE"

    invoke-direct {v7, v8}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const/high16 v8, 0x8000000

    invoke-static {v6, v9, v7, v8}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v3

    new-instance v6, Landroid/app/Notification$Action;

    invoke-direct {v6, v10, v4, v3}, Landroid/app/Notification$Action;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
...
.method public sendSurveyLog(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    const-string/jumbo v2, "sendSurveyLog completed."

    invoke-static {v2}, Lcom/samsung/android/service/SecurityManager/Log;->i(Ljava/lang/String;)I

    :goto_0
    return-void

    :cond_2
    const-string/jumbo v2, "Survey mode is not supported."
...
.method public sendSurveyLogMode()V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/service/SecurityManager/SecurityJob;->isCCModeSupport()Z
    ...
    invoke-virtual {p0, v1, v0, v2, v3}, Lcom/samsung/android/service/SecurityManager/SecurityJob;->sendSurveyLog(Ljava/lang/String;Ljava/lang/String;J)V
