...
.method public registerCoverPowerKeyListener(Lcom/samsung/android/sdk/cover/ScoverManager$CoverPowerKeyListener;)V
    ...
    const-string/jumbo v9, "registerCoverPowerKeyListener : This device does not support cover"
    ...
    const-string/jumbo v9, "registerCoverPowerKeyListener"
    ...
    const-string/jumbo v9, "This device does not support this function. Device is must higher then v1.10.0 for Flip Cover and Neon cover"
    ...
    const-string/jumbo v9, "registerLedSystemListener : This device does not support Flip cover or Neon Cover"
    ...
    const-string/jumbo v9, "registerCoverPowerKeyListener : listener is null"
    ...
    invoke-direct {v5, p1, v10, v8}, Lcom/samsung/android/sdk/cover/CoverPowerKeyListenerDelegate;-><init>(Lcom/samsung/android/sdk/cover/ScoverManager$CoverPowerKeyListener;Landroid/os/Handler;Landroid/content/Context;)V
    ...
    const-string/jumbo v9, "RemoteException in registerCoverPowerKeyListener: "
...
.method public registerLedSystemListener(Lcom/samsung/android/sdk/cover/ScoverManager$LedSystemEventListener;)V
    ...
    const-string/jumbo v10, "registerLedSystemListener"
    ...
    invoke-direct {v6, p1, v11, v9}, Lcom/samsung/android/sdk/cover/LedSystemEventListenerDelegate;-><init>(Lcom/samsung/android/sdk/cover/ScoverManager$LedSystemEventListener;Landroid/os/Handler;Landroid/content/Context;)V
...
.method public registerListener(Lcom/samsung/android/sdk/cover/ScoverManager$CoverStateListener;)V
    ...
    const-string/jumbo v9, "registerListener"
    ...
    const-string/jumbo v9, "registerListener : This device is not supported cover"
    ...
    const-string/jumbo v9, "registerListener : If cover is smart cover, it does not need to register listener of intenal App"
    ...
    const-string/jumbo v9, "This device is not supported this function. Device is must higher then v1.1.0"

    invoke-direct {v8, v9, v11}, Lcom/samsung/android/sdk/SsdkUnsupportedException;-><init>(Ljava/lang/String;I)V
    ...
    invoke-virtual {v8, p1}, Lcom/samsung/android/sdk/cover/ScoverManager$CoverStateListener;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {v1, p1, v10, v8}, Lcom/samsung/android/sdk/cover/CoverStateListenerDelegate;-><init>(Lcom/samsung/android/sdk/cover/ScoverManager$CoverStateListener;Landroid/os/Handler;Landroid/content/Context;)V
...
.method public registerNfcTouchListener(ILcom/samsung/android/sdk/cover/ScoverManager$NfcLedCoverTouchListener;)V
    ...
    const-string/jumbo v9, "registerNfcTouchListener : This device does not support cover"
    ...
    const-string/jumbo v9, "registerNfcTouchListener"
    ...
    const-string/jumbo v9, "registerNfcTouchListener : This device does not support NFC Led cover"
    ...
    const-string/jumbo v9, "This device does not support this function. Device is must higher then v1.3.0"
    ...
    const-string/jumbo v9, "registerNfcTouchListener : listener is null"
    ...
    invoke-direct {v6, p2, v10, v8}, Lcom/samsung/android/sdk/cover/NfcLedCoverTouchListenerDelegate;-><init>(Lcom/samsung/android/sdk/cover/ScoverManager$NfcLedCoverTouchListener;Landroid/os/Handler;Landroid/content/Context;)V
    ...
    const-string/jumbo v9, "RemoteException in registerNfcTouchListener: "
...
.method public unregisterCoverPowerKeyListener(Lcom/samsung/android/sdk/cover/ScoverManager$CoverPowerKeyListener;)V
    ...
    const-string/jumbo v7, "unregisterCoverPowerKeyListener : This device does not support cover"
    ...
    const-string/jumbo v7, "unregisterCoverPowerKeyListener"
    ...
    const-string/jumbo v7, "This device does not support this function. Device is must higher then v1.1.0 for Flip Cover Neon cover"
    ...
    const-string/jumbo v7, "unregisterCoverPowerKeyListener : This device does not support Flip cover or Neon Cover"
    ...
    const-string/jumbo v7, "unregisterCoverPowerKeyListener : listener is null"
    ...
    const-string/jumbo v7, "RemoteException in unregisterCoverPowerKeyListener: "
