.class Lcom/android/launcher3/common/model/FavoritesUpdater$9;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/launcher3/common/model/FavoritesUpdater;->addItems(Ljava/util/ArrayList;)V
.end annotation
...
# direct methods
.method constructor <init>(Lcom/android/launcher3/common/model/FavoritesUpdater;Ljava/util/List;Ljava/util/ArrayList;[Ljava/lang/StackTraceElement;)V
    .locals 0

    iput-object p1, p0, Lcom/android/launcher3/common/model/FavoritesUpdater$9;->this$0:Lcom/android/launcher3/common/model/FavoritesUpdater;

    iput-object p2, p0, Lcom/android/launcher3/common/model/FavoritesUpdater$9;->val$updates:Ljava/util/List;

    iput-object p3, p0, Lcom/android/launcher3/common/model/FavoritesUpdater$9;->val$items:Ljava/util/ArrayList;

    iput-object p4, p0, Lcom/android/launcher3/common/model/FavoritesUpdater$9;->val$stackTrace:[Ljava/lang/StackTraceElement;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/android/launcher3/common/model/FavoritesUpdater$9;->val$updates:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/android/launcher3/common/model/FavoritesUpdater$9;->val$updates:Ljava/util/List;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/launcher3/common/model/FavoritesUpdater$9;->val$items:Ljava/util/ArrayList;
