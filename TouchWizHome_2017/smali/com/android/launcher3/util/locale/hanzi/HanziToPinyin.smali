.class public Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;
...
.field private static final OFFSET_POLYPHONE_PRIOR_PINYIN:[I
...
.field private static final PINYIN_LVE_STR:Ljava/lang/String; = "LVE"

.field private static final PINYIN_LV_STR:Ljava/lang/String; = "LV"

.field private static final PINYIN_NV:[C

.field private static final PINYIN_NVE:[C

.field private static final PINYIN_NVE_STR:Ljava/lang/String; = "NVE"

.field private static final PINYIN_NV_STR:Ljava/lang/String; = "NV"
...
.field private static sInstance:Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->UNIHANS:[C
    ...
    sput-object v0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYINS:[[B
    ...
    sput-object v0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYIN_LV:[C

    new-array v0, v7, [C

    fill-array-data v0, :array_199

    sput-object v0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYIN_LVE:[C

    new-array v0, v6, [C

    fill-array-data v0, :array_19a

    sput-object v0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYIN_NV:[C

    new-array v0, v5, [C

    fill-array-data v0, :array_19b

    sput-object v0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYIN_NVE:[C

    new-array v0, v4, [C

    fill-array-data v0, :array_19c

    sput-object v0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->POLYPHONE_PRIOR_PINYIN:[C

    new-array v0, v4, [I

    fill-array-data v0, :array_19d

    sput-object v0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->OFFSET_POLYPHONE_PRIOR_PINYIN:[I
    ...
    sput-object v0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
...
.method protected constructor <init>(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->mHasChinaCollator:Z
...
.method private addToken(Ljava/lang/StringBuilder;Ljava/util/ArrayList;I)V
    ...
    new-instance v1, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;

    invoke-direct {v1, p3, v0, v0}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;-><init>(ILjava/lang/String;Ljava/lang/String;)V
...
.method private checkPolyphone(Ljava/lang/String;)I
    ...
    sget-object v4, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->POLYPHONE_PRIOR_PINYIN:[C
    ...
    sget-object v4, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->OFFSET_POLYPHONE_PRIOR_PINYIN:[I
...
.method private static doSelfValidation()Z
    ...
    sget-object v6, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->UNIHANS:[C
    ...
    sget-object v7, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->UNIHANS:[C
    ...
    sget-object v9, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
...
.method public static getInstance()Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;
    .locals 6

    const/4 v2, 0x0

    const-class v3, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;

    monitor-enter v3

    :try_start_0
    sget-object v4, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->sInstance:Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;

    if-eqz v4, :cond_0

    sget-object v2, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->sInstance:Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;
    ...
    new-instance v2, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;

    const/4 v4, 0x1

    invoke-direct {v2, v4}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;-><init>(Z)V

    sput-object v2, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->sInstance:Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;
...
.method private pinyinSuffixType(C)I
    ...
    sget-object v10, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYIN_LV:[C
    ...
    sget-object v10, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYIN_LVE:[C
    ...
    sget-object v10, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYIN_NV:[C
    ...
    sget-object v9, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYIN_NVE:[C
...
.method public get(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-boolean v7, p0, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->mHasChinaCollator:Z
    ...
    invoke-direct {p0, v3, v6, v5}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->addToken(Ljava/lang/StringBuilder;Ljava/util/ArrayList;I)V
    ...
    :cond_7
    invoke-virtual {p0, v0}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->getTokenIncludingSpecialSuffix(C)Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;

    move-result-object v4

    iget v7, v4, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;->type:I
    ...
    :cond_a
    iget v5, v4, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;->type:I
...
.method public getPinyin(C)Ljava/lang/String;
    ...
    new-instance v8, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;

    invoke-direct {v8}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;-><init>()V

    invoke-static {p1}, Ljava/lang/Character;->toString(C)Ljava/lang/String;

    move-result-object v4

    iput-object v4, v8, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;->source:Ljava/lang/String;

    const/4 v5, -0x1

    invoke-direct {p0, v4}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->checkPolyphone(Ljava/lang/String;)I
    ...
    iput v12, v8, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;->type:I
    ...
    :goto_1
    sget-object v10, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->PINYINS:[[B
    ...
    iput v10, v8, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;->type:I

    iput-object v4, v8, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;->target:Ljava/lang/String;
    ...
    iput v13, v8, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;->type:I
    ...
    :cond_3
    sget-object v10, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
    ...
    sget-object v10, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->UNIHANS:[C

    array-length v10, v10

    add-int/lit8 v2, v10, -0x1

    invoke-direct {p0, p1}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->pinyinSuffixType(C)I
    ...
    iput-object v10, v8, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;->target:Ljava/lang/String;
...
.method public getPinyinString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->isHasChinese(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->get(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    check-cast v2, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;
    ...
    iget-object v5, v2, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;->target:Ljava/lang/String;
    ...
    const-string v6, "getPinyinString   :"
...
.method protected getTokenIncludingSpecialSuffix(C)Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;
    .locals 14
...
.method public isHanzi(C)Z
    ...
    sget-object v3, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->COLLATOR:Ljava/text/Collator;
...
.method public isHasChinese(Ljava/lang/String;)Z
    .locals 6
    ...
    invoke-virtual {p0, v0}, Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;->isHanzi(C)Z
