...
.method public static getAnimationDuration(Landroid/animation/Animator;)J
    .locals 8
    ...
    instance-of v6, p0, Landroid/animation/AnimatorSet;
...
.method public static getCustomerPageKey(Landroid/content/Context;)J
    ...
    const-string v4, "customerPagePref"
    ...
    const-string v5, "save customer page key "
...
.method public static isComponentActive(Landroid/content/Context;Landroid/content/ComponentName;[Landroid/content/pm/ComponentInfo;)Z
    .locals 7
...
.method public static isDeepShortcut(Landroid/content/Intent;)Z
    .locals 3
...
.method public static isMobileKeyboardMode(Landroid/content/Context;)Z
    .locals 4
...
.method public static startActivitySafely(Landroid/app/Activity;Landroid/view/View;Landroid/content/Intent;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v11}, Landroid/content/pm/PackageManager;->isSafeMode()Z
    ...
    invoke-static {p0, v0}, Lcom/android/launcher3/Utilities;->isSystemApp(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    invoke-static {p0, v0}, Lcom/android/launcher3/Utilities;->appLauncherBoosting(Landroid/app/Activity;Landroid/content/Intent;)Z
    ...
    :try_start_0
    const-string v11, "com.android.launcher3.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION"
    ...
    invoke-virtual {v10, v6, v7}, Lcom/android/launcher3/common/compat/UserManagerCompat;->getUserForSerialNumber(J)Lcom/android/launcher3/common/compat/UserHandleCompat;
    ...
    sget-boolean v11, Lcom/android/launcher3/Utilities;->ATLEAST_MARSHMALLOW:Z

    if-eqz v11, :cond_5

    if-eqz v3, :cond_5

    iget v11, v3, Lcom/android/launcher3/common/base/item/ItemInfo;->itemType:I
    ...
    iget-object v11, v11, Lcom/android/launcher3/common/base/item/IconInfo;->promisedIntent:Landroid/content/Intent;

    if-nez v11, :cond_5

    move-object/from16 v0, p2

    invoke-static {p0, v0, v5, v3}, Lcom/android/launcher3/Utilities;->startActivityVmPolicy(Landroid/app/Activity;Landroid/content/Intent;Landroid/os/Bundle;Lcom/android/launcher3/common/base/item/ItemInfo;)V
    ...
    invoke-virtual {v9, v11}, Lcom/android/launcher3/common/compat/UserHandleCompat;->equals(Ljava/lang/Object;)Z
    ...
    const-string v11, "Launcher.Utilities"
...
.method private static startActivityVmPolicy(Landroid/app/Activity;Landroid/content/Intent;Landroid/os/Bundle;Lcom/android/launcher3/common/base/item/ItemInfo;)V
    .locals 8
    ...
    iget v1, p3, Lcom/android/launcher3/common/base/item/ItemInfo;->itemType:I
    ...
    invoke-virtual {v1}, Lcom/android/launcher3/common/base/item/IconInfo;->getDeepShortcutId()Ljava/lang/String;
    ...
    iget-object v6, p3, Lcom/android/launcher3/common/base/item/ItemInfo;->user:Lcom/android/launcher3/common/compat/UserHandleCompat;

    move-object v5, p2

    invoke-virtual/range {v1 .. v6}, Lcom/android/launcher3/common/quickoption/shortcuts/DeepShortcutManager;->startShortcut(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Rect;Landroid/os/Bundle;Lcom/android/launcher3/common/compat/UserHandleCompat;)V
    :try_end_0
