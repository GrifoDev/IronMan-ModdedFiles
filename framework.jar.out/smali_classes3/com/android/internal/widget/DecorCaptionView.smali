...
.method private flipBackButtonIfNeeded()V
    ...
    iget-boolean v2, p0, Lcom/android/internal/widget/DecorCaptionView;->mIsBackButtonFlipped:Z
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/internal/widget/DecorCaptionView;->mTmpMatrix:Landroid/graphics/Matrix;
    ...
    iget-object v5, p0, Lcom/android/internal/widget/DecorCaptionView;->mTmpMatrix:Landroid/graphics/Matrix;
    ...
    invoke-direct {v9, v1, v8}, Landroid/graphics/drawable/BitmapDrawable;-><init>(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V

    iget-object v1, p0, Lcom/android/internal/widget/DecorCaptionView;->mBack:Landroid/view/View;

    invoke-virtual {v1, v9}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iput-boolean v6, p0, Lcom/android/internal/widget/DecorCaptionView;->mIsBackButtonFlipped:Z

    return-void

    :cond_3
    instance-of v2, v7, Lcom/samsung/android/graphics/spr/SemPathRenderingDrawable;

    if-eqz v2, :cond_2

    check-cast v7, Lcom/samsung/android/graphics/spr/SemPathRenderingDrawable;

    invoke-virtual {v7}, Lcom/samsung/android/graphics/spr/SemPathRenderingDrawable;->getBitmap()Landroid/graphics/Bitmap;
...
.method static synthetic lambda$-com_android_internal_widget_DecorCaptionView_52026()V
    .locals 4
...
.method private rotateWindow()V
    ...
    invoke-virtual {v1, v0}, Lcom/samsung/android/multiwindow/MultiWindowManager;->rotateFreeformTask(Landroid/os/IBinder;)V
...
.method private updateHitRect()V
    ...
    iget-object v6, p0, Lcom/android/internal/widget/DecorCaptionView;->mBackRect:Landroid/graphics/Rect;

    invoke-virtual {v5, v6}, Landroid/view/View;->getHitRect(Landroid/graphics/Rect;)V

    iget-object v5, p0, Lcom/android/internal/widget/DecorCaptionView;->mBackRect:Landroid/graphics/Rect;

    iget-object v6, p0, Lcom/android/internal/widget/DecorCaptionView;->mCaptionContainer:Landroid/view/View;
    ...
    iget-object v5, p0, Lcom/android/internal/widget/DecorCaptionView;->mRotate:Landroid/view/View;

    iget-object v6, p0, Lcom/android/internal/widget/DecorCaptionView;->mRotateRect:Landroid/graphics/Rect;
    ...
    iget-object v6, p0, Lcom/android/internal/widget/DecorCaptionView;->mReduceRect:Landroid/graphics/Rect;
    ...
    :goto_2
    invoke-direct {p0}, Lcom/android/internal/widget/DecorCaptionView;->flipBackButtonIfNeeded()V
...
.method synthetic lambda$-com_android_internal_widget_DecorCaptionView_48966(Landroid/view/View;)V
    .locals 1
...
.method synthetic lambda$-com_android_internal_widget_DecorCaptionView_49178(Ljava/lang/Boolean;Ljava/lang/Integer;)V
    .locals 1
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :goto_0
    iget-boolean v9, p0, Lcom/android/internal/widget/DecorCaptionView;->mOverlayWithAppContent:Z

    if-eqz v9, :cond_0

    iget-object v9, p0, Lcom/android/internal/widget/DecorCaptionView;->mDecorViewSupport:Lcom/android/internal/policy/MultiWindowDecorSupport;

    invoke-virtual {v9}, Lcom/android/internal/policy/MultiWindowDecorSupport;->keepShowingCaption()V
    ...
    invoke-virtual {v9, v10, v11, v12}, Landroid/view/View;->pointInView(FFF)Z
    ...
    iget-object v9, p0, Lcom/android/internal/widget/DecorCaptionView;->mMaximize:Landroid/view/View;
    ...
    const-string/jumbo v9, "DecorCaptionView"
    ...
    iget-object v9, p0, Lcom/android/internal/widget/DecorCaptionView;->mHandler:Landroid/os/Handler;
    ...
    iget-object v9, p0, Lcom/android/internal/widget/DecorCaptionView;->mMinimize:Landroid/view/View;
    ...
    invoke-direct {p0, v8}, Lcom/android/internal/widget/DecorCaptionView;->changeBorderColorWhenHeaderClicked(Z)V
...
.method public onLongPress(Landroid/view/MotionEvent;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/widget/DecorCaptionView;->isDesktopMode()Z
    ...
    iget-object v0, v0, Lcom/android/internal/widget/DecorCaptionView;->mOwner:Lcom/android/internal/policy/PhoneWindow;

    move-object/from16 v16, v0

    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/policy/PhoneWindow;->getDecorView()Landroid/view/View;
...
.method protected onMeasure(II)V
    ...
    :cond_0
    invoke-virtual {p0, v3}, Lcom/android/internal/widget/DecorCaptionView;->setLastMeasuredWithCaptionHeight(Z)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0, v3, v3}, Lcom/android/internal/widget/DecorCaptionView;->updateClickTarget(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-direct {p0, v1, p1, v4}, Lcom/android/internal/widget/DecorCaptionView;->drawRippleEffect(Landroid/view/View;Landroid/view/MotionEvent;Z)V
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/widget/DecorCaptionView;->clearRippleEffect(Z)V
...
.method public setPhoneWindow(Lcom/android/internal/policy/PhoneWindow;Z)V
    ...
    iput-boolean v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mOverlayWithAppContent:Z

    iget-boolean v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mOverlayWithAppContent:Z
    ...
    iget-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mOwner:Lcom/android/internal/policy/PhoneWindow;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mMaximize:Landroid/view/View;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mClose:Landroid/view/View;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mMultiWindowManager:Lcom/samsung/android/multiwindow/MultiWindowManager;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mDecorViewSupport:Lcom/android/internal/policy/MultiWindowDecorSupport;
    ...
    iput v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mFrameThickness:F

    const/high16 v4, 0x40400000    # 3.0f

    invoke-static {v4, v3}, Lcom/android/internal/widget/DecorCaptionView;->dipToPx(FLandroid/content/res/Resources;)F
    ...
    iput v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mClickTargetInset:I
    ...
    iput v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mDragSlop:I
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mCaptionEndContainer:Landroid/view/View;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mCaptionContainer:Landroid/view/View;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mMinimize:Landroid/view/View;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mGhost:Landroid/view/View;

    iget-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mGhost:Landroid/view/View;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mBack:Landroid/view/View;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mRotate:Landroid/view/View;
    ...
    iput-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mReduce:Landroid/view/View;
    ...
    iput-boolean v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mMaximizeVisibilityOnDeX:Z

    iget v4, v2, Landroid/content/pm/ActivityInfo;->screenOrientation:I

    invoke-virtual {p0, v4}, Lcom/android/internal/widget/DecorCaptionView;->dispatchRequestedOrientation(I)V
    :try_end_0
    ...
    iget-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mGestureDetector:Landroid/view/GestureDetector;

    new-instance v5, Lcom/android/internal/widget/DecorCaptionView$DexDoubleTapListener;

    invoke-direct {v5, p0, v7}, Lcom/android/internal/widget/DecorCaptionView$DexDoubleTapListener;-><init>(Lcom/android/internal/widget/DecorCaptionView;Lcom/android/internal/widget/DecorCaptionView$DexDoubleTapListener;)V
    ...
    iget-object v5, p0, Lcom/android/internal/widget/DecorCaptionView;->mOutlineProvider:Landroid/view/ViewOutlineProvider;
    ...
    :cond_4
    :try_start_1
    iget-object v4, p0, Lcom/android/internal/widget/DecorCaptionView;->mDecorViewSupport:Lcom/android/internal/policy/MultiWindowDecorSupport;

    invoke-virtual {v4}, Lcom/android/internal/policy/MultiWindowDecorSupport;->canMaximize()Z
    ...
    const-string/jumbo v4, "DecorCaptionView"

    const-string/jumbo v5, "init: can\'t know button visibility."
...
.method public updateButtonVisibility()V
    ...
    iget-boolean v3, p0, Lcom/android/internal/widget/DecorCaptionView;->mMaximizeVisibilityOnDeX:Z
