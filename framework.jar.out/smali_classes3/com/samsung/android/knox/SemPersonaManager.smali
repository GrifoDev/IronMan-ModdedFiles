...
.field public static final ERROR_CREATE_PERSONA_EC_MAX_PERSONA_LIMIT_REACHED:I = -0x40d
...
.field public static final ERROR_CREATE_PERSONA_SECURE_FOLDER_MAX_PERSONA_LIMIT_REACHED:I = -0x40c
...
.field public static final FOCUS_CHANGED_IN_DEX:I = 0x3
...
.field public static final INTENT_CATEGORY_OBSERVER_ONKEYGUARDHIDDEN:Ljava/lang/String; = "com.sec.knox.container.category.observer.onkeyguardhidden"

.field public static final INTENT_CATEGORY_OBSERVER_ONKEYGUARDSHOWN:Ljava/lang/String; = "com.sec.knox.container.category.observer.onkeyguardshown"
...
.field public static final SHOW_ALL_APPS_IN_DEX:I = 0x1

.field public static final SHOW_RECENT_IN_DEX:I = 0x2
...
.field public static final verifiedPackages:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "com.sec.knox.cocktailprovider"

    aput-object v1, v0, v5

    const-string/jumbo v1, "com.sec.knox.cocktailprovider2"
    ...
    const-string/jumbo v1, "com.sec.knox.knoxlauncher"
    ...
    const-string/jumbo v1, "com.samsung.knox.knoxtrustagent"

    const/16 v2, 0x8

    aput-object v1, v0, v2

    sput-object v0, Lcom/samsung/android/knox/SemPersonaManager;->verifiedPackages:[Ljava/lang/String;
...
.method public hideKeyguardForDex(I)V
    .locals 3
    ...
    invoke-interface {v1, p1}, Lcom/samsung/android/knox/ISemPersonaManager;->hideKeyguardForDex(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "Could not hideKeyguardForDex"
...
.method public isBlurCompatible()Z
    .locals 3
    ...
    invoke-interface {v1}, Lcom/samsung/android/knox/ISemPersonaManager;->isBlurCompatible()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "failed to find isBlurCompatible()"
...
.method public isKnoxKeyguardShown()Z
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/knox/SemPersonaManager;->getKeyguardShowState(I)Z
...
.method public launchPersonaHome(IZ)Z
    ...
    iget-object v3, p0, Lcom/samsung/android/knox/SemPersonaManager;->mContext:Landroid/content/Context;

    invoke-virtual {p0, v2, v3}, Lcom/samsung/android/knox/SemPersonaManager;->getContainerName(ILandroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v5, "launchPersonaHome : "
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/knox/SemPersonaManager;->launchPersonaHome(I)Z
...
.method public showScrim()V
    ...
    invoke-interface {v1}, Lcom/samsung/android/knox/ISemPersonaManager;->showScrim()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "failed to showScrim()"
