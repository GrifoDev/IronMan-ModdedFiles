...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-wide v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mLongPressUpdateInterval:J

    const/4 v7, -0x1

    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCurrentView:I

    const/4 v7, 0x1

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsEnabled:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsFromSystem:Z

    const/4 v7, 0x0

    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mFirstDayOfWeek:I

    const/4 v7, -0x1

    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mOldSelectedDay:I

    const/4 v7, 0x0

    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mPadding:I

    const/4 v7, 0x1

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsFirstMeasure:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsConfigurationChanged:Z

    new-instance v7, Lcom/samsung/android/widget/SemDatePicker$1;

    invoke-direct {v7, p0}, Lcom/samsung/android/widget/SemDatePicker$1;-><init>(Lcom/samsung/android/widget/SemDatePicker;)V

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mBtnFocusChangeListener:Landroid/view/View$OnFocusChangeListener;

    const/4 v7, -0x1

    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mBackgroundBorderlessResId:I

    const/4 v7, 0x0

    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mMode:I

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsLunarSupported:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsLunar:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsLeapMonth:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsFromSetLunar:Z

    const/4 v7, 0x0

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mLunarChanged:Z

    const/4 v7, 0x0

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mPathClassLoader:Ldalvik/system/PathClassLoader;
    ...
    invoke-direct {v7, p0, v8}, Lcom/samsung/android/widget/SemDatePicker$2;-><init>(Lcom/samsung/android/widget/SemDatePicker;Landroid/os/Looper;)V

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mHandler:Landroid/os/Handler;

    new-instance v7, Lcom/samsung/android/widget/SemDatePicker$3;

    invoke-direct {v7, p0}, Lcom/samsung/android/widget/SemDatePicker$3;-><init>(Lcom/samsung/android/widget/SemDatePicker;)V

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mMonthTouchListener:Landroid/view/View$OnTouchListener;

    new-instance v7, Lcom/samsung/android/widget/SemDatePicker$4;

    invoke-direct {v7, p0}, Lcom/samsung/android/widget/SemDatePicker$4;-><init>(Lcom/samsung/android/widget/SemDatePicker;)V

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mMonthKeyListener:Landroid/view/View$OnKeyListener;

    invoke-direct {p0}, Lcom/samsung/android/widget/SemDatePicker;->isRTL()Z

    move-result v7

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsRTL:Z

    invoke-direct {p0}, Lcom/samsung/android/widget/SemDatePicker;->isFarsiLanguage()Z

    move-result v7

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsFarsiLanguage:Z

    invoke-direct {p0}, Lcom/samsung/android/widget/SemDatePicker;->isSimplifiedChinese()Z

    move-result v7

    iput-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsSimplifiedChinese:Z

    iget-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsSimplifiedChinese:Z

    if-eqz v7, :cond_1

    new-instance v7, Ljava/text/SimpleDateFormat;

    const-string/jumbo v8, "EEEEE"
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mDayFormatter:Ljava/text/SimpleDateFormat;
    ...
    invoke-direct {p0, v7, v4}, Lcom/samsung/android/widget/SemDatePicker;->getCalendarForLocale(Ljava/util/Calendar;Ljava/util/Locale;)Ljava/util/Calendar;

    move-result-object v7

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mMinDate:Ljava/util/Calendar;

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mMaxDate:Ljava/util/Calendar;

    invoke-direct {p0, v7, v4}, Lcom/samsung/android/widget/SemDatePicker;->getCalendarForLocale(Ljava/util/Calendar;Ljava/util/Locale;)Ljava/util/Calendar;

    move-result-object v7

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mMaxDate:Ljava/util/Calendar;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mTempMinMaxDate:Ljava/util/Calendar;

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCurrentDate:Ljava/util/Calendar;

    invoke-direct {p0, v7, v4}, Lcom/samsung/android/widget/SemDatePicker;->getCalendarForLocale(Ljava/util/Calendar;Ljava/util/Locale;)Ljava/util/Calendar;

    move-result-object v7

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCurrentDate:Ljava/util/Calendar;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mTempDate:Ljava/util/Calendar;

    invoke-virtual {p0, v4}, Lcom/samsung/android/widget/SemDatePicker;->setLocale(Ljava/util/Locale;)V
    ...
    invoke-virtual {v7, p2, v8, p3, p4}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mStartYear:I
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mEndYear:I

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mMinDate:Ljava/util/Calendar;

    iget v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mStartYear:I
    ...
    iget v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mEndYear:I
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/android/widget/SemDatePicker;->setFirstDayOfWeek(I)V
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarTextColor:Landroid/content/res/ColorStateList;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarViewPager:Lcom/android/internal/widget/ViewPager;

    new-instance v7, Lcom/samsung/android/widget/SemDatePicker$CalendarPagerAdapter;

    invoke-direct {v7, p0}, Lcom/samsung/android/widget/SemDatePicker$CalendarPagerAdapter;-><init>(Lcom/samsung/android/widget/SemDatePicker;)V

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarPagerAdapter:Lcom/samsung/android/widget/SemDatePicker$CalendarPagerAdapter;

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarViewPager:Lcom/android/internal/widget/ViewPager;

    iget-object v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarPagerAdapter:Lcom/samsung/android/widget/SemDatePicker$CalendarPagerAdapter;

    invoke-virtual {v7, v8}, Lcom/android/internal/widget/ViewPager;->setAdapter(Lcom/android/internal/widget/PagerAdapter;)V

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarViewPager:Lcom/android/internal/widget/ViewPager;

    new-instance v8, Lcom/samsung/android/widget/SemDatePicker$CalendarPageChangeListener;

    const/4 v9, 0x0

    invoke-direct {v8, p0, v9}, Lcom/samsung/android/widget/SemDatePicker$CalendarPageChangeListener;-><init>(Lcom/samsung/android/widget/SemDatePicker;Lcom/samsung/android/widget/SemDatePicker$CalendarPageChangeListener;)V
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarHeader:Landroid/widget/RelativeLayout;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarHeaderText:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v7, v8}, Lcom/samsung/android/widget/SemDatePicker;->getCalendarForLocale(Ljava/util/Calendar;Ljava/util/Locale;)Ljava/util/Calendar;

    move-result-object v7

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mStartDate:Ljava/util/Calendar;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mEndDate:Ljava/util/Calendar;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mAnimator:Landroid/widget/ViewAnimator;
    ...
    check-cast v7, Lcom/samsung/android/widget/SemDatePickerSpinnerLayout;

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mSpinnerLayout:Lcom/samsung/android/widget/SemDatePickerSpinnerLayout;

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mSpinnerLayout:Lcom/samsung/android/widget/SemDatePickerSpinnerLayout;

    new-instance v8, Lcom/samsung/android/widget/SemDatePicker$5;

    invoke-direct {v8, p0}, Lcom/samsung/android/widget/SemDatePicker$5;-><init>(Lcom/samsung/android/widget/SemDatePicker;)V

    invoke-virtual {v7, p0, v8}, Lcom/samsung/android/widget/SemDatePickerSpinnerLayout;->setOnSpinnerDateChangedListener(Lcom/samsung/android/widget/SemDatePicker;Lcom/samsung/android/widget/SemDatePickerSpinnerLayout$OnSpinnerDateChangedListener;)V

    const/4 v7, 0x0

    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCurrentView:I

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarHeaderText:Landroid/widget/TextView;

    new-instance v8, Lcom/samsung/android/widget/SemDatePicker$6;

    invoke-direct {v8, p0}, Lcom/samsung/android/widget/SemDatePicker$6;-><init>(Lcom/samsung/android/widget/SemDatePicker;)V

    invoke-virtual {v7, v8}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarHeaderText:Landroid/widget/TextView;

    new-instance v8, Lcom/samsung/android/widget/SemDatePicker$7;

    invoke-direct {v8, p0}, Lcom/samsung/android/widget/SemDatePicker$7;-><init>(Lcom/samsung/android/widget/SemDatePicker;)V
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mDayOfTheWeekLayoutHeight:I
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarViewPagerWidth:I
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarViewMargin:I
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mDayOfTheWeekLayoutWidth:I
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mDayOfTheWeekLayout:Landroid/widget/LinearLayout;

    new-instance v7, Lcom/samsung/android/widget/SemDatePicker$DayOfTheWeekView;

    iget-object v8, p0, Landroid/view/View;->mContext:Landroid/content/Context;

    invoke-direct {v7, p0, v8}, Lcom/samsung/android/widget/SemDatePicker$DayOfTheWeekView;-><init>(Lcom/samsung/android/widget/SemDatePicker;Landroid/content/Context;)V

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mDayOfTheWeekView:Lcom/samsung/android/widget/SemDatePicker$DayOfTheWeekView;

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mDayOfTheWeekLayout:Landroid/widget/LinearLayout;

    iget-object v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mDayOfTheWeekView:Lcom/samsung/android/widget/SemDatePicker$DayOfTheWeekView;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mDatePickerLayout:Landroid/widget/LinearLayout;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarHeaderLayout:Landroid/widget/RelativeLayout;

    iget-boolean v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mIsRTL:Z
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mPrevButton:Landroid/widget/ImageButton;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mNextButton:Landroid/widget/ImageButton;

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mPrevButton:Landroid/widget/ImageButton;
    ...
    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mNextButton:Landroid/widget/ImageButton;
    ...
    iget-object v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mMonthTouchListener:Landroid/view/View$OnTouchListener;
    ...
    iget-object v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mMonthKeyListener:Landroid/view/View$OnKeyListener;
    ...
    iget-object v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mBtnFocusChangeListener:Landroid/view/View$OnFocusChangeListener;
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarHeaderLayoutHeight:I
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarViewPagerHeight:I

    iget v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarViewPagerWidth:I

    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mOldCalendarViewPagerWidth:I
    ...
    invoke-virtual {v7, v8}, Landroid/view/View;->setNextFocusRightId(I)V
    ...
    new-instance v7, Lcom/samsung/android/widget/SemSimpleMonthView;

    iget-object v8, p0, Landroid/view/View;->mContext:Landroid/content/Context;

    invoke-direct {v7, v8}, Lcom/samsung/android/widget/SemSimpleMonthView;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarView:Lcom/samsung/android/widget/SemSimpleMonthView;

    iget-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarView:Lcom/samsung/android/widget/SemSimpleMonthView;

    iget-object v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarTextColor:Landroid/content/res/ColorStateList;

    invoke-virtual {v7, v8}, Lcom/samsung/android/widget/SemSimpleMonthView;->setTextColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v7, p0}, Lcom/samsung/android/widget/SemSimpleMonthView;->setOnDayClickListener(Lcom/samsung/android/widget/SemSimpleMonthView$OnDayClickListener;)V
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mFirstBlankSpace:Landroid/view/View;
    ...
    iput-object v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mSecondBlankSpace:Landroid/view/View;
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mFirstBlankSpaceHeight:I
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mSecondBlankSpaceHeight:I
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mSpinnerLayoutHeight:I
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mSpinnerLayoutTopMargin:I
    ...
    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mSpinnerLayoutBottomMargin:I

    iget v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarHeaderLayoutHeight:I

    iget v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mFirstBlankSpaceHeight:I

    add-int/2addr v7, v8

    iget v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mDayOfTheWeekLayoutHeight:I

    add-int/2addr v7, v8

    iget v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mSecondBlankSpaceHeight:I

    add-int/2addr v7, v8

    iget v8, p0, Lcom/samsung/android/widget/SemDatePicker;->mCalendarViewPagerHeight:I

    add-int/2addr v7, v8

    iput v7, p0, Lcom/samsung/android/widget/SemDatePicker;->mDatePickerHeight:I

    const/4 v7, 0x1

    invoke-direct {p0, v7}, Lcom/samsung/android/widget/SemDatePicker;->updateSimpleMonthView(Z)V
