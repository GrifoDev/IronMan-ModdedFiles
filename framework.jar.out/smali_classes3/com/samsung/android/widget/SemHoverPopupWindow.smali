...
.field private static sIsCheckedRealDisplayMetricsInDexMode:Z
...
.method static synthetic -wrap0(Lcom/samsung/android/widget/SemHoverPopupWindow;)Z
    .locals 1
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/samsung/android/widget/SemHoverPopupWindow;->sIsCheckedRealDisplayMetricsInDexMode:Z
...
.method public constructor <init>(Landroid/view/View;I)V
    ...
    iput v0, p0, Lcom/samsung/android/widget/SemHoverPopupWindow;->ANCHORVIEW_COORDINATES_TYPE_SCREEN:I
...
.method private computePopupPosition(Landroid/view/View;III)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/samsung/android/widget/SemHoverPopupWindow;->getDeviceRotaion()I
    ...
    invoke-virtual/range {v37 .. v37}, Landroid/view/RenderNode;->hasIdentityMatrix()Z
    ...
    invoke-virtual/range {v37 .. v37}, Landroid/view/View;->getRootView()Landroid/view/View;
    ...
    invoke-virtual/range {v28 .. v29}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V
    ...
    new-instance v37, Lcom/samsung/android/widget/SemHoverPopupWindow$TouchablePopupContainer;
    ...
    invoke-virtual/range {v37 .. v37}, Landroid/view/ViewGroup;->getChildCount()I
    ...
    const-string/jumbo v37, "SemHoverPopupWindow"

    const-string/jumbo v38, "computePopupPosition: Call resetTimeout()"
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/samsung/android/widget/SemHoverPopupWindow$TouchablePopupContainer;->resetTimeout()V
    ...
    sget-boolean v37, Landroid/view/View;->TW_SCAFE_2016B:Z

    if-eqz v37, :cond_d

    div-int/lit8 v37, v9, 0x3
    ...
    div-int/lit8 v37, v8, 0x3

    add-int v17, v19, v37

    mul-int/lit8 v37, v8, 0x2
    ...
    invoke-virtual/range {v37 .. v38}, Landroid/widget/PopupWindow;->setAnimationStyle(I)V
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/view/View;->updateDisplayListIfDirty()Landroid/view/RenderNode;
    ...
    invoke-virtual/range {v37 .. v38}, Landroid/view/ViewGroup;->getChildAt(I)Landroid/view/View;
...
.method private computePopupPositionInternal(Landroid/graphics/Rect;Landroid/graphics/Rect;II)V
    ...
    sget v23, Lcom/samsung/android/framework/res/R$dimen;->task_bar_height:I
...
.method private getDeviceRotaion()I
    .locals 6
...
.method private getRealDisplayMetrics()Landroid/util/DisplayMetrics;
    ...
    sget-boolean v6, Lcom/samsung/android/widget/SemHoverPopupWindow;->sIsCheckedRealDisplayMetricsInDexMode:Z

    if-nez v6, :cond_0

    sput-boolean v8, Lcom/samsung/android/widget/SemHoverPopupWindow;->sIsCheckedRealDisplayMetricsInDexMode:Z
    ...
    :try_start_0
    invoke-interface {v4, v2}, Landroid/view/IWindowManager;->getDefaultDisplaySize(Landroid/graphics/Point;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    :goto_0
    sget-object v6, Lcom/samsung/android/widget/SemHoverPopupWindow;->sRealDisplayMetricsInDexMode:Landroid/util/DisplayMetrics;
    ...
    const-string/jumbo v6, "SemHoverPopupWindow"

    const-string/jumbo v7, "RemoteException windowManager.getDefaultDisplaySize in getRealDisplayMetrics: "
    ...
    :cond_1
    iget v6, p0, Lcom/samsung/android/widget/SemHoverPopupWindow;->mNavigationBarHeight:I
    ...
    :goto_1
    iget-object v6, p0, Lcom/samsung/android/widget/SemHoverPopupWindow;->mContext:Landroid/content/Context;
    ...
    iget v6, p0, Lcom/samsung/android/widget/SemHoverPopupWindow;->mDeviceRotation:I
    ...
    iput v6, v1, Landroid/util/DisplayMetrics;->widthPixels:I
