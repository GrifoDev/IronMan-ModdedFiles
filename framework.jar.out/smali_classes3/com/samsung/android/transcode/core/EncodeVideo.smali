...
.method public static checkRewritable(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    const-string/jumbo v2, "Invalid file uri: "
...
# virtual methods
.method public checkTransRewritable(Landroid/media/MediaFormat;I)I
    .locals 11
...
.method public checkTransRewritable(Landroid/media/MediaFormat;ILjava/lang/String;)I
    ...
    const-string/jumbo v6, "Build.VERSION.SEM_PLATFORM_INT: "
...
.method public getLocalEncHeader(I)Lcom/samsung/android/transcode/core/EncodeVideo$SpsPps;
    ...
    invoke-direct {v9, v1}, Lcom/samsung/android/transcode/core/EncodeVideo$SpsPps;-><init>(Lcom/samsung/android/transcode/core/EncodeVideo$1;)V
...
.method protected prepareAudioCodec()V
    ...
    const-string/jumbo v0, "audio/unknown"

    const-string/jumbo v1, "mime"

    invoke-virtual {v9, v1}, Landroid/media/MediaFormat;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-wide v0, p0, Lcom/samsung/android/transcode/core/EncodeVideo;->mTrimAudioEndUs:J
    ...
    const-string/jumbo v1, "mTrimAudioEndUs was 0 but updated"
    ...
    const-string/jumbo v2, "Audio input format "
    ...
    invoke-static {v10}, Lcom/samsung/android/transcode/util/CodecsHelper;->getDecoderCodec(Ljava/lang/String;)Landroid/media/MediaCodecInfo;

    move-result-object v0

    invoke-static {v0, v9}, Lcom/samsung/android/transcode/util/CodecsHelper;->createAudioDecoder(Landroid/media/MediaCodecInfo;Landroid/media/MediaFormat;)Landroid/media/MediaCodec;
    ...
    new-instance v12, Lcom/samsung/android/transcode/core/EncodeVideo$1;

    invoke-direct {v12, p0}, Lcom/samsung/android/transcode/core/EncodeVideo$1;-><init>(Lcom/samsung/android/transcode/core/EncodeVideo;)V
    ...
    invoke-static {v0, v12}, Lcom/samsung/android/transcode/util/CodecsHelper;->scheduleAfter(ILjava/lang/Runnable;)V
    ...
    const-string/jumbo v2, "Audio max input size not defined"
...
.method protected prepareVideoCodec()V
    ...
    const-string/jumbo v2, "Build.VERSION.SEM_PLATFORM_INT: "
    ...
    invoke-direct/range {v0 .. v5}, Lcom/samsung/android/transcode/surfaces/OutputSurface;-><init>(IIIII)V
    ...
    const-string/jumbo v1, "Can\'t get input video resolution"
    ...
    :cond_15
    :try_start_8
    iget v5, p0, Lcom/samsung/android/transcode/core/Encode;->mOutputHeight:I
...
.method protected prepareVideoCodecNeo()V
    ...
    invoke-static {v1, v3}, Lcom/samsung/android/transcode/core/EncodeVideo;->checkRewritable(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    :cond_12
    invoke-virtual {p0, v2, v0}, Lcom/samsung/android/transcode/core/EncodeVideo;->checkTransRewritable(Landroid/media/MediaFormat;I)I
