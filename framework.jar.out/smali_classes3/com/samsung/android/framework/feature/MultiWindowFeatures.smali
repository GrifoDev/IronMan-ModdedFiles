...
# static fields
.field public static final DEX_SUPPORT:Z = true
...
.field public static final UPDATE_LONG_DEVICE_SNAP_MODE_SUPPORT:I = 0x40
...
.method public static onMultiWindowFeaturesChange(Landroid/os/Bundle;)I
    ...
    sget-boolean v5, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->LONG_DEVICE_SNAP_MODE_SUPPORT:Z
    ...
    :goto_0
    sput-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->MULTIWINDOW_DYNAMIC_ENABLED:Z

    const-string/jumbo v8, "com.sec.feature.multiwindow.ensure_docked_view"

    invoke-virtual {p0, v8}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;)Z

    move-result v8

    sput-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->ENSURE_DOCKED_VIEW_SUPPORT:Z

    const-string/jumbo v8, "com.sec.feature.multiwindow.snap_view"
    ...
    :goto_1
    sput-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->SNAP_WINDOW_SUPPORT:Z

    const-string/jumbo v8, "com.sec.feature.multiwindow.long_device_snap_mode"

    invoke-virtual {p0, v8}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;)Z

    move-result v8

    sput-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->LONG_DEVICE_SNAP_MODE_SUPPORT:Z
    ...
    sput-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_SUPPORT:Z

    sget-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_SUPPORT:Z

    sput-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_GUIDE_RESIZE:Z

    sget-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_SUPPORT:Z

    sput-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_DENSITY_CHANGE:Z

    const-string/jumbo v8, "db_popup_view_shortcut"

    const/4 v11, -0x1

    invoke-virtual {p0, v8, v11}, Landroid/os/Bundle;->getInt(Ljava/lang/String;I)I
    ...
    :goto_2
    sput-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_GESTURE:Z

    const-string/jumbo v8, "game_multiwindow_enaable"

    invoke-virtual {p0, v8, v10}, Landroid/os/Bundle;->getInt(Ljava/lang/String;I)I
    ...
    :goto_3
    sput-boolean v9, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_ON_GAMEMODE:Z
    ...
    :cond_1
    sget-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->ENSURE_DOCKED_VIEW_SUPPORT:Z
    ...
    :cond_3
    sget-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->LONG_DEVICE_SNAP_MODE_SUPPORT:Z
    ...
    :cond_6
    sget-boolean v8, Lcom/samsung/android/framework/feature/MultiWindowFeatures;->FREEFORM_ON_GAMEMODE:Z
