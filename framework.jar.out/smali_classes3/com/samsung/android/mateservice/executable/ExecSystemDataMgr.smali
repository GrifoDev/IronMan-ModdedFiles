.class public Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->mContext:Landroid/content/Context;
...
.method private static changeFilePermission(Ljava/io/File;)V
    ...
    invoke-static {v3}, Lcom/samsung/android/mateservice/util/UtilLog;->getSafe(Ljava/lang/String;)Ljava/lang/String;
...
.method private copyPackageAssetsToSysDir(Landroid/os/Bundle;)Z
    ...
    iget-object v15, v0, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->mContext:Landroid/content/Context;
    ...
    invoke-static {v15, v7, v0}, Lcom/samsung/android/mateservice/util/UtilLog;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    :try_end_0
    ...
    invoke-direct {v0, v9, v5}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->createFile(Ljava/io/InputStream;Ljava/lang/String;)Z
    ...
    invoke-static {v15, v0, v1}, Lcom/samsung/android/mateservice/util/UtilLog;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    :try_end_1
    ...
    invoke-static {v6}, Lcom/samsung/android/mateservice/util/UtilLog;->printThrowableStackTrace(Ljava/lang/Throwable;)V
...
.method private createFile(Ljava/io/InputStream;Ljava/lang/String;)Z
    ...
    invoke-static {v7, v9, v10}, Lcom/samsung/android/mateservice/util/UtilLog;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :goto_4
    :try_start_5
    invoke-static {v2}, Lcom/samsung/android/mateservice/util/UtilLog;->printThrowableStackTrace(Ljava/lang/Throwable;)V
    :try_end_5
    ...
    invoke-static {v3}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->changeFilePermission(Ljava/io/File;)V
...
.method private deleteRecursive(Ljava/io/File;)V
    ...
    :cond_0
    invoke-direct {p0, v0}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->deleteRecursive(Ljava/io/File;)V
    :try_end_0
...
.method private deleteSubDirs(Landroid/os/Bundle;)Z
    ...
    const-string/jumbo v8, "deleteSubDirs"

    new-array v9, v6, [Ljava/lang/Object;

    invoke-static {v7, v8, v9}, Lcom/samsung/android/mateservice/util/UtilLog;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    const-string/jumbo v7, "paramStr0"

    invoke-virtual {p1, v7, v10}, Landroid/os/BaseBundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v8, "data is wrong!"
    ...
    const-string/jumbo v8, "target is not a directory!"
...
.method private makeDir(Landroid/os/Bundle;)Z
    ...
    invoke-static {v4, v5, v6}, Lcom/samsung/android/mateservice/util/UtilLog;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->changeFilePermission(Ljava/io/File;)V
    ...
    invoke-static {v4, v5, v6}, Lcom/samsung/android/mateservice/util/UtilLog;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
...
.method private readStringFromFile(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-static {v8, v10, v11}, Lcom/samsung/android/mateservice/util/UtilLog;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    const/4 v5, 0x0

    const-string/jumbo v8, "paramStr0"

    invoke-virtual {p1, v8, v9}, Landroid/os/BaseBundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v8, v10, v11}, Lcom/samsung/android/mateservice/common/BundleArgs$Builder;->put(Ljava/lang/String;Ljava/lang/String;)Lcom/samsung/android/mateservice/common/BundleArgs$Builder;

    move-result-object v8

    invoke-virtual {v8}, Lcom/samsung/android/mateservice/common/BundleArgs$Builder;->build()Landroid/os/Bundle;
    :try_end_5
...
.method private writeStringToFile(Landroid/os/Bundle;)Z
    ...
    invoke-static {v2}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->changeFilePermission(Ljava/io/File;)V
...
.method public execute(Landroid/os/Bundle;II)Landroid/os/Bundle;
    ...
    :pswitch_0
    invoke-direct {p0, p1}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->makeDir(Landroid/os/Bundle;)Z
    ...
    :pswitch_1
    invoke-direct {p0, p1}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->deleteSubDirs(Landroid/os/Bundle;)Z
    ...
    :pswitch_2
    invoke-direct {p0, p1}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->copyPackageAssetsToSysDir(Landroid/os/Bundle;)Z
    ...
    :pswitch_3
    invoke-direct {p0, p1}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->writeStringToFile(Landroid/os/Bundle;)Z
    ...
    :pswitch_4
    invoke-direct {p0, p1}, Lcom/samsung/android/mateservice/executable/ExecSystemDataMgr;->readStringFromFile(Landroid/os/Bundle;)Landroid/os/Bundle;
