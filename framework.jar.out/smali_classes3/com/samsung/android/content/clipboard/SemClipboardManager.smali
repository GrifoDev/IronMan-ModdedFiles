...
.method static synthetic -get1(Lcom/samsung/android/content/clipboard/SemClipboardManager;)Z
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput v1, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->SUCCESS_SET_DATA:I
    ...
    iput-object v2, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mContext:Landroid/content/Context;

    iput-boolean v1, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mIsMaximumSize:Z

    iput-object v2, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mSetDataHandler:Landroid/os/Handler;

    iput-object v2, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mCocktailBarManager:Lcom/samsung/android/cocktailbar/SemCocktailBarManager;

    iput-object v2, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mPersonaManager:Lcom/samsung/android/knox/SemPersonaManager;
    ...
    iput-object v2, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mRegInterface:Landroid/sec/clipboard/IClipboardWorkingFormUiInterface;
    ...
    invoke-direct {v0, p0, v1}, Lcom/samsung/android/content/clipboard/SemClipboardManager$1;-><init>(Lcom/samsung/android/content/clipboard/SemClipboardManager;Landroid/os/Looper;)V
    ...
    invoke-direct {v0, v1}, Lcom/samsung/android/content/clipboard/SemClipboardManager$InnerOnUserChangedListener;-><init>(Landroid/os/Handler;)V
    ...
    invoke-direct {v0, v2}, Lcom/samsung/android/content/clipboard/SemClipboardManager$InnerClipboardDataPasteEvent;-><init>(Lcom/samsung/android/content/clipboard/SemClipboardManager$InnerClipboardDataPasteEvent;)V
...
.method private isCocktailBarDisplayed()Z
    ...
    const-string/jumbo v3, "isCocktailBarDisplayed - isCocktailBarShowing : "
    ...
    const-string/jumbo v3, "isCocktailBarDisplayed - CocktailBarWindowType : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mCocktailBarManager:Lcom/samsung/android/cocktailbar/SemCocktailBarManager;

    invoke-virtual {v3}, Lcom/samsung/android/cocktailbar/SemCocktailBarManager;->getCocktailBarWindowType()I
...
.method private isKnoxKeyguardShowing()Z
    ...
    invoke-interface {v2}, Landroid/sec/clipboard/IClipboardService;->isKnoxKeyguardShowing()Z
    :try_end_0
...
.method private makeFileDescriptor(Lcom/samsung/android/content/clipboard/data/SemClipData;)Z
    ...
    invoke-virtual {v8, v5}, Lcom/samsung/android/content/clipboard/data/SemImageClipData;->setParcelFileDescriptor(Landroid/os/ParcelFileDescriptor;)V
    :try_end_0
    ...
    invoke-virtual {v7, v5}, Lcom/samsung/android/content/clipboard/data/SemHtmlClipData;->setParcelFileDescriptor(Landroid/os/ParcelFileDescriptor;)V
    :try_end_2
    ...
    invoke-virtual {v9, v5}, Lcom/samsung/android/content/clipboard/data/SemUriClipData;->setParcelFileDescriptor(Landroid/os/ParcelFileDescriptor;)V
    :try_end_3
...
.method private notifyEvent(Landroid/os/Message;)V
    ...
    :cond_0
    iget-object v8, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mOnClipboardEventServiceListeners:Ljava/util/ArrayList;
    ...
    check-cast v7, Lcom/samsung/android/content/clipboard/SemClipboardEventListener;

    iget v9, p1, Landroid/os/Message;->what:I

    invoke-interface {v7, v9, v2}, Lcom/samsung/android/content/clipboard/SemClipboardEventListener;->onClipboardUpdated(ILcom/samsung/android/content/clipboard/data/SemClipData;)V
    :try_end_1
    ...
    invoke-interface {v7, v3}, Lcom/samsung/android/content/clipboard/SemClipboardEventListener;->onFilterUpdated(I)V
    :try_end_3
    ...
    :cond_5
    iget-object v8, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mOnUserChangedListeners:Ljava/util/ArrayList;

    monitor-enter v8

    :try_start_4
    iget-object v7, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mOnUserChangedListeners:Ljava/util/ArrayList;
    ...
    check-cast v7, Lcom/samsung/android/content/clipboard/SemClipboardManager$OnUserChangedListener;

    invoke-interface {v7, v6}, Lcom/samsung/android/content/clipboard/SemClipboardManager$OnUserChangedListener;->onUserChanged(I)V
    :try_end_5
...
.method public clearFilter(ILcom/samsung/android/content/clipboard/SemClipboardManager$OnPasteListener;)Z
    ...
    invoke-direct {p0, v2}, Lcom/samsung/android/content/clipboard/SemClipboardManager;->setPasteListener(Lcom/samsung/android/content/clipboard/SemClipboardManager$OnPasteListener;)V
...
.method public filterClip(ILcom/samsung/android/content/clipboard/SemClipboardManager$OnPasteListener;)V
    ...
    const-string/jumbo v1, "filterClip - Format changed"
    ...
    const-string/jumbo v2, "filterClip - Format:"
...
.method public getClipboardExServiceFilter()I
    .locals 2
    ...
    invoke-interface {v1}, Landroid/sec/clipboard/IClipboardService;->getFilter()I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public registerOnUserChangedListener(Lcom/samsung/android/content/clipboard/SemClipboardManager$OnUserChangedListener;)V
    ...
    const-string/jumbo v1, "registerOnUserChangedListener"
    ...
    const-string/jumbo v2, "registerOnUserChangedListener: Service is null."
    ...
    :cond_1
    iget-object v2, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mOnUserChangedListeners:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mInnerOnUserChangedListener:Lcom/samsung/android/content/clipboard/SemClipboardManager$InnerOnUserChangedListener;
    ...
    invoke-interface {v1, v3, v4}, Landroid/sec/clipboard/IClipboardService;->addUserChangedListener(Lcom/samsung/android/content/clipboard/IOnUserChangedListener;Ljava/lang/String;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public showDialog()V
    ...
    const-string/jumbo v3, "showDialog - isKnoxKeyguardShowing() : "
...
.method public showDialog(ILcom/samsung/android/content/clipboard/SemClipboardManager$OnPasteListener;)Z
    ...
    const-string/jumbo v4, "showDialog(int, OnPasteListener) - isKnoxKeyguardShowing() : "
    ...
    iget-object v4, p0, Lcom/samsung/android/content/clipboard/SemClipboardManager;->mInnerClipboardPasteEvent:Lcom/samsung/android/content/clipboard/SemClipboardManager$InnerClipboardDataPasteEvent;
...
.method public unregisterOnUserChangedListener(Lcom/samsung/android/content/clipboard/SemClipboardManager$OnUserChangedListener;)V
    ...
    invoke-interface {v1, v3}, Landroid/sec/clipboard/IClipboardService;->removeUserChangedListener(Lcom/samsung/android/content/clipboard/IOnUserChangedListener;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public updateFilter(IILcom/samsung/android/content/clipboard/SemClipboardManager$OnPasteListener;)V
    ...
    invoke-interface {v1, p1, p2, v2}, Landroid/sec/clipboard/IClipboardService;->updateFilterWithInputType(IILandroid/sec/clipboard/IClipboardDataPasteEvent;)V
