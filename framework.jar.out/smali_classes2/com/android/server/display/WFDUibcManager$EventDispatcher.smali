...
.method private handleMotionEvent()V
    ...
    :cond_10
    invoke-virtual/range {v34 .. v34}, Landroid/hardware/display/DisplayManager;->isAuSLServiceRunning()Z
...
.method public run()V
    ...
    invoke-virtual {p0}, Lcom/android/server/display/WFDUibcManager$EventQueue;->getNextEvent()Landroid/view/InputEvent;

    move-result-object v4

    iput-object v4, p0, Lcom/android/server/display/WFDUibcManager$EventDispatcher;->ev:Landroid/view/InputEvent;

    invoke-virtual {p0}, Lcom/android/server/display/WFDUibcManager$EventQueue;->getRotateEvent()Ljava/lang/Integer;
