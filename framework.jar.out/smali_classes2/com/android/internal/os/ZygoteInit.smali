...
.field public static isSecondaryZygoteReady:Z
...
.field public static zygoteAgentRunning:Z
...
.method static synthetic -wrap0(Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/android/internal/os/ZygoteInit;->waitForSecondaryZygote(Ljava/lang/String;)V
...
.method public static main([Ljava/lang/String;)V
    ...
    :try_start_0
    const-string/jumbo v7, "ZygoteInit"
    ...
    sput-boolean v7, Lcom/android/internal/os/ZygoteInit;->primaryZygoteThreadRunning:Z
    ...
    const-string/jumbo v8, "--abi-list="
    ...
    const-string/jumbo v7, "zygote_agent64"
    ...
    const-string/jumbo v7, "zygote_agent32"
    ...
    sput-boolean v7, Lcom/android/internal/os/ZygoteInit;->zygoteAgentRunning:Z
    :try_end_0
    ...
    const-string/jumbo v9, "Unknown command line argument: "
    ...
    const-string/jumbo v8, "Zygote died with exception"
    ...
    const-string/jumbo v9, "!@Zygote : primaryZygoteThreadRunning = "
    ...
    const-string/jumbo v9, " ZygoteAgentRunning = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    sget-boolean v9, Lcom/android/internal/os/ZygoteInit;->zygoteAgentRunning:Z
    ...
    const-string/jumbo v8, "No ABI list supplied."
    ...
    :cond_6
    sget-boolean v7, Lcom/android/internal/os/ZygoteInit;->zygoteAgentRunning:Z
    ...
    const-string/jumbo v7, "persist.sys.zygote.early"
    ...
    const-string/jumbo v7, "ZygotePreload"
    ...
    const-string/jumbo v7, "PostZygoteInitGC"
    ...
    const-string/jumbo v8, "Accepting command socket connections"
...
.method private static performSystemServerDexOpt(Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/android/internal/os/InstallerConnection;

    invoke-direct {v2}, Lcom/android/internal/os/InstallerConnection;-><init>()V

    invoke-virtual {v2}, Lcom/android/internal/os/InstallerConnection;->waitForConnection()V
    ...
    invoke-static {v3, v5, v4, v7}, Ldalvik/system/DexFile;->getDexOptNeeded(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)I

    move-result v6

    const-string/jumbo v4, "/services.jar"
    ...
    const-string/jumbo v4, "/samsung-services.jar"
    ...
    invoke-static {v3, v5}, Ldalvik/system/DexFile;->getDexFileStatus(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v16

    const-string/jumbo v4, "/data/dalvik-cache"
    ...
    const-string/jumbo v8, ", dexoptNeeded: "
    ...
    invoke-virtual/range {v2 .. v10}, Lcom/android/internal/os/InstallerConnection;->dexopt(Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    const-string/jumbo v8, "Error checking classpath element for system server: "
    ...
    invoke-static {v4, v7, v13}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string/jumbo v8, "Missing classpath element for system server: "
    ...
    invoke-virtual {v2}, Lcom/android/internal/os/InstallerConnection;->disconnect()V
    ...
    const-string/jumbo v8, "Failed compiling classpath element for system server: "
    ...
    invoke-static {v4, v7, v12}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
...
.method static preload()V
    ...
    const-string/jumbo v1, "sys.boot.end_preload"
    ...
    const-string/jumbo v3, "!@PPR: primaryZygoteThreadRunning = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    sget-boolean v3, Lcom/android/internal/os/ZygoteInit;->primaryZygoteThreadRunning:Z

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, " ZygoteAgentRunning = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    sget-boolean v3, Lcom/android/internal/os/ZygoteInit;->zygoteAgentRunning:Z
...
.method private static startSystemServer(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget v4, Landroid/system/OsConstants;->CAP_IPC_LOCK:I

    const/4 v5, 0x0

    aput v4, v3, v5

    sget v4, Landroid/system/OsConstants;->CAP_KILL:I
    ...
    sget v4, Landroid/system/OsConstants;->CAP_SYS_RESOURCE:I
    ...
    invoke-static {v3}, Lcom/android/internal/os/ZygoteInit;->posixCapabilitiesAsBits([I)J

    move-result-wide v12

    const-string/jumbo v3, "ro.boot.container"
    ...
    const-string/jumbo v3, "--setuid=1000"

    const/4 v4, 0x0

    aput-object v3, v2, v4

    const-string/jumbo v3, "--setgid=1000"

    const/4 v4, 0x1

    aput-object v3, v2, v4

    const-string/jumbo v3, "--setgroups=1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1018,1021,1023,1032,3001,3002,3003,3004,3005,3006,3007,3008,3009,3010"
    ...
    const-string/jumbo v3, "--nice-name=system_server"

    const/4 v4, 0x4

    aput-object v3, v2, v4

    const-string/jumbo v3, "--runtime-args"

    const/4 v4, 0x5

    aput-object v3, v2, v4

    const-string/jumbo v3, "com.android.server.SystemServer"
    ...
    :try_start_0
    new-instance v17, Lcom/android/internal/os/ZygoteConnection$Arguments;

    move-object/from16 v0, v17

    invoke-direct {v0, v2}, Lcom/android/internal/os/ZygoteConnection$Arguments;-><init>([Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0

    :try_start_1
    invoke-static/range {v17 .. v17}, Lcom/android/internal/os/ZygoteConnection;->applyDebuggerSystemProperty(Lcom/android/internal/os/ZygoteConnection$Arguments;)V

    invoke-static/range {v17 .. v17}, Lcom/android/internal/os/ZygoteConnection;->applyInvokeWithSystemProperty(Lcom/android/internal/os/ZygoteConnection$Arguments;)V
    ...
    iget-wide v10, v0, Lcom/android/internal/os/ZygoteConnection$Arguments;->effectiveCapabilities:J
    ...
    new-instance v4, Lcom/android/internal/os/ZygoteInit$5;

    move-object/from16 v0, p1

    invoke-direct {v4, v0}, Lcom/android/internal/os/ZygoteInit$5;-><init>(Ljava/lang/String;)V
    ...
    :cond_1
    :goto_0
    invoke-static/range {v17 .. v17}, Lcom/android/internal/os/ZygoteInit;->handleSystemServerProcess(Lcom/android/internal/os/ZygoteConnection$Arguments;)V
    ...
    const-string/jumbo v4, "waitForSecondaryZygote EXCEPTION"
...
.method private static waitForSecondaryZygote(Ljava/lang/String;)V
    ...
    const-string/jumbo v5, "waitForSecondaryZygote successed "

    invoke-static {v4, v5}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    const/4 v4, 0x1

    sput-boolean v4, Lcom/android/internal/os/ZygoteInit;->isSecondaryZygoteReady:Z
