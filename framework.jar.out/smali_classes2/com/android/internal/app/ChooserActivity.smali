...
.method buildUpPagerAdapter()V
    ...
    iget-object v0, v0, Lcom/android/internal/app/ChooserActivity;->mChooserListAdapter:Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;

    move-object/from16 v16, v0

    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;->getCount()I
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;->getServiceTargetCount()I
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;->getCallerTargetCount()I
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;->getStandardTargetCount()I
    ...
    new-instance v17, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;-><init>(Lcom/android/internal/app/ResolverActivity;Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v9}, Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;->getItem(I)Lcom/android/internal/app/ResolverActivity$TargetInfo;
    ...
    check-cast v10, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;

    if-eqz v10, :cond_1

    iget-object v0, v10, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;->mList:Ljava/util/List;
    ...
    iget-object v0, v10, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;->mKey:Ljava/util/List;
...
.method buildUpServiceTargetAdapter()V
    ...
    iget-object v10, p0, Lcom/android/internal/app/ChooserActivity;->mServiceTargetView:Landroid/widget/AbsListView;
    ...
    invoke-virtual {p0, v10}, Lcom/android/internal/app/ChooserActivity;->findViewById(I)Landroid/view/View;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/internal/app/ChooserActivity;->setRoundCornerBackground()V

    iget-object v10, p0, Lcom/android/internal/app/ChooserActivity;->mServiceTargetView:Landroid/widget/AbsListView;

    invoke-virtual {v10, v14}, Landroid/widget/AbsListView;->setVisibility(I)V

    :cond_2
    iget-object v10, p0, Lcom/android/internal/app/ChooserActivity;->mSShareChooserAdapterList:Ljava/util/List;

    new-instance v11, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;

    invoke-direct {v11, p0, p0}, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;-><init>(Lcom/android/internal/app/ResolverActivity;Landroid/content/Context;)V

    invoke-interface {v10, v14, v11}, Ljava/util/List;->add(ILjava/lang/Object;)V
    ...
    const-string/jumbo v10, "panelkey_%1$d_%2$d"
    ...
    invoke-virtual {v10, v4}, Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;->getItem(I)Lcom/android/internal/app/ResolverActivity$TargetInfo;
    ...
    check-cast v5, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;

    if-eqz v5, :cond_3

    iget-object v10, v5, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;->mList:Ljava/util/List;

    invoke-interface {v10, v7}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v10, v5, Lcom/android/internal/app/ResolverActivity$PageResolverListAdapter;->mKey:Ljava/util/List;

    invoke-interface {v10, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_3
    iget-object v10, p0, Lcom/android/internal/app/ChooserActivity;->mServiceTargetListMap:Ljava/util/Map;
...
.method public getLayoutResource()I
    ...
    sget v1, Lcom/samsung/android/share/SShareConstants;->SUPPORT_PAGE_MODE:I
...
.method public onMultiWindowModeChanged(Z)V
    ...
    invoke-super {p0, p1}, Lcom/android/internal/app/ResolverActivity;->onMultiWindowModeChanged(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;->forceHandlePackagesChanged()V

    iget-object v0, p0, Lcom/android/internal/app/ChooserActivity;->mResolverDrawerLayout:Lcom/android/internal/widget/ResolverDrawerLayout;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/android/internal/widget/ResolverDrawerLayout;->setIgnoreChildCountForAbsListView(Z)V
...
.method queryTargetServices(Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;)V
    ...
    invoke-virtual {v0, v10}, Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;->getDisplayResolveInfo(I)Lcom/android/internal/app/ResolverActivity$DisplayResolveInfo;

    move-result-object v8

    move-object/from16 v0, p1

    invoke-virtual {v0, v8}, Lcom/android/internal/app/ChooserActivity$ChooserListAdapter;->getScore(Lcom/android/internal/app/ResolverActivity$DisplayResolveInfo;)F
    ...
    iget-object v11, v5, Landroid/content/pm/ActivityInfo;->metaData:Landroid/os/Bundle;
    ...
    const-string/jumbo v21, "android.service.chooser.chooser_target_service"
    ...
    const-string/jumbo v21, "android.service.chooser.ChooserTargetService"
    ...
    iget-object v12, v0, Landroid/content/pm/ServiceInfo;->permission:Ljava/lang/String;

    const-string/jumbo v20, "android.permission.BIND_CHOOSER_TARGET_SERVICE"
    ...
    const-string/jumbo v20, "ChooserActivity"

    new-instance v21, Ljava/lang/StringBuilder;

    invoke-direct/range {v21 .. v21}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v22, "ChooserTargetService "
    ...
    const-string/jumbo v22, " does not require"
    ...
    const-string/jumbo v22, "android.permission.BIND_CHOOSER_TARGET_SERVICE"

    invoke-virtual/range {v21 .. v22}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v21

    const-string/jumbo v22, " - this service will not be queried for ChooserTargets."

    invoke-virtual/range {v21 .. v22}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v21

    const-string/jumbo v22, " add android:permission=\""
    ...
    const-string/jumbo v22, " to the <service> tag for "
    ...
    const-string/jumbo v22, " in the manifest."
    ...
    const-string/jumbo v22, "Could not look up service "
    ...
    const-string/jumbo v22, "; component name not found"
    ...
    :cond_3
    new-instance v7, Lcom/android/internal/app/ChooserActivity$ChooserTargetServiceConnection;

    move-object/from16 v0, p0

    invoke-direct {v7, v0, v8}, Lcom/android/internal/app/ChooserActivity$ChooserTargetServiceConnection;-><init>(Lcom/android/internal/app/ChooserActivity;Lcom/android/internal/app/ResolverActivity$DisplayResolveInfo;)V
    ...
    :cond_4
    invoke-static/range {v19 .. v19}, Lcom/samsung/android/app/SemDualAppManager;->isDualAppId(I)Z
    ...
    invoke-virtual {v0, v15, v7, v1, v2}, Lcom/android/internal/app/ChooserActivity;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
...
.method public startSelected(IZZ)V
    ...
    iget-object v3, p0, Lcom/android/internal/app/ChooserActivity;->mBixby:Lcom/samsung/android/share/SShareBixby;

    if-eqz v3, :cond_0

    iget-object v3, p0, Lcom/android/internal/app/ChooserActivity;->mBixby:Lcom/samsung/android/share/SShareBixby;

    invoke-virtual {v3}, Lcom/samsung/android/share/SShareBixby;->sendCancelForBixby()V
    ...
    sget v4, Lcom/samsung/android/share/SShareConstants;->SUPPORT_LOGGING:I
