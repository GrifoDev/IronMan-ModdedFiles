...
.method private applyMultiWindowDecorCaptionShade(Lcom/android/internal/widget/DecorCaptionView;)V
    ...
    invoke-virtual {p1}, Lcom/android/internal/widget/DecorCaptionView;->getBackView()Landroid/view/View;
...
.method private isDecorCaptionWindow()Z
    ...
    iget-boolean v1, v1, Lcom/android/internal/policy/DecorView;->mIsDexCompatWindow:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mWindow:Lcom/android/internal/policy/PhoneWindow;
...
.method private updateDecorCaptionWindowVisibility()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->setVisibility(I)V
    ...
    invoke-direct {p0, v2, v2, v0}, Lcom/android/internal/policy/MultiWindowDecorSupport;->updateFullScreenFreeformWindowCaptionVisibility(IZZ)V
...
.method public addDecorCaptionWindow()V
    ...
    invoke-static {v0}, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->-wrap0(Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;)V
...
.method public checkReadyToResizeFreeform(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v7}, Lcom/android/internal/policy/MultiWindowDecorSupport;->changeBorderColorWhenHeaderClicked(Z)V
    ...
    iget-boolean v5, v5, Lcom/android/internal/policy/DecorView;->mIsDexCompatWindow:Z
    ...
    :pswitch_0
    iput-boolean v8, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mCheckEdgeFirst:Z

    invoke-direct {p0, v3, v4, p1}, Lcom/android/internal/policy/MultiWindowDecorSupport;->checkEdgeFlags(IILandroid/view/MotionEvent;)I

    move-result v5

    iput v5, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mEdgeFlag:I
    ...
    invoke-direct {p0, v3, v4, v5}, Lcom/android/internal/policy/MultiWindowDecorSupport;->isOutOfInnerBoundsByEdgeFlag(III)Z
    ...
    iget-object v5, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mMultiWindowManager:Lcom/samsung/android/multiwindow/MultiWindowManager;
    ...
    invoke-virtual {v5, v2, v6, v7}, Lcom/samsung/android/multiwindow/MultiWindowManager;->startResizingFreeformTask(Landroid/os/IBinder;II)V
    ...
    iput v8, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mEdgeFlag:I
...
.method public dispatchHoverEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v3}, Lcom/android/internal/policy/DecorView;->getSystemUiVisibility()I

    move-result v3

    iget-object v4, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mDecorView:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v4}, Lcom/android/internal/policy/DecorView;->getWindowSystemUiVisibility()I
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/policy/MultiWindowDecorSupport;->isImmersiveMode(I)Z
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/policy/MultiWindowDecorSupport;->isImmersiveDecorCaptionWindow(I)Z
    ...
    invoke-direct {p0, v3}, Lcom/android/internal/policy/MultiWindowDecorSupport;->dipToPx(F)F
    ...
    iget-boolean v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mIsEnteredToShowingCaptionAreaInImmersive:Z

    if-nez v3, :cond_2

    iget-object v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mDecorCaptionWindow:Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;

    if-eqz v3, :cond_4

    iget-object v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mDecorCaptionWindow:Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;

    invoke-virtual {v3}, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->isShowing()Z
    ...
    const-string/jumbo v3, "MultiWindowDecorSupport"

    const-string/jumbo v4, "dispatchHoverEvent: post mShowDecorCaptionWindowRunnable"

    invoke-static {v3, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mHandler:Landroid/os/Handler;

    iget-object v4, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mShowDecorCaptionWindowRunnable:Ljava/lang/Runnable;

    iget v5, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mRequestTransientBarDelay:I
    ...
    iput-boolean v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mIsEnteredToShowingCaptionAreaInImmersive:Z
    ...
    const-string/jumbo v4, "dispatchHoverEvent: post mShowCaptionRunnable"

    invoke-static {v3, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mHandler:Landroid/os/Handler;

    iget-object v4, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mShowCaptionRunnable:Ljava/lang/Runnable;
    ...
    const-string/jumbo v4, "dispatchHoverEvent: cancel showing caption"
    ...
    iget-object v4, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mHandler:Landroid/os/Handler;
    ...
    :cond_7
    iget-object v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mHideCaptionRunnable:Ljava/lang/Runnable;

    goto :goto_2

    :pswitch_2
    sget-boolean v3, Lcom/android/internal/policy/MultiWindowDecorSupport;->SAFE_DEBUG:Z

    if-eqz v3, :cond_8

    const-string/jumbo v3, "MultiWindowDecorSupport"

    const-string/jumbo v4, "dispatchHoverEvent: ACTION_HOVER_EXIT"
...
.method public dispatchRequestedOrientation(I)V
    ...
    invoke-static {v0}, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->-get1(Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;)Lcom/android/internal/policy/DecorView;
...
.method public dispatchWindowSystemUiVisiblityChanged(I)V
    ...
    iget v5, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mLastWindowSystemUiVisibility:I
    ...
    iget-boolean v5, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mTempShowingFullscreenFreeformWindowCaption:Z

    if-eqz v5, :cond_1

    iput-boolean v7, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mTempShowingFullscreenFreeformWindowCaption:Z

    iget-object v5, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mHandler:Landroid/os/Handler;

    iget-object v6, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mHideDecorCaptionWindowRunnable:Ljava/lang/Runnable;
    ...
    :goto_0
    invoke-direct {p0, v4, v7, v8}, Lcom/android/internal/policy/MultiWindowDecorSupport;->updateFullScreenFreeformWindowCaptionVisibility(IZZ)V
    ...
    iget-object v6, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mHideCaptionRunnable:Ljava/lang/Runnable;
    ...
    invoke-virtual {v5}, Lcom/android/internal/policy/DecorView;->isShowingCaption()Z
    ...
    invoke-direct {p0, v7, v2, v7}, Lcom/android/internal/policy/MultiWindowDecorSupport;->updateFullScreenFreeformWindowCaptionVisibility(IZZ)V
    ...
    invoke-direct {p0, v8, v2, v7}, Lcom/android/internal/policy/MultiWindowDecorSupport;->updateFullScreenFreeformWindowCaptionVisibility(IZZ)V
    ...
    invoke-direct {p0, v8, v7, v7}, Lcom/android/internal/policy/MultiWindowDecorSupport;->updateFullScreenFreeformWindowCaptionVisibility(IZZ)V
    ...
    iget v5, v5, Lcom/android/internal/policy/DecorView;->mStackId:I
    ...
    iget-object v5, v5, Lcom/android/internal/policy/DecorView;->mDecorCaptionView:Lcom/android/internal/widget/DecorCaptionView;

    invoke-virtual {v5, v3}, Lcom/android/internal/widget/DecorCaptionView;->onConfigurationChanged(Z)V

    iget-object v5, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mDecorView:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v5, v3}, Lcom/android/internal/policy/DecorView;->enableCaption(Z)V
...
.method public hasDecorCaptionWindow()Z
    ...
    invoke-static {v1}, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->-get0(Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;)Landroid/view/Window;
...
.method public onMultiWindowModeChanged(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/widget/DecorCaptionView;->setOverlayWithAppContent(Z)V

    invoke-virtual {p0, v2}, Lcom/android/internal/policy/MultiWindowDecorSupport;->changeBorderColorWhenHeaderClicked(Z)V
...
.method onWindowFocusChanged(Z)V
    ...
    invoke-static {v0}, Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;->-get0(Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;)Landroid/view/Window;
...
.method public removeDecorCaptionWindow()V
    ...
    iput-object v1, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mDecorCaptionWindow:Lcom/android/internal/policy/MultiWindowDecorSupport$DecorCaptionWindow;
...
.method requestInvalidateRenderNode(Ljava/lang/String;)V
    ...
    iget-boolean v0, v2, Lcom/android/internal/policy/DecorView;->mIsDexCompatWindow:Z
...
.method public updateDexInfo()V
    ...
    iget-object v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mMultiWindowManager:Lcom/samsung/android/multiwindow/MultiWindowManager;
    ...
    invoke-virtual {v3, v6, v7}, Lcom/samsung/android/multiwindow/MultiWindowManager;->getDexInfo(Landroid/os/IBinder;I)I
    ...
    :goto_0
    iput-boolean v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mIsInMultiWindow:Z
    ...
    :goto_1
    iput-boolean v3, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mCanMaximize:Z
    ...
    :goto_2
    iput-boolean v4, p0, Lcom/android/internal/policy/MultiWindowDecorSupport;->mIsPreserveOrientationMode:Z
    ...
    const-string/jumbo v5, "updateDexInfo: 0x"
    ...
    invoke-virtual {p0}, Lcom/android/internal/policy/MultiWindowDecorSupport;->hashCode()I
