...
.field static final DEX_NAVIBAR_COLOR:I = -0xf0f10
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v2, p0, Lcom/android/internal/policy/PhoneWindow;->mIsParentThemeDeviceDefaultLight:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Window;)V
    ...
    iput-boolean v3, p0, Lcom/android/internal/policy/PhoneWindow;->mUseDecorContext:Z
    ...
    iget v2, v2, Lcom/android/internal/policy/DecorView;->mStackId:I
    ...
    iget v2, p0, Lcom/android/internal/policy/PhoneWindow;->mElevation:F

    invoke-virtual {p0, v2}, Lcom/android/internal/policy/PhoneWindow;->setElevation(F)V

    :cond_0
    iput-boolean v0, p0, Lcom/android/internal/policy/PhoneWindow;->mLoadElevation:Z

    iput-boolean v3, p0, Lcom/android/internal/policy/PhoneWindow;->mForceDecorInstall:Z
    ...
    const-string/jumbo v4, "force_resizable_activities"
    ...
    const-string/jumbo v3, "android.software.picture_in_picture"
    ...
    :goto_0
    iput-boolean v2, p0, Lcom/android/internal/policy/PhoneWindow;->mSupportsPictureInPicture:Z
...
.method private setNavigationBarIconColorInDarkBar(Z)V
    .locals 6
    ...
    invoke-virtual {v3, v5}, Landroid/view/WindowManager$LayoutParams;->semSetNavigationBarIconColor(I)V
    ...
    invoke-virtual {v3}, Lcom/android/internal/policy/DecorView;->isAttachedToWindow()Z
    ...
    invoke-virtual {v3, v4}, Landroid/view/WindowManager$LayoutParams;->semSetNavigationBarIconColor(I)V
...
.method protected dispatchWindowAttributesChanged(Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-virtual {v4, v6, v5}, Lcom/android/internal/policy/DecorView;->updateColorViews(Landroid/view/WindowInsets;Z)Landroid/view/WindowInsets;
    ...
    iget-object v4, v4, Lcom/android/internal/policy/DecorView;->mDecorCaptionView:Lcom/android/internal/widget/DecorCaptionView;

    if-eqz v4, :cond_1

    iget-object v4, p0, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    iget v4, v4, Lcom/android/internal/policy/DecorView;->mStackId:I
    ...
    iget-object v4, v4, Lcom/android/internal/policy/DecorView;->mMultiWindowDecorSupportBridge:Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;

    invoke-virtual {v4}, Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;->isFullWindow()Z
    ...
    iget-boolean v2, v4, Lcom/android/internal/policy/DecorView;->mIsDesktopModeEnabled:Z
    ...
    invoke-virtual {v4}, Lcom/android/internal/policy/DecorView;->getSystemUiVisibility()I

    move-result v4

    iget-object v5, p0, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v5}, Lcom/android/internal/policy/DecorView;->getWindowSystemUiVisibility()I
    ...
    invoke-virtual {v4}, Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;->isTransientShowingDecorCaption()Z
    ...
    invoke-virtual {v4, v3}, Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;->isImmersiveMode(I)Z
    ...
    invoke-virtual {v4, v2}, Lcom/android/internal/widget/DecorCaptionView;->onConfigurationChanged(Z)V

    iget-object v4, p0, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v4, v2}, Lcom/android/internal/policy/DecorView;->enableCaption(Z)V
...
.method protected generateLayout(Lcom/android/internal/policy/DecorView;)Landroid/view/ViewGroup;
    ...
    :cond_15
    sget-boolean v32, Lcom/samsung/android/framework/feature/NavigationBarFeatures;->SUPPORT_LIGHT_NAVIGATION_BAR:Z

    if-eqz v32, :cond_16

    sget-boolean v32, Lcom/android/internal/policy/PhoneWindow;->IS_FACTORY_MODE:Z
    ...
    const-string/jumbo v33, "current_sec_active_themepackage"
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/content/res/AssetManager;->getOverlays()Ljava/util/ArrayList;
    ...
    sget-boolean v32, Lcom/samsung/android/framework/feature/NavigationBarFeatures;->SUPPORT_CUSTOM_BG_COLOR:Z
    ...
    iput-boolean v0, v1, Lcom/android/internal/policy/PhoneWindow;->mIsParentThemeDeviceDefaultLight:Z
    ...
    const-string/jumbo v33, "navigationbar_current_color"
    ...
    const-string/jumbo v33, "navigationbar_theme_color"
    ...
    const-string/jumbo v33, "navigationbar_use_theme_default"
    ...
    invoke-virtual {v1}, Lcom/android/internal/policy/PhoneWindow;->getDynamicNavBarTweak()Z
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/policy/PhoneWindow;->setNavigationBarIconColorInDarkBar(Z)V
    ...
    invoke-virtual/range {v32 .. v33}, Lcom/android/internal/policy/DecorView;->setLastBackgroundResource(I)V
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/policy/DecorView;->startChanging()V
    ...
    invoke-virtual {v0, v1, v15}, Lcom/android/internal/policy/DecorView;->onResourcesLoaded(Landroid/view/LayoutInflater;I)V
    ...
    const-string/jumbo v33, "Window couldn\'t find content container view"
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/content/Context;->getTheme()Landroid/content/res/Resources$Theme;
    ...
    invoke-virtual/range {v32 .. v33}, Landroid/content/Context;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v32 .. v33}, Lcom/android/internal/policy/DecorView;->setElevation(F)V
    ...
    invoke-virtual/range {v32 .. v33}, Lcom/android/internal/policy/DecorView;->setClipToOutline(Z)V
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/policy/DecorView;->finishChanging()V
...
.method public getDynamicNavBarTweak()Z
    .locals 3
    ...
    const-string/jumbo v1, "dynamic_navbar"
...
.method public resetWindowStateIfNeeded()V
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/internal/policy/DecorView;->resetDecorViewStateIfNeeded()V
...
.method public setNavigationBarColor(I)V
    ...
    invoke-virtual {v1, v4, v2}, Lcom/android/internal/policy/DecorView;->updateColorViews(Landroid/view/WindowInsets;Z)Landroid/view/WindowInsets;

    iget-object v1, p0, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v1}, Lcom/android/internal/policy/DecorView;->updateNavigationGuardColor()V
    ...
    :goto_0
    invoke-direct {p0, v3}, Lcom/android/internal/policy/PhoneWindow;->setNavigationBarIconColorInDarkBar(Z)V

    iget-object v1, p0, Lcom/android/internal/policy/PhoneWindow;->mDecor:Lcom/android/internal/policy/DecorView;

    invoke-virtual {v1, v0}, Lcom/android/internal/policy/DecorView;->setSystemUiVisibilityInternal(I)V
...
.method public setNavigationBarInternalColor(I)V
    ...
    invoke-virtual {v2, v5, v4}, Lcom/android/internal/policy/DecorView;->updateColorViews(Landroid/view/WindowInsets;Z)Landroid/view/WindowInsets;
