...
.method public onDestroyActionMode(Landroid/view/ActionMode;)V
    ...
    iget-object v7, p0, Lcom/android/internal/policy/DecorView$ActionModeCallback2Wrapper;->mWrapped:Landroid/view/ActionMode$Callback;

    invoke-interface {v7, p1}, Landroid/view/ActionMode$Callback;->onDestroyActionMode(Landroid/view/ActionMode;)V
    ...
    invoke-static {v7}, Lcom/android/internal/policy/DecorView;->-get0(Lcom/android/internal/policy/DecorView;)Landroid/content/Context;
    ...
    iget-object v7, v7, Lcom/android/internal/policy/DecorView;->mLogTag:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "Destroying unexpected ActionMode instance of TYPE_PRIMARY; "
    ...
    const-string/jumbo v9, " was not the current primary action mode! Expected "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/internal/policy/DecorView$ActionModeCallback2Wrapper;->this$0:Lcom/android/internal/policy/DecorView;

    iget-object v9, v9, Lcom/android/internal/policy/DecorView;->mPrimaryActionMode:Landroid/view/ActionMode;
    ...
    const-string/jumbo v8, "Destroying unexpected ActionMode instance of TYPE_FLOATING; "
    ...
    const-string/jumbo v8, " was not the current floating action mode! Expected "
    ...
    invoke-static {v8}, Lcom/android/internal/policy/DecorView;->-get2(Lcom/android/internal/policy/DecorView;)Landroid/view/ActionMode;
    ...
    iput-object v10, v5, Lcom/android/internal/policy/DecorView;->mPrimaryActionMode:Landroid/view/ActionMode;
    ...
    invoke-static {v6}, Lcom/android/internal/widget/FloatingToolbar;->setMovingStarted(Z)V

    iget-object v5, p0, Lcom/android/internal/policy/DecorView$ActionModeCallback2Wrapper;->this$0:Lcom/android/internal/policy/DecorView;

    invoke-static {v5, v10}, Lcom/android/internal/policy/DecorView;->-set1(Lcom/android/internal/policy/DecorView;Landroid/view/ActionMode;)Landroid/view/ActionMode;
