...
.method public constructor <init>(Landroid/widget/ActionMenuPresenter;Landroid/content/Context;)V
    ...
    iput v9, p0, Landroid/widget/ActionMenuPresenter$SemOverflowText;->mCurrentFontScale:F
    ...
    iput-object v4, p0, Landroid/widget/ActionMenuPresenter$SemOverflowText;->mDefaultBackground:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v4, p0, Landroid/widget/ActionMenuPresenter$SemOverflowText;->mShowingButtonBackground:Landroid/graphics/drawable/Drawable;
...
.method private changeButtonBackground()V
    ...
    iput-object v0, p0, Landroid/widget/ActionMenuPresenter$SemOverflowText;->mDefaultBackground:Landroid/graphics/drawable/Drawable;

    :goto_1
    if-eqz v1, :cond_2

    iget-object v2, p0, Landroid/widget/ActionMenuPresenter$SemOverflowText;->mShowingButtonBackground:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v2, p0, Landroid/widget/ActionMenuPresenter$SemOverflowText;->mShowingButtonBackground:Landroid/graphics/drawable/Drawable;

    goto :goto_1

    :cond_2
    iget-object v2, p0, Landroid/widget/ActionMenuPresenter$SemOverflowText;->mDefaultBackground:Landroid/graphics/drawable/Drawable;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput v5, p0, Landroid/widget/ActionMenuPresenter$SemOverflowText;->mCurrentFontScale:F
