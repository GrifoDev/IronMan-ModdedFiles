...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean v4, p0, Landroid/widget/HorizontalScrollView;->mUseRatioMaintainedImage:Z
    ...
    :goto_1
    iput-boolean v4, p0, Landroid/widget/HorizontalScrollView;->mChangedTheme:Z
...
.method private handleMessage(Landroid/os/Message;)V
    ...
    :cond_1
    invoke-virtual {p0, v2, v0}, Landroid/widget/HorizontalScrollView;->scrollBy(II)V
    ...
    iget v7, p0, Landroid/widget/HorizontalScrollView;->HOVERSCROLL_DELAY:I

    int-to-long v8, v7

    invoke-virtual {v6, v5, v8, v9}, Landroid/widget/HorizontalScrollView$HoverScrollHandler;->sendEmptyMessageDelayed(IJ)Z
    ...
    iget v7, p0, Landroid/widget/HorizontalScrollView;->mPaddingTop:I
    ...
    invoke-virtual {v6, v1, v7}, Landroid/widget/EdgeEffect;->setSize(II)V

    iget-object v6, p0, Landroid/widget/HorizontalScrollView;->mEdgeGlowLeft:Landroid/widget/EdgeEffect;

    invoke-virtual {v6, v10}, Landroid/widget/EdgeEffect;->onPull(F)V
    ...
    invoke-virtual {v6, v5}, Landroid/widget/HorizontalScrollView$HoverScrollHandler;->hasMessages(I)Z
    ...
    invoke-virtual {v6, v5}, Landroid/widget/HorizontalScrollView$HoverScrollHandler;->removeMessages(I)V
