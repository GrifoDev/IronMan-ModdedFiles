...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput v1, p0, Landroid/widget/ScrollView;->NORMALIZED_EDGEGLOW_DISTANCE:F
    ...
    iput v2, p0, Landroid/widget/ScrollView;->GTP_STATE_PRESSED:I

    const/4 v1, 0x3

    iput v1, p0, Landroid/widget/ScrollView;->GTP_STATE_MAINTAINED:I
    ...
    iput v1, p0, Landroid/widget/ScrollView;->mHoverScrollDirection:I
...
.method private semIsSupportGotoTop()Z
    ...
    iget-boolean v1, p0, Landroid/widget/ScrollView;->mSemEnableGoToTop:Z
...
.method private semSetupGoToTop(I)V
    ...
    :cond_0
    iget-object v7, p0, Landroid/widget/ScrollView;->mSemAutoHide:Ljava/lang/Runnable;

    invoke-virtual {p0, v7}, Landroid/widget/ScrollView;->removeCallbacks(Ljava/lang/Runnable;)Z
    ...
    iget-object v7, p0, Landroid/widget/ScrollView;->mSemGoToTopImage:Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    iget-boolean v7, p0, Landroid/widget/ScrollView;->mIsGoToTopShown:Z

    if-nez v7, :cond_3

    if-nez p1, :cond_3

    iget v7, p0, Landroid/widget/ScrollView;->mSemGoToTopLastState:I

    if-eqz v7, :cond_3

    iget-object v7, p0, Landroid/widget/ScrollView;->mSemGoToTopFadeOutRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0, v7}, Landroid/widget/ScrollView;->post(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {p0, v4}, Landroid/widget/ScrollView;->getLocationInWindow([I)V
    ...
    iput-boolean v12, p0, Landroid/widget/ScrollView;->mIsGoToTopShown:Z
    ...
    iget-boolean v7, p0, Landroid/widget/ScrollView;->mSizeChange:Z

    if-eqz v7, :cond_9

    :cond_8
    iget-object v7, p0, Landroid/widget/ScrollView;->mSemGoToTopFadeInRunnable:Ljava/lang/Runnable;

    invoke-virtual {p0, v7}, Landroid/widget/ScrollView;->post(Ljava/lang/Runnable;)Z

    :cond_9
    iput-boolean v12, p0, Landroid/widget/ScrollView;->mSizeChange:Z

    iget v7, p0, Landroid/widget/ScrollView;->mSemGoToTopState:I

    iput v7, p0, Landroid/widget/ScrollView;->mSemGoToTopLastState:I
    ...
    iget-object v7, p0, Landroid/widget/ScrollView;->mSemGoToTopRect:Landroid/graphics/Rect;
    ...
    iget v8, p0, Landroid/widget/ScrollView;->mGoToTopWH:I

    div-int/lit8 v8, v8, 0x2

    sub-int v8, v0, v8

    iget v9, p0, Landroid/widget/ScrollView;->mGoToTopWH:I

    sub-int v9, v3, v9

    iget v10, p0, Landroid/widget/ScrollView;->mGoToTopGap:I

    sub-int/2addr v9, v10

    iget v10, p0, Landroid/widget/ScrollView;->mGoToTopWH:I

    div-int/lit8 v10, v10, 0x2

    add-int/2addr v10, v0

    iget v11, p0, Landroid/widget/ScrollView;->mGoToTopGap:I
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-super {p0, v7, v2}, Landroid/widget/FrameLayout;->scrollTo(II)V
