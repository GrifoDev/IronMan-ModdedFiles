...
.method public handleShow(Landroid/os/IBinder;)V
    ...
    sget-boolean v7, Landroid/widget/Toast;->localLOGV:Z
    ...
    const-string/jumbo v9, "HANDLE SHOW: "
    ...
    const-string/jumbo v9, " mNextView="
    ...
    iput-object v4, v7, Landroid/view/WindowManager$LayoutParams;->packageName:Ljava/lang/String;
    ...
    :goto_0
    iput-wide v8, v7, Landroid/view/WindowManager$LayoutParams;->hideTimeoutMilliseconds:J

    iget-object v7, p0, Landroid/widget/Toast$TN;->mParams:Landroid/view/WindowManager$LayoutParams;

    iput-object p1, v7, Landroid/view/WindowManager$LayoutParams;->token:Landroid/os/IBinder;
    ...
    :cond_5
    iget-boolean v7, p0, Landroid/widget/Toast$TN;->mDisableHWAcceleration:Z
    ...
    const-string/jumbo v9, "DISABLE HWACCELERATION! "
    ...
    invoke-virtual {v7, v8}, Landroid/view/View;->semAddExtentionFlags(I)V
    ...
    invoke-interface {v5, v10, v9}, Ljava/lang/CharSequence;->subSequence(II)Ljava/lang/CharSequence;
