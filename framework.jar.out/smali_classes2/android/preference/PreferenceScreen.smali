...
.field private pressedPosition:I
...
.method static synthetic -get6(Landroid/preference/PreferenceScreen;)I
    ...
    iget v0, p0, Landroid/preference/PreferenceScreen;->pressedPosition:I
...
.method static synthetic -set7(Landroid/preference/PreferenceScreen;I)I
    ...
    iput p1, p0, Landroid/preference/PreferenceScreen;->pressedPosition:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v3, p0, Landroid/preference/PreferenceScreen;->mLocationTouchDownX:F

    iput v3, p0, Landroid/preference/PreferenceScreen;->mMovedDeltaX:F

    const/4 v1, -0x1

    iput v1, p0, Landroid/preference/PreferenceScreen;->pressedPosition:I
    ...
    iput v1, p0, Landroid/preference/PreferenceScreen;->mScaledTouchSlop:I
    ...
    iput-object v1, p0, Landroid/preference/PreferenceScreen;->TAG:Ljava/lang/String;

    new-instance v1, Landroid/preference/PreferenceScreen$TouchListener;

    invoke-direct {v1, p0, v6}, Landroid/preference/PreferenceScreen$TouchListener;-><init>(Landroid/preference/PreferenceScreen;Landroid/preference/PreferenceScreen$TouchListener;)V

    iput-object v1, p0, Landroid/preference/PreferenceScreen;->mTouchListener:Landroid/preference/PreferenceScreen$TouchListener;
    ...
    invoke-virtual {p1, v6, v1, v5, v2}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    iget-boolean v1, p0, Landroid/preference/PreferenceScreen;->TW_SCAFE_2015A:Z
