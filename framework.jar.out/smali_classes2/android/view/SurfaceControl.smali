...
.field public static final FLAG_SKIP_CAPTURE_SURFACE:I = 0x2000000
...
.method public static screenshot(II)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0}, Landroid/view/SurfaceControl;->maybeRedirected(Landroid/os/IBinder;)Z
    ...
    invoke-static/range {v0 .. v8}, Landroid/view/SurfaceControl;->screenshotRedirected(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZZI)Landroid/graphics/Bitmap;
...
.method private static screenshot(Landroid/os/IBinder;Landroid/view/Surface;Landroid/graphics/Rect;IIIIZZ)V
    ...
    :cond_1
    invoke-static {p0}, Landroid/view/SurfaceControl;->maybeRedirected(Landroid/os/IBinder;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-static {p0, v1}, Landroid/view/SurfaceControl;->getMainDisplayOverride(Landroid/os/IBinder;[I)Landroid/os/IBinder;
