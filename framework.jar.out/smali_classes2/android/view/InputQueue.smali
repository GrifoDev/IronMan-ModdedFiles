...
.method public sendInputEvent(Landroid/view/InputEvent;Ljava/lang/Object;ZLandroid/view/InputQueue$FinishedInputEventCallback;)V
    ...
    iget-wide v8, p0, Landroid/view/InputQueue;->mPtr:J

    check-cast p1, Landroid/view/KeyEvent;

    invoke-static {v8, v9, p1, p3}, Landroid/view/InputQueue;->nativeSendKeyEvent(JLandroid/view/KeyEvent;Z)J

    move-result-wide v2

    :goto_0
    iget-object v7, p0, Landroid/view/InputQueue;->mActiveEventArray:Landroid/util/LongSparseArray;

    invoke-virtual {v7, v2, v3, v1}, Landroid/util/LongSparseArray;->put(JLjava/lang/Object;)V
    ...
    invoke-static {v6, v7, v8}, Landroid/view/MotionEvent;->obtain(Landroid/view/MotionEvent;FF)Landroid/view/MotionEvent;

    move-result-object v0

    iget-wide v8, p0, Landroid/view/InputQueue;->mPtr:J

    invoke-static {v8, v9, v0}, Landroid/view/InputQueue;->nativeSendMotionEvent(JLandroid/view/MotionEvent;)J
    ...
    invoke-static {v8, v9, p1}, Landroid/view/InputQueue;->nativeSendMotionEvent(JLandroid/view/MotionEvent;)J
