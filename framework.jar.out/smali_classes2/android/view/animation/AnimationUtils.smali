...
.method private static createInterpolatorFromXml(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
    ...
    :cond_b
    const-string/jumbo v5, "Elastic5"
    ...
    new-instance v2, Landroid/view/animation/ElasticCustom;

    const v5, 0x3fb33333    # 1.4f

    invoke-direct {v2, v6, v5}, Landroid/view/animation/ElasticCustom;-><init>(FF)V

    goto/16 :goto_0

    :cond_c
    const-string/jumbo v5, "Elastic10"
    ...
    :cond_d
    const-string/jumbo v5, "Elastic40"
    ...
    :cond_e
    const-string/jumbo v5, "Elastic50"
    ...
    invoke-direct {v2, v6, v7}, Landroid/view/animation/ElasticCustom;-><init>(FF)V

    goto/16 :goto_0

    :cond_f
    const-string/jumbo v5, "Elastic60"
...
.method public static loadAnimation(Landroid/content/Context;I)Landroid/view/animation/Animation;
    ...
    :try_start_1
    invoke-static {p0, v3}, Landroid/view/animation/AnimationUtils;->createAnimationFromXml(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Animation;
    :try_end_1
    ...
    :try_start_2
    const-string/jumbo v7, "AnimationUtils"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "RuntimeException for unknown animation name, resouce ID #0x"
    ...
    const-string/jumbo v9, "loadAnimation: getConfiguration = "
    ...
    const-string/jumbo v9, "loadAnimation: getDisplayMetrics = "
    ...
    const-string/jumbo v9, "loadAnimation: resourceName = "
