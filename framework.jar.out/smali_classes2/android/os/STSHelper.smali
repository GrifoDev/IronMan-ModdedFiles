...
.method public declared-synchronized getSTSOption(Ljava/lang/String;)D
    ...
    :cond_0
    invoke-static {}, Landroid/os/OdtcHelper;->getInstance()Landroid/os/OdtcHelper;

    move-result-object v3

    iput-object v3, p0, Landroid/os/STSHelper;->mOdtcHelper:Landroid/os/OdtcHelper;

    iget-object v3, p0, Landroid/os/STSHelper;->mOdtcHelper:Landroid/os/OdtcHelper;

    invoke-virtual {v3, p1}, Landroid/os/OdtcHelper;->isPackageExist(Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, p1}, Landroid/os/OdtcHelper;->getODTCOption(Ljava/lang/String;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
