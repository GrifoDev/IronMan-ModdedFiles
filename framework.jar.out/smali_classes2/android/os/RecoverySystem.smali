...
.method public static installPackage(Landroid/content/Context;Ljava/io/File;Z)V
    ...
    sget-object v20, Landroid/os/RecoverySystem;->sRequestLock:Ljava/lang/Object;

    monitor-enter v20

    :try_start_0
    sget-object v17, Landroid/os/RecoverySystem;->LOG_FILE:Ljava/io/File;

    invoke-virtual/range {v17 .. v17}, Ljava/io/File;->delete()Z

    sget-object v17, Landroid/os/RecoverySystem;->UNCRYPT_PACKAGE_FILE:Ljava/io/File;
    ...
    const-string/jumbo v17, "RecoverySystem"

    new-instance v18, Ljava/lang/StringBuilder;

    invoke-direct/range {v18 .. v18}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v19, "!!! REBOOTING TO INSTALL "
    ...
    sget-object v17, Landroid/os/RecoverySystem;->BLOCK_MAP_FILE:Ljava/io/File;
    ...
    const-string/jumbo v18, "Package claimed to have been processed but failed to find the block map file."

    invoke-static/range {v17 .. v18}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v17, Ljava/io/IOException;

    const-string/jumbo v18, "Failed to find block map file"
    ...
    invoke-direct {v15, v0}, Ljava/io/FileWriter;-><init>(Ljava/io/File;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual/range {v17 .. v19}, Ljava/io/File;->setWritable(ZZ)Z
    ...
    const-string/jumbo v19, "Error setting permission for "

    invoke-virtual/range {v18 .. v19}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v18

    sget-object v19, Landroid/os/RecoverySystem;->UNCRYPT_PACKAGE_FILE:Ljava/io/File;
    ...
    :cond_3
    const-string/jumbo v5, "@/cache/recovery/block.map"
    ...
    const-string/jumbo v18, "--update_package="
    ...
    invoke-virtual/range {v18 .. v18}, Ljava/util/Locale;->toLanguageTag()Ljava/lang/String;
    ...
    const-string/jumbo v18, "--carry_out=open_fota\n"
    ...
    const-string/jumbo v18, "--security\n"
    ...
    :cond_5
    const-string/jumbo v17, "recovery"
    ...
    invoke-direct {v12, v3}, Landroid/os/RecoverySystem;->setupBcb(Ljava/lang/String;)Z
    ...
    const-string/jumbo v18, "Setup BCB failed"
    ...
    const-string/jumbo v18, "!@[reset tracking] installPackage write to recovery_cause"
    ...
    const-string/jumbo v17, "/sys/class/sec/sec_debug/recovery_cause"

    move-object/from16 v0, v17

    invoke-direct {v11, v0}, Ljava/io/FileWriter;-><init>(Ljava/lang/String;)V
    :try_end_4
    ...
    const-string/jumbo v19, "RecoverySystem installPackage: "
    ...
    const-string/jumbo v18, "IOException when writing /sys/class/sec/sec_debug/recovery_cause:"
    ...
    const-string/jumbo v18, "android.software.leanback"
    ...
    const-string/jumbo v18, ",quiescent"
    ...
    const-string/jumbo v18, "Reboot failed (no permissions?)"
