...
.field public static final enum STATE_LAUNCH_CHOOSE_LOCK_PASSWORD_ACTIVITY:Landroid/content/pm/PersonaAttribute;

.field public static final enum STATE_LAUNCH_SAMSUNG_ACCOUNT_ACTIVITY:Landroid/content/pm/PersonaAttribute;
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "STATE_LAUNCH_SAMSUNG_ACCOUNT_ACTIVITY"

    const/16 v2, 0xa

    invoke-direct {v0, v1, v2}, Landroid/content/pm/PersonaAttribute;-><init>(Ljava/lang/String;I)V

    sput-object v0, Landroid/content/pm/PersonaAttribute;->STATE_LAUNCH_SAMSUNG_ACCOUNT_ACTIVITY:Landroid/content/pm/PersonaAttribute;

    new-instance v0, Landroid/content/pm/PersonaAttribute;

    const-string/jumbo v1, "STATE_LAUNCH_CHOOSE_LOCK_PASSWORD_ACTIVITY"

    const/16 v2, 0xb

    invoke-direct {v0, v1, v2}, Landroid/content/pm/PersonaAttribute;-><init>(Ljava/lang/String;I)V

    sput-object v0, Landroid/content/pm/PersonaAttribute;->STATE_LAUNCH_CHOOSE_LOCK_PASSWORD_ACTIVITY:Landroid/content/pm/PersonaAttribute;
    ...
    sget-object v1, Landroid/content/pm/PersonaAttribute;->STATE_LAUNCH_SAMSUNG_ACCOUNT_ACTIVITY:Landroid/content/pm/PersonaAttribute;

    const/16 v2, 0xa

    aput-object v1, v0, v2

    sget-object v1, Landroid/content/pm/PersonaAttribute;->STATE_LAUNCH_CHOOSE_LOCK_PASSWORD_ACTIVITY:Landroid/content/pm/PersonaAttribute;
