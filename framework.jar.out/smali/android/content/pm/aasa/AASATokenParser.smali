...
.method private setTrustedFile(IJJ)V
    ...
    iget-object v3, p0, Landroid/content/pm/aasa/AASATokenParser;->secureTimePath:Ljava/lang/String;
    ...
    const-string/jumbo v5, "setTrustedTime() "
...
.method public AASA_VerifyToken(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    const-string/jumbo v39, " AASA_VerifyToken START"
    ...
    const-string/jumbo v39, " ERROR: plz check certification in the device"
    ...
    const-string/jumbo v40, " ERROR: AASA_VerifyToken "
    ...
    const-string/jumbo v39, " Ship mode device does not support MODE 255"
    ...
    const-string/jumbo v40, "Violate security policy of MSTG. Package("
    ...
    const-string/jumbo v40, ") is blocked. "
    ...
    const-string/jumbo v40, " Token 0:"
    ...
    const-string/jumbo v38, "ADVANCEDDIGEST"
    ...
    const-string/jumbo v38, "CARRIERS"
    ...
    const-string/jumbo v38, "EXPIRED"
    ...
    const-string/jumbo v39, " Token does not have value"
    ...
    aget-object v40, v4, v16

    invoke-virtual/range {v40 .. v40}, Ljava/security/cert/Certificate;->getPublicKey()Ljava/security/PublicKey;

    move-result-object v40

    invoke-interface/range {v40 .. v40}, Ljava/security/PublicKey;->getEncoded()[B

    move-result-object v40

    invoke-static/range {v40 .. v40}, Landroid/content/pm/aasa/AASATokenParser;->toChars([B)[C
    ...
    const-string/jumbo v39, "OK:CERT"
    ...
    const-string/jumbo v39, "OK:UUID"
    ...
    const-string/jumbo v39, "OK:ACCOUNT"
    ...
    const-string/jumbo v39, "OK:AdvancedHASH"
    ...
    const-string/jumbo v40, "NOT OK:AdvancedHASH : "
    ...
    const-string/jumbo v39, "OK:HASH"
    ...
    const-string/jumbo v39, "createDate is bigger than expiredDate."
    ...
    const-string/jumbo v38, "DATELIMIT"
    ...
    const-string/jumbo v39, " Pass ALL"
    ...
    const-string/jumbo v39, " Fail:uuidList"
    ...
    const-string/jumbo v40, " PASS ALL with S/N:"
    ...
    const-string/jumbo v40, " FAIL only S/N:"
