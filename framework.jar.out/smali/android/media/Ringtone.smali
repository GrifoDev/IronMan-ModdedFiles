...
.method private actualURIfromDefaultURI(Z)Landroid/net/Uri;
    .locals 5
    ...
    invoke-static {v2, v1}, Landroid/media/RingtoneManager;->getActualDefaultRingtoneSetting(Landroid/content/Context;I)Landroid/net/Uri;
...
.method public setUri(Landroid/net/Uri;)Z
    ...
    invoke-direct {p0, v8}, Landroid/media/Ringtone;->actualURIfromDefaultURI(Z)Landroid/net/Uri;
    ...
    invoke-static {v5, v6}, Landroid/media/RingtoneManager;->isDRMRingtone(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-direct {p0, v5}, Landroid/media/Ringtone;->actualURIfromDefaultURI(Z)Landroid/net/Uri;
