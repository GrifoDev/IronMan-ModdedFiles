...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-boolean v9, p0, Landroid/media/MediaScanner;->useHashMap:Z

    iput-boolean v8, p0, Landroid/media/MediaScanner;->mCaseInsensitivePaths:Z
    ...
    iput v8, p0, Landroid/media/MediaScanner;->mSimSlotCount:I
    ...
    iput-object v10, p0, Landroid/media/MediaScanner;->mDrmManagerClient:Landroid/drm/DrmManagerClient;

    iput-wide v6, p0, Landroid/media/MediaScanner;->mTotalMakeEntryTime:J
    ...
    iput-wide v6, p0, Landroid/media/MediaScanner;->mTotalSefExtractingTime:J

    iput-wide v6, p0, Landroid/media/MediaScanner;->mTotalBulkInserterTime:J

    iput-wide v6, p0, Landroid/media/MediaScanner;->mTotalDeadThumbnailTime:J

    iput-wide v6, p0, Landroid/media/MediaScanner;->mTotalCheckedFiles:J

    iput-wide v6, p0, Landroid/media/MediaScanner;->mTotalCheckedDirectories:J

    iput-wide v6, p0, Landroid/media/MediaScanner;->mTotalInserted:J

    iput-wide v6, p0, Landroid/media/MediaScanner;->mTotalUpdated:J

    iput-wide v6, p0, Landroid/media/MediaScanner;->mPrescanBulkDeleted:J

    iput v8, p0, Landroid/media/MediaScanner;->mDeleteImageNum:I

    iput v8, p0, Landroid/media/MediaScanner;->mDeleteAudioNum:I

    iput v8, p0, Landroid/media/MediaScanner;->mDeleteVideoNum:I

    iput v8, p0, Landroid/media/MediaScanner;->mDeleteEtcNum:I
    ...
    iput-object v10, p0, Landroid/media/MediaScanner;->mOmcPath:Ljava/lang/String;
    ...
    iput-object v4, p0, Landroid/media/MediaScanner;->mOmcPath:Ljava/lang/String;
    ...
    iput-object v10, p0, Landroid/media/MediaScanner;->mPlaylistsUri:Landroid/net/Uri;

    iput-boolean v9, p0, Landroid/media/MediaScanner;->mIsInternal:Z
    ...
    iput v4, p0, Landroid/media/MediaScanner;->mSimSlotCount:I
...
.method private prescan(Ljava/lang/String;ZLjava/lang/String;)V
    ...
    const-string/jumbo v4, "(((_data >= \'/omr\') AND (_data < \'/omr0\')) OR ((_data >= \'/system/omc\') AND (_data < \'/system/omc0\'))) AND (NOT _data LIKE \'"
    ...
    const-string/jumbo v4, "prescan#1: already nomedia scan requested so skip"
...
.method private prescan(Z)V
    ...
    invoke-static/range {v20 .. v20}, Landroid/media/MediaFile;->getFileType(Ljava/lang/String;)Landroid/media/MediaFile$MediaFileType;
...
.method public scanDirectories([Ljava/lang/String;)V
    ...
    invoke-static/range {v40 .. v40}, Landroid/media/MediaScanner;->encodeStringResource(Ljava/lang/String;)Ljava/lang/String;
