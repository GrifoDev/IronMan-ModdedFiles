...
.method final dispatchMultiWindowModeChanged(Z)V
    ...
    invoke-virtual {v1, p1}, Landroid/app/FragmentController;->dispatchMultiWindowModeChanged(Z)V
    ...
    invoke-virtual {v1}, Lcom/android/internal/policy/DecorView;->getMultiWindowDecorSupportBridge()Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1}, Lcom/samsung/android/internal/policy/MultiWindowDecorSupportBridge;->onMultiWindowModeChanged(Z)V
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    sput v10, Landroid/app/Activity;->mDragBoostPossible:I
    ...
    sget-object v6, Landroid/app/Activity;->mPerf:Landroid/util/BoostFramework;
    ...
    sput-object v6, Landroid/app/Activity;->mPerf:Landroid/util/BoostFramework;
    ...
    invoke-virtual {v6, v1, p1, v7}, Landroid/util/BoostFramework;->boostOverride(Landroid/content/Context;Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Z
    ...
    :cond_2
    sget v6, Landroid/app/Activity;->mPerfLockDuration:I
    ...
    sput v6, Landroid/app/Activity;->mPerfLockDuration:I
    ...
    sput-object v6, Landroid/app/Activity;->mAsParamVal:[I
    ...
    sget-object v9, Landroid/app/Activity;->mAsParamVal:[I

    invoke-virtual {v6, p1, v7, v8, v9}, Landroid/util/BoostFramework;->perfLockAcquireTouch(Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;I[I)I
...
.method public executeAutoCapture()Z
    .locals 1
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v1, v4}, Landroid/graphics/Typeface;->SetAppTypeFace(Landroid/content/Context;Ljava/lang/String;)V

    sget-boolean v4, Landroid/app/Activity;->mSupportSmartManagerTrafficManagerFeature:Z
    ...
    iput-object v4, p0, Landroid/app/Activity;->mPolicyManager:Landroid/net/NetworkPolicyManager;
    ...
    invoke-direct {p0, v4, v5}, Landroid/app/Activity;->checkFireWallPermission(Ljava/lang/String;I)V
    ...
    iput-boolean v6, p0, Landroid/app/Activity;->mEnableDefaultActionBarUp:Z
    ...
    :cond_3
    invoke-virtual {v4, v2, v3}, Landroid/app/FragmentController;->restoreAllState(Landroid/os/Parcelable;Landroid/app/FragmentManagerNonConfig;)V
    ...
    invoke-virtual {v4, v6}, Landroid/app/ActionBar;->setDefaultDisplayHomeAsUpEnabled(Z)V
...
.method final performPause()V
    ...
    invoke-virtual {v0}, Landroid/view/Window;->resetWindowStateIfNeeded()V
