...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/app/WallpaperManager;->SUPPORT_INFINITY_WALLPAPER:Z
    ...
    const-string/jumbo v2, "DEFAULT_INFINITY"
    ...
    :goto_0
    sput-boolean v0, Landroid/app/WallpaperManager;->SUPPORT_DEFAULT_INFINITY_WALLPAPER:Z
    ...
    sput-boolean v0, Landroid/app/WallpaperManager;->SUPPORT_MOTION_WALLPAPER:Z
    ...
    const-string/jumbo v2, "DEFAULT_MOTION"
    ...
    :goto_1
    sput-boolean v0, Landroid/app/WallpaperManager;->SUPPORT_DEFAULT_MOTION_WALLPAPER:Z
...
.method private addInfinityWallpaperURI(ILjava/util/ArrayList;)V
    ...
    const-string/jumbo v12, "addInfinityWallpaperURI : "
    ...
    invoke-direct {p0, v10, v11}, Landroid/app/WallpaperManager;->getDefaultName(II)Ljava/lang/String;
    ...
    const-string/jumbo v11, "android.resource://com.android.systemui/drawable/"
    ...
    const-string/jumbo v11, "?locType=preloadDefault&type=infinity&colorInfo="
    ...
    const-string/jumbo v12, "infinityDefault wallpaper :"
    ...
    invoke-direct {p0, v11, v12}, Landroid/app/WallpaperManager;->getName(II)Ljava/lang/String;
    ...
    invoke-direct {p0, v10, v8}, Landroid/app/WallpaperManager;->getResourceID(ILjava/lang/String;)I
    ...
    const-string/jumbo v11, "?locType=preload&type=infinity&colorInfo="
    ...
    const-string/jumbo v12, "infinity wallpaper :"
...
.method public static getCSCWallpaperFile(ILandroid/app/WallpaperManager$SubUserWallpaperChecker;)Ljava/io/File;
    ...
    invoke-static {p0}, Landroid/app/WallpaperManager;->getOperatorFileName(I)Ljava/lang/String;
...
.method private static getCSCWallpaperFile(Landroid/app/WallpaperManager$SubUserWallpaperChecker;)Ljava/io/File;
    ...
    invoke-static {v4}, Landroid/app/WallpaperManager;->getOperatorFileName(I)Ljava/lang/String;
...
.method private getDefaultWallpaperInformation(I)Landroid/os/Bundle;
    ...
    :cond_0
    sget-boolean v7, Landroid/app/WallpaperManager;->SUPPORT_DEFAULT_INFINITY_WALLPAPER:Z
...
.method private getDefaultWallpaperURI(I)Ljava/lang/String;
    ...
    sget-boolean v6, Landroid/app/WallpaperManager;->SUPPORT_DEFAULT_INFINITY_WALLPAPER:Z
    ...
    sget-boolean v6, Landroid/app/WallpaperManager;->SUPPORT_DEFAULT_MOTION_WALLPAPER:Z
...
.method private static getOperatorFileName(I)Ljava/lang/String;
    .locals 4
    ...
    :goto_0
    sget-boolean v2, Landroid/app/WallpaperManager;->SUPPORT_CSC_CMF:Z
    ...
    :cond_1
    const-string/jumbo v1, "lockscreen_default_wallpaper"
...
.method private getPreloadWallpaperURI(ILjava/lang/String;)Ljava/lang/String;
    ...
    sget-boolean v5, Landroid/app/WallpaperManager;->SUPPORT_DEFAULT_MOTION_WALLPAPER:Z
...
.method private openDefaultInfinityWallpaper(Landroid/content/Context;)Ljava/io/InputStream;
    ...
    :try_start_0
    sget-object v9, Landroid/app/WallpaperManager;->sGlobals:Landroid/app/WallpaperManager$Globals;

    invoke-static {v9}, Landroid/app/WallpaperManager$Globals;->-get0(Landroid/app/WallpaperManager$Globals;)Landroid/app/IWallpaperManager;

    move-result-object v9

    invoke-interface {v9}, Landroid/app/IWallpaperManager;->getLastWallpaper()Landroid/content/ComponentName;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, v9}, Landroid/app/WallpaperManager;->parseInfinityColorInfo(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v10, "default_wallpaper_"
...
.method public static openDefaultWallpaper(Landroid/content/Context;I)Ljava/io/InputStream;
    ...
    :cond_0
    const-string/jumbo v9, "ro.config.wallpaper"
    ...
    invoke-static {v8, v11}, Landroid/app/WallpaperManager;->getDefaultWallpaperID(Landroid/content/Context;I)I
    ...
    invoke-static {p0, v12}, Landroid/app/WallpaperManager;->getDefaultWallpaperID(Landroid/content/Context;I)I
...
.method private setBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;ZIII)I
    ...
    :try_start_0
    sget-boolean v2, Landroid/app/WallpaperManager;->SUPPORT_INFINITY_WALLPAPER:Z
...
.method private setOpenThemeWallpaper(Landroid/graphics/Bitmap;Landroid/graphics/Rect;ZLjava/lang/String;ZZ)V
    ...
    invoke-static {v0, v1}, Landroid/app/WallpaperManager;->getCSCWallpaperFile(ILandroid/app/WallpaperManager$SubUserWallpaperChecker;)Ljava/io/File;
...
.method private setOppositeSideOfWallpaper(ILjava/lang/String;)V
    ...
    const-string/jumbo v3, "User id is between max and min presona id."
    ...
    const-string/jumbo v3, "setOppositeSideOfWallpaper set lock wallpaper to still image"
    ...
    invoke-virtual/range {v18 .. v19}, Landroid/content/res/Resources;->getResourceName(I)Ljava/lang/String;
    ...
    const-string/jumbo v3, "setOppositeSideOfWallpaper set home wallpaper to still image"
...
.method private setStream(Ljava/io/InputStream;Landroid/graphics/Rect;ZII)I
    ...
    :try_start_0
    sget-boolean v4, Landroid/app/WallpaperManager;->SUPPORT_INFINITY_WALLPAPER:Z
...
.method public clear(I)V
    ...
    sget-boolean v1, Landroid/app/WallpaperManager;->SUPPORT_DEFAULT_INFINITY_WALLPAPER:Z
...
.method public isInfinityWallpaper()Z
    ...
    const-string/jumbo v6, "wallpaper component="
    ...
    :cond_1
    invoke-direct {p0, v3}, Landroid/app/WallpaperManager;->isInfinityComponent(Ljava/lang/String;)Z
    ...
    const-string/jumbo v6, "isInfinityWallpaper = "
...
.method public setAnimatedLockscreenWallpaper(Ljava/lang/String;)V
    ...
    sget-boolean v3, Landroid/app/WallpaperManager;->SUPPORT_INFINITY_WALLPAPER:Z
