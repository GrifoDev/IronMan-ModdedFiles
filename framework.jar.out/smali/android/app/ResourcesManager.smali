...
.method private updateResourcesForOpenThemeChange(Landroid/content/res/Configuration;I)V
    ...
    invoke-direct/range {p0 .. p2}, Landroid/app/ResourcesManager;->isDesktopModeEnteringOrExiting(Landroid/content/res/Configuration;I)Z
    ...
    const-string/jumbo v4, "updateOpenThemeResourcesForDexModeChange for Desktop mode config="
    ...
    const-string/jumbo v4, ", uimode&mask = "
    ...
    const-string/jumbo v4, ", prevMode="
    ...
    iget v4, v0, Landroid/app/ResourcesManager;->prevMode:I
    ...
    check-cast v19, Landroid/content/res/ResourcesImpl;
    ...
    check-cast v21, Landroid/content/res/ResourcesKey;
    ...
    const-string/jumbo v4, "updateOpenThemeResourcesForDexModeChange adding to updatedResourceKeys for package "
    ...
    const-string/jumbo v4, " and overlays = null"
    ...
    const-string/jumbo v6, "/data/overlays/currentstyle"
    ...
    iget-object v9, v2, Landroid/content/pm/ApplicationInfo;->resourceDirs:[Ljava/lang/String;
    ...
    iget-object v7, v0, Landroid/content/res/ResourcesKey;->mResDir:Ljava/lang/String;

    move-object/from16 v0, v21

    iget-object v8, v0, Landroid/content/res/ResourcesKey;->mSplitResDirs:[Ljava/lang/String;

    move-object/from16 v0, v21

    iget-object v10, v0, Landroid/content/res/ResourcesKey;->mLibDirs:[Ljava/lang/String;

    move-object/from16 v0, v21

    iget v11, v0, Landroid/content/res/ResourcesKey;->mDisplayId:I

    move-object/from16 v0, v21

    iget-object v12, v0, Landroid/content/res/ResourcesKey;->mOverrideConfiguration:Landroid/content/res/Configuration;

    move-object/from16 v0, v21

    iget-object v13, v0, Landroid/content/res/ResourcesKey;->mCompatInfo:Landroid/content/res/CompatibilityInfo;

    move-object/from16 v0, v21

    iget-object v14, v0, Landroid/content/res/ResourcesKey;->mPackageName:Ljava/lang/String;

    move-object/from16 v0, v21

    iget v15, v0, Landroid/content/res/ResourcesKey;->mUserId:I

    const/16 v16, 0x0

    invoke-direct/range {v6 .. v16}, Landroid/content/res/ResourcesKey;-><init>(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;Ljava/lang/String;IZ)V
    ...
    iget-boolean v0, v0, Landroid/content/res/ResourcesKey;->mIsDesktopMode:Z
