...
.method private updateResourcesForOpenThemeChange(Landroid/content/res/Configuration;I)V
    ...
    const-string/jumbo v4, "updateResourcesForOpenThemeChange for Desktop mode config="
    ...
    const-string/jumbo v4, " may be deleted or updated in mResourceReferences"
    ...
    const-string/jumbo v4, " may be deleted or updated in mActivityResourceReferences"
...
.method private updateSystemOverlaysForDesktopMode(Landroid/content/res/Configuration;)V
    ...
    const-string/jumbo v9, ", uimode&mask = "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p1, Landroid/content/res/Configuration;->uiMode:I
    ...
    const-string/jumbo v9, ", prevMode="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Landroid/app/ResourcesManager;->prevMode:I
...
.method public final applyConfigurationToResourcesLocked(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Z
    ...
    invoke-direct {v0, v1, v2}, Landroid/app/ResourcesManager;->isDesktopModeEnteringOrExiting(Landroid/content/res/Configuration;I)Z

    move-result v15

    if-eqz v15, :cond_2

    invoke-direct/range {p0 .. p1}, Landroid/app/ResourcesManager;->updateSystemOverlaysForDesktopMode(Landroid/content/res/Configuration;)V
