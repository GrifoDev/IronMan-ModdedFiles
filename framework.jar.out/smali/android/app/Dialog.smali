...
.method public show()V
    ...
    invoke-virtual {v12, v13}, Landroid/view/Window;->hasFeature(I)Z
    ...
    invoke-virtual {v12, v13}, Landroid/view/Window;->invalidatePanelMenu(I)V
    ...
    iget-boolean v12, p0, Landroid/app/Dialog;->mCreated:Z

    if-nez v12, :cond_c

    const/4 v12, 0x0

    invoke-virtual {p0, v12}, Landroid/app/Dialog;->dispatchOnCreate(Landroid/os/Bundle;)V
    ...
    iput-object v12, p0, Landroid/app/Dialog;->mDecor:Landroid/view/View;

    iget-object v12, p0, Landroid/app/Dialog;->mActionBar:Landroid/app/ActionBar;
    ...
    iget v13, v5, Landroid/content/pm/ApplicationInfo;->icon:I

    invoke-virtual {v12, v13}, Landroid/view/Window;->setDefaultIcon(I)V

    iget-object v12, p0, Landroid/app/Dialog;->mWindow:Landroid/view/Window;

    iget v13, v5, Landroid/content/pm/ApplicationInfo;->logo:I

    invoke-virtual {v12, v13}, Landroid/view/Window;->setDefaultLogo(I)V

    new-instance v12, Lcom/android/internal/app/WindowDecorActionBar;

    invoke-direct {v12, p0}, Lcom/android/internal/app/WindowDecorActionBar;-><init>(Landroid/app/Dialog;)V

    iput-object v12, p0, Landroid/app/Dialog;->mActionBar:Landroid/app/ActionBar;
    ...
    iget v12, v8, Landroid/view/WindowManager$LayoutParams;->softInputMode:I
    ...
    invoke-virtual {v9, v8}, Landroid/view/WindowManager$LayoutParams;->copyFrom(Landroid/view/WindowManager$LayoutParams;)I

    iget v12, v9, Landroid/view/WindowManager$LayoutParams;->softInputMode:I

    or-int/lit16 v12, v12, 0x100

    iput v12, v9, Landroid/view/WindowManager$LayoutParams;->softInputMode:I
    ...
    iget-boolean v12, p0, Landroid/app/Dialog;->mIsDeviceDefault:Z
    ...
    iget-object v13, p0, Landroid/app/Dialog;->mDecor:Landroid/view/View;

    invoke-interface {v12, v13, v8}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    const/4 v6, 0x1

    :cond_8
    instance-of v12, p0, Landroid/app/ProgressDialog;

    if-eqz v12, :cond_9

    move-object v12, p0

    check-cast v12, Landroid/app/ProgressDialog;

    invoke-virtual {v12}, Landroid/app/ProgressDialog;->getCurrentProgressStyle()I
    ...
    iput-wide v12, v8, Landroid/view/WindowManager$LayoutParams;->dimDuration:J
    ...
    iput-boolean v12, p0, Landroid/app/Dialog;->mShowing:Z
    ...
    invoke-virtual {v12, v1}, Landroid/view/View;->dispatchConfigurationChanged(Landroid/content/res/Configuration;)V
