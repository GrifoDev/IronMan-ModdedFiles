...
.method constructor <init>(Landroid/content/Context;IZ)V
    ...
    iput-boolean v6, p0, Landroid/app/Dialog;->mCreated:Z

    iput-boolean v6, p0, Landroid/app/Dialog;->mShowing:Z
    ...
    iput v6, p0, Landroid/app/Dialog;->mActionModeTypeStarting:I

    new-instance v4, Landroid/app/Dialog$-void__init__android_content_Context_context_int_themeResId_boolean_createContextThemeWrapper_LambdaImpl0;

    invoke-direct {v4, p0}, Landroid/app/Dialog$-void__init__android_content_Context_context_int_themeResId_boolean_createContextThemeWrapper_LambdaImpl0;-><init>(Landroid/app/Dialog;)V

    iput-object v4, p0, Landroid/app/Dialog;->mDismissAction:Ljava/lang/Runnable;

    iput-boolean v6, p0, Landroid/app/Dialog;->mHasFocus:Z
    ...
    invoke-virtual {v3, v4, v8, v8}, Landroid/view/Window;->setWindowManager(Landroid/view/WindowManager;Landroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v7, v2, v6}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
    ...
    invoke-virtual {v4, v7, v0, v5}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
    ...
    :goto_1
    iput-boolean v4, p0, Landroid/app/Dialog;->mIsDeviceDefaultLight:Z
...
.method public show()V
    ...
    iget-object v10, p0, Landroid/app/Dialog;->mActionBar:Landroid/app/ActionBar;
    ...
    iget v11, v4, Landroid/content/pm/ApplicationInfo;->icon:I

    invoke-virtual {v10, v11}, Landroid/view/Window;->setDefaultIcon(I)V

    iget-object v10, p0, Landroid/app/Dialog;->mWindow:Landroid/view/Window;

    iget v11, v4, Landroid/content/pm/ApplicationInfo;->logo:I

    invoke-virtual {v10, v11}, Landroid/view/Window;->setDefaultLogo(I)V

    new-instance v10, Lcom/android/internal/app/WindowDecorActionBar;

    invoke-direct {v10, p0}, Lcom/android/internal/app/WindowDecorActionBar;-><init>(Landroid/app/Dialog;)V

    iput-object v10, p0, Landroid/app/Dialog;->mActionBar:Landroid/app/ActionBar;
    ...
    iget-boolean v10, p0, Landroid/app/Dialog;->mIsDeviceDefaultLight:Z
    ...
    invoke-interface {v10, v11, v9}, Landroid/view/WindowManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    const/4 v5, 0x1

    :cond_9
    instance-of v10, p0, Landroid/app/ProgressDialog;
    ...
    invoke-virtual {v10}, Landroid/app/ProgressDialog;->getCurrentProgressStyle()I
    ...
    iput-wide v10, v9, Landroid/view/WindowManager$LayoutParams;->dimDuration:J
