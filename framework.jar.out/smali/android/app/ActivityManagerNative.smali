...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface/range {v304 .. v304}, Ljava/util/List;->size()I
    ...
    invoke-interface/range {v395 .. v395}, Landroid/app/IAppTask;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {v302 .. v302}, Ljava/util/List;->size()I
    ...
    invoke-interface/range {v352 .. v352}, Landroid/content/IIntentSender;->asBinder()Landroid/os/IBinder;
    ...
    invoke-direct/range {v313 .. v313}, Landroid/app/ActivityManager$MemoryInfo;-><init>()V
    ...
    invoke-direct/range {v279 .. v279}, Landroid/app/ActivityManager$RunningAppProcessInfo;-><init>()V
    ...
    :cond_84
    invoke-virtual/range {v326 .. v326}, Landroid/app/ActivityOptions;->toBundle()Landroid/os/Bundle;
    ...
    move-wide/16 v350, v0

    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    move-object/from16 v0, p3

    move-wide/from16 v1, v350
    ...
    invoke-virtual {v0, v1}, Landroid/app/ActivityManagerNative;->setCustomStartingWindowParams(Landroid/os/Bundle;)Z
    ...
    invoke-virtual {v0, v1}, Landroid/app/ActivityManagerNative;->executeAutoCapture(Landroid/os/IBinder;)Z
    ...
    invoke-virtual {v0, v1}, Landroid/app/ActivityManagerNative;->getTaskInfoFromTaskId(I)Landroid/os/Bundle;
    ...
    invoke-static/range {v387 .. v387}, Ljava/lang/Float;->parseFloat(Ljava/lang/String;)F
    ...
    invoke-virtual/range {v370 .. v370}, Ljava/lang/Float;->floatValue()F
    ...
    invoke-virtual {v0, v1, v2}, Landroid/app/ActivityManagerNative;->setBackgroundSurfaceEnabledForPackage(Ljava/lang/String;Z)V
