...
.field final mPendingActivities:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap",
            "<",
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/app/ActivityThread;->mPendingActivities:Landroid/util/ArrayMap;
...
.method private handleMultiWindowFeaturesChanged()V
    ...
    invoke-virtual {v2}, Landroid/app/Activity;->onMultiWindowFeaturesChanged()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private handleRelaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    iget-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->token:Landroid/os/IBinder;

    if-ne v10, v9, :cond_0

    move-object p1, v7

    iget v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->pendingConfigChanges:I
    ...
    :goto_1
    iget-object v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->createdConfig:Landroid/content/res/Configuration;
    ...
    invoke-virtual {v10, v11}, Landroid/content/res/Configuration;->isOtherSeqNewer(Landroid/content/res/Configuration;)Z
    ...
    invoke-virtual {v10, v1}, Landroid/content/res/Configuration;->isOtherSeqNewer(Landroid/content/res/Configuration;)Z
    ...
    iget-boolean v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->onlyLocalRequest:Z
    ...
    invoke-interface {v10, v11}, Landroid/app/IActivityManager;->activityRelaunched(Landroid/os/IBinder;)V
    :try_end_2
    ...
    iput v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->lastProcessedSeq:I
    ...
    iget v11, v10, Landroid/app/Activity;->mConfigChangeFlags:I

    or-int/2addr v11, v2

    iput v11, v10, Landroid/app/Activity;->mConfigChangeFlags:I
    ...
    iput-boolean v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->mPreserveWindow:Z

    iget v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->lastProcessedSeq:I

    iput v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->lastProcessedSeq:I

    iget v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->relaunchSeq:I

    iput v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->relaunchSeq:I

    iget-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;

    iget-object v3, v10, Landroid/app/Activity;->mIntent:Landroid/content/Intent;

    iget-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;

    const/4 v11, 0x1

    iput-boolean v11, v10, Landroid/app/Activity;->mChangingConfigurations:Z

    :try_start_3
    iget-boolean v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->mPreserveWindow:Z
    ...
    iget-object v12, v7, Landroid/app/ActivityThread$ActivityClientRecord;->token:Landroid/os/IBinder;
    ...
    :goto_2
    invoke-interface {v11, v12, v10}, Landroid/view/IWindowSession;->prepareToReplaceWindows(Landroid/os/IBinder;Z)V
    :try_end_3
    .catch Landroid/os/RemoteException; {:try_start_3 .. :try_end_3} :catch_1

    :cond_c
    iget-boolean v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->paused:Z

    if-nez v10, :cond_d

    iget-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->token:Landroid/os/IBinder;

    invoke-virtual {v7}, Landroid/app/ActivityThread$ActivityClientRecord;->isPreHoneycomb()Z
    ...
    invoke-virtual {p0, v10, v13, v11, v12}, Landroid/app/ActivityThread;->performPauseActivity(Landroid/os/IBinder;ZZLjava/lang/String;)Landroid/os/Bundle;

    :cond_d
    iget-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->state:Landroid/os/Bundle;

    if-nez v10, :cond_e

    iget-boolean v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->stopped:Z
    ...
    instance-of v10, v10, Lcom/android/internal/policy/PhoneWindow;
    ...
    invoke-virtual {v10}, Lcom/android/internal/policy/PhoneWindow;->getLastRequestedOrientation()I
    ...
    invoke-direct {p0, v10, v11, v2, v12}, Landroid/app/ActivityThread;->handleDestroyActivity(Landroid/os/IBinder;ZIZ)V

    const/4 v10, 0x0

    iput-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;
    ...
    iget-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->pendingResults:Ljava/util/List;

    if-nez v10, :cond_16

    iget-object v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->pendingResults:Ljava/util/List;

    iput-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->pendingResults:Ljava/util/List;
    ...
    iget-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->pendingIntents:Ljava/util/List;

    if-nez v10, :cond_17

    iget-object v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->pendingIntents:Ljava/util/List;

    iput-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->pendingIntents:Ljava/util/List;

    :cond_11
    :goto_5
    iget-boolean v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->startsNotResumed:Z

    iput-boolean v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->startsNotResumed:Z

    iget-object v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->overrideConfig:Landroid/content/res/Configuration;

    iput-object v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->overrideConfig:Landroid/content/res/Configuration;

    const-string/jumbo v10, "handleRelaunchActivity"

    invoke-direct {p0, v7, v3, v10}, Landroid/app/ActivityThread;->handleLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v8}, Lcom/android/internal/policy/PhoneWindow;->dispatchRequestedOrientation(I)V

    :cond_12
    iget v10, p1, Landroid/app/ActivityThread$ActivityClientRecord;->displayId:I

    iput v10, v7, Landroid/app/ActivityThread$ActivityClientRecord;->displayId:I
    ...
    iget-object v11, v7, Landroid/app/ActivityThread$ActivityClientRecord;->token:Landroid/os/IBinder;
    ...
    invoke-virtual {v10}, Landroid/view/Window;->reportActivityRelaunched()V
    :try_end_4
    ...
    invoke-direct {p0, v7}, Landroid/app/ActivityThread;->callCallActivityOnSaveInstanceState(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    iget-object v11, p1, Landroid/app/ActivityThread$ActivityClientRecord;->pendingResults:Ljava/util/List;
    ...
    iget-object v11, p1, Landroid/app/ActivityThread$ActivityClientRecord;->pendingIntents:Ljava/util/List;
...
.method private performConfigurationChanged(Landroid/content/ComponentCallbacks2;Landroid/os/IBinder;Landroid/content/res/Configuration;Landroid/content/res/Configuration;Z)V
    ...
    iget-object v8, v0, Landroid/app/Activity;->mCurrentConfig:Landroid/content/res/Configuration;
    ...
    instance-of v8, p1, Landroid/view/ContextThemeWrapper;
    ...
    invoke-virtual {v8, p2, v5}, Landroid/app/ResourcesManager;->updateResourcesForActivity(Landroid/os/IBinder;Landroid/content/res/Configuration;)V
    ...
    iget-boolean v8, v0, Landroid/app/Activity;->mCalled:Z
    ...
    invoke-direct {v8, p3}, Landroid/content/res/Configuration;-><init>(Landroid/content/res/Configuration;)V

    iput-object v8, v0, Landroid/app/Activity;->mCurrentConfig:Landroid/content/res/Configuration;
    ...
    instance-of v8, v7, Lcom/android/internal/policy/PhoneWindow;

    if-eqz v8, :cond_7

    check-cast v7, Lcom/android/internal/policy/PhoneWindow;

    iget-object v8, v0, Landroid/app/Activity;->mCurrentConfig:Landroid/content/res/Configuration;

    iput-object v8, v7, Lcom/android/internal/policy/PhoneWindow;->mActivityCurrentConfig:Landroid/content/res/Configuration;
    ...
    invoke-virtual {v8, p3}, Landroid/content/res/Configuration;->diff(Landroid/content/res/Configuration;)I
    ...
    invoke-virtual {v8, p2, p4}, Landroid/app/ResourcesManager;->isSameResourcesOverrideConfig(Landroid/os/IBinder;Landroid/content/res/Configuration;)Z
    ...
    :cond_a
    iget-boolean v8, p0, Landroid/app/ActivityThread;->mUpdatingSystemConfig:Z

    if-eqz v8, :cond_b

    iget-object v8, v0, Landroid/app/Activity;->mActivityInfo:Landroid/content/pm/ActivityInfo;
    ...
    :cond_d
    new-instance v8, Landroid/util/SuperNotCalledException;
    ...
    const-string/jumbo v10, " did not call through to super.onConfigurationChanged()"
    ...
    invoke-direct {v8, v9}, Landroid/util/SuperNotCalledException;-><init>(Ljava/lang/String;)V
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    iget-object v4, v0, Landroid/app/ActivityThread;->mPendingActivities:Landroid/util/ArrayMap;
    ...
    check-cast v25, Lcom/android/internal/policy/PhoneWindow;
    ...
    const-string/jumbo v6, "performLaunchActivity: mActivityCurrentConfig="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, v2, Landroid/app/Activity;->mCurrentConfig:Landroid/content/res/Configuration;
...
.method final handleActivityConfigurationChanged(Landroid/app/ActivityThread$ActivityConfigChangeData;Z)V
    ...
    invoke-direct {p0, v0, v1}, Landroid/app/ActivityThread;->updateConfigurationForDexCompatIfNeeded(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/res/Configuration;)V
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    invoke-direct {p0, v0, v3}, Landroid/app/ActivityThread;->updateLocaleListFromAppContext(Landroid/content/Context;Landroid/os/LocaleList;)V
    ...
    invoke-virtual {v12}, Landroid/content/res/Resources$Theme;->getChangingConfigurations()I
    ...
    invoke-virtual {v12}, Landroid/content/res/Resources$Theme;->rebase()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-virtual {p0, v0, p1}, Landroid/app/ActivityThread;->collectComponentCallbacks(ZLandroid/content/res/Configuration;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v0, p1, v2}, Landroid/app/ActivityThread;->performConfigurationChangedForActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/res/Configuration;Z)V
...
.method public hasVisibleActivity()Z
    .locals 4
...
.method public final startActivityNow(Landroid/app/Activity;Ljava/lang/String;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Landroid/os/Bundle;Landroid/app/Activity$NonConfigurationInstances;)Landroid/app/Activity;
    ...
    iput-object p5, v3, Landroid/app/ActivityThread$ActivityClientRecord;->token:Landroid/os/IBinder;

    const/4 v4, 0x0

    iput v4, v3, Landroid/app/ActivityThread$ActivityClientRecord;->ident:I

    iput-object p3, v3, Landroid/app/ActivityThread$ActivityClientRecord;->intent:Landroid/content/Intent;

    iput-object p6, v3, Landroid/app/ActivityThread$ActivityClientRecord;->state:Landroid/os/Bundle;

    iput-object p1, v3, Landroid/app/ActivityThread$ActivityClientRecord;->parent:Landroid/app/Activity;

    iput-object p2, v3, Landroid/app/ActivityThread$ActivityClientRecord;->embeddedID:Ljava/lang/String;

    iput-object p4, v3, Landroid/app/ActivityThread$ActivityClientRecord;->activityInfo:Landroid/content/pm/ActivityInfo;

    iput-object p7, v3, Landroid/app/ActivityThread$ActivityClientRecord;->lastNonConfigurationInstances:Landroid/app/Activity$NonConfigurationInstances;
    ...
    iget-object v4, p0, Landroid/app/ActivityThread;->mPendingActivities:Landroid/util/ArrayMap;
    ...
    :cond_1
    :goto_1
    invoke-direct {p0, v3, v6}, Landroid/app/ActivityThread;->performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    iput-object v4, v3, Landroid/app/ActivityThread$ActivityClientRecord;->overrideConfig:Landroid/content/res/Configuration;
