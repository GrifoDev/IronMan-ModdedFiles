...
.method public final dumpLocked(Landroid/content/Context;Ljava/io/PrintWriter;Ljava/lang/String;IIZ)V
    ...
    invoke-virtual/range {v208 .. v208}, Landroid/util/SparseArray;->size()I
    ...
    new-instance v183, Ljava/util/ArrayList;

    invoke-direct/range {v183 .. v183}, Ljava/util/ArrayList;-><init>()V
    ...
    check-cast v202, Landroid/os/BatteryStats$Uid;

    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getWakelockStats()Landroid/util/ArrayMap;
    ...
    check-cast v239, Landroid/os/BatteryStats$Uid$Wakelock;
    ...
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getUid()I
    ...
    :goto_f
    new-instance v100, Lcom/android/internal/os/BatteryStatsHelper;
    ...
    invoke-virtual/range {v100 .. v100}, Lcom/android/internal/os/BatteryStatsHelper;->getUsageList()Ljava/util/List;

    move-result-object v169

    if-eqz v169, :cond_3a

    invoke-interface/range {v169 .. v169}, Ljava/util/List;->size()I
    ...
    invoke-virtual/range {v100 .. v100}, Lcom/android/internal/os/BatteryStatsHelper;->getPowerProfile()Lcom/android/internal/os/PowerProfile;
    ...
    invoke-virtual/range {v100 .. v100}, Lcom/android/internal/os/BatteryStatsHelper;->getComputedPower()D
    ...
    invoke-virtual/range {v100 .. v100}, Lcom/android/internal/os/BatteryStatsHelper;->getMinDrainedPower()D
    ...
    invoke-virtual/range {v100 .. v100}, Lcom/android/internal/os/BatteryStatsHelper;->getMaxDrainedPower()D
    ...
    check-cast v45, Lcom/android/internal/os/BatterySipper;
    ...
    :cond_3a
    invoke-virtual/range {v100 .. v100}, Lcom/android/internal/os/BatteryStatsHelper;->getMobilemsppList()Ljava/util/List;
    ...
    :cond_3c
    new-instance v182, Landroid/os/BatteryStats$1;
    ...
    invoke-interface/range {v115 .. v115}, Ljava/util/Map;->size()I
    ...
    invoke-interface/range {v115 .. v115}, Ljava/util/Map;->entrySet()Ljava/util/Set;
    ...
    invoke-interface/range {v83 .. v83}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;
    ...
    check-cast v175, Landroid/os/BatteryStats$TimerEntry;
    ...
    :cond_41
    invoke-virtual/range {v183 .. v183}, Ljava/util/ArrayList;->size()I
    ...
    :cond_42
    invoke-virtual/range {v183 .. v183}, Ljava/util/ArrayList;->clear()V
    ...
    :goto_17
    invoke-virtual/range {v162 .. v162}, Ljava/util/ArrayList;->size()I
    ...
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getModemControllerActivity()Landroid/os/BatteryStats$ControllerActivityCounter;
    ...
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getWifiControllerActivity()Landroid/os/BatteryStats$ControllerActivityCounter;
    ...
    :cond_55
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getBluetoothScanTimer()Landroid/os/BatteryStats$Timer;

    move-result-object v35

    const-string/jumbo v40, "Bluetooth Scan"
    ...
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->hasUserActivity()Z
    ...
    :cond_66
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getSyncStats()Landroid/util/ArrayMap;

    move-result-object v174

    invoke-virtual/range {v174 .. v174}, Landroid/util/ArrayMap;->size()I

    move-result v6

    add-int/lit8 v110, v6, -0x1
    ...
    :cond_69
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getJobStats()Landroid/util/ArrayMap;
    ...
    :cond_6b
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getFlashlightTurnedOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getCameraTurnedOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getVideoTurnedOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getAudioTurnedOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getSensorStats()Landroid/util/SparseArray;

    move-result-object v167

    invoke-virtual/range {v167 .. v167}, Landroid/util/SparseArray;->size()I
    ...
    check-cast v163, Landroid/os/BatteryStats$Uid$Sensor;
    ...
    invoke-virtual/range {v163 .. v163}, Landroid/os/BatteryStats$Uid$Sensor;->getHandle()I
    ...
    invoke-virtual/range {v163 .. v163}, Landroid/os/BatteryStats$Uid$Sensor;->getSensorTime()Landroid/os/BatteryStats$Timer;
    ...
    :cond_6f
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getVibratorOnTimer()Landroid/os/BatteryStats$Timer;
    ...
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getForegroundActivityTimer()Landroid/os/BatteryStats$Timer;
    ...
    :cond_78
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getProcessStats()Landroid/util/ArrayMap;
    ...
    check-cast v159, Landroid/os/BatteryStats$Uid$Proc;
    ...
    invoke-virtual/range {v159 .. v159}, Landroid/os/BatteryStats$Uid$Proc;->countExcessivePowers()I
    ...
    :cond_87
    invoke-virtual/range {v202 .. v202}, Landroid/os/BatteryStats$Uid;->getPackageStats()Landroid/util/ArrayMap;
    ...
    check-cast v158, Landroid/os/BatteryStats$Uid$Pkg;

    invoke-virtual/range {v158 .. v158}, Landroid/os/BatteryStats$Uid$Pkg;->getWakeupAlarmStats()Landroid/util/ArrayMap;
    ...
    :cond_88
    invoke-virtual/range {v158 .. v158}, Landroid/os/BatteryStats$Uid$Pkg;->getServiceStats()Landroid/util/ArrayMap;
    ...
    check-cast v170, Landroid/os/BatteryStats$Uid$Pkg$Serv;
