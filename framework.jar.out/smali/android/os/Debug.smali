...
# static fields
.field private static final BUGREPORT_SERVICE_LIST:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "bugreportapp"

    aput-object v1, v0, v2

    const-string/jumbo v1, "bugreportnat"

    const/4 v2, 0x1

    aput-object v1, v0, v2

    const-string/jumbo v1, "bugreportsys"

    const/4 v2, 0x2

    aput-object v1, v0, v2

    const-string/jumbo v1, "bugreportanr"

    const/4 v2, 0x3

    aput-object v1, v0, v2

    const-string/jumbo v1, "bugreportswd"

    const/4 v2, 0x4

    aput-object v1, v0, v2

    const-string/jumbo v1, "bugreportsem"

    const/4 v2, 0x5

    aput-object v1, v0, v2

    sput-object v0, Landroid/os/Debug;->BUGREPORT_SERVICE_LIST:[Ljava/lang/String;
...
.method public static saveDump(Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "P|EX"

    invoke-static {v6, v7}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    :goto_0
    const-string/jumbo v6, "sys.mobilecare.preload"
    ...
    const-string/jumbo v7, "!@DumpState : SHIP"
    ...
    const-string/jumbo v8, "!@DumpState : debug level:"
    ...
    const-string/jumbo v6, "bugreportswd"
    ...
    :cond_1
    sget-object v6, Landroid/os/Debug;->BUGREPORT_SERVICE_LIST:[Ljava/lang/String;
    ...
    const-string/jumbo v9, "init.svc."
    ...
    const-string/jumbo v6, "!@Dumpstate is already running\n"
    ...
    const-string/jumbo v6, "init.svc."
    ...
    const-string/jumbo v6, "!@dumpstate auto run"
    ...
    const-string/jumbo v6, "!@Dumpstate waiting timeout(10sec)\n"
    ...
    const-string/jumbo v6, "!@Dumpstate is not executed\n"
