.class Lcom/android/settings/vpn2/VpnSettings$4;
...
.method constructor <init>(Lcom/android/settings/vpn2/VpnSettings;Ljava/util/List;Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/util/Set;Ljava/util/Set;)V
    ...
    iput-object p2, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$vpnProfiles:Ljava/util/List;

    iput-object p3, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$connectedLegacyVpns:Ljava/util/Map;

    iput-object p4, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$lockdownVpnKey:Ljava/lang/String;

    iput-object p5, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$vpnApps:Ljava/util/List;

    iput-object p6, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$connectedAppVpns:Ljava/util/Set;

    iput-object p7, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$alwaysOnAppVpnInfos:Ljava/util/Set;
...
.method public run()V
    ...
    iget-object v12, p0, Lcom/android/settings/vpn2/VpnSettings$4;->this$0:Lcom/android/settings/vpn2/VpnSettings;
    ...
    iget-object v12, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$vpnProfiles:Ljava/util/List;
    ...
    invoke-static {v12, v8}, Lcom/android/settings/vpn2/VpnSettings;->-wrap4(Lcom/android/settings/vpn2/VpnSettings;Lcom/android/internal/net/VpnProfile;)Lcom/android/settings/vpn2/LegacyVpnPreference;

    move-result-object v5

    iget-object v12, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$connectedLegacyVpns:Ljava/util/Map;
    ...
    :goto_1
    iget-object v12, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$lockdownVpnKey:Ljava/lang/String;
    ...
    :cond_3
    iget-object v12, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$vpnApps:Ljava/util/List;
    ...
    invoke-static {v12, v0}, Lcom/android/settings/vpn2/VpnSettings;->-wrap3(Lcom/android/settings/vpn2/VpnSettings;Lcom/android/settings/vpn2/AppVpnInfo;)Lcom/android/settings/vpn2/AppPreference;

    move-result-object v4

    iget-object v12, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$connectedAppVpns:Ljava/util/Set;
    ...
    :goto_4
    iget-object v12, p0, Lcom/android/settings/vpn2/VpnSettings$4;->val$alwaysOnAppVpnInfos:Ljava/util/Set;
    ...
    invoke-static {v12}, Lcom/android/settings/vpn2/VpnSettings;->-get3(Lcom/android/settings/vpn2/VpnSettings;)Ljava/util/Map;
