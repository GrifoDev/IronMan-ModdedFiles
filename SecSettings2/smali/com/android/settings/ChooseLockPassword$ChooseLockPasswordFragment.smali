...
.method private startSaveAndFinish()V
    ...
    invoke-virtual {v10}, Landroid/hardware/fingerprint/FingerprintManager;->preEnroll()J
    ...
    invoke-virtual {v0, v11}, Lcom/android/internal/widget/TextViewInputDisabler;->setInputEnabled(Z)V

    invoke-virtual {p0, v11}, Lcom/android/settings/ChooseLockPassword$ChooseLockPasswordFragment;->setNextEnabled(Z)V
    ...
    const-string/jumbo v1, "n_digits_pin_enabled"

    invoke-static {v0, v1, v11}, Landroid/provider/Settings$Secure;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z

    :goto_0
    invoke-direct {p0}, Lcom/android/settings/ChooseLockPassword$ChooseLockPasswordFragment;->insertSALoggingWhenLockSave()V

    return-void

    :cond_3
    iget v0, p0, Lcom/android/settings/ChooseLockPassword$ChooseLockPasswordFragment;->tempOptionVal:I

    if-lez v0, :cond_4

    iget v0, p0, Lcom/android/settings/ChooseLockPassword$ChooseLockPasswordFragment;->tempNdigits:I
...
.method private updateUi()V
    ...
    const v7, 0x7f0b1497    # 1.848696E38f
...
.method public onClick(Landroid/view/View;)V
    ...
    .sparse-switch
        ...
        0x7f110738 -> :sswitch_1
        0x7f11073a -> :sswitch_0
    .end sparse-switch
.end method
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v13, v3}, Landroid/app/admin/DevicePolicyManager;->semIsPasswordRecoverable(Landroid/content/ComponentName;)Z
    ...
    iget v11, v0, Lcom/android/settings/ChooseLockPassword$ChooseLockPasswordFragment;->mUserId:I

    const/4 v5, 0x0

    move-object v9, v8

    invoke-virtual/range {v2 .. v11}, Lcom/android/settings/ChooseLockPassword$SaveAndFinishWorker;->start(Lcom/android/internal/widget/LockPatternUtils;ZZJLjava/lang/String;Ljava/lang/String;II)V
