...
.method public static getCategories(Landroid/content/Context;Ljava/util/HashMap;)Ljava/util/List;
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/os/UserManager;->getUserProfiles()Ljava/util/List;
...
.method public static getTilesForIntent(Landroid/content/Context;Landroid/os/UserHandle;Landroid/content/Intent;Ljava/util/Map;Ljava/lang/String;Ljava/util/List;ZZZ)V
    ...
    invoke-virtual {v5, p2, v4, v1}, Landroid/content/pm/PackageManager;->queryIntentActivitiesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    sget-object v4, Lcom/android/settingslib/drawer/TileUtils;->defaultSettingsPackage:Ljava/lang/String;
    ...
    :cond_2
    iget-object v9, v3, Landroid/content/pm/ActivityInfo;->metaData:Landroid/os/Bundle;
    ...
    invoke-direct {v8, v1, v4}, Landroid/util/Pair;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v6, v10, Landroid/content/pm/ResolveInfo;->activityInfo:Landroid/content/pm/ActivityInfo;
...
.method private static updateTileData(Landroid/content/Context;Lcom/android/settingslib/drawer/Tile;Landroid/content/pm/ActivityInfo;Landroid/content/pm/ApplicationInfo;Landroid/content/pm/PackageManager;Z)Z
    ...
    iget v7, p2, Landroid/content/pm/ActivityInfo;->labelRes:I

    iput v7, p1, Lcom/android/settingslib/drawer/Tile;->titleRes:I
