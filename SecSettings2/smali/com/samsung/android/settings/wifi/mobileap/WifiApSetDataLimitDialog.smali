...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog$2;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;)Lcom/samsung/android/settings/wifi/mobileap/WifiApDataLimit;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;->mApDataLimit:Lcom/samsung/android/settings/wifi/mobileap/WifiApDataLimit;

    return-object v0
.end method

.method static synthetic -get1(Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;)Landroid/content/Context;
    .locals 1
...
.method static synthetic -get2(Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;)Lcom/samsung/android/settings/bixby/EmSettingsManager;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;

    return-object v0
.end method

.method static synthetic -get3(Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;)Landroid/widget/EditText;
    .locals 1
...
.method static synthetic -get4(Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;)Landroid/widget/TextView;
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;Lcom/samsung/android/settings/wifi/mobileap/WifiApDataLimit;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;
    ...
    new-instance v0, Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog$2;

    invoke-direct {v0, p0}, Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog$2;-><init>(Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;)V

    iput-object v0, p0, Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;->mEmCallback:Lcom/samsung/android/settings/bixby/EmSettingsManager$IEmCallback;
...
.method public dismiss()V
    ...
    const-string/jumbo v1, "MobileHotspotDataLimit"
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;

    iget-object v2, p0, Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;->mContext:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Lcom/samsung/android/settings/wifi/mobileap/WifiApSetDataLimitDialog;->mEmCallback:Lcom/samsung/android/settings/bixby/EmSettingsManager$IEmCallback;
