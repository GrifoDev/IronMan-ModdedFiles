...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const/high16 v6, 0x7f150000

    invoke-virtual {p0, v6}, Lcom/android/settings/LegalSettings;->addPreferencesFromResource(I)V
    ...
    invoke-static {v1, v4, v6, v7}, Lcom/android/settings/Utils;->updatePreferenceToSpecificActivityOrRemove(Landroid/content/Context;Landroid/support/v7/preference/PreferenceGroup;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v6, "webview_license"
    ...
    const-string/jumbo v6, "samsung_legal"
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/LegalSettings;->removePreference(Ljava/lang/String;)V

    :goto_0
    const-string/jumbo v6, "com.samsung.safetyinformation"

    invoke-direct {p0, v6}, Lcom/android/settings/LegalSettings;->isPackageLoaded(Ljava/lang/String;)Z
    ...
    :cond_1
    const-string/jumbo v6, "safetyinfomation"
    ...
    const-string/jumbo v6, "privacy_alert"
    ...
    const-string/jumbo v6, "/system/lib/drm/libdivxplugin.so"
    ...
    const-string/jumbo v6, "divx_license_settings"
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/preference/PreferenceGroup;->removePreference(Landroid/support/v7/preference/Preference;)Z
    ...
    iput-object v6, p0, Lcom/android/settings/LegalSettings;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/preference/Preference;->setFragment(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/preference/Preference;->setIntent(Landroid/content/Intent;)V
    ...
    const-string/jumbo v7, "com.sec.android.app.SecSetupWizard.SamsungLegalActivity"
