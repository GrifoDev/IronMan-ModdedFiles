...
.method public onAccessPointPreferenceClick(Landroid/preference/Preference;)Z
    ...
    const-string/jumbo v6, "onAccessPointPreferenceClick"
    ...
    const-string/jumbo v6, "sd_ap_wifi_setting"

    invoke-static {v5, v6, v8}, Landroid/provider/Settings$System;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z

    :cond_0
    instance-of v5, p1, Lcom/android/settings/wifi/LongPressAccessPointPreference;
    ...
    iget v6, p0, Lcom/android/settings/wifi/WifiSettings;->mSAScreenId:I
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiSettings;->mSelectedAccessPoint:Lcom/android/settingslib/wifi/AccessPoint;
    ...
    invoke-virtual {v5, v6}, Lcom/samsung/android/settings/wifi/WifiPickerHelper;->userPickedAp(Lcom/android/settingslib/wifi/AccessPoint;)Z
    ...
    iget-object v6, p0, Lcom/android/settings/wifi/WifiSettings;->mWifiPickerHelper:Lcom/samsung/android/settings/wifi/WifiPickerHelper;

    iget-object v7, p0, Lcom/android/settings/wifi/WifiSettings;->mSelectedAccessPoint:Lcom/android/settingslib/wifi/AccessPoint;

    invoke-virtual {v6, v7}, Lcom/samsung/android/settings/wifi/WifiPickerHelper;->getApIntent(Lcom/android/settingslib/wifi/AccessPoint;)Landroid/content/Intent;
    ...
    invoke-direct {p0, v5}, Lcom/android/settings/wifi/WifiSettings;->isCoreanVendorAp(Lcom/android/settingslib/wifi/AccessPoint;)Z
    ...
    invoke-virtual {v5}, Lcom/android/settingslib/wifi/AccessPoint;->isSupportedSecurityType()Z
    ...
    invoke-virtual {v4}, Landroid/net/wifi/WifiInfo;->isAuthenticated()Z
    ...
    const-string/jumbo v6, "START captive portal login activity"
    ...
    invoke-virtual {v5}, Lcom/android/settingslib/wifi/AccessPoint;->isFTOnlyType()Z
    ...
    const-string/jumbo v6, "it\'s FT/PSK only secured AP, Wi-Fi configuration should be changed"

    invoke-static {v5, v6}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v5, p0, Lcom/android/settings/wifi/WifiSettings;->mSelectedAccessPoint:Lcom/android/settingslib/wifi/AccessPoint;

    invoke-direct {p0, v5, v8}, Lcom/android/settings/wifi/WifiSettings;->showDialog(Lcom/android/settingslib/wifi/AccessPoint;I)V
    ...
    const-string/jumbo v6, "it\'s FT/EAP only secured AP, Wi-Fi configuration should be changed"
    ...
    iget-object v6, p0, Lcom/android/settings/wifi/WifiSettings;->mOpBranding:Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v10}, Lcom/android/settings/wifi/WifiSettings;->showDialog(Lcom/android/settingslib/wifi/AccessPoint;I)V

    :goto_0
    return v8

    :cond_a
    invoke-virtual {p0, v0, v8}, Lcom/android/settings/wifi/WifiSettings;->connect(Landroid/net/wifi/WifiConfiguration;Z)V
    ...
    invoke-virtual {v5}, Lcom/android/settingslib/wifi/AccessPoint;->generateOpenNetworkConfig()V
    ...
    invoke-virtual {p0, v5, v6}, Lcom/android/settings/wifi/WifiSettings;->connect(Landroid/net/wifi/WifiConfiguration;Z)V
    ...
    invoke-virtual {v5}, Lcom/android/settingslib/wifi/AccessPoint;->isWeChatAp()Z
    ...
    invoke-virtual {v6}, Lcom/android/settingslib/wifi/AccessPoint;->getWeChatBssid()Ljava/lang/String;

    move-result-object v6

    iget-object v7, p0, Lcom/android/settings/wifi/WifiSettings;->mSelectedAccessPoint:Lcom/android/settingslib/wifi/AccessPoint;

    invoke-virtual {v7}, Lcom/android/settingslib/wifi/AccessPoint;->getRssi()I

    move-result v7

    invoke-virtual {p0, v5, v6, v7}, Lcom/android/settings/wifi/WifiSettings;->connectWeChatAccessPoint(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v5}, Lcom/android/settingslib/wifi/AccessPoint;->isPasspoint()Z
    ...
    :cond_11
    iget-object v5, p0, Lcom/android/settings/wifi/WifiSettings;->mAddPreference:Landroid/preference/Preference;
    ...
    iget-object v5, p0, Lcom/android/settings/wifi/WifiSettings;->mPasspointInfoMap:Ljava/util/HashMap;
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiSettings;->mSelectedPasspointConfig:Landroid/net/wifi/hotspot2/PasspointConfiguration;
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiSettings;->mSelectedpasspointName:Ljava/lang/String;

    iget-object v5, p0, Lcom/android/settings/wifi/WifiSettings;->mSelectedPasspointConfig:Landroid/net/wifi/hotspot2/PasspointConfiguration;
    ...
    invoke-direct {p0, v9, v5}, Lcom/android/settings/wifi/WifiSettings;->showDialog(Lcom/android/settingslib/wifi/AccessPoint;I)V
