...
# direct methods
.method static synthetic -get0(Lcom/android/settings/encryption/CryptSDCardSettings;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->fromWhere:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/settings/encryption/CryptSDCardSettings;)Lcom/android/settings/encryption/CryptSDCardSettings$BixbyManager;
    .locals 1
...
.method static synthetic -get2(Lcom/android/settings/encryption/CryptSDCardSettings;)Lcom/samsung/android/security/SemSdCardEncryption;
    .locals 1
...
.method static synthetic -get3(Lcom/android/settings/encryption/CryptSDCardSettings;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic -get4(Lcom/android/settings/encryption/CryptSDCardSettings;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mIsDisabledByOtherDevice:Z

    return v0
.end method

.method static synthetic -get5(Lcom/android/settings/encryption/CryptSDCardSettings;)Landroid/app/Activity;
    .locals 1
...
.method static synthetic -get6(Lcom/android/settings/encryption/CryptSDCardSettings;)I
    .locals 1
...
.method static synthetic -get7(Lcom/android/settings/encryption/CryptSDCardSettings;)Ljava/lang/Object;
    .locals 1
...
.method static synthetic -get8(Lcom/android/settings/encryption/CryptSDCardSettings;)Z
    .locals 1
...
.method static synthetic -set0(Lcom/android/settings/encryption/CryptSDCardSettings;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mDoEncrypt:Z
...
.method static synthetic -set2(Lcom/android/settings/encryption/CryptSDCardSettings;I)I
    .locals 0
...
.method static synthetic -wrap0(Lcom/android/settings/encryption/CryptSDCardSettings;)Z
    .locals 1
...
.method static synthetic -wrap3(Lcom/android/settings/encryption/CryptSDCardSettings;)V
    .locals 0
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->fromWhere:Ljava/lang/String;
...
.method private doEncryptSDCard()V
    ...
    invoke-virtual {p0}, Lcom/android/settings/encryption/CryptSDCardSettings;->getMetricsCategory()I

    move-result v5

    iget-object v6, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mParent:Landroid/app/Activity;
    ...
    invoke-static {v4, v5, v6, v8, v9}, Lcom/android/settings/Utils;->insertEventwithValueLog(Landroid/content/Context;IIJ)V

    iget-object v4, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mParent:Landroid/app/Activity;

    const-string/jumbo v5, "com.android.settings"

    const-string/jumbo v6, "EVNT"

    iget-boolean v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mDoEncrypt:Z

    if-eqz v2, :cond_2

    const-string/jumbo v2, "Encrypt SD card"
    ...
    invoke-virtual {v2, v4}, Lcom/samsung/android/security/SemSdCardEncryption;->encryptStorage(Z)I
    ...
    const-string/jumbo v5, "Error SD card not mounted while encrypting "
    ...
    :cond_2
    const-string/jumbo v2, "Decrypt SD card"
...
.method private finishProgress()V
    ...
    const-string/jumbo v3, "finishProgress + "
    ...
    invoke-virtual {v1, v8}, Landroid/app/Activity;->setTitle(I)V
...
.method private initVariables()V
    ...
    iput-boolean v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mEncryptedState:Z
...
.method private restorePrefs()V
    ...
    const-string/jumbo v6, "restorePrefs"
    ...
    const-string/jumbo v6, "restorePrefs ==> Error Case UI"

    invoke-static {v5, v6}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iput-boolean v7, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mIsDisabledByOtherDevice:Z
    ...
    iput-boolean v7, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mStartedByIntent:Z
    ...
    iput-boolean v7, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mStartedByAdmin:Z
    ...
    invoke-virtual {v3, v8}, Landroid/app/admin/DevicePolicyManager;->semGetRequireStorageCardEncryption(Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v6, "mAdminPolicies is ture"
    ...
    iput v7, v5, Lcom/samsung/android/security/SemSdCardEncryptionPolicy;->mIsPolicy:I
    ...
    iput-boolean v7, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mIsDisabledByAdmin:Z
    ...
    const-string/jumbo v6, "CryptSDCardSettings started by user"
...
.method private updatePrefUI()V
    ...
    const v13, 0x7f121791

    const v12, 0x7f1217a4
    ...
    iput-boolean v7, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mEncryptedState:Z

    iget-boolean v7, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mEncryptedState:Z
    ...
    invoke-static {}, Lcom/samsung/android/security/mdf/MdfUtils;->isMdfEnabled()Z
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mContentView:Landroid/view/View;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/settings/encryption/CryptSDCardSettings;->getIntent()Landroid/content/Intent;
    ...
    iput-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->fromWhere:Ljava/lang/String;

    :cond_1
    new-instance v2, Lcom/android/settings/encryption/CryptSDCardSettings$BixbyManager;

    invoke-direct {v2, p0}, Lcom/android/settings/encryption/CryptSDCardSettings$BixbyManager;-><init>(Lcom/android/settings/encryption/CryptSDCardSettings;)V

    iput-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mBixbyManager:Lcom/android/settings/encryption/CryptSDCardSettings$BixbyManager;

    iget-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mContentView:Landroid/view/View;
    ...
    iput-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mTextDesc:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mLeftButton:Landroid/widget/Button;
    ...
    iput-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mRightButton:Landroid/widget/Button;
    ...
    iput-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mDescriptionLayout:Landroid/widget/LinearLayout;
    ...
    iput-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mProgressLayout:Landroid/widget/LinearLayout;

    iget-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mLeftButton:Landroid/widget/Button;

    invoke-virtual {v2, p0}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v2, p0, Lcom/android/settings/encryption/CryptSDCardSettings;->mRightButton:Landroid/widget/Button;
