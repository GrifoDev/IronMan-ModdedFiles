...
.method static synthetic -get3(Lcom/android/settings/notification/SecVolumeSeekBarPreference;)Landroid/support/v7/preference/PreferenceScreen;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/notification/SecVolumeSeekBarPreference;->mPreferenceScreen:Landroid/support/v7/preference/PreferenceScreen;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, Lcom/android/settings/notification/SecVolumeSeekBarPreference;->mHelper:Lcom/android/settingslib/RestrictedPreferenceHelper;
...
.method private init()V
    ...
    :cond_4
    invoke-virtual {p0, v13}, Lcom/android/settings/notification/SecVolumeSeekBarPreference;->setInitFinish(Z)V
    ...
    invoke-direct {p0, v13}, Lcom/android/settings/notification/SecVolumeSeekBarPreference;->updateIconView(Z)V
...
.method private setDualColorSeekbar()V
    ...
    iget v4, p0, Lcom/android/settings/notification/SecVolumeSeekBarPreference;->mStream:I
    ...
    :cond_0
    const-string/jumbo v4, "VolumeSeekBarPreference"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "setDualColorSeekbar : AudioManager.STREAM_MUSIC. mAudioManager.semIsSafeMediaVolumeDeviceOn() return : "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lcom/android/settings/notification/SecVolumeSeekBarPreference;->mAudioManager:Landroid/media/AudioManager;

    invoke-virtual {v6}, Landroid/media/AudioManager;->semIsSafeMediaVolumeDeviceOn()Z
    ...
    const-string/jumbo v6, "Earphone - mAudioManager.isWiredHeadsetOn() : "
    ...
    :try_start_0
    iget-object v4, p0, Lcom/android/settings/notification/SecVolumeSeekBarPreference;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v5, "telephonyService.isRinging() || telephonyService.isOffhook() Now calling."
    ...
    const-string/jumbo v5, "Don\'t show dual color seekbar. setDualColorSeekbar set single"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v4, p0, Lcom/android/settings/notification/SecVolumeSeekBarPreference;->mSeekBar:Landroid/widget/SeekBar;

    const/4 v5, -0x1

    invoke-virtual {v4, v5}, Landroid/widget/SeekBar;->semSetOverlapPointForDualColor(I)V
    :try_end_0
    ...
    const-string/jumbo v5, "ITelephony threw RemoteException"
    ...
    invoke-virtual {v4}, Landroid/media/AudioManager;->semIsFmRadioActive()Z
    ...
    invoke-virtual {v2, v7}, Landroid/widget/SeekBar;->semSetOverlapPointForDualColor(I)V
...
.method public onBindViewHolder(Landroid/support/v7/preference/PreferenceViewHolder;)V
    ...
    iget-object v0, p0, Lcom/android/settings/notification/SecVolumeSeekBarPreference;->mHelper:Lcom/android/settingslib/RestrictedPreferenceHelper;
    ...
    new-instance v1, Lcom/android/settings/notification/SecVolumeSeekBarPreference$3;

    invoke-direct {v1, p0}, Lcom/android/settings/notification/SecVolumeSeekBarPreference$3;-><init>(Lcom/android/settings/notification/SecVolumeSeekBarPreference;)V
...
.method public onClosed()V
    ...
    invoke-virtual {v1, v2}, Landroid/media/AudioManager;->unregisterAudioFocusRequest(Landroid/media/AudioManager$OnAudioFocusChangeListener;)V
...
.method public performClick()V
    ...
    invoke-super {p0}, Lcom/android/settings/SeekBarPreference;->performClick()V
