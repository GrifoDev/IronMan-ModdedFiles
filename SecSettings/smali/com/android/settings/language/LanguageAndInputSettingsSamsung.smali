...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const v11, 0x7f150082

    invoke-virtual {p0, v11}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->addPreferencesFromResource(I)V
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mIm:Landroid/hardware/input/InputManager;

    const-string/jumbo v11, "pointer_speed"

    invoke-virtual {p0, v11}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v11

    check-cast v11, Lcom/android/settings/PointerSpeedPreferenceSamsung;

    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mPointerSeekbar:Lcom/android/settings/PointerSpeedPreferenceSamsung;

    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mPointerSeekbar:Lcom/android/settings/PointerSpeedPreferenceSamsung;

    iget-object v12, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mPointerSpeedCallback:Lcom/android/settings/language/LanguageAndInputSettingsSamsung$PointerSpeedPreferenceSamsungCallback;

    invoke-virtual {v11, v12}, Lcom/android/settings/PointerSpeedPreferenceSamsung;->setCallback(Lcom/android/settings/PointerSpeedPreferenceSamsung$Callback;)V

    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mPointerSeekbar:Lcom/android/settings/PointerSpeedPreferenceSamsung;

    const/16 v12, 0xe

    invoke-virtual {v11, v12}, Lcom/android/settings/PointerSpeedPreferenceSamsung;->setMax(I)V

    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mPointerSeekbar:Lcom/android/settings/PointerSpeedPreferenceSamsung;

    iget-object v12, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mIm:Landroid/hardware/input/InputManager;

    invoke-virtual {p0}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->getContext()Landroid/content/Context;

    move-result-object v13

    invoke-virtual {v12, v13}, Landroid/hardware/input/InputManager;->getPointerSpeed(Landroid/content/Context;)I

    move-result v12

    add-int/lit8 v12, v12, 0x7

    invoke-virtual {v11, v12}, Lcom/android/settings/PointerSpeedPreferenceSamsung;->setProgress(I)V

    new-instance v11, Lcom/samsung/android/settings/handwritingsearch/LanguageListLoader;

    invoke-virtual {p0}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->getActivity()Landroid/app/Activity;

    move-result-object v12

    invoke-direct {v11, v12}, Lcom/samsung/android/settings/handwritingsearch/LanguageListLoader;-><init>(Landroid/content/Context;)V

    sput-object v11, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mLangListLoader:Lcom/samsung/android/settings/handwritingsearch/LanguageListLoader;

    const-string/jumbo v11, "input_method"

    invoke-virtual {p0, v11}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v11

    check-cast v11, Landroid/view/inputmethod/InputMethodManager;

    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mImm:Landroid/view/inputmethod/InputMethodManager;
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mInputMethodSettingValues:Lcom/android/settingslib/inputmethod/InputMethodSettingValuesWrapper;
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->um:Landroid/os/UserManager;

    const v11, 0x7f120dc9

    :try_start_0
    invoke-virtual {p0, v11}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->getString(I)Ljava/lang/String;
    ...
    iput v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mDefaultInputMethodSelectorVisibility:I
    :try_end_0
    ...
    :goto_1
    new-instance v11, Lcom/android/settings/VoiceInputOutputSettings;

    invoke-direct {v11, p0}, Lcom/android/settings/VoiceInputOutputSettings;-><init>(Lcom/android/settings/SettingsPreferenceFragment;)V

    invoke-virtual {v11}, Lcom/android/settings/VoiceInputOutputSettings;->onCreate()V
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mHardKeyboardCategory:Landroid/support/v7/preference/SecPreferenceCategory;
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mKeyboardSettingsCategory:Landroid/support/v7/preference/SecPreferenceCategory;
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mGameControllerCategory:Landroid/support/v7/preference/SecPreferenceCategory;
    ...
    iput-boolean v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mShowsOnlyFullImeAndKeyboardList:Z

    iget-boolean v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mShowsOnlyFullImeAndKeyboardList:Z
    ...
    invoke-virtual {v8}, Lcom/android/settings/SettingsActivity;->getIntent()Landroid/content/Intent;
    ...
    :cond_0
    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mKeyboardSettingsCategory:Landroid/support/v7/preference/SecPreferenceCategory;

    if-eqz v11, :cond_1

    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mKeyboardSettingsCategory:Landroid/support/v7/preference/SecPreferenceCategory;

    invoke-virtual {v11}, Landroid/support/v7/preference/SecPreferenceCategory;->removeAll()V
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mHandler:Landroid/os/Handler;

    new-instance v11, Lcom/android/settings/language/LanguageAndInputSettingsSamsung$SettingsObserver;

    iget-object v12, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mHandler:Landroid/os/Handler;

    invoke-direct {v11, p0, v12, v0}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung$SettingsObserver;-><init>(Lcom/android/settings/language/LanguageAndInputSettingsSamsung;Landroid/os/Handler;Landroid/content/Context;)V

    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mSettingsObserver:Lcom/android/settings/language/LanguageAndInputSettingsSamsung$SettingsObserver;
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mDpm:Landroid/app/admin/DevicePolicyManager;
    ...
    invoke-direct {p0, v4}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->showKeyboardLayoutDialog(Landroid/hardware/input/InputDeviceIdentifier;)V

    :cond_2
    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->um:Landroid/os/UserManager;
    ...
    const-string/jumbo v12, "current_input_method"
    ...
    const-string/jumbo v12, "keyboard_and_input_methods_category"
    ...
    const-string/jumbo v12, "input_assistance_category"
    ...
    sput-object v11, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mPersona:Lcom/samsung/android/knox/SemPersonaManager;

    sget-object v11, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mPersona:Lcom/samsung/android/knox/SemPersonaManager;
    ...
    invoke-virtual {v11, v12}, Lcom/samsung/android/knox/SemPersonaManager;->isKioskModeEnabled(I)Z

    move-result v11

    if-eqz v11, :cond_3

    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mLanguagePref:Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    invoke-virtual {v11, v1}, Landroid/support/v7/preference/PreferenceScreen;->addPreference(Landroid/support/v7/preference/Preference;)Z
    ...
    invoke-virtual {v11, v7}, Landroid/support/v7/preference/PreferenceScreen;->addPreference(Landroid/support/v7/preference/Preference;)Z
    ...
    invoke-virtual {v11, v5}, Landroid/support/v7/preference/PreferenceScreen;->addPreference(Landroid/support/v7/preference/Preference;)Z

    :cond_7
    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mInputMethodSettingValues:Lcom/android/settingslib/inputmethod/InputMethodSettingValuesWrapper;

    invoke-virtual {v11}, Lcom/android/settingslib/inputmethod/InputMethodSettingValuesWrapper;->refreshAllInputMethodAndSubtypes()V

    invoke-direct {p0}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->updateInputMethodPreferenceViews()V

    :cond_8
    const-string/jumbo v11, "handwriting_search_category"
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mHandwritingSearchCategory:Landroid/support/v7/preference/SecPreferenceCategory;

    const-string/jumbo v11, "handwriting_language"
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mHandwritingLanguage:Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    const-string/jumbo v12, "com.sec.feature.spen_usp"

    invoke-virtual {v11, v12}, Landroid/content/pm/PackageManager;->semGetSystemFeatureLevel(Ljava/lang/String;)I

    move-result v11

    iput v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mUspLevel:I

    iget v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mUspLevel:I

    const/4 v12, 0x2

    if-ge v11, v12, :cond_9

    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mHandwritingLanguage:Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    iget-object v12, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mHandwritingSearchCategory:Landroid/support/v7/preference/SecPreferenceCategory;

    invoke-virtual {v11, v12}, Landroid/support/v7/preference/PreferenceScreen;->removePreference(Landroid/support/v7/preference/Preference;)Z

    :cond_9
    const-string/jumbo v11, "key_show_keyboard_button"

    invoke-virtual {p0, v11}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v11

    check-cast v11, Landroid/support/v14/preference/SecSwitchPreference;

    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mShowKeyboardButtonPref:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mShowKeyboardButtonPref:Landroid/support/v14/preference/SecSwitchPreference;

    const/4 v12, 0x0

    invoke-virtual {v11, v12}, Landroid/support/v14/preference/SecSwitchPreference;->setVisible(Z)V

    :cond_a
    :goto_3
    new-instance v11, Lcom/samsung/android/settings/bixby/EmSettingsManager;

    invoke-direct {v11}, Lcom/samsung/android/settings/bixby/EmSettingsManager;-><init>()V

    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mEmSettingsManager:Lcom/samsung/android/settings/bixby/EmSettingsManager;
    ...
    const-string/jumbo v11, "default_autofill"

    invoke-virtual {v5, v11}, Landroid/support/v7/preference/SecPreferenceCategory;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v11

    check-cast v11, Lcom/samsung/android/settings/SecGearPreference;

    :goto_4
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mAutofillPref:Lcom/samsung/android/settings/SecGearPreference;

    new-instance v11, Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;

    invoke-virtual {p0}, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->getContext()Landroid/content/Context;

    move-result-object v12

    invoke-direct {v11, v12}, Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;-><init>(Landroid/content/Context;)V

    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mDefaultAutofillPreferenceController:Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;

    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mAutofillPref:Lcom/samsung/android/settings/SecGearPreference;

    if-eqz v11, :cond_b

    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mDefaultAutofillPreferenceController:Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;

    invoke-virtual {v11}, Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;->isAvailable()Z
    ...
    invoke-virtual {v11, v12}, Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;->updateState(Landroid/support/v7/preference/Preference;)V

    iget-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mDefaultAutofillPreferenceController:Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;

    invoke-virtual {v11}, Lcom/android/settings/applications/defaultapps/DefaultAutofillPreferenceController;->getDefaultAppLabel()Ljava/lang/CharSequence;
    ...
    iput-object v11, p0, Lcom/android/settings/language/LanguageAndInputSettingsSamsung;->mLanguagePref:Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    invoke-virtual {v11, p0}, Landroid/support/v14/preference/SecSwitchPreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V
