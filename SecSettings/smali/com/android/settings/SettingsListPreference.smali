...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/SettingsListPreference$FullScreeListArrayAdapter;
    }
.end annotation
...
# direct methods
.method static synthetic -wrap0(Lcom/android/settings/SettingsListPreference;Ljava/lang/Object;)Z
    .locals 1

    invoke-virtual {p0, p1}, Lcom/android/settings/SettingsListPreference;->callChangeListener(Ljava/lang/Object;)Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/settings/SettingsListPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/android/settings/SettingsListPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/SettingsListPreference;->setDialogLayoutResource(I)V
...
.method protected createListAdapter()Landroid/widget/ListAdapter;
    ...
    new-instance v0, Lcom/android/settings/SettingsListPreference$FullScreeListArrayAdapter;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/settings/SettingsListPreference$FullScreeListArrayAdapter;-><init>(Landroid/content/Context;[Ljava/lang/CharSequence;I)V
...
.method protected getItemClickListener()Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object v1, p0, Lcom/android/settings/SettingsListPreference;->mListItemListener:Landroid/widget/AdapterView$OnItemClickListener;

    if-nez v1, :cond_0

    new-instance v0, Lcom/android/settings/SettingsListPreference$1;

    invoke-direct {v0, p0}, Lcom/android/settings/SettingsListPreference$1;-><init>(Lcom/android/settings/SettingsListPreference;)V

    iput-object v0, p0, Lcom/android/settings/SettingsListPreference;->mListItemListener:Landroid/widget/AdapterView$OnItemClickListener;
...
.method protected onCreateDialogView(Landroid/content/Context;)Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/android/settings/SettingsListPreference;->getDialogLayoutResource()I
...
.method protected setFullScreenLayout(Landroid/content/Context;Landroid/view/View;)V
    ...
    new-instance v1, Lcom/android/settings/SettingsListPreference$2;

    invoke-direct {v1, p0}, Lcom/android/settings/SettingsListPreference$2;-><init>(Lcom/android/settings/SettingsListPreference;)V

    invoke-virtual {v11, v1}, Landroid/widget/Toolbar;->setNavigationOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p0}, Lcom/android/settings/SettingsListPreference;->getDialogTitle()Ljava/lang/CharSequence;
    ...
    iput-object v9, p0, Lcom/android/settings/SettingsListPreference;->mListView:Landroid/widget/ListView;

    invoke-virtual {p0}, Lcom/android/settings/SettingsListPreference;->createListAdapter()Landroid/widget/ListAdapter;
    ...
    invoke-virtual {p0}, Lcom/android/settings/SettingsListPreference;->getItemClickListener()Landroid/widget/AdapterView$OnItemClickListener;
...
.method protected showDialog(Landroid/os/Bundle;)V
    ...
    :cond_0
    iget-object v4, p0, Lcom/android/settings/SettingsListPreference;->mDialog:Landroid/app/Dialog;
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/settings/SettingsListPreference;->mListView:Landroid/widget/ListView;
    ...
    iget-object v5, p0, Lcom/android/settings/SettingsListPreference;->mDialog:Landroid/app/Dialog;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/SettingsListPreference;->onCreateDialogView(Landroid/content/Context;)Landroid/view/View;

    move-result-object v0

    invoke-virtual {v2, v0}, Landroid/app/Dialog;->setContentView(Landroid/view/View;)V

    invoke-virtual {p0, v1, v0}, Lcom/android/settings/SettingsListPreference;->setFullScreenLayout(Landroid/content/Context;Landroid/view/View;)V
