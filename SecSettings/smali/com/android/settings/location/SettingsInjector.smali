...
.method private addServiceSetting(Landroid/content/Context;Ljava/util/List;Lcom/android/settings/location/InjectedSetting;)Landroid/support/v7/preference/Preference;
    ...
    iget-object v7, p3, Lcom/android/settings/location/InjectedSetting;->packageName:Ljava/lang/String;

    iget v8, p3, Lcom/android/settings/location/InjectedSetting;->iconId:I
    ...
    invoke-virtual {v4, v7}, Landroid/content/pm/PackageManager;->semShouldPackIntoIconTray(Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, v0, v7}, Landroid/content/pm/PackageManager;->semGetDrawableForIconTray(Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    :cond_0
    iget-object v7, p3, Lcom/android/settings/location/InjectedSetting;->mUserHandle:Landroid/os/UserHandle;
    ...
    iget-object v7, p3, Lcom/android/settings/location/InjectedSetting;->title:Ljava/lang/String;

    iget-object v8, p3, Lcom/android/settings/location/InjectedSetting;->mUserHandle:Landroid/os/UserHandle;
    ...
    invoke-direct {v5, p1, v1}, Lcom/android/settings/DimmableIconPreference;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v3, p1}, Lcom/samsung/android/settings/IconResizer;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v7/preference/Preference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    new-instance v7, Lcom/android/settings/location/SettingsInjector$ServiceSettingClickedListener;

    invoke-direct {v7, p0, p3}, Lcom/android/settings/location/SettingsInjector$ServiceSettingClickedListener;-><init>(Lcom/android/settings/location/SettingsInjector;Lcom/android/settings/location/InjectedSetting;)V

    invoke-virtual {v5, v7}, Landroid/support/v7/preference/Preference;->setOnPreferenceClickListener(Landroid/support/v7/preference/Preference$OnPreferenceClickListener;)V

    const v7, 0x7f0d0350

    invoke-virtual {v5, v7}, Landroid/support/v7/preference/Preference;->setLayoutResource(I)V
...
.method private static parseServiceInfo(Landroid/content/pm/ResolveInfo;Landroid/os/UserHandle;Landroid/content/pm/PackageManager;)Lcom/android/settings/location/InjectedSetting;
    ...
    const-string/jumbo v10, "CscFeature_GPS_ConfigAgpsSetting"
...
.method public getInjectedSettings(Landroid/content/Context;I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v2, v5}, Lcom/android/settings/location/SettingsInjector;->addServiceSetting(Landroid/content/Context;Ljava/util/List;Lcom/android/settings/location/InjectedSetting;)Landroid/support/v7/preference/Preference;
    ...
    invoke-direct {v11, p0, v5, v1, v12}, Lcom/android/settings/location/SettingsInjector$Setting;-><init>(Lcom/android/settings/location/SettingsInjector;Lcom/android/settings/location/InjectedSetting;Landroid/support/v7/preference/Preference;Lcom/android/settings/location/SettingsInjector$Setting;)V
