...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v37, "mManageMobilePlanMessage"
    ...
    const-string/jumbo v38, "onCreate: mManageMobilePlanMessage="
    ...
    check-cast v37, Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual/range {v37 .. v37}, Landroid/os/UserManager;->isAdminUser()Z
    ...
    invoke-virtual/range {v37 .. v37}, Landroid/app/Activity;->getBaseContext()Landroid/content/Context;
    ...
    const-string/jumbo v37, "toggle_airplane"
    ...
    check-cast v37, Landroid/support/v14/preference/SecSwitchPreferenceScreen;
    ...
    new-instance v37, Lcom/samsung/android/settings/SecAirplaneModeEnabler;
    ...
    const-string/jumbo v37, "nearby_scanning_setting_category"
    ...
    const-string/jumbo v37, "toggle_nearby_scanning"
    ...
    :goto_1
    const-string/jumbo v37, "display"
    ...
    const-string/jumbo v37, "screen_sharing_ready_category"
    ...
    check-cast v37, Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    const v38, 0x7f121b1d

    invoke-virtual/range {v37 .. v38}, Landroid/support/v7/preference/SecPreferenceScreen;->setSummary(I)V
    ...
    const-string/jumbo v37, "data_usage_settings"
    ...
    const-string/jumbo v37, "mobile_network_settings_for_C"
    ...
    const-string/jumbo v37, "nfc_setting"
    ...
    const-string/jumbo v38, "android.hardware.nfc"

    invoke-virtual/range {v37 .. v38}, Landroid/content/pm/PackageManager;->hasSystemFeature(Ljava/lang/String;)Z
    ...
    invoke-static/range {v37 .. v37}, Lcom/android/settings/Utils;->isHideMobileNetworks(Landroid/content/Context;)Z
    ...
    invoke-virtual/range {v37 .. v38}, Landroid/support/v7/preference/PreferenceScreen;->removePreference(Landroid/support/v7/preference/Preference;)Z
    ...
    :cond_5
    const-string/jumbo v37, "network_management"
    ...
    :cond_6
    :goto_3
    const-string/jumbo v37, "header_connection_tethering_hotspot"
    ...
    :cond_8
    const-string/jumbo v37, "wifi_calling_settings"
    ...
    const-string/jumbo v37, "wifi_ap_settings"
    ...
    sput-object v37, Lcom/samsung/android/settings/WirelessSettings;->sSalesCode:Ljava/lang/String;

    invoke-virtual {v4}, Landroid/app/Activity;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v37

    const-string/jumbo v38, "airplane_mode_toggleable_radios"

    invoke-static/range {v37 .. v38}, Landroid/provider/Settings$Global;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v37 .. v37}, Lcom/android/settings/Utils;->isShopDemo(Landroid/content/Context;)Z
    ...
    const-string/jumbo v38, "no_config_vpn"

    invoke-virtual/range {v37 .. v38}, Landroid/os/UserManager;->hasUserRestriction(Ljava/lang/String;)Z
    ...
    const-string/jumbo v37, "vpn_settings_for_att"
    ...
    const-string/jumbo v37, "bluetooth"
    ...
    const-string/jumbo v37, "no_config_mobile_networks"
    ...
    :cond_e
    const-string/jumbo v37, "mobile_network_settings"
    ...
    sget-boolean v37, Lcom/samsung/android/settings/WirelessSettings;->ALLSHARE_FRAMEWORK:Z
    ...
    :cond_10
    const-string/jumbo v37, "media_share_category_vzw"
    ...
    check-cast v23, Landroid/support/v7/preference/PreferenceCategory;

    const-string/jumbo v37, "nearby_setting_vzw"
    ...
    invoke-static/range {v37 .. v37}, Lcom/android/settings/Utils;->isSupportDeviceVisibility(Landroid/content/Context;)Z
    ...
    invoke-static/range {v37 .. v37}, Lcom/android/settings/Utils;->isSupportGraceUXHeroView(Landroid/content/Context;)Z

    move-result v37

    if-eqz v37, :cond_2f

    const-string/jumbo v37, "device_visibility_settings"
    ...
    new-instance v37, Lcom/samsung/android/settings/devicevisibility/DeviceVisibilityEnabler;
    ...
    const-string/jumbo v37, "data_plan_category"
    ...
    const-string/jumbo v38, "android.hardware.type.television"
    ...
    :cond_14
    const-string/jumbo v37, "persist.sys.tether_data"
    ...
    sput v37, Lcom/samsung/android/settings/WirelessSettings;->mTetheredDataML:I
    ...
    const-string/jumbo v38, "CscFeature_Common_EnableSprintExtension"

    invoke-virtual/range {v37 .. v38}, Lcom/samsung/android/feature/SemCscFeature;->getBoolean(Ljava/lang/String;)Z

    move-result v37

    if-eqz v37, :cond_16

    const-string/jumbo v37, "persist.sys.tether_data_usb"
    ...
    const-string/jumbo v37, "persist.sys.tether_data_bt"
    ...
    const-string/jumbo v37, "persist.sys.tether_data_wifi"
    ...
    :cond_16
    const-string/jumbo v37, "tether_settings"
    ...
    check-cast v37, Lcom/samsung/android/settingslib/RestrictedPreference;
    ...
    :cond_19
    const-string/jumbo v37, "WirelessSettings"

    new-instance v38, Ljava/lang/StringBuilder;

    invoke-direct/range {v38 .. v38}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v39, "KEY_TETHER_SETTINGS isSecondaryUser: "
    ...
    const-string/jumbo v39, " mTetherdData"
    ...
    const-string/jumbo v38, "com.ipsec.vpnclient"

    invoke-static/range {v37 .. v38}, Lcom/android/settings/Utils;->hasPackage(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string/jumbo v38, "com.samsung.tmowfc.wfccontroller"
    ...
    const-string/jumbo v38, "CscFeature_Common_SupportSecWFC"
    ...
    const-string/jumbo v38, "wfc_settings_holder_key"

    invoke-virtual/range {v37 .. v38}, Landroid/support/v7/preference/PreferenceScreen;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    const-string/jumbo v38, "CscFeature_Setting_ConfigOpMenuStructure"
    ...
    invoke-static/range {v37 .. v37}, Lcom/samsung/tmowfc/wfcutils/WfcUtilsHelper;->isValidSim(Landroid/content/Context;)Z
    ...
    invoke-static/range {v37 .. v37}, Lcom/samsung/android/settings/WirelessSettings;->isEnabledWifiCallingActivity(Landroid/content/Context;)Z
    ...
    const v39, 0x7f150136

    const/16 v40, 0x0

    invoke-virtual/range {v37 .. v40}, Landroid/support/v7/preference/PreferenceManager;->inflateFromResource(Landroid/content/Context;ILandroid/support/v7/preference/PreferenceScreen;)Landroid/support/v7/preference/PreferenceScreen;

    move-result-object v36

    const-string/jumbo v37, "wfc_settings_key"
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/support/v7/preference/Preference;->getOrder()I

    move-result v38

    invoke-virtual/range {v37 .. v38}, Landroid/support/v7/preference/Preference;->setOrder(I)V
    ...
    invoke-virtual/range {v37 .. v38}, Landroid/support/v7/preference/PreferenceScreen;->addPreference(Landroid/support/v7/preference/Preference;)Z
    :try_end_1
    ...
    invoke-static/range {v37 .. v37}, Lcom/samsung/android/settings/rcs/RcsUtils;->getInstance(Landroid/content/Context;)Lcom/samsung/android/settings/rcs/RcsUtils;
    ...
    new-instance v37, Lcom/samsung/android/settings/rcs/RcsSettings;
    ...
    const-string/jumbo v38, "com.samsung.rcs"
    ...
    const-string/jumbo v38, "RCS application is not installed"
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/samsung/android/settings/rcs/RcsSettings;->disableAllRcsSettingsPreference()V

    :cond_1c
    :goto_a
    const-string/jumbo v37, "MTR"
    ...
    const-string/jumbo v38, "vpn_settings"
    ...
    const-string/jumbo v38, "com.samsung.feature.mirrorlink_fw"
    ...
    const-string/jumbo v38, "com.samsung.android.app.mirrorlink"
    ...
    const-string/jumbo v38, "ethernet_settings"
    ...
    invoke-static/range {v37 .. v37}, Lcom/samsung/android/settings/WirelessSettings;->isDownloadBoosterSupported(Landroid/content/Context;)Z
    ...
    :cond_20
    const-string/jumbo v37, "smart_bonding_settings"
    ...
    const-string/jumbo v38, "CscFeature_Setting_EnableFactoryResetPasswordWhenNoSIM"
    ...
    :cond_24
    const-string/jumbo v37, "network_reset"
    ...
    invoke-static/range {v37 .. v37}, Lcom/android/settings/Utils;->isFastWebSIMValid(Landroid/content/Context;)Z
    ...
    const-string/jumbo v37, "multi_path"
    ...
    const v37, 0x7f120adc

    move/from16 v0, v37

    invoke-virtual {v12, v0}, Landroid/support/v7/preference/SecPreferenceScreen;->setTitle(I)V

    const-string/jumbo v37, "com.samsung.android.settings.GigaLteSettings"
    ...
    const-string/jumbo v40, "com.samsung.intent.action.SIMHOTSWAP"

    invoke-direct/range {v39 .. v40}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    invoke-virtual/range {v37 .. v39}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    :cond_27
    const-string/jumbo v37, "key_vzw_emergency_alert"
    ...
    invoke-static/range {v37 .. v37}, Lcom/android/settings/Utils;->showVzwEmergencyAlertOption(Landroid/content/Context;)Z
    ...
    const-string/jumbo v38, "hdmi_mode"

    const/16 v39, -0x1

    invoke-static/range {v37 .. v39}, Lcom/android/settings/Utils;->getIntFromDeXSettings(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    const-string/jumbo v38, "com.sec.android.app.desktoplauncher"

    invoke-static/range {v37 .. v38}, Lcom/android/settings/Utils;->isPackageEnabled(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    check-cast v37, Lcom/android/settings/SecDropDownPreference;
    ...
    invoke-virtual/range {v37 .. v38}, Lcom/android/settings/SecDropDownPreference;->setValue(Ljava/lang/String;)V
    ...
    :goto_f
    const-string/jumbo v37, "network_unlock"
    ...
    invoke-static/range {v37 .. v37}, Lcom/android/settings/Utils;->isSupportVZWNetworkLock(Landroid/content/Context;)Z
    ...
    invoke-static/range {v37 .. v37}, Lcom/samsung/android/settings/networklock/NetworkLockUtils;->isVzwNetworkUnLocked(Landroid/content/Context;)Z
    ...
    :cond_2a
    new-instance v37, Lcom/samsung/android/settings/bixby/EmSettingsManager;

    invoke-direct/range {v37 .. v37}, Lcom/samsung/android/settings/bixby/EmSettingsManager;-><init>()V
    ...
    new-instance v38, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->init()Z
    ...
    const v38, 0x7f121b6f

    invoke-virtual/range {v37 .. v38}, Lcom/samsung/android/settingslib/RestrictedPreference;->setTitle(I)V
    ...
    const v38, 0x7f121b64

    invoke-virtual/range {v37 .. v38}, Lcom/samsung/android/settingslib/RestrictedPreference;->setSummary(I)V
    ...
    invoke-static/range {v38 .. v38}, Lcom/android/settings/TetherSettings;->isProvisioningNeededButUnavailable(Landroid/content/Context;)Z

    move-result v38

    xor-int/lit8 v38, v38, 0x1

    invoke-virtual/range {v37 .. v38}, Lcom/samsung/android/settingslib/RestrictedPreference;->setEnabled(Z)V
    ...
    const-string/jumbo v38, "cannot add WfcSwitchPreference"
    ...
    invoke-virtual/range {v37 .. v37}, Lcom/samsung/android/settings/rcs/RcsSettings;->updateRcsSettingsVisibility()V
    ...
    const-string/jumbo v38, "MirrorLink application is not installed"
    ...
    const-string/jumbo v38, "mirror_link_settings"
    ...
    const-string/jumbo v38, "eth_device_conn"

    const/16 v39, 0x0

    const/16 v40, -0x2

    invoke-static/range {v37 .. v40}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string/jumbo v39, "ETH_DEVICE_CONNECTED: "
    ...
    new-instance v37, Lcom/samsung/android/settings/smartbonding/SmartBondingEnabler;
    ...
    invoke-direct/range {v37 .. v39}, Lcom/samsung/android/settings/smartbonding/SmartBondingEnabler;-><init>(Landroid/content/Context;Landroid/support/v14/preference/SecSwitchPreference;)V
    ...
    const-string/jumbo v37, "notificationDialogShown"
    ...
    invoke-virtual/range {v38 .. v38}, Landroid/support/v14/preference/SecSwitchPreferenceScreen;->isChecked()Z

    move-result v38

    xor-int/lit8 v38, v38, 0x1

    invoke-virtual/range {v37 .. v38}, Lcom/samsung/android/settings/smartbonding/SmartBondingEnabler;->onWidgetChanged(Z)Z
    ...
    const-string/jumbo v38, "com.lguplus.lgusetting"
