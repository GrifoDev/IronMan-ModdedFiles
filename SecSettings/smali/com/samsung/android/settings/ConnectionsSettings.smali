...
.method public onResume()V
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/ConnectionsSettings;->mTetheringHotspot:Landroid/support/v7/preference/SecRestrictedPreference;

    if-eqz v2, :cond_0

    iget-object v2, p0, Lcom/samsung/android/settings/ConnectionsSettings;->mTetheringHotspot:Landroid/support/v7/preference/SecRestrictedPreference;

    invoke-virtual {v2, v5}, Landroid/support/v7/preference/SecRestrictedPreference;->setEnabled(Z)V
    ...
    :cond_2
    iget-object v2, p0, Lcom/samsung/android/settings/ConnectionsSettings;->mAirplaneModeEnabler:Lcom/android/settings/SecAirplaneModeEnabler;

    if-eqz v2, :cond_3

    iget-object v2, p0, Lcom/samsung/android/settings/ConnectionsSettings;->mAirplaneModeEnabler:Lcom/android/settings/SecAirplaneModeEnabler;

    invoke-virtual {v2}, Lcom/android/settings/SecAirplaneModeEnabler;->resume()V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/preference/SecRestrictedPreference;->setEnabled(Z)V
