...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mIrisManager:Lcom/samsung/android/camera/iris/SemIrisManager;
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mFaceManager:Lcom/samsung/android/bio/face/SemBioFaceManager;
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mFingerprintManager:Lcom/samsung/android/fingerprint/FingerprintManager;

    const v3, 0x7f0d0157

    invoke-virtual {p0, v3}, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->setContentView(I)V

    iget-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mContext:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v3

    const-string/jumbo v4, "biometrics_backup_type"

    invoke-static {v3, v4, v6}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v3

    iput v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mBackupPasswordStatusDB:I

    const v3, 0x7f0a00b1

    invoke-virtual {p0, v3}, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->findViewById(I)Landroid/view/View;
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mIrisPreview:Landroid/widget/ImageView;
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->linearlayout:Landroid/widget/LinearLayout;
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mCancelBtn:Landroid/widget/TextView;
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mWarningDesc:Landroid/widget/TextView;
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mBackupPasswordBtn:Landroid/widget/Button;
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mVerifyFingerBtn:Landroid/widget/Button;

    iget-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mFaceManager:Lcom/samsung/android/bio/face/SemBioFaceManager;
    ...
    :goto_0
    iget-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mFingerprintManager:Lcom/samsung/android/fingerprint/FingerprintManager;
    ...
    :cond_1
    iget-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mWarningDesc:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->linearlayout:Landroid/widget/LinearLayout;

    invoke-virtual {v3, v6}, Landroid/widget/LinearLayout;->setOrientation(I)V

    iget-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mVerifyFingerBtn:Landroid/widget/Button;

    invoke-virtual {v3, v5}, Landroid/widget/Button;->setVisibility(I)V

    :cond_3
    iget-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mCancelBtn:Landroid/widget/TextView;

    invoke-virtual {v3, p0}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mBackupPasswordBtn:Landroid/widget/Button;
    ...
    :cond_4
    iget v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mBackupPasswordStatusDB:I
    ...
    iget-object v4, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mContext:Landroid/content/Context;
    ...
    iput v3, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mIrisViewWidth:I

    iput v6, p0, Lcom/samsung/android/settings/iris/IrisAuthenticateDialog;->mResultValue:I
