...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/settings/CustomDialogPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private updateChecked()V
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/datausage/AlertAtWarningPreference;->mPolicy:Landroid/net/NetworkPolicy;
...
.method public onBindViewHolder(Landroid/support/v7/preference/PreferenceViewHolder;)V
    ...
    iget-boolean v1, p0, Lcom/samsung/android/settings/datausage/AlertAtWarningPreference;->mChecked:Z
...
.method public onClick()V
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/datausage/AlertAtWarningPreference;->mServices:Lcom/android/settings/datausage/TemplatePreference$NetworkServices;
    ...
    iget-object v6, p0, Lcom/samsung/android/settings/datausage/AlertAtWarningPreference;->mTemplate:Landroid/net/NetworkTemplate;

    invoke-virtual {v1, v6}, Lcom/android/settingslib/NetworkPolicyEditor;->getPolicyLimitBytes(Landroid/net/NetworkTemplate;)J

    move-result-wide v2

    iget-boolean v1, p0, Lcom/samsung/android/settings/datausage/AlertAtWarningPreference;->mIsSPR:Z
    ...
    invoke-direct {p0, v1}, Lcom/samsung/android/settings/datausage/AlertAtWarningPreference;->setChecked(Z)V

    invoke-super {p0}, Lcom/android/settings/CustomDialogPreference;->onClick()V
...
.method public performClick()V
    ...
    invoke-super {p0}, Lcom/android/settings/CustomDialogPreference;->performClick()V
