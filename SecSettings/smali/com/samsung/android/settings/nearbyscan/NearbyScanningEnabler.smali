...
.field private mNearByScanningSwitchPref:Landroid/support/v14/preference/SecSwitchPreference;

.field private mNearbyScanningObserver:Landroid/database/ContentObserver;

.field private mNearbyScanningSettingsSwitch:Landroid/support/v14/preference/SecSwitchPreference;
...
.method static synthetic -get1(Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;)Landroid/support/v14/preference/SecSwitchPreference;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearByScanningSwitchPref:Landroid/support/v14/preference/SecSwitchPreference;

    return-object v0
.end method

.method static synthetic -get2(Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;)Landroid/support/v14/preference/SecSwitchPreference;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearbyScanningSettingsSwitch:Landroid/support/v14/preference/SecSwitchPreference;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearbyScanningSettingsSwitch:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearByScanningSwitchPref:Landroid/support/v14/preference/SecSwitchPreference;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/Object;)V
    ...
    instance-of v0, p2, Landroid/support/v14/preference/SecSwitchPreference;

    if-eqz v0, :cond_1

    check-cast p2, Landroid/support/v14/preference/SecSwitchPreference;

    iput-object p2, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearbyScanningSettingsSwitch:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iput-object p2, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearByScanningSwitchPref:Landroid/support/v14/preference/SecSwitchPreference;
...
.method public init()Z
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearbyScanningSettingsSwitch:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearbyScanningSettingsSwitch:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mOnPreferenceChangeListener:Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;
    ...
    :cond_3
    iget-object v1, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearByScanningSwitchPref:Landroid/support/v14/preference/SecSwitchPreference;
...
.method public onResume()Z
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearbyScanningSettingsSwitch:Landroid/support/v14/preference/SecSwitchPreference;

    if-eqz v3, :cond_5

    iget-object v3, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearbyScanningSettingsSwitch:Landroid/support/v14/preference/SecSwitchPreference;

    invoke-virtual {v3, v4}, Landroid/support/v14/preference/SecSwitchPreference;->semSetSummaryColorToColorPrimaryDark(Z)V

    iget-object v6, p0, Lcom/samsung/android/settings/nearbyscan/NearbyScanningEnabler;->mNearbyScanningSettingsSwitch:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    :goto_1
    invoke-virtual {v6, v3}, Landroid/support/v14/preference/SecSwitchPreference;->setSummary(I)V
