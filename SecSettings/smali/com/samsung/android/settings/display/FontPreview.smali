...
.method protected checkFont(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/samsung/android/settings/display/FontPreview;->isSharedFont(Ljava/lang/String;)Z
...
.method protected isSharedFont(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v5, p0, Lcom/samsung/android/settings/display/FontPreview;->mFontListAdapter:Lcom/samsung/android/settings/flipfont/FontListAdapter;
    ...
    :goto_2
    const-string/jumbo v5, "FontPreview"
...
.method public onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    sget v4, Lcom/samsung/android/settings/display/FontPreview;->sDisplayFontAccessibilitySwitch:I

    iget-boolean v1, p0, Lcom/samsung/android/settings/display/FontPreview;->mIsFontLargerOn:Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v3, v0, Lcom/samsung/android/settings/display/FontPreview;->mDashboardFeatureProvider:Lcom/android/settings/dashboard/DashboardFeatureProvider;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/samsung/android/settings/display/FontPreview;->mDashboardFeatureProvider:Lcom/android/settings/dashboard/DashboardFeatureProvider;
    ...
    iput-object v3, v0, Lcom/samsung/android/settings/display/FontPreview;->mScreenSizeLayout:Landroid/widget/LinearLayout;
    ...
    invoke-static {v3}, Lcom/android/settings/Utils;->getCurrentResolution(Landroid/content/Context;)I
    ...
    iget-object v3, v0, Lcom/samsung/android/settings/display/FontPreview;->mScreenSizeLayout:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/samsung/android/settings/display/FontPreview$LoadListTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-super {p0, p1}, Lcom/android/settings/core/InstrumentedActivity;->onCreateOptionsMenu(Landroid/view/Menu;)Z
...
.method public onResume()V
    ...
    invoke-direct {v6, p0, v9}, Lcom/samsung/android/settings/display/FontPreview$LoadListTask;-><init>(Lcom/samsung/android/settings/display/FontPreview;Lcom/samsung/android/settings/display/FontPreview$LoadListTask;)V
    ...
    invoke-virtual {v6, v9, v10}, Lcom/samsung/android/settings/display/FontPreview$LoadListTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;

    const-string/jumbo v6, "FontPreview onResume"

    const-string/jumbo v9, "called onResume()"
