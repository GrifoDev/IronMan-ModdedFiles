...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    check-cast v23, Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    check-cast v23, Landroid/support/v14/preference/SecSwitchPreference;
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/support/v14/preference/SecSwitchPreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/support/v7/preference/SecPreferenceScreen;->semSetSummaryColorToColorPrimaryDark(Z)V
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/settings/SecSettingsSwitchPreference;->setOnPreferenceClickListener(Landroid/support/v7/preference/Preference$OnPreferenceClickListener;)V
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/settings/SecSettingsSwitchPreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V
    ...
    check-cast v23, Landroid/support/v7/preference/SecPreference;

    move-object/from16 v0, v23

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/samsung/android/settings/PrivacySettings;->mSmartSwitch:Landroid/support/v7/preference/SecPreference;
    ...
    iget-object v0, v0, Lcom/samsung/android/settings/PrivacySettings;->mSmartSwitch:Landroid/support/v7/preference/SecPreference;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/samsung/android/settings/PrivacySettings;->showPreference(Landroid/support/v7/preference/Preference;Landroid/support/v7/preference/PreferenceGroup;Z)V
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/support/v7/preference/SecPreference;->setOnPreferenceClickListener(Landroid/support/v7/preference/Preference$OnPreferenceClickListener;)V
    ...
    invoke-direct {v0, v12, v1, v2}, Lcom/samsung/android/settings/PrivacySettings;->showPreference(Landroid/support/v7/preference/Preference;Landroid/support/v7/preference/PreferenceGroup;Z)V
    ...
    check-cast v23, Landroid/support/v7/preference/PreferenceGroup;
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/support/v7/preference/PreferenceGroup;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/support/v7/preference/SecPreferenceScreen;->setOnPreferenceClickListener(Landroid/support/v7/preference/Preference$OnPreferenceClickListener;)V
    ...
    invoke-virtual {v0, v7}, Landroid/support/v7/preference/PreferenceScreen;->getPreference(I)Landroid/support/v7/preference/Preference;

    move-result-object v15

    invoke-virtual {v15}, Landroid/support/v7/preference/Preference;->getKey()Ljava/lang/String;
    ...
    :cond_b
    instance-of v0, v15, Landroid/support/v7/preference/PreferenceCategory;
    ...
    invoke-virtual {v14}, Landroid/support/v7/preference/PreferenceCategory;->getPreferenceCount()I
    ...
    invoke-virtual {v14, v10}, Landroid/support/v7/preference/PreferenceCategory;->getPreference(I)Landroid/support/v7/preference/Preference;

    move-result-object v21

    invoke-virtual/range {v21 .. v21}, Landroid/support/v7/preference/Preference;->getKey()Ljava/lang/String;
    ...
    invoke-virtual {v14, v0}, Landroid/support/v7/preference/PreferenceCategory;->removePreference(Landroid/support/v7/preference/Preference;)Z
