...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v9}, Lcom/samsung/android/settings/GeneralDeviceSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v9

    check-cast v9, Landroid/support/v7/preference/SecPreferenceScreen;

    iput-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mBatterySettingsPref:Landroid/support/v7/preference/SecPreferenceScreen;

    iget-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mBatterySettingsPref:Landroid/support/v7/preference/SecPreferenceScreen;

    invoke-virtual {v9, v11}, Landroid/support/v7/preference/SecPreferenceScreen;->setFragment(Ljava/lang/String;)V

    iget-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mBatterySettingsPref:Landroid/support/v7/preference/SecPreferenceScreen;

    invoke-virtual {v9, v11}, Landroid/support/v7/preference/SecPreferenceScreen;->setIntent(Landroid/content/Intent;)V
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mStorageSettingsPref:Landroid/support/v7/preference/SecPreferenceScreen;

    iget-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mStorageSettingsPref:Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mMemorySettingsPref:Landroid/support/v7/preference/SecPreferenceScreen;

    iget-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mMemorySettingsPref:Landroid/support/v7/preference/SecPreferenceScreen;
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mDiagnosticInfo:Landroid/support/v14/preference/SecSwitchPreference;

    iget-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mDiagnosticInfo:Landroid/support/v14/preference/SecSwitchPreference;
    ...
    :goto_1
    invoke-virtual {v11, v9}, Landroid/support/v14/preference/SecSwitchPreference;->setChecked(Z)V
    ...
    invoke-virtual {v9, v11}, Landroid/support/v14/preference/SecSwitchPreference;->setOnPreferenceChangeListener(Landroid/support/v7/preference/Preference$OnPreferenceChangeListener;)V
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mDateTimePref:Landroid/support/v7/preference/SecPreference;

    iget-object v9, p0, Lcom/samsung/android/settings/GeneralDeviceSettings;->mDateTimePref:Landroid/support/v7/preference/SecPreference;
    ...
    const v10, 0x7f0d022d

    invoke-virtual {v9, v10}, Landroid/support/v7/preference/SecPreference;->setWidgetLayoutResource(I)V
