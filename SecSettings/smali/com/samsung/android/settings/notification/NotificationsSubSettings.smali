...
.field private mDialKeypadTone:Landroid/support/v14/preference/SwitchPreference;
...
.field private mEmail:Landroid/support/v7/preference/SecPreference;
...
.field private mKeyboardSound:Landroid/support/v14/preference/SwitchPreference;

.field private final mLookupRingtoneNames:Ljava/lang/Runnable;

.field private mMessagePackageName:Ljava/lang/String;

.field private mMessages:Landroid/support/v7/preference/SecPreference;
...
.field private mRingtoyou:Landroid/support/v7/preference/SecPreference;

.field private mScreenLockSound:Landroid/support/v14/preference/SwitchPreference;
...
.field private mSplanner:Landroid/support/v7/preference/SecPreference;

.field private mTcoloring:Landroid/support/v7/preference/SecPreference;

.field private mTelephonyManager:Landroid/telephony/TelephonyManager;

.field private mTouchSounds:Landroid/support/v14/preference/SwitchPreference;
...
.method static synthetic -get6(Lcom/samsung/android/settings/notification/NotificationsSubSettings;)Landroid/support/v7/preference/Preference;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mPhoneRingtone2Preference:Landroid/support/v7/preference/Preference;

    return-object v0
.end method

.method static synthetic -get7(Lcom/samsung/android/settings/notification/NotificationsSubSettings;)Landroid/support/v7/preference/Preference;
    .locals 1

    iget-object v0, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mPhoneRingtonePreference:Landroid/support/v7/preference/Preference;
...
.method private initRingtones()V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v0

    iput-object v0, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mPhoneRingtonePreference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mPhoneRingtone2Preference:Landroid/support/v7/preference/Preference;
    ...
    iput-object v1, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mPhoneRingtonePreference:Landroid/support/v7/preference/Preference;
...
.method private startRingtoneSetting()V
    ...
    iget-object v6, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mRingtonePreference_DS:Landroid/support/v7/preference/Preference;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    :cond_5
    iget-object v4, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mNotificationSound:Lcom/android/settings/DefaultRingtonePreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v9}, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;

    move-result-object v9

    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mRingtonePreference_DS:Landroid/support/v7/preference/Preference;
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mTcoloring:Landroid/support/v7/preference/SecPreference;
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mRingtoyou:Landroid/support/v7/preference/SecPreference;
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mMessages:Landroid/support/v7/preference/SecPreference;
    ...
    :cond_a
    iget-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mMessages:Landroid/support/v7/preference/SecPreference;
    ...
    invoke-virtual {v9, v10}, Landroid/support/v7/preference/SecPreference;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mMessages:Landroid/support/v7/preference/SecPreference;

    const/4 v10, 0x1

    invoke-virtual {v9, v10}, Landroid/support/v7/preference/SecPreference;->semSetSummaryColorToColorPrimaryDark(Z)V
    ...
    invoke-virtual {v9, v10}, Landroid/support/v7/preference/SecPreference;->setEnabled(Z)V
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mSplanner:Landroid/support/v7/preference/SecPreference;

    iget-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mSplanner:Landroid/support/v7/preference/SecPreference;
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mEmail:Landroid/support/v7/preference/SecPreference;

    iget-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mEmail:Landroid/support/v7/preference/SecPreference;
    ...
    const v10, 0x7f1208fa

    invoke-virtual {v9, v10}, Landroid/support/v7/preference/SecPreference;->setSummary(I)V
    ...
    invoke-virtual {v9, v10}, Lcom/android/settings/DefaultRingtonePreference;->setRingtoneType(I)V
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mDialKeypadTone:Landroid/support/v14/preference/SwitchPreference;
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mScreenLockSound:Landroid/support/v14/preference/SwitchPreference;
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mTouchSounds:Landroid/support/v14/preference/SwitchPreference;
    ...
    iput-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mKeyboardSound:Landroid/support/v14/preference/SwitchPreference;
    ...
    iget-object v9, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mRingtonePreference_DS:Landroid/support/v7/preference/Preference;
...
.method public onPreferenceTreeClick(Landroid/support/v7/preference/Preference;)Z
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mTcoloring:Landroid/support/v7/preference/SecPreference;

    if-eq p1, v2, :cond_0

    iget-object v2, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mRingtoyou:Landroid/support/v7/preference/SecPreference;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mNotificationSound:Lcom/android/settings/DefaultRingtonePreference;

    if-ne p1, v2, :cond_2

    iget-object v2, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mNotificationSound:Lcom/android/settings/DefaultRingtonePreference;

    iget-object v3, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mNotificationSound:Lcom/android/settings/DefaultRingtonePreference;

    invoke-virtual {v3}, Lcom/android/settings/DefaultRingtonePreference;->getRingtonePickerIntent()Landroid/content/Intent;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/android/settings/DefaultRingtonePreference;->onPrepareRingtonePickerIntent(Landroid/content/Intent;)V

    iget-object v2, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mNotificationSound:Lcom/android/settings/DefaultRingtonePreference;

    invoke-virtual {v2}, Lcom/android/settings/DefaultRingtonePreference;->getRingtonePickerIntent()Landroid/content/Intent;

    move-result-object v2

    const/4 v3, 0x4

    invoke-virtual {p0, v2, v3}, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->startActivityForResult(Landroid/content/Intent;I)V
    ...
    :cond_6
    iget-object v2, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mMessages:Landroid/support/v7/preference/SecPreference;
    ...
    :cond_7
    iget-object v2, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mSplanner:Landroid/support/v7/preference/SecPreference;
    ...
    :cond_8
    iget-object v2, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mEmail:Landroid/support/v7/preference/SecPreference;
    ...
    :cond_9
    iget-object v2, p0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mKeyboardSound:Landroid/support/v14/preference/SwitchPreference;
...
.method public onResume()V
    ...
    iget-object v4, v0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mSplanner:Landroid/support/v7/preference/SecPreference;
    ...
    iget-object v4, v0, Lcom/samsung/android/settings/notification/NotificationsSubSettings;->mMessages:Landroid/support/v7/preference/SecPreference;
    ...
    invoke-virtual {v4, v0}, Landroid/support/v7/preference/SecPreference;->setSummary(Ljava/lang/CharSequence;)V
