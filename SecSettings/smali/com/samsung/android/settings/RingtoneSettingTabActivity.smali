...
# static fields
.field private static mTabHost:Landroid/support/v13/app/FragmentTabHost;
...
.method private setTabIndicatorTextColor()V
    ...
    sget-object v2, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->mTabHost:Landroid/support/v13/app/FragmentTabHost;

    invoke-virtual {v2}, Landroid/support/v13/app/FragmentTabHost;->getTabWidget()Landroid/widget/TabWidget;
    ...
    iget v2, p0, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->mActivePhone:I

    if-eq v1, v2, :cond_1

    const v2, 0x7f060031

    invoke-virtual {p0, v2}, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->getColor(I)I
...
.method private setupSimTab(I)V
    ...
    sget-object v3, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->mTabHost:Landroid/support/v13/app/FragmentTabHost;

    invoke-virtual {v3, v1}, Landroid/support/v13/app/FragmentTabHost;->newTabSpec(Ljava/lang/String;)Landroid/widget/TabHost$TabSpec;
    ...
    const-class v4, Lcom/samsung/android/settings/DualSoundRingtoneSettings;

    invoke-virtual {v2, v3, v4, v0}, Landroid/support/v13/app/FragmentTabHost;->addTab(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2}, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->setContentView(I)V

    const v2, 0x1020012

    invoke-virtual {p0, v2}, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->findViewById(I)Landroid/view/View;

    move-result-object v2

    check-cast v2, Landroid/support/v13/app/FragmentTabHost;

    sput-object v2, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->mTabHost:Landroid/support/v13/app/FragmentTabHost;

    sget-object v2, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->mTabHost:Landroid/support/v13/app/FragmentTabHost;

    invoke-virtual {p0}, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->getFragmentManager()Landroid/app/FragmentManager;

    move-result-object v3

    const v4, 0x1020011

    invoke-virtual {v2, p0, v3, v4}, Landroid/support/v13/app/FragmentTabHost;->setup(Landroid/content/Context;Landroid/app/FragmentManager;I)V

    sget-object v2, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->mTabHost:Landroid/support/v13/app/FragmentTabHost;

    invoke-virtual {v2, p0}, Landroid/support/v13/app/FragmentTabHost;->setOnTabChangedListener(Landroid/widget/TabHost$OnTabChangeListener;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v13/app/FragmentTabHost;->setCurrentTab(I)V
...
.method public onResume()V
    ...
    sget-object v6, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->mTabHost:Landroid/support/v13/app/FragmentTabHost;

    invoke-virtual {v6}, Landroid/support/v13/app/FragmentTabHost;->getTabWidget()Landroid/widget/TabWidget;
    ...
    invoke-direct {p0}, Lcom/samsung/android/settings/RingtoneSettingTabActivity;->setTabIndicatorTextColor()V
