...
.method public createVirtualScreen(Ljava/lang/String;Landroid/graphics/Rect;I)I
    ...
    const-string/jumbo v8, "createVirtualScreen: Can\'t create virtualscreen in the emergency mode."
    ...
    const-string/jumbo v8, "createVirtualScreen: Can\'t create virtualscreen in the safe mode."
    ...
    const-string/jumbo v8, "createVirtualScreen() Invalid bound"
    ...
    const-string/jumbo v8, "Permission Denial: createVirtualScreen() from pid="
    ...
    const-string/jumbo v9, "createVirtualScreen: don\'t exist displayContent. create new one!"
    ...
    const-string/jumbo v9, "createVirtualScreen() Invalid displayId"
    ...
    const-string/jumbo v10, "createVirtualScreen displayId="
...
.method public moveTaskBackToDisplayIfNeeded(Lcom/android/server/am/TaskRecord;ZZ)Z
    ...
    const-string/jumbo v12, "moveTaskBackToDisplayIfNeeded(): The task has more than one activity"
    ...
    const-string/jumbo v12, "moveTaskBackToDisplayIfNeeded(): root activity or app is null"
    ...
    const-string/jumbo v12, "moveTaskBackToDisplayIfNeeded(): root is not base activity"
    ...
    const-string/jumbo v12, "moveTaskBackToDisplayIfNeeded(): app which created virtualscreen is crashing or not responding, reset offset!"
    ...
    const-string/jumbo v13, "moveTaskBackToDisplayIfNeeded() need to change display="
    ...
    const-string/jumbo v13, "moveTaskBackToDisplayIfNeeded(): app on virtualscreen is crashing or not responding, reset offset! canMoveToDisplay="
    ...
    const-string/jumbo v13, "failed to move task "
...
.method public moveTaskToDisplay(Lcom/android/server/am/TaskRecord;IZZZ)Z
    ...
    const-string/jumbo v1, "moveTaskToDisplay() Couldn\'t update display"
...
.method moveVirtualScreenToDisplayLocked(II)Z
    ...
    const-string/jumbo v7, "moveVirtualScreenToDisplay - virtualScreenDisplayId("
    ...
    const-string/jumbo v7, "moveVirtualScreenToDisplayLocked(): stack is empty"
    ...
    const-string/jumbo v7, "moveVirtualScreenToDisplayLocked(): moving to virtual display, transit=TRANSIT_VIRTUAL_SCREEN_TASK"
...
.method public setOffset(Landroid/os/IBinder;IIIZ)Z
    ...
    const-string/jumbo v17, "3. Performance Test SetOffset Start"
    ...
    const-string/jumbo v18, "3. Performance Test SetOffset In"
    ...
    const-string/jumbo v17, "3. Performance Test SetOffset End"
    ...
    const-string/jumbo v19, "Did not drawn appwindow in display:"
