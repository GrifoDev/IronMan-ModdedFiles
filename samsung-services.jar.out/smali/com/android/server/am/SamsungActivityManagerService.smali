...
.method private isConventionalMode(Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string/jumbo v2, "isConventionalMode : packageName="
...
.method private moveTaskToFreeformStackOrRelayoutLocked(Lcom/android/server/am/TaskRecord;Z)V
    ...
    const-string/jumbo v11, "Desktop mode"
...
.method private testExitVS(Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string/jumbo v5, "moveOffVSStack"
...
.method public applyConventionalMode(Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string/jumbo v7, "Enable ConventionalMode app="
    ...
    const-string/jumbo v7, "Disable ConventionalMode app="
...
.method public clearHomeStack()V
    ...
    const-string/jumbo v8, "clearHomeStack(), defaultHomePkgName="
    ...
    const-string/jumbo v8, ", homeStack="
    ...
    const-string/jumbo v8, "clearHomeStack(), removing task="
...
.method public getLaunchStackVS(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityStack;
    ...
    const-string/jumbo v2, "on_vs_display"
...
.method public killAllBackgroundProcessesExcept(IILandroid/os/Bundle;)V
    ...
    const-string/jumbo v30, "android.permission.KILL_BACKGROUND_PROCESSES"
    ...
    const-string/jumbo v30, "Permission Denial: killAllBackgroundProcessesExcept() from pid="
    ...
    const-string/jumbo v30, " requires "
    ...
    const-string/jumbo v29, "SamsungActivityManager"
    ...
    const-string/jumbo v29, "kill_packages"
    ...
    const-string/jumbo v29, "keep_packages"
    ...
    const-string/jumbo v29, "skip_sdk_version_check"
    ...
    const-string/jumbo v32, "killAllProcesses mSystemUIProcessRecord="
    ...
    const-string/jumbo v33, "kill all background except(policy="
    ...
    const-string/jumbo v29, "sys.skip_lockscreen"
    ...
    :try_start_3
    const-string/jumbo v29, "force-keep-alive"
...
.method public notifyTaskRemovedLocked(Lcom/android/server/am/TaskRecord;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "notifyTaskRemoved: taskId="
...
.method public notifyTaskToFrontLocked(Lcom/android/server/am/TaskRecord;ZLjava/lang/String;)V
    ...
    const-string/jumbo v4, ", mTaskToFront="
...
.method public registerTaskWatcher(ILcom/samsung/android/app/ITaskWatcher;IIZ)V
    ...
    const-string/jumbo v3, "Cannot registerTaskWatcher from pid "
...
.method public resumeVSStackIfNeeded(Lcom/android/server/am/ActivityStack;)V
    ...
    const-string/jumbo v1, "resumeVS"
...
.method public saveDumpLocked(Lcom/android/server/am/ProcessRecord;Ljava/lang/Exception;)V
    ...
    const-string/jumbo v2, "systemui died mApp="
    ...
    const-string/jumbo v1, "saveDump"
...
.method sendTaskCallbacksLocked(Lcom/android/server/am/TaskRecord;I)V
    ...
    const-string/jumbo v9, "SamsungActivityManager"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v11, "All Sending onTaskDescriptionSet for "
    ...
    const-string/jumbo v11, "All Sending onTaskToFront for "
    ...
    const-string/jumbo v11, "All Sending onTaskRemoved for "
    ...
    const-string/jumbo v11, "All Sending onTaskToBack for "
    ...
    const-string/jumbo v11, "Sending onTaskDescriptionSet for "
    ...
    const-string/jumbo v11, "Sending onTaskToFront for "
    ...
    const-string/jumbo v11, "Sending onTaskRemoved for "
    ...
    const-string/jumbo v11, "Sending onTaskToBack for "
    ...
    const-string/jumbo v11, "Watched task "
    ...
    const-string/jumbo v11, " has been removed."
...
.method public unregisterTaskWatcher(ILcom/samsung/android/app/ITaskWatcher;IIZ)V
    ...
    const-string/jumbo v3, "Cannot unregisterTaskWatcher from pid "
