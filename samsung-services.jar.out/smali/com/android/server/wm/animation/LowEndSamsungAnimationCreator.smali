...
.method public createSamsungAnimation(Landroid/graphics/Rect;IZZLandroid/graphics/Rect;Landroid/graphics/Rect;IZZ)Landroid/view/animation/Animation;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->setAppWindowSize(Landroid/graphics/Rect;)V
...
.method public createSamsungAppEnterAnimation(ZZLandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)Landroid/view/animation/Animation;
    ...
    iget-object v3, v0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_ENTER_APP_ALPHA_ANIMATION_INTERPOLATOR:Landroid/view/animation/PathInterpolator;
    ...
    iget-wide v14, v0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_ENTER_APP_CLIP_RECT_ENTER_UPPER:J
    ...
    iget-wide v14, v0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_ENTER_APP_CLIP_RECT_ENTER_MIDDLE:J
    ...
    iget-wide v14, v0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_ENTER_APP_CLIP_RECT_ENTER_LOWER:J
...
.method public createSamsungAppExitAnimation(ZLandroid/graphics/Rect;)Landroid/view/animation/Animation;
    ...
    iget-wide v2, p0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_EXIT_APP_ALPHA_ANIMATION_START_OFFSET:J
...
.method public initSamsungAnimationFactor()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_ENTER_APP_ALPHA_ANIMATION_INTERPOLATOR:Landroid/view/animation/PathInterpolator;
    ...
    iput v3, p0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_ENTER_APP_SCALE_ANIMATION_TO_X_IS_SPLIT:F
    ...
    iput v3, p0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_ENTER_APP_SCALE_ANIMATION_TO_Y_IS_SPLIT:F
    ...
    iput-wide v0, p0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_ENTER_APP_CLIP_RECT_ENTER_MIDDLE:J
    ...
    iput-wide v0, p0, Lcom/android/server/wm/animation/LowEndSamsungAnimationCreator;->APP_EXIT_APP_ALPHA_ANIMATION_START_OFFSET:J
