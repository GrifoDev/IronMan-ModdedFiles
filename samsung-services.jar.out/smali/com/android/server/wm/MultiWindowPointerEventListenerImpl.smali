...
.method private findTargetTaskBounds(IILandroid/graphics/Rect;)Z
    ...
    const-string/jumbo v9, "MultiWindowGesture"

    const-string/jumbo v11, "findTargetTaskBounds: the keyguard is currently locked."
    ...
    const-string/jumbo v11, "findTargetTaskBounds: the quick panel is expanded."
    ...
    const-string/jumbo v11, "findTargetTaskBounds: the edge panel is expanded."
    ...
    const-string/jumbo v11, "findTargetTaskBounds: The screensaver is running."
    ...
    const-string/jumbo v12, "findTargetTaskBounds: "
    ...
    const-string/jumbo v12, "findTargetTaskBounds: failed, task is relaunching, t"
    ...
    const-string/jumbo v12, "findTargetTaskBounds: failed, docked task is adjusted by ime or Recents is visible, t"
    ...
    const-string/jumbo v11, "findTargetTaskBounds: failed, task is not dock or full"
